/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0020/src/com/nec/jp/orteus/metamorBase/AE0020/AE0020010Struct.java,v $
 *
...
public class AE0020010Struct extends DataStruct
{
	...
	/** 第 3 変数： m_MRP_ODR_TYP_DN */
	public String m_MRP_ODR_TYP_DN = null;
	/** 第 4 変数： m_UNIT_QTY_TYP_DN */
	public String m_UNIT_QTY_TYP_DN = null;
	/** 第 5 変数： m_ODR_STS_TYP_DN */
	public String m_ODR_STS_TYP_DN = null;
	/** 第 6 変数： m_DM_STS_TYP_DN */
	public String m_DM_STS_TYP_DN = null;
	/** 第 7 変数： m_AE0020010tree1 */
	public String m_AE0020010tree1 = null;
	/** 第 8 変数： m_id */
	...
	/** 第 3 List変数： l_MRP_ODR_TYP_DN */
	public List l_MRP_ODR_TYP_DN = null;

	/** 第 4 List変数： l_UNIT_QTY_TYP_DN */
	public List l_UNIT_QTY_TYP_DN = null;

	/** 第 5 List変数： l_ODR_STS_TYP_DN */
	public List l_ODR_STS_TYP_DN = null;

	/** 第 6 List変数： l_DM_STS_TYP_DN */
	public List l_DM_STS_TYP_DN = null;

	/** 第 7 List変数： l_AE0020010tree1 */
	public List l_AE0020010tree1 = null;
	...
	public String getAE0020010tree1() { return m_AE0020010tree1; }
	...
	public List getList_AE0020010tree1() { return l_AE0020010tree1; }
	...
	public void setAE0020010tree1(String val) { m_AE0020010tree1 = val; }
	...
	public void setList_AE0020010tree1(List list) { l_AE0020010tree1 = list; }
	...
	public int setL2L_JOB_ODR_TYP_DN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_JOB_ODR_TYP_DN.add(((AE0020010Struct) list.get(i)).getJOB_ODR_TYP_DN());
		}
		return size;
	}
	public int setL2L_OUTSIDE_TYP_DN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OUTSIDE_TYP_DN.add(((AE0020010Struct) list.get(i)).getOUTSIDE_TYP_DN());
		}
		return size;
	}
	public int setL2L_MRP_ODR_TYP_DN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_MRP_ODR_TYP_DN.add(((AE0020010Struct) list.get(i)).getMRP_ODR_TYP_DN());
		}
		return size;
	}
	public int setL2L_UNIT_QTY_TYP_DN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_UNIT_QTY_TYP_DN.add(((AE0020010Struct) list.get(i)).getUNIT_QTY_TYP_DN());
		}
		return size;
	}
	public int setL2L_ODR_STS_TYP_DN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ODR_STS_TYP_DN.add(((AE0020010Struct) list.get(i)).getODR_STS_TYP_DN());
		}
		return size;
	}
	public int setL2L_DM_STS_TYP_DN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DM_STS_TYP_DN.add(((AE0020010Struct) list.get(i)).getDM_STS_TYP_DN());
		}
		return size;
	}
	public int setL2L_AE0020010tree1(List list) {
		int size = (list != null) ? list.size() : 0;
		if (size == 0) {
			return 0;
		}
		if (l_AE0020010tree1 == null) {
			l_AE0020010tree1 = new ArrayList();
		} else {
			l_AE0020010tree1.clear();
		}
		for (int i = 0; i < size; i++) {
			l_AE0020010tree1.add(((AE0020010Struct) list.get(i)).getAE0020010tree1());
		}
		return size;
	}
	public int setL2L_id(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_id.add(((AE0020010Struct) list.get(i)).getid());
		}
		return size;
	}
	public int setL2L_lvl(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_lvl.add(((AE0020010Struct) list.get(i)).getlvl());
		}
		return size;
	}
	public int setL2L_parent(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_parent.add(((AE0020010Struct) list.get(i)).getparent());
		}
		return size;
	}
	public int setL2L_label(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_label.add(((AE0020010Struct) list.get(i)).getlabel());
		}
		return size;
	}
	public int setL2L_ctx(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ctx.add(((AE0020010Struct) list.get(i)).getctx());
		}
		return size;
	}
	public int setL2L_maxid(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_maxid.add(((AE0020010Struct) list.get(i)).getmaxid());
		}
		return size;
	}
	public int setL2L_InitLevel(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_InitLevel.add(((AE0020010Struct) list.get(i)).getInitLevel());
		}
		return size;
	}
	public int setL2L_OD_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OD_NO.add(((AE0020010Struct) list.get(i)).getOD_NO());
		}
		return size;
	}
	public int setL2L_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_CD.add(((AE0020010Struct) list.get(i)).getITEM_CD());
		}
		return size;
	}
	public int setL2L_ITEM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_NAME.add(((AE0020010Struct) list.get(i)).getITEM_NAME());
		}
		return size;
	}
	public int setL2L_OD_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OD_TYP.add(((AE0020010Struct) list.get(i)).getOD_TYP());
		}
		return size;
	}
	public int setL2L_ODR_STS_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ODR_STS_TYP.add(((AE0020010Struct) list.get(i)).getODR_STS_TYP());
		}
		return size;
	}
	public int setL2L_DM_STS_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DM_STS_TYP.add(((AE0020010Struct) list.get(i)).getDM_STS_TYP());
		}
		return size;
	}
	public int setL2L_MRP_ODR_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_MRP_ODR_TYP.add(((AE0020010Struct) list.get(i)).getMRP_ODR_TYP());
		}
		return size;
	}
	public int setL2L_MRP_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_MRP_TYP.add(((AE0020010Struct) list.get(i)).getMRP_TYP());
		}
		return size;
	}
	public int setL2L_OUTSIDE_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OUTSIDE_TYP.add(((AE0020010Struct) list.get(i)).getOUTSIDE_TYP());
		}
		return size;
	}
	public int setL2L_JOB_ODR_STS_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_JOB_ODR_STS_TYP.add(((AE0020010Struct) list.get(i)).getJOB_ODR_STS_TYP());
		}
		return size;
	}
	public int setL2L_MANHOUR_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_MANHOUR_TYP.add(((AE0020010Struct) list.get(i)).getMANHOUR_TYP());
		}
		return size;
	}
	public int setL2L_PLANT_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PLANT_CD.add(((AE0020010Struct) list.get(i)).getPLANT_CD());
		}
		return size;
	}
	public int setL2L_JOB_ODR_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_JOB_ODR_CD.add(((AE0020010Struct) list.get(i)).getJOB_ODR_CD());
		}
		return size;
	}
	public int setL2L_JOB_ODR_CANCEL_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_JOB_ODR_CANCEL_NO.add(((AE0020010Struct) list.get(i)).getJOB_ODR_CANCEL_NO());
		}
		return size;
	}
	public int setL2L_JOB_ODR_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_JOB_ODR_TYP.add(((AE0020010Struct) list.get(i)).getJOB_ODR_TYP());
		}
		return size;
	}
	public int setL2L_ALC_GRP_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ALC_GRP_CD.add(((AE0020010Struct) list.get(i)).getALC_GRP_CD());
		}
		return size;
	}
	public int setL2L_DRAW_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DRAW_CD.add(((AE0020010Struct) list.get(i)).getDRAW_CD());
		}
		return size;
	}
	public int setL2L_SPEC(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SPEC.add(((AE0020010Struct) list.get(i)).getSPEC());
		}
		return size;
	}
	public int setL2L_ITEM_SPOIL(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_SPOIL.add(((AE0020010Struct) list.get(i)).getITEM_SPOIL());
		}
		return size;
	}
	public int setL2L_UNIT_QTY_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_UNIT_QTY_TYP.add(((AE0020010Struct) list.get(i)).getUNIT_QTY_TYP());
		}
		return size;
	}
	public int setL2L_JOB_ODR_DLV_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_JOB_ODR_DLV_DATE.add(((AE0020010Struct) list.get(i)).getJOB_ODR_DLV_DATE());
		}
		return size;
	}
	public int setL2L_DUE_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DUE_DATE.add(((AE0020010Struct) list.get(i)).getDUE_DATE());
		}
		return size;
	}
	public int setL2L_PRD_DUE_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PRD_DUE_DATE.add(((AE0020010Struct) list.get(i)).getPRD_DUE_DATE());
		}
		return size;
	}
	public int setL2L_PRD_START_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PRD_START_DATE.add(((AE0020010Struct) list.get(i)).getPRD_START_DATE());
		}
		return size;
	}
	public int setL2L_ODR_START_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ODR_START_DATE.add(((AE0020010Struct) list.get(i)).getODR_START_DATE());
		}
		return size;
	}
	public int setL2L_SUM_PUCH_ODR_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SUM_PUCH_ODR_QTY.add(((AE0020010Struct) list.get(i)).getSUM_PUCH_ODR_QTY());
		}
		return size;
	}
	public int setL2L_SUM_OPR_INST_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SUM_OPR_INST_QTY.add(((AE0020010Struct) list.get(i)).getSUM_OPR_INST_QTY());
		}
		return size;
	}
	public int setL2L_ODR_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ODR_QTY.add(((AE0020010Struct) list.get(i)).getODR_QTY());
		}
		return size;
	}
	public int setL2L_DM_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DM_QTY.add(((AE0020010Struct) list.get(i)).getDM_QTY());
		}
		return size;
	}
	public int setL2L_SUM_ALCD_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SUM_ALCD_QTY.add(((AE0020010Struct) list.get(i)).getSUM_ALCD_QTY());
		}
		return size;
	}
	public int setL2L_STOCK_UNIT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_STOCK_UNIT.add(((AE0020010Struct) list.get(i)).getSTOCK_UNIT());
		}
		return size;
	}
	public int setL2L_PLANT_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PLANT_NAME.add(((AE0020010Struct) list.get(i)).getPLANT_NAME());
		}
		return size;
	}
	...
	/**
	 * medAE0020010クラスの標準コンストラクタ
	 */
	public AE0020010Struct()
	{
	 ...
	 */
	public void setStruct(AE0020010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructM(AE0020010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
			...
			this.setAE0020010tree1(struct.getAE0020010tree1());
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructL(AE0020010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
			...
			this.setList_AE0020010tree1(struct.getList_AE0020010tree1());
...
/*
	...
	// 第 3 変数初期値： i_MRP_ODR_TYP_DN


	final static String i_MRP_ODR_TYP_DN = null;

	// 第 4 変数初期値： i_UNIT_QTY_TYP_DN


	final static String i_UNIT_QTY_TYP_DN = null;

	// 第 5 変数初期値： i_ODR_STS_TYP_DN


	final static String i_ODR_STS_TYP_DN = null;

	// 第 6 変数初期値： i_DM_STS_TYP_DN


	final static String i_DM_STS_TYP_DN = null;

	// 第 7 変数初期値： i_AE0020010tree1


	final static String i_AE0020010tree1 = null;
	...
	// 第 19 変数初期値： i_ODR_STS_TYP


	final static String i_ODR_STS_TYP = null;

	// 第 20 変数初期値： i_DM_STS_TYP
	...
	// 第 24 変数初期値： i_JOB_ODR_STS_TYP


	final static String i_JOB_ODR_STS_TYP = null;

	// 第 25 変数初期値： i_MANHOUR_TYP
...
*/
	...
	// 第 4 変数初期値： i_OD_TYP
	final static String i_OD_TYP = null;
	// 第 5 変数初期値： i_ODR_STS_TYP
	final static String i_ODR_STS_TYP = null;
	// 第 6 変数初期値： i_DM_STS_TYP
	final static String i_DM_STS_TYP = null;
	// 第 7 変数初期値： i_MRP_ODR_TYP
	final static String i_MRP_ODR_TYP = null;
	// 第 8 変数初期値： i_MRP_TYP
	final static String i_MRP_TYP = null;
	// 第 9 変数初期値： i_OUTSIDE_TYP
	final static String i_OUTSIDE_TYP = null;
	// 第 10 変数初期値： i_JOB_ODR_STS_TYP
	final static String i_JOB_ODR_STS_TYP = null;
	...
	final static String i_ODR_START_DATE = null;
	// 第 29 変数初期値： i_SUM_PUCH_ODR_QTY
	final static String i_SUM_PUCH_ODR_QTY = null;
	// 第 30 変数初期値： i_SUM_OPR_INST_QTY
	final static String i_SUM_OPR_INST_QTY = null;
	// 第 31 変数初期値： i_ODR_QTY
	final static String i_ODR_QTY = null;
	// 第 32 変数初期値： i_DM_QTY
	final static String i_DM_QTY = null;
	// 第 33 変数初期値： i_SUM_ALCD_QTY
	final static String i_SUM_ALCD_QTY = null;
	// 第 34 変数初期値： i_ODR_STS_TYP_DN
	final static String i_ODR_STS_TYP_DN = null;
	// 第 35 変数初期値： i_DM_STS_TYP_DN
	final static String i_DM_STS_TYP_DN = null;
	// 第 36 変数初期値： i_STOCK_UNIT
	final static String i_STOCK_UNIT = null;
	// 第 37 変数初期値： i_PLANT_NAME
	final static String i_PLANT_NAME = null;
	// 第 38 変数初期値： i_AE0020010tree1
	final static String i_AE0020010tree1 = null;
	// 第 39 変数初期値： i_id
	final static String i_id = null;
	// 第 40 変数初期値： i_lvl
	...
	public void initialize()
	{
		...
		m_AE0020010tree1 = i_AE0020010tree1;
		m_id = i_id;
		m_lvl = i_lvl;
		m_parent = i_parent;
		m_label = i_label;
