/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0020/src/com/nec/jp/orteus/metamorBase/AE0020/AE0020010Control.java,v $
 *
...
public class AE0020010Control
{
	...
	public int setXMLDoc(Element el, List list, int startId, int lvl, int parentId) throws BusinessProcessException, FoundationException {
		...
		if(el != null && list != null) {
			...
			for(int i=0; i<list.size(); i++, startId++) {
				...
				setStruct2XML(elChild, (AE0020010Struct)list.get(i), startId, lvl, parentId);
				// 作成したエレメントを子供として追加
	...
	public void setStruct2XML(Element el, AE0020010Struct struct, int id, int lvl, int parentId) throws BusinessProcessException, FoundationException {
	...
	public void setStruct2XML(Element el, AE0020010Struct struct, int id) throws BusinessProcessException, FoundationException {
	 ...
	 * @return リストの値
	 */
	public AE0020010Struct getListvalue(int index) {
		return (AE0020010Struct) list.get(index);
	}
	/**
	 * Structを返します。
	 * @return Struct
	 */
	public AE0020010Struct getStruct() {
		return struct;
	}
	/**
	 * 新しいStructを作って返します。
	 * @return 新しいStruct
	 */
	public AE0020010Struct createStruct() {
		return new AE0020010Struct();
	}
	/**
	 * Structをセットします。
	 * @param structName Struct
	 */
	public void setStruct(Object structName) {
		struct.setStruct((AE0020010Struct) structName);
	}
	/**
	 * Structの値を初期化します。
	 */
	...
	private int expandTree(
		...
		AE0020010Struct parentNodeStruct,
		int parentNodeId,
		int compNodeId,
		int maxNodeId,
		int compTreeLevel,
		...
		try {
			// 子ノードの一覧を取得
			AE0020010Struct workStruct = new AE0020010Struct();
			...
			for (int i = 0; i < compNodeListSize; i++) {
				AE0020010Struct compNodeStruct = (AE0020010Struct) compNodeList.get(i);
				// 子ノードを生成、ツリー用XMLに追加
	...
	public void controlSelect() throws BusinessProcessException, FoundationException
	{
		...
		logger.entering("AE0020010Control"+":USER="+struct.getsUser_ID(),"controlSelect");
		...
		try {
			...
			if (plantList.isEmpty()) {
				...
				AE0020010Struct plantStruct = (AE0020010Struct) plantList.get(0);
			...
			AE0020010Struct rootStruct = (AE0020010Struct) rootList.get(0);
			...
			throw new ExpjException(e);
                ...
                //}}user_implement_dev:<controlSelect>
		logger.exiting("AE0020010Control"+":USER="+struct.getsUser_ID(),"controlSelect");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0020");
		logger.entering("AE0020010Control"+":USER="+struct.getsUser_ID(),"controlFlashTree");
		...
		try {
			...
			for(int i=0; i<list.size(); i++, startId++) {
				...
				root.appendChild(el);
				// エレメントに属性を設定
				setStruct2XML(el, (AE0020010Struct)list.get(i), startId);
		...
		*/
                //}}user_implement_dev:<controlFlashTree>
		logger.exiting("AE0020010Control"+":USER="+struct.getsUser_ID(),"controlFlashTree");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0020");
		logger.entering("AE0020010Control"+":USER="+struct.getsUser_ID(),"controlClear");
			//{{user_implement_dev:<controlClear>
		initializeAll();
                //}}user_implement_dev:<controlClear>
		logger.exiting("AE0020010Control"+":USER="+struct.getsUser_ID(),"controlClear");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0020");
		logger.entering("AE0020010Control"+":USER="+struct.getsUser_ID(),"controlShowDetail");
			//{{user_implement_dev:<controlShowDetail>

		try {
			// 選択されたノードを元に詳細情報を取得
			List detailList = entity.mDetail.read(conn, struct);
			AE0020010Struct detailStruct = (AE0020010Struct) detailList.get(0);

			// 詳細情報を設定
			struct.setJOB_ODR_TYP(detailStruct.getJOB_ODR_TYP());
			struct.setJOB_ODR_TYP_DN(multcombo("JOB_ODR_TYP",detailStruct.getJOB_ODR_TYP()));
			...
			struct.setOUTSIDE_TYP_DN(multcombo("OUTSIDE_TYP",detailStruct.getOUTSIDE_TYP()));
			struct.setMRP_ODR_TYP(detailStruct.getMRP_ODR_TYP());
			struct.setMRP_ODR_TYP_DN(multcombo("MRP_ODR_TYP",detailStruct.getMRP_ODR_TYP()));
			struct.setITEM_SPOIL(detailStruct.getITEM_SPOIL());
			struct.setUNIT_QTY_TYP(detailStruct.getUNIT_QTY_TYP());
			struct.setUNIT_QTY_TYP_DN(multcombo("UNIT_QTY_TYP",detailStruct.getUNIT_QTY_TYP()));
			...
			struct.setODR_STS_TYP_DN(multcombo("ODR_STS_TYP",detailStruct.getODR_STS_TYP()));
			struct.setDM_STS_TYP(detailStruct.getDM_STS_TYP());
			struct.setDM_STS_TYP_DN(multcombo("DM_STS_TYP",detailStruct.getDM_STS_TYP()));
			struct.setSTOCK_UNIT(detailStruct.getSTOCK_UNIT());
		} catch (SQLException e) {
			throw new ExpjException(e);
		}
                //}}user_implement_dev:<controlShowDetail>
		logger.exiting("AE0020010Control"+":USER="+struct.getsUser_ID(),"controlShowDetail");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0020");
		logger.entering("AE0020010Control"+":USER="+struct.getsUser_ID(),"controlAddTree");
		...
		try {
			...
			return;
                ...
                //}}user_implement_dev:<controlAddTree>
		logger.exiting("AE0020010Control"+":USER="+struct.getsUser_ID(),"controlAddTree");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0020");
		logger.entering("AE0020010Control"+":USER="+struct.getsUser_ID(),"controlINITIAL");
		//{{user_implement_dev:<controlINITIAL>
		// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<controlINITIAL>
		logger.exiting("AE0020010Control"+":USER="+struct.getsUser_ID(),"controlINITIAL");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0020");
		logger.entering("AE0020010Control"+":USER="+struct.getsUser_ID(),"controlRELOAD");
		...
		if (isScreenMove() == true) {
			...
			//				controlSelect();
                ...
                //}}user_implement_dev:<controlRELOAD>
		logger.exiting("AE0020010Control"+":USER="+struct.getsUser_ID(),"controlRELOAD");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0020");
		logger.entering("AE0020010Control"+":USER="+struct.getsUser_ID(),"controlPREPARATION");
...
//		}
		...
		try {
			...
			throw new ExpjException(e);
                ...
                //}}user_implement_dev:<controlPREPARATION>
		logger.exiting("AE0020010Control"+":USER="+struct.getsUser_ID(),"controlPREPARATION");
...
//			e.printStackTrace();
//			throw new FoundationException("AE0020010Control",e.getMessage(),"control_eventHandllerメソッドでエラーが発生しました。");
	...
	public void createDefaultCSV(List list, String sTitle[]) throws BusinessProcessException, FoundationException {
		...
		//{{user_implement_dev:<createDefaultCSV>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AE0020010-E999","CSVの出力処理"));
			throw new FoundationException("AE0020010Control",e.getMessage(),"createDefaultCSVメソッドでエラーが発生しました。");
		}
...
//				objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AE0020010-E999","システム日付の取得処理"));
				throw new FoundationException("AE0020010Control","beginTransaction()","システム日付取得処理でエラーが発生しました。");
			}
		...
		//{{user_implement_dev:<beginTransaction>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AE0020010-E999","コントロールのイベント処理"));
			throw new FoundationException("AE0020010Control",e.getMessage(),"beginTransactionメソッドでエラーが発生しました。");
		}
	 ...
	 * メンバ変数の定義
	 */
	protected AE0020010Entity entity;
	protected AE0020010Struct struct;
	...
	public void initialize() throws FoundationException
	{
		...
		entity = new AE0020010Entity();
		struct = new AE0020010Struct();
	...
	/**
	 * AE0020010クラスの標準コンストラクタ
	 */
	public AE0020010Control() throws BusinessProcessException, FoundationException
	{
		initialize();
	...
	public void setOrMsgKey(List keyList) throws MessageApiException {
		...
		for (int i = 0; msgKeyTypeArray != null && i < msgKeyTypeArray.size(); i++) {
			...
			for(int j = 0; j < keyList.size(); j++) {
				AE0020010Struct key = (AE0020010Struct)keyList.get(j);
				// メッセージキーを作成する
				...
				if(msgKeyType.containsKeyColumn("AE0020010tree1") && key.getAE0020010tree1() != null) {
					msgKey.setKeyValue("AE0020010tree1", key.getAE0020010tree1());
				}
		...
		try {
			for (int i = 0; msgKeyTypeArray != null && i < msgKeyTypeArray.size(); i++) {
				...
				for (int j = 0; msgKeyArray != null && j < msgKeyArray.size(); j++) {
					...
					AE0020010Struct key = new AE0020010Struct();
					...
					if(msgKeyType.containsKeyColumn("AE0020010tree1")) {
						key.setAE0020010tree1(msgKey.getKeyValue("AE0020010tree1"));
					}
