/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0020/src/com/nec/jp/orteus/metamorBase/AE0020/AE0020020Struct.java,v $
 *
...
public class AE0020020Struct extends DataStruct
{
	...
	/** 第 39 List変数： l_JOB_ODR_CANCEL_NO */
	...
	/** 第 76 List変数： l_PUCH_ODR_PERSON */
	public List l_PUCH_ODR_PERSON = null;

	/** 第 77 List変数： l_USER_NAME */
	...
	public int setL2L_MRP_ODR_TYP_DN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_MRP_ODR_TYP_DN.add(((AE0020020Struct) list.get(i)).getMRP_ODR_TYP_DN());
		}
		return size;
	}
	public int setL2L_OUTSIDE_TYP_DN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OUTSIDE_TYP_DN.add(((AE0020020Struct) list.get(i)).getOUTSIDE_TYP_DN());
		}
		return size;
	}
	public int setL2L_ODR_STS_TYP_DN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ODR_STS_TYP_DN.add(((AE0020020Struct) list.get(i)).getODR_STS_TYP_DN());
		}
		return size;
	}
	public int setL2L_DM_STS_TYP_DN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DM_STS_TYP_DN.add(((AE0020020Struct) list.get(i)).getDM_STS_TYP_DN());
		}
		return size;
	}
	public int setL2L_OUTSIDE_TYP_name(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OUTSIDE_TYP_name.add(((AE0020020Struct) list.get(i)).getOUTSIDE_TYP_name());
		}
		return size;
	}
	public int setL2L_OUTSIDE_TYP_val(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OUTSIDE_TYP_val.add(((AE0020020Struct) list.get(i)).getOUTSIDE_TYP_val());
		}
		return size;
	}
	public int setL2L_h_OUTSIDE_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_h_OUTSIDE_TYP.add(((AE0020020Struct) list.get(i)).geth_OUTSIDE_TYP());
		}
		return size;
	}
	public int setL2L_SPL_ITEM_TYP_name(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SPL_ITEM_TYP_name.add(((AE0020020Struct) list.get(i)).getSPL_ITEM_TYP_name());
		}
		return size;
	}
	public int setL2L_SPL_ITEM_TYP_val(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SPL_ITEM_TYP_val.add(((AE0020020Struct) list.get(i)).getSPL_ITEM_TYP_val());
		}
		return size;
	}
	public int setL2L_h_SPL_ITEM_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_h_SPL_ITEM_TYP.add(((AE0020020Struct) list.get(i)).geth_SPL_ITEM_TYP());
		}
		return size;
	}
	public int setL2L_UNIT_COST_TYP_name(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_UNIT_COST_TYP_name.add(((AE0020020Struct) list.get(i)).getUNIT_COST_TYP_name());
		}
		return size;
	}
	public int setL2L_UNIT_COST_TYP_val(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_UNIT_COST_TYP_val.add(((AE0020020Struct) list.get(i)).getUNIT_COST_TYP_val());
		}
		return size;
	}
	public int setL2L_HOME_CUR_UNIT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_HOME_CUR_UNIT.add(((AE0020020Struct) list.get(i)).getHOME_CUR_UNIT());
		}
		return size;
	}
	public int setL2L_JOB_ODR_TYP_DN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_JOB_ODR_TYP_DN.add(((AE0020020Struct) list.get(i)).getJOB_ODR_TYP_DN());
		}
		return size;
	}
	public int setL2L_UNIT_QTY_TYP_DN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_UNIT_QTY_TYP_DN.add(((AE0020020Struct) list.get(i)).getUNIT_QTY_TYP_DN());
		}
		return size;
	}
	public int setL2L_SelectUnitCostFlag(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SelectUnitCostFlag.add(((AE0020020Struct) list.get(i)).getSelectUnitCostFlag());
		}
		return size;
	}
	public int setL2L_PRODUCT_TYP_DN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PRODUCT_TYP_DN.add(((AE0020020Struct) list.get(i)).getPRODUCT_TYP_DN());
		}
		return size;
	}
	public int setL2L_h_PUCH_ODR_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_h_PUCH_ODR_QTY.add(((AE0020020Struct) list.get(i)).geth_PUCH_ODR_QTY());
		}
		return size;
	}
	public int setL2L_HOME_DECIMAL_FIG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_HOME_DECIMAL_FIG.add(((AE0020020Struct) list.get(i)).getHOME_DECIMAL_FIG());
		}
		return size;
	}
	public int setL2L_l_PUCH_ODR_START_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_PUCH_ODR_START_DATE.add(((AE0020020Struct) list.get(i)).getl_PUCH_ODR_START_DATE());
		}
		return size;
	}
	public int setL2L_l_PUCH_ODR_DLV_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_PUCH_ODR_DLV_DATE.add(((AE0020020Struct) list.get(i)).getl_PUCH_ODR_DLV_DATE());
		}
		return size;
	}
	public int setL2L_l_PUCH_ODR_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_PUCH_ODR_QTY.add(((AE0020020Struct) list.get(i)).getl_PUCH_ODR_QTY());
		}
		return size;
	}
	public int setL2L_l_STOCK_UNIT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_STOCK_UNIT.add(((AE0020020Struct) list.get(i)).getl_STOCK_UNIT());
		}
		return size;
	}
	public int setL2L_l_UNIT_COST(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_UNIT_COST.add(((AE0020020Struct) list.get(i)).getl_UNIT_COST());
		}
		return size;
	}
	public int setL2L_l_UNIT_COST_TYP_DN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_UNIT_COST_TYP_DN.add(((AE0020020Struct) list.get(i)).getl_UNIT_COST_TYP_DN());
		}
		return size;
	}
	public int setL2L_l_PUCH_ODR_AMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_PUCH_ODR_AMOUNT.add(((AE0020020Struct) list.get(i)).getl_PUCH_ODR_AMOUNT());
		}
		return size;
	}
	public int setL2L_l_CUR_UNIT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_CUR_UNIT.add(((AE0020020Struct) list.get(i)).getl_CUR_UNIT());
		}
		return size;
	}
	public int setL2L_l_VEND_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_VEND_CD.add(((AE0020020Struct) list.get(i)).getl_VEND_CD());
		}
		return size;
	}
	public int setL2L_l_VEND_ANAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_VEND_ANAME.add(((AE0020020Struct) list.get(i)).getl_VEND_ANAME());
		}
		return size;
	}
	public int setL2L_l_WH_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_WH_CD.add(((AE0020020Struct) list.get(i)).getl_WH_CD());
		}
		return size;
	}
	public int setL2L_l_WH_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_WH_NAME.add(((AE0020020Struct) list.get(i)).getl_WH_NAME());
		}
		return size;
	}
	public int setL2L_l_PUCH_ODR_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_PUCH_ODR_CD.add(((AE0020020Struct) list.get(i)).getl_PUCH_ODR_CD());
		}
		return size;
	}
	public int setL2L_l_MODIFY_COUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_MODIFY_COUNT.add(((AE0020020Struct) list.get(i)).getl_MODIFY_COUNT());
		}
		return size;
	}
	public int setL2L_l_PUCH_ODR_STS_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_PUCH_ODR_STS_TYP.add(((AE0020020Struct) list.get(i)).getl_PUCH_ODR_STS_TYP());
		}
		return size;
	}
	public int setL2L_OD_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OD_NO.add(((AE0020020Struct) list.get(i)).getOD_NO());
		}
		return size;
	}
	public int setL2L_PLANT_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PLANT_CD.add(((AE0020020Struct) list.get(i)).getPLANT_CD());
		}
		return size;
	}
	public int setL2L_PLANT_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PLANT_NAME.add(((AE0020020Struct) list.get(i)).getPLANT_NAME());
		}
		return size;
	}
	public int setL2L_JOB_ODR_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_JOB_ODR_CD.add(((AE0020020Struct) list.get(i)).getJOB_ODR_CD());
		}
		return size;
	}
	public int setL2L_JOB_ODR_CANCEL_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_JOB_ODR_CANCEL_NO.add(((AE0020020Struct) list.get(i)).getJOB_ODR_CANCEL_NO());
		}
		return size;
	}
	public int setL2L_JOB_ODR_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_JOB_ODR_TYP.add(((AE0020020Struct) list.get(i)).getJOB_ODR_TYP());
		}
		return size;
	}
	public int setL2L_ALC_GRP_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ALC_GRP_CD.add(((AE0020020Struct) list.get(i)).getALC_GRP_CD());
		}
		return size;
	}
	public int setL2L_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_CD.add(((AE0020020Struct) list.get(i)).getITEM_CD());
		}
		return size;
	}
	public int setL2L_ITEM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_NAME.add(((AE0020020Struct) list.get(i)).getITEM_NAME());
		}
		return size;
	}
	public int setL2L_DRAW_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DRAW_CD.add(((AE0020020Struct) list.get(i)).getDRAW_CD());
		}
		return size;
	}
	public int setL2L_SPEC(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SPEC.add(((AE0020020Struct) list.get(i)).getSPEC());
		}
		return size;
	}
	public int setL2L_OUTSIDE_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OUTSIDE_TYP.add(((AE0020020Struct) list.get(i)).getOUTSIDE_TYP());
		}
		return size;
	}
	public int setL2L_MRP_ODR_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_MRP_ODR_TYP.add(((AE0020020Struct) list.get(i)).getMRP_ODR_TYP());
		}
		return size;
	}
	public int setL2L_ITEM_SPOIL(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_SPOIL.add(((AE0020020Struct) list.get(i)).getITEM_SPOIL());
		}
		return size;
	}
	public int setL2L_UNIT_QTY_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_UNIT_QTY_TYP.add(((AE0020020Struct) list.get(i)).getUNIT_QTY_TYP());
		}
		return size;
	}
	public int setL2L_JOB_ODR_DLV_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_JOB_ODR_DLV_DATE.add(((AE0020020Struct) list.get(i)).getJOB_ODR_DLV_DATE());
		}
		return size;
	}
	public int setL2L_DUE_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DUE_DATE.add(((AE0020020Struct) list.get(i)).getDUE_DATE());
		}
		return size;
	}
	public int setL2L_PRD_DUE_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PRD_DUE_DATE.add(((AE0020020Struct) list.get(i)).getPRD_DUE_DATE());
		}
		return size;
	}
	public int setL2L_PRD_START_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PRD_START_DATE.add(((AE0020020Struct) list.get(i)).getPRD_START_DATE());
		}
		return size;
	}
	public int setL2L_ODR_START_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ODR_START_DATE.add(((AE0020020Struct) list.get(i)).getODR_START_DATE());
		}
		return size;
	}
	public int setL2L_SUM_PUCH_ODR_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SUM_PUCH_ODR_QTY.add(((AE0020020Struct) list.get(i)).getSUM_PUCH_ODR_QTY());
		}
		return size;
	}
	public int setL2L_SUM_OPR_INST_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SUM_OPR_INST_QTY.add(((AE0020020Struct) list.get(i)).getSUM_OPR_INST_QTY());
		}
		return size;
	}
	public int setL2L_ODR_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ODR_QTY.add(((AE0020020Struct) list.get(i)).getODR_QTY());
		}
		return size;
	}
	public int setL2L_DM_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DM_QTY.add(((AE0020020Struct) list.get(i)).getDM_QTY());
		}
		return size;
	}
	public int setL2L_SUM_ALCD_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SUM_ALCD_QTY.add(((AE0020020Struct) list.get(i)).getSUM_ALCD_QTY());
		}
		return size;
	}
	public int setL2L_ODR_STS_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ODR_STS_TYP.add(((AE0020020Struct) list.get(i)).getODR_STS_TYP());
		}
		return size;
	}
	public int setL2L_DM_STS_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DM_STS_TYP.add(((AE0020020Struct) list.get(i)).getDM_STS_TYP());
		}
		return size;
	}
	public int setL2L_STOCK_UNIT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_STOCK_UNIT.add(((AE0020020Struct) list.get(i)).getSTOCK_UNIT());
		}
		return size;
	}
	public int setL2L_NON_NO_ITEM_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_NON_NO_ITEM_FLG.add(((AE0020020Struct) list.get(i)).getNON_NO_ITEM_FLG());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_CD.add(((AE0020020Struct) list.get(i)).getPUCH_ODR_CD());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_START_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_START_DATE.add(((AE0020020Struct) list.get(i)).getPUCH_ODR_START_DATE());
		}
		return size;
	}
	public int setL2L_CONFIRM_DLV_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CONFIRM_DLV_DATE.add(((AE0020020Struct) list.get(i)).getCONFIRM_DLV_DATE());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_DLV_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_DLV_DATE.add(((AE0020020Struct) list.get(i)).getPUCH_ODR_DLV_DATE());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_START_TIME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_START_TIME.add(((AE0020020Struct) list.get(i)).getPUCH_ODR_START_TIME());
		}
		return size;
	}
	public int setL2L_CONFIRM_DLV_TIME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CONFIRM_DLV_TIME.add(((AE0020020Struct) list.get(i)).getCONFIRM_DLV_TIME());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_DLV_TIME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_DLV_TIME.add(((AE0020020Struct) list.get(i)).getPUCH_ODR_DLV_TIME());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_QTY.add(((AE0020020Struct) list.get(i)).getPUCH_ODR_QTY());
		}
		return size;
	}
	public int setL2L_VEND_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_VEND_CD.add(((AE0020020Struct) list.get(i)).getVEND_CD());
		}
		return size;
	}
	public int setL2L_VEND_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_VEND_NAME.add(((AE0020020Struct) list.get(i)).getVEND_NAME());
		}
		return size;
	}
	public int setL2L_WH_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_WH_CD.add(((AE0020020Struct) list.get(i)).getWH_CD());
		}
		return size;
	}
	public int setL2L_WH_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_WH_NAME.add(((AE0020020Struct) list.get(i)).getWH_NAME());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_PERSON(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_PERSON.add(((AE0020020Struct) list.get(i)).getPUCH_ODR_PERSON());
		}
		return size;
	}
	public int setL2L_USER_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_USER_NAME.add(((AE0020020Struct) list.get(i)).getUSER_NAME());
		}
		return size;
	}
	public int setL2L_SPL_ITEM_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SPL_ITEM_TYP.add(((AE0020020Struct) list.get(i)).getSPL_ITEM_TYP());
		}
		return size;
	}
	public int setL2L_PRODUCT_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PRODUCT_TYP.add(((AE0020020Struct) list.get(i)).getPRODUCT_TYP());
		}
		return size;
	}
	public int setL2L_UNIT_COST_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_UNIT_COST_TYP.add(((AE0020020Struct) list.get(i)).getUNIT_COST_TYP());
		}
		return size;
	}
	public int setL2L_UNIT_COST(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_UNIT_COST.add(((AE0020020Struct) list.get(i)).getUNIT_COST());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_AMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_AMOUNT.add(((AE0020020Struct) list.get(i)).getPUCH_ODR_AMOUNT());
		}
		return size;
	}
	public int setL2L_AMOUNT_INCLUDE_TAX(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_AMOUNT_INCLUDE_TAX.add(((AE0020020Struct) list.get(i)).getAMOUNT_INCLUDE_TAX());
		}
		return size;
	}
	public int setL2L_NET_AMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_NET_AMOUNT.add(((AE0020020Struct) list.get(i)).getNET_AMOUNT());
		}
		return size;
	}
	public int setL2L_DISC_AMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DISC_AMOUNT.add(((AE0020020Struct) list.get(i)).getDISC_AMOUNT());
		}
		return size;
	}
	public int setL2L_TAX_RATE_1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_RATE_1.add(((AE0020020Struct) list.get(i)).getTAX_RATE_1());
		}
		return size;
	}
	public int setL2L_TAX_RATE_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_RATE_2.add(((AE0020020Struct) list.get(i)).getTAX_RATE_2());
		}
		return size;
	}
	public int setL2L_TAX_RATE_3(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_RATE_3.add(((AE0020020Struct) list.get(i)).getTAX_RATE_3());
		}
		return size;
	}
	public int setL2L_TAX_AMOUNT_1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_AMOUNT_1.add(((AE0020020Struct) list.get(i)).getTAX_AMOUNT_1());
		}
		return size;
	}
	public int setL2L_TAX_AMOUNT_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_AMOUNT_2.add(((AE0020020Struct) list.get(i)).getTAX_AMOUNT_2());
		}
		return size;
	}
	public int setL2L_TAX_AMOUNT_3(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_AMOUNT_3.add(((AE0020020Struct) list.get(i)).getTAX_AMOUNT_3());
		}
		return size;
	}
	public int setL2L_PROCESSING_COST(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROCESSING_COST.add(((AE0020020Struct) list.get(i)).getPROCESSING_COST());
		}
		return size;
	}
	public int setL2L_MATERIAL_COST(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_MATERIAL_COST.add(((AE0020020Struct) list.get(i)).getMATERIAL_COST());
		}
		return size;
	}
	public int setL2L_OTHER_OVERHEADS(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OTHER_OVERHEADS.add(((AE0020020Struct) list.get(i)).getOTHER_OVERHEADS());
		}
		return size;
	}
	public int setL2L_HOME_CUR_AMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_HOME_CUR_AMOUNT.add(((AE0020020Struct) list.get(i)).getHOME_CUR_AMOUNT());
		}
		return size;
	}
	public int setL2L_EXCH_RATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_EXCH_RATE.add(((AE0020020Struct) list.get(i)).getEXCH_RATE());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_COMMENT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_COMMENT.add(((AE0020020Struct) list.get(i)).getPUCH_ODR_COMMENT());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_STS_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_STS_TYP.add(((AE0020020Struct) list.get(i)).getPUCH_ODR_STS_TYP());
		}
		return size;
	}
	public int setL2L_INV_CTRL_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_INV_CTRL_FLG.add(((AE0020020Struct) list.get(i)).getINV_CTRL_FLG());
		}
		return size;
	}
	public int setL2L_TAX_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_CD.add(((AE0020020Struct) list.get(i)).getTAX_CD());
		}
		return size;
	}
	public int setL2L_TAX_ROUND_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_ROUND_TYP.add(((AE0020020Struct) list.get(i)).getTAX_ROUND_TYP());
		}
		return size;
	}
	public int setL2L_ROUND_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ROUND_TYP.add(((AE0020020Struct) list.get(i)).getROUND_TYP());
		}
		return size;
	}
	public int setL2L_MODIFY_COUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_MODIFY_COUNT.add(((AE0020020Struct) list.get(i)).getMODIFY_COUNT());
		}
		return size;
	}
	public int setL2L_CUR_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUR_CD.add(((AE0020020Struct) list.get(i)).getCUR_CD());
		}
		return size;
	}
	public int setL2L_CUR_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUR_NAME.add(((AE0020020Struct) list.get(i)).getCUR_NAME());
		}
		return size;
	}
	public int setL2L_VEND_CUR_UNIT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_VEND_CUR_UNIT.add(((AE0020020Struct) list.get(i)).getVEND_CUR_UNIT());
		}
		return size;
	}
	public int setL2L_VEND_DECIMAL_FIG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_VEND_DECIMAL_FIG.add(((AE0020020Struct) list.get(i)).getVEND_DECIMAL_FIG());
		}
		return size;
	}
	public int setL2L_CONFIRM_DLV_DATE_COMMENT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CONFIRM_DLV_DATE_COMMENT.add(((AE0020020Struct) list.get(i)).getCONFIRM_DLV_DATE_COMMENT());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_START_DATE_ALL(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_START_DATE_ALL.add(((AE0020020Struct) list.get(i)).getPUCH_ODR_START_DATE_ALL());
		}
		return size;
	}
	public int setL2L_CONFIRM_DLV_DATE_ALL(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CONFIRM_DLV_DATE_ALL.add(((AE0020020Struct) list.get(i)).getCONFIRM_DLV_DATE_ALL());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_DLV_DATE_ALL(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_DLV_DATE_ALL.add(((AE0020020Struct) list.get(i)).getPUCH_ODR_DLV_DATE_ALL());
		}
		return size;
	}
	public int setL2L_COMPANY_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_COMPANY_CD.add(((AE0020020Struct) list.get(i)).getCOMPANY_CD());
		}
		return size;
	}
	public int setL2L_ACPT_INSPC_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ACPT_INSPC_TYP.add(((AE0020020Struct) list.get(i)).getACPT_INSPC_TYP());
		}
		return size;
	}
	public int setL2L_OPR_RSLT_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OPR_RSLT_TYP.add(((AE0020020Struct) list.get(i)).getOPR_RSLT_TYP());
		}
		return size;
	}
	public int setL2L_FIXED_LT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_FIXED_LT.add(((AE0020020Struct) list.get(i)).getFIXED_LT());
		}
		return size;
	}
	public int setL2L_PROP_LT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROP_LT.add(((AE0020020Struct) list.get(i)).getPROP_LT());
		}
		return size;
	}
	public int setL2L_SAFETY_LT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SAFETY_LT.add(((AE0020020Struct) list.get(i)).getSAFETY_LT());
		}
		return size;
	}
	public int setL2L_PROP_LOT_SIZE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROP_LOT_SIZE.add(((AE0020020Struct) list.get(i)).getPROP_LOT_SIZE());
		}
		return size;
	}
	public int setL2L_DEAL_STS_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DEAL_STS_FLG.add(((AE0020020Struct) list.get(i)).getDEAL_STS_FLG());
		}
		return size;
	}
	public int setL2L_ODR_START_TIME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ODR_START_TIME.add(((AE0020020Struct) list.get(i)).getODR_START_TIME());
		}
		return size;
	}
	public int setL2L_WS_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_WS_CD.add(((AE0020020Struct) list.get(i)).getWS_CD());
		}
		return size;
	}
	public int setL2L_OPR_INST_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OPR_INST_CD.add(((AE0020020Struct) list.get(i)).getOPR_INST_CD());
		}
		return size;
	}
	public int setL2L_WORK_ODR_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_WORK_ODR_CD.add(((AE0020020Struct) list.get(i)).getWORK_ODR_CD());
		}
		return size;
	}
	public int setL2L_TIME_CTRL(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TIME_CTRL.add(((AE0020020Struct) list.get(i)).getTIME_CTRL());
		}
		return size;
	}
	public int setL2L_PVC2LOGMODE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PVC2LOGMODE.add(((AE0020020Struct) list.get(i)).getPVC2LOGMODE());
		}
		return size;
	}
	public int setL2L_PVC2OUTPUTMODE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PVC2OUTPUTMODE.add(((AE0020020Struct) list.get(i)).getPVC2OUTPUTMODE());
		}
		return size;
	}
	public int setL2L_PVC2OUTPUTPATH(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PVC2OUTPUTPATH.add(((AE0020020Struct) list.get(i)).getPVC2OUTPUTPATH());
		}
		return size;
	}
	public int setL2L_PVC2OUTPUTNAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PVC2OUTPUTNAME.add(((AE0020020Struct) list.get(i)).getPVC2OUTPUTNAME());
		}
		return size;
	}
	public int setL2L_PVC2USERID(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PVC2USERID.add(((AE0020020Struct) list.get(i)).getPVC2USERID());
		}
		return size;
	}
	public int setL2L_PVC2BUSINESSNAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PVC2BUSINESSNAME.add(((AE0020020Struct) list.get(i)).getPVC2BUSINESSNAME());
		}
		return size;
	}
	public int setL2L_PVC2PLANTCD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PVC2PLANTCD.add(((AE0020020Struct) list.get(i)).getPVC2PLANTCD());
		}
		return size;
	}
	public int setL2L_PVC2TAXID(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PVC2TAXID.add(((AE0020020Struct) list.get(i)).getPVC2TAXID());
		}
		return size;
	}
	public int setL2L_PNUMTAXOUTAMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PNUMTAXOUTAMOUNT.add(((AE0020020Struct) list.get(i)).getPNUMTAXOUTAMOUNT());
		}
		return size;
	}
	public int setL2L_PNUMTAXAMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PNUMTAXAMOUNT.add(((AE0020020Struct) list.get(i)).getPNUMTAXAMOUNT());
		}
		return size;
	}
	public int setL2L_PNUMEXTERNALTAXSALESAMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PNUMEXTERNALTAXSALESAMOUNT.add(((AE0020020Struct) list.get(i)).getPNUMEXTERNALTAXSALESAMOUNT());
		}
		return size;
	}
	public int setL2L_PNUMINTERNALTAXSALESAMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PNUMINTERNALTAXSALESAMOUNT.add(((AE0020020Struct) list.get(i)).getPNUMINTERNALTAXSALESAMOUNT());
		}
		return size;
	}
	public int setL2L_PNUMTAXFREESALESAMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PNUMTAXFREESALESAMOUNT.add(((AE0020020Struct) list.get(i)).getPNUMTAXFREESALESAMOUNT());
		}
		return size;
	}
	public int setL2L_PNUMEXTERNALTAXAMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PNUMEXTERNALTAXAMOUNT.add(((AE0020020Struct) list.get(i)).getPNUMEXTERNALTAXAMOUNT());
		}
		return size;
	}
	public int setL2L_PNUMINTERNALTAXAMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PNUMINTERNALTAXAMOUNT.add(((AE0020020Struct) list.get(i)).getPNUMINTERNALTAXAMOUNT());
		}
		return size;
	}
	public int setL2L_PVC2ERRCD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PVC2ERRCD.add(((AE0020020Struct) list.get(i)).getPVC2ERRCD());
		}
		return size;
	}
	public int setL2L_PNUMSTATUS(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PNUMSTATUS.add(((AE0020020Struct) list.get(i)).getPNUMSTATUS());
		}
		return size;
	}
	public int setL2L_l_COUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_COUNT.add(((AE0020020Struct) list.get(i)).getl_COUNT());
		}
		return size;
	}
	public int setL2L_ROW_COUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ROW_COUNT.add(((AE0020020Struct) list.get(i)).getROW_COUNT());
		}
		return size;
	}
	...
	/**
	 * medAE0020020クラスの標準コンストラクタ
	 */
	public AE0020020Struct()
	{
	 ...
	 */
	public void setStruct(AE0020020Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructM(AE0020020Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructL(AE0020020Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
...
/*
	...
	// 第 34 変数初期値： i_l_PUCH_ODR_STS_TYP
	...
	// 第 39 変数初期値： i_JOB_ODR_CANCEL_NO
	...
	// 第 76 変数初期値： i_PUCH_ODR_PERSON


	final static String i_PUCH_ODR_PERSON = null;

	// 第 77 変数初期値： i_USER_NAME
...
*/
	...
	final static String i_l_PUCH_ODR_DLV_DATE = null;
	// 第 3 変数初期値： i_l_PUCH_ODR_QTY
	final static String i_l_PUCH_ODR_QTY = null;
	// 第 4 変数初期値： i_l_STOCK_UNIT
	final static String i_l_STOCK_UNIT = null;
	// 第 5 変数初期値： i_l_UNIT_COST
	final static String i_l_UNIT_COST = null;
	// 第 6 変数初期値： i_l_UNIT_COST_TYP_DN
	final static String i_l_UNIT_COST_TYP_DN = null;
	// 第 7 変数初期値： i_l_PUCH_ODR_AMOUNT
	final static String i_l_PUCH_ODR_AMOUNT = null;
	// 第 8 変数初期値： i_l_VEND_CD
	final static String i_l_VEND_CD = null;
	// 第 9 変数初期値： i_l_VEND_ANAME
	final static String i_l_VEND_ANAME = null;
	// 第 10 変数初期値： i_l_WH_CD
	final static String i_l_WH_CD = null;
	// 第 11 変数初期値： i_l_WH_NAME
	final static String i_l_WH_NAME = null;
	...
	final static String i_JOB_ODR_CD = null;
	// 第 16 変数初期値： i_JOB_ODR_CANCEL_NO
	final static String i_JOB_ODR_CANCEL_NO = null;
	// 第 17 変数初期値： i_ITEM_CD
	final static String i_ITEM_CD = null;
	// 第 18 変数初期値： i_JOB_ODR_TYP
	final static String i_JOB_ODR_TYP = null;
	// 第 19 変数初期値： i_JOB_ODR_TYP_DN
	final static String i_JOB_ODR_TYP_DN = null;
	// 第 20 変数初期値： i_ALC_GRP_CD
	final static String i_ALC_GRP_CD = null;
	...
	final static String i_OUTSIDE_TYP = null;
	// 第 25 変数初期値： i_OUTSIDE_TYP_DN
	final static String i_OUTSIDE_TYP_DN = null;
	// 第 26 変数初期値： i_MRP_ODR_TYP
	final static String i_MRP_ODR_TYP = null;
	// 第 27 変数初期値： i_MRP_ODR_TYP_DN
	final static String i_MRP_ODR_TYP_DN = null;
	// 第 28 変数初期値： i_ITEM_SPOIL
	final static String i_ITEM_SPOIL = null;
	// 第 29 変数初期値： i_UNIT_QTY_TYP
	final static String i_UNIT_QTY_TYP = null;
	// 第 30 変数初期値： i_UNIT_QTY_TYP_DN
	final static String i_UNIT_QTY_TYP_DN = null;
	// 第 31 変数初期値： i_JOB_ODR_DLV_DATE
	final static String i_JOB_ODR_DLV_DATE = null;
	// 第 32 変数初期値： i_DUE_DATE
	final static String i_DUE_DATE = null;
	// 第 33 変数初期値： i_PRD_DUE_DATE
	final static String i_PRD_DUE_DATE = null;
	// 第 34 変数初期値： i_PRD_START_DATE
	final static String i_PRD_START_DATE = null;
	// 第 35 変数初期値： i_ODR_START_DATE
	final static String i_ODR_START_DATE = null;
	// 第 36 変数初期値： i_SUM_PUCH_ODR_QTY
	final static String i_SUM_PUCH_ODR_QTY = null;
	// 第 37 変数初期値： i_SUM_OPR_INST_QTY
	final static String i_SUM_OPR_INST_QTY = null;
	// 第 38 変数初期値： i_ODR_QTY
	final static String i_ODR_QTY = null;
	// 第 39 変数初期値： i_DM_QTY
	final static String i_DM_QTY = null;
	// 第 40 変数初期値： i_SUM_ALCD_QTY
	final static String i_SUM_ALCD_QTY = null;
	// 第 41 変数初期値： i_ODR_STS_TYP
	final static String i_ODR_STS_TYP = null;
	// 第 42 変数初期値： i_ODR_STS_TYP_DN
	final static String i_ODR_STS_TYP_DN = null;
	// 第 43 変数初期値： i_DM_STS_TYP
	final static String i_DM_STS_TYP = null;
	// 第 44 変数初期値： i_DM_STS_TYP_DN
	final static String i_DM_STS_TYP_DN = null;
	// 第 45 変数初期値： i_STOCK_UNIT
	final static String i_STOCK_UNIT = null;
	// 第 46 変数初期値： i_PLANT_NAME
	final static String i_PLANT_NAME = null;
	// 第 47 変数初期値： i_NON_NO_ITEM_FLG
	final static String i_NON_NO_ITEM_FLG = null;
	// 第 48 変数初期値： i_PUCH_ODR_CD
	final static String i_PUCH_ODR_CD = null;
	// 第 49 変数初期値： i_PUCH_ODR_START_DATE
	final static String i_PUCH_ODR_START_DATE = null;
	// 第 50 変数初期値： i_CONFIRM_DLV_DATE
	final static String i_CONFIRM_DLV_DATE = null;
	// 第 51 変数初期値： i_PUCH_ODR_DLV_DATE
	final static String i_PUCH_ODR_DLV_DATE = null;
	// 第 52 変数初期値： i_PUCH_ODR_QTY
	final static String i_PUCH_ODR_QTY = null;
	// 第 53 変数初期値： i_VEND_CD
	final static String i_VEND_CD = null;
	// 第 54 変数初期値： i_VEND_NAME
	final static String i_VEND_NAME = null;
	// 第 55 変数初期値： i_WH_CD
	final static String i_WH_CD = null;
	// 第 56 変数初期値： i_WH_NAME
	final static String i_WH_NAME = null;
	// 第 57 変数初期値： i_PUCH_ODR_PERSON
	final static String i_PUCH_ODR_PERSON = null;
	...
	final static String i_PRODUCT_TYP = null;
	// 第 61 変数初期値： i_UNIT_COST_TYP
	final static String i_UNIT_COST_TYP = null;
	// 第 62 変数初期値： i_UNIT_COST
	final static String i_UNIT_COST = null;
	...
	final static String i_NET_AMOUNT = null;
	// 第 66 変数初期値： i_DISC_AMOUNT
	final static String i_DISC_AMOUNT = null;
	// 第 67 変数初期値： i_TAX_RATE_1
	final static String i_TAX_RATE_1 = null;
	// 第 68 変数初期値： i_TAX_RATE_2
	final static String i_TAX_RATE_2 = null;
	// 第 69 変数初期値： i_TAX_RATE_3
	final static String i_TAX_RATE_3 = null;
	...
	final static String i_TAX_AMOUNT_3 = null;
	// 第 73 変数初期値： i_PROCESSING_COST
	final static String i_PROCESSING_COST = null;
	// 第 74 変数初期値： i_MATERIAL_COST
	final static String i_MATERIAL_COST = null;
	// 第 75 変数初期値： i_OTHER_OVERHEADS
	final static String i_OTHER_OVERHEADS = null;
	// 第 76 変数初期値： i_HOME_CUR_AMOUNT
	final static String i_HOME_CUR_AMOUNT = null;
	// 第 77 変数初期値： i_EXCH_RATE
	final static String i_EXCH_RATE = null;
	// 第 78 変数初期値： i_PUCH_ODR_COMMENT
	final static String i_PUCH_ODR_COMMENT = null;
	// 第 79 変数初期値： i_PUCH_ODR_STS_TYP
	final static String i_PUCH_ODR_STS_TYP = null;
	// 第 80 変数初期値： i_INV_CTRL_FLG
	final static String i_INV_CTRL_FLG = null;
	// 第 81 変数初期値： i_OD_NO
	final static String i_OD_NO = null;
	// 第 82 変数初期値： i_TAX_CD
	final static String i_TAX_CD = null;
	// 第 83 変数初期値： i_TAX_ROUND_TYP
	final static String i_TAX_ROUND_TYP = null;
	// 第 84 変数初期値： i_ROUND_TYP
	final static String i_ROUND_TYP = null;
	// 第 85 変数初期値： i_MODIFY_COUNT
	final static String i_MODIFY_COUNT = null;
	// 第 86 変数初期値： i_CUR_CD
	final static String i_CUR_CD = null;
	// 第 87 変数初期値： i_CUR_NAME
	final static String i_CUR_NAME = null;
	// 第 88 変数初期値： i_VEND_CUR_UNIT
	final static String i_VEND_CUR_UNIT = null;
	// 第 89 変数初期値： i_VEND_DECIMAL_FIG
	final static String i_VEND_DECIMAL_FIG = null;
	// 第 90 変数初期値： i_COMPANY_CD
	final static String i_COMPANY_CD = null;
	// 第 91 変数初期値： i_ACPT_INSPC_TYP
	final static String i_ACPT_INSPC_TYP = null;
	// 第 92 変数初期値： i_OPR_RSLT_TYP
	final static String i_OPR_RSLT_TYP = null;
	// 第 93 変数初期値： i_DEAL_STS_FLG
	final static String i_DEAL_STS_FLG = null;
	// 第 94 変数初期値： i_WS_CD
	final static String i_WS_CD = null;
	// 第 95 変数初期値： i_OPR_INST_CD
	final static String i_OPR_INST_CD = null;
	// 第 96 変数初期値： i_WORK_ODR_CD
	final static String i_WORK_ODR_CD = null;
	// 第 97 変数初期値： i_OUTSIDE_TYP_name
	final static String i_OUTSIDE_TYP_name = null;
	// 第 98 変数初期値： i_OUTSIDE_TYP_val
	final static String i_OUTSIDE_TYP_val = null;
	// 第 99 変数初期値： i_h_OUTSIDE_TYP
	final static String i_h_OUTSIDE_TYP = null;
	// 第 100 変数初期値： i_SPL_ITEM_TYP_name
	final static String i_SPL_ITEM_TYP_name = null;
	// 第 101 変数初期値： i_SPL_ITEM_TYP_val
	final static String i_SPL_ITEM_TYP_val = null;
	// 第 102 変数初期値： i_h_SPL_ITEM_TYP
	final static String i_h_SPL_ITEM_TYP = null;
	// 第 103 変数初期値： i_UNIT_COST_TYP_name
	final static String i_UNIT_COST_TYP_name = null;
	// 第 104 変数初期値： i_UNIT_COST_TYP_val
	final static String i_UNIT_COST_TYP_val = null;
	// 第 105 変数初期値： i_TAX_NAME_1
	final static String i_TAX_NAME_1 = null;
	// 第 106 変数初期値： i_TAX_NAME_2
	final static String i_TAX_NAME_2 = null;
	// 第 107 変数初期値： i_TAX_NAME_3
	final static String i_TAX_NAME_3 = null;
	// 第 108 変数初期値： i_HOME_CUR_UNIT
	final static String i_HOME_CUR_UNIT = null;
	// 第 109 変数初期値： i_SelectUnitCostFlag
	final static String i_SelectUnitCostFlag = null;
