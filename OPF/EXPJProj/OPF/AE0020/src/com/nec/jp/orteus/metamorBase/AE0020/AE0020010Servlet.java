/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0020/src/com/nec/jp/orteus/metamorBase/AE0020/AE0020010Servlet.java,v $
 *
...
public class AE0020010Servlet extends HttpServlet
{
	 ...
	 * @param control AE0020010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AE0020010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AE0020010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AE0020010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AE0020010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AE0020010Entity entity = control.entity;
		AE0020010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AE0020010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
			// TODO: ユーザ定義のコードを記述してください
			//			objMessage.m_writer.write( Level.ALL, "AE0020010"+" $Revision: 1.15 $" );
			control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AE0020010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AE0020010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AE0020010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0020");
		logger.entering("AE0020010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
		...
		try {
			...
			//			e.printStackTrace();
			//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AE0020010-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
		}
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AE0020010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickSelect(
					...
					HttpSession so,
					Hashtable params,
					AE0020010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AE0020010Entity entity = control.entity;
		AE0020010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0020");
		logger.entering("AE0020010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
		...
		try {
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickSelect>
		logger.exiting("AE0020010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
					...
					AE0020010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0020");
		logger.entering("AE0020010Servlet"+":USER="+request.getRemoteUser(),"onClickFlashTree");
		...
		try {
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickFlashTree>
		logger.exiting("AE0020010Servlet"+":USER="+request.getRemoteUser(),"onClickFlashTree");
					...
					AE0020010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0020");
		logger.entering("AE0020010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
		...
		try {
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("AE0020010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
	...
	public String onClickShowDetail(
					...
					AE0020010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = "/AE0020010Detail.jsp";		// 移動先ＵＲＬ
		AE0020010Entity entity = control.entity;
		AE0020010Struct struct = control.struct;
		getSessionParameters(so, params, struct);

		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0020");
		logger.entering("AE0020010Servlet"+":USER="+request.getRemoteUser(),"onClickShowDetail");
		...
		try {
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickShowDetail>
		logger.exiting("AE0020010Servlet"+":USER="+request.getRemoteUser(),"onClickShowDetail");
	...
	public String onClickAddTree(
					...
					AE0020010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = "/AE0020010Control.jsp";		// 移動先ＵＲＬ
		AE0020010Entity entity = control.entity;
		AE0020010Struct struct = control.struct;
		getSessionParameters(so, params, struct);

		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0020");
		logger.entering("AE0020010Servlet"+":USER="+request.getRemoteUser(),"onClickAddTree");
		...
		try {
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickAddTree>
		logger.exiting("AE0020010Servlet"+":USER="+request.getRemoteUser(),"onClickAddTree");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AE0020010Struct struct)
	{
		...
		String[] AE0020010tree1 = ((params.containsKey("AE0020010tree1")) ? (String[])params.get("AE0020010tree1") : (String[])null);
		...
		struct.setAE0020010tree1( ((AE0020010tree1 == null) ? (String)null : AE0020010tree1[0]) );
		struct.setList_AE0020010tree1(TypeConverter.convert(AE0020010tree1));
	...
	public static String DEFAULT_TARGET = "/AE0020010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAE0020010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAE0020010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0020");
		logger.entering("AE0020010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
		// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AE0020010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AE0020010Control control;
		AE0020010Entity  entity = null;
		AE0020010Struct  struct = null;
		...
		try {
			...
			if( (control = (AE0020010Control)so.getAttribute("AE0020010Control_"+request.getSession(false).getId())) == null ) {
				control = new AE0020010Control();
			...
			try {
				...
				so.setAttribute("AE0020010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.AE0020.AE0020010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AE0020010Servlet()
	{
		//{{user_implement_dev:<AE0020010_DisConnect_FLG>
		...
		//{{user_implement_dev:<AE0020010Servlet>
		// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<AE0020010Servlet>
	}
