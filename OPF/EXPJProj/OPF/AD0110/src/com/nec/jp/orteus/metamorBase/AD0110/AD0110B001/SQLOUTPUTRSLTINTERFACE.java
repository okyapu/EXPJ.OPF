/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AD0110/src/com/nec/jp/orteus/metamorBase/AD0110/AD0110B001/SQLOUTPUTRSLTINTERFACE.java,v $
 *
...
/**
 * CLASS     : SQLOUTPUTRSLTINTERFACE クラス
 * ファイル・クラス説明
 * @author $Author: geng-jia $
 * @version $Revision: 1.3 $ $Date: 2015/12/22 10:04:35 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class SQLOUTPUTRSLTINTERFACE extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public List call() throws BatchAppException
		{
			try {
				...
				e.printStackTrace();
				BatchAppException be=new BatchAppException("SQLOUTPUTRSLTINTERFACE", "call", "Stored Procedure条件設定処理失敗");
				...
				if (cstmt != null) {
					try {
						...
						ef.printStackTrace();
						BatchAppException bef = new BatchAppException("SQLOUTPUTRSLTINTERFACE", "call", "Stored Procedureクローズ処理失敗");
		 ...
		 */
		public medAD0110B001 call(ResultSet rs) throws SQLException
		{
			if(rs == null || rs.next()==false) return null;
			medAD0110B001 data = new medAD0110B001();
			m_med.setpnumReturn(cstmt.getString(11));
			return data;
		}
	...
	/**
	 * SQLOUTPUTRSLTINTERFACEクラスの標準コンストラクタ
	 *
		 */
	public SQLOUTPUTRSLTINTERFACE(medAD0110B001 med, BatchAppConductor cdr) throws SystemException
	{
	...
	protected static String m_calcmd = "{" + "Call SQLOUTPUTRSLTINTERFACE(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" + "}";
