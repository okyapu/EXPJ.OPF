/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0160/src/com/nec/jp/orteus/metamorBase/AE0160/AE0160B001/T_ACPT_RSLT.java,v $
 *
...
public class T_ACPT_RSLT extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN2_R(m_med.getTEMP_PUCH_ODR_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("T_ACPT_RSLT", "read", "レコード検索条件設定処理失敗");
		...
		public String getALREADY_ACPT_QTY_R() throws FoundationException { return m_doRs.getString(1); }
		public String getACPT_NO_R() throws FoundationException { return m_doRs.getString(2); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setALREADY_ACPT_QTY(getALREADY_ACPT_QTY_R());
				m_med.setTEMP_ACPT_NO(getACPT_NO_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("T_ACPT_RSLT", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("T_ACPT_RSLT", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	 ...
	 *
		 */
	public T_ACPT_RSLT(medAE0160B001 med, BatchAppConductor cdr) throws SystemException
	{
...
+"  NVL(SUM(A.ACPT_QTY), 0) AS ALREADY_ACPT_QTY, "
+"  NVL(MAX(A.ACPT_NO) + 1, 1) AS ACPT_NO "
+"FROM "
+"  T_ACPT_RSLT A "
+"WHERE "
+"  A.PUCH_ODR_CD = ?";
