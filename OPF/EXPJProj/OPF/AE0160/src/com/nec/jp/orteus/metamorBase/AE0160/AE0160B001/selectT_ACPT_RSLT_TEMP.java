/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0160/src/com/nec/jp/orteus/metamorBase/AE0160/AE0160B001/selectT_ACPT_RSLT_TEMP.java,v $
 *
...
/**
 * CLASS     : selectT_ACPT_RSLT_TEMP クラス
 * ファイル・クラス説明
...
public class selectT_ACPT_RSLT_TEMP extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setDATEFROM_R(String value) throws FoundationException { getAdapt_R().setString(1, value); }
		public void setDATETO_R(String value) throws FoundationException { getAdapt_R().setString(2, value); }
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setDATEFROM_R(m_med.getDATEFROM());
				setDATETO_R(m_med.getDATETO());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("selectT_ACPT_RSLT_TEMP", "read", "レコード検索条件設定処理失敗");
		...
		public String getLINE_COUNT_R() throws FoundationException { return m_doRs.getString(2); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setLINE_COUNT(getLINE_COUNT_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("selectT_ACPT_RSLT_TEMP", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("selectT_ACPT_RSLT_TEMP", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	...
	/**
	 * selectT_ACPT_RSLT_TEMPクラスの標準コンストラクタ
	 *
		 */
	public selectT_ACPT_RSLT_TEMP(medAE0160B001 med, BatchAppConductor cdr) throws SystemException
	{
