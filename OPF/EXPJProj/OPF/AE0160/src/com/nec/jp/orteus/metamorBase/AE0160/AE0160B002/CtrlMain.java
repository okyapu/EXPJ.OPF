/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0160/src/com/nec/jp/orteus/metamorBase/AE0160/AE0160B002/CtrlMain.java,v $
 *
		...
		implements IBatchAppCommon
{
	 ...
	 *
		 */
	public CtrlMain(medAE0160B002 med, BatchAppConductor cdr) throws BatchAppException
	{
		// メンバ変数を初期化します
		m_conductor = cdr;
		m_med = med;
	 ...
	 *
		 */
	public CtrlMain(medAE0160B002 med) throws BatchAppException
	{
		// メンバ変数を初期化します
		m_med = med;
		m_control = new interControl(med);
...
*/
		...
		try {	
			...
			m_med.setFUNCTION_NAME("SQLACPTRSLTINTERFACE");
			...
			List callList = null;
			callList = m_med.getSQLACPTRSLTINTERFACE().call();
			// PL/SQLの実行結果を取得
			medAE0160B002 resultMed = (medAE0160B002) callList.get(0);
		...
		implements IBatchAppCommon
	{
		...
		public interControl(medAE0160B002 med) throws BatchAppException
		{
			// 各メンバ変数の初期化
			m_med = med;
