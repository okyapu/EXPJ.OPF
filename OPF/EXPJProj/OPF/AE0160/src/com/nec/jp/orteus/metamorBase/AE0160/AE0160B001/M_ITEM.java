/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0160/src/com/nec/jp/orteus/metamorBase/AE0160/AE0160B001/M_ITEM.java,v $
 *
...
public class M_ITEM extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN3_R(m_med.getTEMP_ITEM_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("M_ITEM", "read", "レコード検索条件設定処理失敗");
		...
		public String getITEM_NAME_R() throws FoundationException { return m_doRs.getString(1); }
		public String getLOT_CTRL_FLG_R() throws FoundationException { return m_doRs.getString(2); }
		public String getLOT_NUMBERING_TYP_R() throws FoundationException { return m_doRs.getString(3); }
		public String getUNIT_QTY_TYP_R() throws FoundationException { return m_doRs.getString(4); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setITEM_NAME(getITEM_NAME_R());
				m_med.setLOT_CTRL_FLG(getLOT_CTRL_FLG_R());
				m_med.setLOT_NUMBERING_TYP(getLOT_NUMBERING_TYP_R());
				m_med.setUNIT_QTY_TYP(getUNIT_QTY_TYP_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("M_ITEM", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("M_ITEM", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	 ...
	 *
		 */
	public M_ITEM(medAE0160B001 med, BatchAppConductor cdr) throws SystemException
	{
