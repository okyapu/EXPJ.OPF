/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0160/src/com/nec/jp/orteus/metamorBase/AE0160/AE0160B001/deleteT_ACPT_RSLT_TEMP.java,v $
 *
...
/**
 * CLASS     : deleteT_ACPT_RSLT_TEMP クラス
 * ファイル・クラス説明
...
public class deleteT_ACPT_RSLT_TEMP extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setDATEFROM_D(String value) throws FoundationException { getAdapt_D().setString(1, value); }
		public void setDATETO_D(String value) throws FoundationException { getAdapt_D().setString(2, value); }
		public void setIN2_D(String value) throws FoundationException { getAdapt_D().setString(3, value); }

		public int delete() throws BatchAppException
		{
			try {
				setDATEFROM_D(m_med.getDATEFROM());
				setDATETO_D(m_med.getDATETO());
				setIN2_D(m_med.getTEMP_PUCH_ODR_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("deleteT_ACPT_RSLT_TEMP", "delete", "レコード削除条件設定処理失敗");
	 ...
	 *
		 */
	public deleteT_ACPT_RSLT_TEMP(medAE0160B001 med, BatchAppConductor cdr) throws SystemException
	{
