/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0160/src/com/nec/jp/orteus/metamorBase/AE0160/AE0160020Struct.java,v $
 *
 ...
 * @version $Revision: 1.11 $ $Date: 2017/01/09 08:43:58 $
 *
 */
//}}user_implement_code_header

public class AE0160020Struct extends DataStruct
{
	...
	/** 第 1 List変数： l_DATE_FROM */
	public List l_DATE_FROM = null;

	/** 第 2 List変数： l_DATE_TO */
	...
	public int setL2L_DATE_FROM(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DATE_FROM.add(((AE0160020Struct) list.get(i)).getDATE_FROM());
		}
		return size;
	}
	public int setL2L_DATE_TO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DATE_TO.add(((AE0160020Struct) list.get(i)).getDATE_TO());
		}
		return size;
	}
	...
	/**
	 * medAE0160020クラスの標準コンストラクタ
	 */
	public AE0160020Struct()
	{
	 ...
	 */
	public void setStruct(AE0160020Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructM(AE0160020Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructL(AE0160020Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
