/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0160/src/com/nec/jp/orteus/metamorBase/AE0160/AE0160B002/cdrAE0160B002.java,v $
 *
...
public class cdrAE0160B002 extends Object
		implements IBatchAppCommon
{
	...
	public void initialize() throws BatchAppException, SystemException
	{
		try {
			...
			m_med.setSQLACPTRSLTINTERFACE( new SQLACPTRSLTINTERFACE(m_med, m_conductor) );
			...
			m_conductor.addObject( m_med.getSQLACPTRSLTINTERFACE() );
	...
	public int beginProc() throws BatchAppException
	{
		try {
			...
			setCommitFlag(false);
			BatchAppException be=new BatchAppException("cdrAE0160B002", "beginProc", "conductorの初期処理に失敗しました");
	...
	medAE0160B002 m_med=new medAE0160B002();

	// BatchAppConductorクラスインスタンス
	BatchAppConductor m_conductor=new BatchAppConductor("AE0160B002");
	...
	/**
	 * ctrAE0160B002クラス 標準コンストラクタ
	 *
		 */
	public cdrAE0160B002() throws BatchAppException
	{
		initialize();
