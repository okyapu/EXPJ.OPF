/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0160/src/com/nec/jp/orteus/metamorBase/AE0160/AE0160B001/T_WORK_IN_PROC_BY_PROC.java,v $
 *
...
/**
 * CLASS     : T_WORK_IN_PROC_BY_PROC クラス
 * ファイル・クラス説明
...
public class T_WORK_IN_PROC_BY_PROC extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN1_R(m_med.getWORK_ODR_CD());
				setIN2_R(m_med.getWORK_IN_PROC_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("T_WORK_IN_PROC_BY_PROC", "read", "レコード検索条件設定処理失敗");
		...
		public String getFINAL_PROC_FLG_R() throws FoundationException { return m_doRs.getString(1); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setFINAL_PROC_FLG(getFINAL_PROC_FLG_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("T_WORK_IN_PROC_BY_PROC", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("T_WORK_IN_PROC_BY_PROC", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	...
	/**
	 * T_WORK_IN_PROC_BY_PROCクラスの標準コンストラクタ
	 *
		 */
	public T_WORK_IN_PROC_BY_PROC(medAE0160B001 med, BatchAppConductor cdr) throws SystemException
	{
