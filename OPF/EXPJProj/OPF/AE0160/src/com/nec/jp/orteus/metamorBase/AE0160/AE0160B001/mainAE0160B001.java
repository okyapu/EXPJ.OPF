/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0160/src/com/nec/jp/orteus/metamorBase/AE0160/AE0160B001/mainAE0160B001.java,v $
 *
...
/**
 * CLASS     : mainAE0160B001 クラス
 * ファイル・クラス説明
 * @author $Author: shan-xiuqin $
 * @version $Revision: 1.13 $ $Date: 2017/01/09 08:43:58 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class mainAE0160B001
{
    // リターン値
	...
	public static void main(String args[])
	{
		...
		try {
			...
			if (sysLog == null) {
				...
				if(!sysLog.init("com.nec.jp.orteus.metamorBase.AE0160B001")) {
					//システムログの初期化に失敗しました
			...
			try {
				...
				// 標準出力ファイル名設定
				String logFileName = "AE0160B001.log";
				if (logFileName == null) {
				...
				// 新規作成のためバッチログファイル削除
				if (blogMode == false) {
					File logFile = new File(logOutputPath + "/AE0160B001.log");
				...
				System.setOut(new PrintStream(new FileOutputStream(logOutputPath + "/AE0160B001stdout.log", blogMode)));
				System.setErr(new PrintStream(new FileOutputStream(logOutputPath + "/AE0160B001stderr.log", blogMode)));
			...
			cdrAE0160B001 ebo = new cdrAE0160B001();
