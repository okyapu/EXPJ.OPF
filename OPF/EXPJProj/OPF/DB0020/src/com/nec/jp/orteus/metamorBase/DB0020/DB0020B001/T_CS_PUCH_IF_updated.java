/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DB0020/src/com/nec/jp/orteus/metamorBase/DB0020/DB0020B001/T_CS_PUCH_IF_updated.java,v $
 *
...
/**
 * CLASS     : T_CS_PUCH_IF_updated クラス
 * ファイル・クラス説明
 * @author $Author: koiwa $
 * @version $Revision: 1.3 $ $Date: 2005/04/08 13:00:50 $
 */
//{{user_implement_dev:header
//}}user_implement_dev:header

public class T_CS_PUCH_IF_updated extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int update() throws BatchAppException
		{
			try {
				...
				setIN0_U(m_med.getCOST_TYP());
				setIN1_U(m_med.getPLANT_CD());
				setIN2_U(m_med.getITEM_CD());
				setIN3_U(m_med.getPROC_CD());
				setIN4_U(m_med.getVEND_CD());
				setIN5_U(m_med.getEFF_PHASE_IN_DATE());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("T_CS_PUCH_IF_updated", "update", "レコード更新条件設定処理失敗");
	...
	void prepareAll() throws BatchAppException
	{
		...
		try {
			...
			BatchAppException be=new BatchAppException("T_CS_PUCH_IF_updated", "prepareALL(FoundationException)", "SQL文のprepareで失敗しました");
			be.addMessage(e.getErrmsg());
			throw be;
		} catch(SQLException e) {
			BatchAppException be=new BatchAppException("T_CS_PUCH_IF_updated", "prepareALL(SQLException)", "SQL文のprepareで失敗しました");
			throw be;
		}
	...
	/**
	 * T_CS_PUCH_IF_updatedクラスの標準コンストラクタ
	 *
	 */
	public T_CS_PUCH_IF_updated(medDB0020B001 med, BatchAppConductor cdr) throws SystemException
	{
	...
	// 各状態で実行するsql文の定義
	protected final static String m_selcmd = null;
	protected final static String m_inscmd = null;
	protected final static String m_updcmd = "update "
+"  T_CS_PUCH_IF "
+"set "
+"  \"UPD_FLG\" = 1 "
+"where "
+"  T_CS_PUCH_IF.\"COST_TYP\" = to_number(?) "
...
+"  and T_CS_PUCH_IF.\"EFF_PHASE_IN_DATE\" = to_date(?, 'YYYY/MM/DD HH24:MI:SS')";
	protected final static String m_delcmd = null;
