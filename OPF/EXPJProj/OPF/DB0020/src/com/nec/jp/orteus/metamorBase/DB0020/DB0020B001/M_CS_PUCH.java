/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DB0020/src/com/nec/jp/orteus/metamorBase/DB0020/DB0020B001/M_CS_PUCH.java,v $
 *
 ...
 * @version $Revision: 1.9 $ $Date: 2014/11/05 07:21:08 $
 */
...
public class M_CS_PUCH extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setRCY_VAL_UNIT_COST_C(String value) throws FoundationException { getAdapt_C().setString(18, value); }
		public void setRCY_RECOUP_RATE_C(String value) throws FoundationException { getAdapt_C().setString(19, value); }
		public void setCLASIFICATION_CD_C(String value) throws FoundationException { getAdapt_C().setString(20, value); }
		public void setSTOCK_UNIT_C(String value) throws FoundationException { getAdapt_C().setString(21, value); }
		public void setONEROUS_CONS_FLG_C(String value) throws FoundationException { getAdapt_C().setString(22, value); }
		public void setCOMPANY_CD_C(String value) throws FoundationException { getAdapt_C().setString(23, value); }
		public void setORG_CD_C(String value) throws FoundationException { getAdapt_C().setString(24, value); }
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN1_R(m_med.getYEAR());
				setIN2_R(m_med.getHALF_TERM_TYP());
				setIN3_R(m_med.getCOST_TYP());
				setIN4_R(m_med.getPLANT_CD());
				setIN5_R(m_med.getITEM_CD());
			} catch(FoundationException e) {
	 ...
	 *
		 */
	public M_CS_PUCH(medDB0020B001 med, BatchAppConductor cdr) throws SystemException
	{
...
+"values "
+"  (to_number(?), to_number(?), to_number(?), ?, ?, null, ?, to_number(?), to_number(?), ?, to_number(?), to_number(?), to_number(?), to_number(?), null, 0, 1, null, 0, 1, 0, 0, ?, ?, 1, 1, to_number(?), 1, 0, ?, ?)";
