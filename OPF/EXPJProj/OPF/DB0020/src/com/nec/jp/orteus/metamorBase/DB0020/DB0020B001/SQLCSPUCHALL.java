/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DB0020/src/com/nec/jp/orteus/metamorBase/DB0020/DB0020B001/SQLCSPUCHALL.java,v $
 *
...
public class SQLCSPUCHALL extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public List call() throws BatchAppException
		{
			try {
				...
				cstmt.setInt(8, m_med.getBATCH_TYP().intValue());
				cstmt.setInt(9, m_med.getpnumYear().intValue());
				cstmt.setInt(10, m_med.getpnumHalfTermTyp().intValue());
				cstmt.setInt(11, m_med.getpnumCostTyp().intValue());
				cstmt.setInt(12, m_med.getpnumYyyyMm().intValue());
				cstmt.setInt(13, m_med.getpnumExecuteTyp().intValue());
				cstmt.setInt(14, m_med.getpnumUpdateMode().intValue());
				...
				if(rs != null) {
					...
					m_med.setpnumReturn( new Integer(cstmt.getInt(15)) );
					list.add(m_med);
				}
				...
				e.printStackTrace();
				BatchAppException be=new BatchAppException("SQLCSPUCHALL", "call", "Stored Procedure条件設定処理失敗");
				...
				if (cstmt != null) {
					try {
						...
						ef.printStackTrace();
						BatchAppException bef = new BatchAppException("SQLCSPUCHALL", "call", "Stored Procedureクローズ処理失敗");
	...
	/**
	 * SQLCSPUCHALLクラスの標準コンストラクタ
	 *
		 */
	public SQLCSPUCHALL(medDB0020B001 med, BatchAppConductor cdr) throws SystemException
	{
	...
	protected static String m_calcmd = "{" + "call SQLCSPUCHALL(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" + "}";
