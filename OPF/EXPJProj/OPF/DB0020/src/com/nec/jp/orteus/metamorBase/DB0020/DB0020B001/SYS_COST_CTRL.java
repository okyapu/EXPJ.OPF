/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DB0020/src/com/nec/jp/orteus/metamorBase/DB0020/DB0020B001/SYS_COST_CTRL.java,v $
 *
 ...
 * @version $Revision: 1.9 $ $Date: 2014/11/05 07:21:10 $
 */
...
public class SYS_COST_CTRL extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public String getYEAR_R() throws FoundationException { return m_doRs.getString(1); }
		public String getHALF_TERM_TYP_R() throws FoundationException { return m_doRs.getString(2); }
		public String getSTART_MONTH_R() throws FoundationException { return m_doRs.getString(3); }
		public String getM_CS_PUCH_PRIORITY_TYP_R() throws FoundationException { return m_doRs.getString(4); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setYEAR(getYEAR_R());
				m_med.setHALF_TERM_TYP(getHALF_TERM_TYP_R());
				m_med.setSTART_MONTH(getSTART_MONTH_R());
				m_med.setPRIORITY_TYP(getM_CS_PUCH_PRIORITY_TYP_R());
			} catch(FoundationException e) {
	 ...
	 *
		 */
	public SYS_COST_CTRL(medDB0020B001 med, BatchAppConductor cdr) throws SystemException
	{
...
+"  to_char(SYS_COST_CTRL.\"CURRENT_YEAR\") as \"YEAR\", "
