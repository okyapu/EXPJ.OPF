/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DB0020/src/com/nec/jp/orteus/metamorBase/DB0020/DB0020B001/T_CS_PUCH_IF.java,v $
 *
...
public class T_CS_PUCH_IF extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setVEND_CD_C(String value) throws FoundationException { getAdapt_C().setString(12, value); }
		public void setEFF_PHASE_IN_DATE_C(String value) throws FoundationException { getAdapt_C().setString(13, value); }
		public void setPUCH_PRIORITY_REF_NO_C(String value) throws FoundationException { getAdapt_C().setString(14, value); }
		public void setUNIT_COST_C(String value) throws FoundationException { getAdapt_C().setString(15, value); }
		public void setUNIT_COST_TYP_C(String value) throws FoundationException { getAdapt_C().setString(16, value); }
		public void setCUR_CD_C(String value) throws FoundationException { getAdapt_C().setString(17, value); }
		public void setEXCH_RATE_C(String value) throws FoundationException { getAdapt_C().setString(18, value); }
		public void setPUCH_UNIT_QTY_C(String value) throws FoundationException { getAdapt_C().setString(19, value); }
		public void setCLASIFICATION_CD_C(String value) throws FoundationException { getAdapt_C().setString(20, value); }
		public void setCOMPANY_CD_C(String value) throws FoundationException { getAdapt_C().setString(21, value); }
		public void setORG_CD_C(String value) throws FoundationException { getAdapt_C().setString(22, value); }
		public void setSTOCK_UNIT_C(String value) throws FoundationException { getAdapt_C().setString(23, value); }
		public void setONEROUS_CONS_FLG_C(String value) throws FoundationException { getAdapt_C().setString(24, value); }
		public void setSAVE_UPDATED_DATE_C(String value) throws FoundationException { getAdapt_C().setString(25, value); }
		public void setTRANSACTION_TYP_C(String value) throws FoundationException { getAdapt_C().setString(26, value); }
		...
		public int create() throws BatchAppException
		{
			try {
				...
				setPUCH_PRIORITY_REF_NO_C(m_med.getPUCH_PRIORITY_REF_NO());
		...
		public void setIN22_R(String value) throws FoundationException { getAdapt_R().setString(1, value); }
		public void setIN23_R(String value) throws FoundationException { getAdapt_R().setString(2, value); }
		public void setIN24_R(String value) throws FoundationException { getAdapt_R().setString(3, value); }
		public void setIN25_R(String value) throws FoundationException { getAdapt_R().setString(4, value); }
		public void setIN26_R(String value) throws FoundationException { getAdapt_R().setString(5, value); }
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN22_R(m_med.getYEAR());
				setIN23_R(m_med.getHALF_TERM_TYP());
				setIN24_R(m_med.getCOST_TYP());
				setIN25_R(m_med.getPLANT_CD());
				setIN26_R(m_med.getYYYYMM());
			} catch(FoundationException e) {
		...
		public void setVEND_CD_U(String value) throws FoundationException { getAdapt_U().setString(9, value); }
		public void setEFF_PHASE_IN_DATE_U(String value) throws FoundationException { getAdapt_U().setString(10, value); }
		public void setPUCH_PRIORITY_REF_NO_U(String value) throws FoundationException { getAdapt_U().setString(11, value); }
		...
		public int update() throws BatchAppException
		{
			try {
				...
				setPUCH_PRIORITY_REF_NO_U(m_med.getPUCH_PRIORITY_REF_NO());
				...
				setIN25_U(m_med.getVEND_CD());
				setIN26_U(m_med.getEFF_PHASE_IN_DATE());
			} catch(FoundationException e) {
		...
		public String getCOMPANY_CD_R() throws FoundationException { return m_doRs.getString(16); }
		public String getORG_CD_R() throws FoundationException { return m_doRs.getString(17); }
		public String getSTOCK_UNIT_R() throws FoundationException { return m_doRs.getString(18); }
		public String getCS_PUCH_TYP_R() throws FoundationException { return m_doRs.getString(19); }
		public String getONEROUS_CONS_FLG_R() throws FoundationException { return m_doRs.getString(20); }
		public String getTRANSACTION_TYP_R() throws FoundationException { return m_doRs.getString(21); }
		public String getUPD_FLG_R() throws FoundationException { return m_doRs.getString(22); }
	 ...
	 *
		 */
	public T_CS_PUCH_IF(medDB0020B001 med, BatchAppConductor cdr) throws SystemException
	{
...
+"  T_CS_PUCH_IF(\"YEAR\", \"HALF_TERM_TYP\", \"COST_TYP\", \"PLANT_CD\", \"ITEM_CD\", \"CS_PROC_CD\", \"VEND_CD\", \"EFF_PHASE_IN_DATE\", \"PUCH_PRIORITY_REF_NO\", \"UNIT_COST\", \"UNIT_COST_TYP\", \"CUR_CD\", \"EXCH_RATE\", \"PUCH_UNIT_QTY\", \"RCY_VAL_UNIT_COST\", \"RCY_RECOUP_RATE\", \"CLASIFICATION_CD\", \"COMPANY_CD\", \"ORG_CD\", \"STOCK_UNIT\", \"CS_PUCH_TYP\", \"ONEROUS_CONS_FLG\", \"SAVE_UPDATED_DATE\", \"TRANSACTION_TYP\", \"UPD_FLG\") "
+"values "
+"  (to_number(?), to_number(?), to_number(?), ?, ?, '*', ?, to_date(?, 'YYYY/MM/DD HH24:MI:SS'), to_number(?), to_number(?), to_number(?), ?, to_number(?), to_number(?), 0, 0, ?, ?, ?, ?, 1, to_number(?), to_date(?, 'YYYY/MM/DD HH24:MI:SS'), to_number(?), 0)";
...
+"  \"PUCH_PRIORITY_REF_NO\" = to_number(?), "
+"  \"UNIT_COST\" = to_number(?), "
...
+"where "
+"  T_CS_PUCH_IF.\"YEAR\" = ? "
+"  and T_CS_PUCH_IF.\"HALF_TERM_TYP\" = ? "
+"  and T_CS_PUCH_IF.\"COST_TYP\" = ? "
+"  and T_CS_PUCH_IF.\"PLANT_CD\" = ? "
