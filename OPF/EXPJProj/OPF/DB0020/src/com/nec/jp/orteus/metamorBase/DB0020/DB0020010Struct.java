/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DB0020/src/com/nec/jp/orteus/metamorBase/DB0020/DB0020010Struct.java,v $
 *
...
public class DB0020010Struct extends DataStruct
{
	...
	public int setL2L_PLANT_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PLANT_CD.add(((DB0020010Struct) list.get(i)).getPLANT_CD());
		}
		return size;
	}
	public int setL2L_PLANT_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PLANT_NAME.add(((DB0020010Struct) list.get(i)).getPLANT_NAME());
		}
		return size;
	}
	public int setL2L_CURRENT_YEAR(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CURRENT_YEAR.add(((DB0020010Struct) list.get(i)).getCURRENT_YEAR());
		}
		return size;
	}
	public int setL2L_HALF_TERM_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_HALF_TERM_TYP.add(((DB0020010Struct) list.get(i)).getHALF_TERM_TYP());
		}
		return size;
	}
	public int setL2L_PC_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PC_FLG.add(((DB0020010Struct) list.get(i)).getPC_FLG());
		}
		return size;
	}
	public int setL2L_YEAR(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_YEAR.add(((DB0020010Struct) list.get(i)).getYEAR());
		}
		return size;
	}
	public int setL2L_HALF_TERM_TYP_name(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_HALF_TERM_TYP_name.add(((DB0020010Struct) list.get(i)).getHALF_TERM_TYP_name());
		}
		return size;
	}
	public int setL2L_HALF_TERM_TYP_val(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_HALF_TERM_TYP_val.add(((DB0020010Struct) list.get(i)).getHALF_TERM_TYP_val());
		}
		return size;
	}
	public int setL2L_COST_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_COST_TYP.add(((DB0020010Struct) list.get(i)).getCOST_TYP());
		}
		return size;
	}
	public int setL2L_COST_TYP_name(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_COST_TYP_name.add(((DB0020010Struct) list.get(i)).getCOST_TYP_name());
		}
		return size;
	}
	public int setL2L_COST_TYP_val(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_COST_TYP_val.add(((DB0020010Struct) list.get(i)).getCOST_TYP_val());
		}
		return size;
	}
	public int setL2L_c_Extract(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_c_Extract.add(((DB0020010Struct) list.get(i)).getc_Extract());
		}
		return size;
	}
	public int setL2L_r1_UpdateMode(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_r1_UpdateMode.add(((DB0020010Struct) list.get(i)).getr1_UpdateMode());
		}
		return size;
	}
	public int setL2L_r2_UpdateMode(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_r2_UpdateMode.add(((DB0020010Struct) list.get(i)).getr2_UpdateMode());
		}
		return size;
	}
	public int setL2L_c_ShelfRegist(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_c_ShelfRegist.add(((DB0020010Struct) list.get(i)).getc_ShelfRegist());
		}
		return size;
	}
	...
	/**
	 * medDB0020010クラスの標準コンストラクタ
	 */
	public DB0020010Struct()
	{
	 ...
	 */
	public void setStruct(DB0020010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructM(DB0020010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructL(DB0020010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
