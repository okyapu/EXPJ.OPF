/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DB0020/src/com/nec/jp/orteus/metamorBase/DB0020/DB0020B001/T_CS_ERROR.java,v $
 *
...
public class T_CS_ERROR extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setBATCH_TYP_C(Integer value) throws FoundationException {
			if (value == null) {
				getAdapt_C().setString(8, null);
			} else {
				getAdapt_C().setInt(8, value.intValue());
			}
		}
	 ...
	 *
		 */
	public T_CS_ERROR(medDB0020B001 med, BatchAppConductor cdr) throws SystemException
	{
...
+"  T_CS_ERROR(\"CS_ERROR_CD\", \"BATCH_TYP\", \"BUSINESS_ID\", \"COST_TYP\", \"PLANT_CD\", \"ITEM_CD\", \"CS_PROC_CD\", \"VEND_CD\", \"PROC_COST_CLS_CD\", \"EFFECTIVE_START_DATE\", \"TRANSACTION_TYP\", \"MESSAGE_CD\", \"READ_COUNT\", \"REMARKS\", \"LIST_ISS_FLG\") "
+"values "
