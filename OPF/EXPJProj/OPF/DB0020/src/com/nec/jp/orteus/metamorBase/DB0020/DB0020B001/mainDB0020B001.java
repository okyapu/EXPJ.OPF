/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DB0020/src/com/nec/jp/orteus/metamorBase/DB0020/DB0020B001/mainDB0020B001.java,v $
 *
...
/**
 * CLASS     : mainDB0020B001 クラス
 * ファイル・クラス説明
 * @author $Author: xl-hs-zzw $
 * @version $Revision: 1.10 $ $Date: 2014/11/05 07:21:12 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class mainDB0020B001
{
    // リターン値
	...
	public static void main(String args[])
	{
		...
		try {
			...
			if (sysLog == null) {
				...
				if(!sysLog.init("com.nec.jp.orteus.metamorBase.DB0020B001")) {
					//システムログの初期化に失敗しました
			...
			try {
				...
				// 標準出力ファイル名設定
				String logFileName = "DB0020B001.log";
				if (logFileName == null) {
				...
				// 新規作成のためバッチログファイル削除
				if (blogMode == false) {
					File logFile = new File(logOutputPath + "/DB0020B001.log");
				...
				System.setOut(new PrintStream(new FileOutputStream(logOutputPath + "/DB0020B001stdout.log", blogMode)));
				System.setErr(new PrintStream(new FileOutputStream(logOutputPath + "/DB0020B001stderr.log", blogMode)));
			...
			cdrDB0020B001 ebo = new cdrDB0020B001();
