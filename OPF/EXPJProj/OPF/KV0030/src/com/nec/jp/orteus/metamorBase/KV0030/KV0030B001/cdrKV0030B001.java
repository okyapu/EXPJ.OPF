/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KV0030/src/com/nec/jp/orteus/metamorBase/KV0030/KV0030B001/cdrKV0030B001.java,v $
 *
...
public class cdrKV0030B001 extends Object
		implements IBatchAppCommon
{
	...
	public void initialize() throws BatchAppException, SystemException
	{
		try {
			...
			m_med.setreadT_ANS_DLV_DATE( new readT_ANS_DLV_DATE(m_med, m_conductor) );
			m_med.setinsertT_OD( new insertT_OD(m_med, m_conductor) );
			m_med.setupdateT_ANS_DLV_DATE( new updateT_ANS_DLV_DATE(m_med, m_conductor) );
			m_med.setupdateT_OD( new updateT_OD(m_med, m_conductor) );
			...
			m_conductor.addObject( m_med.getreadT_ANS_DLV_DATE() );
			m_conductor.addObject( m_med.getinsertT_OD() );
			m_conductor.addObject( m_med.getupdateT_ANS_DLV_DATE() );
			m_conductor.addObject( m_med.getupdateT_OD() );
	...
	public int getType() { return m_conductor.getType(); }
        ...
        public int beginProc() throws BatchAppException
        {
         try {
          ...
          setCommitFlag(false);
          BatchAppException be=new BatchAppException("cdrKV0030B001", "beginProc", "conductorの初期処理に失敗しました");
	...
	medKV0030B001 m_med=new medKV0030B001();

	// BatchAppConductorクラスインスタンス
	BatchAppConductor m_conductor=new BatchAppConductor("KV0030B001");
	...
	/**
	 * ctrKV0030B001クラス 標準コンストラクタ
	 *
		 */
	public cdrKV0030B001() throws BatchAppException
	{
		initialize();
