/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KV0030/src/com/nec/jp/orteus/metamorBase/KV0030/KV0030B001/updateT_ANS_DLV_DATE.java,v $
 *
...
/**
 * CLASS     : updateT_ANS_DLV_DATE クラス
 * ファイル・クラス説明
...
public class updateT_ANS_DLV_DATE extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setOD_NO_U(String value) throws FoundationException { getAdapt_U().setString(4, value); }
		public void setODR_NO_U(String value) throws FoundationException { getAdapt_U().setString(5, value); }
		public void setPART_DLV_SEQ_NO_U(String value) throws FoundationException { getAdapt_U().setString(6, value); }
		...
		public int update() throws BatchAppException
		{
			try {
				...
				setOD_NO_U(m_med.getinOD_NO());
				setODR_NO_U(m_med.getODR_NO());
				setPART_DLV_SEQ_NO_U(m_med.getPART_DLV_SEQ_NO());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("updateT_ANS_DLV_DATE", "update", "レコード更新条件設定処理失敗");
	...
	void prepareAll() throws BatchAppException
	{
		...
		try {
			...
			BatchAppException be=new BatchAppException("updateT_ANS_DLV_DATE", "prepareALL(FoundationException)", "SQL文のprepareで失敗しました");
			be.addMessage(e.getErrmsg());
			throw be;
		} catch(SQLException e) {
			BatchAppException be=new BatchAppException("updateT_ANS_DLV_DATE", "prepareALL(SQLException)", "SQL文のprepareで失敗しました");
			throw be;
		}
	...
	/**
	 * updateT_ANS_DLV_DATEクラスの標準コンストラクタ
	 *
		 */
	public updateT_ANS_DLV_DATE(medKV0030B001 med, BatchAppConductor cdr) throws SystemException
	{
	...
	protected static String m_updcmd = "update T_ANS_DLV_DATE "
+"set OD_NO = ? "
+"where ODR_NO = ? "
+"  and PART_DLV_SEQ_NO = ?";
