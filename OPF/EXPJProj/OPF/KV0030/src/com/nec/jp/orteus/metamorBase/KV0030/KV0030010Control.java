...
public class KV0030010Control
{
	...
	//{{user_implement_code_main
       ...
       //	public Object getListvalue(int x) { return this.list.get(x); }	// リストの値を返します。
        public KV0030010Struct getListvalue(int x) { return (KV0030010Struct)(this.list.get(x)); }	// リストの値を返します。
        public KV0030010Struct getStruct() { return this.struct; }	// Structを返します。
        public KV0030010Struct createStruct() { return new KV0030010Struct(); }	// 新しいStructを作って返します。
        public void setStruct(Object structname) { this.struct.setStruct((KV0030010Struct)structname); }	// Structをセットします。
        ...
        private void executeBatchProgram(String plantCd) throws Exception {
         ...
         try {
          ...
          String ProgID = "KV0030010";		  // 呼出もとの業務ID
...
//           cmd = cmd + " " + "com.nec.jp.orteus.metamorBase.KV0030.KV0030B001.mainKV0030B001"; // 呼び出し先クラス
...
//           cmd = cmd + " " + plantCd;      // 工場コード
           ...
           buffer.add("com.nec.jp.orteus.metamorBase.KV0030.KV0030B001.mainKV0030B001"); // 呼び出し先クラス
              ...
              //System.out.println("this.struct.gettxtPlantCd()==" + this.struct.gettxtPlantCd());
                 ...
                 if (plantTyp.equals("1")) {
                  ...
                  if (this.list != null && this.list.size() > 0) {
                   ...
                   //sysLog.info("KV00302", sysUSER_CD); // 工場データが存在しません。
...
//			e.printStackTrace();
//			throw new FoundationException("KV0030010Control",e.getMessage(),"control_eventHandllerメソッドでエラーが発生しました。");
	...
	public void createDefaultCSV(List list, String sTitle[]) throws BusinessProcessException, FoundationException {
		...
		//{{user_implement_dev:<createDefaultCSV>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("KV0030010-E999","CSVの出力処理"));
			throw new FoundationException("KV0030010Control",e.getMessage(),"createDefaultCSVメソッドでエラーが発生しました。");
		}
...
//				objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("KV0030010-E999","システム日付の取得処理"));
				throw new FoundationException("KV0030010Control","beginTransaction()","システム日付取得処理でエラーが発生しました。");
			}
		...
		//{{user_implement_dev:<beginTransaction>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("KV0030010-E999","コントロールのイベント処理"));
			throw new FoundationException("KV0030010Control",e.getMessage(),"beginTransactionメソッドでエラーが発生しました。");
		}
