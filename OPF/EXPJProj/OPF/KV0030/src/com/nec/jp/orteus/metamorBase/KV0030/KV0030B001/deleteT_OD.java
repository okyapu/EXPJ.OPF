/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KV0030/src/com/nec/jp/orteus/metamorBase/KV0030/KV0030B001/deleteT_OD.java,v $
 *
...
public class deleteT_OD extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setinPLANT_CD_D(String value) throws FoundationException { getAdapt_D().setString(1, value); }

		public int delete() throws BatchAppException
		{
			try {
				setinPLANT_CD_D(m_med.getPLANT_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("deleteT_OD", "delete", "レコード削除条件設定処理失敗");
	 ...
	 *
		 */
	public deleteT_OD(medKV0030B001 med, BatchAppConductor cdr) throws SystemException
	{
	...
	protected static String m_delcmd = "delete from T_OD "
+"where OD_GNR_TYP = 8 "
+"  and PLANT_CD = ? "
+"  and not exists (select 'x' from T_ANS_DLV_DATE "
+"                   where T_ANS_DLV_DATE.OD_NO = T_OD.OD_NO) "
+"";
