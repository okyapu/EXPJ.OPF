/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KV0030/src/com/nec/jp/orteus/metamorBase/KV0030/KV0030B001/updateT_OD.java,v $
 *
...
/**
 * CLASS     : updateT_OD クラス
 * ファイル・クラス説明
 * @author $Author: geng-jia $
 * @version $Revision: 1.9 $ $Date: 2015/12/03 08:57:31 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class updateT_OD extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setDUE_DATE_U(String value) throws FoundationException { getAdapt_U().setString(4, value); }
		public void setPRD_DUE_DATE_U(String value) throws FoundationException { getAdapt_U().setString(5, value); }
		public void setDM_QTY_U(String value) throws FoundationException { getAdapt_U().setString(6, value); }
		public void setinOD_NO_U(String value) throws FoundationException { getAdapt_U().setString(7, value); }
		public void setinDUE_DATE_U(String value) throws FoundationException { getAdapt_U().setString(8, value); }
		public void setinDM_QTY_U(String value) throws FoundationException { getAdapt_U().setString(9, value); }
		...
		public int update() throws BatchAppException
		{
			try {
				...
				setDUE_DATE_U(m_med.getDESINATED_SHIP_DATE());
				setPRD_DUE_DATE_U(m_med.getDESINATED_SHIP_DATE());
				setDM_QTY_U(m_med.getDESINATED_SHIP_QTY());
				setinOD_NO_U(m_med.getOD_NO());
				setinDUE_DATE_U(m_med.getDESINATED_SHIP_DATE());
				setinDM_QTY_U(m_med.getDESINATED_SHIP_QTY());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("updateT_OD", "update", "レコード更新条件設定処理失敗");
	...
	void prepareAll() throws BatchAppException
	{
		...
		try {
			...
			BatchAppException be=new BatchAppException("updateT_OD", "prepareALL(FoundationException)", "SQL文のprepareで失敗しました");
			be.addMessage(e.getErrmsg());
			throw be;
		} catch(SQLException e) {
			BatchAppException be=new BatchAppException("updateT_OD", "prepareALL(SQLException)", "SQL文のprepareで失敗しました");
			throw be;
		}
	 ...
	 *
		 */
	public updateT_OD(medKV0030B001 med, BatchAppConductor cdr) throws SystemException
	{
	...
	protected static String m_updcmd = "update T_OD "
+"set DUE_DATE = ?, "
+"    PRD_DUE_DATE = ?, "
+"    DM_QTY = ? "
+"where OD_NO = ? "
