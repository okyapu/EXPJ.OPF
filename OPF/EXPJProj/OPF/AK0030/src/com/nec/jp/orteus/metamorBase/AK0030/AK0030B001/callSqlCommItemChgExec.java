/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AK0030/src/com/nec/jp/orteus/metamorBase/AK0030/AK0030B001/callSqlCommItemChgExec.java,v $
 *
...
/**
 * CLASS     : callSqlCommItemChgExec クラス
 * ファイル・クラス説明
...
public class callSqlCommItemChgExec extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public List call() throws BatchAppException
		{
			try {
				...
				cstmt.setString(8, m_med.getpvc2StepFlg());


				cstmt.execute();

				List list = new ArrayList();
				medAK0030B001 data = null;
				...
				e.printStackTrace();
				BatchAppException be=new BatchAppException("callSqlCommItemChgExec", "call", "Stored Procedure条件設定処理失敗");
				...
				if (cstmt != null) {
					try {
						...
						ef.printStackTrace();
						BatchAppException bef = new BatchAppException("callSqlCommItemChgExec", "call", "Stored Procedureクローズ処理失敗");
		 ...
		 */
		public medAK0030B001 call(ResultSet rs) throws SQLException
		{
			if(rs == null || rs.next()==false) return null;
			medAK0030B001 data = new medAK0030B001();
			return data;
		}
	...
	/**
	 * callSqlCommItemChgExecクラスの標準コンストラクタ
	 *
		 */
	public callSqlCommItemChgExec(medAK0030B001 med, BatchAppConductor cdr) throws SystemException
	{
	...
	protected static String m_calcmd = "{" + "call SQLCOMMITEMCHGEXEC(?,?,?,?,?,?,?,?)" + "}";
