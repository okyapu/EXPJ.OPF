/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AK0030/src/com/nec/jp/orteus/metamorBase/AK0030/AK0030B001/cdrAK0030B001.java,v $
 *
...
public class cdrAK0030B001 extends Object
		implements IBatchAppCommon
{
	...
	public void initialize() throws BatchAppException, SystemException
	{
		try {
			...
			m_med.setcallSqlCommItemChgExec( new callSqlCommItemChgExec(m_med, m_conductor) );
			...
			m_med.setselectPrdReqCtrl( new selectPrdReqCtrl(m_med, m_conductor) );
			m_med.setCtrlMain( new CtrlMain(m_med, m_conductor) );
			m_conductor.addObject( m_med.getcallSqlCommItemChgExec() );
			...
			m_conductor.addObject( m_med.getselectPrdReqCtrl() );
	...
	public int getType() { return m_conductor.getType(); }
        ...
        public int beginProc() throws BatchAppException
        {
         try {
          ...
          setCommitFlag(false);
          BatchAppException be=new BatchAppException("cdrAK0030B001", "beginProc", "conductorの初期処理に失敗しました");
	...
	medAK0030B001 m_med=new medAK0030B001();

	// BatchAppConductorクラスインスタンス
	BatchAppConductor m_conductor=new BatchAppConductor("AK0030B001");
	...
	/**
	 * ctrAK0030B001クラス 標準コンストラクタ
	 *
		 */
	public cdrAK0030B001() throws BatchAppException
	{
		initialize();
