/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KR0070/src/com/nec/jp/orteus/metamorBase/KR0070/KZ1010P001Struct.java,v $
 *
...
/**
 * CLASS     : KZ1010P001Control クラス
 * ファイル・クラス説明
 * @author $Author: luoxiao $
 * @version $Revision: 1.1 $ $Date: 2014/02/21 07:52:32 $
 *
 */
//}}user_implement_code_header

public class KZ1010P001Struct extends DataStruct
{
	...
	/** 第 23 変数： m_FINAL_DLV_LOC_CD */
	public String m_FINAL_DLV_LOC_CD = null;
	/** 第 24 変数： m_SHIP_DATE */
	public String m_SHIP_DATE = null;
	/** 第 25 変数： m_ODR_CTL_NO */
	public String m_ODR_CTL_NO = null;
	/** 第 26 変数： m_CUST_ITEM_CD */
	public String m_CUST_ITEM_CD = null;
	/** 第 27 変数： m_CUST_ITEM_NAME */
	...
	/** 第 30 変数： m_PURPOSE_UNIT_PRICE_TYP */
	public String m_PURPOSE_UNIT_PRICE_TYP = null;
	/** 第 31 変数： m_SHIP_PLAN_DATE */
	public String m_SHIP_PLAN_DATE = null;
	/** 第 32 変数： m_SCDL_DLV_DATE */
	public String m_SCDL_DLV_DATE = null;
	/** 第 33 変数： m_UNCNFM_CUST_ODR_CREATE_DATE */
	public String m_UNCNFM_CUST_ODR_CREATE_DATE = null;
	/** 第 34 変数： m_CUS_DLV_KEY_CD */
	public String m_CUS_DLV_KEY_CD = null;
	/** 第 35 変数： m_AMOUNT_TYP */
	public String m_AMOUNT_TYP = null;
	/** 第 36 変数： m_ODR_CMPLT_FLG */
	public String m_ODR_CMPLT_FLG = null;
	/** 第 37 変数： m_SHIP_COUNT */
	public String m_SHIP_COUNT = null;
	/** 第 38 変数： m_ODR_QTY */
	...
	/** 第 23 List変数： l_FINAL_DLV_LOC_CD */
	public List l_FINAL_DLV_LOC_CD = null;

	/** 第 24 List変数： l_SHIP_DATE */
	public List l_SHIP_DATE = null;

	/** 第 25 List変数： l_ODR_CTL_NO */
	public List l_ODR_CTL_NO = null;

	/** 第 26 List変数： l_CUST_ITEM_CD */
	public List l_CUST_ITEM_CD = null;

	/** 第 27 List変数： l_CUST_ITEM_NAME */
	...
	/** 第 30 List変数： l_PURPOSE_UNIT_PRICE_TYP */
	public List l_PURPOSE_UNIT_PRICE_TYP = null;

	/** 第 31 List変数： l_SHIP_PLAN_DATE */
	public List l_SHIP_PLAN_DATE = null;

	/** 第 32 List変数： l_SCDL_DLV_DATE */
	public List l_SCDL_DLV_DATE = null;

	/** 第 33 List変数： l_UNCNFM_CUST_ODR_CREATE_DATE */
	public List l_UNCNFM_CUST_ODR_CREATE_DATE = null;

	/** 第 34 List変数： l_CUS_DLV_KEY_CD */
	public List l_CUS_DLV_KEY_CD = null;

	/** 第 35 List変数： l_AMOUNT_TYP */
	public List l_AMOUNT_TYP = null;

	/** 第 36 List変数： l_ODR_CMPLT_FLG */
	public List l_ODR_CMPLT_FLG = null;

	/** 第 37 List変数： l_SHIP_COUNT */
	public List l_SHIP_COUNT = null;

	/** 第 38 List変数： l_ODR_QTY */
	public List l_ODR_QTY = null;

	/** 第 39 List変数： l_T_ODR_TAX_CD */
	public List l_T_ODR_TAX_CD = null;

	/** 第 40 List変数： l_CUST_NAME */
	public List l_CUST_NAME = null;

	/** 第 41 List変数： l_TAX_CALC_TYP */
	public List l_TAX_CALC_TYP = null;

	/** 第 42 List変数： l_TAX_APPLY_TYP */
	public List l_TAX_APPLY_TYP = null;

	/** 第 43 List変数： l_TEMP_UNIT_PRICE_SALES_FLG */
	public List l_TEMP_UNIT_PRICE_SALES_FLG = null;

	/** 第 44 List変数： l_CLAIM_CYCLE_TYP */
	public List l_CLAIM_CYCLE_TYP = null;

	/** 第 45 List変数： l_RM_INP_TYP */
	public List l_RM_INP_TYP = null;

	/** 第 46 List変数： l_CUR_CD */
	public List l_CUR_CD = null;

	/** 第 47 List変数： l_EXCH_TYP */
	public List l_EXCH_TYP = null;

	/** 第 48 List変数： l_TAX_CD */
	public List l_TAX_CD = null;

	/** 第 49 List変数： l_CUST_VARIOUS_TYP */
	public List l_CUST_VARIOUS_TYP = null;

	/** 第 50 List変数： l_SLIP_PRINTING_TYP_1 */
	public List l_SLIP_PRINTING_TYP_1 = null;

	/** 第 51 List変数： l_SLIP_PRINTING_TYP_2 */
	public List l_SLIP_PRINTING_TYP_2 = null;

	/** 第 52 List変数： l_SLIP_PRINTING_TYP_3 */
	public List l_SLIP_PRINTING_TYP_3 = null;

	/** 第 53 List変数： l_SLIP_PRINTING_TYP_4 */
	public List l_SLIP_PRINTING_TYP_4 = null;

	/** 第 54 List変数： l_SLIP_PRINTING_TYP_5 */
	public List l_SLIP_PRINTING_TYP_5 = null;

	/** 第 55 List変数： l_PRICE_RANK_CD */
	public List l_PRICE_RANK_CD = null;

	/** 第 56 List変数： l_INSPC_ACPT_TYP */
	public List l_INSPC_ACPT_TYP = null;

	/** 第 57 List変数： l_PRICE_ROUND_TYP */
	...
	/** 第 79 List変数： l_EDI_DATA_TYP */
	public List l_EDI_DATA_TYP = null;

	/** 第 80 List変数： l_STATUS */
	...
	public String getFINAL_DLV_LOC_CD() { return m_FINAL_DLV_LOC_CD; }
	...
	public String getPURPOSE_UNIT_PRICE_TYP() { return m_PURPOSE_UNIT_PRICE_TYP; }
	public String getSHIP_PLAN_DATE() { return m_SHIP_PLAN_DATE; }
	public String getSCDL_DLV_DATE() { return m_SCDL_DLV_DATE; }
	public String getUNCNFM_CUST_ODR_CREATE_DATE() { return m_UNCNFM_CUST_ODR_CREATE_DATE; }
	...
	public String getSHIP_COUNT() { return m_SHIP_COUNT; }
	...
	public List getList_FINAL_DLV_LOC_CD() { return l_FINAL_DLV_LOC_CD; }
	...
	public List getList_PURPOSE_UNIT_PRICE_TYP() { return l_PURPOSE_UNIT_PRICE_TYP; }
	public List getList_SHIP_PLAN_DATE() { return l_SHIP_PLAN_DATE; }
	public List getList_SCDL_DLV_DATE() { return l_SCDL_DLV_DATE; }
	public List getList_UNCNFM_CUST_ODR_CREATE_DATE() { return l_UNCNFM_CUST_ODR_CREATE_DATE; }
	...
	public List getList_SHIP_COUNT() { return l_SHIP_COUNT; }
	...
	public void setFINAL_DLV_LOC_CD(String val) { m_FINAL_DLV_LOC_CD = val; }
	...
	public void setPURPOSE_UNIT_PRICE_TYP(String val) { m_PURPOSE_UNIT_PRICE_TYP = val; }
	public void setSHIP_PLAN_DATE(String val) { m_SHIP_PLAN_DATE = val; }
	public void setSCDL_DLV_DATE(String val) { m_SCDL_DLV_DATE = val; }
	public void setUNCNFM_CUST_ODR_CREATE_DATE(String val) { m_UNCNFM_CUST_ODR_CREATE_DATE = val; }
	...
	public void setSHIP_COUNT(String val) { m_SHIP_COUNT = val; }
	...
	public void setList_FINAL_DLV_LOC_CD(List list) { l_FINAL_DLV_LOC_CD = list; }
	...
	public void setList_PURPOSE_UNIT_PRICE_TYP(List list) { l_PURPOSE_UNIT_PRICE_TYP = list; }
	public void setList_SHIP_PLAN_DATE(List list) { l_SHIP_PLAN_DATE = list; }
	public void setList_SCDL_DLV_DATE(List list) { l_SCDL_DLV_DATE = list; }
	public void setList_UNCNFM_CUST_ODR_CREATE_DATE(List list) { l_UNCNFM_CUST_ODR_CREATE_DATE = list; }
	...
	public void setList_SHIP_COUNT(List list) { l_SHIP_COUNT = list; }
	...
	public int setL2L_COMPANY_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_COMPANY_CD.add(((KZ1010P001Struct) list.get(i)).getCOMPANY_CD());
		}
		return size;
	}
	public int setL2L_SLIP_CTRL_GRP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SLIP_CTRL_GRP.add(((KZ1010P001Struct) list.get(i)).getSLIP_CTRL_GRP());
		}
		return size;
	}
	public int setL2L_SLIP_TRN_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SLIP_TRN_CD.add(((KZ1010P001Struct) list.get(i)).getSLIP_TRN_CD());
		}
		return size;
	}
	public int setL2L_STOCK_CLASS_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_STOCK_CLASS_CD.add(((KZ1010P001Struct) list.get(i)).getSTOCK_CLASS_CD());
		}
		return size;
	}
	public int setL2L_BALANCE_CLASS_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_BALANCE_CLASS_CD.add(((KZ1010P001Struct) list.get(i)).getBALANCE_CLASS_CD());
		}
		return size;
	}
	public int setL2L_HOME_CUR_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_HOME_CUR_CD.add(((KZ1010P001Struct) list.get(i)).getHOME_CUR_CD());
		}
		return size;
	}
	public int setL2L_SALES_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SALES_DATE.add(((KZ1010P001Struct) list.get(i)).getSALES_DATE());
		}
		return size;
	}
	public int setL2L_SALES_DEPT_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SALES_DEPT_CD.add(((KZ1010P001Struct) list.get(i)).getSALES_DEPT_CD());
		}
		return size;
	}
	public int setL2L_CUST_CHRG_PSN_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUST_CHRG_PSN_CD.add(((KZ1010P001Struct) list.get(i)).getCUST_CHRG_PSN_CD());
		}
		return size;
	}
	public int setL2L_CUST_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUST_CD.add(((KZ1010P001Struct) list.get(i)).getCUST_CD());
		}
		return size;
	}
	public int setL2L_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_CD.add(((KZ1010P001Struct) list.get(i)).getITEM_CD());
		}
		return size;
	}
	public int setL2L_ITEM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_NAME.add(((KZ1010P001Struct) list.get(i)).getITEM_NAME());
		}
		return size;
	}
	public int setL2L_CUST_ODR_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUST_ODR_NO.add(((KZ1010P001Struct) list.get(i)).getCUST_ODR_NO());
		}
		return size;
	}
	public int setL2L_SALES_AMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SALES_AMOUNT.add(((KZ1010P001Struct) list.get(i)).getSALES_AMOUNT());
		}
		return size;
	}
	public int setL2L_REMARKS(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_REMARKS.add(((KZ1010P001Struct) list.get(i)).getREMARKS());
		}
		return size;
	}
	public int setL2L_SALES_AMOUNT_EXCH_RATES(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SALES_AMOUNT_EXCH_RATES.add(((KZ1010P001Struct) list.get(i)).getSALES_AMOUNT_EXCH_RATES());
		}
		return size;
	}
	public int setL2L_OWN_CUR_TAXCREDIT_SALES_AMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OWN_CUR_TAXCREDIT_SALES_AMOUNT.add(((KZ1010P001Struct) list.get(i)).getOWN_CUR_TAXCREDIT_SALES_AMOUNT());
		}
		return size;
	}
	public int setL2L_SALES_UNIT_PRICE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SALES_UNIT_PRICE.add(((KZ1010P001Struct) list.get(i)).getSALES_UNIT_PRICE());
		}
		return size;
	}
	public int setL2L_SALES_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SALES_QTY.add(((KZ1010P001Struct) list.get(i)).getSALES_QTY());
		}
		return size;
	}
	public int setL2L_INSPC_ACPT_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_INSPC_ACPT_DATE.add(((KZ1010P001Struct) list.get(i)).getINSPC_ACPT_DATE());
		}
		return size;
	}
	public int setL2L_INSPC_ACPT_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_INSPC_ACPT_QTY.add(((KZ1010P001Struct) list.get(i)).getINSPC_ACPT_QTY());
		}
		return size;
	}
	public int setL2L_SLIP_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SLIP_CD.add(((KZ1010P001Struct) list.get(i)).getSLIP_CD());
		}
		return size;
	}
	public int setL2L_FINAL_DLV_LOC_CD(List list) {
		int size = (list != null) ? list.size() : 0;
		if (size == 0) {
			return 0;
		}
		if (l_FINAL_DLV_LOC_CD == null) {
			l_FINAL_DLV_LOC_CD = new ArrayList();
		} else {
			l_FINAL_DLV_LOC_CD.clear();
		}
		for (int i = 0; i < size; i++) {
			l_FINAL_DLV_LOC_CD.add(((KZ1010P001Struct) list.get(i)).getFINAL_DLV_LOC_CD());
		}
		return size;
	}
	public int setL2L_SHIP_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SHIP_DATE.add(((KZ1010P001Struct) list.get(i)).getSHIP_DATE());
		}
		return size;
	}
	public int setL2L_ODR_CTL_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ODR_CTL_NO.add(((KZ1010P001Struct) list.get(i)).getODR_CTL_NO());
		}
		return size;
	}
	public int setL2L_CUST_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUST_ITEM_CD.add(((KZ1010P001Struct) list.get(i)).getCUST_ITEM_CD());
		}
		return size;
	}
	public int setL2L_CUST_ITEM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUST_ITEM_NAME.add(((KZ1010P001Struct) list.get(i)).getCUST_ITEM_NAME());
		}
		return size;
	}
	public int setL2L_PART_DLV_SEQ_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PART_DLV_SEQ_NO.add(((KZ1010P001Struct) list.get(i)).getPART_DLV_SEQ_NO());
		}
		return size;
	}
	public int setL2L_SHIP_ODR_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SHIP_ODR_NO.add(((KZ1010P001Struct) list.get(i)).getSHIP_ODR_NO());
		}
		return size;
	}
	public int setL2L_PURPOSE_UNIT_PRICE_TYP(List list) {
		int size = (list != null) ? list.size() : 0;
		if (size == 0) {
			return 0;
		}
		if (l_PURPOSE_UNIT_PRICE_TYP == null) {
			l_PURPOSE_UNIT_PRICE_TYP = new ArrayList();
		} else {
			l_PURPOSE_UNIT_PRICE_TYP.clear();
		}
		for (int i = 0; i < size; i++) {
			l_PURPOSE_UNIT_PRICE_TYP.add(((KZ1010P001Struct) list.get(i)).getPURPOSE_UNIT_PRICE_TYP());
		}
		return size;
	}
	public int setL2L_SHIP_PLAN_DATE(List list) {
		int size = (list != null) ? list.size() : 0;
		if (size == 0) {
			return 0;
		}
		if (l_SHIP_PLAN_DATE == null) {
			l_SHIP_PLAN_DATE = new ArrayList();
		} else {
			l_SHIP_PLAN_DATE.clear();
		}
		for (int i = 0; i < size; i++) {
			l_SHIP_PLAN_DATE.add(((KZ1010P001Struct) list.get(i)).getSHIP_PLAN_DATE());
		}
		return size;
	}
	public int setL2L_SCDL_DLV_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SCDL_DLV_DATE.add(((KZ1010P001Struct) list.get(i)).getSCDL_DLV_DATE());
		}
		return size;
	}
	public int setL2L_UNCNFM_CUST_ODR_CREATE_DATE(List list) {
		int size = (list != null) ? list.size() : 0;
		if (size == 0) {
			return 0;
		}
		if (l_UNCNFM_CUST_ODR_CREATE_DATE == null) {
			l_UNCNFM_CUST_ODR_CREATE_DATE = new ArrayList();
		} else {
			l_UNCNFM_CUST_ODR_CREATE_DATE.clear();
		}
		for (int i = 0; i < size; i++) {
			l_UNCNFM_CUST_ODR_CREATE_DATE.add(((KZ1010P001Struct) list.get(i)).getUNCNFM_CUST_ODR_CREATE_DATE());
		}
		return size;
	}
	public int setL2L_CUS_DLV_KEY_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUS_DLV_KEY_CD.add(((KZ1010P001Struct) list.get(i)).getCUS_DLV_KEY_CD());
		}
		return size;
	}
	public int setL2L_AMOUNT_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_AMOUNT_TYP.add(((KZ1010P001Struct) list.get(i)).getAMOUNT_TYP());
		}
		return size;
	}
	public int setL2L_ODR_CMPLT_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ODR_CMPLT_FLG.add(((KZ1010P001Struct) list.get(i)).getODR_CMPLT_FLG());
		}
		return size;
	}
	public int setL2L_SHIP_COUNT(List list) {
		int size = (list != null) ? list.size() : 0;
		if (size == 0) {
			return 0;
		}
		if (l_SHIP_COUNT == null) {
			l_SHIP_COUNT = new ArrayList();
		} else {
			l_SHIP_COUNT.clear();
		}
		for (int i = 0; i < size; i++) {
			l_SHIP_COUNT.add(((KZ1010P001Struct) list.get(i)).getSHIP_COUNT());
		}
		return size;
	}
	public int setL2L_ODR_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ODR_QTY.add(((KZ1010P001Struct) list.get(i)).getODR_QTY());
		}
		return size;
	}
	public int setL2L_T_ODR_TAX_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_T_ODR_TAX_CD.add(((KZ1010P001Struct) list.get(i)).getT_ODR_TAX_CD());
		}
		return size;
	}
	public int setL2L_CUST_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUST_NAME.add(((KZ1010P001Struct) list.get(i)).getCUST_NAME());
		}
		return size;
	}
	public int setL2L_TAX_CALC_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_CALC_TYP.add(((KZ1010P001Struct) list.get(i)).getTAX_CALC_TYP());
		}
		return size;
	}
	public int setL2L_TAX_APPLY_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_APPLY_TYP.add(((KZ1010P001Struct) list.get(i)).getTAX_APPLY_TYP());
		}
		return size;
	}
	public int setL2L_TEMP_UNIT_PRICE_SALES_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TEMP_UNIT_PRICE_SALES_FLG.add(((KZ1010P001Struct) list.get(i)).getTEMP_UNIT_PRICE_SALES_FLG());
		}
		return size;
	}
	public int setL2L_CLAIM_CYCLE_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CLAIM_CYCLE_TYP.add(((KZ1010P001Struct) list.get(i)).getCLAIM_CYCLE_TYP());
		}
		return size;
	}
	public int setL2L_RM_INP_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_RM_INP_TYP.add(((KZ1010P001Struct) list.get(i)).getRM_INP_TYP());
		}
		return size;
	}
	public int setL2L_CUR_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUR_CD.add(((KZ1010P001Struct) list.get(i)).getCUR_CD());
		}
		return size;
	}
	public int setL2L_EXCH_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_EXCH_TYP.add(((KZ1010P001Struct) list.get(i)).getEXCH_TYP());
		}
		return size;
	}
	public int setL2L_TAX_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_CD.add(((KZ1010P001Struct) list.get(i)).getTAX_CD());
		}
		return size;
	}
	public int setL2L_CUST_VARIOUS_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUST_VARIOUS_TYP.add(((KZ1010P001Struct) list.get(i)).getCUST_VARIOUS_TYP());
		}
		return size;
	}
	public int setL2L_SLIP_PRINTING_TYP_1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SLIP_PRINTING_TYP_1.add(((KZ1010P001Struct) list.get(i)).getSLIP_PRINTING_TYP_1());
		}
		return size;
	}
	public int setL2L_SLIP_PRINTING_TYP_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SLIP_PRINTING_TYP_2.add(((KZ1010P001Struct) list.get(i)).getSLIP_PRINTING_TYP_2());
		}
		return size;
	}
	public int setL2L_SLIP_PRINTING_TYP_3(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SLIP_PRINTING_TYP_3.add(((KZ1010P001Struct) list.get(i)).getSLIP_PRINTING_TYP_3());
		}
		return size;
	}
	public int setL2L_SLIP_PRINTING_TYP_4(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SLIP_PRINTING_TYP_4.add(((KZ1010P001Struct) list.get(i)).getSLIP_PRINTING_TYP_4());
		}
		return size;
	}
	public int setL2L_SLIP_PRINTING_TYP_5(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SLIP_PRINTING_TYP_5.add(((KZ1010P001Struct) list.get(i)).getSLIP_PRINTING_TYP_5());
		}
		return size;
	}
	public int setL2L_PRICE_RANK_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PRICE_RANK_CD.add(((KZ1010P001Struct) list.get(i)).getPRICE_RANK_CD());
		}
		return size;
	}
	public int setL2L_INSPC_ACPT_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_INSPC_ACPT_TYP.add(((KZ1010P001Struct) list.get(i)).getINSPC_ACPT_TYP());
		}
		return size;
	}
	public int setL2L_PRICE_ROUND_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PRICE_ROUND_TYP.add(((KZ1010P001Struct) list.get(i)).getPRICE_ROUND_TYP());
		}
		return size;
	}
	public int setL2L_SHIP_SLIP_ID(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SHIP_SLIP_ID.add(((KZ1010P001Struct) list.get(i)).getSHIP_SLIP_ID());
		}
		return size;
	}
	public int setL2L_CARRIAGE_CHARGE_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CARRIAGE_CHARGE_TYP.add(((KZ1010P001Struct) list.get(i)).getCARRIAGE_CHARGE_TYP());
		}
		return size;
	}
	public int setL2L_BILL_ADDRESSEE_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_BILL_ADDRESSEE_CD.add(((KZ1010P001Struct) list.get(i)).getBILL_ADDRESSEE_CD());
		}
		return size;
	}
	public int setL2L_STL_COND_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_STL_COND_CD.add(((KZ1010P001Struct) list.get(i)).getSTL_COND_CD());
		}
		return size;
	}
	public int setL2L_DLV_LOC_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_LOC_NAME.add(((KZ1010P001Struct) list.get(i)).getDLV_LOC_NAME());
		}
		return size;
	}
	public int setL2L_ZIP_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ZIP_CD.add(((KZ1010P001Struct) list.get(i)).getZIP_CD());
		}
		return size;
	}
	public int setL2L_ADDRESS_1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ADDRESS_1.add(((KZ1010P001Struct) list.get(i)).getADDRESS_1());
		}
		return size;
	}
	public int setL2L_ADDRESS_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ADDRESS_2.add(((KZ1010P001Struct) list.get(i)).getADDRESS_2());
		}
		return size;
	}
	public int setL2L_DLV_LOC_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_LOC_CD.add(((KZ1010P001Struct) list.get(i)).getDLV_LOC_CD());
		}
		return size;
	}
	public int setL2L_EXCH_RATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_EXCH_RATE.add(((KZ1010P001Struct) list.get(i)).getEXCH_RATE());
		}
		return size;
	}
	public int setL2L_SLIP_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SLIP_DATE.add(((KZ1010P001Struct) list.get(i)).getSLIP_DATE());
		}
		return size;
	}
	public int setL2L_SHIP_SLIP_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SHIP_SLIP_CD.add(((KZ1010P001Struct) list.get(i)).getSHIP_SLIP_CD());
		}
		return size;
	}
	public int setL2L_EXTERNAL_TAX_SALES_AMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_EXTERNAL_TAX_SALES_AMOUNT.add(((KZ1010P001Struct) list.get(i)).getEXTERNAL_TAX_SALES_AMOUNT());
		}
		return size;
	}
	public int setL2L_INTERNAL_TAX_SALES_AMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_INTERNAL_TAX_SALES_AMOUNT.add(((KZ1010P001Struct) list.get(i)).getINTERNAL_TAX_SALES_AMOUNT());
		}
		return size;
	}
	public int setL2L_TAXFREE_SALES_AMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAXFREE_SALES_AMOUNT.add(((KZ1010P001Struct) list.get(i)).getTAXFREE_SALES_AMOUNT());
		}
		return size;
	}
	public int setL2L_TAX_CREDIT_SALES_AMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_CREDIT_SALES_AMOUNT.add(((KZ1010P001Struct) list.get(i)).getTAX_CREDIT_SALES_AMOUNT());
		}
		return size;
	}
	public int setL2L_EXTERNAL_TAX_AMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_EXTERNAL_TAX_AMOUNT.add(((KZ1010P001Struct) list.get(i)).getEXTERNAL_TAX_AMOUNT());
		}
		return size;
	}
	public int setL2L_INTERNAL_TAX_AMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_INTERNAL_TAX_AMOUNT.add(((KZ1010P001Struct) list.get(i)).getINTERNAL_TAX_AMOUNT());
		}
		return size;
	}
	public int setL2L_TAX_AMOUNT_1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_AMOUNT_1.add(((KZ1010P001Struct) list.get(i)).getTAX_AMOUNT_1());
		}
		return size;
	}
	public int setL2L_TAX_AMOUNT_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_AMOUNT_2.add(((KZ1010P001Struct) list.get(i)).getTAX_AMOUNT_2());
		}
		return size;
	}
	public int setL2L_TAX_AMOUNT_3(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_AMOUNT_3.add(((KZ1010P001Struct) list.get(i)).getTAX_AMOUNT_3());
		}
		return size;
	}
	public int setL2L_EDI_DATA_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_EDI_DATA_TYP.add(((KZ1010P001Struct) list.get(i)).getEDI_DATA_TYP());
		}
		return size;
	}
	public int setL2L_STATUS(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_STATUS.add(((KZ1010P001Struct) list.get(i)).getSTATUS());
		}
		return size;
	}
	public int setL2L_OLD_TAX_RATE_1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OLD_TAX_RATE_1.add(((KZ1010P001Struct) list.get(i)).getOLD_TAX_RATE_1());
		}
		return size;
	}
	public int setL2L_OLD_TAX_RATE_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OLD_TAX_RATE_2.add(((KZ1010P001Struct) list.get(i)).getOLD_TAX_RATE_2());
		}
		return size;
	}
	public int setL2L_OLD_TAX_RATE_3(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OLD_TAX_RATE_3.add(((KZ1010P001Struct) list.get(i)).getOLD_TAX_RATE_3());
		}
		return size;
	}
	public int setL2L_NEW_TAX_RATE_START_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_NEW_TAX_RATE_START_DATE.add(((KZ1010P001Struct) list.get(i)).getNEW_TAX_RATE_START_DATE());
		}
		return size;
	}
	public int setL2L_NEW_TAX_RATE_1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_NEW_TAX_RATE_1.add(((KZ1010P001Struct) list.get(i)).getNEW_TAX_RATE_1());
		}
		return size;
	}
	public int setL2L_NEW_TAX_RATE_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_NEW_TAX_RATE_2.add(((KZ1010P001Struct) list.get(i)).getNEW_TAX_RATE_2());
		}
		return size;
	}
	public int setL2L_NEW_TAX_RATE_3(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_NEW_TAX_RATE_3.add(((KZ1010P001Struct) list.get(i)).getNEW_TAX_RATE_3());
		}
		return size;
	}
	public int setL2L_ROUND_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ROUND_TYP.add(((KZ1010P001Struct) list.get(i)).getROUND_TYP());
		}
		return size;
	}
	public int setL2L_DECIMAL_FIG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DECIMAL_FIG.add(((KZ1010P001Struct) list.get(i)).getDECIMAL_FIG());
		}
		return size;
	}
	public int setL2L_SEQ_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SEQ_NO.add(((KZ1010P001Struct) list.get(i)).getSEQ_NO());
		}
		return size;
	}
	public int setL2L_LINE_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_LINE_NO.add(((KZ1010P001Struct) list.get(i)).getLINE_NO());
		}
		return size;
	}
	public int setL2L_LINE_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_LINE_TYP.add(((KZ1010P001Struct) list.get(i)).getLINE_TYP());
		}
		return size;
	}
	public int setL2L_COMM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_COMM_CD.add(((KZ1010P001Struct) list.get(i)).getCOMM_CD());
		}
		return size;
	}
	public int setL2L_COMM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_COMM_NAME.add(((KZ1010P001Struct) list.get(i)).getCOMM_NAME());
		}
		return size;
	}
	public int setL2L_SPEC(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SPEC.add(((KZ1010P001Struct) list.get(i)).getSPEC());
		}
		return size;
	}
	public int setL2L_TAX_CD_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_CD_2.add(((KZ1010P001Struct) list.get(i)).getTAX_CD_2());
		}
		return size;
	}
	public int setL2L_INP_UNIT_PRICE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_INP_UNIT_PRICE.add(((KZ1010P001Struct) list.get(i)).getINP_UNIT_PRICE());
		}
		return size;
	}
	public int setL2L_UNIT_COST_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_UNIT_COST_TYP.add(((KZ1010P001Struct) list.get(i)).getUNIT_COST_TYP());
		}
		return size;
	}
	public int setL2L_SLIP_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SLIP_QTY.add(((KZ1010P001Struct) list.get(i)).getSLIP_QTY());
		}
		return size;
	}
	public int setL2L_PART_DLV_TIMES(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PART_DLV_TIMES.add(((KZ1010P001Struct) list.get(i)).getPART_DLV_TIMES());
		}
		return size;
	}
	public int setL2L_PART_DLV_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PART_DLV_TYP.add(((KZ1010P001Struct) list.get(i)).getPART_DLV_TYP());
		}
		return size;
	}
	public int setL2L_CUST_COMM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUST_COMM_CD.add(((KZ1010P001Struct) list.get(i)).getCUST_COMM_CD());
		}
		return size;
	}
	public int setL2L_CUST_COMM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUST_COMM_NAME.add(((KZ1010P001Struct) list.get(i)).getCUST_COMM_NAME());
		}
		return size;
	}
	public int setL2L_CUST_ODR_SLIP_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUST_ODR_SLIP_CD.add(((KZ1010P001Struct) list.get(i)).getCUST_ODR_SLIP_CD());
		}
		return size;
	}
	public int setL2L_CUST_UNIT_PRICE_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUST_UNIT_PRICE_TYP.add(((KZ1010P001Struct) list.get(i)).getCUST_UNIT_PRICE_TYP());
		}
		return size;
	}
	public int setL2L_OWN_CUR_SALES_AMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OWN_CUR_SALES_AMOUNT.add(((KZ1010P001Struct) list.get(i)).getOWN_CUR_SALES_AMOUNT());
		}
		return size;
	}
	public int setL2L_STOCK_CTRL_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_STOCK_CTRL_FLG.add(((KZ1010P001Struct) list.get(i)).getSTOCK_CTRL_FLG());
		}
		return size;
	}
	public int setL2L_DUMMY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DUMMY.add(((KZ1010P001Struct) list.get(i)).getDUMMY());
		}
		return size;
	}
	public int setL2L_SLIP_CD2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SLIP_CD2.add(((KZ1010P001Struct) list.get(i)).getSLIP_CD2());
		}
		return size;
	}
	public int setL2L_SYSTEMDATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SYSTEMDATE.add(((KZ1010P001Struct) list.get(i)).getSYSTEMDATE());
		}
		return size;
	}
	public int setL2L_SYSTEMUSER(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SYSTEMUSER.add(((KZ1010P001Struct) list.get(i)).getSYSTEMUSER());
		}
		return size;
	}
	public int setL2L_PROGRAMID(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROGRAMID.add(((KZ1010P001Struct) list.get(i)).getPROGRAMID());
		}
		return size;
	}
	...
	public void clear()
	{
		...
		m_UNCNFM_CUST_ODR_CREATE_DATE = null;
		...
		l_SHIP_ODR_NO = null;
		l_PURPOSE_UNIT_PRICE_TYP = null;
		l_SHIP_PLAN_DATE = null;
		l_SCDL_DLV_DATE = null;
		l_UNCNFM_CUST_ODR_CREATE_DATE = null;
	...
	/**
	 * medKZ1010P001クラスの標準コンストラクタ
	 */
	public KZ1010P001Struct()
	{
	 ...
	 */
	public void setStruct(KZ1010P001Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructM(KZ1010P001Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
			...
			this.setFINAL_DLV_LOC_CD(struct.getFINAL_DLV_LOC_CD());
			...
			this.setPURPOSE_UNIT_PRICE_TYP(struct.getPURPOSE_UNIT_PRICE_TYP());
			this.setSHIP_PLAN_DATE(struct.getSHIP_PLAN_DATE());
			this.setSCDL_DLV_DATE(struct.getSCDL_DLV_DATE());
			this.setUNCNFM_CUST_ODR_CREATE_DATE(struct.getUNCNFM_CUST_ODR_CREATE_DATE());
			...
			this.setSHIP_COUNT(struct.getSHIP_COUNT());
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructL(KZ1010P001Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
			...
			this.setList_FINAL_DLV_LOC_CD(struct.getList_FINAL_DLV_LOC_CD());
			...
			this.setList_PURPOSE_UNIT_PRICE_TYP(struct.getList_PURPOSE_UNIT_PRICE_TYP());
			this.setList_SHIP_PLAN_DATE(struct.getList_SHIP_PLAN_DATE());
			this.setList_SCDL_DLV_DATE(struct.getList_SCDL_DLV_DATE());
			this.setList_UNCNFM_CUST_ODR_CREATE_DATE(struct.getList_UNCNFM_CUST_ODR_CREATE_DATE());
			...
			this.setList_SHIP_COUNT(struct.getList_SHIP_COUNT());
...
/*
	...
	// 第 23 変数初期値： i_FINAL_DLV_LOC_CD


	final static String i_FINAL_DLV_LOC_CD = null;
	...
	// 第 30 変数初期値： i_PURPOSE_UNIT_PRICE_TYP


	final static String i_PURPOSE_UNIT_PRICE_TYP = null;

	// 第 31 変数初期値： i_SHIP_PLAN_DATE


	final static String i_SHIP_PLAN_DATE = null;
	...
	// 第 33 変数初期値： i_UNCNFM_CUST_ODR_CREATE_DATE


	final static String i_UNCNFM_CUST_ODR_CREATE_DATE = null;

	// 第 34 変数初期値： i_CUS_DLV_KEY_CD


	final static String i_CUS_DLV_KEY_CD = null;

	// 第 35 変数初期値： i_AMOUNT_TYP


	final static String i_AMOUNT_TYP = null;

	// 第 36 変数初期値： i_ODR_CMPLT_FLG


	final static String i_ODR_CMPLT_FLG = null;

	// 第 37 変数初期値： i_SHIP_COUNT


	final static String i_SHIP_COUNT = null;
...
*/
	...
	// 第 15 変数初期値： i_SALES_AMOUNT_EXCH_RATES

	final static String i_SALES_AMOUNT_EXCH_RATES = null;

	// 第 16 変数初期値： i_OWN_CUR_TAXCREDIT_SALES_AMOUNT
	...
	// 第 18 変数初期値： i_SALES_QTY

	final static String i_SALES_QTY = null;

	// 第 19 変数初期値： i_INSPC_ACPT_DATE

	final static String i_INSPC_ACPT_DATE = null;

	// 第 20 変数初期値： i_INSPC_ACPT_QTY

	final static String i_INSPC_ACPT_QTY = null;

	// 第 21 変数初期値： i_SLIP_CD

	final static String i_SLIP_CD = null;

	// 第 22 変数初期値： i_FINAL_DLV_LOC_CD

	final static String i_FINAL_DLV_LOC_CD = null;

	// 第 23 変数初期値： i_SHIP_DATE
	...
	// 第 39 変数初期値： i_TAX_CALC_TYP

	final static String i_TAX_CALC_TYP = null;

	// 第 40 変数初期値： i_TAX_APPLY_TYP

	final static String i_TAX_APPLY_TYP = null;

	// 第 41 変数初期値： i_TEMP_UNIT_PRICE_SALES_FLG

	final static String i_TEMP_UNIT_PRICE_SALES_FLG = null;

	// 第 42 変数初期値： i_CLAIM_CYCLE_TYP

	final static String i_CLAIM_CYCLE_TYP = null;

	// 第 43 変数初期値： i_RM_INP_TYP
	...
	// 第 47 変数初期値： i_CUST_VARIOUS_TYP

	final static String i_CUST_VARIOUS_TYP = null;

	// 第 48 変数初期値： i_SLIP_PRINTING_TYP_1

	final static String i_SLIP_PRINTING_TYP_1 = null;

	// 第 49 変数初期値： i_SLIP_PRINTING_TYP_2

	final static String i_SLIP_PRINTING_TYP_2 = null;

	// 第 50 変数初期値： i_SLIP_PRINTING_TYP_3

	final static String i_SLIP_PRINTING_TYP_3 = null;

	// 第 51 変数初期値： i_SLIP_PRINTING_TYP_4

	final static String i_SLIP_PRINTING_TYP_4 = null;

	// 第 52 変数初期値： i_SLIP_PRINTING_TYP_5

	final static String i_SLIP_PRINTING_TYP_5 = null;

	// 第 53 変数初期値： i_PRICE_RANK_CD

	final static String i_PRICE_RANK_CD = null;

	// 第 54 変数初期値： i_INSPC_ACPT_TYP

	final static String i_INSPC_ACPT_TYP = null;

	// 第 55 変数初期値： i_PRICE_ROUND_TYP

	final static String i_PRICE_ROUND_TYP = null;

	// 第 56 変数初期値： i_SHIP_SLIP_ID

	final static String i_SHIP_SLIP_ID = null;

	// 第 57 変数初期値： i_CARRIAGE_CHARGE_TYP

	final static String i_CARRIAGE_CHARGE_TYP = null;

	// 第 58 変数初期値： i_BILL_ADDRESSEE_CD

	final static String i_BILL_ADDRESSEE_CD = null;

	// 第 59 変数初期値： i_STL_COND_CD

	final static String i_STL_COND_CD = null;

	// 第 60 変数初期値： i_DLV_LOC_NAME
	...
	// 第 62 変数初期値： i_ADDRESS_1

	final static String i_ADDRESS_1 = null;

	// 第 63 変数初期値： i_ADDRESS_2

	final static String i_ADDRESS_2 = null;

	// 第 64 変数初期値： i_DLV_LOC_CD
	...
	// 第 66 変数初期値： i_SLIP_DATE

	final static String i_SLIP_DATE = null;

	// 第 67 変数初期値： i_SHIP_SLIP_CD

	final static String i_SHIP_SLIP_CD = null;

	// 第 68 変数初期値： i_EXTERNAL_TAX_SALES_AMOUNT

	final static String i_EXTERNAL_TAX_SALES_AMOUNT = null;

	// 第 69 変数初期値： i_INTERNAL_TAX_SALES_AMOUNT

	final static String i_INTERNAL_TAX_SALES_AMOUNT = null;

	// 第 70 変数初期値： i_TAXFREE_SALES_AMOUNT

	final static String i_TAXFREE_SALES_AMOUNT = null;

	// 第 71 変数初期値： i_TAX_CREDIT_SALES_AMOUNT

	final static String i_TAX_CREDIT_SALES_AMOUNT = null;

	// 第 72 変数初期値： i_EXTERNAL_TAX_AMOUNT

	final static String i_EXTERNAL_TAX_AMOUNT = null;

	// 第 73 変数初期値： i_INTERNAL_TAX_AMOUNT

	final static String i_INTERNAL_TAX_AMOUNT = null;

	// 第 74 変数初期値： i_TAX_AMOUNT_1

	final static String i_TAX_AMOUNT_1 = null;

	// 第 75 変数初期値： i_TAX_AMOUNT_2

	final static String i_TAX_AMOUNT_2 = null;

	// 第 76 変数初期値： i_TAX_AMOUNT_3

	final static String i_TAX_AMOUNT_3 = null;

	// 第 77 変数初期値： i_EDI_DATA_TYP
	...
	// 第 79 変数初期値： i_OLD_TAX_RATE_1

	final static String i_OLD_TAX_RATE_1 = null;

	// 第 80 変数初期値： i_OLD_TAX_RATE_2

	final static String i_OLD_TAX_RATE_2 = null;

	// 第 81 変数初期値： i_OLD_TAX_RATE_3

	final static String i_OLD_TAX_RATE_3 = null;

	// 第 82 変数初期値： i_NEW_TAX_RATE_START_DATE

	final static String i_NEW_TAX_RATE_START_DATE = null;

	// 第 83 変数初期値： i_NEW_TAX_RATE_1

	final static String i_NEW_TAX_RATE_1 = null;

	// 第 84 変数初期値： i_NEW_TAX_RATE_2

	final static String i_NEW_TAX_RATE_2 = null;

	// 第 85 変数初期値： i_NEW_TAX_RATE_3

	final static String i_NEW_TAX_RATE_3 = null;

	// 第 86 変数初期値： i_ROUND_TYP
	...
	// 第 89 変数初期値： i_LINE_NO

	final static String i_LINE_NO = null;

	// 第 90 変数初期値： i_LINE_TYP

	final static String i_LINE_TYP = null;

	// 第 91 変数初期値： i_COMM_CD

	final static String i_COMM_CD = null;

	// 第 92 変数初期値： i_COMM_NAME
	...
	// 第 94 変数初期値： i_TAX_CD_2

	final static String i_TAX_CD_2 = null;

	// 第 95 変数初期値： i_INP_UNIT_PRICE

	final static String i_INP_UNIT_PRICE = null;

	// 第 96 変数初期値： i_UNIT_COST_TYP

	final static String i_UNIT_COST_TYP = null;

	// 第 97 変数初期値： i_SLIP_QTY

	final static String i_SLIP_QTY = null;

	// 第 98 変数初期値： i_PART_DLV_TIMES

	final static String i_PART_DLV_TIMES = null;

	// 第 99 変数初期値： i_PART_DLV_TYP

	final static String i_PART_DLV_TYP = null;

	// 第 100 変数初期値： i_CUST_COMM_CD

	final static String i_CUST_COMM_CD = null;

	// 第 101 変数初期値： i_CUST_COMM_NAME

	final static String i_CUST_COMM_NAME = null;

	// 第 102 変数初期値： i_CUST_ODR_SLIP_CD

	final static String i_CUST_ODR_SLIP_CD = null;

	// 第 103 変数初期値： i_CUST_UNIT_PRICE_TYP

	final static String i_CUST_UNIT_PRICE_TYP = null;

	// 第 104 変数初期値： i_OWN_CUR_SALES_AMOUNT

	final static String i_OWN_CUR_SALES_AMOUNT = null;

	// 第 105 変数初期値： i_STOCK_CTRL_FLG
	...
	// 第 107 変数初期値： i_SLIP_CD2

	final static String i_SLIP_CD2 = null;

	// 第 108 変数初期値： i_SYSTEMDATE

	final static String i_SYSTEMDATE = null;

	// 第 109 変数初期値： i_SYSTEMUSER

	final static String i_SYSTEMUSER = null;

	// 第 110 変数初期値： i_PROGRAMID
	...
	public void initialize()
	{
		...
		m_SLIP_CD = i_SLIP_CD;
		m_FINAL_DLV_LOC_CD = i_FINAL_DLV_LOC_CD;
		...
		m_PURPOSE_UNIT_PRICE_TYP = i_PURPOSE_UNIT_PRICE_TYP;
		m_SHIP_PLAN_DATE = i_SHIP_PLAN_DATE;
		m_SCDL_DLV_DATE = i_SCDL_DLV_DATE;
		m_UNCNFM_CUST_ODR_CREATE_DATE = i_UNCNFM_CUST_ODR_CREATE_DATE;
		m_CUS_DLV_KEY_CD = i_CUS_DLV_KEY_CD;
		m_AMOUNT_TYP = i_AMOUNT_TYP;
		m_ODR_CMPLT_FLG = i_ODR_CMPLT_FLG;
		m_SHIP_COUNT = i_SHIP_COUNT;
		m_CUST_NAME = i_CUST_NAME;
		m_TAX_CALC_TYP = i_TAX_CALC_TYP;
		m_TAX_APPLY_TYP = i_TAX_APPLY_TYP;
		m_TEMP_UNIT_PRICE_SALES_FLG = i_TEMP_UNIT_PRICE_SALES_FLG;
		m_CLAIM_CYCLE_TYP = i_CLAIM_CYCLE_TYP;
		m_RM_INP_TYP = i_RM_INP_TYP;
		m_CUR_CD = i_CUR_CD;
		m_EXCH_TYP = i_EXCH_TYP;
		m_TAX_CD = i_TAX_CD;
		m_CUST_VARIOUS_TYP = i_CUST_VARIOUS_TYP;
		m_SLIP_PRINTING_TYP_1 = i_SLIP_PRINTING_TYP_1;
		m_SLIP_PRINTING_TYP_2 = i_SLIP_PRINTING_TYP_2;
		m_SLIP_PRINTING_TYP_3 = i_SLIP_PRINTING_TYP_3;
		m_SLIP_PRINTING_TYP_4 = i_SLIP_PRINTING_TYP_4;
		m_SLIP_PRINTING_TYP_5 = i_SLIP_PRINTING_TYP_5;
		m_PRICE_RANK_CD = i_PRICE_RANK_CD;
		m_INSPC_ACPT_TYP = i_INSPC_ACPT_TYP;
		m_PRICE_ROUND_TYP = i_PRICE_ROUND_TYP;
		m_SHIP_SLIP_ID = i_SHIP_SLIP_ID;
		m_CARRIAGE_CHARGE_TYP = i_CARRIAGE_CHARGE_TYP;
		m_BILL_ADDRESSEE_CD = i_BILL_ADDRESSEE_CD;
		m_STL_COND_CD = i_STL_COND_CD;
		...
		m_COMM_CD = i_COMM_CD;
		m_COMM_NAME = i_COMM_NAME;
		m_SPEC = i_SPEC;
		m_TAX_CD_2 = i_TAX_CD_2;
		m_INP_UNIT_PRICE = i_INP_UNIT_PRICE;
		m_UNIT_COST_TYP = i_UNIT_COST_TYP;
		m_SLIP_QTY = i_SLIP_QTY;
		m_PART_DLV_TIMES = i_PART_DLV_TIMES;
		m_PART_DLV_TYP = i_PART_DLV_TYP;
		m_CUST_COMM_CD = i_CUST_COMM_CD;
		m_CUST_COMM_NAME = i_CUST_COMM_NAME;
		m_CUST_ODR_SLIP_CD = i_CUST_ODR_SLIP_CD;
		m_CUST_UNIT_PRICE_TYP = i_CUST_UNIT_PRICE_TYP;
		m_OWN_CUR_SALES_AMOUNT = i_OWN_CUR_SALES_AMOUNT;
		m_STOCK_CTRL_FLG = i_STOCK_CTRL_FLG;
		m_DUMMY = i_DUMMY;
		m_SLIP_CD2 = i_SLIP_CD2;
		m_SYSTEMDATE = i_SYSTEMDATE;
		m_SYSTEMUSER = i_SYSTEMUSER;
		m_PROGRAMID = i_PROGRAMID;
	}
