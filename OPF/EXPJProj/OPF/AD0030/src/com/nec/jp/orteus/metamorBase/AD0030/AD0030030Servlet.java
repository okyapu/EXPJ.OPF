/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AD0030/src/com/nec/jp/orteus/metamorBase/AD0030/AD0030030Servlet.java,v $
 *
...
public class AD0030030Servlet extends HttpServlet
{
	 ...
	 * @param control AD0030030Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AD0030030Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AD0030030Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AD0030030Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AD0030030Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AD0030030Entity entity = control.entity;
		AD0030030Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AD0030030Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
			// TODO: ユーザ定義のコードを記述してください
//			objMessage.m_writer.write( Level.ALL, "AD0030030"+" $Revision: 1.20 $" );
			control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AD0030030Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AD0030030Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AD0030030Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AD0030");
		logger.entering("AD0030030Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
...
//			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AD0030030-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
		}
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AD0030030Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickSelect(
					...
					HttpSession so,
					Hashtable params,
					AD0030030Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AD0030030Entity entity = control.entity;
		AD0030030Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AD0030");
		logger.entering("AD0030030Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickSelect>
		logger.exiting("AD0030030Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
					...
					AD0030030Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AD0030");
		logger.entering("AD0030030Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("AD0030030Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
					...
					AD0030030Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AD0030");
		logger.entering("AD0030030Servlet"+":USER="+request.getRemoteUser(),"onClickUpdateAll");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickUpdateAll>
		logger.exiting("AD0030030Servlet"+":USER="+request.getRemoteUser(),"onClickUpdateAll");
					...
					AD0030030Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AD0030");
		logger.entering("AD0030030Servlet"+":USER="+request.getRemoteUser(),"onClickUpdateAssort");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickUpdateAssort>
		logger.exiting("AD0030030Servlet"+":USER="+request.getRemoteUser(),"onClickUpdateAssort");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AD0030030Struct struct)
	{
		...
		String[] c_OUTPUT_RSLT = ((params.containsKey("c_OUTPUT_RSLT")) ? (String[])params.get("c_OUTPUT_RSLT") : (String[])null);
		...
		String[] c_OUTSIDE_TYP_IN = ((params.containsKey("c_OUTSIDE_TYP_IN")) ? (String[])params.get("c_OUTSIDE_TYP_IN") : (String[])null);
		String[] JOB_ODR_CD = ((params.containsKey("JOB_ODR_CD")) ? (String[])params.get("JOB_ODR_CD") : (String[])null);
		String[] c_OUTSIDE_TYP_OUT = ((params.containsKey("c_OUTSIDE_TYP_OUT")) ? (String[])params.get("c_OUTSIDE_TYP_OUT") : (String[])null);
		...
		struct.setc_OUTPUT_RSLT( ((c_OUTPUT_RSLT == null) ? (String)null : c_OUTPUT_RSLT[0]) );
		struct.setList_c_OUTPUT_RSLT(TypeConverter.convert(c_OUTPUT_RSLT));
		...
		struct.setc_OUTSIDE_TYP_IN( ((c_OUTSIDE_TYP_IN == null) ? (String)null : c_OUTSIDE_TYP_IN[0]) );
		struct.setList_c_OUTSIDE_TYP_IN(TypeConverter.convert(c_OUTSIDE_TYP_IN));
		struct.setJOB_ODR_CD( ((JOB_ODR_CD == null) ? (String)null : JOB_ODR_CD[0]) );
		struct.setList_JOB_ODR_CD(TypeConverter.convert(JOB_ODR_CD));
		struct.setc_OUTSIDE_TYP_OUT( ((c_OUTSIDE_TYP_OUT == null) ? (String)null : c_OUTSIDE_TYP_OUT[0]) );
		struct.setList_c_OUTSIDE_TYP_OUT(TypeConverter.convert(c_OUTSIDE_TYP_OUT));
	...
	public static String DEFAULT_TARGET = "/AD0030030.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAD0030030Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAD0030030Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AD0030");
		logger.entering("AD0030030Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AD0030030Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AD0030030Control control;
		AD0030030Entity  entity = null;
		AD0030030Struct  struct = null;
		...
		try {
			...
			if( (control = (AD0030030Control)so.getAttribute("AD0030030Control_"+request.getSession(false).getId())) == null ) {
				control = new AD0030030Control();
			...
			try {
				...
				so.setAttribute("AD0030030Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.AD0030.AD0030030Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AD0030030Servlet()
	{
		//{{user_implement_dev:<AD0030030_DisConnect_FLG>
		...
		//{{user_implement_dev:<AD0030030Servlet>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<AD0030030Servlet>
	}
