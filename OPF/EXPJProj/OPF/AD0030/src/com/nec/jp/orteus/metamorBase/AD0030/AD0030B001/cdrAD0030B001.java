/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AD0030/src/com/nec/jp/orteus/metamorBase/AD0030/AD0030B001/cdrAD0030B001.java,v $
 *
...
/**
 * CLASS     : cdrAD0030B001 クラス
 * ファイル・クラス説明
 * @author $Author: shan-xiuqin $
 * @version $Revision: 1.21 $ $Date: 2016/05/23 08:12:44 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class cdrAD0030B001 extends Object
		implements IBatchAppCommon
{
	...
	public void initialize() throws BatchAppException, SystemException
	{
		try {
			...
			m_med.setcallSqlExpandByProc( new callSqlExpandByProc(m_med, m_conductor) );
			...
			m_conductor.addObject( m_med.getcallSqlExpandByProc() );
	...
	public int beginProc() throws BatchAppException
	{
		try {
			...
			setCommitFlag(false);
			BatchAppException be=new BatchAppException("cdrAD0030B001", "beginProc", "conductorの初期処理に失敗しました");
	...
	medAD0030B001 m_med=new medAD0030B001();

	// BatchAppConductorクラスインスタンス
	BatchAppConductor m_conductor=new BatchAppConductor("AD0030B001");
	...
	/**
	 * ctrAD0030B001クラス 標準コンストラクタ
	 *
		 */
	public cdrAD0030B001() throws BatchAppException
	{
		initialize();
