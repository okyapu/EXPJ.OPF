/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AD0030/src/com/nec/jp/orteus/metamorBase/AD0030/AD0030B001/callSqlExpandByProc.java,v $
 *
...
public class callSqlExpandByProc extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public List call() throws BatchAppException
		{
			try {
				...
				cstmt.setString(8, m_med.getpvc2OprInstStartDate());
				cstmt.setString(9, m_med.getpvc2WorkOdrDlvDate());
				...
				e.printStackTrace();
				BatchAppException be=new BatchAppException("callSqlExpandByProc", "call", "Stored Procedure条件設定処理失敗");
				...
				if (cstmt != null) {
					try {
						...
						ef.printStackTrace();
						BatchAppException bef = new BatchAppException("callSqlExpandByProc", "call", "Stored Procedureクローズ処理失敗");
		 ...
		 */
		public medAD0030B001 call(ResultSet rs) throws SQLException
		{
			if(rs == null || rs.next()==false) return null;
			medAD0030B001 data = new medAD0030B001();
			return data;
		}
	...
	/**
	 * callSqlExpandByProcクラスの標準コンストラクタ
	 *
		 */
	public callSqlExpandByProc(medAD0030B001 med, BatchAppConductor cdr) throws SystemException
	{
	...
	protected static String m_calcmd = "{" + "call SQLEXPANDBYPROC(?,?,?,?,?,?,?,?,?,?)" + "}";
