/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AD0030/src/com/nec/jp/orteus/metamorBase/AD0030/AD0030B002/mainAD0030B002.java,v $
 *
...
/**
 * CLASS     : mainAD0030B002 クラス
 * ファイル・クラス説明
 * @author $Author: shan-xiuqin $
 * @version $Revision: 1.22 $ $Date: 2016/05/23 08:12:47 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class mainAD0030B002
{
    // リターン値
	...
	public static void main(String args[])
	{
		...
		try {
			...
			if (sysLog == null) {
				...
				if(!sysLog.init("com.nec.jp.orteus.metamorBase.AD0030B002")) {
					//システムログの初期化に失敗しました
			...
			try {
				...
				// 標準出力ファイル名設定
				String logFileName = "AD0030B002.log";
				if (logFileName == null) {
				...
				// 新規作成のためバッチログファイル削除
				if (blogMode == false) {
					File logFile = new File(logOutputPath + "/AD0030B002.log");
				...
				System.setOut(new PrintStream(new FileOutputStream(logOutputPath + "/AD0030B002stdout.log", blogMode)));
				System.setErr(new PrintStream(new FileOutputStream(logOutputPath + "/AD0030B002stderr.log", blogMode)));
			...
			cdrAD0030B002 ebo = new cdrAD0030B002();
