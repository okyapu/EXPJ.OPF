/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AD0030/src/com/nec/jp/orteus/metamorBase/AD0030/AD0030040Servlet.java,v $
 *
...
public class AD0030040Servlet extends HttpServlet
{
	 ...
	 * @param control AD0030040Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AD0030040Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AD0030040Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AD0030040Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AD0030040Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AD0030040Entity entity = control.entity;
		AD0030040Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AD0030040Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
			// TODO: ユーザ定義のコードを記述してください
//			objMessage.m_writer.write( Level.ALL, "AD0030040"+" $Revision: 1.20 $" );
			control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AD0030040Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AD0030040Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AD0030040Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AD0030");
		logger.entering("AD0030040Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
...
//			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AD0030040-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
		}
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AD0030040Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickSelect(
					...
					HttpSession so,
					Hashtable params,
					AD0030040Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AD0030040Entity entity = control.entity;
		AD0030040Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AD0030");
		logger.entering("AD0030040Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickSelect>
		logger.exiting("AD0030040Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
					...
					AD0030040Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AD0030");
		logger.entering("AD0030040Servlet"+":USER="+request.getRemoteUser(),"onClickPrint");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickPrint>
		logger.exiting("AD0030040Servlet"+":USER="+request.getRemoteUser(),"onClickPrint");
					...
					AD0030040Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AD0030");
		logger.entering("AD0030040Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("AD0030040Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
	 ...
	 * @param control AD0030040Controlクラスインスタンス
	 */
	public String onClickCardPrint(
					HttpServletRequest request,
					HttpServletResponse response,
					HttpSession so,
					Hashtable params,
					AD0030040Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AD0030");
		logger.entering("AD0030040Servlet"+":USER="+request.getRemoteUser(),"onClickCardPrint");
		//{{user_implement_dev:<onClickCardPrint>
			// TODO: ユーザ定義のコードを記述してください
		try {
			control.control_eventHandller("CardPrint");
		} catch(FoundationException e) {
//			e.printStackTrace();
			// エラー処理を記述してください。
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
                ...
                //}}user_implement_dev:<onClickCardPrint>
		logger.exiting("AD0030040Servlet"+":USER="+request.getRemoteUser(),"onClickCardPrint");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AD0030040Struct struct)
	{
		...
		String[] r1_MODE = ((params.containsKey("r1_MODE")) ? (String[])params.get("r1_MODE") : (String[])null);
		...
		String[] r2_MODE = ((params.containsKey("r2_MODE")) ? (String[])params.get("r2_MODE") : (String[])null);
		String[] JOB_ODR_CD = ((params.containsKey("JOB_ODR_CD")) ? (String[])params.get("JOB_ODR_CD") : (String[])null);
		String[] ITEM_CD = ((params.containsKey("ITEM_CD")) ? (String[])params.get("ITEM_CD") : (String[])null);
		String[] PRINT_PATTERN = ((params.containsKey("PRINT_PATTERN")) ? (String[])params.get("PRINT_PATTERN") : (String[])null);
		...
		String[] l_WORK_IN_PROC_COMMENT = ((params.containsKey("l_WORK_IN_PROC_COMMENT")) ? (String[])params.get("l_WORK_IN_PROC_COMMENT") : (String[])null);
		...
		String[] l_OPR_INST_SLIP_ISS_FLG_DN = ((params.containsKey("l_OPR_INST_SLIP_ISS_FLG_DN")) ? (String[])params.get("l_OPR_INST_SLIP_ISS_FLG_DN") : (String[])null);
		String[] l_OPR_INST_SLIP_ISS_FLG = ((params.containsKey("l_OPR_INST_SLIP_ISS_FLG")) ? (String[])params.get("l_OPR_INST_SLIP_ISS_FLG") : (String[])null);
		String[] l_MODIFY_COUNT = ((params.containsKey("l_MODIFY_COUNT")) ? (String[])params.get("l_MODIFY_COUNT") : (String[])null);
		String[] DATE = ((params.containsKey("DATE")) ? (String[])params.get("DATE") : (String[])null);
		String[] TIME = ((params.containsKey("TIME")) ? (String[])params.get("TIME") : (String[])null);
		String[] PAGE = ((params.containsKey("PAGE")) ? (String[])params.get("PAGE") : (String[])null);
		...
		String[] BARCODE1 = ((params.containsKey("BARCODE1")) ? (String[])params.get("BARCODE1") : (String[])null);
		...
		String[] OPR_INST_START_TIME = ((params.containsKey("OPR_INST_START_TIME")) ? (String[])params.get("OPR_INST_START_TIME") : (String[])null);
		String[] WORK_ODR_DLV_TIME = ((params.containsKey("WORK_ODR_DLV_TIME")) ? (String[])params.get("WORK_ODR_DLV_TIME") : (String[])null);
		String[] TIME_CTRL = ((params.containsKey("TIME_CTRL")) ? (String[])params.get("TIME_CTRL") : (String[])null);
		String[] c_CARD_PRINT = ((params.containsKey("c_CARD_PRINT")) ? (String[])params.get("c_CARD_PRINT") : (String[])null);
		String[] INST_PRINTED = ((params.containsKey("INST_PRINTED")) ? (String[])params.get("INST_PRINTED") : (String[])null);
		String[] l_CARD_PRINTED_FLG = ((params.containsKey("l_CARD_PRINTED_FLG")) ? (String[])params.get("l_CARD_PRINTED_FLG") : (String[])null);
		...
		struct.setr1_MODE( ((r1_MODE == null) ? (String)null : r1_MODE[0]) );
		struct.setList_r1_MODE(TypeConverter.convert(r1_MODE));
		...
		struct.setr2_MODE( ((r2_MODE == null) ? (String)null : r2_MODE[0]) );
		struct.setList_r2_MODE(TypeConverter.convert(r2_MODE));
		...
		struct.setPRINT_PATTERN( ((PRINT_PATTERN == null) ? (String)null : PRINT_PATTERN[0]) );
		struct.setList_PRINT_PATTERN(TypeConverter.convert(PRINT_PATTERN));
		...
		struct.setl_WORK_IN_PROC_COMMENT( ((l_WORK_IN_PROC_COMMENT == null) ? (String)null : l_WORK_IN_PROC_COMMENT[0]) );
		struct.setList_l_WORK_IN_PROC_COMMENT(TypeConverter.convert(l_WORK_IN_PROC_COMMENT));
		...
		struct.setl_OPR_INST_SLIP_ISS_FLG_DN( ((l_OPR_INST_SLIP_ISS_FLG_DN == null) ? (String)null : l_OPR_INST_SLIP_ISS_FLG_DN[0]) );
		struct.setList_l_OPR_INST_SLIP_ISS_FLG_DN(TypeConverter.convert(l_OPR_INST_SLIP_ISS_FLG_DN));
		struct.setl_OPR_INST_SLIP_ISS_FLG( ((l_OPR_INST_SLIP_ISS_FLG == null) ? (String)null : l_OPR_INST_SLIP_ISS_FLG[0]) );
		struct.setList_l_OPR_INST_SLIP_ISS_FLG(TypeConverter.convert(l_OPR_INST_SLIP_ISS_FLG));
		...
		struct.setDATE( ((DATE == null) ? (String)null : DATE[0]) );
		struct.setList_DATE(TypeConverter.convert(DATE));
		struct.setTIME( ((TIME == null) ? (String)null : TIME[0]) );
		struct.setList_TIME(TypeConverter.convert(TIME));
		struct.setPAGE( ((PAGE == null) ? (String)null : PAGE[0]) );
		struct.setList_PAGE(TypeConverter.convert(PAGE));
		...
		struct.setBARCODE1( ((BARCODE1 == null) ? (String)null : BARCODE1[0]) );
		struct.setList_BARCODE1(TypeConverter.convert(BARCODE1));
		...
		struct.setOPR_INST_START_TIME( ((OPR_INST_START_TIME == null) ? (String)null : OPR_INST_START_TIME[0]) );
		struct.setList_OPR_INST_START_TIME(TypeConverter.convert(OPR_INST_START_TIME));
		struct.setWORK_ODR_DLV_TIME( ((WORK_ODR_DLV_TIME == null) ? (String)null : WORK_ODR_DLV_TIME[0]) );
		struct.setList_WORK_ODR_DLV_TIME(TypeConverter.convert(WORK_ODR_DLV_TIME));
		struct.setTIME_CTRL( ((TIME_CTRL == null) ? (String)null : TIME_CTRL[0]) );
		struct.setList_TIME_CTRL(TypeConverter.convert(TIME_CTRL));
		struct.setc_CARD_PRINT( ((c_CARD_PRINT == null) ? (String)null : c_CARD_PRINT[0]) );
		struct.setList_c_CARD_PRINT(TypeConverter.convert(c_CARD_PRINT));
		struct.setINST_PRINTED( ((INST_PRINTED == null) ? (String)null : INST_PRINTED[0]) );
		struct.setList_INST_PRINTED(TypeConverter.convert(INST_PRINTED));
		struct.setl_CARD_PRINTED_FLG( ((l_CARD_PRINTED_FLG == null) ? (String)null : l_CARD_PRINTED_FLG[0]) );
		struct.setList_l_CARD_PRINTED_FLG(TypeConverter.convert(l_CARD_PRINTED_FLG));
	...
	public static String DEFAULT_TARGET = "/AD0030040.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAD0030040Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAD0030040Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AD0030");
		logger.entering("AD0030040Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AD0030040Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AD0030040Control control;
		AD0030040Entity  entity = null;
		AD0030040Struct  struct = null;
		...
		try {
			...
			if( (control = (AD0030040Control)so.getAttribute("AD0030040Control_"+request.getSession(false).getId())) == null ) {
				control = new AD0030040Control();
			...
			try {
				...
				} else if( isClick(request, "CardPrint") ) {
					if ( !isCryptical(request, so, params, "CardPrint") ) return ERROR_TARGET;
					target = onClickCardPrint(request, response, so, params, control);
					control.setButton("CardPrint");
				} else {
					target = defaultEvent(request, response, so, params, control, refererURL);
				}

				so.setAttribute("AD0030040Control_"+request.getSession(false).getId(),control);
				...
				|| (isClick(request, "CardPrint") && bFLG_DISCONNECT_CardPrint)
				) {
	...
	private  static boolean bFLG_DISCONNECT_CardPrint = true;
	...
	{
		return "com.nec.jp.orteus.metamorBase.AD0030.AD0030040Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AD0030040Servlet()
	{
		//{{user_implement_dev:<AD0030040_DisConnect_FLG>
		...
		//{{user_implement_dev:<AD0030040Servlet>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<AD0030040Servlet>
	}
