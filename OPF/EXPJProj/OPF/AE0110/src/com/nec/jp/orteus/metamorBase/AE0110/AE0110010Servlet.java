/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0110/src/com/nec/jp/orteus/metamorBase/AE0110/AE0110010Servlet.java,v $
 *
...
public class AE0110010Servlet extends HttpServlet
{
	 ...
	 * @param control AE0110010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AE0110010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AE0110010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AE0110010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AE0110010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AE0110010Entity entity = control.entity;
		AE0110010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AE0110010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
			// TODO: ユーザ定義のコードを記述してください
//			LogWriter.write( Level.ALL, "AE0110010"+" $Revision: 1.8 $" );
			control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AE0110010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AE0110010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AE0110010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0110");
		logger.entering("AE0110010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
...
//			e.printStackTrace();
//			LogWriter.write(Level.ALL, objMessage.getIDMsg("AE0110010-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
		}
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AE0110010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickSelect(
					...
					HttpSession so,
					Hashtable params,
					AE0110010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AE0110010Entity entity = control.entity;
		AE0110010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0110");
		logger.entering("AE0110010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickSelect>
		logger.exiting("AE0110010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
					...
					AE0110010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0110");
		logger.entering("AE0110010Servlet"+":USER="+request.getRemoteUser(),"onClickCsvOut");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickCsvOut>
		logger.exiting("AE0110010Servlet"+":USER="+request.getRemoteUser(),"onClickCsvOut");
					...
					AE0110010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0110");
		logger.entering("AE0110010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("AE0110010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AE0110010Struct struct)
	{
		...
		String[] ISSUE_DATE_FROM = ((params.containsKey("ISSUE_DATE_FROM")) ? (String[])params.get("ISSUE_DATE_FROM") : (String[])null);
		String[] ISSUE_DATE_TO = ((params.containsKey("ISSUE_DATE_TO")) ? (String[])params.get("ISSUE_DATE_TO") : (String[])null);
		...
		String[] r1_RETURNED_GNR_TYP = ((params.containsKey("r1_RETURNED_GNR_TYP")) ? (String[])params.get("r1_RETURNED_GNR_TYP") : (String[])null);
		...
		String[] ONEROUS_CONS_NO = ((params.containsKey("ONEROUS_CONS_NO")) ? (String[])params.get("ONEROUS_CONS_NO") : (String[])null);
		String[] l_PLANT_CD = ((params.containsKey("l_PLANT_CD")) ? (String[])params.get("l_PLANT_CD") : (String[])null);
		String[] l_ONEROUS_CONS_NO = ((params.containsKey("l_ONEROUS_CONS_NO")) ? (String[])params.get("l_ONEROUS_CONS_NO") : (String[])null);
		...
		String[] l_UNIT_COST_DN = ((params.containsKey("l_UNIT_COST_DN")) ? (String[])params.get("l_UNIT_COST_DN") : (String[])null);
		String[] l_VEND_LOT_NO = ((params.containsKey("l_VEND_LOT_NO")) ? (String[])params.get("l_VEND_LOT_NO") : (String[])null);
		String[] l_RCV_ISSUE_CTRL_CD = ((params.containsKey("l_RCV_ISSUE_CTRL_CD")) ? (String[])params.get("l_RCV_ISSUE_CTRL_CD") : (String[])null);
		...
		String[] l_RETURNED_WH_CD = ((params.containsKey("l_RETURNED_WH_CD")) ? (String[])params.get("l_RETURNED_WH_CD") : (String[])null);
		String[] l_WH_NAME = ((params.containsKey("l_WH_NAME")) ? (String[])params.get("l_WH_NAME") : (String[])null);
		String[] l_RETURNED_GNR_TYP_DN = ((params.containsKey("l_RETURNED_GNR_TYP_DN")) ? (String[])params.get("l_RETURNED_GNR_TYP_DN") : (String[])null);
		String[] l_AP_PROC_TYP_DN = ((params.containsKey("l_AP_PROC_TYP_DN")) ? (String[])params.get("l_AP_PROC_TYP_DN") : (String[])null);
		String[] l_RETURNED_CAUSE_CD = ((params.containsKey("l_RETURNED_CAUSE_CD")) ? (String[])params.get("l_RETURNED_CAUSE_CD") : (String[])null);
		String[] l_STOCK_UNIT = ((params.containsKey("l_STOCK_UNIT")) ? (String[])params.get("l_STOCK_UNIT") : (String[])null);
		String[] r2_RETURNED_GNR_TYP = ((params.containsKey("r2_RETURNED_GNR_TYP")) ? (String[])params.get("r2_RETURNED_GNR_TYP") : (String[])null);
		String[] r3_RETURNED_GNR_TYP = ((params.containsKey("r3_RETURNED_GNR_TYP")) ? (String[])params.get("r3_RETURNED_GNR_TYP") : (String[])null);
		...
		struct.setISSUE_DATE_FROM( ((ISSUE_DATE_FROM == null) ? (String)null : ISSUE_DATE_FROM[0]) );
		struct.setList_ISSUE_DATE_FROM(TypeConverter.convert(ISSUE_DATE_FROM));
		struct.setISSUE_DATE_TO( ((ISSUE_DATE_TO == null) ? (String)null : ISSUE_DATE_TO[0]) );
		struct.setList_ISSUE_DATE_TO(TypeConverter.convert(ISSUE_DATE_TO));
		...
		struct.setr1_RETURNED_GNR_TYP( ((r1_RETURNED_GNR_TYP == null) ? (String)null : r1_RETURNED_GNR_TYP[0]) );
		struct.setList_r1_RETURNED_GNR_TYP(TypeConverter.convert(r1_RETURNED_GNR_TYP));
		...
		struct.setONEROUS_CONS_NO( ((ONEROUS_CONS_NO == null) ? (String)null : ONEROUS_CONS_NO[0]) );
		struct.setList_ONEROUS_CONS_NO(TypeConverter.convert(ONEROUS_CONS_NO));
		struct.setl_PLANT_CD( ((l_PLANT_CD == null) ? (String)null : l_PLANT_CD[0]) );
		struct.setList_l_PLANT_CD(TypeConverter.convert(l_PLANT_CD));
		struct.setl_ONEROUS_CONS_NO( ((l_ONEROUS_CONS_NO == null) ? (String)null : l_ONEROUS_CONS_NO[0]) );
		struct.setList_l_ONEROUS_CONS_NO(TypeConverter.convert(l_ONEROUS_CONS_NO));
		...
		struct.setl_UNIT_COST_DN( ((l_UNIT_COST_DN == null) ? (String)null : l_UNIT_COST_DN[0]) );
		struct.setList_l_UNIT_COST_DN(TypeConverter.convert(l_UNIT_COST_DN));
		...
		struct.setl_RCV_ISSUE_CTRL_CD( ((l_RCV_ISSUE_CTRL_CD == null) ? (String)null : l_RCV_ISSUE_CTRL_CD[0]) );
		struct.setList_l_RCV_ISSUE_CTRL_CD(TypeConverter.convert(l_RCV_ISSUE_CTRL_CD));
		...
		struct.setl_RETURNED_WH_CD( ((l_RETURNED_WH_CD == null) ? (String)null : l_RETURNED_WH_CD[0]) );
		struct.setList_l_RETURNED_WH_CD(TypeConverter.convert(l_RETURNED_WH_CD));
		struct.setl_WH_NAME( ((l_WH_NAME == null) ? (String)null : l_WH_NAME[0]) );
		struct.setList_l_WH_NAME(TypeConverter.convert(l_WH_NAME));
		struct.setl_RETURNED_GNR_TYP_DN( ((l_RETURNED_GNR_TYP_DN == null) ? (String)null : l_RETURNED_GNR_TYP_DN[0]) );
		struct.setList_l_RETURNED_GNR_TYP_DN(TypeConverter.convert(l_RETURNED_GNR_TYP_DN));
		struct.setl_AP_PROC_TYP_DN( ((l_AP_PROC_TYP_DN == null) ? (String)null : l_AP_PROC_TYP_DN[0]) );
		struct.setList_l_AP_PROC_TYP_DN(TypeConverter.convert(l_AP_PROC_TYP_DN));
		struct.setl_RETURNED_CAUSE_CD( ((l_RETURNED_CAUSE_CD == null) ? (String)null : l_RETURNED_CAUSE_CD[0]) );
		struct.setList_l_RETURNED_CAUSE_CD(TypeConverter.convert(l_RETURNED_CAUSE_CD));
		...
		struct.setr2_RETURNED_GNR_TYP( ((r2_RETURNED_GNR_TYP == null) ? (String)null : r2_RETURNED_GNR_TYP[0]) );
		struct.setList_r2_RETURNED_GNR_TYP(TypeConverter.convert(r2_RETURNED_GNR_TYP));
		struct.setr3_RETURNED_GNR_TYP( ((r3_RETURNED_GNR_TYP == null) ? (String)null : r3_RETURNED_GNR_TYP[0]) );
		struct.setList_r3_RETURNED_GNR_TYP(TypeConverter.convert(r3_RETURNED_GNR_TYP));
	...
	public static String DEFAULT_TARGET = "/AE0110010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAE0110010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAE0110010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0110");
		logger.entering("AE0110010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AE0110010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AE0110010Control control;
		AE0110010Entity  entity = null;
		AE0110010Struct  struct = null;
		...
		try {
			...
			if( (control = (AE0110010Control)so.getAttribute("AE0110010Control_"+request.getSession(false).getId())) == null ) {
				control = new AE0110010Control();
			...
			try {
				...
				so.setAttribute("AE0110010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.AE0110.AE0110010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AE0110010Servlet()
	{
		//{{user_implement_dev:<AE0110010_DisConnect_FLG>
		...
		//{{user_implement_dev:<AE0110010Servlet>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<AE0110010Servlet>
	}
