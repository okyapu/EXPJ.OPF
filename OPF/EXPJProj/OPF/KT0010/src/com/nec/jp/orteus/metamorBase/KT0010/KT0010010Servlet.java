/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KT0010/src/com/nec/jp/orteus/metamorBase/KT0010/KT0010010Servlet.java,v $
 *
...
public class KT0010010Servlet extends HttpServlet
{
	 ...
	 * @param control KT0010010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, KT0010010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control KT0010010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, KT0010010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					KT0010010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		KT0010010Entity entity = control.entity;
		KT0010010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("KT0010010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
                 // TODO: ユーザ定義のコードを記述してください
              //			objMessage.m_writer.write( Level.ALL, "KT0010010"+" $Revision: 1.11 $" );
                 control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("KT0010010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					KT0010010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		KT0010010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KT0010");
		logger.entering("KT0010010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
		...
		//{{user_implement_dev:<reloadEvent>
              ...
              //			e.printStackTrace();
              //			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("KT0010010-E999","リロード処理"));
                 ExpjException ee = new ExpjException(e, "ZZ01106");
                 throw ee;
                }
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("KT0010010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickSelect(
					...
					HttpSession so,
					Hashtable params,
					KT0010010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		KT0010010Entity entity = control.entity;
		KT0010010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KT0010");
		logger.entering("KT0010010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
		//{{user_implement_dev:<onClickSelect>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickSelect>
		logger.exiting("KT0010010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
					...
					KT0010010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KT0010");
		logger.entering("KT0010010Servlet"+":USER="+request.getRemoteUser(),"onClickInsert");
		//{{user_implement_dev:<onClickInsert>
                 // TODO: ユーザ定義のコードを記述してください
                try {
                 // 選択情報の設定
                 struct.setList_KT0010010view1_selected(TypeConverter.convert((String[])params.get("KT0010010view1_selected")));
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickInsert>
		logger.exiting("KT0010010Servlet"+":USER="+request.getRemoteUser(),"onClickInsert");
					...
					KT0010010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KT0010");
		logger.entering("KT0010010Servlet"+":USER="+request.getRemoteUser(),"onClickLineCopy");
		//{{user_implement_dev:<onClickLineCopy>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickLineCopy>
		logger.exiting("KT0010010Servlet"+":USER="+request.getRemoteUser(),"onClickLineCopy");
					...
					KT0010010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KT0010");
		logger.entering("KT0010010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
		//{{user_implement_dev:<onClickClear>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("KT0010010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
					...
					KT0010010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KT0010");
		logger.entering("KT0010010Servlet"+":USER="+request.getRemoteUser(),"onClickUpdate");
		//{{user_implement_dev:<onClickUpdate>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickUpdate>
		logger.exiting("KT0010010Servlet"+":USER="+request.getRemoteUser(),"onClickUpdate");
					...
					KT0010010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KT0010");
		logger.entering("KT0010010Servlet"+":USER="+request.getRemoteUser(),"onClickDelete");
		//{{user_implement_dev:<onClickDelete>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickDelete>
		logger.exiting("KT0010010Servlet"+":USER="+request.getRemoteUser(),"onClickDelete");
					...
					KT0010010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KT0010");
		logger.entering("KT0010010Servlet"+":USER="+request.getRemoteUser(),"onClickCheckAll");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickCheckAll>
		logger.exiting("KT0010010Servlet"+":USER="+request.getRemoteUser(),"onClickCheckAll");
	 ...
	 * @param control KT0010010Controlクラスインスタンス
	 */
	public String onClickUncheckAll(
					HttpServletRequest request,
					HttpServletResponse response,
					HttpSession so,
					Hashtable params,
					KT0010010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KT0010");
		logger.entering("KT0010010Servlet"+":USER="+request.getRemoteUser(),"onClickUncheckAll");
		//{{user_implement_dev:<onClickUncheckAll>
			// TODO: ユーザ定義のコードを記述してください
		try {
			control.control_eventHandller("UncheckAll");
		} catch(FoundationException e) {
//			e.printStackTrace();
			// エラー処理を記述してください。
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
                ...
                //}}user_implement_dev:<onClickUncheckAll>
		logger.exiting("KT0010010Servlet"+":USER="+request.getRemoteUser(),"onClickUncheckAll");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, KT0010010Struct struct)
	{
		...
		String[] l_SHIP_PLAN_REMAIN_QTY = ((params.containsKey("l_SHIP_PLAN_REMAIN_QTY")) ? (String[])params.get("l_SHIP_PLAN_REMAIN_QTY") : (String[])null);
		...
		String[] l_DESINATED_SHIP_QTY = ((params.containsKey("l_DESINATED_SHIP_QTY")) ? (String[])params.get("l_DESINATED_SHIP_QTY") : (String[])null);
		...
		String[] r1_STS_TYP = ((params.containsKey("r1_STS_TYP")) ? (String[])params.get("r1_STS_TYP") : (String[])null);
		String[] r2_STS_TYP = ((params.containsKey("r2_STS_TYP")) ? (String[])params.get("r2_STS_TYP") : (String[])null);
		String[] l_MODIFY_COUNT = ((params.containsKey("l_MODIFY_COUNT")) ? (String[])params.get("l_MODIFY_COUNT") : (String[])null);
		String[] l_bk_DESINATED_SHIP_QTY = ((params.containsKey("l_bk_DESINATED_SHIP_QTY")) ? (String[])params.get("l_bk_DESINATED_SHIP_QTY") : (String[])null);
		...
		String[] l_PKG_UNIT = ((params.containsKey("l_PKG_UNIT")) ? (String[])params.get("l_PKG_UNIT") : (String[])null);
		...
		String[] l_SHIP_WH_CD = ((params.containsKey("l_SHIP_WH_CD")) ? (String[])params.get("l_SHIP_WH_CD") : (String[])null);
		String[] l_SHIP_PLANT_CD = ((params.containsKey("l_SHIP_PLANT_CD")) ? (String[])params.get("l_SHIP_PLANT_CD") : (String[])null);
		...
		struct.setl_SHIP_PLAN_REMAIN_QTY( ((l_SHIP_PLAN_REMAIN_QTY == null) ? (String)null : l_SHIP_PLAN_REMAIN_QTY[0]) );
		struct.setList_l_SHIP_PLAN_REMAIN_QTY(TypeConverter.convert(l_SHIP_PLAN_REMAIN_QTY));
		...
		struct.setl_DESINATED_SHIP_QTY( ((l_DESINATED_SHIP_QTY == null) ? (String)null : l_DESINATED_SHIP_QTY[0]) );
		struct.setList_l_DESINATED_SHIP_QTY(TypeConverter.convert(l_DESINATED_SHIP_QTY));
		...
		struct.setr1_STS_TYP( ((r1_STS_TYP == null) ? (String)null : r1_STS_TYP[0]) );
		struct.setList_r1_STS_TYP(TypeConverter.convert(r1_STS_TYP));
		struct.setr2_STS_TYP( ((r2_STS_TYP == null) ? (String)null : r2_STS_TYP[0]) );
		struct.setList_r2_STS_TYP(TypeConverter.convert(r2_STS_TYP));
		...
		struct.setl_bk_DESINATED_SHIP_QTY( ((l_bk_DESINATED_SHIP_QTY == null) ? (String)null : l_bk_DESINATED_SHIP_QTY[0]) );
		struct.setList_l_bk_DESINATED_SHIP_QTY(TypeConverter.convert(l_bk_DESINATED_SHIP_QTY));
		...
		struct.setl_PKG_UNIT( ((l_PKG_UNIT == null) ? (String)null : l_PKG_UNIT[0]) );
		struct.setList_l_PKG_UNIT(TypeConverter.convert(l_PKG_UNIT));
		...
		struct.setl_SHIP_WH_CD( ((l_SHIP_WH_CD == null) ? (String)null : l_SHIP_WH_CD[0]) );
		struct.setList_l_SHIP_WH_CD(TypeConverter.convert(l_SHIP_WH_CD));
		struct.setl_SHIP_PLANT_CD( ((l_SHIP_PLANT_CD == null) ? (String)null : l_SHIP_PLANT_CD[0]) );
		struct.setList_l_SHIP_PLANT_CD(TypeConverter.convert(l_SHIP_PLANT_CD));
	...
	public static String DEFAULT_TARGET = "/KT0010010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aKT0010010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aKT0010010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KT0010");
		logger.entering("KT0010010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("KT0010010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		KT0010010Control control;
		KT0010010Entity  entity = null;
		KT0010010Struct  struct = null;
		...
		try {
			...
			if( (control = (KT0010010Control)so.getAttribute("KT0010010Control_"+request.getSession(false).getId())) == null ) {
				control = new KT0010010Control();
			...
			try {
				...
				} else if( isClick(request, "UncheckAll") ) {
					if ( !isCryptical(request, so, params, "UncheckAll") ) return ERROR_TARGET;
					target = onClickUncheckAll(request, response, so, params, control);
					control.setButton("UncheckAll");
				} else {
					target = defaultEvent(request, response, so, params, control, refererURL);
				}

				so.setAttribute("KT0010010Control_"+request.getSession(false).getId(),control);
				...
				|| (isClick(request, "UncheckAll") && bFLG_DISCONNECT_UncheckAll)
				) {
	...
	private  static boolean bFLG_DISCONNECT_UncheckAll = true;
	...
	{
		return "com.nec.jp.orteus.metamorBase.KT0010.KT0010010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public KT0010010Servlet()
	{
		//{{user_implement_dev:<KT0010010_DisConnect_FLG>
		...
		//{{user_implement_dev:<KT0010010Servlet>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<KT0010010Servlet>
	}
