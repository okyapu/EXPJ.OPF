...
public class KR0010010Servlet extends HttpServlet
{
	 ...
	 * @param control KR0010010Controlクラスインスタンス
	 */
...
//			e.printStackTrace();
					...
					KR0010010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		//{{user_implement_dev:<reloadEvent>
              ...
              //			e.printStackTrace();
              //			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("KR0010010-E999","リロード処理"));
                 ExpjException ee = new ExpjException(e, "ZZ01106");
                 throw ee;
                }
                //}}user_implement_dev:<reloadEvent>
	...
	public static String DEFAULT_TARGET = "/KR0010010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aKR0010010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aKR0010010Struct";   // JSP先のバインド名(Struct)の指定
