/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DB0010/src/com/nec/jp/orteus/metamorBase/DB0010/DB0010B001/T_ITEM_CS_PROC_IF_delete.java,v $
 *
...
/**
 * CLASS     : T_ITEM_CS_PROC_IF_delete クラス
 * ファイル・クラス説明
 * @author $Author: xl-hs-zzw $
 * @version $Revision: 1.6 $ $Date: 2014/11/05 07:20:43 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class T_ITEM_CS_PROC_IF_delete extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int update() throws BatchAppException
		{
			try {
				...
				BatchAppException be=new BatchAppException("T_ITEM_CS_PROC_IF_delete", "update", "レコード更新条件設定処理失敗");
	...
	void prepareAll() throws BatchAppException
	{
		...
		try {
			...
			BatchAppException be=new BatchAppException("T_ITEM_CS_PROC_IF_delete", "prepareALL(FoundationException)", "SQL文のprepareで失敗しました");
			be.addMessage(e.getErrmsg());
			throw be;
		} catch(SQLException e) {
			BatchAppException be=new BatchAppException("T_ITEM_CS_PROC_IF_delete", "prepareALL(SQLException)", "SQL文のprepareで失敗しました");
			throw be;
		}
	...
	/**
	 * T_ITEM_CS_PROC_IF_deleteクラスの標準コンストラクタ
	 *
		 */
	public T_ITEM_CS_PROC_IF_delete(medDB0010B001 med, BatchAppConductor cdr) throws SystemException
	{
...
+"  and T_ITEM_CS_PROC_IF.UPD_FLG = '1' "
+"  and not exists( "
+"    select "
+"      1 "
+"    from "
...
+"      and M_PROC_GRP.\"PROC_CD\" = T_ITEM_CS_PROC_IF.\"CS_PROC_CD\" "
+"  )";
