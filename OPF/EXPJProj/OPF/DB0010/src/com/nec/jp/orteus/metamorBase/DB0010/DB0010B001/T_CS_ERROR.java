/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DB0010/src/com/nec/jp/orteus/metamorBase/DB0010/DB0010B001/T_CS_ERROR.java,v $
 *
...
public class T_CS_ERROR extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setTRANSACTION_TYP_C(String value) throws FoundationException { getAdapt_C().setString(13, value); }
		public void setMESSAGE_CD_C(String value) throws FoundationException { getAdapt_C().setString(14, value); }
		public void setREAD_COUNT_C(String value) throws FoundationException { getAdapt_C().setString(15, value); }
		...
		public int create() throws BatchAppException
		{
			try {
				...
				BatchAppException be=new BatchAppException("T_CS_ERROR", "create", "レコード新規追加パラメータ設定処理失敗");
	...
	void prepareAll() throws BatchAppException
	{
		...
		try {
			...
			BatchAppException be=new BatchAppException("T_CS_ERROR", "prepareALL(FoundationException)", "SQL文のprepareで失敗しました");
			be.addMessage(e.getErrmsg());
			throw be;
		} catch(SQLException e) {
			BatchAppException be=new BatchAppException("T_CS_ERROR", "prepareALL(SQLException)", "SQL文のprepareで失敗しました");
			throw be;
		}
	 ...
	 *
		 */
	public T_CS_ERROR(medDB0010B001 med, BatchAppConductor cdr) throws SystemException
	{
...
+"  T_CS_ERROR(\"CS_ERROR_CD\", \"BATCH_TYP\", \"BUSINESS_ID\", \"COST_TYP\", \"PLANT_CD\", \"ITEM_CD\", \"CS_PROC_CD\", \"TRANSACTION_TYP\", \"MESSAGE_CD\", \"READ_COUNT\", \"LIST_ISS_FLG\") "
+"values "
+"  (?, to_number(?), ?, 1, ?, ?, ?, to_number(?), ?, to_number(?), 0)";
