/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DB0010/src/com/nec/jp/orteus/metamorBase/DB0010/DB0010B001/T_ITEM_CS_PROC_IF_updated.java,v $
 *
...
/**
 * CLASS     : T_ITEM_CS_PROC_IF_updated クラス
 * ファイル・クラス説明
...
public class T_ITEM_CS_PROC_IF_updated extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int update() throws BatchAppException
		{
			try {
				...
				setIN2_U(m_med.getPROC_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("T_ITEM_CS_PROC_IF_updated", "update", "レコード更新条件設定処理失敗");
	...
	void prepareAll() throws BatchAppException
	{
		...
		try {
			...
			BatchAppException be=new BatchAppException("T_ITEM_CS_PROC_IF_updated", "prepareALL(FoundationException)", "SQL文のprepareで失敗しました");
			be.addMessage(e.getErrmsg());
			throw be;
		} catch(SQLException e) {
			BatchAppException be=new BatchAppException("T_ITEM_CS_PROC_IF_updated", "prepareALL(SQLException)", "SQL文のprepareで失敗しました");
			throw be;
		}
	...
	/**
	 * T_ITEM_CS_PROC_IF_updatedクラスの標準コンストラクタ
	 *
		 */
	public T_ITEM_CS_PROC_IF_updated(medDB0010B001 med, BatchAppConductor cdr) throws SystemException
	{
