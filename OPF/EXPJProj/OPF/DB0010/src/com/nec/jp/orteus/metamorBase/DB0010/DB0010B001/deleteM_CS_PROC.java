/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DB0010/src/com/nec/jp/orteus/metamorBase/DB0010/DB0010B001/deleteM_CS_PROC.java,v $
 *
...
/**
 * CLASS     : deleteM_CS_PROC クラス
 * ファイル・クラス説明
 * @author $Author: xl-hs-zzw $
 * @version $Revision: 1.2 $ $Date: 2014/11/05 07:20:43 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class deleteM_CS_PROC extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int update() throws BatchAppException
		{
			try {
				...
				BatchAppException be=new BatchAppException("deleteM_CS_PROC", "update", "レコード更新条件設定処理失敗");
	...
	void prepareAll() throws BatchAppException
	{
		...
		try {
			...
			BatchAppException be=new BatchAppException("deleteM_CS_PROC", "prepareALL(FoundationException)", "SQL文のprepareで失敗しました");
			be.addMessage(e.getErrmsg());
			throw be;
		} catch(SQLException e) {
			BatchAppException be=new BatchAppException("deleteM_CS_PROC", "prepareALL(SQLException)", "SQL文のprepareで失敗しました");
			throw be;
		}
	...
	/**
	 * deleteM_CS_PROCクラスの標準コンストラクタ
	 *
		 */
	public deleteM_CS_PROC(medDB0010B001 med, BatchAppConductor cdr) throws SystemException
	{
