/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DB0010/src/com/nec/jp/orteus/metamorBase/DB0010/DB0010B001/SYS_COST_CTRL.java,v $
 *
...
public class SYS_COST_CTRL extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public String getM_CS_PROC_PRIORITY_TYP_R() throws FoundationException { return m_doRs.getString(1); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setPRIORITY_TYP(getM_CS_PROC_PRIORITY_TYP_R());
			} catch(FoundationException e) {
	 ...
	 *
		 */
	public SYS_COST_CTRL(medDB0010B001 med, BatchAppConductor cdr) throws SystemException
	{
...
+"  SYS_COST_CTRL.\"M_CS_PROC_PRIORITY_TYP\" as \"M_CS_PROC_PRIORITY_TYP\" "
+"from "
+"  SYS_COST_CTRL "
+"where "
