/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AG0030/src/com/nec/jp/orteus/metamorBase/AG0030/AG0030010Servlet.java,v $
 *
...
public class AG0030010Servlet extends HttpServlet
{
	 ...
	 * @param control AG0030010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AG0030010Control control)
	{
		if (params == null) {
...
//{{user_implement_dev:<setScreenMoveParams>
		...
		String[] plantCd = null;
		String[] devtyp = null;
		devtyp = (String[])params.get("h_DEVELOP_TYP");
		if(params.containsKey("Lower_ITEM_CD")) {
			itemCd = (String[])params.get("Lower_ITEM_CD");
		}else if(params.containsKey("COMP_ITEM_CD")){
			itemCd = (String[])params.get("COMP_ITEM_CD");
			if("".equals(itemCd[0])&& params.containsKey("PARENT_ITEM_CD")){
				itemCd = (String[])params.get("PARENT_ITEM_CD");
			}else if("2".equals(devtyp[0])){
				itemCd = (String[])params.get("PARENT_ITEM_CD");
			}
		}else{
			itemCd = (String[])null;
		...
		if(itemCd == null) {
			control.setItemCd((String)null);
		}
		else {
			control.setItemCd(itemCd[0]);
        }
		
		if(params.containsKey("PLANT_CD")) {
			plantCd = (String[])params.get("PLANT_CD");
		}
		else {
			plantCd = (String[])null;
		}
		if(itemCd == null) {
			control.setPlantCd((String)null);
		}
		else {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AG0030010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AG0030010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AG0030010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AG0030010Entity entity = control.entity;
		AG0030010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AG0030010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
              //			objMessage.m_writer.write( Level.ALL, "AG0030010"+" $Revision: 1.5 $" );
                 control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AG0030010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AG0030010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AG0030010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AG0030");
		logger.entering("AG0030010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
		...
		//{{user_implement_dev:<reloadEvent>
                ...
                try
                {
            		...
            		String[] ScreenMoveID = null;
            		String   w_ScreenMoveID = null;
            		if(params.containsKey("SUBMIT_SCREEN")) {
            			ScreenMoveID = (String[])params.get("SUBMIT_SCREEN");
            			w_ScreenMoveID = ScreenMoveID[0].substring(0, 8);
            		}else{
            		    ScreenMoveID = null;
              			w_ScreenMoveID = null;
            		}
                 ...
                 if(control.isScreenMove() && !w_ScreenMoveID.equals("AE009004")) {
	                  getSessionParameters(so, params, struct);
                ...
                //------------------------------------------------------------------------------
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AG0030010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickselect(
					...
					HttpSession so,
					Hashtable params,
					AG0030010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AG0030010Entity entity = control.entity;
		AG0030010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AG0030");
		logger.entering("AG0030010Servlet"+":USER="+request.getRemoteUser(),"onClickselect");
		//{{user_implement_dev:<onClickselect>
                ...
                //------------------------------------------------------------------
                //}}user_implement_dev:<onClickselect>
		logger.exiting("AG0030010Servlet"+":USER="+request.getRemoteUser(),"onClickselect");
					...
					AG0030010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AG0030");
		logger.entering("AG0030010Servlet"+":USER="+request.getRemoteUser(),"onClickclear");
		//{{user_implement_dev:<onClickclear>
                ...
                //------------------------------------------------------------------
                //}}user_implement_dev:<onClickclear>
		logger.exiting("AG0030010Servlet"+":USER="+request.getRemoteUser(),"onClickclear");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AG0030010Struct struct)
	{
	...
	public static String DEFAULT_TARGET = "/AG0030010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAG0030010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAG0030010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AG0030");
		logger.entering("AG0030010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AG0030010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AG0030010Control control;
		AG0030010Entity  entity = null;
		AG0030010Struct  struct = null;
		...
		try {
			...
			if( (control = (AG0030010Control)so.getAttribute("AG0030010Control_"+request.getSession(false).getId())) == null ) {
				control = new AG0030010Control();
			...
			try {
				...
				so.setAttribute("AG0030010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.AG0030.AG0030010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AG0030010Servlet()
	{
		//{{user_implement_dev:<AG0030010_DisConnect_FLG>
		...
		//{{user_implement_dev:<AG0030010Servlet>
                //}}user_implement_dev:<AG0030010Servlet>
	}
