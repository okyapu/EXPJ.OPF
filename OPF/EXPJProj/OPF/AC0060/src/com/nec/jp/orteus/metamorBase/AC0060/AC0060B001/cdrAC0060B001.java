/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AC0060/src/com/nec/jp/orteus/metamorBase/AC0060/AC0060B001/cdrAC0060B001.java,v $
 *
...
/**
 * CLASS     : cdrAC0060B001 クラス
 * ファイル・クラス説明
 * @author $Author: shan-xiuqin $
 * @version $Revision: 1.15 $ $Date: 2016/05/23 08:00:00 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class cdrAC0060B001 extends Object
		implements IBatchAppCommon
{
	...
	public int getType() { return m_conductor.getType(); }
        ...
        public int beginProc() throws BatchAppException
        {
         try {
          ...
          setCommitFlag(false);
          BatchAppException be=new BatchAppException("cdrAC0060B001", "beginProc", "conductorの初期処理に失敗しました");
	...
	medAC0060B001 m_med=new medAC0060B001();

	// BatchAppConductorクラスインスタンス
	BatchAppConductor m_conductor=new BatchAppConductor("AC0060B001");
	...
	/**
	 * ctrAC0060B001クラス 標準コンストラクタ
	 *
		 */
	public cdrAC0060B001() throws BatchAppException
	{
		initialize();
