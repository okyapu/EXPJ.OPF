/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AC0060/src/com/nec/jp/orteus/metamorBase/AC0060/AC0060B001/mainAC0060B001.java,v $
 *
...
/**
 * CLASS     : mainAC0060B001 クラス
 * ファイル・クラス説明
 * @author $Author: shan-xiuqin $
 * @version $Revision: 1.16 $ $Date: 2016/05/23 08:00:01 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class mainAC0060B001
{
    // リターン値
	...
	public static void main(String args[])
	{
		...
		try {
			...
			if (sysLog == null) {
				...
				if(!sysLog.init("com.nec.jp.orteus.metamorBase.AC0060B001")) {
					//システムログの初期化に失敗しました
			...
			try {
				...
				// 標準出力ファイル名設定
				String logFileName = "AC0060B001.log";
				if (logFileName == null) {
				...
				// 新規作成のためバッチログファイル削除
				if (blogMode == false) {
					File logFile = new File(logOutputPath + "/AC0060B001.log");
				...
				System.setOut(new PrintStream(new FileOutputStream(logOutputPath + "/AC0060B001stdout.log", blogMode)));
				System.setErr(new PrintStream(new FileOutputStream(logOutputPath + "/AC0060B001stderr.log", blogMode)));
			...
			cdrAC0060B001 ebo = new cdrAC0060B001();
