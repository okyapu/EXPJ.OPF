/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0070/src/com/nec/jp/orteus/metamorBase/AE0070/AE0070010Servlet.java,v $
 *
...
public class AE0070010Servlet extends HttpServlet
{
	 ...
	 * @param control AE0070010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AE0070010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AE0070010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AE0070010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AE0070010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AE0070010Entity entity = control.entity;
		AE0070010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AE0070010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
			// TODO: ユーザ定義のコードを記述してください
//			LogWriter.write( Level.ALL, "AE0070010"+" $Revision: 1.12 $" );
			control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AE0070010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AE0070010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AE0070010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0070");
		logger.entering("AE0070010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
...
//			e.printStackTrace();
//			LogWriter.write(Level.ALL, objMessage.getIDMsg("AE0070010-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
		}
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AE0070010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickSelect(
					...
					HttpSession so,
					Hashtable params,
					AE0070010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AE0070010Entity entity = control.entity;
		AE0070010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0070");
		logger.entering("AE0070010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickSelect>
		logger.exiting("AE0070010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
					...
					AE0070010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0070");
		logger.entering("AE0070010Servlet"+":USER="+request.getRemoteUser(),"onClickPrint");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickPrint>
		logger.exiting("AE0070010Servlet"+":USER="+request.getRemoteUser(),"onClickPrint");
					...
					AE0070010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0070");
		logger.entering("AE0070010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("AE0070010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AE0070010Struct struct)
	{
		...
		String[] PUCH_ODR_START_DATE_FROM = ((params.containsKey("PUCH_ODR_START_DATE_FROM")) ? (String[])params.get("PUCH_ODR_START_DATE_FROM") : (String[])null);
		String[] PUCH_ODR_START_DATE_TO = ((params.containsKey("PUCH_ODR_START_DATE_TO")) ? (String[])params.get("PUCH_ODR_START_DATE_TO") : (String[])null);
		String[] PUCH_ODR_DLV_DATE_FROM = ((params.containsKey("PUCH_ODR_DLV_DATE_FROM")) ? (String[])params.get("PUCH_ODR_DLV_DATE_FROM") : (String[])null);
		String[] PUCH_ODR_DLV_DATE_TO = ((params.containsKey("PUCH_ODR_DLV_DATE_TO")) ? (String[])params.get("PUCH_ODR_DLV_DATE_TO") : (String[])null);
		String[] ODR_CANCEL_SLIP_ISS_DATE_FROM = ((params.containsKey("ODR_CANCEL_SLIP_ISS_DATE_FROM")) ? (String[])params.get("ODR_CANCEL_SLIP_ISS_DATE_FROM") : (String[])null);
		String[] ODR_CANCEL_SLIP_ISS_DATE_TO = ((params.containsKey("ODR_CANCEL_SLIP_ISS_DATE_TO")) ? (String[])params.get("ODR_CANCEL_SLIP_ISS_DATE_TO") : (String[])null);
		...
		String[] l_ACPT_RSLT_COMMENT = ((params.containsKey("l_ACPT_RSLT_COMMENT")) ? (String[])params.get("l_ACPT_RSLT_COMMENT") : (String[])null);
		String[] ITEM_CD = ((params.containsKey("ITEM_CD")) ? (String[])params.get("ITEM_CD") : (String[])null);
		String[] ReOutputFlg = ((params.containsKey("ReOutputFlg")) ? (String[])params.get("ReOutputFlg") : (String[])null);
		String[] ACPT_DATE_FROM = ((params.containsKey("ACPT_DATE_FROM")) ? (String[])params.get("ACPT_DATE_FROM") : (String[])null);
		String[] ACPT_DATE_TO = ((params.containsKey("ACPT_DATE_TO")) ? (String[])params.get("ACPT_DATE_TO") : (String[])null);
		...
		struct.setPUCH_ODR_START_DATE_FROM( ((PUCH_ODR_START_DATE_FROM == null) ? (String)null : PUCH_ODR_START_DATE_FROM[0]) );
		struct.setList_PUCH_ODR_START_DATE_FROM(TypeConverter.convert(PUCH_ODR_START_DATE_FROM));
		struct.setPUCH_ODR_START_DATE_TO( ((PUCH_ODR_START_DATE_TO == null) ? (String)null : PUCH_ODR_START_DATE_TO[0]) );
		struct.setList_PUCH_ODR_START_DATE_TO(TypeConverter.convert(PUCH_ODR_START_DATE_TO));
		struct.setPUCH_ODR_DLV_DATE_FROM( ((PUCH_ODR_DLV_DATE_FROM == null) ? (String)null : PUCH_ODR_DLV_DATE_FROM[0]) );
		struct.setList_PUCH_ODR_DLV_DATE_FROM(TypeConverter.convert(PUCH_ODR_DLV_DATE_FROM));
		struct.setPUCH_ODR_DLV_DATE_TO( ((PUCH_ODR_DLV_DATE_TO == null) ? (String)null : PUCH_ODR_DLV_DATE_TO[0]) );
		struct.setList_PUCH_ODR_DLV_DATE_TO(TypeConverter.convert(PUCH_ODR_DLV_DATE_TO));
		struct.setODR_CANCEL_SLIP_ISS_DATE_FROM( ((ODR_CANCEL_SLIP_ISS_DATE_FROM == null) ? (String)null : ODR_CANCEL_SLIP_ISS_DATE_FROM[0]) );
		struct.setList_ODR_CANCEL_SLIP_ISS_DATE_FROM(TypeConverter.convert(ODR_CANCEL_SLIP_ISS_DATE_FROM));
		struct.setODR_CANCEL_SLIP_ISS_DATE_TO( ((ODR_CANCEL_SLIP_ISS_DATE_TO == null) ? (String)null : ODR_CANCEL_SLIP_ISS_DATE_TO[0]) );
		struct.setList_ODR_CANCEL_SLIP_ISS_DATE_TO(TypeConverter.convert(ODR_CANCEL_SLIP_ISS_DATE_TO));
		...
		struct.setl_ACPT_RSLT_COMMENT( ((l_ACPT_RSLT_COMMENT == null) ? (String)null : l_ACPT_RSLT_COMMENT[0]) );
		struct.setList_l_ACPT_RSLT_COMMENT(TypeConverter.convert(l_ACPT_RSLT_COMMENT));
		struct.setITEM_CD( ((ITEM_CD == null) ? (String)null : ITEM_CD[0]) );
		struct.setList_ITEM_CD(TypeConverter.convert(ITEM_CD));
		struct.setReOutputFlg( ((ReOutputFlg == null) ? (String)null : ReOutputFlg[0]) );
		struct.setList_ReOutputFlg(TypeConverter.convert(ReOutputFlg));
		struct.setACPT_DATE_FROM( ((ACPT_DATE_FROM == null) ? (String)null : ACPT_DATE_FROM[0]) );
		struct.setList_ACPT_DATE_FROM(TypeConverter.convert(ACPT_DATE_FROM));
		struct.setACPT_DATE_TO( ((ACPT_DATE_TO == null) ? (String)null : ACPT_DATE_TO[0]) );
		struct.setList_ACPT_DATE_TO(TypeConverter.convert(ACPT_DATE_TO));
	...
	public static String DEFAULT_TARGET = "/AE0070010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAE0070010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAE0070010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0070");
		logger.entering("AE0070010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AE0070010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AE0070010Control control;
		AE0070010Entity  entity = null;
		AE0070010Struct  struct = null;
		...
		try {
			...
			if( (control = (AE0070010Control)so.getAttribute("AE0070010Control_"+request.getSession(false).getId())) == null ) {
				control = new AE0070010Control();
			...
			try {
				...
				so.setAttribute("AE0070010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.AE0070.AE0070010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AE0070010Servlet()
	{
		//{{user_implement_dev:<AE0070010_DisConnect_FLG>
		...
		//{{user_implement_dev:<AE0070010Servlet>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<AE0070010Servlet>
	}
