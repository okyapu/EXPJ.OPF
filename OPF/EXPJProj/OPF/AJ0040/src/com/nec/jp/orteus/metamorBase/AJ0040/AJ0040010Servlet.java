/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AJ0040/src/com/nec/jp/orteus/metamorBase/AJ0040/AJ0040010Servlet.java,v $
 *
...
public class AJ0040010Servlet extends HttpServlet
{
	 ...
	 * @param control AJ0040010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AJ0040010Control control)
	{
		if (params == null) {
...
//{{user_implement_dev:<setScreenMoveParams>
		...
		if (odNo == null) {
			odNo = (String[]) params.get("h_PARAMETER_OD_NO");
			if (odNo == null) {
				control.setOdNo(null);
			} else {
				control.setOdNo(odNo[0]);
			}
			String[] workOdrCd = (String[]) params.get("l_WORK_ODR_CD");
			if (workOdrCd == null) {
				control.setWorkOdrCd(null);
			} else {
				control.setWorkOdrCd(workOdrCd[0]);
			}
			String[] workInProcCd = (String[]) params.get("l_WORK_IN_PROC_CD");
			if (workInProcCd == null) {
				control.setWorkInProcCd(null);
			} else {
				control.setWorkInProcCd(workInProcCd[0]);
			}
		}
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AJ0040010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AJ0040010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AJ0040010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AJ0040010Entity entity = control.entity;
		AJ0040010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AJ0040010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
			// TODO: ユーザ定義のコードを記述してください
//			objMessage.m_writer.write( Level.ALL, "AJ0040010"+" $Revision: 1.8 $" );
			control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AJ0040010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AJ0040010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AJ0040010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AJ0040");
		logger.entering("AJ0040010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
...
//			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AJ0040010-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
		}
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AJ0040010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickClose(
					...
					HttpSession so,
					Hashtable params,
					AJ0040010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AJ0040010Entity entity = control.entity;
		AJ0040010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AJ0040");
		logger.entering("AJ0040010Servlet"+":USER="+request.getRemoteUser(),"onClickClose");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClose>
		logger.exiting("AJ0040010Servlet"+":USER="+request.getRemoteUser(),"onClickClose");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AJ0040010Struct struct)
	{
		...
		String[] l_PUCH_ODR_STS_TYP_DN = ((params.containsKey("l_PUCH_ODR_STS_TYP_DN")) ? (String[])params.get("l_PUCH_ODR_STS_TYP_DN") : (String[])null);
		...
		String[] l_PUCH_ODR_EDI_ISS_DATE = ((params.containsKey("l_PUCH_ODR_EDI_ISS_DATE")) ? (String[])params.get("l_PUCH_ODR_EDI_ISS_DATE") : (String[])null);
		...
		String[] l_TOTAL_INSPECTED_QTY = ((params.containsKey("l_TOTAL_INSPECTED_QTY")) ? (String[])params.get("l_TOTAL_INSPECTED_QTY") : (String[])null);
		String[] l_TOTAL_ACCEPTED_QTY = ((params.containsKey("l_TOTAL_ACCEPTED_QTY")) ? (String[])params.get("l_TOTAL_ACCEPTED_QTY") : (String[])null);
		String[] l_TOTAL_DEFECTED_QTY = ((params.containsKey("l_TOTAL_DEFECTED_QTY")) ? (String[])params.get("l_TOTAL_DEFECTED_QTY") : (String[])null);
		...
		struct.setl_PUCH_ODR_STS_TYP_DN( ((l_PUCH_ODR_STS_TYP_DN == null) ? (String)null : l_PUCH_ODR_STS_TYP_DN[0]) );
		struct.setList_l_PUCH_ODR_STS_TYP_DN(TypeConverter.convert(l_PUCH_ODR_STS_TYP_DN));
		...
		struct.setl_PUCH_ODR_EDI_ISS_DATE( ((l_PUCH_ODR_EDI_ISS_DATE == null) ? (String)null : l_PUCH_ODR_EDI_ISS_DATE[0]) );
		struct.setList_l_PUCH_ODR_EDI_ISS_DATE(TypeConverter.convert(l_PUCH_ODR_EDI_ISS_DATE));
		...
		struct.setl_TOTAL_INSPECTED_QTY( ((l_TOTAL_INSPECTED_QTY == null) ? (String)null : l_TOTAL_INSPECTED_QTY[0]) );
		struct.setList_l_TOTAL_INSPECTED_QTY(TypeConverter.convert(l_TOTAL_INSPECTED_QTY));
		struct.setl_TOTAL_ACCEPTED_QTY( ((l_TOTAL_ACCEPTED_QTY == null) ? (String)null : l_TOTAL_ACCEPTED_QTY[0]) );
		struct.setList_l_TOTAL_ACCEPTED_QTY(TypeConverter.convert(l_TOTAL_ACCEPTED_QTY));
		struct.setl_TOTAL_DEFECTED_QTY( ((l_TOTAL_DEFECTED_QTY == null) ? (String)null : l_TOTAL_DEFECTED_QTY[0]) );
		struct.setList_l_TOTAL_DEFECTED_QTY(TypeConverter.convert(l_TOTAL_DEFECTED_QTY));
	...
	public static String DEFAULT_TARGET = "/AJ0040010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAJ0040010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAJ0040010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AJ0040");
		logger.entering("AJ0040010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AJ0040010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AJ0040010Control control;
		AJ0040010Entity  entity = null;
		AJ0040010Struct  struct = null;
		...
		try {
			...
			if( (control = (AJ0040010Control)so.getAttribute("AJ0040010Control_"+request.getSession(false).getId())) == null ) {
				control = new AJ0040010Control();
			...
			try {
				...
				so.setAttribute("AJ0040010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.AJ0040.AJ0040010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AJ0040010Servlet()
	{
		//{{user_implement_dev:<AJ0040010_DisConnect_FLG>
		...
		//{{user_implement_dev:<AJ0040010Servlet>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<AJ0040010Servlet>
	}
