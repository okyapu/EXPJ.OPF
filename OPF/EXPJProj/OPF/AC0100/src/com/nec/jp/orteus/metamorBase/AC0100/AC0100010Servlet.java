...
public class AC0100010Servlet extends HttpServlet
{
	 ...
	 * @param control AC0100010Controlクラスインスタンス
	 */
...
//			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AC0100010-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
		}
                //}}user_implement_dev:<reloadEvent>
...
//			e.printStackTrace();
	...
	public String onClickAlcUpdate(
					...
					AC0100010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = "/AC0100011.jsp";		// 移動先ＵＲＬ
		AC0100010Entity entity = control.entity;
		AC0100010Struct struct = control.struct;
		getSessionParameters(so, params, struct);
...
//			e.printStackTrace();
	...
	public String onClickInsert(
					...
					AC0100010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = "/AC0100010.jsp";		// 移動先ＵＲＬ
		AC0100010Entity entity = control.entity;
		AC0100010Struct struct = control.struct;
		getSessionParameters(so, params, struct);
...
//			e.printStackTrace();
	...
	public static String DEFAULT_TARGET = "/AC0100010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAC0100010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAC0100010Struct";   // JSP先のバインド名(Struct)の指定
