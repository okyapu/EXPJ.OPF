/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0060/src/com/nec/jp/orteus/metamorBase/AE0060/AE0060010Servlet.java,v $
 *
...
public class AE0060010Servlet extends HttpServlet
{
	 ...
	 * @param control AE0060010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AE0060010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AE0060010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AE0060010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AE0060010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AE0060010Entity entity = control.entity;
		AE0060010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AE0060010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
			// TODO: ユーザ定義のコードを記述してください
			//			objMessage.m_writer.write( Level.ALL, "AE0060010"+" $Revision: 1.39 $" );
			control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AE0060010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AE0060010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AE0060010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0060");
		logger.entering("AE0060010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
		...
		try {
			...
			//			e.printStackTrace();
			//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AE0060010-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
		}
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AE0060010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickSelect(
					...
					HttpSession so,
					Hashtable params,
					AE0060010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AE0060010Entity entity = control.entity;
		AE0060010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0060");
		logger.entering("AE0060010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
		...
		try {
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickSelect>
		logger.exiting("AE0060010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
					...
					AE0060010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0060");
		logger.entering("AE0060010Servlet"+":USER="+request.getRemoteUser(),"onClickSelectUnitCost");
		...
		try {
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickSelectUnitCost>
		logger.exiting("AE0060010Servlet"+":USER="+request.getRemoteUser(),"onClickSelectUnitCost");
					...
					AE0060010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0060");
		logger.entering("AE0060010Servlet"+":USER="+request.getRemoteUser(),"onClickInsert");
		...
		try {
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickInsert>
		logger.exiting("AE0060010Servlet"+":USER="+request.getRemoteUser(),"onClickInsert");
					...
					AE0060010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0060");
		logger.entering("AE0060010Servlet"+":USER="+request.getRemoteUser(),"onClickCancelComplete");
		...
		try {
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickCancelComplete>
		logger.exiting("AE0060010Servlet"+":USER="+request.getRemoteUser(),"onClickCancelComplete");
					...
					AE0060010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0060");
		logger.entering("AE0060010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
		...
		try {
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("AE0060010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
					...
					AE0060010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0060");
		logger.entering("AE0060010Servlet"+":USER="+request.getRemoteUser(),"onClickCancelOdrCancel");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickCancelOdrCancel>
		logger.exiting("AE0060010Servlet"+":USER="+request.getRemoteUser(),"onClickCancelOdrCancel");
					...
					AE0060010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0060");
		logger.entering("AE0060010Servlet"+":USER="+request.getRemoteUser(),"onClickLotInsert");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickLotInsert>
		logger.exiting("AE0060010Servlet"+":USER="+request.getRemoteUser(),"onClickLotInsert");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AE0060010Struct struct)
	{
		...
		String[] h_FINAL_PROC_CD = ((params.containsKey("h_FINAL_PROC_CD")) ? (String[])params.get("h_FINAL_PROC_CD") : (String[])null);
		...
		String[] h_PUCH_ODR_CD_1 = ((params.containsKey("h_PUCH_ODR_CD_1")) ? (String[])params.get("h_PUCH_ODR_CD_1") : (String[])null);
		...
		struct.seth_FINAL_PROC_CD( ((h_FINAL_PROC_CD == null) ? (String)null : h_FINAL_PROC_CD[0]) );
		struct.setList_h_FINAL_PROC_CD(TypeConverter.convert(h_FINAL_PROC_CD));
		...
		struct.seth_PUCH_ODR_CD_1( ((h_PUCH_ODR_CD_1 == null) ? (String)null : h_PUCH_ODR_CD_1[0]) );
		struct.setList_h_PUCH_ODR_CD_1(TypeConverter.convert(h_PUCH_ODR_CD_1));
	...
	public static String DEFAULT_TARGET = "/AE0060010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAE0060010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAE0060010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0060");
		logger.entering("AE0060010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
		// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AE0060010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AE0060010Control control;
		AE0060010Entity  entity = null;
		AE0060010Struct  struct = null;
		...
		try {
			...
			if( (control = (AE0060010Control)so.getAttribute("AE0060010Control_"+request.getSession(false).getId())) == null ) {
				control = new AE0060010Control();
			...
			try {
				...
				so.setAttribute("AE0060010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.AE0060.AE0060010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AE0060010Servlet()
	{
		//{{user_implement_dev:<AE0060010_DisConnect_FLG>
		...
		//{{user_implement_dev:<AE0060010Servlet>
		// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<AE0060010Servlet>
	}
