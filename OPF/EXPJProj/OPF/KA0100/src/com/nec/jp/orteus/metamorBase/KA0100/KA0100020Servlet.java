...
public class KA0100020Servlet extends HttpServlet
{
	 ...
	 * @param control KA0100020Controlクラスインスタンス
	 */
...
//			e.printStackTrace();
					...
					KA0100020Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		//{{user_implement_dev:<reloadEvent>
              ...
              //			e.printStackTrace();
              //			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("KA0100020-E999","リロード処理"));
                 ExpjException ee = new ExpjException(e, "ZZ01106");
                 throw ee;
                }
                //}}user_implement_dev:<reloadEvent>
	...
	public static String DEFAULT_TARGET = "/KA0100020.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aKA0100020Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aKA0100020Struct";   // JSP先のバインド名(Struct)の指定
