/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KR0080/src/com/nec/jp/orteus/metamorBase/KR0080/KZ0010P001.java,v $
 *
 ...
 * @version $Revision: 1.1 $ $Date: 2014/06/09 03:17:22 $
*/
public class KZ0010P001 {
    ...
    public String execute() {
    	// Mod Start 20140116 liu-j
        // if ((_mode == null) || (_mode.length() != 1) ||
        if ((_mode == null) ||
        // Mod End 20140116 liu-j
            ((!"1".equals(_mode)) && (!"2".equals(_mode)) &&
             ...
             // Mod Start 20140116 liu-j
             //(!"9".equals(_mode))) {
             (!"9".equals(_mode)) && (!"10".equals(_mode)))) {
        	// Mod End 20140116 liu-j
            // 処理モード未設定 or 誤設定
            //   処理なし
            ...
            // Add Start 20140116 liu-j
            else if ("10".equals(_mode)) {
    ...
    private String addTrn() {
        ...
        if (("1".equals(_mode)) || ("3".equals(_mode)) ||
        	// Mod Start 20140116 liu-j	
        	//("4".equals(_mode))) {
            ("4".equals(_mode)) || ("10".equals(_mode))) {
        	// Mod End 20140116 liu-j
            // 処理モード1:出荷実績-登録
            // 処理モード3:出荷実績-返品
            // 処理モード4:受領売上-登録
        ...
        //System.out.println("selectHomeCurCd:" + _messageNo);
        if (!"0".equals(_messageNo)) return _messageNo;
