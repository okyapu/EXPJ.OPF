/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KR0030/src/com/nec/jp/orteus/metamorBase/KR0030/KR0030010Servlet.java,v $
 *
...
public class KR0030010Servlet extends HttpServlet
{
	 ...
	 * @param control KR0030010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, KR0030010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control KR0030010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, KR0030010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					KR0030010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		KR0030010Entity entity = control.entity;
		KR0030010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("KR0030010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
                 // TODO: ユーザ定義のコードを記述してください
              //			objMessage.m_writer.write( Level.ALL, "KR0030010"+" $Revision: 1.8 $" );
                 control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("KR0030010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					KR0030010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		KR0030010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KR0030");
		logger.entering("KR0030010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
		...
		//{{user_implement_dev:<reloadEvent>
              ...
              //			e.printStackTrace();
              //			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("KR0030010-E999","リロード処理"));
                 ExpjException ee = new ExpjException(e, "ZZ01106");
                 throw ee;
                }
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("KR0030010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickSelect(
					...
					HttpSession so,
					Hashtable params,
					KR0030010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		KR0030010Entity entity = control.entity;
		KR0030010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KR0030");
		logger.entering("KR0030010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
		//{{user_implement_dev:<onClickSelect>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickSelect>
		logger.exiting("KR0030010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
					...
					KR0030010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KR0030");
		logger.entering("KR0030010Servlet"+":USER="+request.getRemoteUser(),"onClickRecalc");
		//{{user_implement_dev:<onClickRecalc>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickRecalc>
		logger.exiting("KR0030010Servlet"+":USER="+request.getRemoteUser(),"onClickRecalc");
					...
					KR0030010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KR0030");
		logger.entering("KR0030010Servlet"+":USER="+request.getRemoteUser(),"onClickInsert");
		//{{user_implement_dev:<onClickInsert>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickInsert>
		logger.exiting("KR0030010Servlet"+":USER="+request.getRemoteUser(),"onClickInsert");
					...
					KR0030010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KR0030");
		logger.entering("KR0030010Servlet"+":USER="+request.getRemoteUser(),"onClickUpdate");
		//{{user_implement_dev:<onClickUpdate>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickUpdate>
		logger.exiting("KR0030010Servlet"+":USER="+request.getRemoteUser(),"onClickUpdate");
					...
					KR0030010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KR0030");
		logger.entering("KR0030010Servlet"+":USER="+request.getRemoteUser(),"onClickDelete");
		//{{user_implement_dev:<onClickDelete>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickDelete>
		logger.exiting("KR0030010Servlet"+":USER="+request.getRemoteUser(),"onClickDelete");
					...
					KR0030010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KR0030");
		logger.entering("KR0030010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
		//{{user_implement_dev:<onClickClear>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("KR0030010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, KR0030010Struct struct)
	{
	...
	public static String DEFAULT_TARGET = "/KR0030010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aKR0030010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aKR0030010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KR0030");
		logger.entering("KR0030010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("KR0030010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		KR0030010Control control;
		KR0030010Entity  entity = null;
		KR0030010Struct  struct = null;
		...
		try {
			...
			if( (control = (KR0030010Control)so.getAttribute("KR0030010Control_"+request.getSession(false).getId())) == null ) {
				control = new KR0030010Control();
			...
			try {
				...
				so.setAttribute("KR0030010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.KR0030.KR0030010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public KR0030010Servlet()
	{
		//{{user_implement_dev:<KR0030010_DisConnect_FLG>
		...
		//{{user_implement_dev:<KR0030010Servlet>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<KR0030010Servlet>
	}
