/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AN0110/src/com/nec/jp/orteus/metamorBase/AN0110/AN0110010Struct.java,v $
 *
 ...
 * @version $Revision: 1.2 $ $Date: 2011/01/28 11:26:19 $
 *
 */
//}}user_implement_code_header

public class AN0110010Struct extends DataStruct
{

	//////////////////////////////

	/** 第 1 変数： m_OD_CALC_FLG_name */
	public String m_OD_CALC_FLG_name = null;
	/** 第 2 変数： m_OD_CALC_FLG_val */
	public String m_OD_CALC_FLG_val = null;
	/** 第 3 変数： m_OD_MNT_FLG_name */
	public String m_OD_MNT_FLG_name = null;
	/** 第 4 変数： m_OD_MNT_FLG_val */
	public String m_OD_MNT_FLG_val = null;
	/** 第 5 変数： m_PLANT_NAME */
	public String m_PLANT_NAME = null;
	/** 第 6 変数： m_PLANT_CD */
	public String m_PLANT_CD = null;
	/** 第 7 変数： m_OD_CALC_FLG */
	...
	/** 第 1 List変数： l_OD_CALC_FLG_name */
	public List l_OD_CALC_FLG_name = null;

	/** 第 2 List変数： l_OD_CALC_FLG_val */
	public List l_OD_CALC_FLG_val = null;

	/** 第 3 List変数： l_OD_MNT_FLG_name */
	public List l_OD_MNT_FLG_name = null;

	/** 第 4 List変数： l_OD_MNT_FLG_val */
	...
	/** 第 7 List変数： l_OD_CALC_FLG */
	public List l_OD_CALC_FLG = null;

	/** 第 8 List変数： l_OD_MNT_FLG */
	...
	public int setL2L_OD_CALC_FLG_name(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OD_CALC_FLG_name.add(((AN0110010Struct) list.get(i)).getOD_CALC_FLG_name());
		}
		return size;
	}
	public int setL2L_OD_CALC_FLG_val(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OD_CALC_FLG_val.add(((AN0110010Struct) list.get(i)).getOD_CALC_FLG_val());
		}
		return size;
	}
	public int setL2L_OD_MNT_FLG_name(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OD_MNT_FLG_name.add(((AN0110010Struct) list.get(i)).getOD_MNT_FLG_name());
		}
		return size;
	}
	public int setL2L_OD_MNT_FLG_val(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OD_MNT_FLG_val.add(((AN0110010Struct) list.get(i)).getOD_MNT_FLG_val());
		}
		return size;
	}
	public int setL2L_PLANT_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PLANT_NAME.add(((AN0110010Struct) list.get(i)).getPLANT_NAME());
		}
		return size;
	}
	public int setL2L_PLANT_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PLANT_CD.add(((AN0110010Struct) list.get(i)).getPLANT_CD());
		}
		return size;
	}
	public int setL2L_OD_CALC_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OD_CALC_FLG.add(((AN0110010Struct) list.get(i)).getOD_CALC_FLG());
		}
		return size;
	}
	public int setL2L_OD_MNT_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OD_MNT_FLG.add(((AN0110010Struct) list.get(i)).getOD_MNT_FLG());
		}
		return size;
	}
	public int setL2L_h_MODIFY_COUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_h_MODIFY_COUNT.add(((AN0110010Struct) list.get(i)).geth_MODIFY_COUNT());
		}
		return size;
	}
	public int setL2L_JOB_ODR_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_JOB_ODR_CD.add(((AN0110010Struct) list.get(i)).getJOB_ODR_CD());
		}
		return size;
	}
	...
	/**
	 * medAN0110010クラスの標準コンストラクタ
	 */
	public AN0110010Struct()
	{
	 ...
	 */
	public void setStruct(AN0110010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructM(AN0110010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructL(AN0110010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
...
/*
	...
	// 第 7 変数初期値： i_OD_CALC_FLG


	final static String i_OD_CALC_FLG = null;

	// 第 8 変数初期値： i_OD_MNT_FLG
