/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AK0020/src/com/nec/jp/orteus/metamorBase/AK0020/AK0020B003/callSqlDeleteProc.java,v $
 *
...
public class callSqlDeleteProc extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		 ...
		 */
		public medAK0020B003 call(ResultSet rs) throws SQLException
		{
			if(rs == null || rs.next()==false) return null;
			medAK0020B003 data = new medAK0020B003();
			return data;
		}
	 ...
	 *
		 */
	public callSqlDeleteProc(medAK0020B003 med, BatchAppConductor cdr) throws SystemException
	{
	...
	protected static String m_calcmd = "{" + "call SQLDELETEHISTORYBYTRIGGER(?, ?, ?, ?, ?, ?, ?, ?)" + "}";
