/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AK0020/src/com/nec/jp/orteus/metamorBase/AK0020/AK0020010Struct.java,v $
 *
...
public class AK0020010Struct extends DataStruct
{
	...
	public int setL2L_h_PLANT_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_h_PLANT_CD.add(((AK0020010Struct) list.get(i)).geth_PLANT_CD());
		}
		return size;
	}
	public int setL2L_h_FINAL_MONTHLY_PROC_EXEC_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_h_FINAL_MONTHLY_PROC_EXEC_DATE.add(((AK0020010Struct) list.get(i)).geth_FINAL_MONTHLY_PROC_EXEC_DATE());
		}
		return size;
	}
	public int setL2L_PLANT_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PLANT_CD.add(((AK0020010Struct) list.get(i)).getPLANT_CD());
		}
		return size;
	}
	public int setL2L_FINAL_MONTHLY_PROC_EXEC_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_FINAL_MONTHLY_PROC_EXEC_DATE.add(((AK0020010Struct) list.get(i)).getFINAL_MONTHLY_PROC_EXEC_DATE());
		}
		return size;
	}
	...
	/**
	 * medAK0020010クラスの標準コンストラクタ
	 */
	public AK0020010Struct()
	{
	 ...
	 */
	public void setStruct(AK0020010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructM(AK0020010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructL(AK0020010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
