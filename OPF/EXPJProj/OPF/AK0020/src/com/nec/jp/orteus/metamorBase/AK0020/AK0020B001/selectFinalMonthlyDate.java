/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AK0020/src/com/nec/jp/orteus/metamorBase/AK0020/AK0020B001/selectFinalMonthlyDate.java,v $
 *
...
/**
 * CLASS     : selectFinalMonthlyDate クラス
 * ファイル・クラス説明
 * @author $Author: shan-xiuqin $
 * @version $Revision: 1.6 $ $Date: 2016/05/23 08:27:48 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class selectFinalMonthlyDate extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				BatchAppException be=new BatchAppException("selectFinalMonthlyDate", "read", "レコード検索条件設定処理失敗");
		...
		public String getFINAL_MONTHLY_PROC_EXEC_DATE_R() throws FoundationException { return m_doRs.getString(1); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setFINAL_MONTHLY_PROC_EXEC_DATE(getFINAL_MONTHLY_PROC_EXEC_DATE_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("selectFinalMonthlyDate", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("selectFinalMonthlyDate", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	 ...
	 *
		 */
	public selectFinalMonthlyDate(medAK0020B001 med, BatchAppConductor cdr) throws SystemException
	{
