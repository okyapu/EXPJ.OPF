/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AK0020/src/com/nec/jp/orteus/metamorBase/AK0020/AK0020B002/callSqlDeleteProc.java,v $
 *
...
public class callSqlDeleteProc extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public List call() throws BatchAppException
		{
			try {
				...
				cstmt.setString(8, m_med.getpvcDeleteProcExecDate());


				cstmt.execute();

				List list = new ArrayList();
				medAK0020B002 data = null;
				...
				e.printStackTrace();
				BatchAppException be=new BatchAppException("callSqlDeleteProc", "call", "Stored Procedure条件設定処理失敗");
				...
				if (cstmt != null) {
					try {
						...
						ef.printStackTrace();
						BatchAppException bef = new BatchAppException("callSqlDeleteProc", "call", "Stored Procedureクローズ処理失敗");
		 ...
		 */
		public medAK0020B002 call(ResultSet rs) throws SQLException
		{
			if(rs == null || rs.next()==false) return null;
			medAK0020B002 data = new medAK0020B002();
			return data;
		}
	...
	/**
	 * callSqlDeleteProcクラスの標準コンストラクタ
	 *
		 */
	public callSqlDeleteProc(medAK0020B002 med, BatchAppConductor cdr) throws SystemException
	{
	...
	protected static String m_calcmd = "{" + "call SqlDeleteProc(?,?,?,?,?,?,?,?)" + "}";
