/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AK0020/src/com/nec/jp/orteus/metamorBase/AK0020/AK0020B002/mainAK0020B002.java,v $
 *
...
/**
 * CLASS     : mainAK0020B002 クラス
 * ファイル・クラス説明
 * @author $Author: shan-xiuqin $
 * @version $Revision: 1.7 $ $Date: 2016/05/23 08:27:50 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class mainAK0020B002
{
    // リターン値
	...
	public static void main(String args[])
	{
		...
		try {
			...
			if (sysLog == null) {
				...
				if(!sysLog.init("com.nec.jp.orteus.metamorBase.AK0020B002")) {
					//システムログの初期化に失敗しました
			...
			try {
				...
				// 標準出力ファイル名設定
				String logFileName = "AK0020B002.log";
				if (logFileName == null) {
				...
				// 新規作成のためバッチログファイル削除
				if (blogMode == false) {
					File logFile = new File(logOutputPath + "/AK0020B002.log");
				...
				System.setOut(new PrintStream(new FileOutputStream(logOutputPath + "/AK0020B002stdout.log", blogMode)));
				System.setErr(new PrintStream(new FileOutputStream(logOutputPath + "/AK0020B002stderr.log", blogMode)));
			...
			cdrAK0020B002 ebo = new cdrAK0020B002();
