/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AK0020/src/com/nec/jp/orteus/metamorBase/AK0020/AK0020B001/callSqlMonthlyProc.java,v $
 *
...
public class callSqlMonthlyProc extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public List call() throws BatchAppException
		{
			try {
				...
				cstmt.setString(8, m_med.getpvc2MonthlyDate());


				cstmt.execute();

				List list = new ArrayList();
				medAK0020B001 data = null;
				...
				e.printStackTrace();
				BatchAppException be=new BatchAppException("callSqlMonthlyProc", "call", "Stored Procedure条件設定処理失敗");
				...
				if (cstmt != null) {
					try {
						...
						ef.printStackTrace();
						BatchAppException bef = new BatchAppException("callSqlMonthlyProc", "call", "Stored Procedureクローズ処理失敗");
		 ...
		 */
		public medAK0020B001 call(ResultSet rs) throws SQLException
		{
			if(rs == null || rs.next()==false) return null;
			medAK0020B001 data = new medAK0020B001();
			return data;
		}
	...
	/**
	 * callSqlMonthlyProcクラスの標準コンストラクタ
	 *
		 */
	public callSqlMonthlyProc(medAK0020B001 med, BatchAppConductor cdr) throws SystemException
	{
	...
	protected static String m_calcmd = "{" + "call SqlMonthlyProc(?,?,?,?,?,?,?,?)" + "}";
