...
public class AK0020020Control
{
	...
	//{{user_implement_code_main
       ...
       //	public Object getListvalue(int x) { return this.list.get(x); }	// リストの値を返します。
        public AK0020020Struct getListvalue(int x) { return (AK0020020Struct)(this.list.get(x)); }	// リストの値を返します。
        public AK0020020Struct getStruct() { return this.struct; }	// Structを返します。
        public AK0020020Struct createStruct() { return new AK0020020Struct(); }	// 新しいStructを作って返します。
        public void setStruct(Object structname) { this.struct.setStruct((AK0020020Struct)structname); }	// Structをセットします。
		...
		logger.entering("AK0020020Control"+":USER="+struct.getsUser_ID(),"controlExecute");
			//{{user_implement_dev:<controlExecute>
                ...
                try {
                 ...
                 String screenFinalMonthlyDate = null;   // 画面の削除処理対象日
...
//                 Process p = runtime.exec(cmd.toString());
                 ...
                 buffer.add("com.nec.jp.orteus.metamorBase.AK0020.AK0020B002.mainAK0020B002");		// 呼び出し先クラス
...
//			e.printStackTrace();
//			throw new FoundationException("AK0020020Control",e.getMessage(),"control_eventHandllerメソッドでエラーが発生しました。");
	...
	public void createDefaultCSV(List list, String sTitle[]) throws BusinessProcessException, FoundationException {
		...
		//{{user_implement_dev:<createDefaultCSV>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AK0020020-E999","CSVの出力処理"));
			throw new FoundationException("AK0020020Control",e.getMessage(),"createDefaultCSVメソッドでエラーが発生しました。");
		}
...
//				objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AK0020020-E999","システム日付の取得処理"));
				throw new FoundationException("AK0020020Control","beginTransaction()","システム日付取得処理でエラーが発生しました。");
			}
		...
		//{{user_implement_dev:<beginTransaction>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AK0020020-E999","コントロールのイベント処理"));
			throw new FoundationException("AK0020020Control",e.getMessage(),"beginTransactionメソッドでエラーが発生しました。");
		}
