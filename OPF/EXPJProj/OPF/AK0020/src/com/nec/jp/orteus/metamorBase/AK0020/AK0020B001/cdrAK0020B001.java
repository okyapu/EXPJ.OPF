/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AK0020/src/com/nec/jp/orteus/metamorBase/AK0020/AK0020B001/cdrAK0020B001.java,v $
 *
...
public class cdrAK0020B001 extends Object
		implements IBatchAppCommon
{
	...
	public void initialize() throws BatchAppException, SystemException
	{
		try {
			...
			m_med.setcallSqlMonthlyProc( new callSqlMonthlyProc(m_med, m_conductor) );
			m_med.setreadSysBatParm( new readSysBatParm(m_med, m_conductor) );
			m_med.setselectPlantCd( new selectPlantCd(m_med, m_conductor) );
			m_med.setselectAllPlantCd( new selectAllPlantCd(m_med, m_conductor) );
			m_med.setselectFinalMonthlyDate( new selectFinalMonthlyDate(m_med, m_conductor) );
			m_med.setselectUserCd( new selectUserCd(m_med, m_conductor) );
			m_med.setCtrlMain( new CtrlMain(m_med, m_conductor) );
			m_conductor.addObject( m_med.getcallSqlMonthlyProc() );
			m_conductor.addObject( m_med.getreadSysBatParm() );
			m_conductor.addObject( m_med.getselectPlantCd() );
			m_conductor.addObject( m_med.getselectAllPlantCd() );
			m_conductor.addObject( m_med.getselectFinalMonthlyDate() );
			m_conductor.addObject( m_med.getselectUserCd() );
	...
	public int getType() { return m_conductor.getType(); }
        ...
        public int beginProc() throws BatchAppException
        {
         try {
          ...
          setCommitFlag(false);
          BatchAppException be=new BatchAppException("cdrAK0020B001", "beginProc", "conductorの初期処理に失敗しました");
	...
	medAK0020B001 m_med=new medAK0020B001();

	// BatchAppConductorクラスインスタンス
	BatchAppConductor m_conductor=new BatchAppConductor("AK0020B001");
	...
	/**
	 * ctrAK0020B001クラス 標準コンストラクタ
	 *
		 */
	public cdrAK0020B001() throws BatchAppException
	{
		initialize();
