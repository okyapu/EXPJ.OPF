/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AF0130/src/com/nec/jp/orteus/metamorBase/AF0130/AF0130B001/SQLMANISSUEINSTINTERFACE.java,v $
 *
...
/**
 * CLASS     : SQLMANISSUEINSTINTERFACE クラス
 * ファイル・クラス説明
...
public class SQLMANISSUEINSTINTERFACE extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public List call() throws BatchAppException
		{
			try {
				...
				e.printStackTrace();
				BatchAppException be=new BatchAppException("SQLMANISSUEINSTINTERFACE", "call", "Stored Procedure条件設定処理失敗");
				...
				if (cstmt != null) {
					try {
						...
						ef.printStackTrace();
						BatchAppException bef = new BatchAppException("SQLMANISSUEINSTINTERFACE", "call", "Stored Procedureクローズ処理失敗");
		 ...
		 */
		public medAF0130B001 call(ResultSet rs) throws SQLException
		{
			if(rs == null || rs.next()==false) return null;
			medAF0130B001 data = new medAF0130B001();
			m_med.setpnumReturn(cstmt.getString(11));
			return data;
		}
	...
	/**
	 * SQLMANISSUEINSTINTERFACEクラスの標準コンストラクタ
	 *
		 */
	public SQLMANISSUEINSTINTERFACE(medAF0130B001 med, BatchAppConductor cdr) throws SystemException
	{
	...
	protected static String m_calcmd = "{" + "Call SQLMANISSUEINSTINTERFACE(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" + "}";
