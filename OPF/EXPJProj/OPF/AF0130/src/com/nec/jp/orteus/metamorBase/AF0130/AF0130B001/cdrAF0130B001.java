/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AF0130/src/com/nec/jp/orteus/metamorBase/AF0130/AF0130B001/cdrAF0130B001.java,v $
 *
...
public class cdrAF0130B001 extends Object
		implements IBatchAppCommon
{
	...
	public void initialize() throws BatchAppException, SystemException
	{
		try {
			...
			m_med.setSQLMANISSUEINSTINTERFACE( new SQLMANISSUEINSTINTERFACE(m_med, m_conductor) );
			...
			m_med.setT_MAN_ISSUE_INST_TEMP( new T_MAN_ISSUE_INST_TEMP(m_med, m_conductor) );
			m_med.setdeleteT_MAN_ISSUE_INST_TEMP( new deleteT_MAN_ISSUE_INST_TEMP(m_med, m_conductor) );
			m_med.setCtrlMain( new CtrlMain(m_med, m_conductor) );
			m_conductor.addObject( m_med.getSQLMANISSUEINSTINTERFACE() );
			...
			m_conductor.addObject( m_med.getT_MAN_ISSUE_INST_TEMP() );
			m_conductor.addObject( m_med.getdeleteT_MAN_ISSUE_INST_TEMP() );
	...
	public int beginProc() throws BatchAppException
	{
		try {
			...
			setCommitFlag(false);
			BatchAppException be=new BatchAppException("cdrAF0130B001", "beginProc", "conductorの初期処理に失敗しました");
	...
	medAF0130B001 m_med=new medAF0130B001();

	// BatchAppConductorクラスインスタンス
	BatchAppConductor m_conductor=new BatchAppConductor("AF0130B001");
	...
	/**
	 * ctrAF0130B001クラス 標準コンストラクタ
	 *
		 */
	public cdrAF0130B001() throws BatchAppException
	{
		initialize();
