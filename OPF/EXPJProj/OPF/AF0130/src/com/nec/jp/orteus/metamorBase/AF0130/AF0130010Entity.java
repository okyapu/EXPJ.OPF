/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AF0130/src/com/nec/jp/orteus/metamorBase/AF0130/AF0130010Entity.java,v $
 *
...
public class AF0130010Entity extends DataObject
{
	...
	// select_T_ISSUE_INST1クラス インスタンス
	public select_T_ISSUE_INST1 mselect_T_ISSUE_INST1 = new select_T_ISSUE_INST1();

	// check_T_ISSUE_INSTクラス インスタンス
	public check_T_ISSUE_INST mcheck_T_ISSUE_INST = new check_T_ISSUE_INST();

	// check_JOB_ODR_CDクラス インスタンス
	public check_JOB_ODR_CD mcheck_JOB_ODR_CD = new check_JOB_ODR_CD();

	// select_M_WHクラス インスタンス
	public select_M_WH mselect_M_WH = new select_M_WH();

	// select_LOT_CTRL_FLGクラス インスタンス
	public select_LOT_CTRL_FLG mselect_LOT_CTRL_FLG = new select_LOT_CTRL_FLG();

	// check_TLOT_CTRLクラス インスタンス
	public check_TLOT_CTRL mcheck_TLOT_CTRL = new check_TLOT_CTRL();

	// select_T_ITEM_STOCKクラス インスタンス
	public select_T_ITEM_STOCK mselect_T_ITEM_STOCK = new select_T_ITEM_STOCK();

	// select_T_JOB_ODR_CD_STOCKクラス インスタンス
	public select_T_JOB_ODR_CD_STOCK mselect_T_JOB_ODR_CD_STOCK = new select_T_JOB_ODR_CD_STOCK();

	// select_BEST_BEFORE_DATEクラス インスタンス
	public select_BEST_BEFORE_DATE mselect_BEST_BEFORE_DATE = new select_BEST_BEFORE_DATE();

	// selectSYS_ACTUAL_COST_CTRL_AC	クラス インスタンス
	public selectSYS_ACTUAL_COST_CTRL_AC	 mselectSYS_ACTUAL_COST_CTRL_AC	 = new selectSYS_ACTUAL_COST_CTRL_AC	();

	// c_BEST_BEFORE_DATE	クラス インスタンス
	public c_BEST_BEFORE_DATE	 mc_BEST_BEFORE_DATE	 = new c_BEST_BEFORE_DATE	();

	// SELECT_SYS_PARAMETER	クラス インスタンス
	public SELECT_SYS_PARAMETER	 mSELECT_SYS_PARAMETER	 = new SELECT_SYS_PARAMETER	();

	// SYS_INSTALL_OPTIONS	クラス インスタンス
	public SYS_INSTALL_OPTIONS	 mSYS_INSTALL_OPTIONS	 = new SYS_INSTALL_OPTIONS	();

	// SYS_DEBT_CTRL	クラス インスタンス
	public SYS_DEBT_CTRL	 mSYS_DEBT_CTRL	 = new SYS_DEBT_CTRL	();

	// selectクラス インスタンス
	public select mselect = new select();

	// insertSub1T_RCV_ISSUEクラス インスタンス
	public insertSub1T_RCV_ISSUE minsertSub1T_RCV_ISSUE = new insertSub1T_RCV_ISSUE();

	// mselectM_COSTクラス インスタンス
	public mselectM_COST mmselectM_COST = new mselectM_COST();

	// insertSub1T_PAST_ONEROUS_CONSクラス インスタンス
	...
	// selectSub1_ODR_STOCKクラス インスタンス
...
+"";		//////////////////////////////
	...
	public class ei_CSVOut extends DataObject
	{
		...
		String m_write_fname="AF0130010.csv";

		protected WriteCsv m_writer=null;		// csv書込み用

		String m_ProjName="AF0130010";
	 ...
	 * Entity定義 静的SQL
	 */
	public class select_T_ISSUE_INST1 extends DataObject
	{
...
+"  ISSUE_INST_CD = ?";
		...
		//{{user_implement_dev:select_T_ISSUE_INST1_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:select_T_ISSUE_INST1_def
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AF0130010Struct data, String replaceStr)
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AF0130010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_T_ISSUE_INST1_read
			if(m_selcmd==null) throw new FoundationException("select_T_ISSUE_INST1", "read", "クエリー未登録");
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AF0130010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_T_ISSUE_INST1_read2
			if(m_selcmd==null) throw new FoundationException("select_T_ISSUE_INST1", "read", "クエリー未登録");
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AF0130010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_T_ISSUE_INST1_read3
			if(m_selcmd==null) throw new FoundationException("select_T_ISSUE_INST1", "read", "クエリー未登録");
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(PreparedStatement stmt, AF0130010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public PreparedStatement prepare(Connection conn, String query, AF0130010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt;
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public ResultSet executeQuery(PreparedStatement stmt, AF0130010Struct data) throws FoundationException, SQLException
		{
			int no=1;
		 ...
		 * レコードデータをStructに格納して返します
		 */
		public AF0130010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			if(rs.next()==false) return null;

			AF0130010Struct data = new AF0130010Struct();
			...
			data.setWORK_ODR_CD( getString(8, rs) );
			data.setWORK_IN_PROC_CD( getString(9, rs) );
			data.setRCV_WH_CD( getString(10, rs) );
			data.setISSUE_CMPLT_FLG( getString(11, rs) );
			data.setISSUE_TYP( getString(12, rs) );
			data.setCONS_TYP( getString(13, rs) );
			data.setISSUE_INST_QTY( getString(14, rs) );
			data.setTOTAL_ISSUE_QTY( getString(15, rs) );
			data.setSHIP_REMAIN_QTY( getString(16, rs) );
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(IDbConnection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("select_T_ISSUE_INST1", "hasRecord", "クエリー未登録");
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(IDbConnection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_T_ISSUE_INST1_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(PreparedStatement stmt, AF0130010Struct data) throws FoundationException, SQLException
		{
			ResultSet rs=executeQuery(stmt, data);
			boolean ret=true;
		...
		public void clear()
		{
			//{{user_implement_dev:select_T_ISSUE_INST1_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:select_T_ISSUE_INST1_clear
		...
		/**
		 * select_T_ISSUE_INST1クラスの標準コンストラクタ
		 */
		public select_T_ISSUE_INST1()
		{
			//{{user_implement_dev:select_T_ISSUE_INST1_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:select_T_ISSUE_INST1_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class check_T_ISSUE_INST extends DataObject
	{
...
+"  ISSUE_INST_CD = ?";
		...
		//{{user_implement_dev:check_T_ISSUE_INST_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:check_T_ISSUE_INST_def
		...
		public boolean check(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:check_T_ISSUE_INST_check
		...
		public void clear()
		{
			//{{user_implement_dev:check_T_ISSUE_INST_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:check_T_ISSUE_INST_clear
		...
		/**
		 * check_T_ISSUE_INSTクラスの標準コンストラクタ
		 */
		public check_T_ISSUE_INST()
		{
			//{{user_implement_dev:check_T_ISSUE_INST_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:check_T_ISSUE_INST_constractor
...
+"  T_JOB_ODR.JOB_ODR_CD = ?";
	 ...
	 * Entity定義 静的SQL
	 */
	public class select_M_WH extends DataObject
	{
		protected String m_selcmd = "select "
+"  WH_CD, "
+"  PLANT_CD, "
...
+"  WH_CD = ?";
		...
		//{{user_implement_dev:select_M_WH_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:select_M_WH_def
		...
		public List read(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_M_WH_read
			if(m_selcmd==null) throw new FoundationException("select_M_WH", "read", "クエリー未登録");
		...
		public List read(Connection conn, AF0130010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_M_WH_read2
			if(m_selcmd==null) throw new FoundationException("select_M_WH", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AF0130010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_M_WH_read3
			if(m_selcmd==null) throw new FoundationException("select_M_WH", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean hasRecord(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("select_M_WH", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_M_WH_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:select_M_WH_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:select_M_WH_clear
		...
		/**
		 * select_M_WHクラスの標準コンストラクタ
		 */
		public select_M_WH()
		{
			//{{user_implement_dev:select_M_WH_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:select_M_WH_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class select_LOT_CTRL_FLG extends DataObject
	{
		protected String m_selcmd = "select "
+"  M_ITEM.LOT_CTRL_FLG, "
+"  MRP_ODR_TYP "
...
+"  and T_ISSUE_INST.ITEM_CD = M_ITEM.ITEM_CD";
		...
		//{{user_implement_dev:select_LOT_CTRL_FLG_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:select_LOT_CTRL_FLG_def
		...
		public List read(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_LOT_CTRL_FLG_read
			if(m_selcmd==null) throw new FoundationException("select_LOT_CTRL_FLG", "read", "クエリー未登録");
		...
		public List read(Connection conn, AF0130010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_LOT_CTRL_FLG_read2
			if(m_selcmd==null) throw new FoundationException("select_LOT_CTRL_FLG", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AF0130010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_LOT_CTRL_FLG_read3
			if(m_selcmd==null) throw new FoundationException("select_LOT_CTRL_FLG", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean hasRecord(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("select_LOT_CTRL_FLG", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_LOT_CTRL_FLG_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:select_LOT_CTRL_FLG_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:select_LOT_CTRL_FLG_clear
		...
		/**
		 * select_LOT_CTRL_FLGクラスの標準コンストラクタ
		 */
		public select_LOT_CTRL_FLG()
		{
			//{{user_implement_dev:select_LOT_CTRL_FLG_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:select_LOT_CTRL_FLG_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class check_TLOT_CTRL extends DataObject
	{
		protected String m_selcmd = null;
		protected String m_chkcmd = "select "
+"  1 "
...
+"where "
+"  T_LOT_CTRL.LOT_NO = ? "
+"  and T_LOT_CTRL.ITEM_CD = T_ISSUE_INST.ITEM_CD "
+"  and T_ISSUE_INST.ISSUE_INST_CD = ?";
		...
		//{{user_implement_dev:check_TLOT_CTRL_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:check_TLOT_CTRL_def
		...
		public boolean check(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:check_TLOT_CTRL_check
			PreparedStatement stmt = prepare(conn, m_chkcmd, data);
		...
		public void clear()
		{
			//{{user_implement_dev:check_TLOT_CTRL_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:check_TLOT_CTRL_clear
		...
		/**
		 * check_TLOT_CTRLクラスの標準コンストラクタ
		 */
		public check_TLOT_CTRL()
		{
			//{{user_implement_dev:check_TLOT_CTRL_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:check_TLOT_CTRL_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class select_T_ITEM_STOCK extends DataObject
	{
		protected String m_selcmd = "select "
+"  1 "
+"from "
...
+"  T_ISSUE_INST "
+"where "
+"  T_ITEM_STOCK.ITEM_CD = T_ISSUE_INST.ITEM_CD "
...
+"  and T_ISSUE_INST.ISSUE_INST_CD = ?";
		...
		//{{user_implement_dev:select_T_ITEM_STOCK_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:select_T_ITEM_STOCK_def
		...
		public List read(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_T_ITEM_STOCK_read
			if(m_selcmd==null) throw new FoundationException("select_T_ITEM_STOCK", "read", "クエリー未登録");
		...
		public List read(Connection conn, AF0130010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_T_ITEM_STOCK_read2
			if(m_selcmd==null) throw new FoundationException("select_T_ITEM_STOCK", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AF0130010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_T_ITEM_STOCK_read3
			if(m_selcmd==null) throw new FoundationException("select_T_ITEM_STOCK", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean hasRecord(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("select_T_ITEM_STOCK", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_T_ITEM_STOCK_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:select_T_ITEM_STOCK_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:select_T_ITEM_STOCK_clear
		...
		/**
		 * select_T_ITEM_STOCKクラスの標準コンストラクタ
		 */
		public select_T_ITEM_STOCK()
		{
			//{{user_implement_dev:select_T_ITEM_STOCK_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:select_T_ITEM_STOCK_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class select_T_JOB_ODR_CD_STOCK extends DataObject
	{
		protected String m_selcmd = "select "
+"  1 "
+"from "
...
+"  T_ISSUE_INST "
+"where "
+"  T_JOB_ODR_CD_STOCK.ITEM_CD = T_ISSUE_INST.ITEM_CD "
...
+"  and T_ISSUE_INST.ISSUE_INST_CD = ?";
		...
		//{{user_implement_dev:select_T_JOB_ODR_CD_STOCK_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:select_T_JOB_ODR_CD_STOCK_def
		...
		public List read(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_T_JOB_ODR_CD_STOCK_read
			if(m_selcmd==null) throw new FoundationException("select_T_JOB_ODR_CD_STOCK", "read", "クエリー未登録");
		...
		public List read(Connection conn, AF0130010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_T_JOB_ODR_CD_STOCK_read2
			if(m_selcmd==null) throw new FoundationException("select_T_JOB_ODR_CD_STOCK", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AF0130010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_T_JOB_ODR_CD_STOCK_read3
			if(m_selcmd==null) throw new FoundationException("select_T_JOB_ODR_CD_STOCK", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean hasRecord(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("select_T_JOB_ODR_CD_STOCK", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_T_JOB_ODR_CD_STOCK_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:select_T_JOB_ODR_CD_STOCK_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:select_T_JOB_ODR_CD_STOCK_clear
		...
		/**
		 * select_T_JOB_ODR_CD_STOCKクラスの標準コンストラクタ
		 */
		public select_T_JOB_ODR_CD_STOCK()
		{
			//{{user_implement_dev:select_T_JOB_ODR_CD_STOCK_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:select_T_JOB_ODR_CD_STOCK_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class select_BEST_BEFORE_DATE extends DataObject
	{
		protected String m_selcmd = "select "
+"  BEST_BEFORE_DATE "
+"from "
...
+"where "
+"  T_LOT_CTRL.LOT_NO = ? "
+"  and T_LOT_CTRL.ITEM_CD = ISSUE_INST_CD.ITEM_CD "
+"  and T_ISSUE_INST.ISSUE_INST_CD = ?";
		protected String m_chkcmd = null;
		protected String m_inscmd = null;
		protected String m_updcmd = null;
		...
		//{{user_implement_dev:select_BEST_BEFORE_DATE_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:select_BEST_BEFORE_DATE_def
		...
		public List read(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_BEST_BEFORE_DATE_read
			if(m_selcmd==null) throw new FoundationException("select_BEST_BEFORE_DATE", "read", "クエリー未登録");
		...
		public List read(Connection conn, AF0130010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_BEST_BEFORE_DATE_read2
			if(m_selcmd==null) throw new FoundationException("select_BEST_BEFORE_DATE", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AF0130010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_BEST_BEFORE_DATE_read3
			if(m_selcmd==null) throw new FoundationException("select_BEST_BEFORE_DATE", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean hasRecord(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("select_BEST_BEFORE_DATE", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_BEST_BEFORE_DATE_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:select_BEST_BEFORE_DATE_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:select_BEST_BEFORE_DATE_clear
		...
		/**
		 * select_BEST_BEFORE_DATEクラスの標準コンストラクタ
		 */
		public select_BEST_BEFORE_DATE()
		{
			//{{user_implement_dev:select_BEST_BEFORE_DATE_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:select_BEST_BEFORE_DATE_constractor
...
+"  PLANT_CD = ?";
		...
		//{{user_implement_dev:selectSYS_ACTUAL_COST_CTRL_AC	_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:selectSYS_ACTUAL_COST_CTRL_AC	_def
		...
		public List read(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectSYS_ACTUAL_COST_CTRL_AC	_read
			if(m_selcmd==null) throw new FoundationException("selectSYS_ACTUAL_COST_CTRL_AC	", "read", "クエリー未登録");
		...
		public List read(Connection conn, AF0130010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectSYS_ACTUAL_COST_CTRL_AC	_read2
			if(m_selcmd==null) throw new FoundationException("selectSYS_ACTUAL_COST_CTRL_AC	", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AF0130010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectSYS_ACTUAL_COST_CTRL_AC	_read3
			if(m_selcmd==null) throw new FoundationException("selectSYS_ACTUAL_COST_CTRL_AC	", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean hasRecord(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("selectSYS_ACTUAL_COST_CTRL_AC	", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectSYS_ACTUAL_COST_CTRL_AC	_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:selectSYS_ACTUAL_COST_CTRL_AC	_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:selectSYS_ACTUAL_COST_CTRL_AC	_clear
		...
		/**
		 * selectSYS_ACTUAL_COST_CTRL_AC	クラスの標準コンストラクタ
		 */
		public selectSYS_ACTUAL_COST_CTRL_AC	()
		{
			//{{user_implement_dev:selectSYS_ACTUAL_COST_CTRL_AC	_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:selectSYS_ACTUAL_COST_CTRL_AC	_constractor
...
+"  AND T_ISSUE_INST.ISSUE_INST_CD = ?";
		...
		//{{user_implement_dev:c_BEST_BEFORE_DATE	_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:c_BEST_BEFORE_DATE	_def
		...
		public List read(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:c_BEST_BEFORE_DATE	_read
		...
		public List read(Connection conn, AF0130010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:c_BEST_BEFORE_DATE	_read2
			if(m_selcmd==null) throw new FoundationException("c_BEST_BEFORE_DATE	", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AF0130010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:c_BEST_BEFORE_DATE	_read3
			if(m_selcmd==null) throw new FoundationException("c_BEST_BEFORE_DATE	", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public PreparedStatement prepare(Connection conn, String query, AF0130010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				ary.addElement(data.getISSUE_DATE_SUB());
				if(isNull(data.getISSUE_DATE_SUB())) isNull = true;
				ary.addElement(data.getLOT_NO());
				if(isNull(data.getLOT_NO())) isNull = true;
				ary.addElement(data.getISSUE_INST_CD());
				if(isNull(data.getISSUE_INST_CD())) isNull = true;
		...
		public ResultSet executeQuery(PreparedStatement stmt, AF0130010Struct data) throws FoundationException, SQLException
		{
			...
			// 静的SQL文の生成
			setString(no ++, data.getISSUE_DATE_SUB(), stmt);
			// 静的SQL文の生成
			setString(no ++, data.getLOT_NO(), stmt);
			// 静的SQL文の生成
			setString(no ++, data.getISSUE_INST_CD(), stmt);
		...
		public boolean check(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:c_BEST_BEFORE_DATE	_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:c_BEST_BEFORE_DATE	_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:c_BEST_BEFORE_DATE	_clear
		...
		/**
		 * c_BEST_BEFORE_DATE	クラスの標準コンストラクタ
		 */
		public c_BEST_BEFORE_DATE	()
		{
			//{{user_implement_dev:c_BEST_BEFORE_DATE	_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:c_BEST_BEFORE_DATE	_constractor
...
+"  NAME = ?";
		...
		//{{user_implement_dev:SELECT_SYS_PARAMETER	_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:SELECT_SYS_PARAMETER	_def
		...
		public List read(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:SELECT_SYS_PARAMETER	_read
		...
		public List read(Connection conn, AF0130010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:SELECT_SYS_PARAMETER	_read2
			if(m_selcmd==null) throw new FoundationException("SELECT_SYS_PARAMETER	", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AF0130010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:SELECT_SYS_PARAMETER	_read3
			if(m_selcmd==null) throw new FoundationException("SELECT_SYS_PARAMETER	", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean check(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:SELECT_SYS_PARAMETER	_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:SELECT_SYS_PARAMETER	_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:SELECT_SYS_PARAMETER	_clear
		...
		/**
		 * SELECT_SYS_PARAMETER	クラスの標準コンストラクタ
		 */
		public SELECT_SYS_PARAMETER	()
		{
			//{{user_implement_dev:SELECT_SYS_PARAMETER	_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:SELECT_SYS_PARAMETER	_constractor
...
+"  OPTION_ID = 'C*'";
		...
		//{{user_implement_dev:SYS_INSTALL_OPTIONS	_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:SYS_INSTALL_OPTIONS	_def
		...
		public List read(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:SYS_INSTALL_OPTIONS	_read
		...
		public List read(Connection conn, AF0130010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:SYS_INSTALL_OPTIONS	_read2
			if(m_selcmd==null) throw new FoundationException("SYS_INSTALL_OPTIONS	", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AF0130010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:SYS_INSTALL_OPTIONS	_read3
			if(m_selcmd==null) throw new FoundationException("SYS_INSTALL_OPTIONS	", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean check(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:SYS_INSTALL_OPTIONS	_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:SYS_INSTALL_OPTIONS	_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:SYS_INSTALL_OPTIONS	_clear
		...
		/**
		 * SYS_INSTALL_OPTIONS	クラスの標準コンストラクタ
		 */
		public SYS_INSTALL_OPTIONS	()
		{
			//{{user_implement_dev:SYS_INSTALL_OPTIONS	_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:SYS_INSTALL_OPTIONS	_constractor
...
+"  )";
		...
		//{{user_implement_dev:SYS_DEBT_CTRL	_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:SYS_DEBT_CTRL	_def
		...
		public List read(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:SYS_DEBT_CTRL	_read
		...
		public List read(Connection conn, AF0130010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:SYS_DEBT_CTRL	_read2
			if(m_selcmd==null) throw new FoundationException("SYS_DEBT_CTRL	", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AF0130010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:SYS_DEBT_CTRL	_read3
			if(m_selcmd==null) throw new FoundationException("SYS_DEBT_CTRL	", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean check(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:SYS_DEBT_CTRL	_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:SYS_DEBT_CTRL	_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:SYS_DEBT_CTRL	_clear
		...
		/**
		 * SYS_DEBT_CTRL	クラスの標準コンストラクタ
		 */
		public SYS_DEBT_CTRL	()
		{
			//{{user_implement_dev:SYS_DEBT_CTRL	_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:SYS_DEBT_CTRL	_constractor
...
+"  T_ISSUE_INST.\"ISSUE_INST_CD\"";
		...
		public ResultSet executeQuery(PreparedStatement stmt, AF0130010Struct data) throws FoundationException, SQLException
		{
			...
			// 静的SQL文の生成
			setString(no ++, data.getw_ISSUE_INST_CD(), stmt);
			// 静的SQL文の生成
			setString(no ++, data.getw_WS_CD(), stmt);
			// 静的SQL文の生成
			setString(no ++, data.getw_VEND_CD(), stmt);
			// 静的SQL文の生成
			setString(no ++, data.getw_ISSUE_CMPLT_FLG(), stmt);
			// 静的SQL文の生成
			setString(no ++, data.getw_PLANT_CD(), stmt);
			// 静的SQL文の生成
			setString(no ++, data.gett_WORK_ODR_CD(), stmt);
			// 静的SQL文の生成
			setString(no ++, data.gett_WORK_IN_PROC_CD(), stmt);
			// 静的SQL文の生成
			setString(no ++, data.getw_PUCH_ODR_CD(), stmt);
			// 静的SQL文の生成
			setString(no ++, data.getw_LOT_CTRL_FLG(), stmt);
...
+"values "
+"  (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, TO_NUMBER(?), TO_DATE(?, 'YYYY/MM/DD HH24:MI'), ?, ?, ?, ?, ?, ?, ?, ?, ?)";
		protected String m_updcmd = null;
		protected String m_delcmd = null;
		protected String m_spcmd = null;

		protected String m_sCreateProgramName="AF0130010";
		protected String m_sUpdateProgramName="AF0130010";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int create(IDbConnection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int create(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt=null;
		...
		/**
		 * insertSub1T_RCV_ISSUEクラスの標準コンストラクタ
		 */
	 ...
	 * Entity定義 静的SQL
	 */
	public class mselectM_COST extends DataObject
	{
		protected String m_selcmd = "select "
...
+"  and M_CONS_UNIT_COST.\"EFF_PHASE_IN_DATE\" <= TO_DATE(?, 'YYYY/MM/DD HH24:MI') "
+"order by "
+"  M_CONS_UNIT_COST.\"EFF_PHASE_IN_DATE\" desc";
		...
		//{{user_implement_dev:mselectM_COST_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:mselectM_COST_def
		...
		public List read(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:mselectM_COST_read
			if(m_selcmd==null) throw new FoundationException("mselectM_COST", "read", "クエリー未登録");
		...
		public List read(Connection conn, AF0130010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:mselectM_COST_read2
			if(m_selcmd==null) throw new FoundationException("mselectM_COST", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AF0130010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:mselectM_COST_read3
			if(m_selcmd==null) throw new FoundationException("mselectM_COST", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean hasRecord(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("mselectM_COST", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:mselectM_COST_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:mselectM_COST_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:mselectM_COST_clear
		...
		/**
		 * mselectM_COSTクラスの標準コンストラクタ
		 */
		public mselectM_COST()
		{
			//{{user_implement_dev:mselectM_COST_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:mselectM_COST_constractor
...
+"values "
+"  (?, ?, ?, ?, ?, ?, TO_DATE(?, 'YYYY/MM/DD HH24:MI'), TO_NUMBER(?), TO_NUMBER(?), ?, ?, ?, ?, ?, ?, ?, ?, null, 0, 0, ?)";
		protected String m_updcmd = null;
		protected String m_delcmd = null;
		protected String m_spcmd = null;
		...
		public int create(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				...
				setString(24, data.getSTOCK_LOT_CD(), stmt);
		...
		/**
		 * insertSub1T_PAST_ONEROUS_CONSクラスの標準コンストラクタ
		 */
...
+"VALUES "
+"  (?, ?, ?, ?, ?, TO_NUMBER(?), TO_DATE(?, 'YYYY/MM/DD HH24:MI'), 0)";
		protected String m_updcmd = "UPDATE "
+"  T_LOT_ISSUE_INST "
+"SET "
+"  ISSUE_QTY = TO_NUMBER(?), "
+"  ISSUE_DATE = TO_DATE(?, 'YYYY/MM/DD HH24:MI') "
+"WHERE "
...
+"  AND T_LOT_ISSUE_INST.LOT_NO = ?";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int update(IDbConnection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int update(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt=null;
			int modifyCount;
...
+"  and M_WH.\"MRP_FLG\" = 1";
		...
		public List read(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			...
			if(m_selcmd==null) throw new FoundationException("selectSub1_ODR_STOCK", "read", "クエリー未登録");
		...
		public boolean hasRecord(Connection conn, AF0130010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("selectSub1_ODR_STOCK", "hasRecord", "クエリー未登録");
		...
		/**
		 * selectSub1_ODR_STOCKクラスの標準コンストラクタ
		 */
...
+"  name = 'PAST_RESULT_ENTRY_TYP'";
	...
	public void clear()
	{
		mselect_T_ISSUE_INST1.clear();
		mselect_T_ISSUE_INST1 = null;
		mcheck_T_ISSUE_INST.clear();
		mcheck_T_ISSUE_INST = null;
		mcheck_JOB_ODR_CD.clear();
		mcheck_JOB_ODR_CD = null;
		mselect_M_WH.clear();
		mselect_M_WH = null;
		mselect_LOT_CTRL_FLG.clear();
		mselect_LOT_CTRL_FLG = null;
		mcheck_TLOT_CTRL.clear();
		mcheck_TLOT_CTRL = null;
		mselect_T_ITEM_STOCK.clear();
		mselect_T_ITEM_STOCK = null;
		mselect_T_JOB_ODR_CD_STOCK.clear();
		mselect_T_JOB_ODR_CD_STOCK = null;
		mselect_BEST_BEFORE_DATE.clear();
		mselect_BEST_BEFORE_DATE = null;
	 ...
	 */
	public AF0130010Entity() throws FoundationException
	{
