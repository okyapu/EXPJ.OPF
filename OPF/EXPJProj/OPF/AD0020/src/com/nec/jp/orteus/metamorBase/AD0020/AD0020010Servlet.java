/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AD0020/src/com/nec/jp/orteus/metamorBase/AD0020/AD0020010Servlet.java,v $
 *
...
public class AD0020010Servlet extends HttpServlet
{
	 ...
	 * @param control AD0020010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AD0020010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AD0020010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AD0020010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AD0020010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AD0020010Entity entity = control.entity;
		AD0020010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AD0020010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
			// TODO: ユーザ定義のコードを記述してください
//			objMessage.m_writer.write( Level.ALL, "AD0020010"+" $Revision: 1.7 $" );
			control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AD0020010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AD0020010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AD0020010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AD0020");
		logger.entering("AD0020010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
...
//			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AD0020010-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
		}
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AD0020010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickSelect(
					...
					HttpSession so,
					Hashtable params,
					AD0020010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AD0020010Entity entity = control.entity;
		AD0020010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AD0020");
		logger.entering("AD0020010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickSelect>
		logger.exiting("AD0020010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
					...
					AD0020010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AD0020");
		logger.entering("AD0020010Servlet"+":USER="+request.getRemoteUser(),"onClickFlashTree");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickFlashTree>
		logger.exiting("AD0020010Servlet"+":USER="+request.getRemoteUser(),"onClickFlashTree");
					...
					AD0020010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AD0020");
		logger.entering("AD0020010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("AD0020010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
	...
	public String onClickShowDetail(
					...
					AD0020010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = "/AD0020010Detail.jsp";		// 移動先ＵＲＬ
		AD0020010Entity entity = control.entity;
		AD0020010Struct struct = control.struct;
		getSessionParameters(so, params, struct);

		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AD0020");
		logger.entering("AD0020010Servlet"+":USER="+request.getRemoteUser(),"onClickShowDetail");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickShowDetail>
		logger.exiting("AD0020010Servlet"+":USER="+request.getRemoteUser(),"onClickShowDetail");
	...
	public String onClickAddTree(
					...
					AD0020010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = "/AD0020010Control.jsp";		// 移動先ＵＲＬ
		AD0020010Entity entity = control.entity;
		AD0020010Struct struct = control.struct;
		getSessionParameters(so, params, struct);

		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AD0020");
		logger.entering("AD0020010Servlet"+":USER="+request.getRemoteUser(),"onClickAddTree");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickAddTree>
		logger.exiting("AD0020010Servlet"+":USER="+request.getRemoteUser(),"onClickAddTree");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AD0020010Struct struct)
	{
		...
		String[] AD0020010tree1 = ((params.containsKey("AD0020010tree1")) ? (String[])params.get("AD0020010tree1") : (String[])null);
		...
		struct.setAD0020010tree1( ((AD0020010tree1 == null) ? (String)null : AD0020010tree1[0]) );
		struct.setList_AD0020010tree1(TypeConverter.convert(AD0020010tree1));
	...
	public static String DEFAULT_TARGET = "/AD0020010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAD0020010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAD0020010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AD0020");
		logger.entering("AD0020010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AD0020010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AD0020010Control control;
		AD0020010Entity  entity = null;
		AD0020010Struct  struct = null;
		...
		try {
			...
			if( (control = (AD0020010Control)so.getAttribute("AD0020010Control_"+request.getSession(false).getId())) == null ) {
				control = new AD0020010Control();
			...
			try {
				...
				so.setAttribute("AD0020010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.AD0020.AD0020010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AD0020010Servlet()
	{
		//{{user_implement_dev:<AD0020010_DisConnect_FLG>
		...
		//{{user_implement_dev:<AD0020010Servlet>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<AD0020010Servlet>
	}
