/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AD0020/src/com/nec/jp/orteus/metamorBase/AD0020/AD0020010Entity.java,v $
 *
...
public class AD0020010Entity extends DataObject
{
...
+"";		//////////////////////////////
	...
	public class ei_CSVOut extends DataObject
	{
		...
		String m_write_fname="AD0020010.csv";

		protected WriteCsv m_writer=null;		// csv書込み用

		String m_ProjName="AD0020010";
...
+"  T_OD.\"ITEM_CD\"";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AD0020010Struct data) throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AD0020010Struct data, String replaceStr)
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AD0020010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AD0020010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AD0020010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AD0020010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(PreparedStatement stmt, AD0020010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public PreparedStatement prepare(Connection conn, String query, AD0020010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt;
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public ResultSet executeQuery(PreparedStatement stmt, AD0020010Struct data) throws FoundationException, SQLException
		{
			int no=1;
		 ...
		 * レコードデータをStructに格納して返します
		 */
		public AD0020010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			if(rs.next()==false) return null;

			AD0020010Struct data = new AD0020010Struct();
			...
			data.setOUTSIDE_TYP( getString(10, rs) );
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(IDbConnection conn, AD0020010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(Connection conn, AD0020010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(IDbConnection conn, AD0020010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(Connection conn, AD0020010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(PreparedStatement stmt, AD0020010Struct data) throws FoundationException, SQLException
		{
			ResultSet rs=executeQuery(stmt, data);
			boolean ret=true;
...
+"  T_JOB_ODR.JOB_ODR_TYP as \"JOB_ODR_TYP_DN\", "
...
+"  M_ITEM.UNIT_QTY_TYP as \"UNIT_QTY_TYP_DN\", "
...
+"  to_char(T_OD.\"ODR_STS_TYP\") as \"ODR_STS_TYP\", "
+"  T_OD.ODR_STS_TYP as \"ODR_STS_TYP_DN\", "
+"  to_char(T_OD.\"DM_STS_TYP\") as \"DM_STS_TYP\", "
+"  T_OD.DM_STS_TYP as \"DM_STS_TYP_DN\", "
...
+"  and T_OD.\"OD_NO\" = ?";
		...
		public AD0020010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setJOB_ODR_TYP_DN( getString(2, rs) );
			...
			data.setOUTSIDE_TYP( getString(8, rs) );
			data.setOUTSIDE_TYP_DN( getString(9, rs) );
			data.setMRP_ODR_TYP( getString(10, rs) );
			data.setMRP_ODR_TYP_DN( getString(11, rs) );
			data.setITEM_SPOIL( getString(12, rs) );
			data.setUNIT_QTY_TYP( getString(13, rs) );
			data.setUNIT_QTY_TYP_DN( getString(14, rs) );
			...
			data.setODR_STS_TYP_DN( getString(26, rs) );
			data.setDM_STS_TYP( getString(27, rs) );
			data.setDM_STS_TYP_DN( getString(28, rs) );
			data.setSTOCK_UNIT( getString(29, rs) );
	 ...
	 */
	public AD0020010Entity() throws FoundationException
	{
