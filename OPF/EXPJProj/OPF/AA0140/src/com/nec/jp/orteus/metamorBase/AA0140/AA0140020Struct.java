/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AA0140/src/com/nec/jp/orteus/metamorBase/AA0140/AA0140020Struct.java,v $
 *
 ...
 * @version $Revision: 1.4 $ $Date: 2012/12/04 05:44:34 $
 *
 */
//}}user_implement_code_header

public class AA0140020Struct extends DataStruct
{
	...
	public String getSBCNT_SIZE() { return m_SBCNT_SIZE; }
	...
	public List getList_SBCNT_SIZE() { return l_SBCNT_SIZE; }
	...
	public void setSBCNT_SIZE(String val) { m_SBCNT_SIZE = val; }
	...
	public void setList_SBCNT_SIZE(List list) { l_SBCNT_SIZE = list; }
	...
	public int setL2L_DOWNLOAD_FILE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DOWNLOAD_FILE.add(((AA0140020Struct) list.get(i)).getDOWNLOAD_FILE());
		}
		return size;
	}
	public int setL2L_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_CD.add(((AA0140020Struct) list.get(i)).getITEM_CD());
		}
		return size;
	}
	public int setL2L_ITEM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_NAME.add(((AA0140020Struct) list.get(i)).getITEM_NAME());
		}
		return size;
	}
	public int setL2L_w_PLANT_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_w_PLANT_CD.add(((AA0140020Struct) list.get(i)).getw_PLANT_CD());
		}
		return size;
	}
	public int setL2L_VEND_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_VEND_CD.add(((AA0140020Struct) list.get(i)).getVEND_CD());
		}
		return size;
	}
	public int setL2L_PROC_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROC_CD.add(((AA0140020Struct) list.get(i)).getPROC_CD());
		}
		return size;
	}
	public int setL2L_PROC_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROC_NAME.add(((AA0140020Struct) list.get(i)).getPROC_NAME());
		}
		return size;
	}
	public int setL2L_SBCNT_SIZE(List list) {
		int size = (list != null) ? list.size() : 0;
		if (size == 0) {
			return 0;
		}
		if (l_SBCNT_SIZE == null) {
			l_SBCNT_SIZE = new ArrayList();
		} else {
			l_SBCNT_SIZE.clear();
		}
		for (int i = 0; i < size; i++) {
			l_SBCNT_SIZE.add(((AA0140020Struct) list.get(i)).getSBCNT_SIZE());
		}
		return size;
	}
	public int setL2L_UNIT_COST(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_UNIT_COST.add(((AA0140020Struct) list.get(i)).getUNIT_COST());
		}
		return size;
	}
	public int setL2L_CUR_UNIT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUR_UNIT.add(((AA0140020Struct) list.get(i)).getCUR_UNIT());
		}
		return size;
	}
	public int setL2L_PROCESSING_COST(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROCESSING_COST.add(((AA0140020Struct) list.get(i)).getPROCESSING_COST());
		}
		return size;
	}
	public int setL2L_MATERIAL_COST(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_MATERIAL_COST.add(((AA0140020Struct) list.get(i)).getMATERIAL_COST());
		}
		return size;
	}
	public int setL2L_OTHER_OVERHEADS(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OTHER_OVERHEADS.add(((AA0140020Struct) list.get(i)).getOTHER_OVERHEADS());
		}
		return size;
	}
	public int setL2L_EFF_PHASE_IN_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_EFF_PHASE_IN_DATE.add(((AA0140020Struct) list.get(i)).getEFF_PHASE_IN_DATE());
		}
		return size;
	}
	public int setL2L_VEND_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_VEND_NAME.add(((AA0140020Struct) list.get(i)).getVEND_NAME());
		}
		return size;
	}
	public int setL2L_DISPLAY_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DISPLAY_NAME.add(((AA0140020Struct) list.get(i)).getDISPLAY_NAME());
		}
		return size;
	}
	public int setL2L_l_COUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_COUNT.add(((AA0140020Struct) list.get(i)).getl_COUNT());
		}
		return size;
	}
	public int setL2L_ROW_COUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ROW_COUNT.add(((AA0140020Struct) list.get(i)).getROW_COUNT());
		}
		return size;
	}
	...
	/**
	 * medAA0140020クラスの標準コンストラクタ
	 */
	public AA0140020Struct()
	{
	 ...
	 */
	public void setStruct(AA0140020Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructM(AA0140020Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
			...
			this.setSBCNT_SIZE(struct.getSBCNT_SIZE());
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructL(AA0140020Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
			...
			this.setList_SBCNT_SIZE(struct.getList_SBCNT_SIZE());
...
/*
	...
	// 第 7 変数初期値： i_PROC_NAME


	final static String i_PROC_NAME = null;

	// 第 8 変数初期値： i_SBCNT_SIZE


	final static String i_SBCNT_SIZE = null;

	// 第 9 変数初期値： i_UNIT_COST


	final static String i_UNIT_COST = null;

	// 第 10 変数初期値： i_CUR_UNIT


	final static String i_CUR_UNIT = null;

	// 第 11 変数初期値： i_PROCESSING_COST


	final static String i_PROCESSING_COST = null;

	// 第 12 変数初期値： i_MATERIAL_COST


	final static String i_MATERIAL_COST = null;

	// 第 13 変数初期値： i_OTHER_OVERHEADS
	...
	// 第 15 変数初期値： i_VEND_NAME


	final static String i_VEND_NAME = null;

	// 第 16 変数初期値： i_DISPLAY_NAME
