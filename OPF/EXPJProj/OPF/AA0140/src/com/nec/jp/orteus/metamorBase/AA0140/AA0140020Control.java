/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AA0140/src/com/nec/jp/orteus/metamorBase/AA0140/AA0140020Control.java,v $
 *
...
//	public Object getListvalue(int x) { return this.list.get(x); }	// リストの値を返します。
	public AA0140020Struct getListvalue(int x) { return (AA0140020Struct)(this.list.get(x)); }	// リストの値を返します。
	public AA0140020Struct getStruct() { return this.struct; }	// Structの値を返します。
	public AA0140020Struct createStruct() { return new AA0140020Struct(); }	// 新しいStructを作って返します。
	public void setStruct(Object structname) { this.struct.setStruct((AA0140020Struct)structname); }	// Structをセットします。
	...
	public void controlSelect() throws BusinessProcessException, FoundationException
	{
		...
		logger.entering("AA0140020Control"+":USER="+struct.getsUser_ID(),"controlSelect");
		...
		try {
			...
			if (itemList.isEmpty()) {
				...
				// 検索できた場合は「工場名」を設定する。
				AA0140020Struct itemStruct = (AA0140020Struct) itemList.get(0);
			...
			long rowCount = Long.parseLong(((AA0140020Struct)viewList.get(0)).getl_COUNT());
			// 対象件数=0件の場合エラ-
			if (rowCount==0) {
			...
			// リストデータを設定
			//AA0140020Struct viewStruct = (AA0140020Struct) viewList.get(0);
			...
			readStatus = NORMAL;
                ...
                //}}user_implement_dev:<controlSelect>
		logger.exiting("AA0140020Control"+":USER="+struct.getsUser_ID(),"controlSelect");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0140");
		logger.entering("AA0140020Control"+":USER="+struct.getsUser_ID(),"controlCsvOut");
		...
		try {	
			...
			String[] title = {
				...
				"Expj.VEND_CD",				//	取引先コード
				"Expj.VEND_NAME",			//	取引先名
				"Expj.PROC_CD",				//	品目別作業コード
				"Expj.PROC_NAME",			//	作業名
				"Expj.EFF_PHASE_IN_DATE",	//	有効開始日付
				"Expj.COMM_SIZE",			//	サイズ
				"Expj.UNIT_COST_TYP",		//	単価区分
				"Expj.UNIT_COST",			//	単価
				"Expj.CUR_UNIT",			//	通貨単位
				"Expj.PROCESSING_COST_1",	//	外注加工費
				"Expj.MATERIAL_COST_1",		//	外注材料費
				"Expj.OTHER_OVERHEADS_1",	//	外注その他経費
			};
			csvList.add(title);
			for (Iterator i = _csvList.iterator(); i.hasNext();) {
				AA0140020Struct csvStruct = (AA0140020Struct) i.next();
				...
				csvStr[nCnt++] = csvStruct.getPROC_CD();
				csvStr[nCnt++] = csvStruct.getPROC_NAME();
				csvStr[nCnt++] = csvStruct.getEFF_PHASE_IN_DATE();
				csvStr[nCnt++] = sizeFormat(csvStruct.getSBCNT_SIZE());
				csvStr[nCnt++] = csvStruct.getDISPLAY_NAME();
				csvStr[nCnt++] = unitCostFormat(csvStruct.getUNIT_COST());
				csvStr[nCnt++] = csvStruct.getCUR_UNIT();
				csvStr[nCnt++] = unitCostFormat(csvStruct.getPROCESSING_COST());
				csvStr[nCnt++] = unitCostFormat(csvStruct.getMATERIAL_COST());
				csvStr[nCnt++] = unitCostFormat(csvStruct.getOTHER_OVERHEADS());
				csvList.add(csvStr);
			}
			...
			throw new ExpjException(e);
                ...
                //}}user_implement_dev:<controlCsvOut>
		logger.exiting("AA0140020Control"+":USER="+struct.getsUser_ID(),"controlCsvOut");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0140");
		logger.entering("AA0140020Control"+":USER="+struct.getsUser_ID(),"controlClear");
			...
			initializeAll();
                ...
                //}}user_implement_dev:<controlClear>
		logger.exiting("AA0140020Control"+":USER="+struct.getsUser_ID(),"controlClear");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0140");
		logger.entering("AA0140020Control"+":USER="+struct.getsUser_ID(),"controlClose");
			//{{user_implement_dev:<controlClose>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<controlClose>
		logger.exiting("AA0140020Control"+":USER="+struct.getsUser_ID(),"controlClose");

		return;
	}

	/**
	 * 外注単価メンテナンスボタン押下時に実行される処理です。
	 *
	 */
	public void controlButton1() throws BusinessProcessException, FoundationException
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0140");
		logger.entering("AA0140020Control"+":USER="+struct.getsUser_ID(),"controlButton1");
			//{{user_implement_dev:<controlButton1>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<controlButton1>
		logger.exiting("AA0140020Control"+":USER="+struct.getsUser_ID(),"controlButton1");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0140");
		logger.entering("AA0140020Control"+":USER="+struct.getsUser_ID(),"controlINITIAL");
		//{{user_implement_dev:<controlINITIAL>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<controlINITIAL>
		logger.exiting("AA0140020Control"+":USER="+struct.getsUser_ID(),"controlINITIAL");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0140");
		logger.entering("AA0140020Control"+":USER="+struct.getsUser_ID(),"controlRELOAD");
		//{{user_implement_dev:<controlRELOAD>
            ...
            //  徐中華  2006/09/14追加　end
                //}}user_implement_dev:<controlRELOAD>
		logger.exiting("AA0140020Control"+":USER="+struct.getsUser_ID(),"controlRELOAD");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0140");
		logger.entering("AA0140020Control"+":USER="+struct.getsUser_ID(),"controlPREPARATION");
...
//		}
		...
		//{{user_implement_dev:<controlPREPARATION>
			...
			// コンボボックス部品のデータのセットはここに記述してください。
                //}}user_implement_dev:<controlPREPARATION>
		logger.exiting("AA0140020Control"+":USER="+struct.getsUser_ID(),"controlPREPARATION");
...
//			e.printStackTrace();
//			throw new FoundationException("AA0140020Control",e.getMessage(),"control_eventHandllerメソッドでエラーが発生しました。");
	...
	public void createDefaultCSV(List list, String sTitle[]) throws BusinessProcessException, FoundationException {
		...
		//{{user_implement_dev:<createDefaultCSV>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AA0140020-E999","CSVの出力処理"));
			throw new FoundationException("AA0140020Control",e.getMessage(),"createDefaultCSVメソッドでエラーが発生しました。");
		}
...
//				objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AA0140020-E999","システム日付の取得処理"));
				throw new FoundationException("AA0140020Control","beginTransaction()","システム日付取得処理でエラーが発生しました。");
			}
		...
		//{{user_implement_dev:<beginTransaction>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AA0140020-E999","コントロールのイベント処理"));
			throw new FoundationException("AA0140020Control",e.getMessage(),"beginTransactionメソッドでエラーが発生しました。");
		}
	 ...
	 * メンバ変数の定義
	 */
	protected AA0140020Entity entity;
	protected AA0140020Struct struct;
	...
	public void initialize() throws FoundationException
	{
		...
		entity = new AA0140020Entity();
		struct = new AA0140020Struct();
	...
	/**
	 * AA0140020クラスの標準コンストラクタ
	 */
	public AA0140020Control() throws BusinessProcessException, FoundationException
	{
		initialize();
	...
	public void setOrMsgKey(List keyList) throws MessageApiException {
		...
		for (int i = 0; msgKeyTypeArray != null && i < msgKeyTypeArray.size(); i++) {
			...
			for(int j = 0; j < keyList.size(); j++) {
				AA0140020Struct key = (AA0140020Struct)keyList.get(j);
				// メッセージキーを作成する
				...
				if(msgKeyType.containsKeyColumn("SBCNT_SIZE") && key.getSBCNT_SIZE() != null) {
					msgKey.setKeyValue("SBCNT_SIZE", key.getSBCNT_SIZE());
				}
		...
		try {
			for (int i = 0; msgKeyTypeArray != null && i < msgKeyTypeArray.size(); i++) {
				...
				for (int j = 0; msgKeyArray != null && j < msgKeyArray.size(); j++) {
					...
					AA0140020Struct key = new AA0140020Struct();
					...
					if(msgKeyType.containsKeyColumn("SBCNT_SIZE")) {
						key.setSBCNT_SIZE(msgKey.getKeyValue("SBCNT_SIZE"));
					}
