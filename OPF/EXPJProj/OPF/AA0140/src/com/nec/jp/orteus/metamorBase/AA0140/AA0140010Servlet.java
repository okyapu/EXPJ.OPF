/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AA0140/src/com/nec/jp/orteus/metamorBase/AA0140/AA0140010Servlet.java,v $
 *
...
public class AA0140010Servlet extends HttpServlet
{
	 ...
	 * @param control AA0140010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AA0140010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AA0140010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AA0140010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AA0140010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AA0140010Entity entity = control.entity;
		AA0140010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AA0140010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
			// TODO: ユーザ定義のコードを記述してください
//			LogWriter.write( Level.ALL, "AA0140010"+" $Revision: 1.5 $" );
			control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AA0140010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AA0140010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AA0140010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0140");
		logger.entering("AA0140010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
...
//			e.printStackTrace();
//			LogWriter.write(Level.ALL, objMessage.getIDMsg("AA0140010-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
		}
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AA0140010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickSelect(
					...
					HttpSession so,
					Hashtable params,
					AA0140010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AA0140010Entity entity = control.entity;
		AA0140010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0140");
		logger.entering("AA0140010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickSelect>
		logger.exiting("AA0140010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
					...
					AA0140010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0140");
		logger.entering("AA0140010Servlet"+":USER="+request.getRemoteUser(),"onClickCsvOut");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickCsvOut>
		logger.exiting("AA0140010Servlet"+":USER="+request.getRemoteUser(),"onClickCsvOut");
					...
					AA0140010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0140");
		logger.entering("AA0140010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("AA0140010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
					...
					AA0140010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0140");
		logger.entering("AA0140010Servlet"+":USER="+request.getRemoteUser(),"onClickClose");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClose>
		logger.exiting("AA0140010Servlet"+":USER="+request.getRemoteUser(),"onClickClose");
					...
					AA0140010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0140");
		logger.entering("AA0140010Servlet"+":USER="+request.getRemoteUser(),"onClickButton1");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickButton1>
		logger.exiting("AA0140010Servlet"+":USER="+request.getRemoteUser(),"onClickButton1");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AA0140010Struct struct)
	{
	...
	public static String DEFAULT_TARGET = "/AA0140010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAA0140010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAA0140010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0140");
		logger.entering("AA0140010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AA0140010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AA0140010Control control;
		AA0140010Entity  entity = null;
		AA0140010Struct  struct = null;
		...
		try {
			...
			if( (control = (AA0140010Control)so.getAttribute("AA0140010Control_"+request.getSession(false).getId())) == null ) {
				control = new AA0140010Control();
			...
			try {
				...
				so.setAttribute("AA0140010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.AA0140.AA0140010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AA0140010Servlet()
	{
		//{{user_implement_dev:<AA0140010_DisConnect_FLG>
		...
		//{{user_implement_dev:<AA0140010Servlet>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<AA0140010Servlet>
	}
