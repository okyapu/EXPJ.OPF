...
public class KU0030010Servlet extends HttpServlet
{
	 ...
	 * @param control KU0030010Controlクラスインスタンス
	 */
...
//			e.printStackTrace();
					...
					KU0030010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		//{{user_implement_dev:<reloadEvent>
              ...
              //			e.printStackTrace();
              //			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("KU0030010-E999","リロード処理"));
                 ExpjException ee = new ExpjException(e, "ZZ01106");
                 throw ee;
                }
                //}}user_implement_dev:<reloadEvent>
	...
	public static String DEFAULT_TARGET = "/KU0030010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aKU0030010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aKU0030010Struct";   // JSP先のバインド名(Struct)の指定
