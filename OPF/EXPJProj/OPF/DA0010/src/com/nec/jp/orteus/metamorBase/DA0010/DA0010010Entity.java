/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DA0010/src/com/nec/jp/orteus/metamorBase/DA0010/DA0010010Entity.java,v $
 *
...
public class DA0010010Entity extends DataObject
{
	...
	// M_CS_PROC_Lockクラス インスタンス
	public M_CS_PROC_Lock mM_CS_PROC_Lock = new M_CS_PROC_Lock();

	// M_CS_PROCクラス インスタンス
	public M_CS_PROC mM_CS_PROC = new M_CS_PROC();

	// M_CS_PROC_Deleteクラス インスタンス
	public M_CS_PROC_Delete mM_CS_PROC_Delete = new M_CS_PROC_Delete();

	// M_CS_PROC_CancelDeleteクラス インスタンス
	public M_CS_PROC_CancelDelete mM_CS_PROC_CancelDelete = new M_CS_PROC_CancelDelete();
...
+"";		//////////////////////////////
	...
	public class ei_CSVOut extends DataObject
	{
		...
		String m_write_fname="DA0010010.csv";

		protected WriteCsv m_writer=null;		// csv書込み用

		String m_ProjName="DA0010010";
...
+"  M_CS_PROC.OUTSIDE_TYP as OUTSIDE_TYP_DN, "
+"  M_CS_PROC.VEND_CD as VEND_CD, "
+"  M_VEND_CTRL.VEND_ANAME as VEND_ANAME, "
+"  to_char(M_CS_PROC.MODIFY_COUNT) as MODIFY_COUNT "
+"from "
+"  M_CS_PROC, "
+"  M_VEND_CTRL, "
+"  M_WS, "
+"  SYS_MY_COMPANY "
+"where "
+"  SYS_MY_COMPANY.COMPANY_CD(+) = M_VEND_CTRL.COMPANY_CD "
+"  and M_VEND_CTRL.VEND_CD(+) = M_CS_PROC.VEND_CD "
+"  and M_WS.WS_CD(+) = M_CS_PROC.WS_CD "
+"  and SYS_MY_COMPANY.CTRL_CD(+) = 'SYSTEM' "
+"  and M_CS_PROC.PLANT_CD = ? "
+"  and M_CS_PROC.CS_PROC_CD like ? "
+"  and M_CS_PROC.WS_CD like ? "
+"  and M_CS_PROC.DEL_FLG = to_number(?) "
+"order by "
+"  M_CS_PROC.CS_PROC_CD";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, DA0010010Struct data) throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, DA0010010Struct data, String replaceStr)
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, DA0010010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, DA0010010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, DA0010010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, DA0010010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(PreparedStatement stmt, DA0010010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public PreparedStatement prepare(Connection conn, String query, DA0010010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt;
			...
			try {
				...
				ary.addElement(data.getw_CS_PROC_CD());
				if(isNull(data.getw_CS_PROC_CD())) isNull = true;
				ary.addElement(data.getw_WS_CD());
				if(isNull(data.getw_WS_CD())) isNull = true;
				ary.addElement(data.getDEL_FLG());
				if(isNull(data.getDEL_FLG())) isNull = true;
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public ResultSet executeQuery(PreparedStatement stmt, DA0010010Struct data) throws FoundationException, SQLException
		{
			int no=1;
			...
			//動的SQL生成ロジック
			if(!isNull(data.getw_CS_PROC_CD())) setString(no ++, data.getw_CS_PROC_CD(), stmt);
			//動的SQL生成ロジック
			if(!isNull(data.getw_WS_CD())) setString(no ++, data.getw_WS_CD(), stmt);
			//動的SQL生成ロジック
			if(!isNull(data.getDEL_FLG())) setString(no ++, data.getDEL_FLG(), stmt);
		 ...
		 * レコードデータをStructに格納して返します
		 */
		public DA0010010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			if(rs.next()==false) return null;

			DA0010010Struct data = new DA0010010Struct();

			data.setl_CS_PROC_CD( getString(1, rs) );
			data.setl_CS_PROC_NAME( getString(2, rs) );
			data.setl_WS_CD( getString(3, rs) );
			data.setl_WS_NAME( getString(4, rs) );
			data.setl_OUTSIDE_TYP_DN( getString(5, rs) );
			data.setl_VEND_CD( getString(6, rs) );
			data.setl_VEND_ANAME( getString(7, rs) );
			data.setl_MODIFY_COUNT( getString(8, rs) );
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(IDbConnection conn, DA0010010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(Connection conn, DA0010010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(IDbConnection conn, DA0010010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(Connection conn, DA0010010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(PreparedStatement stmt, DA0010010Struct data) throws FoundationException, SQLException
		{
			ResultSet rs=executeQuery(stmt, data);
			boolean ret=true;
...
+"  M_CS_PROC.WS_CD as WS_CD, "
+"  M_WS.WS_NAME as WS_NAME, "
+"  to_char(M_CS_PROC.OUTSIDE_TYP) as OUTSIDE_TYP, "
+"  M_CS_PROC.VEND_CD as VEND_CD, "
+"  M_VEND_CTRL.VEND_NAME as VEND_NAME, "
+"  M_CS_PROC.COMPANY_CD as COMPANY_CD, "
+"  M_CS_PROC.ORG_CD as ORG_CD, "
+"  M_ORG.ORG_NAME as ORG_NAME, "
+"  to_char(M_CS_PROC.STD_COST_OF_MONTH) as STD_COST_OF_MONTH, "
+"  to_char(M_CS_PROC.STD_COST_UNIT_TYP) as STD_COST_UNIT_TYP, "
+"  to_char(M_CS_PROC.MODIFY_COUNT) as MODIFY_COUNT "
+"from "
+"  M_CS_PROC, "
+"  M_WS, "
...
+"  M_ORG "
+"where "
+"  M_WS.WS_CD(+) = M_CS_PROC.WS_CD "
+"  and M_VEND_CTRL.COMPANY_CD(+) = M_CS_PROC.COMPANY_CD "
+"  and M_VEND_CTRL.VEND_CD(+) = M_CS_PROC.VEND_CD "
...
+"  and M_CS_PROC.CS_PROC_CD = ?";
		...
		public PreparedStatement prepare(Connection conn, String query, DA0010010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				ary.addElement(data.getPLANT_CD());
				if(isNull(data.getPLANT_CD())) isNull = true;
				ary.addElement(data.getl_CS_PROC_CD());
				if(isNull(data.getl_CS_PROC_CD())) isNull = true;
		...
		public ResultSet executeQuery(PreparedStatement stmt, DA0010010Struct data) throws FoundationException, SQLException
		{
			...
			// 静的SQL文の生成
			setString(no ++, data.getl_CS_PROC_CD(), stmt);
		...
		public DA0010010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setCS_PROC_CD( getString(1, rs) );
			data.setCS_PROC_NAME( getString(2, rs) );
			...
			data.setVEND_NAME( getString(7, rs) );
			data.setCOMPANY_CD( getString(8, rs) );
			data.setORG_CD( getString(9, rs) );
			data.setORG_NAME( getString(10, rs) );
			data.setSTD_COST_OF_MONTH( getString(11, rs) );
			data.setSTD_COST_UNIT_TYP( getString(12, rs) );
	 ...
	 * Entity定義 静的SQL
	 */
	public class M_CS_PROC_Lock extends DataObject
	{
		protected String m_selcmd = "select "
+"  to_char(M_CS_PROC.\"MODIFY_COUNT\") as \"MODIFY_COUNT\" "
+"from "
...
+"for update nowait";
		...
		//{{user_implement_dev:M_CS_PROC_Lock_def
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:M_CS_PROC_Lock_def
		...
		public List read(Connection conn, DA0010010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:M_CS_PROC_Lock_read
                        if(m_selcmd==null) throw new FoundationException("M_CS_PROC_Lock", "read", "クエリー未登録");
		...
		public List read(Connection conn, DA0010010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:M_CS_PROC_Lock_read2
			if(m_selcmd==null) throw new FoundationException("M_CS_PROC_Lock", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, DA0010010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:M_CS_PROC_Lock_read3
			if(m_selcmd==null) throw new FoundationException("M_CS_PROC_Lock", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean hasRecord(Connection conn, DA0010010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("M_CS_PROC_Lock", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, DA0010010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:M_CS_PROC_Lock_check
                        PreparedStatement stmt;
                        ...
                        if(m_chkcmd!=null) {
                         ...
                         throw new FoundationException("M_CS_PROC_Lock", "check", "クエリー未登録");
                        }
		...
		public void clear()
		{
			//{{user_implement_dev:M_CS_PROC_Lock_clear
                         // todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:M_CS_PROC_Lock_clear
		...
		/**
		 * M_CS_PROC_Lockクラスの標準コンストラクタ
		 */
		public M_CS_PROC_Lock()
		{
			//{{user_implement_dev:M_CS_PROC_Lock_constractor
                         // TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:M_CS_PROC_Lock_constractor
...
+"  M_CS_PROC(\"PLANT_CD\", \"CS_PROC_CD\", \"RCY_TYP_CD\", \"CS_PROC_NAME\", \"WS_CD\", \"OUTSIDE_TYP\", \"VEND_CD\", \"COMPANY_CD\", \"ORG_CD\", \"STD_COST_OF_MONTH\", \"STD_COST_UNIT_TYP\", \"UPDATE_TYP\", \"DEL_FLG\") "
+"values "
+"  (?, ?, '*', ?, ?, to_number(?), ?, ?, ?, to_number(?), to_number(?), 2, 0)";
...
+"  and M_CS_PROC.\"CS_PROC_CD\" = ?";
		...
		protected String m_sCreateProgramName="DA0010010";
		protected String m_sUpdateProgramName="DA0010010";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int create(IDbConnection conn, DA0010010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int create(Connection conn, DA0010010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt=null;
			...
			try {
				...
				setString(9, data.getCS_PROC_NAME(), stmt);
				setString(10, data.getWS_CD(), stmt);
				setString(11, data.getOUTSIDE_TYP(), stmt);
				setString(12, data.getVEND_CD(), stmt);
				setString(13, data.getCOMPANY_CD(), stmt);
				setString(14, data.getORG_CD(), stmt);
				setString(15, data.getSTD_COST_OF_MONTH(), stmt);
				setString(16, data.getSTD_COST_UNIT_TYP(), stmt);
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int update(IDbConnection conn, DA0010010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int update(Connection conn, DA0010010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt=null;
			int modifyCount;
			...
			try {
				...
				setString(4, data.getCS_PROC_NAME(), stmt);
				setString(5, data.getWS_CD(), stmt);
				setString(6, data.getOUTSIDE_TYP(), stmt);
				setString(7, data.getVEND_CD(), stmt);
				setString(8, data.getCOMPANY_CD(), stmt);
				setString(9, data.getORG_CD(), stmt);
				setString(10, data.getSTD_COST_OF_MONTH(), stmt);
				setString(11, data.getSTD_COST_UNIT_TYP(), stmt);
				setString(12, data.getPLANT_CD(), stmt);
				setString(13, data.getCS_PROC_CD(), stmt);
	 ...
	 * Entity定義 静的SQL
	 */
	public class M_CS_PROC_Delete extends DataObject
	{
...
+"  and M_CS_PROC.\"CS_PROC_CD\" = ?";
		...
		//{{user_implement_dev:M_CS_PROC_Delete_def
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:M_CS_PROC_Delete_def
		...
		public int update(Connection conn, DA0010010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				...
				setString(5, data.getCS_PROC_CD(), stmt);
		...
		public void clear()
		{
			//{{user_implement_dev:M_CS_PROC_Delete_clear
                         // todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:M_CS_PROC_Delete_clear
		 ...
		 */
		public M_CS_PROC_Delete()
		{
			//{{user_implement_dev:M_CS_PROC_Delete_constractor
                         // TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:M_CS_PROC_Delete_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class M_CS_PROC_CancelDelete extends DataObject
	{
		protected String m_selcmd = null;
		protected String m_chkcmd = null;
		protected String m_inscmd = null;
...
+"  and M_CS_PROC.\"CS_PROC_CD\" = ?";
		...
		//{{user_implement_dev:M_CS_PROC_CancelDelete_def
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:M_CS_PROC_CancelDelete_def
		...
		public void clear()
		{
			//{{user_implement_dev:M_CS_PROC_CancelDelete_clear
                         // todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:M_CS_PROC_CancelDelete_clear
		...
		/**
		 * M_CS_PROC_CancelDeleteクラスの標準コンストラクタ
		 */
		public M_CS_PROC_CancelDelete()
		{
			//{{user_implement_dev:M_CS_PROC_CancelDelete_constractor
                         // TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:M_CS_PROC_CancelDelete_constractor
...
+"";
	...
	public void clear()
	{
		...
		mFormSub1.clear();
		mFormSub1 = null;
		mM_CS_PROC_Lock.clear();
		mM_CS_PROC_Lock = null;
		mM_CS_PROC.clear();
		mM_CS_PROC = null;
		mM_CS_PROC_Delete.clear();
		mM_CS_PROC_Delete = null;
		mM_CS_PROC_CancelDelete.clear();
		mM_CS_PROC_CancelDelete = null;
		mM_PLANT.clear();
		mM_PLANT = null;
		mM_WS.clear();
		mM_WS = null;
	 ...
	 */
	public DA0010010Entity() throws FoundationException
	{
