/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KA0030/src/com/nec/jp/orteus/metamorBase/KA0030/KA0030010Servlet.java,v $
 *
...
public class KA0030010Servlet extends HttpServlet
{
	 ...
	 * @param control KA0030010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, KA0030010Control control)
	{
		if (params == null) {
...
// 顧客品目番号
String[] custItemCd = null;
if(params.containsKey("CUST_ITEM_CD")) {
 custItemCd = (String[])params.get("CUST_ITEM_CD");
}
else {
 custItemCd = (String[])null;
}
if(custItemCd == null) {
 control.setCustItemCd((String)null);
}
else {
 control.setCustItemCd(custItemCd[0]);
}
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control KA0030010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, KA0030010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					KA0030010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		KA0030010Entity entity = control.entity;
		KA0030010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("KA0030010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
                 // TODO: ユーザ定義のコードを記述してください
              //			objMessage.m_writer.write( Level.ALL, "KA0030010"+" $Revision: 1.5 $" );
                 control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("KA0030010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					KA0030010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		KA0030010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KA0030");
		logger.entering("KA0030010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
		...
		//{{user_implement_dev:<reloadEvent>
              ...
              //			e.printStackTrace();
              //			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("KA0030010-E999","リロード処理"));
                 ExpjException ee = new ExpjException(e, "ZZ01106");
                 throw ee;
                }
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("KA0030010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickselect(
					...
					HttpSession so,
					Hashtable params,
					KA0030010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		KA0030010Entity entity = control.entity;
		KA0030010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KA0030");
		logger.entering("KA0030010Servlet"+":USER="+request.getRemoteUser(),"onClickselect");
		//{{user_implement_dev:<onClickselect>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickselect>
		logger.exiting("KA0030010Servlet"+":USER="+request.getRemoteUser(),"onClickselect");
					...
					KA0030010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KA0030");
		logger.entering("KA0030010Servlet"+":USER="+request.getRemoteUser(),"onClickinsert");
		//{{user_implement_dev:<onClickinsert>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickinsert>
		logger.exiting("KA0030010Servlet"+":USER="+request.getRemoteUser(),"onClickinsert");
					...
					KA0030010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KA0030");
		logger.entering("KA0030010Servlet"+":USER="+request.getRemoteUser(),"onClickupdate");
		//{{user_implement_dev:<onClickupdate>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickupdate>
		logger.exiting("KA0030010Servlet"+":USER="+request.getRemoteUser(),"onClickupdate");
					...
					KA0030010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KA0030");
		logger.entering("KA0030010Servlet"+":USER="+request.getRemoteUser(),"onClickclear");
		//{{user_implement_dev:<onClickclear>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickclear>
		logger.exiting("KA0030010Servlet"+":USER="+request.getRemoteUser(),"onClickclear");
					...
					KA0030010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KA0030");
		logger.entering("KA0030010Servlet"+":USER="+request.getRemoteUser(),"onClickdelete");
		//{{user_implement_dev:<onClickdelete>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickdelete>
		logger.exiting("KA0030010Servlet"+":USER="+request.getRemoteUser(),"onClickdelete");
					...
					KA0030010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KA0030");
		logger.entering("KA0030010Servlet"+":USER="+request.getRemoteUser(),"onClickclose");
		//{{user_implement_dev:<onClickclose>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickclose>
		logger.exiting("KA0030010Servlet"+":USER="+request.getRemoteUser(),"onClickclose");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, KA0030010Struct struct)
	{
		...
		String[] NOTE1 = ((params.containsKey("NOTE1")) ? (String[])params.get("NOTE1") : (String[])null);
		String[] NOTE2 = ((params.containsKey("NOTE2")) ? (String[])params.get("NOTE2") : (String[])null);
		...
		String[] h_DEPO_TYP = ((params.containsKey("h_DEPO_TYP")) ? (String[])params.get("h_DEPO_TYP") : (String[])null);
		...
		struct.setNOTE1( ((NOTE1 == null) ? (String)null : NOTE1[0]) );
		struct.setList_NOTE1(TypeConverter.convert(NOTE1));
		struct.setNOTE2( ((NOTE2 == null) ? (String)null : NOTE2[0]) );
		struct.setList_NOTE2(TypeConverter.convert(NOTE2));
		...
		if( (h_DEPO_TYP == null)||("".equals(h_DEPO_TYP[0])) ) {
		   struct.seth_DEPO_TYP( (Double)null );
		} else {
		   struct.seth_DEPO_TYP( new Double(h_DEPO_TYP[0]) );
		   struct.setList_h_DEPO_TYP(TypeConverter.convert(h_DEPO_TYP));
		}
	...
	public static String DEFAULT_TARGET = "/KA0030010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aKA0030010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aKA0030010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KA0030");
		logger.entering("KA0030010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("KA0030010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		KA0030010Control control;
		KA0030010Entity  entity = null;
		KA0030010Struct  struct = null;
		...
		try {
			...
			if( (control = (KA0030010Control)so.getAttribute("KA0030010Control_"+request.getSession(false).getId())) == null ) {
				control = new KA0030010Control();
			...
			try {
				...
				so.setAttribute("KA0030010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.KA0030.KA0030010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public KA0030010Servlet()
	{
		//{{user_implement_dev:<KA0030010_DisConnect_FLG>
		...
		//{{user_implement_dev:<KA0030010Servlet>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<KA0030010Servlet>
	}
