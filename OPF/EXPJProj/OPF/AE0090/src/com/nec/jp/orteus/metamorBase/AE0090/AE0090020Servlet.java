...
public class AE0090020Servlet extends HttpServlet
{
	 ...
	 * @param control AE0090020Controlクラスインスタンス
	 */
...
//			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AE0090020-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
		}
                //}}user_implement_dev:<reloadEvent>
...
//			e.printStackTrace();
	...
	public static String DEFAULT_TARGET = "/AE0090020.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAE0090020Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAE0090020Struct";   // JSP先のバインド名(Struct)の指定
