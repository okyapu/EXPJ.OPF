/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0090/src/com/nec/jp/orteus/metamorBase/AE0090/AE0090020Entity.java,v $
 *
...
public class AE0090020Entity extends DataObject
{
...
+"";		//////////////////////////////
	...
	public class ei_CSVOut extends DataObject
	{
		...
		String m_write_fname="AE0090020.csv";

		protected WriteCsv m_writer=null;		// csv書込み用

		String m_ProjName="AE0090020";
...
+"  PUCH_ODR_PERSON, "
+"  USER_NAME, "
+"  FNCGETFORMATTEDDATETIME(PUCH_ODR_START_DATE) AS \"PUCH_ODR_START_DATE\", "
+"  FNCGETFORMATTEDDATETIME(PUCH_ODR_DLV_DATE) AS \"PUCH_ODR_DLV_DATE\", "
+"  TO_CHAR(PUCH_ODR_QTY, 'fm99999999999990.0999') AS \"PUCH_ODR_QTY\", "
+"  STOCK_UNIT, "
+"  UNIT_COST_TYP, "
+"  TO_CHAR(UNIT_COST, 'fm99999999999990.0099') AS \"UNIT_COST\", "
+"  TO_CHAR(PUCH_ODR_AMOUNT, 'fm99999999999990.0099') AS \"PUCH_ODR_AMOUNT\", "
+"  VEND_CUR_UNIT, "
+"  TO_CHAR(DISC_AMOUNT, 'fm99999999999990.0099') AS \"DISC_AMOUNT\", "
+"  TO_CHAR(NET_AMOUNT, 'fm99999999999990.0099') AS \"NET_AMOUNT\", "
+"  TO_CHAR(TAX_AMOUNT_1, 'fm99999999999990.0099') AS \"TAX_AMOUNT_1\", "
+"  TO_CHAR(TAX_AMOUNT_2, 'fm99999999999990.0099') AS \"TAX_AMOUNT_2\", "
+"  TO_CHAR(TAX_AMOUNT_3, 'fm99999999999990.0099') AS \"TAX_AMOUNT_3\", "
+"  TO_CHAR(AMOUNT_INCLUDE_TAX, 'fm99999999999990.0099') AS \"AMOUNT_INCLUDE_TAX\", "
+"  FNCGETFORMATTEDDATETIME(RATE_JUDGE_DATE) AS \"RATE_JUDGE_DATE\", "
+"  TO_CHAR(EXCH_RATE, 'fm99999999999990.009999') AS \"EXCH_RATE\", "
+"  TO_CHAR(HOME_CUR_AMOUNT, 'fm99999999999990.0099') AS \"HOME_CUR_AMOUNT\", "
+"  HOME_CUR_UNIT, "
+"  FNCGETFORMATTEDDATETIME(PUCH_ODR_INST_DATE) AS \"PUCH_ODR_INST_DATE\", "
+"  PUCH_ODR_INST_SLIP_ISS_FLG, "
+"  FNCGETFORMATTEDDATETIME(PUCH_ODR_SLIP_ISS_DATE) AS \"PUCH_ODR_SLIP_ISS_DATE\", "
+"  PUCH_ODR_STS_TYP, "
+"  INSPC_CMPLT_FLG, "
+"  FNCGETFORMATTEDDATETIME(INSPC_CMPLT_DATE) AS \"INSPC_CMPLT_DATE\", "
+"  FNCGETFORMATTEDDATETIME(CONFIRM_DLV_DATE) AS \"CONFIRM_DLV_DATE\", "
+"  SPL_ITEM_TYP, "
+"  ACPT_INSPC_TYP, "
+"  INV_CTRL_FLG, "
+"  WORK_ODR_CD, "
...
+"  SPEC, "
+"  MRP_ODR_TYP, "
+"  TO_CHAR(NVL(ACPT_QTY, 0), 'fm99999999999990.0999') AS \"ACPT_QTY\", "
+"  FNCGETFORMATTEDDATETIME(ACPT_CMPLT_DATE) AS \"ACPT_CMPLT_DATE\", "
+"  TO_CHAR(NVL(INSPECTED_QTY, 0), 'fm99999999999990.0999') AS \"INSPECTED_QTY\", "
+"  TO_CHAR(NVL(ACCEPTED_QTY, 0), 'fm99999999999990.0999') AS \"ACCEPTED_QTY\", "
+"  FNCGETFORMATTEDDATETIME(PUCH_ODR_EDI_ISS_DATE) AS \"PUCH_ODR_EDI_ISS_DATE\", "
+"  FNCGETFORMATTEDDATETIME(ODR_CANCEL_SLIP_ISS_DATE) AS \"ODR_CANCEL_SLIP_ISS_DATE\", "
+"  CONFIRM_DLV_DATE_COMMENT, "
+"  ODR_CANCEL_SLIP_ISS_FLG, "
+"  FNCGETFORMATTEDDATETIME(ODR_CANCEL_EDI_ISS_DATE) AS \"ODR_CANCEL_EDI_ISS_DATE\", "
+"  V_WORK_RLSD_PUCH_ODR_LST_2.ODR_CANCEL_CAUSE_CD, "
+"  V_WORK_RLSD_PUCH_ODR_LST_2.\"STATUS\" AS \"STATUS\" "
+"FROM "
+"  V_WORK_RLSD_PUCH_ODR_LST_2 "
+"WHERE "
+"  PLANT_CD = ? "
+"  AND PUCH_ODR_START_DATE <= TO_DATE(?, 'YYYY/MM/DD HH24:MI') "
+"  AND PUCH_ODR_DLV_DATE <= TO_DATE(?, 'YYYY/MM/DD HH24:MI') "
+"  AND VEND_CD = ? "
+"  AND ITEM_CD = ? "
+"  AND PUCH_ODR_CD = ? "
+"  AND(STATUS = ? "
...
+"  AND WH_CD = ? "
+"  AND JOB_ODR_CD = ? "
+"  AND V_WORK_RLSD_PUCH_ODR_LST_2.\"PUCH_ODR_PERSON\" = ? "
+"ORDER BY "
+"  PUCH_ODR_START_DATE, "
+"  PUCH_ODR_DLV_DATE, "
+"  VEND_CD, "
+"  ITEM_CD";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AE0090020Struct data) throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AE0090020Struct data, String replaceStr)
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AE0090020Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AE0090020Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AE0090020Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AE0090020Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(PreparedStatement stmt, AE0090020Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public PreparedStatement prepare(Connection conn, String query, AE0090020Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt;
			...
			try {
				...
				ary.addElement(data.getSTATUS7());
				if(isNull(data.getSTATUS7())) isNull = true;
				ary.addElement(data.getSTATUS8());
				if(isNull(data.getSTATUS8())) isNull = true;
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public ResultSet executeQuery(PreparedStatement stmt, AE0090020Struct data) throws FoundationException, SQLException
		{
			int no=1;
			...
			//動的SQL生成ロジック
			if(!isNull(data.getSTATUS7())) setString(no ++, data.getSTATUS7(), stmt);
			//動的SQL生成ロジック
			if(!isNull(data.getSTATUS8())) setString(no ++, data.getSTATUS8(), stmt);
			//動的SQL生成ロジック
		 ...
		 * レコードデータをStructに格納して返します
		 */
		public AE0090020Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			if(rs.next()==false) return null;

			AE0090020Struct data = new AE0090020Struct();

			data.setl_PUCH_ODR_CD( getString(1, rs) );
			data.setl_PLANT_CD( getString(2, rs) );
			data.setPLANT_NAME( getString(3, rs) );
			data.setl_WH_CD( getString(4, rs) );
			data.setl_WH_NAME( getString(5, rs) );
			data.setl_ITEM_CD( getString(6, rs) );
			data.setl_ITEM_NAME( getString(7, rs) );
			data.setl_COMPANY_CD( getString(8, rs) );
			data.setl_VEND_CD( getString(9, rs) );
			data.setl_VEND_ANAME( getString(10, rs) );
			data.setVEND_NAME( getString(11, rs) );
			data.setl_PUCH_ODR_PERSON( getString(12, rs) );
			data.setl_USER_NAME( getString(13, rs) );
			data.setl_PUCH_ODR_START_DATE( getString(14, rs) );
			data.setl_PUCH_ODR_DLV_DATE( getString(15, rs) );
			data.setl_PUCH_ODR_QTY( getString(16, rs) );
			data.setl_STOCK_UNIT( getString(17, rs) );
			data.setl_UNIT_COST_TYP( getString(18, rs) );
			data.setl_UNIT_COST( getString(19, rs) );
			data.setl_PUCH_ODR_AMOUNT( getString(20, rs) );
			data.setl_VEND_CUR_UNIT( getString(21, rs) );
			data.setl_DISC_AMOUNT( getString(22, rs) );
			data.setl_NET_AMOUNT( getString(23, rs) );
			data.setl_TAX_AMOUNT_1( getString(24, rs) );
			data.setl_TAX_AMOUNT_2( getString(25, rs) );
			data.setl_TAX_AMOUNT_3( getString(26, rs) );
			data.setl_AMOUNT_INCLUDE_TAX( getString(27, rs) );
			data.setl_RATE_JUDGE_DATE( getString(28, rs) );
			data.setl_EXCH_RATE( getString(29, rs) );
			data.setl_HOME_CUR_AMOUNT( getString(30, rs) );
			data.setl_HOME_CUR_UNIT( getString(31, rs) );
			data.setl_PUCH_ODR_INST_DATE( getString(32, rs) );
			data.setl_PUCH_ODR_INST_SLIP_ISS_FLG( getString(33, rs) );
			data.setl_PUCH_ODR_SLIP_ISS_DATE( getString(34, rs) );
			data.setl_PUCH_ODR_STS_TYP( getString(35, rs) );
			data.setl_INSPC_CMPLT_FLG( getString(36, rs) );
			data.setl_INSPC_CMPLT_DATE( getString(37, rs) );
			data.setl_CONFIRM_DLV_DATE( getString(38, rs) );
			data.setl_SPL_ITEM_TYP( getString(39, rs) );
			data.setl_ACPT_INSPC_TYP( getString(40, rs) );
			data.setl_INV_CTRL_FLG( getString(41, rs) );
			data.setl_WORK_ODR_CD( getString(42, rs) );
			data.setl_OD_NO( getString(43, rs) );
			data.setl_JOB_ODR_CD( getString(44, rs) );
			data.setl_PUCH_ODR_COMMENT( getString(45, rs) );
			data.setl_ODR_CD( getString(46, rs) );
			data.setl_DETAIL_NO( getString(47, rs) );
			data.setl_NON_NO_ITEM_FLG( getString(48, rs) );
			data.setl_DRAW_CD( getString(49, rs) );
			data.setl_SPEC( getString(50, rs) );
			data.setl_MRP_ODR_TYP( getString(51, rs) );
			data.setl_ACPT_QTY( getString(52, rs) );
			data.setl_ACPT_CMPLT_DATE( getString(53, rs) );
			data.setl_INSPECTED_QTY( getString(54, rs) );
			data.setl_ACCEPTED_QTY( getString(55, rs) );
			data.setl_PUCH_ODR_EDI_ISS_DATE( getString(56, rs) );
			data.setl_ODR_CANCEL_SLIP_ISS_DATE( getString(57, rs) );
			data.setl_CONFIRM_DLV_DATE_COMMENT( getString(58, rs) );
			data.setl_ODR_CANCEL_SLIP_ISS_FLG( getString(59, rs) );
			data.setl_ODR_CANCEL_EDI_ISS_DATE( getString(60, rs) );
			data.setl_ODR_CANCEL_CAUSE_CD( getString(61, rs) );
			data.setl_STATUS( getString(62, rs) );
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(IDbConnection conn, AE0090020Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(Connection conn, AE0090020Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(IDbConnection conn, AE0090020Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(Connection conn, AE0090020Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(PreparedStatement stmt, AE0090020Struct data) throws FoundationException, SQLException
		{
			ResultSet rs=executeQuery(stmt, data);
			boolean ret=true;
...
+"  T_RLSD_PUCH_ODR.\"PUCH_ODR_CD\" = ?";
		...
		public AE0090020Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setOUT_PUCH_ODR_CD( getString(1, rs) );
...
+"  USER_MST.\"USER_CD\" = ?";
		...
		public AE0090020Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setPUCH_ODR_PERSON( getString(1, rs) );
...
+"  AND ROWNUM <= TO_NUMBER(?) + 1";
	 ...
	 */
	public AE0090020Entity() throws FoundationException
	{
