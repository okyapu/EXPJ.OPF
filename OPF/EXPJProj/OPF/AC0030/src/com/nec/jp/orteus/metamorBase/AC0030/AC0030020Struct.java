/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AC0030/src/com/nec/jp/orteus/metamorBase/AC0030/AC0030020Struct.java,v $
 *
...
public class AC0030020Struct extends DataStruct
{
	...
	public int setL2L_txtEntryDate(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_txtEntryDate.add(((AC0030020Struct) list.get(i)).gettxtEntryDate());
		}
		return size;
	}
	public int setL2L_rdoOutsideTyp1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_rdoOutsideTyp1.add(((AC0030020Struct) list.get(i)).getrdoOutsideTyp1());
		}
		return size;
	}
	public int setL2L_rdoOutsideTyp2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_rdoOutsideTyp2.add(((AC0030020Struct) list.get(i)).getrdoOutsideTyp2());
		}
		return size;
	}
	public int setL2L_rdoOutsideTyp3(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_rdoOutsideTyp3.add(((AC0030020Struct) list.get(i)).getrdoOutsideTyp3());
		}
		return size;
	}
	public int setL2L_rdoEntry1Typ1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_rdoEntry1Typ1.add(((AC0030020Struct) list.get(i)).getrdoEntry1Typ1());
		}
		return size;
	}
	public int setL2L_rdoEntry1Typ2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_rdoEntry1Typ2.add(((AC0030020Struct) list.get(i)).getrdoEntry1Typ2());
		}
		return size;
	}
	public int setL2L_rdoEntry1Typ3(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_rdoEntry1Typ3.add(((AC0030020Struct) list.get(i)).getrdoEntry1Typ3());
		}
		return size;
	}
	public int setL2L_txtJobOdrCd(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_txtJobOdrCd.add(((AC0030020Struct) list.get(i)).gettxtJobOdrCd());
		}
		return size;
	}
	public int setL2L_rdoOutsideTyp(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_rdoOutsideTyp.add(((AC0030020Struct) list.get(i)).getrdoOutsideTyp());
		}
		return size;
	}
	public int setL2L_rdoEntry1Typ(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_rdoEntry1Typ.add(((AC0030020Struct) list.get(i)).getrdoEntry1Typ());
		}
		return size;
	}
	public int setL2L_txtEntryTime(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_txtEntryTime.add(((AC0030020Struct) list.get(i)).gettxtEntryTime());
		}
		return size;
	}
	public int setL2L_TIME_CTRL(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TIME_CTRL.add(((AC0030020Struct) list.get(i)).getTIME_CTRL());
		}
		return size;
	}
	public int setL2L_hdnBusinessOprDate(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_hdnBusinessOprDate.add(((AC0030020Struct) list.get(i)).gethdnBusinessOprDate());
		}
		return size;
	}
	public int setL2L_plantCd(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_plantCd.add(((AC0030020Struct) list.get(i)).getplantCd());
		}
		return size;
	}
	...
	/**
	 * medAC0030020クラスの標準コンストラクタ
	 */
	public AC0030020Struct()
	{
	 ...
	 */
	public void setStruct(AC0030020Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructM(AC0030020Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructL(AC0030020Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
