...
+"  T_WORK_IN_PROC_BY_ITEM.\"WORK_ODR_DLV_DATE\"";
		...
		public List read(Connection conn, AD0050010Struct data) throws FoundationException, SQLException
		{
			...
			if(m_selcmd==null) throw new FoundationException("SelectChkProcByItem", "read", "クエリー未登録");
		...
		public boolean hasRecord(Connection conn, AD0050010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("SelectChkProcByItem", "hasRecord", "クエリー未登録");
		...
		/**
		 * SelectChkProcByItemクラスの標準コンストラクタ
		 */
...
+"for update nowait";
		...
		public List read(Connection conn, AD0050010Struct data) throws FoundationException, SQLException
		{
			...
			if(m_selcmd==null) throw new FoundationException("SelectTargetProcByItem", "read", "クエリー未登録");
		...
		public boolean hasRecord(Connection conn, AD0050010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("SelectTargetProcByItem", "hasRecord", "クエリー未登録");
		...
		/**
		 * SelectTargetProcByItemクラスの標準コンストラクタ
		 */
...
+"  T_OPR_RSLT.\"OPR_INST_CD\" = ?";
		...
		public List read(Connection conn, AD0050010Struct data) throws FoundationException, SQLException
		{
			...
			if(m_selcmd==null) throw new FoundationException("SelectSumOprRsltQty", "read", "クエリー未登録");
		...
		public boolean hasRecord(Connection conn, AD0050010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("SelectSumOprRsltQty", "hasRecord", "クエリー未登録");
		...
		/**
		 * SelectSumOprRsltQtyクラスの標準コンストラクタ
		 */
...
+"for update nowait";
		...
		public List read(Connection conn, AD0050010Struct data) throws FoundationException, SQLException
		{
			...
			if(m_selcmd==null) throw new FoundationException("SelectCompleteProcByItem", "read", "クエリー未登録");
		...
		public boolean hasRecord(Connection conn, AD0050010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("SelectCompleteProcByItem", "hasRecord", "クエリー未登録");
		...
		/**
		 * SelectCompleteProcByItemクラスの標準コンストラクタ
		 */
...
+"  3";
		...
		public List read(Connection conn, AD0050010Struct data) throws FoundationException, SQLException
		{
			...
			if(m_selcmd==null) throw new FoundationException("SelectModifyTargetProcByItem", "read", "クエリー未登録");
		...
		public boolean hasRecord(Connection conn, AD0050010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("SelectModifyTargetProcByItem", "hasRecord", "クエリー未登録");
		...
		/**
		 * SelectModifyTargetProcByItemクラスの標準コンストラクタ
		 */
...
+"  T_OPR_RSLT.\"OPR_INST_CD\" = ?";
		...
		public List read(Connection conn, AD0050010Struct data) throws FoundationException, SQLException
		{
			...
			if(m_selcmd==null) throw new FoundationException("SelectSumOprRsltQtyExceptCancel", "read", "クエリー未登録");
		...
		public boolean hasRecord(Connection conn, AD0050010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("SelectSumOprRsltQtyExceptCancel", "hasRecord", "クエリー未登録");
		...
		/**
		 * SelectSumOprRsltQtyExceptCancelクラスの標準コンストラクタ
		 */
...
+"  T_OPR_RSLT.\"PARTIAL_PRD_NO\"";
		...
		public List read(Connection conn, AD0050010Struct data) throws FoundationException, SQLException
		{
			...
			if(m_selcmd==null) throw new FoundationException("SelectModifyZeroOprRslt", "read", "クエリー未登録");
		...
		public boolean hasRecord(Connection conn, AD0050010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("SelectModifyZeroOprRslt", "hasRecord", "クエリー未登録");
		...
		/**
		 * SelectModifyZeroOprRsltクラスの標準コンストラクタ
		 */
...
+"for update nowait";
		...
		public List read(Connection conn, AD0050010Struct data) throws FoundationException, SQLException
		{
			...
			if(m_selcmd==null) throw new FoundationException("SelectModifyZeroProcByItem", "read", "クエリー未登録");
		...
		public boolean hasRecord(Connection conn, AD0050010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("SelectModifyZeroProcByItem", "hasRecord", "クエリー未登録");
		...
		/**
		 * SelectModifyZeroProcByItemクラスの標準コンストラクタ
		 */
...
+"for update nowait";
		...
		public List read(Connection conn, AD0050010Struct data) throws FoundationException, SQLException
		{
			...
			if(m_selcmd==null) throw new FoundationException("SelectChkOutputRslt", "read", "クエリー未登録");
		...
		public boolean hasRecord(Connection conn, AD0050010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("SelectChkOutputRslt", "hasRecord", "クエリー未登録");
		...
		/**
		 * SelectChkOutputRsltクラスの標準コンストラクタ
		 */
...
+"  AND T_ISSUE_INST.\"ISSUE_TYP\" IN ('1', '2')";
		...
		public List read(Connection conn, AD0050010Struct data) throws FoundationException, SQLException
		{
			...
			if(m_selcmd==null) throw new FoundationException("SelectIssueForUpdate", "read", "クエリー未登録");
		...
		public boolean hasRecord(Connection conn, AD0050010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("SelectIssueForUpdate", "hasRecord", "クエリー未登録");
		...
		/**
		 * SelectIssueForUpdateクラスの標準コンストラクタ
		 */
...
+"  AND ROWNUM <= NVL(TO_NUMBER(?), ROWNUM) + 1";
		...
		public List read(Connection conn, AD0050010Struct data) throws FoundationException, SQLException
		{
			...
			if(m_selcmd==null) throw new FoundationException("SelectIssueCnt	", "read", "クエリー未登録");
		...
		public boolean hasRecord(Connection conn, AD0050010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("SelectIssueCnt	", "hasRecord", "クエリー未登録");
