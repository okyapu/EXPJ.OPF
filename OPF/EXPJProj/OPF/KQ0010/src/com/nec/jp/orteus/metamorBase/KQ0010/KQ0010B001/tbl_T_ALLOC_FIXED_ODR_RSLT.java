...
/**
 * CLASS     : tbl_T_ALLOC_FIXED_ODR_RSLT クラス
 * ファイル・クラス説明
...
public class tbl_T_ALLOC_FIXED_ODR_RSLT extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int create() throws BatchAppException
		{
			try {
				...
				BatchAppException be=new BatchAppException("tbl_T_ALLOC_FIXED_ODR_RSLT", "create", "レコード新規追加パラメータ設定処理失敗");
	...
	void prepareAll() throws BatchAppException
	{
		...
		try {
			...
			BatchAppException be=new BatchAppException("tbl_T_ALLOC_FIXED_ODR_RSLT", "prepareALL(FoundationException)", "SQL文のprepareで失敗しました");
			be.addMessage(e.getErrmsg());
			throw be;
		} catch(SQLException e) {
			BatchAppException be=new BatchAppException("tbl_T_ALLOC_FIXED_ODR_RSLT", "prepareALL(SQLException)", "SQL文のprepareで失敗しました");
			throw be;
		}
	...
	/**
	 * tbl_T_ALLOC_FIXED_ODR_RSLTクラスの標準コンストラクタ
	 *
		 */
