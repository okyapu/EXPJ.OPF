/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KQ0010/src/com/nec/jp/orteus/metamorBase/KQ0010/KQ0010B001/getUserInfo.java,v $
 *
...
public class getUserInfo extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setUSER_CD_R(String value) throws FoundationException { getAdapt_R().setString(1, value); }
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setUSER_CD_R(m_med.getstrUSER_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("getUserInfo", "read", "レコード検索条件設定処理失敗");
		...
		public String getSECTION_CD_R() throws FoundationException { return m_doRs.getString(2); }
		public String getORG_CD_R() throws FoundationException { return m_doRs.getString(3); }
		public String getORG_NAME_R() throws FoundationException { return m_doRs.getString(4); }
		public String getORG_ANAME_R() throws FoundationException { return m_doRs.getString(5); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setstrUSER_NAME(getUSER_NAME_R());
				m_med.setstrSECTION_CD(getSECTION_CD_R());
				m_med.setstrORG_CD(getORG_CD_R());
				m_med.setstrORG_NAME(getORG_NAME_R());
				m_med.setstrORG_ANAME(getORG_ANAME_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("getUserInfo", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("getUserInfo", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	 ...
	 *
		 */
	public getUserInfo(medKQ0010B001 med, BatchAppConductor cdr) throws SystemException
	{
