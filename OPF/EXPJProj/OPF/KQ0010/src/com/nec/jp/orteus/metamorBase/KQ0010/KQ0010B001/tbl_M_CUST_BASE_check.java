/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KQ0010/src/com/nec/jp/orteus/metamorBase/KQ0010/KQ0010B001/tbl_M_CUST_BASE_check.java,v $
 *
...
/**
 * CLASS     : tbl_M_CUST_BASE_check クラス
 * ファイル・クラス説明
...
public class tbl_M_CUST_BASE_check extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setIN11_R(String value) throws FoundationException { getAdapt_R().setString(3, value); }
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN11_R(m_med.getstrDLV_LOC_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("tbl_M_CUST_BASE_check", "read", "レコード検索条件設定処理失敗");
		...
		public String getDLV_LOC_NAME_R() throws FoundationException { return m_doRs.getString(4); }
		public String getCAL_NO_R() throws FoundationException { return m_doRs.getString(5); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				BatchAppException be=new BatchAppException("tbl_M_CUST_BASE_check", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("tbl_M_CUST_BASE_check", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	...
	/**
	 * tbl_M_CUST_BASE_checkクラスの標準コンストラクタ
	 *
		 */
	public tbl_M_CUST_BASE_check(medKQ0010B001 med, BatchAppConductor cdr) throws SystemException
	{
