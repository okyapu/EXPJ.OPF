/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KQ0010/src/com/nec/jp/orteus/metamorBase/KQ0010/KQ0010B001/tbl_M_UNIT_COST.java,v $
 *
...
public class tbl_M_UNIT_COST extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setEFF_PHASE_IN_DATE_R(String value) throws FoundationException { getAdapt_R().setString(4, value); }
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setEFF_PHASE_IN_DATE_R(m_med.getstrEFF_PHASE_IN_DATE());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("tbl_M_UNIT_COST", "read", "レコード検索条件設定処理失敗");
		...
		public boolean wasNull_UNIT_COST_R() throws FoundationException { return m_doRs.wasNull(1); }
		public Number getUNIT_COST_R() throws FoundationException { return m_doRs.getDouble(1); }
		public String getEFF_PHASE_IN_DATE_R() throws FoundationException { return m_doRs.getString(2); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				if(wasNull_UNIT_COST_R()==true) {
					m_med.setstrUNIT_PRICE(null);
				} else {
					m_med.setstrUNIT_PRICE(new Double(getUNIT_COST_R().doubleValue()));
				}
				m_med.setstrEFF_PHASE_IN_DATE(getEFF_PHASE_IN_DATE_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("tbl_M_UNIT_COST", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("tbl_M_UNIT_COST", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	...
	/**
	 * tbl_M_UNIT_COSTクラスの標準コンストラクタ
	 *
		 */
	public tbl_M_UNIT_COST(medKQ0010B001 med, BatchAppConductor cdr) throws SystemException
	{
