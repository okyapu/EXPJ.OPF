/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KQ0010/src/com/nec/jp/orteus/metamorBase/KQ0010/KQ0010B001/tbl_M_ITEM_SPEC.java,v $
 *
...
public class tbl_M_ITEM_SPEC extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN4_R(m_med.getstrCUST_ITEM_CD());
				setIN5_R(m_med.getstrCOMPANY_CD());
				setIN6_R(m_med.getstrCUST_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("tbl_M_ITEM_SPEC", "read", "レコード検索条件設定処理失敗");
		...
		public String getCUST_ITEM_NAME_R() throws FoundationException { return m_doRs.getString(2); }
		public String getDEPO_TYP_R() throws FoundationException { return m_doRs.getString(3); }
		public String getTAX_CD_R() throws FoundationException { return m_doRs.getString(4); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setstrITEM_CD(getITEM_CD_R());
				m_med.setstrCUST_ITEM_NAME(getCUST_ITEM_NAME_R());
				m_med.setstrDEPO_TYP(getDEPO_TYP_R());
				m_med.setstrsTAX_CD(getTAX_CD_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("tbl_M_ITEM_SPEC", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("tbl_M_ITEM_SPEC", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	 ...
	 *
		 */
	public tbl_M_ITEM_SPEC(medKQ0010B001 med, BatchAppConductor cdr) throws SystemException
	{
