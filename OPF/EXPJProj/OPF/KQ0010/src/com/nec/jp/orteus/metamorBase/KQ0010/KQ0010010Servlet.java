/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KQ0010/src/com/nec/jp/orteus/metamorBase/KQ0010/KQ0010010Servlet.java,v $
 *
...
public class KQ0010010Servlet extends HttpServlet
{
	 ...
	 * @param control KQ0010010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, KQ0010010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control KQ0010010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, KQ0010010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					KQ0010010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		KQ0010010Entity entity = control.entity;
		KQ0010010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("KQ0010010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
			// TODO: ユーザ定義のコードを記述してください
//			LogWriter.write( Level.ALL, "KQ0010010"+" $Revision: 1.21 $" );
			control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("KQ0010010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					KQ0010010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		KQ0010010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KQ0010");
		logger.entering("KQ0010010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
...
//			e.printStackTrace();
//			LogWriter.write(Level.ALL, objMessage.getIDMsg("KQ0010010-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
		}
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("KQ0010010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickAddition(
					...
					HttpSession so,
					Hashtable params,
					KQ0010010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		KQ0010010Entity entity = control.entity;
		KQ0010010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KQ0010");
		logger.entering("KQ0010010Servlet"+":USER="+request.getRemoteUser(),"onClickAddition");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickAddition>
		logger.exiting("KQ0010010Servlet"+":USER="+request.getRemoteUser(),"onClickAddition");
					...
					KQ0010010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KQ0010");
		logger.entering("KQ0010010Servlet"+":USER="+request.getRemoteUser(),"onClickModify");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickModify>
		logger.exiting("KQ0010010Servlet"+":USER="+request.getRemoteUser(),"onClickModify");
					...
					KQ0010010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KQ0010");
		logger.entering("KQ0010010Servlet"+":USER="+request.getRemoteUser(),"onClickEliminate");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickEliminate>
		logger.exiting("KQ0010010Servlet"+":USER="+request.getRemoteUser(),"onClickEliminate");
					...
					KQ0010010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KQ0010");
		logger.entering("KQ0010010Servlet"+":USER="+request.getRemoteUser(),"onClickInsert");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickInsert>
		logger.exiting("KQ0010010Servlet"+":USER="+request.getRemoteUser(),"onClickInsert");
					...
					KQ0010010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KQ0010");
		logger.entering("KQ0010010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("KQ0010010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, KQ0010010Struct struct)
	{
		String locale = (String) so.getAttribute("LOCALE");
		
		String[] l_NO = ((params.containsKey("l_NO")) ? (String[])params.get("l_NO") : (String[])null);
		...
		String[] ODR_TYP_name = ((params.containsKey("ODR_TYP_name")) ? (String[])params.get("ODR_TYP_name") : (String[])null);
		String[] ODR_TYP_val = ((params.containsKey("ODR_TYP_val")) ? (String[])params.get("ODR_TYP_val") : (String[])null);
		...
		String[] h_DOODRFLG = ((params.containsKey("h_DOODRFLG")) ? (String[])params.get("h_DOODRFLG") : (String[])null);
		String[] h_INPUTODRCDFLG = ((params.containsKey("h_INPUTODRCDFLG")) ? (String[])params.get("h_INPUTODRCDFLG") : (String[])null);
		String[] h_MRP_ODR_TYP = ((params.containsKey("h_MRP_ODR_TYP")) ? (String[])params.get("h_MRP_ODR_TYP") : (String[])null);
		String[] h_SHIP_PLANT_CD = ((params.containsKey("h_SHIP_PLANT_CD")) ? (String[])params.get("h_SHIP_PLANT_CD") : (String[])null);
		String[] h_CHECK_STATUS = ((params.containsKey("h_CHECK_STATUS")) ? (String[])params.get("h_CHECK_STATUS") : (String[])null);
		...
		struct.setl_NO( ((l_NO == null) ? (String)null : l_NO[0]) );
		struct.setList_l_NO(TypeConverter.convert(l_NO));
		...
		struct.setODR_TYP_name( ((ODR_TYP_name == null) ? (String)null : ODR_TYP_name[0]) );
		struct.setList_ODR_TYP_name(TypeConverter.convert(ODR_TYP_name));
		struct.setODR_TYP_val( ((ODR_TYP_val == null) ? (String)null : ODR_TYP_val[0]) );
		struct.setList_ODR_TYP_val(TypeConverter.convert(ODR_TYP_val));
		...
		struct.seth_DOODRFLG( ((h_DOODRFLG == null) ? (String)null : h_DOODRFLG[0]) );
		struct.setList_h_DOODRFLG(TypeConverter.convert(h_DOODRFLG));
		struct.seth_INPUTODRCDFLG( ((h_INPUTODRCDFLG == null) ? (String)null : h_INPUTODRCDFLG[0]) );
		struct.setList_h_INPUTODRCDFLG(TypeConverter.convert(h_INPUTODRCDFLG));
		...
		struct.seth_SHIP_PLANT_CD( ((h_SHIP_PLANT_CD == null) ? (String)null : h_SHIP_PLANT_CD[0]) );
		struct.setList_h_SHIP_PLANT_CD(TypeConverter.convert(h_SHIP_PLANT_CD));
		struct.seth_CHECK_STATUS( ((h_CHECK_STATUS == null) ? (String)null : h_CHECK_STATUS[0]) );
		struct.setList_h_CHECK_STATUS(TypeConverter.convert(h_CHECK_STATUS));
	...
	public static String DEFAULT_TARGET = "/KQ0010010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aKQ0010010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aKQ0010010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KQ0010");
		logger.entering("KQ0010010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("KQ0010010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		KQ0010010Control control;
		KQ0010010Entity  entity = null;
		KQ0010010Struct  struct = null;
		...
		try {
			...
			if( (control = (KQ0010010Control)so.getAttribute("KQ0010010Control_"+request.getSession(false).getId())) == null ) {
				control = new KQ0010010Control();
			...
			try {
				...
				so.setAttribute("KQ0010010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.KQ0010.KQ0010010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public KQ0010010Servlet()
	{
		//{{user_implement_dev:<KQ0010010_DisConnect_FLG>
		...
		//{{user_implement_dev:<KQ0010010Servlet>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<KQ0010010Servlet>
	}
