/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KQ0010/src/com/nec/jp/orteus/metamorBase/KQ0010/KQ0010B001/tbl_M_ITEM.java,v $
 *
...
public class tbl_M_ITEM extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				BatchAppException be=new BatchAppException("tbl_M_ITEM", "read", "レコード検索条件設定処理失敗");
		...
		public String getSTOCK_UNIT_R() throws FoundationException { return m_doRs.getString(1); }
		public String getITEM_NAME_R() throws FoundationException { return m_doRs.getString(2); }
		public String getUNIT_QTY_TYP_R() throws FoundationException { return m_doRs.getString(3); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setstrSTOCK_UNIT(getSTOCK_UNIT_R());
				m_med.setstrITEM_NAME(getITEM_NAME_R());
				m_med.setstrUNIT_QTY_TYP(getUNIT_QTY_TYP_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("tbl_M_ITEM", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("tbl_M_ITEM", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	 ...
	 *
		 */
	public tbl_M_ITEM(medKQ0010B001 med, BatchAppConductor cdr) throws SystemException
	{
