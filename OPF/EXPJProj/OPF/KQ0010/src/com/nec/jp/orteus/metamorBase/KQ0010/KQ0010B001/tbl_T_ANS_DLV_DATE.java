/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KQ0010/src/com/nec/jp/orteus/metamorBase/KQ0010/KQ0010B001/tbl_T_ANS_DLV_DATE.java,v $
 *
...
public class tbl_T_ANS_DLV_DATE extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setDESINATED_SHIP_DATE_C(String value) throws FoundationException { getAdapt_C().setString(8, value); }
		public void setDESINATED_SHIP_QTY_C(Double value) throws FoundationException {
			if (value == null) {
				getAdapt_C().setString(9, null);
			} else {
				getAdapt_C().setDouble(9, value);
			}
		}
		public void setREST_SHIP_ODR_QTY_C(Double value) throws FoundationException {
			if (value == null) {
		...
		public void setLAST_ANS_DLV_DATE_RCD_C(String value) throws FoundationException { getAdapt_C().setString(11, value); }
		...
		public int create() throws BatchAppException
		{
			try {
				...
				setDESINATED_SHIP_DATE_C(m_med.getstrDESINATED_SHIP_DATE());
				setDESINATED_SHIP_QTY_C(m_med.getstrDESINATED_SHIP_QTY());
				setREST_SHIP_ODR_QTY_C(m_med.getstrREST_SHIP_ODR_QTY());
				setLAST_ANS_DLV_DATE_RCD_C(m_med.getstrLAST_ANS_DLV_DATE_RCD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("tbl_T_ANS_DLV_DATE", "create", "レコード新規追加パラメータ設定処理失敗");
	...
	void prepareAll() throws BatchAppException
	{
		...
		try {
			...
			BatchAppException be=new BatchAppException("tbl_T_ANS_DLV_DATE", "prepareALL(FoundationException)", "SQL文のprepareで失敗しました");
			be.addMessage(e.getErrmsg());
			throw be;
		} catch(SQLException e) {
			BatchAppException be=new BatchAppException("tbl_T_ANS_DLV_DATE", "prepareALL(SQLException)", "SQL文のprepareで失敗しました");
			throw be;
		}
	 ...
	 *
		 */
	public tbl_T_ANS_DLV_DATE(medKQ0010B001 med, BatchAppConductor cdr) throws SystemException
	{
...
+"  T_ANS_DLV_DATE(\"ODR_NO\", \"PART_DLV_SEQ_NO\", \"DESINATED_SHIP_DATE\", \"DESINATED_SHIP_QTY\", \"REST_SHIP_ODR_QTY\", \"SHIP_ODR_CMPLT_FLG\", \"DEL_FLG\", \"LAST_ANS_DLV_DATE_RCD\") "
+"values "
+"  (?, 1, ?, ?, ?, '0', '0', ?)";
