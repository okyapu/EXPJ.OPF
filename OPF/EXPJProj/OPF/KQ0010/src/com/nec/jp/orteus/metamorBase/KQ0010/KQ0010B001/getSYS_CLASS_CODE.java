/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KQ0010/src/com/nec/jp/orteus/metamorBase/KQ0010/KQ0010B001/getSYS_CLASS_CODE.java,v $
 *
...
public class getSYS_CLASS_CODE extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setCLASS_CODE_R(String value) throws FoundationException { getAdapt_R().setString(1, value); }
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setCLASS_CODE_R(m_med.getsysCLASS_CODE());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("getSYS_CLASS_CODE", "read", "レコード検索条件設定処理失敗");
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setsysCODE(getCODE_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("getSYS_CLASS_CODE", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("getSYS_CLASS_CODE", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	 ...
	 *
		 */
	public getSYS_CLASS_CODE(medKQ0010B001 med, BatchAppConductor cdr) throws SystemException
	{
