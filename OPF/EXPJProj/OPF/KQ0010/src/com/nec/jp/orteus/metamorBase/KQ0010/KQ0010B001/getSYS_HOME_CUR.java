/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KQ0010/src/com/nec/jp/orteus/metamorBase/KQ0010/KQ0010B001/getSYS_HOME_CUR.java,v $
 *
...
public class getSYS_HOME_CUR extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				BatchAppException be=new BatchAppException("getSYS_HOME_CUR", "read", "レコード検索条件設定処理失敗");
		...
		public String getHOME_CUR_CD_R() throws FoundationException { return m_doRs.getString(1); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setsysHomeCurCd(getHOME_CUR_CD_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("getSYS_HOME_CUR", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("getSYS_HOME_CUR", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	...
	/**
	 * getSYS_HOME_CURクラスの標準コンストラクタ
	 *
		 */
	public getSYS_HOME_CUR(medKQ0010B001 med, BatchAppConductor cdr) throws SystemException
	{
