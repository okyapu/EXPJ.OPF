/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0140/src/com/nec/jp/orteus/metamorBase/AE0140/AE0140010Servlet.java,v $
 *
...
public class AE0140010Servlet extends HttpServlet
{
	 ...
	 * @param control AE0140010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AE0140010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AE0140010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AE0140010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AE0140010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AE0140010Entity entity = control.entity;
		AE0140010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AE0140010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
			// TODO: ユーザ定義のコードを記述してください
//			LogWriter.write( Level.ALL, "AE0140010"+" $Revision: 1.8 $" );
			control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AE0140010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AE0140010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AE0140010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0140");
		logger.entering("AE0140010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
...
//			e.printStackTrace();
//			LogWriter.write(Level.ALL, objMessage.getIDMsg("AE0140010-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
		}
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AE0140010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickSelect(
					...
					HttpSession so,
					Hashtable params,
					AE0140010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AE0140010Entity entity = control.entity;
		AE0140010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0140");
		logger.entering("AE0140010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickSelect>
		logger.exiting("AE0140010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
					...
					AE0140010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0140");
		logger.entering("AE0140010Servlet"+":USER="+request.getRemoteUser(),"onClickCsvOut");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickCsvOut>
		logger.exiting("AE0140010Servlet"+":USER="+request.getRemoteUser(),"onClickCsvOut");
					...
					AE0140010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0140");
		logger.entering("AE0140010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("AE0140010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AE0140010Struct struct)
	{
		...
		String[] INSPEC_DATE_FROM = ((params.containsKey("INSPEC_DATE_FROM")) ? (String[])params.get("INSPEC_DATE_FROM") : (String[])null);
		...
		String[] r1_ACPT_STS_TYP = ((params.containsKey("r1_ACPT_STS_TYP")) ? (String[])params.get("r1_ACPT_STS_TYP") : (String[])null);
		String[] ITEM_CD = ((params.containsKey("ITEM_CD")) ? (String[])params.get("ITEM_CD") : (String[])null);
		String[] ITEM_NAME = ((params.containsKey("ITEM_NAME")) ? (String[])params.get("ITEM_NAME") : (String[])null);
		String[] r2_ACPT_STS_TYP = ((params.containsKey("r2_ACPT_STS_TYP")) ? (String[])params.get("r2_ACPT_STS_TYP") : (String[])null);
		...
		String[] r3_ACPT_STS_TYP = ((params.containsKey("r3_ACPT_STS_TYP")) ? (String[])params.get("r3_ACPT_STS_TYP") : (String[])null);
		...
		String[] l_REJECTED_GOODS_QTY = ((params.containsKey("l_REJECTED_GOODS_QTY")) ? (String[])params.get("l_REJECTED_GOODS_QTY") : (String[])null);
		...
		String[] l_INSPC_CRCT_NO = ((params.containsKey("l_INSPC_CRCT_NO")) ? (String[])params.get("l_INSPC_CRCT_NO") : (String[])null);
		String[] l_INSPEC_RSLT_COMMENT = ((params.containsKey("l_INSPEC_RSLT_COMMENT")) ? (String[])params.get("l_INSPEC_RSLT_COMMENT") : (String[])null);
		String[] INSPEC_DATE_TO = ((params.containsKey("INSPEC_DATE_TO")) ? (String[])params.get("INSPEC_DATE_TO") : (String[])null);
		String[] r4_ACPT_STS_TYP = ((params.containsKey("r4_ACPT_STS_TYP")) ? (String[])params.get("r4_ACPT_STS_TYP") : (String[])null);
		...
		struct.setINSPEC_DATE_FROM( ((INSPEC_DATE_FROM == null) ? (String)null : INSPEC_DATE_FROM[0]) );
		struct.setList_INSPEC_DATE_FROM(TypeConverter.convert(INSPEC_DATE_FROM));
		...
		struct.setr1_ACPT_STS_TYP( ((r1_ACPT_STS_TYP == null) ? (String)null : r1_ACPT_STS_TYP[0]) );
		struct.setList_r1_ACPT_STS_TYP(TypeConverter.convert(r1_ACPT_STS_TYP));
		struct.setITEM_CD( ((ITEM_CD == null) ? (String)null : ITEM_CD[0]) );
		struct.setList_ITEM_CD(TypeConverter.convert(ITEM_CD));
		struct.setITEM_NAME( ((ITEM_NAME == null) ? (String)null : ITEM_NAME[0]) );
		struct.setList_ITEM_NAME(TypeConverter.convert(ITEM_NAME));
		struct.setr2_ACPT_STS_TYP( ((r2_ACPT_STS_TYP == null) ? (String)null : r2_ACPT_STS_TYP[0]) );
		struct.setList_r2_ACPT_STS_TYP(TypeConverter.convert(r2_ACPT_STS_TYP));
		...
		struct.setr3_ACPT_STS_TYP( ((r3_ACPT_STS_TYP == null) ? (String)null : r3_ACPT_STS_TYP[0]) );
		struct.setList_r3_ACPT_STS_TYP(TypeConverter.convert(r3_ACPT_STS_TYP));
		...
		struct.setl_REJECTED_GOODS_QTY( ((l_REJECTED_GOODS_QTY == null) ? (String)null : l_REJECTED_GOODS_QTY[0]) );
		struct.setList_l_REJECTED_GOODS_QTY(TypeConverter.convert(l_REJECTED_GOODS_QTY));
		...
		struct.setl_INSPC_CRCT_NO( ((l_INSPC_CRCT_NO == null) ? (String)null : l_INSPC_CRCT_NO[0]) );
		struct.setList_l_INSPC_CRCT_NO(TypeConverter.convert(l_INSPC_CRCT_NO));
		struct.setl_INSPEC_RSLT_COMMENT( ((l_INSPEC_RSLT_COMMENT == null) ? (String)null : l_INSPEC_RSLT_COMMENT[0]) );
		struct.setList_l_INSPEC_RSLT_COMMENT(TypeConverter.convert(l_INSPEC_RSLT_COMMENT));
		struct.setINSPEC_DATE_TO( ((INSPEC_DATE_TO == null) ? (String)null : INSPEC_DATE_TO[0]) );
		struct.setList_INSPEC_DATE_TO(TypeConverter.convert(INSPEC_DATE_TO));
		struct.setr4_ACPT_STS_TYP( ((r4_ACPT_STS_TYP == null) ? (String)null : r4_ACPT_STS_TYP[0]) );
		struct.setList_r4_ACPT_STS_TYP(TypeConverter.convert(r4_ACPT_STS_TYP));
	...
	public static String DEFAULT_TARGET = "/AE0140010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAE0140010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAE0140010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0140");
		logger.entering("AE0140010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AE0140010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AE0140010Control control;
		AE0140010Entity  entity = null;
		AE0140010Struct  struct = null;
		...
		try {
			...
			if( (control = (AE0140010Control)so.getAttribute("AE0140010Control_"+request.getSession(false).getId())) == null ) {
				control = new AE0140010Control();
			...
			try {
				...
				so.setAttribute("AE0140010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.AE0140.AE0140010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AE0140010Servlet()
	{
		//{{user_implement_dev:<AE0140010_DisConnect_FLG>
		...
		//{{user_implement_dev:<AE0140010Servlet>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<AE0140010Servlet>
	}
