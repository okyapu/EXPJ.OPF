...
public class AF0020010Servlet extends HttpServlet
{
	 ...
	 * @param control AF0020010Controlクラスインスタンス
	 */
...
//			e.printStackTrace();
	...
	public String onClickinsertSub2(
					...
					AF0020010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = "/AF0020012.jsp";		// 移動先ＵＲＬ
		AF0020010Entity entity = control.entity;
		AF0020010Struct struct = control.struct;
		getSessionParameters(so, params, struct);
...
//			e.printStackTrace();
	...
	public static String DEFAULT_TARGET = "/AF0020010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAF0020010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAF0020010Struct";   // JSP先のバインド名(Struct)の指定
