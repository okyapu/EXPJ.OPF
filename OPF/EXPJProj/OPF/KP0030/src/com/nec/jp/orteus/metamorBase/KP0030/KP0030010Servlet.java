/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KP0030/src/com/nec/jp/orteus/metamorBase/KP0030/KP0030010Servlet.java,v $
 *
...
public class KP0030010Servlet extends HttpServlet
{
	 ...
	 * @param control KP0030010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, KP0030010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control KP0030010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, KP0030010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					KP0030010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		KP0030010Entity entity = control.entity;
		KP0030010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("KP0030010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
			// TODO: ユーザ定義のコードを記述してください
//			LogWriter.write( Level.ALL, "KP0030010"+" $Revision: 1.9 $" );
			control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("KP0030010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					KP0030010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		KP0030010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KP0030");
		logger.entering("KP0030010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
...
//			e.printStackTrace();
//			LogWriter.write(Level.ALL, objMessage.getIDMsg("KP0030010-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
		}
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("KP0030010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickSelect(
					...
					HttpSession so,
					Hashtable params,
					KP0030010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		KP0030010Entity entity = control.entity;
		KP0030010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KP0030");
		logger.entering("KP0030010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickSelect>
		logger.exiting("KP0030010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
					...
					KP0030010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KP0030");
		logger.entering("KP0030010Servlet"+":USER="+request.getRemoteUser(),"onClickGoSub");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickGoSub>
		logger.exiting("KP0030010Servlet"+":USER="+request.getRemoteUser(),"onClickGoSub");
					...
					KP0030010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KP0030");
		logger.entering("KP0030010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("KP0030010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
					...
					KP0030010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KP0030");
		logger.entering("KP0030010Servlet"+":USER="+request.getRemoteUser(),"onClickClose");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClose>
		logger.exiting("KP0030010Servlet"+":USER="+request.getRemoteUser(),"onClickClose");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, KP0030010Struct struct)
	{
		...
		String[] IN_STR_DATE = ((params.containsKey("IN_STR_DATE")) ? (String[])params.get("IN_STR_DATE") : (String[])null);
		String[] IN_END_DATE = ((params.containsKey("IN_END_DATE")) ? (String[])params.get("IN_END_DATE") : (String[])null);
		String[] SALES_PLAN_CD = ((params.containsKey("SALES_PLAN_CD")) ? (String[])params.get("SALES_PLAN_CD") : (String[])null);
		...
		String[] PLN_CD = ((params.containsKey("PLN_CD")) ? (String[])params.get("PLN_CD") : (String[])null);
		...
		struct.setIN_STR_DATE( ((IN_STR_DATE == null) ? (String)null : IN_STR_DATE[0]) );
		struct.setList_IN_STR_DATE(TypeConverter.convert(IN_STR_DATE));
		struct.setIN_END_DATE( ((IN_END_DATE == null) ? (String)null : IN_END_DATE[0]) );
		struct.setList_IN_END_DATE(TypeConverter.convert(IN_END_DATE));
		struct.setSALES_PLAN_CD( ((SALES_PLAN_CD == null) ? (String)null : SALES_PLAN_CD[0]) );
		struct.setList_SALES_PLAN_CD(TypeConverter.convert(SALES_PLAN_CD));
		...
		struct.setPLN_CD( ((PLN_CD == null) ? (String)null : PLN_CD[0]) );
		struct.setList_PLN_CD(TypeConverter.convert(PLN_CD));
	...
	public static String DEFAULT_TARGET = "/KP0030010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aKP0030010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aKP0030010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KP0030");
		logger.entering("KP0030010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("KP0030010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		KP0030010Control control;
		KP0030010Entity  entity = null;
		KP0030010Struct  struct = null;
		...
		try {
			...
			if( (control = (KP0030010Control)so.getAttribute("KP0030010Control_"+request.getSession(false).getId())) == null ) {
				control = new KP0030010Control();
			...
			try {
				...
				so.setAttribute("KP0030010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.KP0030.KP0030010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public KP0030010Servlet()
	{
		//{{user_implement_dev:<KP0030010_DisConnect_FLG>
		...
		//{{user_implement_dev:<KP0030010Servlet>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<KP0030010Servlet>
	}
