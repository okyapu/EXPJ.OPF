/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KP0040/src/com/nec/jp/orteus/metamorBase/KP0040/KP0040B003/insertT_SALES_PLAN.java,v $
 *
...
public class insertT_SALES_PLAN extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setPLN_QTY_REMAIN_U(String value) throws FoundationException { getAdapt_U().setString(4, value); }
		...
		public int update() throws BatchAppException
		{
			try {
				...
				setPLN_QTY_REMAIN_U(m_med.getIN_REM_QTY());
				setIN1_U(m_med.getIN_SALES_PLAN_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("insertT_SALES_PLAN", "update", "レコード更新条件設定処理失敗");
	 ...
	 *
		 */
	public insertT_SALES_PLAN(medKP0040B003 med, BatchAppConductor cdr) throws SystemException
	{
...
+"  T_SALES_PLAN "
+"SET "
+"  T_SALES_PLAN.PLN_QTY_REMAIN = ? "
+"WHERE "
+"  T_SALES_PLAN.SALES_PLAN_CD = ?";
