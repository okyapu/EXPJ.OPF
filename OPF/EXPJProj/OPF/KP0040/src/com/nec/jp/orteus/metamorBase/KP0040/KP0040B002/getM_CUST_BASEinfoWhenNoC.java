/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KP0040/src/com/nec/jp/orteus/metamorBase/KP0040/KP0040B002/getM_CUST_BASEinfoWhenNoC.java,v $
 *
...
/**
 * CLASS     : getM_CUST_BASEinfoWhenNoC クラス
 * ファイル・クラス説明
...
public class getM_CUST_BASEinfoWhenNoC extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				BatchAppException be=new BatchAppException("getM_CUST_BASEinfoWhenNoC", "read", "レコード検索条件設定処理失敗");
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				BatchAppException be=new BatchAppException("getM_CUST_BASEinfoWhenNoC", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("getM_CUST_BASEinfoWhenNoC", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	 ...
	 *
		 */
	public getM_CUST_BASEinfoWhenNoC(medKP0040B002 med, BatchAppConductor cdr) throws SystemException
	{
