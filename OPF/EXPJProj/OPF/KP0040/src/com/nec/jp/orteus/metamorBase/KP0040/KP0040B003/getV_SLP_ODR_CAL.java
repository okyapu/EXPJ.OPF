/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KP0040/src/com/nec/jp/orteus/metamorBase/KP0040/KP0040B003/getV_SLP_ODR_CAL.java,v $
 *
...
public class getV_SLP_ODR_CAL extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				BatchAppException be=new BatchAppException("getV_SLP_ODR_CAL", "read", "レコード検索条件設定処理失敗");
		...
		public String getREM_QTY_R() throws FoundationException { return m_doRs.getString(2); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setVIEW_SALES_PLAN_CD(getSALES_PLAN_CD_R());
				m_med.setVIEW_REM_QTY(getREM_QTY_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("getV_SLP_ODR_CAL", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("getV_SLP_ODR_CAL", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	...
	/**
	 * getV_SLP_ODR_CALクラスの標準コンストラクタ
	 *
		 */
	public getV_SLP_ODR_CAL(medKP0040B003 med, BatchAppConductor cdr) throws SystemException
	{
