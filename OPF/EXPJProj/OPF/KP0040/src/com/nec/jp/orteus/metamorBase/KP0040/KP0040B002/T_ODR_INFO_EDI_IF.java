/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KP0040/src/com/nec/jp/orteus/metamorBase/KP0040/KP0040B002/T_ODR_INFO_EDI_IF.java,v $
 *
 ...
 * @version $Revision: 1.15 $ $Date: 2015/12/03 08:53:24 $
 */
...
public class T_ODR_INFO_EDI_IF extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setIN1_U(Double value) throws FoundationException {
			if (value == null) {
		...
		public int update() throws BatchAppException
		{
			try {
				...
				setIN1_U(m_med.getEdiODR_INFO_IF_CTRL_NO());
			} catch(FoundationException e) {
	 ...
	 *
		 */
	public T_ODR_INFO_EDI_IF(medKP0040B002 med, BatchAppConductor cdr) throws SystemException
	{
...
+"  T_SALESPLN_IF.\"ODR_INFO_IF_CTRL_NO\" as \"ODR_INFO_IF_CTRL_NO\", "
+"  T_SALESPLN_IF.\"DATA_PROC_CD\" as \"DATA_PROC_CD\", "
+"  T_SALESPLN_IF.\"INFO_TYP_CD\" as \"INFO_TYP_CD\", "
+"  T_SALESPLN_IF.\"DATA_CREATED_DATE\" as \"DATA_CREATED_DATE\", "
+"  T_SALESPLN_IF.\"CLIENT_CD\" as \"CLIENT_CD\", "
+"  T_SALESPLN_IF.\"TRUSTEE_CD\" as \"TRUSTEE_CD\", "
+"  T_SALESPLN_IF.\"BUYER_ORG_CD\" as \"BUYER_ORG_CD\", "
+"  T_SALESPLN_IF.\"PUCH_ODR_CD\" as \"PUCH_ODR_CD\", "
+"  T_SALESPLN_IF.\"PRDCT_ODR_CD\" as \"PRDCT_ODR_CD\", "
+"  T_SALESPLN_IF.\"MODIFICATION_CODE\" as \"MODIFICATION_CODE\", "
+"  T_SALESPLN_IF.\"COCK_TYP\" as \"COCK_TYP\", "
+"  T_SALESPLN_IF.\"PUCH_ODR_DATE\" as \"PUCH_ODR_DATE\", "
+"  T_SALESPLN_IF.\"UNIT\" as \"UNIT\", "
+"  T_SALESPLN_IF.\"UNIT_PRICE\" as \"UNIT_PRICE\", "
+"  T_SALESPLN_IF.\"PRICE_TYP\" as \"PRICE_TYP\", "
+"  T_SALESPLN_IF.\"PUCH_ODR_QTY\" as \"PUCH_ODR_QTY\", "
+"  T_SALESPLN_IF.\"PUCH_ODR_AMOUNT\" as \"PUCH_ODR_AMOUNT\", "
+"  T_SALESPLN_IF.\"CONS_TYP\" as \"CONS_TYP\", "
+"  T_SALESPLN_IF.\"BUYER_NAME\" as \"BUYER_NAME\", "
+"  T_SALESPLN_IF.\"MATR_SPEC_SIZE\" as \"MATR_SPEC_SIZE\", "
+"  T_SALESPLN_IF.\"SPECTP\" as \"SPECTP\", "
+"  T_SALESPLN_IF.\"DROWING_EDITION\" as \"DROWING_EDITION\", "
+"  T_SALESPLN_IF.\"PART_NAME\" as \"PART_NAME\", "
+"  T_SALESPLN_IF.\"OWN_ITEM_CD\" as \"OWN_ITEM_CD\", "
+"  T_SALESPLN_IF.\"CUST_ITEM_CD\" as \"CUST_ITEM_CD\", "
+"  T_SALESPLN_IF.\"DROW_SPEC_QTY\" as \"DROW_SPEC_QTY\", "
+"  T_SALESPLN_IF.\"PKG_UNIT\" as \"PKG_UNIT\", "
+"  T_SALESPLN_IF.\"DIRECT_DLV_TYP\" as \"DIRECT_DLV_TYP\", "
+"  T_SALESPLN_IF.\"DLV_LOC_CD\" as \"DLV_LOC_CD\", "
+"  T_SALESPLN_IF.\"INSPC_TYP\" as \"INSPC_TYP\", "
+"  T_SALESPLN_IF.\"DLV_INST_TYP\" as \"DLV_INST_TYP\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_1\" as \"SCDL_DLV_DATE_1\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_1\" as \"SCDL_DLV_QTY_1\", "
+"  T_SALESPLN_IF.\"DLV_CD_1\" as \"DLV_CD_1\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_2\" as \"SCDL_DLV_DATE_2\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_2\" as \"SCDL_DLV_QTY_2\", "
+"  T_SALESPLN_IF.\"DLV_CD_2\" as \"DLV_CD_2\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_3\" as \"SCDL_DLV_DATE_3\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_3\" as \"SCDL_DLV_QTY_3\", "
+"  T_SALESPLN_IF.\"DLV_CD_3\" as \"DLV_CD_3\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_4\" as \"SCDL_DLV_DATE_4\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_4\" as \"SCDL_DLV_QTY_4\", "
+"  T_SALESPLN_IF.\"DLV_CD_4\" as \"DLV_CD_4\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_5\" as \"SCDL_DLV_DATE_5\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_5\" as \"SCDL_DLV_QTY_5\", "
+"  T_SALESPLN_IF.\"DLV_CD_5\" as \"DLV_CD_5\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_6\" as \"SCDL_DLV_DATE_6\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_6\" as \"SCDL_DLV_QTY_6\", "
+"  T_SALESPLN_IF.\"DLV_CD_6\" as \"DLV_CD_6\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_7\" as \"SCDL_DLV_DATE_7\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_7\" as \"SCDL_DLV_QTY_7\", "
+"  T_SALESPLN_IF.\"DLV_CD_7\" as \"DLV_CD_7\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_8\" as \"SCDL_DLV_DATE_8\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_8\" as \"SCDL_DLV_QTY_8\", "
+"  T_SALESPLN_IF.\"DLV_CD_8\" as \"DLV_CD_8\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_9\" as \"SCDL_DLV_DATE_9\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_9\" as \"SCDL_DLV_QTY_9\", "
+"  T_SALESPLN_IF.\"DLV_CD_9\" as \"DLV_CD_9\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_10\" as \"SCDL_DLV_DATE_10\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_10\" as \"SCDL_DLV_QTY_10\", "
+"  T_SALESPLN_IF.\"DLV_CD_10\" as \"DLV_CD_10\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_11\" as \"SCDL_DLV_DATE_11\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_11\" as \"SCDL_DLV_QTY_11\", "
+"  T_SALESPLN_IF.\"DLV_CD_11\" as \"DLV_CD_11\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_12\" as \"SCDL_DLV_DATE_12\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_12\" as \"SCDL_DLV_QTY_12\", "
+"  T_SALESPLN_IF.\"DLV_CD_12\" as \"DLV_CD_12\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_13\" as \"SCDL_DLV_DATE_13\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_13\" as \"SCDL_DLV_QTY_13\", "
+"  T_SALESPLN_IF.\"DLV_CD_13\" as \"DLV_CD_13\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_14\" as \"SCDL_DLV_DATE_14\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_14\" as \"SCDL_DLV_QTY_14\", "
+"  T_SALESPLN_IF.\"DLV_CD_14\" as \"DLV_CD_14\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_15\" as \"SCDL_DLV_DATE_15\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_15\" as \"SCDL_DLV_QTY_15\", "
+"  T_SALESPLN_IF.\"DLV_CD_15\" as \"DLV_CD_15\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_16\" as \"SCDL_DLV_DATE_16\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_16\" as \"SCDL_DLV_QTY_16\", "
+"  T_SALESPLN_IF.\"DLV_CD_16\" as \"DLV_CD_16\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_17\" as \"SCDL_DLV_DATE_17\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_17\" as \"SCDL_DLV_QTY_17\", "
+"  T_SALESPLN_IF.\"DLV_CD_17\" as \"DLV_CD_17\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_18\" as \"SCDL_DLV_DATE_18\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_18\" as \"SCDL_DLV_QTY_18\", "
+"  T_SALESPLN_IF.\"DLV_CD_18\" as \"DLV_CD_18\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_19\" as \"SCDL_DLV_DATE_19\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_19\" as \"SCDL_DLV_QTY_19\", "
+"  T_SALESPLN_IF.\"DLV_CD_19\" as \"DLV_CD_19\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_20\" as \"SCDL_DLV_DATE_20\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_20\" as \"SCDL_DLV_QTY_20\", "
+"  T_SALESPLN_IF.\"DLV_CD_20\" as \"DLV_CD_20\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_21\" as \"SCDL_DLV_DATE_21\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_21\" as \"SCDL_DLV_QTY_21\", "
+"  T_SALESPLN_IF.\"DLV_CD_21\" as \"DLV_CD_21\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_22\" as \"SCDL_DLV_DATE_22\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_22\" as \"SCDL_DLV_QTY_22\", "
+"  T_SALESPLN_IF.\"DLV_CD_22\" as \"DLV_CD_22\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_23\" as \"SCDL_DLV_DATE_23\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_23\" as \"SCDL_DLV_QTY_23\", "
+"  T_SALESPLN_IF.\"DLV_CD_23\" as \"DLV_CD_23\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_24\" as \"SCDL_DLV_DATE_24\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_24\" as \"SCDL_DLV_QTY_24\", "
+"  T_SALESPLN_IF.\"DLV_CD_24\" as \"DLV_CD_24\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_25\" as \"SCDL_DLV_DATE_25\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_25\" as \"SCDL_DLV_QTY_25\", "
+"  T_SALESPLN_IF.\"DLV_CD_25\" as \"DLV_CD_25\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_26\" as \"SCDL_DLV_DATE_26\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_26\" as \"SCDL_DLV_QTY_26\", "
+"  T_SALESPLN_IF.\"DLV_CD_26\" as \"DLV_CD_26\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_27\" as \"SCDL_DLV_DATE_27\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_27\" as \"SCDL_DLV_QTY_27\", "
+"  T_SALESPLN_IF.\"DLV_CD_27\" as \"DLV_CD_27\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_28\" as \"SCDL_DLV_DATE_28\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_28\" as \"SCDL_DLV_QTY_28\", "
+"  T_SALESPLN_IF.\"DLV_CD_28\" as \"DLV_CD_28\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_29\" as \"SCDL_DLV_DATE_29\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_29\" as \"SCDL_DLV_QTY_29\", "
+"  T_SALESPLN_IF.\"DLV_CD_29\" as \"DLV_CD_29\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_30\" as \"SCDL_DLV_DATE_30\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_30\" as \"SCDL_DLV_QTY_30\", "
+"  T_SALESPLN_IF.\"DLV_CD_30\" as \"DLV_CD_30\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_DATE_31\" as \"SCDL_DLV_DATE_31\", "
+"  T_SALESPLN_IF.\"SCDL_DLV_QTY_31\" as \"SCDL_DLV_QTY_31\", "
+"  T_SALESPLN_IF.\"DLV_CD_31\" as \"DLV_CD_31\", "
+"  T_SALESPLN_IF.\"FREE_TEXT\" as \"FREE_TEXT\", "
+"  T_SALESPLN_IF.\"REMARKS\" as \"REMARKS\", "
+"  T_SALESPLN_IF.\"TAX_TYP\" as \"TAX_TYP\", "
+"  T_SALESPLN_IF.\"CUST_TAXATION_TYP\" as \"CUST_TAXATION_TYP\", "
+"  T_SALESPLN_IF.\"TAX_AMOUNT\" as \"TAX_AMOUNT\", "
+"  T_SALESPLN_IF.\"CUST_TOTAL_AMOUNT\" as \"CUST_TOTAL_AMOUNT\", "
+"  T_SALESPLN_IF.\"UNCONFIRM_ODR_CD\" as \"UNCONFIRM_ODR_CD\", "
+"  T_SALESPLN_IF.\"UNCONFIRM_ODR_DATE\" as \"UNCONFIRM_ODR_DATE\", "
+"  T_SALESPLN_IF.\"UNCONFIRM_ODR_QTY\" as \"UNCONFIRM_ODR_QTY\", "
+"  T_SALESPLN_IF.\"UNCONFIRM_ODR_AMOUNT\" as \"UNCONFIRM_ODR_AMOUNT\", "
+"  T_SALESPLN_IF.\"ESTIMATE_REQST_CD\" as \"ESTIMATE_REQST_CD\", "
+"  T_SALESPLN_IF.\"STL_COND_CD\" as \"STL_COND_CD\", "
+"  T_SALESPLN_IF.\"END_USER_NAME\" as \"END_USER_NAME\", "
+"  T_SALESPLN_IF.\"DLV_ZIP_CD\" as \"DLV_ZIP_CD\", "
+"  T_SALESPLN_IF.\"DLV_ADDRESS\" as \"DLV_ADDRESS\", "
+"  T_SALESPLN_IF.\"DLV_ADDRESSEE\" as \"DLV_ADDRESSEE\", "
+"  T_SALESPLN_IF.\"CUST_COMM_SUBNAME\" as \"CUST_COMM_SUBNAME\", "
+"  T_SALESPLN_IF.\"CUST_COMM_SUBCD\" as \"CUST_COMM_SUBCD\", "
+"  T_SALESPLN_IF.\"END_USER_ODR_CD\" as \"END_USER_ODR_CD\", "
+"  T_SALESPLN_IF.\"CUST_DESINATED_MAKER\" as \"CUST_DESINATED_MAKER\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_1\" as \"DLV_KEY_NO_1\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_2\" as \"DLV_KEY_NO_2\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_3\" as \"DLV_KEY_NO_3\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_4\" as \"DLV_KEY_NO_4\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_5\" as \"DLV_KEY_NO_5\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_6\" as \"DLV_KEY_NO_6\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_7\" as \"DLV_KEY_NO_7\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_8\" as \"DLV_KEY_NO_8\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_9\" as \"DLV_KEY_NO_9\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_10\" as \"DLV_KEY_NO_10\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_11\" as \"DLV_KEY_NO_11\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_12\" as \"DLV_KEY_NO_12\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_13\" as \"DLV_KEY_NO_13\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_14\" as \"DLV_KEY_NO_14\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_15\" as \"DLV_KEY_NO_15\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_16\" as \"DLV_KEY_NO_16\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_17\" as \"DLV_KEY_NO_17\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_18\" as \"DLV_KEY_NO_18\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_19\" as \"DLV_KEY_NO_19\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_20\" as \"DLV_KEY_NO_20\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_21\" as \"DLV_KEY_NO_21\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_22\" as \"DLV_KEY_NO_22\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_23\" as \"DLV_KEY_NO_23\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_24\" as \"DLV_KEY_NO_24\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_25\" as \"DLV_KEY_NO_25\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_26\" as \"DLV_KEY_NO_26\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_27\" as \"DLV_KEY_NO_27\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_28\" as \"DLV_KEY_NO_28\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_29\" as \"DLV_KEY_NO_29\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_30\" as \"DLV_KEY_NO_30\", "
+"  T_SALESPLN_IF.\"DLV_KEY_NO_31\" as \"DLV_KEY_NO_31\", "
+"  T_SALESPLN_IF.\"DLV_LOC_NAME\" as \"DLV_LOC_NAME\", "
+"  T_SALESPLN_IF.\"CLIENT_BARCODE_INF\" as \"CLIENT_BARCODE_INF\", "
+"  T_SALESPLN_IF.\"CLIENT_REMARK\" as \"CLIENT_REMARK\", "
+"  T_SALESPLN_IF.\"CONTRACT_COND_TYP\" as \"CONTRACT_COND_TYP\", "
+"  T_SALESPLN_IF.\"PUCH_ODR_SHAP_TYP\" as \"PUCH_ODR_SHAP_TYP\", "
+"  T_SALESPLN_IF.\"MASTER_PUCH_ODR_CD\" as \"MASTER_PUCH_ODR_CD\", "
+"  T_SALESPLN_IF.\"QTY_CONTRACT_TYP\" as \"QTY_CONTRACT_TYP\", "
+"  T_SALESPLN_IF.\"ODR_MODIFICATION_TYP_1\" as \"ODR_MODIFICATION_TYP_1\", "
+"  T_SALESPLN_IF.\"ODR_MODIFICATION_TYP_2\" as \"ODR_MODIFICATION_TYP_2\", "
+"  T_SALESPLN_IF.\"ODR_MODIFICATION_TYP_3\" as \"ODR_MODIFICATION_TYP_3\", "
+"  T_SALESPLN_IF.\"MACHINE_TYP_CD\" as \"MACHINE_TYP_CD\", "
+"  T_SALESPLN_IF.\"ENGINNERING_CHG_CD\" as \"ENGINNERING_CHG_CD\", "
+"  T_SALESPLN_IF.\"DROW_SPEC_CD\" as \"DROW_SPEC_CD\", "
+"  T_SALESPLN_IF.\"DLV_DOC_FORM_1\" as \"DLV_DOC_FORM_1\", "
+"  T_SALESPLN_IF.\"DLV_DOC_COPY_NUM_1\" as \"DLV_DOC_COPY_NUM_1\", "
+"  T_SALESPLN_IF.\"DLV_DOC_LANG_1\" as \"DLV_DOC_LANG_1\", "
+"  T_SALESPLN_IF.\"DLV_DOC_FORM_2\" as \"DLV_DOC_FORM_2\", "
+"  T_SALESPLN_IF.\"DLV_DOC_COPY_NUM_2\" as \"DLV_DOC_COPY_NUM_2\", "
+"  T_SALESPLN_IF.\"DLV_DOC_LANG_2\" as \"DLV_DOC_LANG_2\", "
+"  T_SALESPLN_IF.\"DLV_DOC_FORM_3\" as \"DLV_DOC_FORM_3\", "
+"  T_SALESPLN_IF.\"DLV_DOC_COPY_NUM_3\" as \"DLV_DOC_COPY_NUM_3\", "
+"  T_SALESPLN_IF.\"DLV_DOC_LANG_3\" as \"DLV_DOC_LANG_3\", "
+"  T_SALESPLN_IF.\"DLV_DOC_FORM_4\" as \"DLV_DOC_FORM_4\", "
+"  T_SALESPLN_IF.\"DLV_DOC_COPY_NUM_4\" as \"DLV_DOC_COPY_NUM_4\", "
+"  T_SALESPLN_IF.\"DLV_DOC_LANG_4\" as \"DLV_DOC_LANG_4\", "
+"  T_SALESPLN_IF.\"STRATEGIC_GOODS_TYP\" as \"STRATEGIC_GOODS_TYP\", "
+"  T_SALESPLN_IF.\"ORGN_PLACE_CD_1\" as \"ORGN_PLACE_CD_1\", "
+"  T_SALESPLN_IF.\"ORGN_PLACE_CD_2\" as \"ORGN_PLACE_CD_2\", "
+"  T_SALESPLN_IF.\"ORGN_PLACE_CD_3\" as \"ORGN_PLACE_CD_3\", "
+"  T_SALESPLN_IF.\"ORGN_PLACE_CD_4\" as \"ORGN_PLACE_CD_4\", "
+"  T_SALESPLN_IF.\"ORGN_PLACE_CD_5\" as \"ORGN_PLACE_CD_5\", "
+"  T_SALESPLN_IF.\"DLV_TIME_1\" as \"DLV_TIME_1\", "
+"  T_SALESPLN_IF.\"DLV_TIME_2\" as \"DLV_TIME_2\", "
+"  T_SALESPLN_IF.\"DLV_TIME_3\" as \"DLV_TIME_3\", "
+"  T_SALESPLN_IF.\"DLV_TIME_4\" as \"DLV_TIME_4\", "
+"  T_SALESPLN_IF.\"DLV_TIME_5\" as \"DLV_TIME_5\", "
+"  T_SALESPLN_IF.\"DLV_TIME_6\" as \"DLV_TIME_6\", "
+"  T_SALESPLN_IF.\"DLV_TIME_7\" as \"DLV_TIME_7\", "
+"  T_SALESPLN_IF.\"DLV_TIME_8\" as \"DLV_TIME_8\", "
+"  T_SALESPLN_IF.\"DLV_TIME_9\" as \"DLV_TIME_9\", "
+"  T_SALESPLN_IF.\"DLV_TIME_10\" as \"DLV_TIME_10\", "
+"  T_SALESPLN_IF.\"DLV_TIME_11\" as \"DLV_TIME_11\", "
+"  T_SALESPLN_IF.\"DLV_TIME_12\" as \"DLV_TIME_12\", "
+"  T_SALESPLN_IF.\"DLV_TIME_13\" as \"DLV_TIME_13\", "
+"  T_SALESPLN_IF.\"DLV_TIME_14\" as \"DLV_TIME_14\", "
+"  T_SALESPLN_IF.\"DLV_TIME_15\" as \"DLV_TIME_15\", "
+"  T_SALESPLN_IF.\"DLV_TIME_16\" as \"DLV_TIME_16\", "
+"  T_SALESPLN_IF.\"DLV_TIME_17\" as \"DLV_TIME_17\", "
+"  T_SALESPLN_IF.\"DLV_TIME_18\" as \"DLV_TIME_18\", "
+"  T_SALESPLN_IF.\"DLV_TIME_19\" as \"DLV_TIME_19\", "
+"  T_SALESPLN_IF.\"DLV_TIME_20\" as \"DLV_TIME_20\", "
+"  T_SALESPLN_IF.\"DLV_TIME_21\" as \"DLV_TIME_21\", "
+"  T_SALESPLN_IF.\"DLV_TIME_22\" as \"DLV_TIME_22\", "
+"  T_SALESPLN_IF.\"DLV_TIME_23\" as \"DLV_TIME_23\", "
+"  T_SALESPLN_IF.\"DLV_TIME_24\" as \"DLV_TIME_24\", "
+"  T_SALESPLN_IF.\"DLV_TIME_25\" as \"DLV_TIME_25\", "
+"  T_SALESPLN_IF.\"DLV_TIME_26\" as \"DLV_TIME_26\", "
+"  T_SALESPLN_IF.\"DLV_TIME_27\" as \"DLV_TIME_27\", "
+"  T_SALESPLN_IF.\"DLV_TIME_28\" as \"DLV_TIME_28\", "
+"  T_SALESPLN_IF.\"DLV_TIME_29\" as \"DLV_TIME_29\", "
+"  T_SALESPLN_IF.\"DLV_TIME_30\" as \"DLV_TIME_30\", "
+"  T_SALESPLN_IF.\"DLV_TIME_31\" as \"DLV_TIME_31\", "
+"  T_SALESPLN_IF.\"PACKAGE_DLV_CD\" as \"PACKAGE_DLV_CD\", "
+"  T_SALESPLN_IF.\"SPEC\" as \"SPEC\", "
+"  T_SALESPLN_IF.\"BUYER_ORG_NAME\" as \"BUYER_ORG_NAME\", "
+"  T_SALESPLN_IF.\"DLV_PART_LEN_1\" as \"DLV_PART_LEN_1\", "
+"  T_SALESPLN_IF.\"DLV_PART_QTY_1\" as \"DLV_PART_QTY_1\", "
+"  T_SALESPLN_IF.\"DLV_PART_LEN_2\" as \"DLV_PART_LEN_2\", "
+"  T_SALESPLN_IF.\"DLV_PART_QTY_2\" as \"DLV_PART_QTY_2\", "
+"  T_SALESPLN_IF.\"DLV_PART_LEN_3\" as \"DLV_PART_LEN_3\", "
+"  T_SALESPLN_IF.\"DLV_PART_QTY_3\" as \"DLV_PART_QTY_3\", "
+"  T_SALESPLN_IF.\"DLV_PART_LEN_4\" as \"DLV_PART_LEN_4\", "
+"  T_SALESPLN_IF.\"DLV_PART_QTY_4\" as \"DLV_PART_QTY_4\", "
+"  T_SALESPLN_IF.\"DLV_PART_LEN_5\" as \"DLV_PART_LEN_5\", "
+"  T_SALESPLN_IF.\"DLV_PART_QTY_5\" as \"DLV_PART_QTY_5\", "
+"  T_SALESPLN_IF.\"DLV_PART_LEN_6\" as \"DLV_PART_LEN_6\", "
+"  T_SALESPLN_IF.\"DLV_PART_QTY_6\" as \"DLV_PART_QTY_6\", "
+"  T_SALESPLN_IF.\"DLV_PART_LEN_7\" as \"DLV_PART_LEN_7\", "
+"  T_SALESPLN_IF.\"DLV_PART_QTY_7\" as \"DLV_PART_QTY_7\", "
+"  T_SALESPLN_IF.\"DLV_PART_LEN_8\" as \"DLV_PART_LEN_8\", "
+"  T_SALESPLN_IF.\"DLV_PART_QTY_8\" as \"DLV_PART_QTY_8\", "
+"  T_SALESPLN_IF.\"DLV_PART_LEN_9\" as \"DLV_PART_LEN_9\", "
+"  T_SALESPLN_IF.\"DLV_PART_QTY_9\" as \"DLV_PART_QTY_9\", "
+"  T_SALESPLN_IF.\"DLV_PART_LEN_10\" as \"DLV_PART_LEN_10\", "
+"  T_SALESPLN_IF.\"DLV_PART_QTY_10\" as \"DLV_PART_QTY_10\", "
+"  T_SALESPLN_IF.\"DLV_PART_UNIT\" as \"DLV_PART_UNIT\", "
+"  T_SALESPLN_IF.\"CUST_CONSTRUCT_NAME\" as \"CUST_CONSTRUCT_NAME\", "
+"  T_SALESPLN_IF.\"MATERIAL_CD\" as \"MATERIAL_CD\", "
+"  T_SALESPLN_IF.\"MATERIAL_UNIT_PRICE\" as \"MATERIAL_UNIT_PRICE\", "
+"  T_SALESPLN_IF.\"MATERIAL_UNIT\" as \"MATERIAL_UNIT\", "
+"  T_SALESPLN_IF.\"TEST_REPORT_NEED_TYP\" as \"TEST_REPORT_NEED_TYP\", "
+"  T_SALESPLN_IF.\"TEST_REPORT_CHK_TYP\" as \"TEST_REPORT_CHK_TYP\", "
+"  T_SALESPLN_IF.\"TEST_REPORT_PRESENT_TYP\" as \"TEST_REPORT_PRESENT_TYP\", "
+"  T_SALESPLN_IF.\"MUNICIPAL_CD\" as \"MUNICIPAL_CD\", "
+"  T_SALESPLN_IF.\"DLV_CONTACT_TEL\" as \"DLV_CONTACT_TEL\", "
+"  T_SALESPLN_IF.\"SLIP_PRICE_PRINT_TYP\" as \"SLIP_PRICE_PRINT_TYP\", "
+"  T_SALESPLN_IF.\"BUYER_NAME_KANJI\" as \"BUYER_NAME_KANJI\", "
+"  T_SALESPLN_IF.\"SPEC_KANJI\" as \"SPEC_KANJI\", "
+"  T_SALESPLN_IF.\"ITEM_NAME_KANJI\" as \"ITEM_NAME_KANJI\", "
+"  T_SALESPLN_IF.\"REMARKS_KANJI\" as \"REMARKS_KANJI\", "
+"  T_SALESPLN_IF.\"END_USER_NAME_KANJI\" as \"END_USER_NAME_KANJI\", "
+"  T_SALESPLN_IF.\"DLV_ADDRESS_KANJI\" as \"DLV_ADDRESS_KANJI\", "
+"  T_SALESPLN_IF.\"DLV_ADDRESSEE_KANJI\" as \"DLV_ADDRESSEE_KANJI\", "
+"  T_SALESPLN_IF.\"END_USER_ITEM_NAME_KANJI\" as \"END_USER_ITEM_NAME_KANJI\", "
+"  T_SALESPLN_IF.\"CUST_DESINATED_MAKER_KANJI\" as \"CUST_DESINATED_MAKER_KANJI\", "
+"  T_SALESPLN_IF.\"DLV_LOC_NAME_KANJI\" as \"DLV_LOC_NAME_KANJI\", "
+"  T_SALESPLN_IF.\"CLIENT_REMARK_KANJI\" as \"CLIENT_REMARK_KANJI\", "
+"  T_SALESPLN_IF.\"MACHINE_TYPE_NAME_KANJI\" as \"MACHINE_TYPE_NAME_KANJI\", "
+"  T_SALESPLN_IF.\"CUST_SPC_KANJI\" as \"CUST_SPC_KANJI\", "
+"  T_SALESPLN_IF.\"BUYER_ORG_NAME_KANJI\" as \"BUYER_ORG_NAME_KANJI\", "
+"  T_SALESPLN_IF.\"CUST_CONSTRUCT_NAME_KANJI\" as \"CUST_CONSTRUCT_NAME_KANJI\", "
+"  T_SALESPLN_IF.\"CUR_CD\" as \"CUR_CD\", "
+"  T_SALESPLN_IF.\"UNIT_PRICE_EXCH_RATES\" as \"UNIT_PRICE_EXCH_RATES\", "
+"  T_SALESPLN_IF.\"ODR_AMOUNT_EXCH_RATES\" as \"ODR_AMOUNT_EXCH_RATES\", "
+"  T_SALESPLN_IF.\"TAX_AMOUNT_EXCH_RATES\" as \"TAX_AMOUNT_EXCH_RATES\", "
+"  T_SALESPLN_IF.\"TOTAL_AMOUNT_EXCH_RATES\" as \"TOTAL_AMOUNT_EXCH_RATES\", "
+"  T_SALESPLN_IF.\"UNCONFIRM_AMOUNT_EXCH_RATES\" as \"UNCONFIRM_AMOUNT_EXCH_RATES\", "
+"  T_SALESPLN_IF.\"MATERIAL_CD_EXCH_RATES\" as \"MATERIAL_CD_EXCH_RATES\", "
+"  T_SALESPLN_IF.\"PLANNING_ODR_CD\" as \"PLANNING_ODR_CD\", "
+"  T_SALESPLN_IF.\"PLANNING_ODR_DATE\" as \"PLANNING_ODR_DATE\", "
+"  T_SALESPLN_IF.\"STANDARD_DLV_TERM\" as \"STANDARD_DLV_TERM\", "
+"  T_SALESPLN_IF.\"REQUIRED_TERM\" as \"REQUIRED_TERM\" "
+"from "
+"  T_SALESPLN_IF "
+"where "
+"  T_SALESPLN_IF.\"SYSTEM_PROC_TYP\" = '0' "
+"  and T_SALESPLN_IF.\"DEL_FLG\" = '0' "
+"  and T_SALESPLN_IF.INFO_TYP_CD = '0201' "
+"order by "
+"  T_SALESPLN_IF.\"INFO_TYP_CD\", "
+"  T_SALESPLN_IF.\"ODR_INFO_IF_CTRL_NO\"";
