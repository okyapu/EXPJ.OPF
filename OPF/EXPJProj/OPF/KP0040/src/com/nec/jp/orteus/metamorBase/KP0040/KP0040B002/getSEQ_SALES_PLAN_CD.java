/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KP0040/src/com/nec/jp/orteus/metamorBase/KP0040/KP0040B002/getSEQ_SALES_PLAN_CD.java,v $
 *
...
/**
 * CLASS     : getSEQ_SALES_PLAN_CD クラス
 * ファイル・クラス説明
...
public class getSEQ_SALES_PLAN_CD extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				BatchAppException be=new BatchAppException("getSEQ_SALES_PLAN_CD", "read", "レコード検索条件設定処理失敗");
		...
		public String getSEQNUM_R() throws FoundationException { return m_doRs.getString(1); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setSALES_PLAN_CD(getSEQNUM_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("getSEQ_SALES_PLAN_CD", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("getSEQ_SALES_PLAN_CD", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	 ...
	 *
		 */
	public getSEQ_SALES_PLAN_CD(medKP0040B002 med, BatchAppConductor cdr) throws SystemException
	{
