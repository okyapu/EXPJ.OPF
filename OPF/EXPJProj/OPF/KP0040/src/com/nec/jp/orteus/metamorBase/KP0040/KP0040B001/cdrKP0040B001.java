/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KP0040/src/com/nec/jp/orteus/metamorBase/KP0040/KP0040B001/cdrKP0040B001.java,v $
 *
...
public class cdrKP0040B001 extends Object
		implements IBatchAppCommon
{
	...
	public void initialize() throws BatchAppException, SystemException
	{
		try {
			...
			m_med.setSEQ_ODR_INFO_IF_CTRL_NO( new SEQ_ODR_INFO_IF_CTRL_NO(m_med, m_conductor) );
			...
			m_conductor.addObject( m_med.getSEQ_ODR_INFO_IF_CTRL_NO() );
	...
	public int beginProc() throws BatchAppException
	{
		try {
			...
			setCommitFlag(false);
			BatchAppException be=new BatchAppException("cdrKP0040B001", "beginProc", "conductorの初期処理に失敗しました");
	...
	medKP0040B001 m_med=new medKP0040B001();

	// BatchAppConductorクラスインスタンス
	BatchAppConductor m_conductor=new BatchAppConductor("KP0040B001");
	...
	/**
	 * ctrKP0040B001クラス 標準コンストラクタ
	 *
		 */
	public cdrKP0040B001() throws BatchAppException
	{
		initialize();
