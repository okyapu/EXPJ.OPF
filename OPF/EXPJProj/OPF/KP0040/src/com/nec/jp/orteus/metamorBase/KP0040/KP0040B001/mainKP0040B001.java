/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KP0040/src/com/nec/jp/orteus/metamorBase/KP0040/KP0040B001/mainKP0040B001.java,v $
 *
...
/**
 * CLASS     : mainKP0040B001 クラス
 * ファイル・クラス説明
 * @author $Author: geng-jia $
 * @version $Revision: 1.14 $ $Date: 2015/12/03 08:53:22 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class mainKP0040B001
{
    // リターン値
	...
	public static void main(String args[])
	{
		...
		try {
			...
			if (sysLog == null) {
				...
				if(!sysLog.init("com.nec.jp.orteus.metamorBase.KP0040B001")) {
					//システムログの初期化に失敗しました
			...
			try {
				...
				// 標準出力ファイル名設定
				String logFileName = "KP0040B001.log";
				if (logFileName == null) {
				...
				// 新規作成のためバッチログファイル削除
				if (blogMode == false) {
					File logFile = new File(logOutputPath + "/KP0040B001.log");
				...
				System.setOut(new PrintStream(new FileOutputStream(logOutputPath + "/KP0040B001stdout.log", blogMode)));
				System.setErr(new PrintStream(new FileOutputStream(logOutputPath + "/KP0040B001stderr.log", blogMode)));
			...
			cdrKP0040B001 ebo = new cdrKP0040B001();
