/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KP0040/src/com/nec/jp/orteus/metamorBase/KP0040/KP0040B002/getITEMinfo.java,v $
 *
...
public class getITEMinfo extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN2_R(m_med.getCOMPANY_CD());
				setIN3_R(m_med.getCUST_CD());
				setIN4_R(m_med.getIN_CUST_ITEM_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("getITEMinfo", "read", "レコード検索条件設定処理失敗");
		...
		public String getCUST_ITEM_CD_R() throws FoundationException { return m_doRs.getString(1); }
		public String getMRP_ODR_TYP_R() throws FoundationException { return m_doRs.getString(2); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				BatchAppException be=new BatchAppException("getITEMinfo", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("getITEMinfo", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	 ...
	 *
		 */
	public getITEMinfo(medKP0040B002 med, BatchAppConductor cdr) throws SystemException
	{
