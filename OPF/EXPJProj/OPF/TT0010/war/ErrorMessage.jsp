...
致命的エラーメッセージ出力
$Source: D:/EXPJCVS/EXPJCORE/ejstudioV2/EXPJStudio/tools/framework/expjhtml5/EJmenu/ErrorMessage.jsp,v $
$Author: n-saito $	
...
<script type="text/javascript">
	function onInitializeOnLoad(){
		if(this.location.hash){
			var tmp = this.location.hash;

			tmp = tmp.slice(1,tmp.length);
			document.all("MSG").innerText = tmp;
		}
	}
</script>
