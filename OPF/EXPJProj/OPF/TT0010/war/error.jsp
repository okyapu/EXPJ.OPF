...
<!--          <input type="button" name="submit" value="<%=CoreTools.getRBString("Orteus.Common.N00023", rb)%>" onClick="history.back()"> -->
      <% // EJ CHANGE 1line %>
      <div style="padding-bottom:0px;"><button type="button" onclick="delPage();"><%=CoreTools.getRBString("Orteus.Common.N00001", rb)%></button></div>
...
<hr>
  <table width="100%" align="left" height="8">
    <tr>
      ...
      <td width="87%" height="19"><i> <a href="errorDetail.jsp" target="_blank"> 
        <%
	...
	if(e==null) {
		...
		out.print(TypeConverter.sanitizer(e.toString()));
	}
%>
        </a> </i></td>
    </tr>
