/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DD0010/src/com/nec/jp/orteus/metamorBase/DD0010/DD0010020Entity.java,v $
 *
...
public class DD0010020Entity extends DataObject
{
...
+"";		//////////////////////////////
	...
	public class ei_CSVOut extends DataObject
	{
		...
		String m_write_fname="DD0010020.csv";

		protected WriteCsv m_writer=null;		// csv書込み用

		String m_ProjName="DD0010020";
...
+"  and T_ITEM_COST.COST_EXCLUDE_FLG = 0";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, DD0010020Struct data) throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, DD0010020Struct data, String replaceStr)
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, DD0010020Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, DD0010020Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, DD0010020Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, DD0010020Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(PreparedStatement stmt, DD0010020Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public PreparedStatement prepare(Connection conn, String query, DD0010020Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt;
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public ResultSet executeQuery(PreparedStatement stmt, DD0010020Struct data) throws FoundationException, SQLException
		{
			int no=1;
		 ...
		 * レコードデータをStructに格納して返します
		 */
		public DD0010020Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			if(rs.next()==false) return null;

			DD0010020Struct data = new DD0010020Struct();

			data.setTOTAL_MATR_COST( getString(1, rs) );
			data.setTOTAL_SBCNT_MATR_COST( getString(2, rs) );
			data.setTOTAL_PROC_COST_SUM_ALL( getString(3, rs) );
			data.setTOTAL_COST( getString(4, rs) );
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(IDbConnection conn, DD0010020Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(Connection conn, DD0010020Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(IDbConnection conn, DD0010020Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(Connection conn, DD0010020Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(PreparedStatement stmt, DD0010020Struct data) throws FoundationException, SQLException
		{
			ResultSet rs=executeQuery(stmt, data);
			boolean ret=true;
...
+"";
		...
		public DD0010020Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setl_PARENT_ITEM_CD( getString(3, rs) );
			data.setl_OUTSIDE_TYP_DN( getString(4, rs) );
			data.setl_PROC_OUTSIDE_TYP_DN( getString(5, rs) );
			data.setl_CLASIFICATION_CD( getString(6, rs) );
			data.setl_CS_PROC_CD( getString(7, rs) );
			data.setl_CS_PROC_NAME( getString(8, rs) );
			data.setl_NECESSARY_QTY( getString(9, rs) );
			data.setl_STOCK_UNIT( getString(10, rs) );
			data.setl_HOME_CUR_UNIT( getString(11, rs) );
			data.setl_OWN_MATR_COST( getString(12, rs) );
			data.setl_TOTAL_MATR_COST( getString(13, rs) );
			data.setl_OWN_SBCNT_MATR_COST( getString(14, rs) );
			data.setl_TOTAL_SBCNT_MATR_COST( getString(15, rs) );
			data.setl_OWN_PROC_COST_SUM_ALL( getString(16, rs) );
			data.setl_TOTAL_PROC_COST_SUM_ALL( getString(17, rs) );
...
+"  and M_HOME_CUR.CUR_CD = SYS_HOME_CUR.HOME_CUR_CD";
	 ...
	 */
	public DD0010020Entity() throws FoundationException
	{
