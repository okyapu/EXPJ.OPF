...
public class DD0010010Servlet extends HttpServlet
{
	 ...
	 * @param control DD0010010Controlクラスインスタンス
	 */
...
//			e.printStackTrace();
					...
					DD0010010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		//{{user_implement_dev:<reloadEvent>
              ...
              //			e.printStackTrace();
              //			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("DD0010010-E999","リロード処理"));
                 ExpjException ee = new ExpjException(e, "ZZ01106");
                 throw ee;
                }
                //}}user_implement_dev:<reloadEvent>
	...
	public String onClickAddTree(
					...
					DD0010010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = "/DD0010010Control.jsp";		// 移動先ＵＲＬ
		DD0010010Entity entity = control.entity;
		DD0010010Struct struct = control.struct;
		getSessionParameters(so, params, struct);
	...
	public String onClickShowDetail(
					...
					DD0010010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = "/DD0010010Detail.jsp";		// 移動先ＵＲＬ
		DD0010010Entity entity = control.entity;
		DD0010010Struct struct = control.struct;
		getSessionParameters(so, params, struct);
...
//			e.printStackTrace();
	...
	public static String DEFAULT_TARGET = "/DD0010010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aDD0010010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aDD0010010Struct";   // JSP先のバインド名(Struct)の指定
