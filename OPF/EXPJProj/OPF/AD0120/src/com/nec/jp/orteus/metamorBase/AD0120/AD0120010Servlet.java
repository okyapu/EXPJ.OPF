...
public class AD0120010Servlet extends HttpServlet
{
	 ...
	 * @param control AD0120010Controlクラスインスタンス
	 */
...
//			e.printStackTrace();
//			LogWriter.write(Level.ALL, objMessage.getIDMsg("AD0120010-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
		}
                //}}user_implement_dev:<reloadEvent>
	...
	{
		String nextUrl = "/AD0120010.jsp";		// 移動先ＵＲＬ
		AD0120010Entity entity = control.entity;
		AD0120010Struct struct = control.struct;
		getSessionParameters(so, params, struct);
...
//			e.printStackTrace();
	...
	public static String DEFAULT_TARGET = "/AD0120010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAD0120010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAD0120010Struct";   // JSP先のバインド名(Struct)の指定
