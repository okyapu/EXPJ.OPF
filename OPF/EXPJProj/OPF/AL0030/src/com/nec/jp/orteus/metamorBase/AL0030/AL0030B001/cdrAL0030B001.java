/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AL0030/src/com/nec/jp/orteus/metamorBase/AL0030/AL0030B001/cdrAL0030B001.java,v $
 *
...
public class cdrAL0030B001 extends Object
		implements IBatchAppCommon
{
	...
	public void initialize() throws BatchAppException, SystemException
	{
		try {
			...
			m_med.setcallSqlLoadPsMake( new callSqlLoadPsMake(m_med, m_conductor) );
			m_med.setCtrlMain( new CtrlMain(m_med, m_conductor) );
			m_conductor.addObject( m_med.getreadSysBatParm() );
			m_conductor.addObject( m_med.getcallSqlLoadPsMake() );
	...
	public int getType() { return m_conductor.getType(); }
        ...
        public int beginProc() throws BatchAppException
        {
         try {
          ...
          setCommitFlag(false);
          BatchAppException be=new BatchAppException("cdrAL0030B001", "beginProc", "conductorの初期処理に失敗しました");
	...
	medAL0030B001 m_med=new medAL0030B001();

	// BatchAppConductorクラスインスタンス
	BatchAppConductor m_conductor=new BatchAppConductor("AL0030B001");
	...
	/**
	 * ctrAL0030B001クラス 標準コンストラクタ
	 *
		 */
	public cdrAL0030B001() throws BatchAppException
	{
		initialize();
