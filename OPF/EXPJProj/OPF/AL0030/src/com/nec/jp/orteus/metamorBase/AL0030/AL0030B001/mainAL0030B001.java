/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AL0030/src/com/nec/jp/orteus/metamorBase/AL0030/AL0030B001/mainAL0030B001.java,v $
 *
	...
	public static void main(String args[])
	{
		...
		try {
			...
			if (sysLog == null) {
				...
				if(!sysLog.init("com.nec.jp.orteus.metamorBase.AL0030B001")) {
					//システムログの初期化に失敗しました
			...
			try {
				...
				// 標準出力ファイル名設定
				String logFileName = "AL0030B001.log";
				if (logFileName == null) {
				...
				// 新規作成のためバッチログファイル削除
				if (blogMode == false) {
					File logFile = new File(logOutputPath + "/AL0030B001.log");
				...
				System.setOut(new PrintStream(new FileOutputStream(logOutputPath + "/AL0030B001stdout.log", blogMode)));
				System.setErr(new PrintStream(new FileOutputStream(logOutputPath + "/AL0030B001stderr.log", blogMode)));
			...
			cdrAL0030B001 ebo = new cdrAL0030B001();
