/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AL0030/src/com/nec/jp/orteus/metamorBase/AL0030/AL0030B001/medAL0030B001.java,v $
 *
...
public class medAL0030B001 extends Object
{
	...
	/**
	 * callSqlLoadPsMake entity インスタンスを格納します
	 */
	 ...
	 * プログラム名を格納します。
	 */
	protected String m_Progname="AL0030B001";
	...
	public AbstractBatchAppEntity getcallSqlLoadPsMake() { return m_entity1; }
	public void setcallSqlLoadPsMake(AbstractBatchAppEntity obj) { m_entity1 = obj; }
	...
	/**
	 * medAL0030B001クラスの標準コンストラクタ
	 *
		 */
	public medAL0030B001()
	{
		// mediator変数を初期化します
		m_PROGRAM_CD = null;
