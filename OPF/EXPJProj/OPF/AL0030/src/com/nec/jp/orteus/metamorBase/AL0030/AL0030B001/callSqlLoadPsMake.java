/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AL0030/src/com/nec/jp/orteus/metamorBase/AL0030/AL0030B001/callSqlLoadPsMake.java,v $
 *
...
public class callSqlLoadPsMake extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public List call() throws BatchAppException
		{
			try {
				...
				e.printStackTrace();
				BatchAppException be=new BatchAppException("callSqlLoadPsMake", "call", "Stored Procedure条件設定処理失敗");
				...
				if (cstmt != null) {
					try {
						...
						ef.printStackTrace();
						BatchAppException bef = new BatchAppException("callSqlLoadPsMake", "call", "Stored Procedureクローズ処理失敗");
		 ...
		 */
		public medAL0030B001 call(ResultSet rs) throws SQLException
		{
			if(rs == null || rs.next()==false) return null;
			medAL0030B001 data = new medAL0030B001();
			return data;
		}
	...
	/**
	 * callSqlLoadPsMakeクラスの標準コンストラクタ
	 *
		 */
	public callSqlLoadPsMake(medAL0030B001 med, BatchAppConductor cdr) throws SystemException
	{
	...
	protected static String m_calcmd = "{" + "call SqlLoadPsMake(?, ?, ?, ?, ?, ?, ?)" + "}";
