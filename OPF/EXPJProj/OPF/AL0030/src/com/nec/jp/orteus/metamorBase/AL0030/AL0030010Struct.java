/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AL0030/src/com/nec/jp/orteus/metamorBase/AL0030/AL0030010Struct.java,v $
 *
...
public class AL0030010Struct extends DataStruct
{

	//////////////////////////////

	/** 第 1 変数： m_UPDATED_DATE */
	...
	/** 第 1 List変数： l_UPDATED_DATE */
	public List l_UPDATED_DATE = null;

	/** 第 2 List変数： l_h_PLANT_CD */
	...
	public int setL2L_UPDATED_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_UPDATED_DATE.add(((AL0030010Struct) list.get(i)).getUPDATED_DATE());
		}
		return size;
	}
	public int setL2L_h_PLANT_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_h_PLANT_CD.add(((AL0030010Struct) list.get(i)).geth_PLANT_CD());
		}
		return size;
	}
	...
	/**
	 * medAL0030010クラスの標準コンストラクタ
	 */
	public AL0030010Struct()
	{
	 ...
	 */
	public void setStruct(AL0030010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructM(AL0030010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructL(AL0030010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
...
/*
	// 第 1 変数初期値： i_UPDATED_DATE


	final static String i_UPDATED_DATE = null;

	// 第 2 変数初期値： i_h_PLANT_CD
