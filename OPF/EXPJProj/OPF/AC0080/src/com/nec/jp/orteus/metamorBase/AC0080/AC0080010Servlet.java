/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AC0080/src/com/nec/jp/orteus/metamorBase/AC0080/AC0080010Servlet.java,v $
 *
...
public class AC0080010Servlet extends HttpServlet
{
	 ...
	 * @param control AC0080010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AC0080010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AC0080010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AC0080010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AC0080010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AC0080010Entity entity = control.entity;
		AC0080010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AC0080010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
                          objMessage.m_writer.write( Level.ALL, "AC0080010"+" $Revision: 1.7 $" );
                          control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AC0080010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AC0080010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AC0080010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AC0080");
		logger.entering("AC0080010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
		...
		//{{user_implement_dev:<reloadEvent>
                ...
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AC0080010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickselect(
					...
					HttpSession so,
					Hashtable params,
					AC0080010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AC0080010Entity entity = control.entity;
		AC0080010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AC0080");
		logger.entering("AC0080010Servlet"+":USER="+request.getRemoteUser(),"onClickselect");
		//{{user_implement_dev:<onClickselect>
                      //------------------------------------------------------------------------------
                      try {
              
                       // コンボボックスの値を設定
                       struct.seth_ODR_DMD_TYP(struct.getw_OD_TYP());
                    
                       // チェックボックスの値を設定
                    if(struct.getc_UN_CONNECT_DEMAND().equals("true"))
                    {
                     struct.seth_DEMAND_FLG("1");
                    }
                    else
                    {
                     struct.seth_DEMAND_FLG("0");
                       }
                 ...
                 throw ee;
                      ...
                      //------------------------------------------------------------------------------
                //}}user_implement_dev:<onClickselect>
		logger.exiting("AC0080010Servlet"+":USER="+request.getRemoteUser(),"onClickselect");
					...
					AC0080010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AC0080");
		logger.entering("AC0080010Servlet"+":USER="+request.getRemoteUser(),"onClickcsv");
		//{{user_implement_dev:<onClickcsv>
                 ...
                 throw ee;
                      ...
                      //------------------------------------------------------------------------------
                //}}user_implement_dev:<onClickcsv>
		logger.exiting("AC0080010Servlet"+":USER="+request.getRemoteUser(),"onClickcsv");
					...
					AC0080010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AC0080");
		logger.entering("AC0080010Servlet"+":USER="+request.getRemoteUser(),"onClickclear");
		//{{user_implement_dev:<onClickclear>
                 ...
                 throw ee;
                      ...
                      //------------------------------------------------------------------------------
                //}}user_implement_dev:<onClickclear>
		logger.exiting("AC0080010Servlet"+":USER="+request.getRemoteUser(),"onClickclear");
					...
					AC0080010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AC0080");
		logger.entering("AC0080010Servlet"+":USER="+request.getRemoteUser(),"onClickdelete");
		//{{user_implement_dev:<onClickdelete>
                 ...
                 throw ee;
                      ...
                      //------------------------------------------------------------------
                //}}user_implement_dev:<onClickdelete>
		logger.exiting("AC0080010Servlet"+":USER="+request.getRemoteUser(),"onClickdelete");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AC0080010Struct struct)
	{
		...
		String[] h_DEMAND_FLG = ((params.containsKey("h_DEMAND_FLG")) ? (String[])params.get("h_DEMAND_FLG") : (String[])null);
		String[] ODR_DM_QTY = ((params.containsKey("ODR_DM_QTY")) ? (String[])params.get("ODR_DM_QTY") : (String[])null);
		String[] PRD_DUE_DATE = ((params.containsKey("PRD_DUE_DATE")) ? (String[])params.get("PRD_DUE_DATE") : (String[])null);
		String[] h_ODR_DMD_TYP = ((params.containsKey("h_ODR_DMD_TYP")) ? (String[])params.get("h_ODR_DMD_TYP") : (String[])null);
		String[] w_STS_TYP = ((params.containsKey("w_STS_TYP")) ? (String[])params.get("w_STS_TYP") : (String[])null);
		String[] c_UN_CONNECT_DEMAND = ((params.containsKey("c_UN_CONNECT_DEMAND")) ? (String[])params.get("c_UN_CONNECT_DEMAND") : (String[])null);
		String[] DOWNLOAD_FILE = ((params.containsKey("DOWNLOAD_FILE")) ? (String[])params.get("DOWNLOAD_FILE") : (String[])null);
		String[] EX_MODIFY_COUNT = ((params.containsKey("EX_MODIFY_COUNT")) ? (String[])params.get("EX_MODIFY_COUNT") : (String[])null);
		...
		struct.seth_DEMAND_FLG( ((h_DEMAND_FLG == null) ? (String)null : h_DEMAND_FLG[0]) );
		struct.setList_h_DEMAND_FLG(TypeConverter.convert(h_DEMAND_FLG));
		struct.setODR_DM_QTY( ((ODR_DM_QTY == null) ? (String)null : ODR_DM_QTY[0]) );
		struct.setList_ODR_DM_QTY(TypeConverter.convert(ODR_DM_QTY));
		...
		struct.seth_ODR_DMD_TYP( ((h_ODR_DMD_TYP == null) ? (String)null : h_ODR_DMD_TYP[0]) );
		struct.setList_h_ODR_DMD_TYP(TypeConverter.convert(h_ODR_DMD_TYP));
		struct.setw_STS_TYP( ((w_STS_TYP == null) ? (String)null : w_STS_TYP[0]) );
		struct.setList_w_STS_TYP(TypeConverter.convert(w_STS_TYP));
		struct.setc_UN_CONNECT_DEMAND( ((c_UN_CONNECT_DEMAND == null) ? (String)null : c_UN_CONNECT_DEMAND[0]) );
		struct.setList_c_UN_CONNECT_DEMAND(TypeConverter.convert(c_UN_CONNECT_DEMAND));
		...
		struct.setEX_MODIFY_COUNT( ((EX_MODIFY_COUNT == null) ? (String)null : EX_MODIFY_COUNT[0]) );
		struct.setList_EX_MODIFY_COUNT(TypeConverter.convert(EX_MODIFY_COUNT));
	...
	public static String DEFAULT_TARGET = "/AC0080010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAC0080010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAC0080010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AC0080");
		logger.entering("AC0080010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
              
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AC0080010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AC0080010Control control;
		AC0080010Entity  entity = null;
		AC0080010Struct  struct = null;
		...
		try {
			...
			if( (control = (AC0080010Control)so.getAttribute("AC0080010Control_"+request.getSession(false).getId())) == null ) {
				control = new AC0080010Control();
			...
			try {
				...
				so.setAttribute("AC0080010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.AC0080.AC0080010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AC0080010Servlet()
	{
		//{{user_implement_dev:<AC0080010_DisConnect_FLG>
		...
		//{{user_implement_dev:<AC0080010Servlet>
