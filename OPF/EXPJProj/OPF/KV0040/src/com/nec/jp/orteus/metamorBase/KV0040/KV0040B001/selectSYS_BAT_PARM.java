/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KV0040/src/com/nec/jp/orteus/metamorBase/KV0040/KV0040B001/selectSYS_BAT_PARM.java,v $
 *
...
public class selectSYS_BAT_PARM extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN4_R(m_med.getPROGRAM_CD());
				setIN5_R(m_med.getFUNCTION_NAME());
		...
		public String getFILE_PATH_R() throws FoundationException { return m_doRs.getString(1); }
		public String getFILE_NAME_R() throws FoundationException { return m_doRs.getString(2); }
		public String getLOG_MODE_TYP_R() throws FoundationException { return m_doRs.getString(3); }
		public String getOUTPUT_MODE_TYP_R() throws FoundationException { return m_doRs.getString(4); }
	 ...
	 *
		 */
	public selectSYS_BAT_PARM(medKV0040B001 med, BatchAppConductor cdr) throws SystemException
	{
