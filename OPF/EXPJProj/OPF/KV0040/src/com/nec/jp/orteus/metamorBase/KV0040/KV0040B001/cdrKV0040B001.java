/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KV0040/src/com/nec/jp/orteus/metamorBase/KV0040/KV0040B001/cdrKV0040B001.java,v $
 *
...
public class cdrKV0040B001 extends Object
		implements IBatchAppCommon
{
	...
	public void initialize() throws BatchAppException, SystemException
	{
		try {
			...
			m_med.setcallSQL( new callSQL(m_med, m_conductor) );
			...
			m_conductor.addObject( m_med.getcallSQL() );
	...
	public int beginProc() throws BatchAppException
	{
		try {
			...
			setCommitFlag(false);
			BatchAppException be=new BatchAppException("cdrKV0040B001", "beginProc", "conductorの初期処理に失敗しました");
	...
	medKV0040B001 m_med=new medKV0040B001();

	// BatchAppConductorクラスインスタンス
	BatchAppConductor m_conductor=new BatchAppConductor("KV0040B001");
	...
	/**
	 * ctrKV0040B001クラス 標準コンストラクタ
	 *
		 */
	public cdrKV0040B001() throws BatchAppException
	{
		initialize();
