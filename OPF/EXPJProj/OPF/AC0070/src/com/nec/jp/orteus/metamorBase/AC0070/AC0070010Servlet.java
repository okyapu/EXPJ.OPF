/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AC0070/src/com/nec/jp/orteus/metamorBase/AC0070/AC0070010Servlet.java,v $
 *
...
public class AC0070010Servlet extends HttpServlet
{
	 ...
	 * @param control AC0070010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AC0070010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AC0070010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AC0070010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AC0070010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AC0070010Entity entity = control.entity;
		AC0070010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AC0070010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
                 objMessage.m_writer.write( Level.ALL, "AC0070010"+" $Revision: 1.5 $" );
                 control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AC0070010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AC0070010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AC0070010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AC0070");
		logger.entering("AC0070010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
		...
		//{{user_implement_dev:<reloadEvent>
                ...
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AC0070010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickselect(
					...
					HttpSession so,
					Hashtable params,
					AC0070010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AC0070010Entity entity = control.entity;
		AC0070010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AC0070");
		logger.entering("AC0070010Servlet"+":USER="+request.getRemoteUser(),"onClickselect");
		//{{user_implement_dev:<onClickselect>
                ...
                //}}user_implement_dev:<onClickselect>
		logger.exiting("AC0070010Servlet"+":USER="+request.getRemoteUser(),"onClickselect");
					...
					AC0070010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AC0070");
		logger.entering("AC0070010Servlet"+":USER="+request.getRemoteUser(),"onClickclear");
		//{{user_implement_dev:<onClickclear>
                ...
                //}}user_implement_dev:<onClickclear>
		logger.exiting("AC0070010Servlet"+":USER="+request.getRemoteUser(),"onClickclear");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AC0070010Struct struct)
	{
		String locale = (String) so.getAttribute("LOCALE");
		
		String[] w_PLAN_CD = ((params.containsKey("w_PLAN_CD")) ? (String[])params.get("w_PLAN_CD") : (String[])null);
		...
		String[] EXTERNAL_LEVEL_NO = ((params.containsKey("EXTERNAL_LEVEL_NO")) ? (String[])params.get("EXTERNAL_LEVEL_NO") : (String[])null);
		String[] ODR_STS_NAME = ((params.containsKey("ODR_STS_NAME")) ? (String[])params.get("ODR_STS_NAME") : (String[])null);
		String[] EXTERNAL_PLAN_DEL_NAME = ((params.containsKey("EXTERNAL_PLAN_DEL_NAME")) ? (String[])params.get("EXTERNAL_PLAN_DEL_NAME") : (String[])null);
		...
		struct.setw_PLAN_CD( ((w_PLAN_CD == null) ? (String)null : w_PLAN_CD[0]) );
		struct.setList_w_PLAN_CD(TypeConverter.convert(w_PLAN_CD));
		...
		struct.setEXTERNAL_LEVEL_NO( ((EXTERNAL_LEVEL_NO == null) ? (String)null : EXTERNAL_LEVEL_NO[0]) );
		struct.setList_EXTERNAL_LEVEL_NO(TypeConverter.convert(EXTERNAL_LEVEL_NO));
		struct.setODR_STS_NAME( ((ODR_STS_NAME == null) ? (String)null : ODR_STS_NAME[0]) );
		struct.setList_ODR_STS_NAME(TypeConverter.convert(ODR_STS_NAME));
		struct.setEXTERNAL_PLAN_DEL_NAME( ((EXTERNAL_PLAN_DEL_NAME == null) ? (String)null : EXTERNAL_PLAN_DEL_NAME[0]) );
		struct.setList_EXTERNAL_PLAN_DEL_NAME(TypeConverter.convert(EXTERNAL_PLAN_DEL_NAME));
	...
	public static String DEFAULT_TARGET = "/AC0070010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAC0070010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAC0070010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AC0070");
		logger.entering("AC0070010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
                 
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AC0070010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AC0070010Control control;
		AC0070010Entity  entity = null;
		AC0070010Struct  struct = null;
		...
		try {
			...
			if( (control = (AC0070010Control)so.getAttribute("AC0070010Control_"+request.getSession(false).getId())) == null ) {
				control = new AC0070010Control();
			...
			try {
				...
				so.setAttribute("AC0070010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.AC0070.AC0070010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AC0070010Servlet()
	{
		//{{user_implement_dev:<AC0070010_DisConnect_FLG>
		...
		//{{user_implement_dev:<AC0070010Servlet>
                //}}user_implement_dev:<AC0070010Servlet>
	}
