/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AA0210/src/com/nec/jp/orteus/metamorBase/AA0210/AA0210010Servlet.java,v $
 *
...
public class AA0210010Servlet extends HttpServlet
{
	 ...
	 * @param control AA0210010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AA0210010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AA0210010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AA0210010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AA0210010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AA0210010Entity entity = control.entity;
		AA0210010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AA0210010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
			// TODO: ユーザ定義のコードを記述してください
//			LogWriter.write( Level.ALL, "AA0210010"+" $Revision: 1.1 $" );
			control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AA0210010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AA0210010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AA0210010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0210");
		logger.entering("AA0210010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
...
//			e.printStackTrace();
//			LogWriter.write(Level.ALL, objMessage.getIDMsg("AA0210010-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
		}
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AA0210010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickCsvImport(
					...
					HttpSession so,
					Hashtable params,
					AA0210010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = "/AA0210011.jsp";		// 移動先ＵＲＬ
		AA0210010Entity entity = control.entity;
		AA0210010Struct struct = control.struct;
		getSessionParameters(so, params, struct);

		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0210");
		logger.entering("AA0210010Servlet"+":USER="+request.getRemoteUser(),"onClickCsvImport");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickCsvImport>
		logger.exiting("AA0210010Servlet"+":USER="+request.getRemoteUser(),"onClickCsvImport");
					...
					AA0210010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0210");
		logger.entering("AA0210010Servlet"+":USER="+request.getRemoteUser(),"onClickBrowse");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickBrowse>
		logger.exiting("AA0210010Servlet"+":USER="+request.getRemoteUser(),"onClickBrowse");
					...
					AA0210010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0210");
		logger.entering("AA0210010Servlet"+":USER="+request.getRemoteUser(),"onClickCsvIn");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickCsvIn>
		logger.exiting("AA0210010Servlet"+":USER="+request.getRemoteUser(),"onClickCsvIn");
					...
					AA0210010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0210");
		logger.entering("AA0210010Servlet"+":USER="+request.getRemoteUser(),"onClickCsvOut");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickCsvOut>
		logger.exiting("AA0210010Servlet"+":USER="+request.getRemoteUser(),"onClickCsvOut");
					...
					AA0210010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0210");
		logger.entering("AA0210010Servlet"+":USER="+request.getRemoteUser(),"onClickreturn_sub1");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickreturn_sub1>
		logger.exiting("AA0210010Servlet"+":USER="+request.getRemoteUser(),"onClickreturn_sub1");
					...
					AA0210010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0210");
		logger.entering("AA0210010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("AA0210010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
					...
					AA0210010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0210");
		logger.entering("AA0210010Servlet"+":USER="+request.getRemoteUser(),"onClickClose");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClose>
		logger.exiting("AA0210010Servlet"+":USER="+request.getRemoteUser(),"onClickClose");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AA0210010Struct struct)
	{
		...
		String[] l_ERR_ADR = ((params.containsKey("l_ERR_ADR")) ? (String[])params.get("l_ERR_ADR") : (String[])null);
		...
		String[] l_ERROR_FIELD_NAME = ((params.containsKey("l_ERROR_FIELD_NAME")) ? (String[])params.get("l_ERROR_FIELD_NAME") : (String[])null);
		String[] l_ERR_TEXT = ((params.containsKey("l_ERR_TEXT")) ? (String[])params.get("l_ERR_TEXT") : (String[])null);
		...
		struct.setl_ERR_ADR( ((l_ERR_ADR == null) ? (String)null : l_ERR_ADR[0]) );
		struct.setList_l_ERR_ADR(TypeConverter.convert(l_ERR_ADR));
		...
		struct.setl_ERROR_FIELD_NAME( ((l_ERROR_FIELD_NAME == null) ? (String)null : l_ERROR_FIELD_NAME[0]) );
		struct.setList_l_ERROR_FIELD_NAME(TypeConverter.convert(l_ERROR_FIELD_NAME));
		struct.setl_ERR_TEXT( ((l_ERR_TEXT == null) ? (String)null : l_ERR_TEXT[0]) );
		struct.setList_l_ERR_TEXT(TypeConverter.convert(l_ERR_TEXT));
	...
	public static String DEFAULT_TARGET = "/AA0210010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAA0210010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAA0210010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0210");
		logger.entering("AA0210010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AA0210010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AA0210010Control control;
		AA0210010Entity  entity = null;
		AA0210010Struct  struct = null;
		...
		try {
			...
			if( (control = (AA0210010Control)so.getAttribute("AA0210010Control_"+request.getSession(false).getId())) == null ) {
				control = new AA0210010Control();
			...
			try {
				...
				so.setAttribute("AA0210010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.AA0210.AA0210010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AA0210010Servlet()
	{
		//{{user_implement_dev:<AA0210010_DisConnect_FLG>
		...
		//{{user_implement_dev:<AA0210010Servlet>
