/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AA0210/src/com/nec/jp/orteus/metamorBase/AA0210/AA0210010Entity.java,v $
 *
...
public class AA0210010Entity extends DataObject
{
	...
	// selectCurCdクラス インスタンス
	public selectCurCd mselectCurCd = new selectCurCd();

	// checkVEND_CTRLクラス インスタンス
	public checkVEND_CTRL mcheckVEND_CTRL = new checkVEND_CTRL();
...
+"";		//////////////////////////////
	...
	public class ei_CSVOut extends DataObject
	{
		...
		String m_write_fname="AA0210010.csv";

		protected WriteCsv m_writer=null;		// csv書込み用

		String m_ProjName="AA0210010";
...
+"  AND VEND_CD = ?";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AA0210010Struct data) throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AA0210010Struct data, String replaceStr)
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AA0210010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AA0210010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AA0210010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AA0210010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(PreparedStatement stmt, AA0210010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public PreparedStatement prepare(Connection conn, String query, AA0210010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt;
			...
			try {
				...
				ary.addElement(data.getOUT_VEND_CD());
				if(isNull(data.getOUT_VEND_CD())) isNull = true;
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public ResultSet executeQuery(PreparedStatement stmt, AA0210010Struct data) throws FoundationException, SQLException
		{
			int no=1;
			...
			// 静的SQL文の生成
			setString(no ++, data.getOUT_VEND_CD(), stmt);
		 ...
		 * レコードデータをStructに格納して返します
		 */
		public AA0210010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			if(rs.next()==false) return null;

			AA0210010Struct data = new AA0210010Struct();

			data.setl_VEND_NAME( getString(1, rs) );
			data.setl_VEND_ANAME( getString(2, rs) );
			data.setl_VEND_KNAME( getString(3, rs) );
			data.setl_ZIP_CD( getString(4, rs) );
			data.setl_ADDRESS_1( getString(5, rs) );
			data.setl_ADDRESS_2( getString(6, rs) );
			data.setl_ADDRESS_K_1( getString(7, rs) );
			data.setl_ADDRESS_K_2( getString(8, rs) );
			data.setl_TEL( getString(9, rs) );
			data.setl_FAX( getString(10, rs) );
			data.setl_EMAIL( getString(11, rs) );
			data.setl_VEND_ORG( getString(12, rs) );
			data.setl_VEND_PERSON( getString(13, rs) );
			data.setl_OWN_ORG_CD( getString(14, rs) );
			data.setl_OWN_ORG_NAME( getString(15, rs) );
			data.setl_OWN_PERSON_CD( getString(16, rs) );
			data.setl_OWN_PERSON_NAME( getString(17, rs) );
			data.setl_ROUND_TYP( getString(18, rs) );
			data.setl_TAX_CD( getString(19, rs) );
			data.setl_TAX_APPLY_TYP( getString(20, rs) );
			data.setl_TAX_CALC_TYP( getString(21, rs) );
			data.setl_INSPC_ACPT_APP_TYP( getString(22, rs) );
			data.setl_ODR_FORM_FLG( getString(23, rs) );
			data.setl_ODR_EDI_FLG( getString(24, rs) );
			data.setl_VEND_REM( getString(25, rs) );
			data.setl_CUR_CD( getString(26, rs) );
			data.setl_EXCH_TYP( getString(27, rs) );
			data.setl_IMPORT_TRN_TYP( getString(28, rs) );
			data.setl_UNIT_COST_RETROACTION_FLG( getString(29, rs) );
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(IDbConnection conn, AA0210010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(Connection conn, AA0210010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(IDbConnection conn, AA0210010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(Connection conn, AA0210010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(PreparedStatement stmt, AA0210010Struct data) throws FoundationException, SQLException
		{
			ResultSet rs=executeQuery(stmt, data);
			boolean ret=true;
...
+"  M_VEND_CTRL(COMPANY_CD, VEND_CD, VEND_NAME, VEND_ANAME, VEND_KNAME, ZIP_CD, ADDRESS_1, ADDRESS_2, ADDRESS_K_1, ADDRESS_K_2, TEL, FAX, EMAIL, VEND_ORG, VEND_PERSON, OWN_ORG_CD, OWN_ORG_NAME, OWN_PERSON_CD, OWN_PERSON_NAME, ROUND_TYP, TAX_CD, TAX_APPLY_TYP, TAX_CALC_TYP, INSPC_ACPT_APP_TYP, ODR_FORM_FLG, ODR_EDI_FLG, VEND_REM, CUR_CD, EXCH_TYP, IMPORT_TRN_TYP, UNIT_COST_RETROACTION_FLG) "
+"VALUES "
+"  (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, TO_NUMBER(?), ?, TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), ?, ?, TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?))";
		protected String m_updcmd = null;
		protected String m_delcmd = null;
		protected String m_spcmd = null;

		protected String m_sCreateProgramName="AA0210010";
		protected String m_sUpdateProgramName="AA0210010";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int create(IDbConnection conn, AA0210010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int create(Connection conn, AA0210010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt=null;
			...
			try {
				...
				setString(7, data.getl_COMPANY_CD(), stmt);
				setString(8, data.getOUT_VEND_CD(), stmt);
				setString(9, data.getl_VEND_NAME(), stmt);
				setString(10, data.getl_VEND_ANAME(), stmt);
				setString(11, data.getl_VEND_KNAME(), stmt);
				setString(12, data.getl_ZIP_CD(), stmt);
				setString(13, data.getl_ADDRESS_1(), stmt);
				setString(14, data.getl_ADDRESS_2(), stmt);
				setString(15, data.getl_ADDRESS_K_1(), stmt);
				setString(16, data.getl_ADDRESS_K_2(), stmt);
				setString(17, data.getl_TEL(), stmt);
				setString(18, data.getl_FAX(), stmt);
				setString(19, data.getl_EMAIL(), stmt);
				setString(20, data.getl_VEND_ORG(), stmt);
				setString(21, data.getl_VEND_PERSON(), stmt);
				setString(22, data.getl_OWN_ORG_CD(), stmt);
				setString(23, data.getl_OWN_ORG_NAME(), stmt);
				setString(24, data.getl_OWN_PERSON_CD(), stmt);
				setString(25, data.getl_OWN_PERSON_NAME(), stmt);
				setString(26, data.getl_ROUND_TYP(), stmt);
				setString(27, data.getl_TAX_CD(), stmt);
				setString(28, data.getl_TAX_APPLY_TYP(), stmt);
				setString(29, data.getl_TAX_CALC_TYP(), stmt);
				setString(30, data.getl_INSPC_ACPT_APP_TYP(), stmt);
				setString(31, data.getl_ODR_FORM_FLG(), stmt);
				setString(32, data.getl_ODR_EDI_FLG(), stmt);
				setString(33, data.getl_VEND_REM(), stmt);
				setString(34, data.getl_CUR_CD(), stmt);
				setString(35, data.getl_EXCH_TYP(), stmt);
				setString(36, data.getl_IMPORT_TRN_TYP(), stmt);
				setString(37, data.getl_UNIT_COST_RETROACTION_FLG(), stmt);
...
+"  AND VEND_CD = ?";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int update(IDbConnection conn, AA0210010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int update(Connection conn, AA0210010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt=null;
			int modifyCount;
			...
			try {
				...
				setString(4, data.getl_VEND_NAME(), stmt);
				setString(5, data.getl_VEND_ANAME(), stmt);
				setString(6, data.getl_VEND_KNAME(), stmt);
				setString(7, data.getl_ZIP_CD(), stmt);
				setString(8, data.getl_ADDRESS_1(), stmt);
				setString(9, data.getl_ADDRESS_2(), stmt);
				setString(10, data.getl_ADDRESS_K_1(), stmt);
				setString(11, data.getl_ADDRESS_K_2(), stmt);
				setString(12, data.getl_TEL(), stmt);
				setString(13, data.getl_FAX(), stmt);
				setString(14, data.getl_EMAIL(), stmt);
				setString(15, data.getl_VEND_ORG(), stmt);
				setString(16, data.getl_VEND_PERSON(), stmt);
				setString(17, data.getl_OWN_ORG_CD(), stmt);
				setString(18, data.getl_OWN_ORG_NAME(), stmt);
				setString(19, data.getl_OWN_PERSON_CD(), stmt);
				setString(20, data.getl_OWN_PERSON_NAME(), stmt);
				setString(21, data.getl_ROUND_TYP(), stmt);
				setString(22, data.getl_TAX_CD(), stmt);
				setString(23, data.getl_TAX_APPLY_TYP(), stmt);
				setString(24, data.getl_TAX_CALC_TYP(), stmt);
				setString(25, data.getl_INSPC_ACPT_APP_TYP(), stmt);
				setString(26, data.getl_ODR_FORM_FLG(), stmt);
				setString(27, data.getl_ODR_EDI_FLG(), stmt);
				setString(28, data.getl_VEND_REM(), stmt);
				setString(29, data.getl_CUR_CD(), stmt);
				setString(30, data.getl_EXCH_TYP(), stmt);
				setString(31, data.getl_IMPORT_TRN_TYP(), stmt);
				setString(32, data.getl_UNIT_COST_RETROACTION_FLG(), stmt);
				setString(33, data.getl_COMPANY_CD(), stmt);
				setString(34, data.getOUT_VEND_CD(), stmt);
...
+"  AND VEND_CD = ?";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int delete(IDbConnection conn, AA0210010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int delete(Connection conn, AA0210010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt=null;
			...
			try {
				...
				setString(1, data.getl_COMPANY_CD(), stmt);
				setString(2, data.getOUT_VEND_CD(), stmt);
	 ...
	 * Entity定義 静的SQL
	 */
	public class selectCurCd extends DataObject
	{
		protected String m_selcmd = "SELECT "
+"  HOME_CUR_CD "
+"FROM "
...
+"  CTRL_CD = 'SYSTEM'";
		...
		//{{user_implement_dev:selectCurCd_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:selectCurCd_def
		...
		public List read(Connection conn, AA0210010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectCurCd_read
			if(m_selcmd==null) throw new FoundationException("selectCurCd", "read", "クエリー未登録");
		...
		public List read(Connection conn, AA0210010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectCurCd_read2
			if(m_selcmd==null) throw new FoundationException("selectCurCd", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AA0210010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectCurCd_read3
			if(m_selcmd==null) throw new FoundationException("selectCurCd", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public AA0210010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setl_HOME_CUR_CD( getString(1, rs) );
		...
		public boolean hasRecord(Connection conn, AA0210010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("selectCurCd", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AA0210010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectCurCd_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:selectCurCd_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:selectCurCd_clear
		...
		/**
		 * selectCurCdクラスの標準コンストラクタ
		 */
		public selectCurCd()
		{
			//{{user_implement_dev:selectCurCd_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:selectCurCd_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class checkVEND_CTRL extends DataObject
	{
		protected String m_selcmd = "SELECT "
+"  VEND_CD "
+"FROM "
...
+"  AND VEND_CD = ?";
		...
		//{{user_implement_dev:checkVEND_CTRL_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:checkVEND_CTRL_def
		...
		public List read(Connection conn, AA0210010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:checkVEND_CTRL_read
			if(m_selcmd==null) throw new FoundationException("checkVEND_CTRL", "read", "クエリー未登録");
		...
		public List read(Connection conn, AA0210010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:checkVEND_CTRL_read2
			if(m_selcmd==null) throw new FoundationException("checkVEND_CTRL", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AA0210010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:checkVEND_CTRL_read3
			if(m_selcmd==null) throw new FoundationException("checkVEND_CTRL", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public AA0210010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setOUT_VEND_CD( getString(1, rs) );
		...
		public boolean hasRecord(Connection conn, AA0210010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("checkVEND_CTRL", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AA0210010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:checkVEND_CTRL_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:checkVEND_CTRL_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:checkVEND_CTRL_clear
		...
		/**
		 * checkVEND_CTRLクラスの標準コンストラクタ
		 */
		public checkVEND_CTRL()
		{
			//{{user_implement_dev:checkVEND_CTRL_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:checkVEND_CTRL_constractor
...
+"  TAX_CD = ?";
		...
		public PreparedStatement prepare(Connection conn, String query, AA0210010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				ary.addElement(data.getl_TAX_CD());
				if(isNull(data.getl_TAX_CD())) isNull = true;
		...
		public ResultSet executeQuery(PreparedStatement stmt, AA0210010Struct data) throws FoundationException, SQLException
		{
			...
			// 静的SQL文の生成
			setString(no ++, data.getl_TAX_CD(), stmt);
		...
		public AA0210010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setl_TAX_CD( getString(1, rs) );
...
+"  CUR_CD = ?";
		...
		public AA0210010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setl_CUR_CD( getString(1, rs) );
...
+"  AND UM.PLANT_CD = MP.PLANT_CD";
		...
		public PreparedStatement prepare(Connection conn, String query, AA0210010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				ary.addElement(data.getl_OWN_PERSON_CD());
				if(isNull(data.getl_OWN_PERSON_CD())) isNull = true;
		...
		public ResultSet executeQuery(PreparedStatement stmt, AA0210010Struct data) throws FoundationException, SQLException
		{
			...
			// 静的SQL文の生成
			setString(no ++, data.getl_OWN_PERSON_CD(), stmt);
		...
		public AA0210010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setl_OWN_PERSON_NAME( getString(1, rs) );
...
+"  SYS_MY_COMPANY.\"CTRL_CD\" = 'SYSTEM'";
		...
		public AA0210010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setl_COMPANY_CD( getString(1, rs) );
...
+"  OR  PAYEE_CD = ?)";
	...
	public void clear()
	{
		...
		mselectCurCd.clear();
		mselectCurCd = null;
		mcheckVEND_CTRL.clear();
		mcheckVEND_CTRL = null;
		mselectM_TAX.clear();
		mselectM_TAX = null;
		mselectM_CUR.clear();
		mselectM_CUR = null;
	 ...
	 */
	public AA0210010Entity() throws FoundationException
	{
