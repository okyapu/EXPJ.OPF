...
public class AD0100010Entity extends DataObject
{
	...
	// Select_PAST_RESULT_ENTRY_TYPクラス インスタンス
	...
	// Select_MODIFY_T_WORK_IN_PROC_BY_ITEMクラス インスタンス
...
+"  (?, ?, ?, 0, 0, '0', NULL, TO_DATE(?, 'YYYY/MM/DD'), ?, ?, 1, 0, 0, 0, 0, NULL, NULL, ?, NULL, NULL)";
		...
		/**
		 * Insert_T_OUTPUT_RSLTクラスの標準コンストラクタ
		 */
...
+"  (?, ?, ?, ?, 0, 0, TO_DATE(?, 'YYYY/MM/DD'), ?, ?, NULL, 1, 0, 0, 0, 0, NULL, ?, ?, NULL, NULL, 0)";
		...
		/**
		 * Insert_T_OPR_RSLTクラスの標準コンストラクタ
		 */
...
+"  WORK_ODR_CD = ?";
		...
		/**
		 * Update_T_WORK_IN_PROC_BY_ITEMクラスの標準コンストラクタ
		 */
...
+"  OPR_INST_CD = ?";
		...
		public List read(Connection conn, AD0100010Struct data) throws FoundationException, SQLException
		{
			...
			if(m_selcmd==null) throw new FoundationException("Select_Max_PARTIAL_PRD_NO", "read", "クエリー未登録");
		...
		{
			if(m_selcmd==null) throw new FoundationException("Select_Max_PARTIAL_PRD_NO", "hasRecord", "クエリー未登録");
		...
		/**
		 * Select_Max_PARTIAL_PRD_NOクラスの標準コンストラクタ
		 */
...
+"  NAME = 'PAST_RESULT_ENTRY_TYP'";
		...
		public List read(Connection conn, AD0100010Struct data) throws FoundationException, SQLException
		{
			...
			if(m_selcmd==null) throw new FoundationException("Select_PAST_RESULT_ENTRY_TYP", "read", "クエリー未登録");
		...
		public boolean hasRecord(Connection conn, AD0100010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("Select_PAST_RESULT_ENTRY_TYP", "hasRecord", "クエリー未登録");
		...
		/**
		 * Select_PAST_RESULT_ENTRY_TYPクラスの標準コンストラクタ
		 */
...
+"  AND MODIFY_COUNT = TO_NUMBER(?)";
		...
		public List read(Connection conn, AD0100010Struct data) throws FoundationException, SQLException
		{
			...
			if(m_selcmd==null) throw new FoundationException("Select_MODIFY_T_WORK_IN_PROC_BY_ITEM", "read", "クエリー未登録");
		...
		public boolean hasRecord(Connection conn, AD0100010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("Select_MODIFY_T_WORK_IN_PROC_BY_ITEM", "hasRecord", "クエリー未登録");
		...
		/**
		 * Select_MODIFY_T_WORK_IN_PROC_BY_ITEMクラスの標準コンストラクタ
		 */
