...
public class AH0060010Servlet extends HttpServlet
{
	 ...
	 * @param control AH0060010Controlクラスインスタンス
	 */
...
//			e.printStackTrace();
	...
	public static String DEFAULT_TARGET = "/AH0060010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAH0060010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAH0060010Struct";   // JSP先のバインド名(Struct)の指定
