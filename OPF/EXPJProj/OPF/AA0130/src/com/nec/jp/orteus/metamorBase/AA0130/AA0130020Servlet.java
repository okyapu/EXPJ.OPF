...
public class AA0130020Servlet extends HttpServlet
{
	 ...
	 * @param control AA0130020Controlクラスインスタンス
	 */
...
//			e.printStackTrace();
					...
					AA0130020Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		//{{user_implement_dev:<reloadEvent>
              ...
              //			e.printStackTrace();
              //			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AA0130020-E999","リロード処理"));
                 ExpjException ee = new ExpjException(e, "ZZ01106");
	...
	public static String DEFAULT_TARGET = "/AA0130020.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAA0130020Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAA0130020Struct";   // JSP先のバインド名(Struct)の指定
