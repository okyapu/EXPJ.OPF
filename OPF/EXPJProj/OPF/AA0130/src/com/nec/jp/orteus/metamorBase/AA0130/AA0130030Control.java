/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AA0130/src/com/nec/jp/orteus/metamorBase/AA0130/AA0130030Control.java,v $
 *
...
public class AA0130030Control
{
	...
	//{{user_implement_code_main
       ...
       //	public Object getListvalue(int x) { return this.list.get(x); }	// リストの値を返します。
        public AA0130030Struct getListvalue(int x) { return (AA0130030Struct)(this.list.get(x)); }	// リストの値を返します。
        public AA0130030Struct getStruct() { return this.struct; }	// Structを返します。
        public AA0130030Struct createStruct() { return new AA0130030Struct(); }	// 新しいStructを作って返します。
        public void setStruct(Object structname) { this.struct.setStruct((AA0130030Struct)structname); }	// Structをセットします。
         ...
         * データなし例外クラスです。
         */
        private class AA0130030NoDataException extends ExpjBadException
        {
         /**
             * AA0130030NoDataExceptionオブジェクトを構築します。
          *
          * @param em エラーメッセージオブジェクト
          */
         private AA0130030NoDataException(ExpjMessage em)
         {
          super(em);
         }
        }
         ...
         * @throws AA0130030NoDataException 品目番号が存在しない
         */
        private String getItemName(String itemCd)
          throws FoundationException, SQLException, AA0130030NoDataException
        {
         AA0130030Struct workStruct = new AA0130030Struct();
         workStruct.setFr_ITEM_CD(itemCd);
         List workList = entity.mSelect.read(conn, workStruct);
         if (workList == null || workList.isEmpty()) {
          // 品目番号が存在しない場合
          throw new AA0130030NoDataException(new ExpjMessage("ZZ01006",
            "M_ITEM.ITEM_CD:" + itemCd));
         }
         workStruct = (AA0130030Struct)workList.get(0);
         ...
         */
         ...
         try {
          ...
          if (workList != null && workList.size() > 0) {
           businessDate = ((AA0130030Struct)workList.get(0)).getReplaceDate();
          } else {
          ...
          throws BusinessProcessException, FoundationException, ExpjException
        {
         ...
         } catch (AA0130030NoDataException nde) {
          // 読込状態（読込失敗）を設定
          setReadStatus(ERROR);
	...
	public void controlSelect() throws BusinessProcessException, FoundationException
	{
		...
		logger.entering("AA0130030Control"+":USER="+struct.getsUser_ID(),"controlSelect");
			//{{user_implement_dev:<controlSelect>
                ...
                //}}user_implement_dev:<controlSelect>
		logger.exiting("AA0130030Control"+":USER="+struct.getsUser_ID(),"controlSelect");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130030Control"+":USER="+struct.getsUser_ID(),"controlUpdate");
			//{{user_implement_dev:<controlUpdate>
                ...
                try {
                 ...
                 if(_psMaint.replacePs(struct.getFr_ITEM_CD(), parentDataList, compDataList,
                         struct.getTo_ITEM_CD(), struct.getReplaceDate()) > 0){
                	 // ワーニングエラー：【置換先の品目構成に、有効期間範囲以外の下位品目が存在してます。】
                	 ExpjMessage emsg = new ExpjMessage("AA00219");
...
// 2008/07/15 SYSCOM 小林 ADD START
                 ...
                 // 警告：置換元品目が工数管理品目の場合、下位品目を作成する置換は行えません。
                 ExpjMessage emsg = new ExpjMessage("AA00182");
                 msgStruct.addError(emsg);
                 sysLog.warning(emsg, getsysUSER_CD());
...
// 2008/07/15 SYSCOM 小林 ADD END
                 ...
                 msgStruct.addError(emsg);
                 sysLog.warning(emsg, getsysUSER_CD());
                 // Add Start 20140312 wanghp
                 if(value != null && !"".equals(value)){
                 // Add End 20140312 wanghp
                 emsg = new ExpjMessage("ZZ01006", value);
                 msgStruct.addError(emsg);
                 sysLog.warning(emsg, getsysUSER_CD());
                 // Add Start 20140312 wanghp
                ...
                //}}user_implement_dev:<controlUpdate>
		logger.exiting("AA0130030Control"+":USER="+struct.getsUser_ID(),"controlUpdate");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130030Control"+":USER="+struct.getsUser_ID(),"controlClear");
			//{{user_implement_dev:<controlClear>
                ...
                //}}user_implement_dev:<controlClear>
		logger.exiting("AA0130030Control"+":USER="+struct.getsUser_ID(),"controlClear");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130030Control"+":USER="+struct.getsUser_ID(),"controlClose");
			//{{user_implement_dev:<controlClose>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<controlClose>
		logger.exiting("AA0130030Control"+":USER="+struct.getsUser_ID(),"controlClose");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130030Control"+":USER="+struct.getsUser_ID(),"controlINITIAL");
		//{{user_implement_dev:<controlINITIAL>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<controlINITIAL>
		logger.exiting("AA0130030Control"+":USER="+struct.getsUser_ID(),"controlINITIAL");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130030Control"+":USER="+struct.getsUser_ID(),"controlRELOAD");
		//{{user_implement_dev:<controlRELOAD>
                ...
                //}}user_implement_dev:<controlRELOAD>
		logger.exiting("AA0130030Control"+":USER="+struct.getsUser_ID(),"controlRELOAD");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130030Control"+":USER="+struct.getsUser_ID(),"controlPREPARATION");
...
//		}
		...
		//{{user_implement_dev:<controlPREPARATION>
              ...
              //			struct.setDOWNLOAD_FILE((String)null);
                 ...
                 // コンボボックスデータ用意
                //}}user_implement_dev:<controlPREPARATION>
		logger.exiting("AA0130030Control"+":USER="+struct.getsUser_ID(),"controlPREPARATION");
...
//			e.printStackTrace();
//			throw new FoundationException("AA0130030Control",e.getMessage(),"control_eventHandllerメソッドでエラーが発生しました。");
	...
	public void createDefaultCSV(List list, String sTitle[]) throws BusinessProcessException, FoundationException {
		...
		//{{user_implement_dev:<createDefaultCSV>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AA0130030-E999","CSVの出力処理"));
			throw new FoundationException("AA0130030Control",e.getMessage(),"createDefaultCSVメソッドでエラーが発生しました。");
		}
...
//				objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AA0130030-E999","システム日付の取得処理"));
				throw new FoundationException("AA0130030Control","beginTransaction()","システム日付取得処理でエラーが発生しました。");
			}
		...
		//{{user_implement_dev:<beginTransaction>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AA0130030-E999","コントロールのイベント処理"));
			throw new FoundationException("AA0130030Control",e.getMessage(),"beginTransactionメソッドでエラーが発生しました。");
		}
	 ...
	 * メンバ変数の定義
	 */
	protected AA0130030Entity entity;
	protected AA0130030Struct struct;
	...
	public void initialize() throws FoundationException
	{
		...
		entity = new AA0130030Entity();
		struct = new AA0130030Struct();
	 ...
	 */
	public AA0130030Control() throws BusinessProcessException, FoundationException
	{
		initialize();
	...
	public void setOrMsgKey(List keyList) throws MessageApiException {
		...
		for (int i = 0; msgKeyTypeArray != null && i < msgKeyTypeArray.size(); i++) {
			...
			for(int j = 0; j < keyList.size(); j++) {
				AA0130030Struct key = (AA0130030Struct)keyList.get(j);
				// メッセージキーを作成する
		...
		try {
			for (int i = 0; msgKeyTypeArray != null && i < msgKeyTypeArray.size(); i++) {
				...
				for (int j = 0; msgKeyArray != null && j < msgKeyArray.size(); j++) {
					...
					AA0130030Struct key = new AA0130030Struct();
