/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AA0130/src/com/nec/jp/orteus/metamorBase/AA0130/AA0130030Struct.java,v $
 *
...
public class AA0130030Struct extends DataStruct
{
	...
	public int setL2L_h_Fr_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_h_Fr_ITEM_CD.add(((AA0130030Struct) list.get(i)).geth_Fr_ITEM_CD());
		}
		return size;
	}
	public int setL2L_TargetDate(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TargetDate.add(((AA0130030Struct) list.get(i)).getTargetDate());
		}
		return size;
	}
	public int setL2L_h_TargetDate(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_h_TargetDate.add(((AA0130030Struct) list.get(i)).geth_TargetDate());
		}
		return size;
	}
	public int setL2L_FrParent_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_FrParent_ITEM_CD.add(((AA0130030Struct) list.get(i)).getFrParent_ITEM_CD());
		}
		return size;
	}
	public int setL2L_FrParent_PS_EDITION(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_FrParent_PS_EDITION.add(((AA0130030Struct) list.get(i)).getFrParent_PS_EDITION());
		}
		return size;
	}
	public int setL2L_FrParent_ITEM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_FrParent_ITEM_NAME.add(((AA0130030Struct) list.get(i)).getFrParent_ITEM_NAME());
		}
		return size;
	}
	public int setL2L_FrParent_EFF_PHASE_IN_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_FrParent_EFF_PHASE_IN_DATE.add(((AA0130030Struct) list.get(i)).getFrParent_EFF_PHASE_IN_DATE());
		}
		return size;
	}
	public int setL2L_FrParent_EFF_PHASE_OUT_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_FrParent_EFF_PHASE_OUT_DATE.add(((AA0130030Struct) list.get(i)).getFrParent_EFF_PHASE_OUT_DATE());
		}
		return size;
	}
	public int setL2L_h_FrParent_MODIFY_COUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_h_FrParent_MODIFY_COUNT.add(((AA0130030Struct) list.get(i)).geth_FrParent_MODIFY_COUNT());
		}
		return size;
	}
	public int setL2L_FrComp_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_FrComp_ITEM_CD.add(((AA0130030Struct) list.get(i)).getFrComp_ITEM_CD());
		}
		return size;
	}
	public int setL2L_FrComp_PS_EDITION(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_FrComp_PS_EDITION.add(((AA0130030Struct) list.get(i)).getFrComp_PS_EDITION());
		}
		return size;
	}
	public int setL2L_FrComp_ITEM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_FrComp_ITEM_NAME.add(((AA0130030Struct) list.get(i)).getFrComp_ITEM_NAME());
		}
		return size;
	}
	public int setL2L_FrComp_EFF_PHASE_IN_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_FrComp_EFF_PHASE_IN_DATE.add(((AA0130030Struct) list.get(i)).getFrComp_EFF_PHASE_IN_DATE());
		}
		return size;
	}
	public int setL2L_FrComp_EFF_PHASE_OUT_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_FrComp_EFF_PHASE_OUT_DATE.add(((AA0130030Struct) list.get(i)).getFrComp_EFF_PHASE_OUT_DATE());
		}
		return size;
	}
	public int setL2L_h_FrComp_MODIFY_COUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_h_FrComp_MODIFY_COUNT.add(((AA0130030Struct) list.get(i)).geth_FrComp_MODIFY_COUNT());
		}
		return size;
	}
	public int setL2L_Fr_ITEM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_Fr_ITEM_NAME.add(((AA0130030Struct) list.get(i)).getFr_ITEM_NAME());
		}
		return size;
	}
	public int setL2L_Fr_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_Fr_ITEM_CD.add(((AA0130030Struct) list.get(i)).getFr_ITEM_CD());
		}
		return size;
	}
	public int setL2L_To_ITEM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_To_ITEM_NAME.add(((AA0130030Struct) list.get(i)).getTo_ITEM_NAME());
		}
		return size;
	}
	public int setL2L_To_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_To_ITEM_CD.add(((AA0130030Struct) list.get(i)).getTo_ITEM_CD());
		}
		return size;
	}
	public int setL2L_ReplaceDate(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ReplaceDate.add(((AA0130030Struct) list.get(i)).getReplaceDate());
		}
		return size;
	}
	public int setL2L_h_PLANT_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_h_PLANT_CD.add(((AA0130030Struct) list.get(i)).geth_PLANT_CD());
		}
		return size;
	}
	...
	/**
	 * medAA0130030クラスの標準コンストラクタ
	 */
	public AA0130030Struct()
	{
	 ...
	 */
	public void setStruct(AA0130030Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructM(AA0130030Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructL(AA0130030Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
