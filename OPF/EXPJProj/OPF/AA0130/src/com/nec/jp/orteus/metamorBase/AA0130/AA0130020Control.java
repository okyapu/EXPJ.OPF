/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AA0130/src/com/nec/jp/orteus/metamorBase/AA0130/AA0130020Control.java,v $
 *
...
public class AA0130020Control
{
	...
	//{{user_implement_code_main
       ...
       //	public Object getListvalue(int x) { return this.list.get(x); }	// リストの値を返します。
        public AA0130020Struct getListvalue(int x) { return (AA0130020Struct)(this.list.get(x)); }	// リストの値を返します。
        public AA0130020Struct getStruct() { return this.struct; }	// Structを返します。
        public AA0130020Struct createStruct() { return new AA0130020Struct(); }	// 新しいStructを作って返します。
        public void setStruct(Object structname) { this.struct.setStruct((AA0130020Struct)structname); }	// Structをセットします。
         ...
         * データなし例外クラスです。
         */
        private class AA0130020NoDataException extends ExpjBadException
        {
         /**
             * AA0130020NoDataExceptionオブジェクトを構築します。
          *
          * @param em エラーメッセージオブジェクト
          */
         private AA0130020NoDataException(ExpjMessage em)
         {
          super(em);
         }
        }
         ...
         * 同一品目番号例外クラスです。
         */
        private class AA0130020SameItemCdException extends ExpjBadException
        {
         /**
             * AA0130020SameItemCdExceptionオブジェクトを構築します。
          *
          * @param em エラーメッセージオブジェクト
          */
         private AA0130020SameItemCdException(ExpjMessage em)
         {
          super(em);
         }
        }
         ...
         * @throws AA0130020SameItemCdException コピー元既存構成の品目がコピー先既存構成の品目に一致
         */
        private void testCompAlreadyExist(String toParentItemCd, String fromCompItemCd)
          throws SQLException, FoundationException, AA0130020SameItemCdException
        {
         AA0130020Struct workStruct = new AA0130020Struct();
         ...
         if (workList != null && workList.size() > 0) {
          ...
          throw new AA0130020SameItemCdException(new ExpjMessage("ZZ01006",
        ...
        private void testParentAlreadyExist(String fromParentItemCd, String toCompItemCd)
          throws FoundationException, SQLException, AA0130020SameItemCdException
        {
         AA0130020Struct workStruct = new AA0130020Struct();
         ...
         * @throws FoundationException
         * @throws SQLException DBアクセスに失敗
         * @throws AA0130020NoDataException 品目番号が存在しない
         */
        private String getItemName(String itemCd)
          throws FoundationException, SQLException, AA0130020NoDataException
        {
         AA0130020Struct workStruct = new AA0130020Struct();
         ...
         if (workList == null || workList.isEmpty()) {
          // 品目番号が存在しない場合
          throw new AA0130020NoDataException(new ExpjMessage("ZZ01006",
            "M_ITEM.ITEM_CD:" + itemCd));
         }
         workStruct = (AA0130020Struct)workList.get(0);
           ...
           if (struct.getFrUp_ITEM_CD() != null
             && struct.getFrUp_ITEM_CD().equals("") == false){
               ...
               if(!entity.mCheckItem_cd.check(conn, struct)){
            	   ...
            	   // 元品目名
            	   struct.setFrUp_ITEM_NAME(getItemName(struct.getFrUp_ITEM_CD()));
                   ...
                   if (frPsSize == 0 && struct.getFrUp_ITEM_CD() != null
                     && struct.getFrUp_ITEM_CD().equals("") == false) {
                       ...
                       AA0130020NoDataException nde = null;
                       if (struct.getDEVELOP_TYP().equals(DEVELOP_NORMAL) == true) {
                           // 正展開の場合
                           nde = new AA0130020NoDataException(new ExpjMessage("ZZ01006",
...
// 2008/07/11 SYSCOM 小林 ADD START
				// コピー先品目番号が工数管理品目で、かつ正展開の場合
				}else if(entity.mCheckItem_Manhour_Typ.check(conn, struct)
					&& struct.getDEVELOP_TYP().equals(DEVELOP_NORMAL)) {
					// 読込状態（読込失敗）を設定
					setReadStatus(ERROR);
					// 警告：工数管理品目に、下位品目の構成追加は行えません。
					ExpjMessage emsg = new ExpjMessage("AA00178" ,"M_ITEM.ITEM_CD:" + struct.geth_ToUp_ITEM_CD());
					msgStruct.addError(emsg);
					setErrorParameter("M_ITEM","ITEM_CD",struct.getToUp_ITEM_CD());
// 2008/07/11 SYSCOM 小林 ADD END
            	   ...
            	   // 先品目名
            	   struct.setToUp_ITEM_NAME(getItemName(struct.getToUp_ITEM_CD()));
         ...
         } catch (AA0130020NoDataException nde) {
          // 読込状態（読込失敗）を設定
          setReadStatus(ERROR);
          // 警告：対象データが存在しません。
          ExpjMessage emsg = new ExpjMessage("ZZ06001");
	...
	public void controlSelect() throws BusinessProcessException, FoundationException
	{
		...
		logger.entering("AA0130020Control"+":USER="+struct.getsUser_ID(),"controlSelect");
			//{{user_implement_dev:<controlSelect>
                ...
                //}}user_implement_dev:<controlSelect>
		logger.exiting("AA0130020Control"+":USER="+struct.getsUser_ID(),"controlSelect");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130020Control"+":USER="+struct.getsUser_ID(),"controlUpdate");
			//{{user_implement_dev:<controlUpdate>
                ...
                try {
                 ...
                 for (int i = 0; i < frLoItemCdListSize; i++) {
                  ...
                  if (frLoItemCd.equals(struct.getToUp_ITEM_CD()) == true) {
                   ...
                   AA0130020SameItemCdException sice = null;
                   if (struct.getDEVELOP_TYP().equals(DEVELOP_NORMAL) == true) {
                    // 正展開の場合
                    sice = new AA0130020SameItemCdException(new ExpjMessage("ZZ01006",
                  ...
                  for (int j = 0; j < toListSize; j++) {
                   AA0130020Struct workStruct = (AA0130020Struct)_toList.get(j);
                ...
                } catch (AA0130020SameItemCdException sice) {
                 // 読込状態（読込失敗）を設定
                 setReadStatus(ERROR);
                 // 警告：同一品目番号は追加できません。
                ...
                //}}user_implement_dev:<controlUpdate>
		logger.exiting("AA0130020Control"+":USER="+struct.getsUser_ID(),"controlUpdate");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130020Control"+":USER="+struct.getsUser_ID(),"controlClear");
			//{{user_implement_dev:<controlClear>
                ...
                //}}user_implement_dev:<controlClear>
		logger.exiting("AA0130020Control"+":USER="+struct.getsUser_ID(),"controlClear");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130020Control"+":USER="+struct.getsUser_ID(),"controlClose");
			//{{user_implement_dev:<controlClose>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<controlClose>
		logger.exiting("AA0130020Control"+":USER="+struct.getsUser_ID(),"controlClose");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130020Control"+":USER="+struct.getsUser_ID(),"controlINITIAL");
		//{{user_implement_dev:<controlINITIAL>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<controlINITIAL>
		logger.exiting("AA0130020Control"+":USER="+struct.getsUser_ID(),"controlINITIAL");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130020Control"+":USER="+struct.getsUser_ID(),"controlRELOAD");
		//{{user_implement_dev:<controlRELOAD>
                ...
                //}}user_implement_dev:<controlRELOAD>
		logger.exiting("AA0130020Control"+":USER="+struct.getsUser_ID(),"controlRELOAD");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130020Control"+":USER="+struct.getsUser_ID(),"controlPREPARATION");
...
//		}
		...
		//{{user_implement_dev:<controlPREPARATION>
                ...
                //}}user_implement_dev:<controlPREPARATION>
		logger.exiting("AA0130020Control"+":USER="+struct.getsUser_ID(),"controlPREPARATION");
...
//			e.printStackTrace();
//			throw new FoundationException("AA0130020Control",e.getMessage(),"control_eventHandllerメソッドでエラーが発生しました。");
	...
	public void createDefaultCSV(List list, String sTitle[]) throws BusinessProcessException, FoundationException {
		...
		//{{user_implement_dev:<createDefaultCSV>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AA0130020-E999","CSVの出力処理"));
			throw new FoundationException("AA0130020Control",e.getMessage(),"createDefaultCSVメソッドでエラーが発生しました。");
		}
...
//				objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AA0130020-E999","システム日付の取得処理"));
				throw new FoundationException("AA0130020Control","beginTransaction()","システム日付取得処理でエラーが発生しました。");
			}
		...
		//{{user_implement_dev:<beginTransaction>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AA0130020-E999","コントロールのイベント処理"));
			throw new FoundationException("AA0130020Control",e.getMessage(),"beginTransactionメソッドでエラーが発生しました。");
		}
	 ...
	 * メンバ変数の定義
	 */
	protected AA0130020Entity entity;
	protected AA0130020Struct struct;
	...
	public void initialize() throws FoundationException
	{
		...
		entity = new AA0130020Entity();
		struct = new AA0130020Struct();
	 ...
	 */
	public AA0130020Control() throws BusinessProcessException, FoundationException
	{
		initialize();
	...
	public void setOrMsgKey(List keyList) throws MessageApiException {
		...
		for (int i = 0; msgKeyTypeArray != null && i < msgKeyTypeArray.size(); i++) {
			...
			for(int j = 0; j < keyList.size(); j++) {
				AA0130020Struct key = (AA0130020Struct)keyList.get(j);
				// メッセージキーを作成する
		...
		try {
			for (int i = 0; msgKeyTypeArray != null && i < msgKeyTypeArray.size(); i++) {
				...
				for (int j = 0; msgKeyArray != null && j < msgKeyArray.size(); j++) {
					...
					AA0130020Struct key = new AA0130020Struct();
