/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AA0130/src/com/nec/jp/orteus/metamorBase/AA0130/AA0130020Struct.java,v $
 *
...
public class AA0130020Struct extends DataStruct
{
	...
	public int setL2L_ToUp_ITEM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ToUp_ITEM_NAME.add(((AA0130020Struct) list.get(i)).getToUp_ITEM_NAME());
		}
		return size;
	}
	public int setL2L_TargetDate(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TargetDate.add(((AA0130020Struct) list.get(i)).getTargetDate());
		}
		return size;
	}
	public int setL2L_DEVELOP_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DEVELOP_TYP.add(((AA0130020Struct) list.get(i)).getDEVELOP_TYP());
		}
		return size;
	}
	public int setL2L_Fr_PS_EDITION(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_Fr_PS_EDITION.add(((AA0130020Struct) list.get(i)).getFr_PS_EDITION());
		}
		return size;
	}
	public int setL2L_Fr_EFF_PHASE_IN_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_Fr_EFF_PHASE_IN_DATE.add(((AA0130020Struct) list.get(i)).getFr_EFF_PHASE_IN_DATE());
		}
		return size;
	}
	public int setL2L_Fr_EFF_PHASE_OUT_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_Fr_EFF_PHASE_OUT_DATE.add(((AA0130020Struct) list.get(i)).getFr_EFF_PHASE_OUT_DATE());
		}
		return size;
	}
	public int setL2L_h_Fr_MODIFY_COUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_h_Fr_MODIFY_COUNT.add(((AA0130020Struct) list.get(i)).geth_Fr_MODIFY_COUNT());
		}
		return size;
	}
	public int setL2L_ToLo_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ToLo_ITEM_CD.add(((AA0130020Struct) list.get(i)).getToLo_ITEM_CD());
		}
		return size;
	}
	public int setL2L_To_PS_EDITION(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_To_PS_EDITION.add(((AA0130020Struct) list.get(i)).getTo_PS_EDITION());
		}
		return size;
	}
	public int setL2L_ToLo_ITEM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ToLo_ITEM_NAME.add(((AA0130020Struct) list.get(i)).getToLo_ITEM_NAME());
		}
		return size;
	}
	public int setL2L_To_EFF_PHASE_IN_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_To_EFF_PHASE_IN_DATE.add(((AA0130020Struct) list.get(i)).getTo_EFF_PHASE_IN_DATE());
		}
		return size;
	}
	public int setL2L_To_EFF_PHASE_OUT_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_To_EFF_PHASE_OUT_DATE.add(((AA0130020Struct) list.get(i)).getTo_EFF_PHASE_OUT_DATE());
		}
		return size;
	}
	public int setL2L_h_FrUp_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_h_FrUp_ITEM_CD.add(((AA0130020Struct) list.get(i)).geth_FrUp_ITEM_CD());
		}
		return size;
	}
	public int setL2L_h_ToUp_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_h_ToUp_ITEM_CD.add(((AA0130020Struct) list.get(i)).geth_ToUp_ITEM_CD());
		}
		return size;
	}
	public int setL2L_h_TargetDate(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_h_TargetDate.add(((AA0130020Struct) list.get(i)).geth_TargetDate());
		}
		return size;
	}
	public int setL2L_h_DEVELOP_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_h_DEVELOP_TYP.add(((AA0130020Struct) list.get(i)).geth_DEVELOP_TYP());
		}
		return size;
	}
	public int setL2L_DEVELOP_TYP_name(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DEVELOP_TYP_name.add(((AA0130020Struct) list.get(i)).getDEVELOP_TYP_name());
		}
		return size;
	}
	public int setL2L_DEVELOP_TYP_val(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DEVELOP_TYP_val.add(((AA0130020Struct) list.get(i)).getDEVELOP_TYP_val());
		}
		return size;
	}
	public int setL2L_FrUp_ITEM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_FrUp_ITEM_NAME.add(((AA0130020Struct) list.get(i)).getFrUp_ITEM_NAME());
		}
		return size;
	}
	public int setL2L_FrUp_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_FrUp_ITEM_CD.add(((AA0130020Struct) list.get(i)).getFrUp_ITEM_CD());
		}
		return size;
	}
	public int setL2L_FrLo_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_FrLo_ITEM_CD.add(((AA0130020Struct) list.get(i)).getFrLo_ITEM_CD());
		}
		return size;
	}
	public int setL2L_ToUp_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ToUp_ITEM_CD.add(((AA0130020Struct) list.get(i)).getToUp_ITEM_CD());
		}
		return size;
	}
	public int setL2L_FrLo_ITEM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_FrLo_ITEM_NAME.add(((AA0130020Struct) list.get(i)).getFrLo_ITEM_NAME());
		}
		return size;
	}
	public int setL2L_CK_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CK_ITEM_CD.add(((AA0130020Struct) list.get(i)).getCK_ITEM_CD());
		}
		return size;
	}
	...
	/**
	 * medAA0130020クラスの標準コンストラクタ
	 */
	public AA0130020Struct()
	{
	 ...
	 */
	public void setStruct(AA0130020Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructM(AA0130020Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructL(AA0130020Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
