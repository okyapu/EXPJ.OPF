/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AA0130/src/com/nec/jp/orteus/metamorBase/AA0130/AA0130010Servlet.java,v $
 *
...
public class AA0130010Servlet extends HttpServlet
{
	 ...
	 * @param control AA0130010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AA0130010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AA0130010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AA0130010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AA0130010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AA0130010Entity entity = control.entity;
		AA0130010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AA0130010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
                 // TODO: ユーザ定義のコードを記述してください
              //			objMessage.m_writer.write( Level.ALL, "AA0130010"+" $Revision: 1.11 $" );
                 control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AA0130010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AA0130010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AA0130010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
		...
		//{{user_implement_dev:<reloadEvent>
              ...
              //			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AA0130010-E999","リロード処理"));
                ...
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AA0130010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickSelect(
					...
					HttpSession so,
					Hashtable params,
					AA0130010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AA0130010Entity entity = control.entity;
		AA0130010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
		//{{user_implement_dev:<onClickSelect>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickSelect>
		logger.exiting("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
					...
					AA0130010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickFlashTree");
		//{{user_implement_dev:<onClickFlashTree>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickFlashTree>
		logger.exiting("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickFlashTree");
	...
	public String onClickLineInsert(
					...
					AA0130010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = "/AA0130011.jsp";		// 移動先ＵＲＬ
		AA0130010Entity entity = control.entity;
		AA0130010Struct struct = control.struct;
		getSessionParameters(so, params, struct);

		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickLineInsert");
		//{{user_implement_dev:<onClickLineInsert>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickLineInsert>
		logger.exiting("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickLineInsert");
					...
					AA0130010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickLineUpdate");
		//{{user_implement_dev:<onClickLineUpdate>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickLineUpdate>
		logger.exiting("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickLineUpdate");
					...
					AA0130010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickLineDelete");
		//{{user_implement_dev:<onClickLineDelete>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickLineDelete>
		logger.exiting("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickLineDelete");
					...
					AA0130010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
		//{{user_implement_dev:<onClickClear>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
					...
					AA0130010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickClose");
		//{{user_implement_dev:<onClickClose>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickClose>
		logger.exiting("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickClose");
					...
					AA0130010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickDeleteAll");
		//{{user_implement_dev:<onClickDeleteAll>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickDeleteAll>
		logger.exiting("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickDeleteAll");
					...
					AA0130010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickShowS_Tree");
		//{{user_implement_dev:<onClickShowS_Tree>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickShowS_Tree>
		logger.exiting("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickShowS_Tree");
					...
					AA0130010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickShowR_Tree");
		//{{user_implement_dev:<onClickShowR_Tree>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickShowR_Tree>
		logger.exiting("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickShowR_Tree");
	...
	public String onClickAddTree(
					...
					AA0130010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = "/AA0130010Control.jsp";		// 移動先ＵＲＬ
		AA0130010Entity entity = control.entity;
		AA0130010Struct struct = control.struct;
		getSessionParameters(so, params, struct);

		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickAddTree");
		//{{user_implement_dev:<onClickAddTree>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickAddTree>
		logger.exiting("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickAddTree");
	...
	public String onClickShowDetail(
					...
					AA0130010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = "/AA0130010Detail.jsp";		// 移動先ＵＲＬ
		AA0130010Entity entity = control.entity;
		AA0130010Struct struct = control.struct;
		getSessionParameters(so, params, struct);

		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickShowDetail");
		//{{user_implement_dev:<onClickShowDetail>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickShowDetail>
		logger.exiting("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickShowDetail");
					...
					AA0130010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickSub1Insert");
		//{{user_implement_dev:<onClickSub1Insert>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickSub1Insert>
		logger.exiting("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickSub1Insert");
					...
					AA0130010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickSub1Update");
		//{{user_implement_dev:<onClickSub1Update>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickSub1Update>
		logger.exiting("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickSub1Update");
					...
					AA0130010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickSub1Return");
		//{{user_implement_dev:<onClickSub1Return>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickSub1Return>
		logger.exiting("AA0130010Servlet"+":USER="+request.getRemoteUser(),"onClickSub1Return");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AA0130010Struct struct)
	{
		...
		String[] AA0130010tree1 = ((params.containsKey("AA0130010tree1")) ? (String[])params.get("AA0130010tree1") : (String[])null);
		...
		struct.setAA0130010tree1( ((AA0130010tree1 == null) ? (String)null : AA0130010tree1[0]) );
		struct.setList_AA0130010tree1(TypeConverter.convert(AA0130010tree1));
	...
	public static String DEFAULT_TARGET = "/AA0130010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAA0130010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAA0130010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0130");
		logger.entering("AA0130010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AA0130010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AA0130010Control control;
		AA0130010Entity  entity = null;
		AA0130010Struct  struct = null;
		...
		try {
			...
			if( (control = (AA0130010Control)so.getAttribute("AA0130010Control_"+request.getSession(false).getId())) == null ) {
				control = new AA0130010Control();
			...
			try {
				...
				so.setAttribute("AA0130010Control_"+request.getSession(false).getId(),control);
				...
				//{{user_implement_dev:<eventHandling>
                                 ...
                                 //if (struct.getAA0130010tree1() != null) { System.out.println("               AA0130010tree1: " + struct.getAA0130010tree1()); }
	...
	{
		return "com.nec.jp.orteus.metamorBase.AA0130.AA0130010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AA0130010Servlet()
	{
		//{{user_implement_dev:<AA0130010_DisConnect_FLG>
		...
		//{{user_implement_dev:<AA0130010Servlet>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<AA0130010Servlet>
	}
