/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AF0040/src/com/nec/jp/orteus/metamorBase/AF0040/AF0040010Struct.java,v $
 *
...
public class AF0040010Struct extends DataStruct
{
	...
	/** 第 4 変数： m_r_SELECT_CHOICE_0 */
	public String m_r_SELECT_CHOICE_0 = null;
	/** 第 5 変数： m_r_SELECT_CHOICE_1 */
	public String m_r_SELECT_CHOICE_1 = null;
	/** 第 6 変数： m_c_JOB_ODR */
	public String m_c_JOB_ODR = null;
	/** 第 7 変数： m_c_SHIP_COMPLETE */
	public String m_c_SHIP_COMPLETE = null;
	/** 第 8 変数： m_w_ISSUE_CMPLT_FLG_NAME */
	public String m_w_ISSUE_CMPLT_FLG_NAME = null;
	/** 第 9 変数： m_w_CONS_TYP_NAME */
	public String m_w_CONS_TYP_NAME = null;
	/** 第 10 変数： m_w_CHOICE */
	public String m_w_CHOICE = null;
	/** 第 11 変数： m_ITEM_STOCK_NON_ALC_QTY */
	public String m_ITEM_STOCK_NON_ALC_QTY = null;
	/** 第 12 変数： m_ODR_ISSUE_POSS_QTY */
	public String m_ODR_ISSUE_POSS_QTY = null;
	/** 第 13 変数： m_ALC_NOISSUE_QTY */
	public String m_ALC_NOISSUE_QTY = null;
	/** 第 14 変数： m_THIS_TIME_ISSUE_POSS_QTY */
	...
	/** 第 34 変数： m_OPR_INST_START_DATE */
	public String m_OPR_INST_START_DATE = null;
	/** 第 35 変数： m_WORK_ODR_DLV_DATE */
	public String m_WORK_ODR_DLV_DATE = null;
	/** 第 36 変数： m_OPR_INST_QTY */
	...
	/** 第 59 変数： m_UNIT_QTY_TYP */
	public String m_UNIT_QTY_TYP = null;
	/** 第 60 変数： m_MRP_ODR_TYP */
	...
	/** 第 2 List変数： l_w_WH_NAME */
	public List l_w_WH_NAME = null;

	/** 第 3 List変数： l_h_SHIP_COMPLETE */
	public List l_h_SHIP_COMPLETE = null;

	/** 第 4 List変数： l_r_SELECT_CHOICE_0 */
	public List l_r_SELECT_CHOICE_0 = null;

	/** 第 5 List変数： l_r_SELECT_CHOICE_1 */
	public List l_r_SELECT_CHOICE_1 = null;

	/** 第 6 List変数： l_c_JOB_ODR */
	public List l_c_JOB_ODR = null;

	/** 第 7 List変数： l_c_SHIP_COMPLETE */
	public List l_c_SHIP_COMPLETE = null;

	/** 第 8 List変数： l_w_ISSUE_CMPLT_FLG_NAME */
	public List l_w_ISSUE_CMPLT_FLG_NAME = null;

	/** 第 9 List変数： l_w_CONS_TYP_NAME */
	public List l_w_CONS_TYP_NAME = null;

	/** 第 10 List変数： l_w_CHOICE */
	public List l_w_CHOICE = null;

	/** 第 11 List変数： l_ITEM_STOCK_NON_ALC_QTY */
	public List l_ITEM_STOCK_NON_ALC_QTY = null;

	/** 第 12 List変数： l_ODR_ISSUE_POSS_QTY */
	public List l_ODR_ISSUE_POSS_QTY = null;

	/** 第 13 List変数： l_ALC_NOISSUE_QTY */
	public List l_ALC_NOISSUE_QTY = null;

	/** 第 14 List変数： l_THIS_TIME_ISSUE_POSS_QTY */
	public List l_THIS_TIME_ISSUE_POSS_QTY = null;

	/** 第 15 List変数： l_WH_FLG */
	public List l_WH_FLG = null;

	/** 第 16 List変数： l_h_WH_CD */
	public List l_h_WH_CD = null;

	/** 第 17 List変数： l_h_lotCtrl */
	public List l_h_lotCtrl = null;

	/** 第 18 List変数： l_LOT_CTRL_FLG_name */
	public List l_LOT_CTRL_FLG_name = null;

	/** 第 19 List変数： l_LOT_CTRL_FLG_val */
	public List l_LOT_CTRL_FLG_val = null;

	/** 第 20 List変数： l_w_PLANT_CD */
	public List l_w_PLANT_CD = null;

	/** 第 21 List変数： l_tmp_WH_CD */
	public List l_tmp_WH_CD = null;

	/** 第 22 List変数： l_tmp_RCV_ISSUE_QTY */
	public List l_tmp_RCV_ISSUE_QTY = null;

	/** 第 23 List変数： l_ISSUE_CMPLT_FLG_name */
	public List l_ISSUE_CMPLT_FLG_name = null;

	/** 第 24 List変数： l_ISSUE_CMPLT_FLG_val */
	public List l_ISSUE_CMPLT_FLG_val = null;

	/** 第 25 List変数： l_CONS_TYP_name */
	public List l_CONS_TYP_name = null;

	/** 第 26 List変数： l_CONS_TYP_val */
	public List l_CONS_TYP_val = null;

	/** 第 27 List変数： l_OPR_INST_CD_GNR_TYP */
	public List l_OPR_INST_CD_GNR_TYP = null;

	/** 第 28 List変数： l_PLANT_CD */
	public List l_PLANT_CD = null;

	/** 第 29 List変数： l_OPR_INST_CD */
	...
	/** 第 59 List変数： l_UNIT_QTY_TYP */
	public List l_UNIT_QTY_TYP = null;

	/** 第 60 List変数： l_MRP_ODR_TYP */
	public List l_MRP_ODR_TYP = null;

	/** 第 61 List変数： l_WH_NAME */
	public List l_WH_NAME = null;

	/** 第 62 List変数： l_ISSUE_TYP */
	public List l_ISSUE_TYP = null;

	/** 第 63 List変数： l_LOT_CTRL_FLG */
	public List l_LOT_CTRL_FLG = null;

	/** 第 64 List変数： l_w_TOTAL_STOCK_ON_HAND_QTY */
	public List l_w_TOTAL_STOCK_ON_HAND_QTY = null;

	/** 第 65 List変数： l_w_JOB_ODR_CD */
	public List l_w_JOB_ODR_CD = null;

	/** 第 66 List変数： l_BUSINESS_OPR_DATE */
	public List l_BUSINESS_OPR_DATE = null;

	/** 第 67 List変数： l_WH_PLANT_CD */
	public List l_WH_PLANT_CD = null;

	/** 第 68 List変数： l_WH_VEND_CD */
	public List l_WH_VEND_CD = null;

	/** 第 69 List変数： l_WH_TYP */
	public List l_WH_TYP = null;

	/** 第 70 List変数： l_MRP_FLG */
	public List l_MRP_FLG = null;

	/** 第 71 List変数： l_RCV_ISSUE_CTRL_CD */
	public List l_RCV_ISSUE_CTRL_CD = null;

	/** 第 72 List変数： l_RCV_ISSUE_TYP */
	...
	public String getr_SELECT_CHOICE_0() { return m_r_SELECT_CHOICE_0; }
	public String getr_SELECT_CHOICE_1() { return m_r_SELECT_CHOICE_1; }
	...
	public String getw_CONS_TYP_NAME() { return m_w_CONS_TYP_NAME; }
	...
	public List getList_r_SELECT_CHOICE_0() { return l_r_SELECT_CHOICE_0; }
	public List getList_r_SELECT_CHOICE_1() { return l_r_SELECT_CHOICE_1; }
	...
	public List getList_w_CONS_TYP_NAME() { return l_w_CONS_TYP_NAME; }
	...
	public void setr_SELECT_CHOICE_0(String val) { m_r_SELECT_CHOICE_0 = val; }
	public void setr_SELECT_CHOICE_1(String val) { m_r_SELECT_CHOICE_1 = val; }
	...
	public void setw_CONS_TYP_NAME(String val) { m_w_CONS_TYP_NAME = val; }
	...
	public void setList_r_SELECT_CHOICE_0(List list) { l_r_SELECT_CHOICE_0 = list; }
	public void setList_r_SELECT_CHOICE_1(List list) { l_r_SELECT_CHOICE_1 = list; }
	...
	public void setList_w_CONS_TYP_NAME(List list) { l_w_CONS_TYP_NAME = list; }
	...
	public int setL2L_h_JOB_ODR(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_h_JOB_ODR.add(((AF0040010Struct) list.get(i)).geth_JOB_ODR());
		}
		return size;
	}
	public int setL2L_w_WH_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_w_WH_NAME.add(((AF0040010Struct) list.get(i)).getw_WH_NAME());
		}
		return size;
	}
	public int setL2L_h_SHIP_COMPLETE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_h_SHIP_COMPLETE.add(((AF0040010Struct) list.get(i)).geth_SHIP_COMPLETE());
		}
		return size;
	}
	public int setL2L_r_SELECT_CHOICE_0(List list) {
		int size = (list != null) ? list.size() : 0;
		if (size == 0) {
			return 0;
		}
		if (l_r_SELECT_CHOICE_0 == null) {
			l_r_SELECT_CHOICE_0 = new ArrayList();
		} else {
			l_r_SELECT_CHOICE_0.clear();
		}
		for (int i = 0; i < size; i++) {
			l_r_SELECT_CHOICE_0.add(((AF0040010Struct) list.get(i)).getr_SELECT_CHOICE_0());
		}
		return size;
	}
	public int setL2L_r_SELECT_CHOICE_1(List list) {
		int size = (list != null) ? list.size() : 0;
		if (size == 0) {
			return 0;
		}
		if (l_r_SELECT_CHOICE_1 == null) {
			l_r_SELECT_CHOICE_1 = new ArrayList();
		} else {
			l_r_SELECT_CHOICE_1.clear();
		}
		for (int i = 0; i < size; i++) {
			l_r_SELECT_CHOICE_1.add(((AF0040010Struct) list.get(i)).getr_SELECT_CHOICE_1());
		}
		return size;
	}
	public int setL2L_c_JOB_ODR(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_c_JOB_ODR.add(((AF0040010Struct) list.get(i)).getc_JOB_ODR());
		}
		return size;
	}
	public int setL2L_c_SHIP_COMPLETE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_c_SHIP_COMPLETE.add(((AF0040010Struct) list.get(i)).getc_SHIP_COMPLETE());
		}
		return size;
	}
	public int setL2L_w_ISSUE_CMPLT_FLG_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_w_ISSUE_CMPLT_FLG_NAME.add(((AF0040010Struct) list.get(i)).getw_ISSUE_CMPLT_FLG_NAME());
		}
		return size;
	}
	public int setL2L_w_CONS_TYP_NAME(List list) {
		int size = (list != null) ? list.size() : 0;
		if (size == 0) {
			return 0;
		}
		if (l_w_CONS_TYP_NAME == null) {
			l_w_CONS_TYP_NAME = new ArrayList();
		} else {
			l_w_CONS_TYP_NAME.clear();
		}
		for (int i = 0; i < size; i++) {
			l_w_CONS_TYP_NAME.add(((AF0040010Struct) list.get(i)).getw_CONS_TYP_NAME());
		}
		return size;
	}
	public int setL2L_w_CHOICE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_w_CHOICE.add(((AF0040010Struct) list.get(i)).getw_CHOICE());
		}
		return size;
	}
	public int setL2L_ITEM_STOCK_NON_ALC_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_STOCK_NON_ALC_QTY.add(((AF0040010Struct) list.get(i)).getITEM_STOCK_NON_ALC_QTY());
		}
		return size;
	}
	public int setL2L_ODR_ISSUE_POSS_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ODR_ISSUE_POSS_QTY.add(((AF0040010Struct) list.get(i)).getODR_ISSUE_POSS_QTY());
		}
		return size;
	}
	public int setL2L_ALC_NOISSUE_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ALC_NOISSUE_QTY.add(((AF0040010Struct) list.get(i)).getALC_NOISSUE_QTY());
		}
		return size;
	}
	public int setL2L_THIS_TIME_ISSUE_POSS_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_THIS_TIME_ISSUE_POSS_QTY.add(((AF0040010Struct) list.get(i)).getTHIS_TIME_ISSUE_POSS_QTY());
		}
		return size;
	}
	public int setL2L_WH_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_WH_FLG.add(((AF0040010Struct) list.get(i)).getWH_FLG());
		}
		return size;
	}
	public int setL2L_h_WH_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_h_WH_CD.add(((AF0040010Struct) list.get(i)).geth_WH_CD());
		}
		return size;
	}
	public int setL2L_h_lotCtrl(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_h_lotCtrl.add(((AF0040010Struct) list.get(i)).geth_lotCtrl());
		}
		return size;
	}
	public int setL2L_LOT_CTRL_FLG_name(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_LOT_CTRL_FLG_name.add(((AF0040010Struct) list.get(i)).getLOT_CTRL_FLG_name());
		}
		return size;
	}
	public int setL2L_LOT_CTRL_FLG_val(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_LOT_CTRL_FLG_val.add(((AF0040010Struct) list.get(i)).getLOT_CTRL_FLG_val());
		}
		return size;
	}
	public int setL2L_w_PLANT_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_w_PLANT_CD.add(((AF0040010Struct) list.get(i)).getw_PLANT_CD());
		}
		return size;
	}
	public int setL2L_tmp_WH_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_tmp_WH_CD.add(((AF0040010Struct) list.get(i)).gettmp_WH_CD());
		}
		return size;
	}
	public int setL2L_tmp_RCV_ISSUE_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_tmp_RCV_ISSUE_QTY.add(((AF0040010Struct) list.get(i)).gettmp_RCV_ISSUE_QTY());
		}
		return size;
	}
	public int setL2L_ISSUE_CMPLT_FLG_name(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ISSUE_CMPLT_FLG_name.add(((AF0040010Struct) list.get(i)).getISSUE_CMPLT_FLG_name());
		}
		return size;
	}
	public int setL2L_ISSUE_CMPLT_FLG_val(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ISSUE_CMPLT_FLG_val.add(((AF0040010Struct) list.get(i)).getISSUE_CMPLT_FLG_val());
		}
		return size;
	}
	public int setL2L_CONS_TYP_name(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CONS_TYP_name.add(((AF0040010Struct) list.get(i)).getCONS_TYP_name());
		}
		return size;
	}
	public int setL2L_CONS_TYP_val(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CONS_TYP_val.add(((AF0040010Struct) list.get(i)).getCONS_TYP_val());
		}
		return size;
	}
	public int setL2L_OPR_INST_CD_GNR_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OPR_INST_CD_GNR_TYP.add(((AF0040010Struct) list.get(i)).getOPR_INST_CD_GNR_TYP());
		}
		return size;
	}
	public int setL2L_PLANT_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PLANT_CD.add(((AF0040010Struct) list.get(i)).getPLANT_CD());
		}
		return size;
	}
	public int setL2L_OPR_INST_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OPR_INST_CD.add(((AF0040010Struct) list.get(i)).getOPR_INST_CD());
		}
		return size;
	}
	public int setL2L_WORK_ODR_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_WORK_ODR_CD.add(((AF0040010Struct) list.get(i)).getWORK_ODR_CD());
		}
		return size;
	}
	public int setL2L_OD_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OD_NO.add(((AF0040010Struct) list.get(i)).getOD_NO());
		}
		return size;
	}
	public int setL2L_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_CD.add(((AF0040010Struct) list.get(i)).getITEM_CD());
		}
		return size;
	}
	public int setL2L_WS_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_WS_CD.add(((AF0040010Struct) list.get(i)).getWS_CD());
		}
		return size;
	}
	public int setL2L_OPR_INST_START_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OPR_INST_START_DATE.add(((AF0040010Struct) list.get(i)).getOPR_INST_START_DATE());
		}
		return size;
	}
	public int setL2L_WORK_ODR_DLV_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_WORK_ODR_DLV_DATE.add(((AF0040010Struct) list.get(i)).getWORK_ODR_DLV_DATE());
		}
		return size;
	}
	public int setL2L_OPR_INST_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OPR_INST_QTY.add(((AF0040010Struct) list.get(i)).getOPR_INST_QTY());
		}
		return size;
	}
	public int setL2L_JOB_ODR_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_JOB_ODR_CD.add(((AF0040010Struct) list.get(i)).getJOB_ODR_CD());
		}
		return size;
	}
	public int setL2L_WS_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_WS_NAME.add(((AF0040010Struct) list.get(i)).getWS_NAME());
		}
		return size;
	}
	public int setL2L_ITEM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_NAME.add(((AF0040010Struct) list.get(i)).getITEM_NAME());
		}
		return size;
	}
	public int setL2L_STOCK_UNIT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_STOCK_UNIT.add(((AF0040010Struct) list.get(i)).getSTOCK_UNIT());
		}
		return size;
	}
	public int setL2L_WORK_IN_PROC_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_WORK_IN_PROC_CD.add(((AF0040010Struct) list.get(i)).getWORK_IN_PROC_CD());
		}
		return size;
	}
	public int setL2L_PROC_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROC_NAME.add(((AF0040010Struct) list.get(i)).getPROC_NAME());
		}
		return size;
	}
	public int setL2L_COMPANY_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_COMPANY_CD.add(((AF0040010Struct) list.get(i)).getCOMPANY_CD());
		}
		return size;
	}
	public int setL2L_VEND_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_VEND_CD.add(((AF0040010Struct) list.get(i)).getVEND_CD());
		}
		return size;
	}
	public int setL2L_VEND_ANAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_VEND_ANAME.add(((AF0040010Struct) list.get(i)).getVEND_ANAME());
		}
		return size;
	}
	public int setL2L_WH_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_WH_CD.add(((AF0040010Struct) list.get(i)).getWH_CD());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_CD.add(((AF0040010Struct) list.get(i)).getPUCH_ODR_CD());
		}
		return size;
	}
	public int setL2L_ISSUE_INST_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ISSUE_INST_CD.add(((AF0040010Struct) list.get(i)).getISSUE_INST_CD());
		}
		return size;
	}
	public int setL2L_ISSUE_INST_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ISSUE_INST_QTY.add(((AF0040010Struct) list.get(i)).getISSUE_INST_QTY());
		}
		return size;
	}
	public int setL2L_TOTAL_ISSUE_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TOTAL_ISSUE_QTY.add(((AF0040010Struct) list.get(i)).getTOTAL_ISSUE_QTY());
		}
		return size;
	}
	public int setL2L_w_SHIP_REMAIN_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_w_SHIP_REMAIN_QTY.add(((AF0040010Struct) list.get(i)).getw_SHIP_REMAIN_QTY());
		}
		return size;
	}
	public int setL2L_SCDL_ISSUE_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SCDL_ISSUE_DATE.add(((AF0040010Struct) list.get(i)).getSCDL_ISSUE_DATE());
		}
		return size;
	}
	public int setL2L_ISSUE_CMPLT_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ISSUE_CMPLT_DATE.add(((AF0040010Struct) list.get(i)).getISSUE_CMPLT_DATE());
		}
		return size;
	}
	public int setL2L_ISSUE_CMPLT_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ISSUE_CMPLT_FLG.add(((AF0040010Struct) list.get(i)).getISSUE_CMPLT_FLG());
		}
		return size;
	}
	public int setL2L_CONS_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CONS_TYP.add(((AF0040010Struct) list.get(i)).getCONS_TYP());
		}
		return size;
	}
	public int setL2L_MODIFY_COUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_MODIFY_COUNT.add(((AF0040010Struct) list.get(i)).getMODIFY_COUNT());
		}
		return size;
	}
	public int setL2L_DRAW_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DRAW_CD.add(((AF0040010Struct) list.get(i)).getDRAW_CD());
		}
		return size;
	}
	public int setL2L_SPEC(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SPEC.add(((AF0040010Struct) list.get(i)).getSPEC());
		}
		return size;
	}
	public int setL2L_UNIT_QTY_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_UNIT_QTY_TYP.add(((AF0040010Struct) list.get(i)).getUNIT_QTY_TYP());
		}
		return size;
	}
	public int setL2L_MRP_ODR_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_MRP_ODR_TYP.add(((AF0040010Struct) list.get(i)).getMRP_ODR_TYP());
		}
		return size;
	}
	public int setL2L_WH_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_WH_NAME.add(((AF0040010Struct) list.get(i)).getWH_NAME());
		}
		return size;
	}
	public int setL2L_ISSUE_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ISSUE_TYP.add(((AF0040010Struct) list.get(i)).getISSUE_TYP());
		}
		return size;
	}
	public int setL2L_LOT_CTRL_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_LOT_CTRL_FLG.add(((AF0040010Struct) list.get(i)).getLOT_CTRL_FLG());
		}
		return size;
	}
	public int setL2L_w_TOTAL_STOCK_ON_HAND_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_w_TOTAL_STOCK_ON_HAND_QTY.add(((AF0040010Struct) list.get(i)).getw_TOTAL_STOCK_ON_HAND_QTY());
		}
		return size;
	}
	public int setL2L_w_JOB_ODR_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_w_JOB_ODR_CD.add(((AF0040010Struct) list.get(i)).getw_JOB_ODR_CD());
		}
		return size;
	}
	public int setL2L_BUSINESS_OPR_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_BUSINESS_OPR_DATE.add(((AF0040010Struct) list.get(i)).getBUSINESS_OPR_DATE());
		}
		return size;
	}
	public int setL2L_WH_PLANT_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_WH_PLANT_CD.add(((AF0040010Struct) list.get(i)).getWH_PLANT_CD());
		}
		return size;
	}
	public int setL2L_WH_VEND_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_WH_VEND_CD.add(((AF0040010Struct) list.get(i)).getWH_VEND_CD());
		}
		return size;
	}
	public int setL2L_WH_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_WH_TYP.add(((AF0040010Struct) list.get(i)).getWH_TYP());
		}
		return size;
	}
	public int setL2L_MRP_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_MRP_FLG.add(((AF0040010Struct) list.get(i)).getMRP_FLG());
		}
		return size;
	}
	public int setL2L_RCV_ISSUE_CTRL_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_RCV_ISSUE_CTRL_CD.add(((AF0040010Struct) list.get(i)).getRCV_ISSUE_CTRL_CD());
		}
		return size;
	}
	public int setL2L_RCV_ISSUE_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_RCV_ISSUE_TYP.add(((AF0040010Struct) list.get(i)).getRCV_ISSUE_TYP());
		}
		return size;
	}
	public int setL2L_RCV_ISSUE_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_RCV_ISSUE_DATE.add(((AF0040010Struct) list.get(i)).getRCV_ISSUE_DATE());
		}
		return size;
	}
	public int setL2L_RCV_ISSUE_GNR_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_RCV_ISSUE_GNR_TYP.add(((AF0040010Struct) list.get(i)).getRCV_ISSUE_GNR_TYP());
		}
		return size;
	}
	public int setL2L_STOCK_UPD_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_STOCK_UPD_TYP.add(((AF0040010Struct) list.get(i)).getSTOCK_UPD_TYP());
		}
		return size;
	}
	public int setL2L_RCV_ISSUE_CMPLT_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_RCV_ISSUE_CMPLT_FLG.add(((AF0040010Struct) list.get(i)).getRCV_ISSUE_CMPLT_FLG());
		}
		return size;
	}
	public int setL2L_VEND_LOT_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_VEND_LOT_NO.add(((AF0040010Struct) list.get(i)).getVEND_LOT_NO());
		}
		return size;
	}
	public int setL2L_LOT_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_LOT_NO.add(((AF0040010Struct) list.get(i)).getLOT_NO());
		}
		return size;
	}
	public int setL2L_ONEROUS_CONS_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ONEROUS_CONS_NO.add(((AF0040010Struct) list.get(i)).getONEROUS_CONS_NO());
		}
		return size;
	}
	public int setL2L_UNIT_COST(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_UNIT_COST.add(((AF0040010Struct) list.get(i)).getUNIT_COST());
		}
		return size;
	}
	public int setL2L_UNIT_COST_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_UNIT_COST_TYP.add(((AF0040010Struct) list.get(i)).getUNIT_COST_TYP());
		}
		return size;
	}
	public int setL2L_RETURNED_WH_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_RETURNED_WH_CD.add(((AF0040010Struct) list.get(i)).getRETURNED_WH_CD());
		}
		return size;
	}
	public int setL2L_w_STOCK_ON_HAND_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_w_STOCK_ON_HAND_QTY.add(((AF0040010Struct) list.get(i)).getw_STOCK_ON_HAND_QTY());
		}
		return size;
	}
	public int setL2L_w_WH_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_w_WH_CD.add(((AF0040010Struct) list.get(i)).getw_WH_CD());
		}
		return size;
	}
	public int setL2L_ONEROUS_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ONEROUS_FLG.add(((AF0040010Struct) list.get(i)).getONEROUS_FLG());
		}
		return size;
	}
	public int setL2L_THIS_MONTH(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_THIS_MONTH.add(((AF0040010Struct) list.get(i)).getTHIS_MONTH());
		}
		return size;
	}
	public int setL2L_INSTALL_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_INSTALL_FLG.add(((AF0040010Struct) list.get(i)).getINSTALL_FLG());
		}
		return size;
	}
	public int setL2L_PAST_RESULT_ENTRY_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PAST_RESULT_ENTRY_TYP.add(((AF0040010Struct) list.get(i)).getPAST_RESULT_ENTRY_TYP());
		}
		return size;
	}
	public int setL2L_PROC_EXEC_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROC_EXEC_DATE.add(((AF0040010Struct) list.get(i)).getPROC_EXEC_DATE());
		}
		return size;
	}
	public int setL2L_l_LOT_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_LOT_NO.add(((AF0040010Struct) list.get(i)).getl_LOT_NO());
		}
		return size;
	}
	public int setL2L_l_ISSUE_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_ISSUE_QTY.add(((AF0040010Struct) list.get(i)).getl_ISSUE_QTY());
		}
		return size;
	}
	public int setL2L_l_ISSUE_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_ISSUE_DATE.add(((AF0040010Struct) list.get(i)).getl_ISSUE_DATE());
		}
		return size;
	}
	public int setL2L_l_SPENT_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_SPENT_QTY.add(((AF0040010Struct) list.get(i)).getl_SPENT_QTY());
		}
		return size;
	}
	public int setL2L_l_STOCK_UNIT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_STOCK_UNIT.add(((AF0040010Struct) list.get(i)).getl_STOCK_UNIT());
		}
		return size;
	}
	public int setL2L_RCV_ISSUE_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_RCV_ISSUE_QTY.add(((AF0040010Struct) list.get(i)).getRCV_ISSUE_QTY());
		}
		return size;
	}
	public int setL2L_ISSUE_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ISSUE_QTY.add(((AF0040010Struct) list.get(i)).getISSUE_QTY());
		}
		return size;
	}
	public int setL2L_l_WH_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_WH_CD.add(((AF0040010Struct) list.get(i)).getl_WH_CD());
		}
		return size;
	}
	public int setL2L_l_STOCK_ON_HAND_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_STOCK_ON_HAND_QTY.add(((AF0040010Struct) list.get(i)).getl_STOCK_ON_HAND_QTY());
		}
		return size;
	}
	public int setL2L_l_DEFECT_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_DEFECT_QTY.add(((AF0040010Struct) list.get(i)).getl_DEFECT_QTY());
		}
		return size;
	}
	public int setL2L_l_ALLOCABLE_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_ALLOCABLE_QTY.add(((AF0040010Struct) list.get(i)).getl_ALLOCABLE_QTY());
		}
		return size;
	}
	public int setL2L_l_EXTERNAL_LOT_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_EXTERNAL_LOT_NO.add(((AF0040010Struct) list.get(i)).getl_EXTERNAL_LOT_NO());
		}
		return size;
	}
	public int setL2L_l_BEST_BEFORE_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_BEST_BEFORE_DATE.add(((AF0040010Struct) list.get(i)).getl_BEST_BEFORE_DATE());
		}
		return size;
	}
	public int setL2L_l_PRD_CMPLT_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_PRD_CMPLT_DATE.add(((AF0040010Struct) list.get(i)).getl_PRD_CMPLT_DATE());
		}
		return size;
	}
	public int setL2L_l_WH_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_WH_NAME.add(((AF0040010Struct) list.get(i)).getl_WH_NAME());
		}
		return size;
	}
	public int setL2L_BBD_c_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_BBD_c_FLG.add(((AF0040010Struct) list.get(i)).getBBD_c_FLG());
		}
		return size;
	}
	public int setL2L_BEST_BEFORE_DATE_CHECK_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_BEST_BEFORE_DATE_CHECK_FLG.add(((AF0040010Struct) list.get(i)).getBEST_BEFORE_DATE_CHECK_FLG());
		}
		return size;
	}
	public int setL2L_l_COUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_COUNT.add(((AF0040010Struct) list.get(i)).getl_COUNT());
		}
		return size;
	}
	public int setL2L_ROW_COUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ROW_COUNT.add(((AF0040010Struct) list.get(i)).getROW_COUNT());
		}
		return size;
	}
	...
	public void clear()
	{
		...
		m_r_SELECT_CHOICE_0 = null;
		m_r_SELECT_CHOICE_1 = null;
		m_c_JOB_ODR = null;
		m_c_SHIP_COMPLETE = null;
		m_w_ISSUE_CMPLT_FLG_NAME = null;
		m_w_CONS_TYP_NAME = null;
		m_w_CHOICE = null;
		...
		l_r_SELECT_CHOICE_0 = null;
		l_r_SELECT_CHOICE_1 = null;
		l_c_JOB_ODR = null;
		l_c_SHIP_COMPLETE = null;
		l_w_ISSUE_CMPLT_FLG_NAME = null;
		l_w_CONS_TYP_NAME = null;
		l_w_CHOICE = null;
	...
	/**
	 * medAF0040010クラスの標準コンストラクタ
	 */
	public AF0040010Struct()
	{
	 ...
	 */
	public void setStruct(AF0040010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructM(AF0040010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
			...
			this.setr_SELECT_CHOICE_0(struct.getr_SELECT_CHOICE_0());
			this.setr_SELECT_CHOICE_1(struct.getr_SELECT_CHOICE_1());
			...
			this.setw_CONS_TYP_NAME(struct.getw_CONS_TYP_NAME());
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructL(AF0040010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
			...
			this.setList_r_SELECT_CHOICE_0(struct.getList_r_SELECT_CHOICE_0());
			this.setList_r_SELECT_CHOICE_1(struct.getList_r_SELECT_CHOICE_1());
			...
			this.setList_w_CONS_TYP_NAME(struct.getList_w_CONS_TYP_NAME());
...
/*
	...
	// 第 4 変数初期値： i_r_SELECT_CHOICE_0


	final static String i_r_SELECT_CHOICE_0 = null;

	// 第 5 変数初期値： i_r_SELECT_CHOICE_1


	final static String i_r_SELECT_CHOICE_1 = null;

	// 第 6 変数初期値： i_c_JOB_ODR


	final static String i_c_JOB_ODR = null;

	// 第 7 変数初期値： i_c_SHIP_COMPLETE


	final static String i_c_SHIP_COMPLETE = null;

	// 第 8 変数初期値： i_w_ISSUE_CMPLT_FLG_NAME


	final static String i_w_ISSUE_CMPLT_FLG_NAME = null;

	// 第 9 変数初期値： i_w_CONS_TYP_NAME


	final static String i_w_CONS_TYP_NAME = null;

	// 第 10 変数初期値： i_w_CHOICE


	final static String i_w_CHOICE = null;

	// 第 11 変数初期値： i_ITEM_STOCK_NON_ALC_QTY


	final static String i_ITEM_STOCK_NON_ALC_QTY = null;

	// 第 12 変数初期値： i_ODR_ISSUE_POSS_QTY


	final static String i_ODR_ISSUE_POSS_QTY = null;

	// 第 13 変数初期値： i_ALC_NOISSUE_QTY


	final static String i_ALC_NOISSUE_QTY = null;

	// 第 14 変数初期値： i_THIS_TIME_ISSUE_POSS_QTY
	...
	// 第 59 変数初期値： i_UNIT_QTY_TYP


	final static String i_UNIT_QTY_TYP = null;

	// 第 60 変数初期値： i_MRP_ODR_TYP


	final static String i_MRP_ODR_TYP = null;

	// 第 61 変数初期値： i_WH_NAME


	final static String i_WH_NAME = null;

	// 第 62 変数初期値： i_ISSUE_TYP
	...
	// 第 64 変数初期値： i_w_TOTAL_STOCK_ON_HAND_QTY


	final static String i_w_TOTAL_STOCK_ON_HAND_QTY = null;

	// 第 65 変数初期値： i_w_JOB_ODR_CD


	final static String i_w_JOB_ODR_CD = null;

	// 第 66 変数初期値： i_BUSINESS_OPR_DATE


	final static String i_BUSINESS_OPR_DATE = null;

	// 第 67 変数初期値： i_WH_PLANT_CD


	final static String i_WH_PLANT_CD = null;

	// 第 68 変数初期値： i_WH_VEND_CD
...
*/
	 ...
	 * @param s コピー元	
	 */	
	public void copy(AF0040010Struct s)	
	{	
		clear();
		...
		if(s.m_r_SELECT_CHOICE_0 != null) m_r_SELECT_CHOICE_0 = new String(s.m_r_SELECT_CHOICE_0);
		if(s.m_r_SELECT_CHOICE_1 != null) m_r_SELECT_CHOICE_1 = new String(s.m_r_SELECT_CHOICE_1);
		...
		if(s.m_w_CONS_TYP_NAME != null) m_w_CONS_TYP_NAME = new String(s.m_w_CONS_TYP_NAME);
	 ...
	 * @param struct コピー対象
	 */
	 public AF0040010Struct(AF0040010Struct struct)
	 {
	 	copy(struct);
	 }
	...
	final static String i_w_CHOICE = "0";
