/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0100/src/com/nec/jp/orteus/metamorBase/AE0100/AE0100010Servlet.java,v $
 *
...
public class AE0100010Servlet extends HttpServlet
{
	 ...
	 * @param control AE0100010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AE0100010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AE0100010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AE0100010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AE0100010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AE0100010Entity entity = control.entity;
		AE0100010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AE0100010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
			// TODO: ユーザ定義のコードを記述してください
//			LogWriter.write( Level.ALL, "AE0100010"+" $Revision: 1.11 $" );
			control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AE0100010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AE0100010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AE0100010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0100");
		logger.entering("AE0100010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
...
//			e.printStackTrace();
//			LogWriter.write(Level.ALL, objMessage.getIDMsg("AE0100010-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
		}
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AE0100010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickSelect(
					...
					HttpSession so,
					Hashtable params,
					AE0100010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AE0100010Entity entity = control.entity;
		AE0100010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0100");
		logger.entering("AE0100010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickSelect>
		logger.exiting("AE0100010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
					...
					AE0100010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0100");
		logger.entering("AE0100010Servlet"+":USER="+request.getRemoteUser(),"onClickSelectUnitCost");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickSelectUnitCost>
		logger.exiting("AE0100010Servlet"+":USER="+request.getRemoteUser(),"onClickSelectUnitCost");
					...
					AE0100010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0100");
		logger.entering("AE0100010Servlet"+":USER="+request.getRemoteUser(),"onClickInsert");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickInsert>
		logger.exiting("AE0100010Servlet"+":USER="+request.getRemoteUser(),"onClickInsert");
					...
					AE0100010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0100");
		logger.entering("AE0100010Servlet"+":USER="+request.getRemoteUser(),"onClickUpdate");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickUpdate>
		logger.exiting("AE0100010Servlet"+":USER="+request.getRemoteUser(),"onClickUpdate");
					...
					AE0100010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0100");
		logger.entering("AE0100010Servlet"+":USER="+request.getRemoteUser(),"onClickDelete");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickDelete>
		logger.exiting("AE0100010Servlet"+":USER="+request.getRemoteUser(),"onClickDelete");
					...
					AE0100010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0100");
		logger.entering("AE0100010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("AE0100010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
					...
					AE0100010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0100");
		logger.entering("AE0100010Servlet"+":USER="+request.getRemoteUser(),"onClickLotCtrl");
		//{{user_implement_dev:<onClickLotCtrl>
			// TODO: ユーザ定義のコードを記述してください
		try {
			control.control_eventHandller("LotCtrl");
		} catch(FoundationException e) {
//			e.printStackTrace();
			// エラー処理を記述してください。
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
                ...
                //}}user_implement_dev:<onClickLotCtrl>
		logger.exiting("AE0100010Servlet"+":USER="+request.getRemoteUser(),"onClickLotCtrl");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AE0100010Struct struct)
	{
		...
		String[] RETURNED_WH_CD = ((params.containsKey("RETURNED_WH_CD")) ? (String[])params.get("RETURNED_WH_CD") : (String[])null);
		String[] WH_NAME = ((params.containsKey("WH_NAME")) ? (String[])params.get("WH_NAME") : (String[])null);
		String[] RETURNED_CAUSE_CD = ((params.containsKey("RETURNED_CAUSE_CD")) ? (String[])params.get("RETURNED_CAUSE_CD") : (String[])null);
		...
		String[] r3_FILTER = ((params.containsKey("r3_FILTER")) ? (String[])params.get("r3_FILTER") : (String[])null);
		String[] PUCH_ODR_CD = ((params.containsKey("PUCH_ODR_CD")) ? (String[])params.get("PUCH_ODR_CD") : (String[])null);
		String[] ONEROUS_CONS_COMMENT = ((params.containsKey("ONEROUS_CONS_COMMENT")) ? (String[])params.get("ONEROUS_CONS_COMMENT") : (String[])null);
		String[] c_ONEROUS_CONS_INV_TYP = ((params.containsKey("c_ONEROUS_CONS_INV_TYP")) ? (String[])params.get("c_ONEROUS_CONS_INV_TYP") : (String[])null);
		String[] h_ONEROUS_CONS_NO = ((params.containsKey("h_ONEROUS_CONS_NO")) ? (String[])params.get("h_ONEROUS_CONS_NO") : (String[])null);
		String[] h_ISSUE_DATE = ((params.containsKey("h_ISSUE_DATE")) ? (String[])params.get("h_ISSUE_DATE") : (String[])null);
		String[] LOT_NO = ((params.containsKey("LOT_NO")) ? (String[])params.get("LOT_NO") : (String[])null);
		String[] h_LOT_NO_2 = ((params.containsKey("h_LOT_NO_2")) ? (String[])params.get("h_LOT_NO_2") : (String[])null);
		...
		struct.setRETURNED_WH_CD( ((RETURNED_WH_CD == null) ? (String)null : RETURNED_WH_CD[0]) );
		struct.setList_RETURNED_WH_CD(TypeConverter.convert(RETURNED_WH_CD));
		struct.setWH_NAME( ((WH_NAME == null) ? (String)null : WH_NAME[0]) );
		struct.setList_WH_NAME(TypeConverter.convert(WH_NAME));
		struct.setRETURNED_CAUSE_CD( ((RETURNED_CAUSE_CD == null) ? (String)null : RETURNED_CAUSE_CD[0]) );
		struct.setList_RETURNED_CAUSE_CD(TypeConverter.convert(RETURNED_CAUSE_CD));
		...
		struct.setr3_FILTER( ((r3_FILTER == null) ? (String)null : r3_FILTER[0]) );
		struct.setList_r3_FILTER(TypeConverter.convert(r3_FILTER));
		...
		struct.setONEROUS_CONS_COMMENT( ((ONEROUS_CONS_COMMENT == null) ? (String)null : ONEROUS_CONS_COMMENT[0]) );
		struct.setList_ONEROUS_CONS_COMMENT(TypeConverter.convert(ONEROUS_CONS_COMMENT));
		struct.setc_ONEROUS_CONS_INV_TYP( ((c_ONEROUS_CONS_INV_TYP == null) ? (String)null : c_ONEROUS_CONS_INV_TYP[0]) );
		struct.setList_c_ONEROUS_CONS_INV_TYP(TypeConverter.convert(c_ONEROUS_CONS_INV_TYP));
		struct.seth_ONEROUS_CONS_NO( ((h_ONEROUS_CONS_NO == null) ? (String)null : h_ONEROUS_CONS_NO[0]) );
		struct.setList_h_ONEROUS_CONS_NO(TypeConverter.convert(h_ONEROUS_CONS_NO));
		struct.seth_ISSUE_DATE( ((h_ISSUE_DATE == null) ? (String)null : h_ISSUE_DATE[0]) );
		struct.setList_h_ISSUE_DATE(TypeConverter.convert(h_ISSUE_DATE));
		struct.setLOT_NO( ((LOT_NO == null) ? (String)null : LOT_NO[0]) );
		struct.setList_LOT_NO(TypeConverter.convert(LOT_NO));
		struct.seth_LOT_NO_2( ((h_LOT_NO_2 == null) ? (String)null : h_LOT_NO_2[0]) );
		struct.setList_h_LOT_NO_2(TypeConverter.convert(h_LOT_NO_2));
	...
	public static String DEFAULT_TARGET = "/AE0100010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAE0100010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAE0100010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0100");
		logger.entering("AE0100010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AE0100010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AE0100010Control control;
		AE0100010Entity  entity = null;
		AE0100010Struct  struct = null;
		...
		try {
			...
			if( (control = (AE0100010Control)so.getAttribute("AE0100010Control_"+request.getSession(false).getId())) == null ) {
				control = new AE0100010Control();
			...
			try {
				...
				} else if( isClick(request, "LotCtrl") ) {
					if ( !isCryptical(request, so, params, "LotCtrl") ) return ERROR_TARGET;
					target = onClickLotCtrl(request, response, so, params, control);
					control.setButton("LotCtrl");
				} else {
					target = defaultEvent(request, response, so, params, control, refererURL);
				}

				so.setAttribute("AE0100010Control_"+request.getSession(false).getId(),control);
				...
				|| (isClick(request, "LotCtrl") && bFLG_DISCONNECT_LotCtrl)
				) {
	...
	private  static boolean bFLG_DISCONNECT_LotCtrl = true;
	...
	{
		return "com.nec.jp.orteus.metamorBase.AE0100.AE0100010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AE0100010Servlet()
	{
		//{{user_implement_dev:<AE0100010_DisConnect_FLG>
		...
		//{{user_implement_dev:<AE0100010Servlet>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<AE0100010Servlet>
	}
