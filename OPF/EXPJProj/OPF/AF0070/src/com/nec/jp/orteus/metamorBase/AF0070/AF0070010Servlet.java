/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AF0070/src/com/nec/jp/orteus/metamorBase/AF0070/AF0070010Servlet.java,v $
 *
...
public class AF0070010Servlet extends HttpServlet
{
	 ...
	 * @param control AF0070010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AF0070010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AF0070010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AF0070010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AF0070010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AF0070010Entity entity = control.entity;
		AF0070010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AF0070010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
//			objMessage.m_writer.write( Level.ALL, "AF0070010"+" $Revision: 1.4 $" );
			control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AF0070010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AF0070010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AF0070010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AF0070");
		logger.entering("AF0070010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
		...
		//---------------------------------------------------------------------
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AF0070010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickselect(
					...
					HttpSession so,
					Hashtable params,
					AF0070010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AF0070010Entity entity = control.entity;
		AF0070010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AF0070");
		logger.entering("AF0070010Servlet"+":USER="+request.getRemoteUser(),"onClickselect");
		...
		//---------------------------------------------------------------------
                //}}user_implement_dev:<onClickselect>
		logger.exiting("AF0070010Servlet"+":USER="+request.getRemoteUser(),"onClickselect");
					...
					AF0070010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AF0070");
		logger.entering("AF0070010Servlet"+":USER="+request.getRemoteUser(),"onClickmodify");
		...
		//------------------------------------------------------------------
                //}}user_implement_dev:<onClickmodify>
		logger.exiting("AF0070010Servlet"+":USER="+request.getRemoteUser(),"onClickmodify");
					...
					AF0070010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AF0070");
		logger.entering("AF0070010Servlet"+":USER="+request.getRemoteUser(),"onClickclear");
		...
		//---------------------------------------------------------------------
                //}}user_implement_dev:<onClickclear>
		logger.exiting("AF0070010Servlet"+":USER="+request.getRemoteUser(),"onClickclear");
					...
					AF0070010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AF0070");
		logger.entering("AF0070010Servlet"+":USER="+request.getRemoteUser(),"onClickinsertSub1");
		...
		//---------------------------------------------------------------------
                //}}user_implement_dev:<onClickinsertSub1>
		logger.exiting("AF0070010Servlet"+":USER="+request.getRemoteUser(),"onClickinsertSub1");
					...
					AF0070010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AF0070");
		logger.entering("AF0070010Servlet"+":USER="+request.getRemoteUser(),"onClickcloseSub1");
		...
		//------------------------------------------------------------------
                //}}user_implement_dev:<onClickcloseSub1>
		logger.exiting("AF0070010Servlet"+":USER="+request.getRemoteUser(),"onClickcloseSub1");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AF0070010Struct struct)
	{
		...
		String[] w_WH_STOCK_QTY = ((params.containsKey("w_WH_STOCK_QTY")) ? (String[])params.get("w_WH_STOCK_QTY") : (String[])null);
		...
		String[] ALC_POS_STOCK_QTY = ((params.containsKey("ALC_POS_STOCK_QTY")) ? (String[])params.get("ALC_POS_STOCK_QTY") : (String[])null);
		String[] RCV_ISSUE_POS_QTY = ((params.containsKey("RCV_ISSUE_POS_QTY")) ? (String[])params.get("RCV_ISSUE_POS_QTY") : (String[])null);
		...
		struct.setw_WH_STOCK_QTY( ((w_WH_STOCK_QTY == null) ? (String)null : w_WH_STOCK_QTY[0]) );
		struct.setList_w_WH_STOCK_QTY(TypeConverter.convert(w_WH_STOCK_QTY));
		...
		struct.setALC_POS_STOCK_QTY( ((ALC_POS_STOCK_QTY == null) ? (String)null : ALC_POS_STOCK_QTY[0]) );
		struct.setList_ALC_POS_STOCK_QTY(TypeConverter.convert(ALC_POS_STOCK_QTY));
		struct.setRCV_ISSUE_POS_QTY( ((RCV_ISSUE_POS_QTY == null) ? (String)null : RCV_ISSUE_POS_QTY[0]) );
		struct.setList_RCV_ISSUE_POS_QTY(TypeConverter.convert(RCV_ISSUE_POS_QTY));
	...
	public static String DEFAULT_TARGET = "/AF0070010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAF0070010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAF0070010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AF0070");
		logger.entering("AF0070010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AF0070010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AF0070010Control control;
		AF0070010Entity  entity = null;
		AF0070010Struct  struct = null;
		...
		try {
			...
			if( (control = (AF0070010Control)so.getAttribute("AF0070010Control_"+request.getSession(false).getId())) == null ) {
				control = new AF0070010Control();
			...
			try {
				...
				so.setAttribute("AF0070010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.AF0070.AF0070010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AF0070010Servlet()
	{
		//{{user_implement_dev:<AF0070010_DisConnect_FLG>
		...
		//{{user_implement_dev:<AF0070010Servlet>
                //}}user_implement_dev:<AF0070010Servlet>
	}
