/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AF0070/src/com/nec/jp/orteus/metamorBase/AF0070/AF0070010Entity.java,v $
 *
...
public class AF0070010Entity extends DataObject
{
	...
	// selectJOB_ODR_STOCK_QTYクラス インスタンス
	public selectJOB_ODR_STOCK_QTY mselectJOB_ODR_STOCK_QTY = new selectJOB_ODR_STOCK_QTY();
...
+"";		//////////////////////////////
	...
	public class ei_CSVOut extends DataObject
	{
		...
		String m_write_fname="AF0070010.csv";

		protected WriteCsv m_writer=null;		// csv書込み用

		String m_ProjName="AF0070010";
...
+"  and T_JOB_ODR_CD_STOCK.\"JOB_ODR_CD\" like ? "
...
+"  WH_CD";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AF0070010Struct data) throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AF0070010Struct data, String replaceStr)
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AF0070010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AF0070010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AF0070010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AF0070010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(PreparedStatement stmt, AF0070010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public PreparedStatement prepare(Connection conn, String query, AF0070010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt;
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public ResultSet executeQuery(PreparedStatement stmt, AF0070010Struct data) throws FoundationException, SQLException
		{
			int no=1;
		 ...
		 * レコードデータをStructに格納して返します
		 */
		public AF0070010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			if(rs.next()==false) return null;

			AF0070010Struct data = new AF0070010Struct();
			...
			data.setMRP_FLG( getString(7, rs) );
			data.setw_WH_STOCK_QTY( getString(8, rs) );
			data.setDRAW_CD( getString(9, rs) );
			data.setSPEC( getString(10, rs) );
			data.setSTOCK_UNIT( getString(11, rs) );
			data.setw_UNIT_QTY_TYP( getInteger(12, rs) );
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(IDbConnection conn, AF0070010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(Connection conn, AF0070010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(IDbConnection conn, AF0070010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(Connection conn, AF0070010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(PreparedStatement stmt, AF0070010Struct data) throws FoundationException, SQLException
		{
			ResultSet rs=executeQuery(stmt, data);
			boolean ret=true;
...
+"  SYS_MY_COMPANY.\"CTRL_CD\" = 'SYSTEM'";
	 ...
	 * Entity定義 静的SQL
	 */
	public class selectJOB_ODR_STOCK_QTY extends DataObject
	{
		protected String m_selcmd = "select "
...
+"  and T_JOB_ODR_CD_STOCK.\"PLANT_CD\" = ?";
		...
		//{{user_implement_dev:selectJOB_ODR_STOCK_QTY_def
                //}}user_implement_dev:selectJOB_ODR_STOCK_QTY_def
		...
		public List read(Connection conn, AF0070010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectJOB_ODR_STOCK_QTY_read
			if(m_selcmd==null) throw new FoundationException("selectJOB_ODR_STOCK_QTY", "read", "クエリー未登録");
		...
		public List read(Connection conn, AF0070010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectJOB_ODR_STOCK_QTY_read2
			if(m_selcmd==null) throw new FoundationException("selectJOB_ODR_STOCK_QTY", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AF0070010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectJOB_ODR_STOCK_QTY_read3
			if(m_selcmd==null) throw new FoundationException("selectJOB_ODR_STOCK_QTY", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean hasRecord(Connection conn, AF0070010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("selectJOB_ODR_STOCK_QTY", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AF0070010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectJOB_ODR_STOCK_QTY_check
			PreparedStatement stmt;
			...
			if(m_chkcmd!=null) {
				...
				throw new FoundationException("selectJOB_ODR_STOCK_QTY", "check", "クエリー未登録");
			}
		...
		public void clear()
		{
			//{{user_implement_dev:selectJOB_ODR_STOCK_QTY_clear
                        //}}user_implement_dev:selectJOB_ODR_STOCK_QTY_clear
		...
		/**
		 * selectJOB_ODR_STOCK_QTYクラスの標準コンストラクタ
		 */
		public selectJOB_ODR_STOCK_QTY()
		{
			//{{user_implement_dev:selectJOB_ODR_STOCK_QTY_constractor
                        //}}user_implement_dev:selectJOB_ODR_STOCK_QTY_constractor
...
+"  T_RCV_ISSUE(\"RCV_ISSUE_CTRL_CD\", \"RCV_ISSUE_TYP\", \"ITEM_CD\", \"WH_CD\", \"JOB_ODR_CD\", \"RCV_ISSUE_QTY\", \"RCV_ISSUE_DATE\", \"RCV_ISSUE_GNR_TYP\", \"PLANT_CD\", \"VEND_LOT_NO\", \"COMPANY_CD\", \"VEND_CD\", \"CONS_TYP\", \"STOCK_UPD_TYP\") "
+"values "
+"  (?, ?, ?, ?, ?, TO_NUMBER(?), TO_DATE(?), ?, ?, ?, ?, ?, ?, ?)";
		protected String m_updcmd = null;
		protected String m_delcmd = null;
		...
		protected String m_sCreateProgramName="AF0070010";
		protected String m_sUpdateProgramName="AF0070010";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int create(IDbConnection conn, AF0070010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int create(Connection conn, AF0070010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt=null;
...
+"  M_WH.\"WH_CD\" = ?";
		...
		public boolean check(Connection conn, AF0070010Struct data) throws FoundationException, SQLException
		{
			...
			if(m_chkcmd!=null) {
				...
				throw new FoundationException("selectVEND_CD", "check", "クエリー未登録");
			}
...
+"  and ROWNUM <= TO_NUMBER(?) + 1";
	...
	public void clear()
	{
		...
		mselectJOB_ODR_STOCK_QTY.clear();
		mselectJOB_ODR_STOCK_QTY = null;
	 ...
	 */
	public AF0070010Entity() throws FoundationException
	{
