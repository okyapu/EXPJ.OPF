...
public class AD0130010Servlet extends HttpServlet
{
	 ...
	 * @param control AD0130010Controlクラスインスタンス
	 */
...
//			e.printStackTrace();
//			LogWriter.write(Level.ALL, objMessage.getIDMsg("AD0130010-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
...
//			e.printStackTrace();
	...
	public String onClicksub1_Return(
					...
					AD0130010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = "/AD0130010.jsp";		// 移動先ＵＲＬ
		AD0130010Entity entity = control.entity;
		AD0130010Struct struct = control.struct;
		getSessionParameters(so, params, struct);
...
//			e.printStackTrace();
	...
	public static String DEFAULT_TARGET = "/AD0130010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAD0130010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAD0130010Struct";   // JSP先のバインド名(Struct)の指定
