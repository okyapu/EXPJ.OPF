/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DC0010/src/com/nec/jp/orteus/metamorBase/DC0010/DC0010B001/SQLSTDITEMPSWORKENTRY.java,v $
 *
 ...
 * @version $Revision: 1.12 $ $Date: 2014/11/05 07:22:48 $
 */
...
public class SQLSTDITEMPSWORKENTRY extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		 ...
		 */
		public medDC0010B001 call(ResultSet rs) throws SQLException
		{
			if(rs == null || rs.next()==false) return null;
			medDC0010B001 data = new medDC0010B001();
			m_med.setpnumReturn(cstmt.getString(12));
			return data;
		}
	 ...
	 *
		 */
	public SQLSTDITEMPSWORKENTRY(medDC0010B001 med, BatchAppConductor cdr) throws SystemException
	{
