/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DC0010/src/com/nec/jp/orteus/metamorBase/DC0010/DC0010B001/SYS_CS_CALC_CTRL_Active.java,v $
 *
...
/**
 * CLASS     : SYS_CS_CALC_CTRL_Active クラス
 * ファイル・クラス説明
...
public class SYS_CS_CALC_CTRL_Active extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setRESULT_STATUS_TYP_U(String value) throws FoundationException { getAdapt_U().setString(4, value); }
		public void setCS_CALC_PROC_NO_U(String value) throws FoundationException { getAdapt_U().setString(5, value); }
		...
		public int update() throws BatchAppException
		{
			try {
				...
				setRESULT_STATUS_TYP_U(m_med.getRESULT_STATUS_TYP());
				setCS_CALC_PROC_NO_U(m_med.getCS_CALC_PROC_NO());
				setIN2_U(m_med.getPLANT_CD());
				setIN3_U(m_med.getYEAR());
				setIN4_U(m_med.getHALF_TERM_TYP());
				setIN5_U(m_med.getCOST_TYP());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("SYS_CS_CALC_CTRL_Active", "update", "レコード更新条件設定処理失敗");
	...
	void prepareAll() throws BatchAppException
	{
		...
		try {
			...
			BatchAppException be=new BatchAppException("SYS_CS_CALC_CTRL_Active", "prepareALL(FoundationException)", "SQL文のprepareで失敗しました");
			be.addMessage(e.getErrmsg());
			throw be;
		} catch(SQLException e) {
			BatchAppException be=new BatchAppException("SYS_CS_CALC_CTRL_Active", "prepareALL(SQLException)", "SQL文のprepareで失敗しました");
			throw be;
		}
	...
	/**
	 * SYS_CS_CALC_CTRL_Activeクラスの標準コンストラクタ
	 *
		 */
	public SYS_CS_CALC_CTRL_Active(medDC0010B001 med, BatchAppConductor cdr) throws SystemException
	{
...
+"  SYS_CS_CALC_CTRL "
+"set "
+"  \"RESULT_STATUS_TYP\" = to_number(?), "
+"  \"CS_CALC_PROC_NO\" = to_number(?) "
+"where "
