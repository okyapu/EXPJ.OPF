/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DC0010/src/com/nec/jp/orteus/metamorBase/DC0010/DC0010B001/SQLSTOCKVALUPDATE.java,v $
 *
...
/**
 * CLASS     : SQLSTOCKVALUPDATE クラス
 * ファイル・クラス説明
 * @author $Author: xl-hs-zzw $
 * @version $Revision: 1.6 $ $Date: 2014/11/05 07:22:49 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class SQLSTOCKVALUPDATE extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public List call() throws BatchAppException
		{
			try {
				...
				e.printStackTrace();
				BatchAppException be=new BatchAppException("SQLSTOCKVALUPDATE", "call", "Stored Procedure条件設定処理失敗");
				...
				if (cstmt != null) {
					try {
						...
						ef.printStackTrace();
						BatchAppException bef = new BatchAppException("SQLSTOCKVALUPDATE", "call", "Stored Procedureクローズ処理失敗");
	...
	/**
	 * SQLSTOCKVALUPDATEクラスの標準コンストラクタ
	 *
		 */
	public SQLSTOCKVALUPDATE(medDC0010B001 med, BatchAppConductor cdr) throws SystemException
	{
	...
	protected static String m_calcmd = "{" + "call SQLSTOCKVALUPDATE(?, ?, ?, ?, ?, ?, ?, to_number(?), to_number(?), to_number(?), to_number(?), ?)" + "}";
