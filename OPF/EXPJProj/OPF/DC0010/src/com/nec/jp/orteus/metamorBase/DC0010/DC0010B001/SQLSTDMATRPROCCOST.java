/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DC0010/src/com/nec/jp/orteus/metamorBase/DC0010/DC0010B001/SQLSTDMATRPROCCOST.java,v $
 *
...
public class SQLSTDMATRPROCCOST extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public List call() throws BatchAppException
		{
			try {
				...
				e.printStackTrace();
				BatchAppException be=new BatchAppException("SQLSTDMATRPROCCOST", "call", "Stored Procedure条件設定処理失敗");
				...
				if (cstmt != null) {
					try {
						...
						ef.printStackTrace();
						BatchAppException bef = new BatchAppException("SQLSTDMATRPROCCOST", "call", "Stored Procedureクローズ処理失敗");
	...
	/**
	 * SQLSTDMATRPROCCOSTクラスの標準コンストラクタ
	 *
		 */
	public SQLSTDMATRPROCCOST(medDC0010B001 med, BatchAppConductor cdr) throws SystemException
	{
	...
	protected static String m_calcmd = "{" + "call SQLSTDMATRPROCCOST(?, ?, ?, ?, ?, ?, ?, to_number(?), to_number(?), to_number(?), to_number(?), ?)" + "}";
