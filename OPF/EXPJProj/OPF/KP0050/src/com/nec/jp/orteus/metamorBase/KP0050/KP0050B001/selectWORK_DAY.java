/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KP0050/src/com/nec/jp/orteus/metamorBase/KP0050/KP0050B001/selectWORK_DAY.java,v $
 *
...
public class selectWORK_DAY extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setCAL_DATE_R(String value) throws FoundationException { getAdapt_R().setString(3, value); }
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setCAL_DATE_R(m_med.getCAL_DATE());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("selectWORK_DAY", "read", "レコード検索条件設定処理失敗");
		...
		public String getWORK_DAY_R() throws FoundationException { return m_doRs.getString(1); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setCAL_DATE(getWORK_DAY_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("selectWORK_DAY", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("selectWORK_DAY", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	...
	/**
	 * selectWORK_DAYクラスの標準コンストラクタ
	 *
		 */
	public selectWORK_DAY(medKP0050B001 med, BatchAppConductor cdr) throws SystemException
	{
