/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KP0050/src/com/nec/jp/orteus/metamorBase/KP0050/KP0050B001/readM_PLANT.java,v $
 *
...
public class readM_PLANT extends AbstractBatchAppEntity
{
	 ...
	 *
		 */
	public readM_PLANT(medKP0050B001 med, BatchAppConductor cdr) throws SystemException
	{
...
+"  SYS_DATE_CTRL "
+"where "
+"  M_PLANT.PLANT_CD like ? "
+"  AND M_PLANT.PLANT_CD = SYS_DATE_CTRL.PLANT_CD(+)";
