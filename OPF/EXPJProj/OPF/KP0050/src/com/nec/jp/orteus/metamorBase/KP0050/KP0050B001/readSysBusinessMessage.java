/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KP0050/src/com/nec/jp/orteus/metamorBase/KP0050/KP0050B001/readSysBusinessMessage.java,v $
 *
 ...
 * @version $Revision: 1.12 $ $Date: 2015/12/03 08:54:00 $
 */
...
public class readSysBusinessMessage extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN2_R(m_med.getsysBusinessIN_MEG_CD());
	 ...
	 *
		 */
	public readSysBusinessMessage(medKP0050B001 med, BatchAppConductor cdr) throws SystemException
	{
