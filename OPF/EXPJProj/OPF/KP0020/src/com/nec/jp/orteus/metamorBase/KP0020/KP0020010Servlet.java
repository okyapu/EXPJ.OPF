/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KP0020/src/com/nec/jp/orteus/metamorBase/KP0020/KP0020010Servlet.java,v $
 *
...
public class KP0020010Servlet extends HttpServlet
{
	 ...
	 * @param control KP0020010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, KP0020010Control control)
	{
		if (params == null) {
...
//{{user_implement_dev:<setScreenMoveParams>
		...
		// TODO: ユーザ定義のコードを記述してください
		String[] IN_SALES_PLAN_CD = (String[]) params.get("SALES_PLAN_CD");
		control.setIN_SALES_PLAN_CD((IN_SALES_PLAN_CD == null) ? null : IN_SALES_PLAN_CD[0]);
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control KP0020010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, KP0020010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					KP0020010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		KP0020010Entity entity = control.entity;
		KP0020010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("KP0020010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
			// TODO: ユーザ定義のコードを記述してください
//			LogWriter.write( Level.ALL, "KP0020010"+" $Revision: 1.11 $" );
			control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("KP0020010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					KP0020010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		KP0020010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KP0020");
		logger.entering("KP0020010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
...
//			e.printStackTrace();
//			LogWriter.write(Level.ALL, objMessage.getIDMsg("KP0020010-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
		}
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("KP0020010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickSelect(
					...
					HttpSession so,
					Hashtable params,
					KP0020010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		KP0020010Entity entity = control.entity;
		KP0020010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KP0020");
		logger.entering("KP0020010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickSelect>
		logger.exiting("KP0020010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
					...
					KP0020010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KP0020");
		logger.entering("KP0020010Servlet"+":USER="+request.getRemoteUser(),"onClickUpdate");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickUpdate>
		logger.exiting("KP0020010Servlet"+":USER="+request.getRemoteUser(),"onClickUpdate");
					...
					KP0020010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KP0020");
		logger.entering("KP0020010Servlet"+":USER="+request.getRemoteUser(),"onClickDelete");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickDelete>
		logger.exiting("KP0020010Servlet"+":USER="+request.getRemoteUser(),"onClickDelete");
					...
					KP0020010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KP0020");
		logger.entering("KP0020010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("KP0020010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
					...
					KP0020010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KP0020");
		logger.entering("KP0020010Servlet"+":USER="+request.getRemoteUser(),"onClickClose");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClose>
		logger.exiting("KP0020010Servlet"+":USER="+request.getRemoteUser(),"onClickClose");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, KP0020010Struct struct)
	{
		String locale = (String) so.getAttribute("LOCALE");
		
		String[] IN_SALES_PLAN_CD = ((params.containsKey("IN_SALES_PLAN_CD")) ? (String[])params.get("IN_SALES_PLAN_CD") : (String[])null);
		...
		struct.setIN_SALES_PLAN_CD( ((IN_SALES_PLAN_CD == null) ? (String)null : IN_SALES_PLAN_CD[0]) );
		struct.setList_IN_SALES_PLAN_CD(TypeConverter.convert(IN_SALES_PLAN_CD));
	...
	public static String DEFAULT_TARGET = "/KP0020010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aKP0020010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aKP0020010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KP0020");
		logger.entering("KP0020010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("KP0020010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		KP0020010Control control;
		KP0020010Entity  entity = null;
		KP0020010Struct  struct = null;
		...
		try {
			...
			if( (control = (KP0020010Control)so.getAttribute("KP0020010Control_"+request.getSession(false).getId())) == null ) {
				control = new KP0020010Control();
			...
			try {
				...
				so.setAttribute("KP0020010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.KP0020.KP0020010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public KP0020010Servlet()
	{
		//{{user_implement_dev:<KP0020010_DisConnect_FLG>
		...
		//{{user_implement_dev:<KP0020010Servlet>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<KP0020010Servlet>
	}
