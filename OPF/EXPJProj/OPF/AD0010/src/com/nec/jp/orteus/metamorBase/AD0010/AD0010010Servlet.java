...
public class AD0010010Servlet extends HttpServlet
{
	 ...
	 * @param control AD0010010Controlクラスインスタンス
	 */
...
//			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AD0010010-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
		}
                //}}user_implement_dev:<reloadEvent>
...
//			e.printStackTrace();
	...
	public static String DEFAULT_TARGET = "/AD0010010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAD0010010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAD0010010Struct";   // JSP先のバインド名(Struct)の指定
