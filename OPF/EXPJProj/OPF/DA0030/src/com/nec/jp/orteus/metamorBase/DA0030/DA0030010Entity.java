/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DA0030/src/com/nec/jp/orteus/metamorBase/DA0030/DA0030010Entity.java,v $
 *
...
public class DA0030010Entity extends DataObject
{
	...
	// M_PROC_COST_Lockクラス インスタンス
	public M_PROC_COST_Lock mM_PROC_COST_Lock = new M_PROC_COST_Lock();

	// M_PROC_COSTクラス インスタンス
	public M_PROC_COST mM_PROC_COST = new M_PROC_COST();

	// M_PROC_COST_Deleteクラス インスタンス
	public M_PROC_COST_Delete mM_PROC_COST_Delete = new M_PROC_COST_Delete();

	// M_PROC_COST_CancelDeleteクラス インスタンス
	public M_PROC_COST_CancelDelete mM_PROC_COST_CancelDelete = new M_PROC_COST_CancelDelete();
...
+"";		//////////////////////////////
	...
	public class ei_CSVOut extends DataObject
	{
		...
		String m_write_fname="DA0030010.csv";

		protected WriteCsv m_writer=null;		// csv書込み用

		String m_ProjName="DA0030010";
...
+"  to_char(M_PROC_COST.MODIFY_COUNT) as MODIFY_COUNT "
+"from "
+"  M_PROC_COST "
+"where "
...
+"  and M_PROC_COST.PROC_COST_CLS_CD = ?";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, DA0030010Struct data) throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, DA0030010Struct data, String replaceStr)
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, DA0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, DA0030010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, DA0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, DA0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(PreparedStatement stmt, DA0030010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public PreparedStatement prepare(Connection conn, String query, DA0030010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt;
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public ResultSet executeQuery(PreparedStatement stmt, DA0030010Struct data) throws FoundationException, SQLException
		{
			int no=1;
		 ...
		 * レコードデータをStructに格納して返します
		 */
		public DA0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			if(rs.next()==false) return null;

			DA0030010Struct data = new DA0030010Struct();

			data.setPROC_COST_UNIT_QTY( getString(1, rs) );
			data.setSTOCK_UNIT( getString(2, rs) );
			data.setPROC_COST_01( getString(3, rs) );
			data.setPROC_COST_02( getString(4, rs) );
			data.setPROC_COST_03( getString(5, rs) );
			data.setPROC_COST_04( getString(6, rs) );
			data.setPROC_COST_05( getString(7, rs) );
			data.setPROC_COST_06( getString(8, rs) );
			data.setPROC_COST_07( getString(9, rs) );
			data.setPROC_COST_08( getString(10, rs) );
			data.setPROC_COST_09( getString(11, rs) );
			data.setPROC_COST_10( getString(12, rs) );
			data.setPROC_COST_11( getString(13, rs) );
			data.setPROC_COST_12( getString(14, rs) );
			data.setPROC_COST_SUM( getString(15, rs) );
			data.setDEL_FLG( getString(16, rs) );
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(IDbConnection conn, DA0030010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(Connection conn, DA0030010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(IDbConnection conn, DA0030010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(Connection conn, DA0030010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(PreparedStatement stmt, DA0030010Struct data) throws FoundationException, SQLException
		{
			ResultSet rs=executeQuery(stmt, data);
			boolean ret=true;
	 ...
	 * Entity定義 静的SQL
	 */
	public class M_PROC_COST_Lock extends DataObject
	{
		protected String m_selcmd = "select "
+"  to_char(M_PROC_COST.\"MODIFY_COUNT\") as \"MODIFY_COUNT\" "
+"from "
...
+"for update nowait";
		...
		//{{user_implement_dev:M_PROC_COST_Lock_def
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:M_PROC_COST_Lock_def
		...
		public List read(Connection conn, DA0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:M_PROC_COST_Lock_read
                        if(m_selcmd==null) throw new FoundationException("M_PROC_COST_Lock", "read", "クエリー未登録");
		...
		public List read(Connection conn, DA0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:M_PROC_COST_Lock_read2
			if(m_selcmd==null) throw new FoundationException("M_PROC_COST_Lock", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, DA0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:M_PROC_COST_Lock_read3
			if(m_selcmd==null) throw new FoundationException("M_PROC_COST_Lock", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean hasRecord(Connection conn, DA0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("M_PROC_COST_Lock", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, DA0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:M_PROC_COST_Lock_check
                        PreparedStatement stmt;
                        ...
                        if(m_chkcmd!=null) {
                         ...
                         throw new FoundationException("M_PROC_COST_Lock", "check", "クエリー未登録");
                        }
		...
		public void clear()
		{
			//{{user_implement_dev:M_PROC_COST_Lock_clear
                         // todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:M_PROC_COST_Lock_clear
		...
		/**
		 * M_PROC_COST_Lockクラスの標準コンストラクタ
		 */
		public M_PROC_COST_Lock()
		{
			//{{user_implement_dev:M_PROC_COST_Lock_constractor
                         // TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:M_PROC_COST_Lock_constractor
...
+"  M_PROC_COST(\"YEAR\", \"HALF_TERM_TYP\", \"COST_TYP\", \"PLANT_CD\", \"CS_PROC_CD\", \"PROC_COST_CLS_CD\", \"PROC_COST_UNIT_QTY\", \"STOCK_UNIT\", \"PROC_COST_01\", \"PROC_COST_02\", \"PROC_COST_03\", \"PROC_COST_04\", \"PROC_COST_05\", \"PROC_COST_06\", \"PROC_COST_07\", \"PROC_COST_08\", \"PROC_COST_09\", \"PROC_COST_10\", \"PROC_COST_11\", \"PROC_COST_12\", \"PROC_COST_SUM\", \"UPDATE_TYP\", \"DEL_FLG\") "
+"values "
+"  (to_number(?), to_number(?), to_number(?), ?, ?, ?, to_number(?), ?, to_number(?), to_number(?), to_number(?), to_number(?), to_number(?), to_number(?), to_number(?), to_number(?), to_number(?), to_number(?), to_number(?), to_number(?), to_number(?), 2, 0)";
		protected String m_updcmd = "update "
+"  M_PROC_COST "
+"set "
+"  \"PROC_COST_UNIT_QTY\" = to_number(?), "
+"  \"STOCK_UNIT\" = ?, "
+"  \"PROC_COST_01\" = to_number(?), "
+"  \"PROC_COST_02\" = to_number(?), "
+"  \"PROC_COST_03\" = to_number(?), "
+"  \"PROC_COST_04\" = to_number(?), "
+"  \"PROC_COST_05\" = to_number(?), "
+"  \"PROC_COST_06\" = to_number(?), "
+"  \"PROC_COST_07\" = to_number(?), "
+"  \"PROC_COST_08\" = to_number(?), "
+"  \"PROC_COST_09\" = to_number(?), "
+"  \"PROC_COST_10\" = to_number(?), "
+"  \"PROC_COST_11\" = to_number(?), "
+"  \"PROC_COST_12\" = to_number(?), "
+"  \"PROC_COST_SUM\" = to_number(?), "
+"  \"UPDATE_TYP\" = 2, "
+"  \"DEL_FLG\" = 0 "
+"where "
+"  M_PROC_COST.\"YEAR\" = to_number(?) "
...
+"  and M_PROC_COST.\"PROC_COST_CLS_CD\" = ?";
		...
		protected String m_sCreateProgramName="DA0030010";
		protected String m_sUpdateProgramName="DA0030010";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int create(IDbConnection conn, DA0030010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int create(Connection conn, DA0030010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt=null;
			...
			try {
				...
				setString(11, data.getCS_PROC_CD(), stmt);
				setString(12, data.getPROC_COST_CLS_CD(), stmt);
				setString(13, data.getPROC_COST_UNIT_QTY(), stmt);
				setString(14, data.getSTOCK_UNIT(), stmt);
				setString(15, data.getPROC_COST_01(), stmt);
				setString(16, data.getPROC_COST_02(), stmt);
				setString(17, data.getPROC_COST_03(), stmt);
				setString(18, data.getPROC_COST_04(), stmt);
				setString(19, data.getPROC_COST_05(), stmt);
				setString(20, data.getPROC_COST_06(), stmt);
				setString(21, data.getPROC_COST_07(), stmt);
				setString(22, data.getPROC_COST_08(), stmt);
				setString(23, data.getPROC_COST_09(), stmt);
				setString(24, data.getPROC_COST_10(), stmt);
				setString(25, data.getPROC_COST_11(), stmt);
				setString(26, data.getPROC_COST_12(), stmt);
				setString(27, data.getPROC_COST_SUM(), stmt);
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int update(IDbConnection conn, DA0030010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int update(Connection conn, DA0030010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt=null;
			int modifyCount;
			...
			try {
				...
				setString(4, data.getPROC_COST_UNIT_QTY(), stmt);
				setString(5, data.getSTOCK_UNIT(), stmt);
				setString(6, data.getPROC_COST_01(), stmt);
				setString(7, data.getPROC_COST_02(), stmt);
				setString(8, data.getPROC_COST_03(), stmt);
				setString(9, data.getPROC_COST_04(), stmt);
				setString(10, data.getPROC_COST_05(), stmt);
				setString(11, data.getPROC_COST_06(), stmt);
				setString(12, data.getPROC_COST_07(), stmt);
				setString(13, data.getPROC_COST_08(), stmt);
				setString(14, data.getPROC_COST_09(), stmt);
				setString(15, data.getPROC_COST_10(), stmt);
				setString(16, data.getPROC_COST_11(), stmt);
				setString(17, data.getPROC_COST_12(), stmt);
				setString(18, data.getPROC_COST_SUM(), stmt);
				setString(19, data.getYEAR(), stmt);
				setString(20, data.getHALF_TERM_TYP(), stmt);
				setString(21, data.getCOST_TYP(), stmt);
				setString(22, data.getPLANT_CD(), stmt);
				setString(23, data.getCS_PROC_CD(), stmt);
				setString(24, data.getPROC_COST_CLS_CD(), stmt);
	 ...
	 * Entity定義 静的SQL
	 */
	public class M_PROC_COST_Delete extends DataObject
	{
...
+"  and M_PROC_COST.\"PROC_COST_CLS_CD\" = ?";
		...
		//{{user_implement_dev:M_PROC_COST_Delete_def
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:M_PROC_COST_Delete_def
		...
		public int update(Connection conn, DA0030010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				...
				setString(2, data.getsUser_ID(), stmt);
				setString(3, m_sUpdateProgramName, stmt);
				setString(4, data.getYEAR(), stmt);
				setString(5, data.getHALF_TERM_TYP(), stmt);
				setString(6, data.getCOST_TYP(), stmt);
		...
		public void clear()
		{
			//{{user_implement_dev:M_PROC_COST_Delete_clear
                         // todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:M_PROC_COST_Delete_clear
		...
		/**
		 * M_PROC_COST_Deleteクラスの標準コンストラクタ
		 */
		public M_PROC_COST_Delete()
		{
			//{{user_implement_dev:M_PROC_COST_Delete_constractor
                         // TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:M_PROC_COST_Delete_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class M_PROC_COST_CancelDelete extends DataObject
	{
		protected String m_selcmd = null;
		protected String m_chkcmd = null;
		protected String m_inscmd = null;
...
+"  and M_PROC_COST.\"PROC_COST_CLS_CD\" = ?";
		...
		//{{user_implement_dev:M_PROC_COST_CancelDelete_def
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:M_PROC_COST_CancelDelete_def
		...
		public void clear()
		{
			//{{user_implement_dev:M_PROC_COST_CancelDelete_clear
                         // todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:M_PROC_COST_CancelDelete_clear
		...
		/**
		 * M_PROC_COST_CancelDeleteクラスの標準コンストラクタ
		 */
		public M_PROC_COST_CancelDelete()
		{
			//{{user_implement_dev:M_PROC_COST_CancelDelete_constractor
                         // TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:M_PROC_COST_CancelDelete_constractor
...
+"  and M_PROC_COST_CLS.\"PROC_COST_CLS_CD\" = ?";
		...
		public DA0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setPROC_COST_02_NAME( getString(3, rs) );
			data.setPROC_COST_03_NAME( getString(4, rs) );
			data.setPROC_COST_04_NAME( getString(5, rs) );
			data.setPROC_COST_05_NAME( getString(6, rs) );
			data.setPROC_COST_06_NAME( getString(7, rs) );
			data.setPROC_COST_07_NAME( getString(8, rs) );
			data.setPROC_COST_08_NAME( getString(9, rs) );
			data.setPROC_COST_09_NAME( getString(10, rs) );
			data.setPROC_COST_10_NAME( getString(11, rs) );
			data.setPROC_COST_11_NAME( getString(12, rs) );
			data.setPROC_COST_12_NAME( getString(13, rs) );
...
+"  and M_HOME_CUR.CUR_CD = SYS_HOME_CUR.HOME_CUR_CD";
	...
	public void clear()
	{
		mForm.clear();
		mForm = null;
		mM_PROC_COST_Lock.clear();
		mM_PROC_COST_Lock = null;
		mM_PROC_COST.clear();
		mM_PROC_COST = null;
		mM_PROC_COST_Delete.clear();
		mM_PROC_COST_Delete = null;
		mM_PROC_COST_CancelDelete.clear();
		mM_PROC_COST_CancelDelete = null;
	 ...
	 */
	public DA0030010Entity() throws FoundationException
	{
