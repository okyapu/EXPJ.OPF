/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DB0030/src/com/nec/jp/orteus/metamorBase/DB0030/DB0030B001/M_SBCNT_UNIT_COST.java,v $
 *
...
public class M_SBCNT_UNIT_COST extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN18_R(m_med.getPLANT_CD());
				setIN19_R(m_med.getYYYYMM());
				setIN20_R(m_med.getYYYYMM());
				setIN21_R(m_med.getPLANT_CD());
				setIN22_R(m_med.getYYYYMM());
				setIN23_R(m_med.getYEAR());
				setIN24_R(m_med.getHALF_TERM_TYP());
				setIN25_R(m_med.getCOST_TYP());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("M_SBCNT_UNIT_COST", "read", "レコード検索条件設定処理失敗");
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				BatchAppException be=new BatchAppException("M_SBCNT_UNIT_COST", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("M_SBCNT_UNIT_COST", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	...
	/**
	 * M_SBCNT_UNIT_COSTクラスの標準コンストラクタ
	 *
		 */
	public M_SBCNT_UNIT_COST(medDB0030B001 med, BatchAppConductor cdr) throws SystemException
	{
...
+"  UNIT_COST.\"PROC_CD\" as \"PROC_CD\", "
+"  to_char(UNIT_COST.\"EFF_PHASE_IN_DATE\", 'YYYY/MM/DD HH24:MI:SS') as \"EFF_PHASE_IN_DATE\", "
+"  UNIT_COST.\"VEND_CD\" as \"VEND_CD\", "
+"  to_char(trunc(decode(UNIT_COST.\"SBCNT_SIZE\", 0, M_SBCNT_UNIT_COST.\"UNIT_COST\", M_SBCNT_UNIT_COST.\"UNIT_COST\" * UNIT_COST.\"SBCNT_SIZE\") + 0.00009, 4)) as \"UNIT_COST\", "
+"  to_char(M_SBCNT_UNIT_COST.\"UNIT_COST_TYP\") as \"UNIT_COST_TYP\", "
+"  M_VEND_CTRL.\"CUR_CD\" as \"CUR_CD\", "
+"  to_char(decode(M_EXCH_RATE.\"EXCH_RATE\", null, 1, M_EXCH_RATE.\"EXCH_RATE\")) as \"EXCH_RATE\", "
+"  to_char(decode(UNIT_COST.\"SBCNT_SIZE\", 0, 1, UNIT_COST.SBCNT_SIZE)) as \"PUCH_SIZE\", "
+"  M_ITEM.\"CLASIFICATION_CD\" as \"CLASIFICATION_CD\", "
+"  M_SBCNT_UNIT_COST.\"COMPANY_CD\" as \"COMPANY_CD\", "
+"  SYS_COST_CTRL.\"ORG_CD\" as \"ORG_CD\", "
+"  M_ITEM.\"STOCK_UNIT\" as \"STOCK_UNIT\", "
+"  to_char(decode(M_CONS_UNIT_COST.\"ONEROUS_FLG\", null, 0, M_CONS_UNIT_COST.\"ONEROUS_FLG\")) as \"ONEROUS_FLG\", "
+"  to_char(M_SBCNT_UNIT_COST.\"UPDATED_DATE\", 'YYYY/MM/DD HH24:MI:SS') as \"UPDATED_DATE\", "
+"  decode(T_CS_PUCH_IF.\"PLANT_CD\", null, '1', '2') as \"TRANSACTION_TYP\", "
+"  to_char(T_CS_PUCH_IF.\"SAVE_UPDATED_DATE\", 'YYYY/MM/DD HH24:MI:SS') as \"SAVE_UPDATED_DATE\" "
+"from "
+"  M_SBCNT_UNIT_COST, "
+"  M_VEND_CTRL, "
+"  M_ITEM, "
...
+"      min(UNIT_COST.\"SBCNT_SIZE\") as \"SBCNT_SIZE\" "
+"    from "
+"      M_SBCNT_UNIT_COST UNIT_COST, "
+"      ( "
+"        select "
+"          UNIT_COST.\"COMPANY_CD\" as \"COMPANY_CD\", "
+"          UNIT_COST.\"VEND_CD\" as \"VEND_CD\", "
...
+"      and UNIT_COST.\"PROC_CD\" = UNIT_COST_2.\"PROC_CD\" "
...
+"      ) CONS "
+"    where "
+"      CONS.\"COMPANY_CD\" = M_CONS_UNIT_COST.\"COMPANY_CD\" "
+"      and CONS.\"PLANT_CD\" = M_CONS_UNIT_COST.\"PLANT_CD\" "
+"      and CONS.\"ITEM_CD\" = M_CONS_UNIT_COST.\"ITEM_CD\" "
+"      and CONS.\"EFF_PHASE_IN_DATE\" = M_CONS_UNIT_COST.\"EFF_PHASE_IN_DATE\" "
+"    group by "
+"      M_CONS_UNIT_COST.\"COMPANY_CD\", "
+"      M_CONS_UNIT_COST.\"PLANT_CD\", "
+"      M_CONS_UNIT_COST.\"ITEM_CD\" "
...
+"  SYS_MY_COMPANY "
+"where "
+"  UNIT_COST.\"COMPANY_CD\" = M_SBCNT_UNIT_COST.\"COMPANY_CD\" "
+"  and UNIT_COST.\"VEND_CD\" = M_SBCNT_UNIT_COST.\"VEND_CD\" "
+"  and UNIT_COST.\"PLANT_CD\" = M_SBCNT_UNIT_COST.\"PLANT_CD\" "
+"  and UNIT_COST.\"ITEM_CD\" = M_SBCNT_UNIT_COST.\"ITEM_CD\" "
+"  and UNIT_COST.\"PROC_CD\" = M_SBCNT_UNIT_COST.\"PROC_CD\" "
+"  and UNIT_COST.\"EFF_PHASE_IN_DATE\" = M_SBCNT_UNIT_COST.\"EFF_PHASE_IN_DATE\" "
+"  and UNIT_COST.\"SBCNT_SIZE\" = M_SBCNT_UNIT_COST.\"SBCNT_SIZE\" "
...
+"  and UNIT_COST.\"COMPANY_CD\" = M_CONS_UNIT_COST.\"COMPANY_CD\"(+) "
+"  and UNIT_COST.\"PLANT_CD\" = M_CONS_UNIT_COST.\"PLANT_CD\"(+) "
+"  and UNIT_COST.\"ITEM_CD\" = M_CONS_UNIT_COST.\"ITEM_CD\"(+) "
+"  and M_VEND_CTRL.\"COMPANY_CD\" = M_EXCH_RATE.\"COMPANY_CD\"(+) "
+"  and M_VEND_CTRL.\"CUR_CD\" = M_EXCH_RATE.\"CUR_CD\"(+) "
+"  and M_VEND_CTRL.\"EXCH_TYP\" = M_EXCH_RATE.\"EXCH_TYP\"(+) "
+"  and T_CS_PUCH_IF.\"YEAR\"(+) = to_number(?) "
+"  and T_CS_PUCH_IF.\"HALF_TERM_TYP\"(+) = to_number(?) "
+"  and T_CS_PUCH_IF.\"COST_TYP\"(+) = to_number(?) "
+"  and UNIT_COST.\"PLANT_CD\" = T_CS_PUCH_IF.\"PLANT_CD\"(+) "
+"  and UNIT_COST.\"ITEM_CD\" = T_CS_PUCH_IF.\"ITEM_CD\"(+) "
+"  and UNIT_COST.\"PROC_CD\" = T_CS_PUCH_IF.\"CS_PROC_CD\"(+) "
+"  and UNIT_COST.\"VEND_CD\" = T_CS_PUCH_IF.\"VEND_CD\"(+) "
+"  and UNIT_COST.\"EFF_PHASE_IN_DATE\" = T_CS_PUCH_IF.\"EFF_PHASE_IN_DATE\"(+) "
