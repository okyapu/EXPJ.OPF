/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DB0030/src/com/nec/jp/orteus/metamorBase/DB0030/DB0030B001/M_CS_PROC.java,v $
 *
 ...
 * @version $Revision: 1.7 $ $Date: 2014/11/05 07:21:37 $
 */
...
public class M_CS_PROC extends AbstractBatchAppEntity
{
	 ...
	 *
		 */
	public M_CS_PROC(medDB0030B001 med, BatchAppConductor cdr) throws SystemException
	{
...
+"  M_CS_PROC.\"PLANT_CD\" as \"PLANT_CD\", "
+"  M_CS_PROC.\"CS_PROC_CD\" as \"CS_PROC_CD\" "
+"from "
+"  M_CS_PROC "
+"where "
+"  M_CS_PROC.\"PLANT_CD\" = ? "
