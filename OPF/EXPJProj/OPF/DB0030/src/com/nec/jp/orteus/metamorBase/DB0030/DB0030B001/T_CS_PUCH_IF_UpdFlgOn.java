/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DB0030/src/com/nec/jp/orteus/metamorBase/DB0030/DB0030B001/T_CS_PUCH_IF_UpdFlgOn.java,v $
 *
...
/**
 * CLASS     : T_CS_PUCH_IF_UpdFlgOn クラス
 * ファイル・クラス説明
 * @author $Author: xl-hs-zzw $
 * @version $Revision: 1.7 $ $Date: 2014/11/05 07:21:40 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class T_CS_PUCH_IF_UpdFlgOn extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int update() throws BatchAppException
		{
			try {
				...
				BatchAppException be=new BatchAppException("T_CS_PUCH_IF_UpdFlgOn", "update", "レコード更新条件設定処理失敗");
	...
	void prepareAll() throws BatchAppException
	{
		...
		try {
			...
			BatchAppException be=new BatchAppException("T_CS_PUCH_IF_UpdFlgOn", "prepareALL(FoundationException)", "SQL文のprepareで失敗しました");
			be.addMessage(e.getErrmsg());
			throw be;
		} catch(SQLException e) {
			BatchAppException be=new BatchAppException("T_CS_PUCH_IF_UpdFlgOn", "prepareALL(SQLException)", "SQL文のprepareで失敗しました");
			throw be;
		}
	...
	/**
	 * T_CS_PUCH_IF_UpdFlgOnクラスの標準コンストラクタ
	 *
		 */
	public T_CS_PUCH_IF_UpdFlgOn(medDB0030B001 med, BatchAppConductor cdr) throws SystemException
	{
