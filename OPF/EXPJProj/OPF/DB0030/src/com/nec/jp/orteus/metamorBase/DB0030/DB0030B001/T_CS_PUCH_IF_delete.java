/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DB0030/src/com/nec/jp/orteus/metamorBase/DB0030/DB0030B001/T_CS_PUCH_IF_delete.java,v $
 *
...
public class T_CS_PUCH_IF_delete extends AbstractBatchAppEntity
{
	 ...
	 *
		 */
	public T_CS_PUCH_IF_delete(medDB0030B001 med, BatchAppConductor cdr) throws SystemException
	{
...
+"      M_SBCNT_UNIT_COST "
+"    where "
+"      M_SBCNT_UNIT_COST.\"COMPANY_CD\" = T_CS_PUCH_IF.\"COMPANY_CD\" "
+"      and M_SBCNT_UNIT_COST.\"PLANT_CD\" = T_CS_PUCH_IF.\"PLANT_CD\" "
+"      and M_SBCNT_UNIT_COST.\"ITEM_CD\" = T_CS_PUCH_IF.\"ITEM_CD\" "
+"  )";
