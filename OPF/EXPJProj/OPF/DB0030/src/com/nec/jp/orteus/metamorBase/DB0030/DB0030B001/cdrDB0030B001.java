/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DB0030/src/com/nec/jp/orteus/metamorBase/DB0030/DB0030B001/cdrDB0030B001.java,v $
 *
...
public class cdrDB0030B001 extends Object
		implements IBatchAppCommon
{
	...
	public void initialize() throws BatchAppException, SystemException
	{
		try {
			...
			m_med.setM_SBCNT_UNIT_COST( new M_SBCNT_UNIT_COST(m_med, m_conductor) );
			...
			m_conductor.addObject( m_med.getM_SBCNT_UNIT_COST() );
	...
	public int beginProc() throws BatchAppException
	{
		try {
			...
			setCommitFlag(false);
			BatchAppException be=new BatchAppException("cdrDB0030B001", "beginProc", "conductorの初期処理に失敗しました");
	...
	medDB0030B001 m_med=new medDB0030B001();

	// BatchAppConductorクラスインスタンス
	BatchAppConductor m_conductor=new BatchAppConductor("DB0030B001");
	...
	/**
	 * ctrDB0030B001クラス 標準コンストラクタ
	 *
		 */
	public cdrDB0030B001() throws BatchAppException
	{
		initialize();
