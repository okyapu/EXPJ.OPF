/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DB0030/src/com/nec/jp/orteus/metamorBase/DB0030/DB0030B001/M_CS_PUCH_delete.java,v $
 *
...
public class M_CS_PUCH_delete extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int update() throws BatchAppException
		{
			try {
				...
				setIN4_U(m_med.getITEM_CD());
				setIN5_U(m_med.getPROC_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("M_CS_PUCH_delete", "update", "レコード更新条件設定処理失敗");
	...
	void prepareAll() throws BatchAppException
	{
		...
		try {
			...
			BatchAppException be=new BatchAppException("M_CS_PUCH_delete", "prepareALL(FoundationException)", "SQL文のprepareで失敗しました");
			be.addMessage(e.getErrmsg());
			throw be;
		} catch(SQLException e) {
			BatchAppException be=new BatchAppException("M_CS_PUCH_delete", "prepareALL(SQLException)", "SQL文のprepareで失敗しました");
			throw be;
		}
	...
	/**
	 * M_CS_PUCH_deleteクラスの標準コンストラクタ
	 *
		 */
	public M_CS_PUCH_delete(medDB0030B001 med, BatchAppConductor cdr) throws SystemException
	{
