/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KM0030/src/com/nec/jp/orteus/metamorBase/KM0030/KM0030010Entity.java,v $
 *
...
public class KM0030010Entity extends DataObject
{
	...
	// T_ESTIMATEクラス インスタンス
	public T_ESTIMATE mT_ESTIMATE = new T_ESTIMATE();

	// T_ESTIMATE_DETALクラス インスタンス
	public T_ESTIMATE_DETAL mT_ESTIMATE_DETAL = new T_ESTIMATE_DETAL();

	// T_ESTIMATE2クラス インスタンス
	public T_ESTIMATE2 mT_ESTIMATE2 = new T_ESTIMATE2();

	// CHECK_JOB_ODR_CDクラス インスタンス
	public CHECK_JOB_ODR_CD mCHECK_JOB_ODR_CD = new CHECK_JOB_ODR_CD();

	// CHECK_M_ITEMクラス インスタンス
	public CHECK_M_ITEM mCHECK_M_ITEM = new CHECK_M_ITEM();
	...
	// TBL_T_ESTIMATEクラス インスタンス
	public TBL_T_ESTIMATE mTBL_T_ESTIMATE = new TBL_T_ESTIMATE();

	// CAL_T_ESTIMATEクラス インスタンス
	public CAL_T_ESTIMATE mCAL_T_ESTIMATE = new CAL_T_ESTIMATE();
	...
	// readT_ODR_CTLクラス インスタンス
	public readT_ODR_CTL mreadT_ODR_CTL = new readT_ODR_CTL();

	// TBL_T_ODR_UNSTOCKクラス インスタンス
	public TBL_T_ODR_UNSTOCK mTBL_T_ODR_UNSTOCK = new TBL_T_ODR_UNSTOCK();

	// DEL_T_ODRクラス インスタンス
	public DEL_T_ODR mDEL_T_ODR = new DEL_T_ODR();

	// T_SERVICEクラス インスタンス
	public T_SERVICE mT_SERVICE = new T_SERVICE();

	// CHECK_STS_T_ESTIMATE_DETALクラス インスタンス
	public CHECK_STS_T_ESTIMATE_DETAL mCHECK_STS_T_ESTIMATE_DETAL = new CHECK_STS_T_ESTIMATE_DETAL();

	// MODIFY_CNT_T_ESTIMATEクラス インスタンス
	public MODIFY_CNT_T_ESTIMATE mMODIFY_CNT_T_ESTIMATE = new MODIFY_CNT_T_ESTIMATE();

	// UPD_REST_T_ESTIMATEクラス インスタンス
	public UPD_REST_T_ESTIMATE mUPD_REST_T_ESTIMATE = new UPD_REST_T_ESTIMATE();

	// SYS_JOB_ODR_CD_CTRLクラス インスタンス
	public SYS_JOB_ODR_CD_CTRL mSYS_JOB_ODR_CD_CTRL = new SYS_JOB_ODR_CD_CTRL();

	// SEQ_ODR_UNSTOCKクラス インスタンス
	public SEQ_ODR_UNSTOCK mSEQ_ODR_UNSTOCK = new SEQ_ODR_UNSTOCK();

	// HS_T_ODR_UNSTOCKクラス インスタンス
	public HS_T_ODR_UNSTOCK mHS_T_ODR_UNSTOCK = new HS_T_ODR_UNSTOCK();
	...
	// CHECK_M_ITEM_SPECクラス インスタンス
	public CHECK_M_ITEM_SPEC mCHECK_M_ITEM_SPEC = new CHECK_M_ITEM_SPEC();

	// M_ITEMクラス インスタンス
	public M_ITEM mM_ITEM = new M_ITEM();

	// T_ESTIMATE_Rクラス インスタンス
	public T_ESTIMATE_R mT_ESTIMATE_R = new T_ESTIMATE_R();

	// selectT_ANS_DLV_DATEクラス インスタンス
	public selectT_ANS_DLV_DATE mselectT_ANS_DLV_DATE = new selectT_ANS_DLV_DATE();

	// T_ESTIMATE2_Rクラス インスタンス
	public T_ESTIMATE2_R mT_ESTIMATE2_R = new T_ESTIMATE2_R();

	// selectM_ITEMクラス インスタンス
	public selectM_ITEM mselectM_ITEM = new selectM_ITEM();

	// selectT_TRAN_APRクラス インスタンス
	public selectT_TRAN_APR mselectT_TRAN_APR = new selectT_TRAN_APR();

	// selectT_TRAN_APR1クラス インスタンス
	public selectT_TRAN_APR1 mselectT_TRAN_APR1 = new selectT_TRAN_APR1();

	// T_ESTIMATE_DETAL1クラス インスタンス
	public T_ESTIMATE_DETAL1 mT_ESTIMATE_DETAL1 = new T_ESTIMATE_DETAL1();

	// T_JOB_ODR_Rクラス インスタンス
	public T_JOB_ODR_R mT_JOB_ODR_R = new T_JOB_ODR_R();

	// M_ITEM_SPEC2クラス インスタンス
	public M_ITEM_SPEC2 mM_ITEM_SPEC2 = new M_ITEM_SPEC2();
...
+"";		//////////////////////////////
	...
	public class ei_CSVOut extends DataObject
	{
		...
		String m_write_fname="KM0030010.csv";

		protected WriteCsv m_writer=null;		// csv書込み用

		String m_ProjName="KM0030010";
	...
	{
		protected String m_selcmd = "SELECT T_ESTIMATE_DETAL.\"PROJECT_CD\" AS \"PROJECT_CD\",T_ESTIMATE_DETAL.\"ESTIMATE_NO\" AS \"ESTIMATE_NO\",T_ESTIMATE_DETAL.\"DETAL_NO\" AS \"DETAL_NO\",M_CUST.\"CUST_NAME\" AS \"CUST_NAME\" "
+"FROM T_ESTIMATE_DETAL,M_CUST";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, KM0030010Struct data, String replaceStr)
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, KM0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, KM0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, KM0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(PreparedStatement stmt, KM0030010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public PreparedStatement prepare(Connection conn, String query, KM0030010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt;
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public ResultSet executeQuery(PreparedStatement stmt, KM0030010Struct data) throws FoundationException, SQLException
		{
			int no=1;
		 ...
		 * レコードデータをStructに格納して返します
		 */
		public KM0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			if(rs.next()==false) return null;

			KM0030010Struct data = new KM0030010Struct();

			data.setPROJECT_CD( getString(1, rs) );
			data.setESTIMATE_NO( getString(2, rs) );
			data.setl_DETAL_NO( getString(3, rs) );
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(IDbConnection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(IDbConnection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(PreparedStatement stmt, KM0030010Struct data) throws FoundationException, SQLException
		{
			ResultSet rs=executeQuery(stmt, data);
			boolean ret=true;
...
+"  T_PROJECT.\"PROJECT_CD\" = ?";
		...
		protected String m_sCreateProgramName="KM0030010";
		protected String m_sUpdateProgramName="KM0030010";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int update(IDbConnection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int update(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt=null;
			int modifyCount;
...
+"  AND CUST_CD = ?";
		...
		public KM0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setTAX_APPLY_TYP( getString(4, rs) );
			data.setTAX_CD( getString(5, rs) );
			data.setTAX_CALC_TYP( getString(6, rs) );
			data.setPARTIAL_SHIP_INST_FLG( getString(7, rs) );
...
+"  CUR_CD = ?";
	...
	{
		protected String m_selcmd = "SELECT "
+"  T_ESTIMATE.ES_USER_CD, "
+"  T_ESTIMATE.ES_ORG_CD, "
+"  T_ESTIMATE_DETAL.DETAL_NO, "
+"  T_ESTIMATE_DETAL.CUST_ITEM_CD, "
+"  T_ESTIMATE_DETAL.ESTIMATE_QTY, "
+"  T_ESTIMATE_DETAL.UNIT_CD, "
+"  T_ESTIMATE_DETAL.ESTIMATE_UNIT_PRICE, "
+"  T_ESTIMATE_DETAL.ESTIMATE_AMOUNT, "
...
+"  ( "
+"    SELECT "
+"      T_ESTIMATE.PROJECT_CD AS PROJECT_CD, "
+"      MAX(T_ESTIMATE.ESTIMATE_NO) AS ESTIMATE_NO "
+"    FROM "
+"      T_ESTIMATE "
+"    WHERE "
+"      T_ESTIMATE.PROJECT_CD = ? "
+"      AND(0 = ? "
+"      OR  T_ESTIMATE.ESTIMATE_NO = ?) "
+"      AND DEL_FLG = 0 "
+"    GROUP BY "
+"      T_ESTIMATE.PROJECT_CD "
+"  ) ESTIMATE, "
...
+"  M_ORG "
+"WHERE "
+"  T_ESTIMATE.PROJECT_CD = ESTIMATE.PROJECT_CD "
+"  AND T_ESTIMATE.ESTIMATE_NO = ESTIMATE.ESTIMATE_NO "
+"  AND T_ESTIMATE.PROJECT_CD = T_ESTIMATE_DETAL.PROJECT_CD "
+"  AND T_ESTIMATE.ESTIMATE_NO = T_ESTIMATE_DETAL.ESTIMATE_NO "
...
+"  ) "
+"  AND T_ESTIMATE.ES_USER_CD = USER_MST.USER_CD(+) "
+"  AND T_ESTIMATE.ES_ORG_CD = M_ORG.ORG_CD(+) "
+"  AND M_ORG.COMPANY_CD(+) = ?";
		...
		public KM0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setl_ES_USER_CD( getString(1, rs) );
			data.setl_ES_ORG_CD( getString(2, rs) );
			data.setl_DETAL_NO( getString(3, rs) );
			data.setl_CUST_ITEM_CD( getString(4, rs) );
			data.setl_ESTIMATE_QTY( getString(5, rs) );
			data.setl_UNIT_CD( getString(6, rs) );
			data.setl_ESTIMATE_UNIT_PRICE( getString(7, rs) );
			data.setl_ESTIMATE_AMOUNT( getString(8, rs) );
			data.setl_ESTIMATE_TYPE( getString(9, rs) );
			data.setl_ESTIMATE_ITEM_NAME( getString(10, rs) );
...
+"  AND M_CUST_BASE.CUST_CD = M_CUST.CUST_CD "
...
+"  AND M_CUST_BASE.DLV_LOC_CD = ?";
		...
		public KM0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setTRANSPORT_LT( getString(3, rs) );
			data.setTRANSPORT_CD( getString(4, rs) );
			data.setTRANSPORT_TYP( getString(5, rs) );
			data.setDEPO_WH_CD( getString(6, rs) );
			data.setSHIP_PLANT_CD( getString(7, rs) );
...
+"  AND M_ITEM_SPEC.ITEM_CD = M_ITEM.ITEM_CD";
		protected String m_chkcmd = null;
		protected String m_inscmd = null;
		protected String m_updcmd = null;
		protected String m_delcmd = null;
		...
		public KM0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setDEPO_TYP( getString(2, rs) );
			data.setCUST_ITEM_NAME( getString(3, rs) );
	...
	{
		protected String m_selcmd = "SELECT "
+"  T_PJ_ODR_ALC.ESTIMATE_TYPE, "
+"  T_PJ_ODR_ALC.ODR_NO "
+"FROM "
+"  T_PJ_ODR_ALC "
+"WHERE "
+"  T_PJ_ODR_ALC.PROJECT_CD = ? "
+"  AND T_PJ_ODR_ALC.ESTIMATE_NO = ? "
+"  AND(? IS NOT NULL "
+"  AND T_PJ_ODR_ALC.DETAL_NO = ? "
+"  OR  ? IS NULL)";
		protected String m_chkcmd = null;
		protected String m_inscmd = "INSERT INTO "
+"  T_PJ_ODR_ALC(\"PROJECT_CD\", \"ESTIMATE_NO\", \"DETAL_NO\", \"ODR_NO\", \"ESTIMATE_TYPE\") "
+"VALUES "
+"  (?, ?, ?, ?, ?)";
		protected String m_updcmd = null;
...
+"  AND T_PJ_ODR_ALC.\"DETAL_NO\" = ?";
		...
		public List read(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			...
			if(m_selcmd==null) throw new FoundationException("T_PJ_ODR_ALC", "read", "クエリー未登録");
		...
		public KM0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setESTIMATE_TYPE( getString(1, rs) );
			data.setODR_NO( getString(2, rs) );
		...
		public boolean hasRecord(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("T_PJ_ODR_ALC", "hasRecord", "クエリー未登録");
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int create(IDbConnection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int create(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt=null;
			...
			try {
				...
				setString(9, data.getDETAL_NO(), stmt);
				setString(10, data.getODR_NO(), stmt);
				setString(11, data.getESTIMATE_TYPE(), stmt);
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int delete(IDbConnection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int delete(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt=null;
			...
			try {
				...
				setString(2, data.getESTIMATE_NO(), stmt);
				setString(3, data.getDETAL_NO(), stmt);
...
+"  AND T_ODR.DEL_FLG = 0 "
+"  AND T_ODR.ODR_TYP = 3 "
+"  AND T_ODR.TOTAL_SHIP_QTY = 0 "
+"  AND T_ODR.ODR_NO = ? "
+"  AND T_ODR_CTL.CUST_CD = ? "
+"  AND M_ORG.COMPANY_CD(+) = ?";
		protected String m_chkcmd = null;
		protected String m_inscmd = "INSERT INTO "
+"  T_ODR(\"ODR_NO\", \"ODR_TYP\", \"ODR_CTL_NO\", \"CUST_ODR_NO\", \"CUST_CHRG_ORG_CD\", \"CUST_CHRG_PSN_CD\", \"ODR_ACPT_PSN_CD\", \"CURRNCY_CD\", \"EXCH_TYP\", \"DLV_LOC_CD\", \"DLV_LOC_NAME_KANJI\", \"ODR_UNIT_PRICE\", \"SPCL_PRICE_TYP\", \"DEPO_TYP\", \"DESINATED_DLV_DATE\", \"STD_DESINATED_RCV_DATE\", \"ODR_QTY\", \"REMAIN_UNCONFIRM_ODR_QTY\", \"CANCELED_UNCONFIRM_ODR_QTY\", \"UNIT_CD\", \"UNCONFIRM_ODR_BALANCE\", \"ODR_AMOUNT\", \"ODR_AMOUNT_EXCH_RATES\", \"ODR_CMPLT_FLG\", \"PART_NAME\", \"TRANSPORT_CD\", \"TRANSPORT_TYP\", \"TAX_APPLY_TYP\", \"TAX_CD\", \"TAX_CALC_TYP\", \"REMARKS\", \"ODR_ACPT_DATE\", \"SHIP_PLAN_REMAIN_QTY\", \"SHIP_PLAN_CMPLT_FLG\", \"UNCONFIRMED_ODR_EFF_OVR_FLG\", \"PARTIAL_SHIP_INST_FLG\", \"ENTRY_TYP\", \"DEL_FLG\", \"JOB_ODR_SET_FLG\") "
+"VALUES "
...
+"  T_ODR.\"ODR_NO\" = ?";
		...
		public KM0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setl_ODR_TYP( getString(2, rs) );
			data.setl_CUST_ODR_NO( getString(3, rs) );
			data.setl_CUST_ITEM_CD( getString(4, rs) );
			data.setl_ITEM_CD( getString(5, rs) );
			data.setl_DESINATED_DLV_DATE( getString(6, rs) );
			data.setl_ODR_QTY( getString(7, rs) );
			data.setl_UNIT_CD( getString(8, rs) );
			data.setl_ESTIMATE_UNIT_PRICE( getString(9, rs) );
			data.setl_ODR_AMOUNT( getString(10, rs) );
			data.setl_ODR_AMOUNT_EXCH_RATES( getString(11, rs) );
			data.setl_DLV_LOC_CD( getString(12, rs) );
			data.setl_DEPO_TYP( getString(13, rs) );
			data.setl_ODR_ACPT_DATE( getString(14, rs) );
			data.setl_REMARKS( getString(15, rs) );
			data.setl_OWN_PERSON_CD( getString(16, rs) );
			data.setl_TODR_MODIFY_COUNT( getString(17, rs) );
			data.setl_CUST_CHRG_PSN_NAME( getString(18, rs) );
			data.setl_OWN_ORG_CD( getString(19, rs) );
			data.setl_CUST_CHRG_ORG_NAME( getString(20, rs) );
		...
		public int create(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				...
				setString(5, data.getsUser_ID(), stmt);
				setString(6, m_sCreateProgramName, stmt);
				setString(7, data.getODR_NO(), stmt);
				setString(8, data.getODR_TYP(), stmt);
				setString(9, data.getODR_CTL_NO(), stmt);
				setString(10, data.getCUST_ODR_NO(), stmt);
				setString(11, data.getCUST_CHRG_ORG_CD(), stmt);
				setString(12, data.getCUST_CHRG_PSN_CD(), stmt);
				setString(13, data.getODR_ACPT_PSN_CD(), stmt);
				setString(14, data.getCURRNCY_CD(), stmt);
				setString(15, data.getEXCH_TYP(), stmt);
				setString(16, data.getDLV_LOC_CD(), stmt);
				setString(17, data.getDLV_LOC_NAME_KANJI(), stmt);
				setString(18, data.getODR_UNIT_PRICE(), stmt);
				setString(19, data.getSPCL_PRICE_TYP(), stmt);
				setString(20, data.getDEPO_TYP(), stmt);
				setString(21, data.getDESINATED_DLV_DATE(), stmt);
				setString(22, data.getSTD_DESINATED_RCV_DATE(), stmt);
				setString(23, data.getODR_QTY(), stmt);
				setString(24, data.getREMAIN_UNCONFIRM_ODR_QTY(), stmt);
				setString(25, data.getCANCELED_UNCONFIRM_ODR_QTY(), stmt);
				setString(26, data.getUNIT_CD(), stmt);
				setString(27, data.getUNCONFIRM_ODR_BALANCE(), stmt);
				setString(28, data.getODR_AMOUNT(), stmt);
				setString(29, data.getODR_AMOUNT_EXCH_RATES(), stmt);
				setString(30, data.getODR_CMPLT_FLG(), stmt);
				setString(31, data.getPART_NAME(), stmt);
				setString(32, data.getTRANSPORT_CD(), stmt);
				setString(33, data.getTRANSPORT_TYP(), stmt);
				setString(34, data.getTAX_APPLY_TYP(), stmt);
				setString(35, data.getTAX_CD(), stmt);
				setString(36, data.getTAX_CALC_TYP(), stmt);
				setString(37, data.getREMARKS(), stmt);
				setString(38, data.getODR_ACPT_DATE(), stmt);
				setString(39, data.getSHIP_PLAN_REMAIN_QTY(), stmt);
				setString(40, data.getSHIP_PLAN_CMPLT_FLG(), stmt);
				setString(41, data.getUNCONFIRMED_ODR_EFF_OVR_FLG(), stmt);
				setString(42, data.getPARTIAL_SHIP_INST_FLG(), stmt);
				setString(43, data.getENTRY_TYP(), stmt);
				setString(44, data.getDEL_FLG(), stmt);
				setString(45, data.getJOB_ODR_SET_FLG(), stmt);
...
+"  B.STOCK_UNIT AS \"UNIT_CD\", "
+"  T_ODR_UNSTOCK.ODR_UNIT_PRICE, "
+"  T_ODR_UNSTOCK.ODR_AMOUNT, "
+"  T_ODR_UNSTOCK.ODR_AMOUNT_EXCH_RATES, "
+"  '' AS \"DLV_LOC_CD\", "
+"  10, "
+"  TO_CHAR(T_ODR_UNSTOCK.ODR_ACPT_DATE, 'YYYY/MM/DD') AS ODR_ACPT_DATE, "
+"  T_ODR_UNSTOCK.REMARKS, "
+"  T_ODR_UNSTOCK.CUST_CHRG_PSN_CD, "
+"  T_ODR_UNSTOCK.\"MODIFY_COUNT\" AS \"MODIFY_COUNT\", "
+"  A.USER_NAME, "
+"  T_ODR_UNSTOCK.CUST_CHRG_ORG_CD AS \"CUST_CHRG_ORG_CD\", "
+"  C.ORG_NAME "
+"FROM "
+"  T_ODR_UNSTOCK, "
+"  ( "
...
+"      T_ODR_UNSTOCK "
+"    WHERE "
+"      T_ODR_UNSTOCK.CUST_CHRG_PSN_CD = USER_MST.USER_CD(+) "
+"  ) A, "
+"  ( "
+"    SELECT "
+"      M_ITEM.STOCK_UNIT, "
...
+"      T_ODR_UNSTOCK "
+"    WHERE "
+"      T_ODR_UNSTOCK.ITEM_CD = M_ITEM.ITEM_CD(+) "
+"  ) B, "
+"  ( "
+"    SELECT "
+"      M_ORG.ORG_NAME, "
...
+"      T_ODR_UNSTOCK "
+"    WHERE "
+"      T_ODR_UNSTOCK.CUST_CHRG_ORG_CD = M_ORG.ORG_CD(+) "
+"      AND M_ORG.COMPANY_CD(+) = ? "
+"  ) C "
+"WHERE "
+"  T_ODR_UNSTOCK.ODR_NO = A.ODR_NO "
+"  AND T_ODR_UNSTOCK.ODR_NO = B.ODR_NO "
+"  AND T_ODR_UNSTOCK.ODR_NO = C.ODR_NO "
+"  AND T_ODR_UNSTOCK.ODR_CMPLT_FLG = 0 "
+"  AND T_ODR_UNSTOCK.DEL_FLG = 0 "
+"  AND T_ODR_UNSTOCK.ODR_NO = ?";
		protected String m_chkcmd = null;
		protected String m_inscmd = "INSERT INTO "
+"  T_ODR_UNSTOCK(\"ODR_NO\", \"COMPANY_CD\", \"SLIP_CD\", \"CUST_ODR_NO\", \"CUST_CD\", \"ITEM_CD\", \"ITEM_NAME\", \"CUST_CHRG_PSN_CD\", \"ODR_ACPT_PSN_CD\", \"CURRNCY_CD\", \"EXCH_TYP\", \"DESINATED_DLV_DATE\", \"ODR_UNIT_PRICE\", \"ODR_QTY\", \"ODR_AMOUNT\", \"ODR_AMOUNT_EXCH_RATES\", \"TAX_APPLY_TYP\", \"TAX_CD\", \"TAX_CALC_TYP\", \"REMARKS\", \"ODR_ACPT_DATE\", \"ORGN_ODR_NO\", \"ADD_ODR_FLG\", \"ODR_CMPLT_FLG\", \"ODR_CMPLT_DATE\", \"DEL_FLG\", \"CUST_CHRG_ORG_CD\", \"ODR_ACPT_ORG_CD\") "
+"VALUES "
+"  (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, TO_DATE(?, 'YYYY/MM/DD'), ?, ?, ?, ?, ?, ?, ?, ?, TO_DATE(?, 'YYYY/MM/DD'), ?, ?, ?, TO_DATE(?, 'YYYY/MM/DD'), ?, ?, ?)";
		protected String m_updcmd = "UPDATE "
+"  T_ODR_UNSTOCK "
...
+"  T_ODR_UNSTOCK.\"ODR_NO\" = ?";
		...
		public int create(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				...
				setString(16, data.getCURRNCY_CD(), stmt);
				setString(17, data.getEXCH_TYP(), stmt);
				setString(18, data.getDESINATED_DLV_DATE(), stmt);
				setString(19, data.getODR_UNIT_PRICE(), stmt);
				setString(20, data.getODR_QTY(), stmt);
				setString(21, data.getODR_AMOUNT(), stmt);
				setString(22, data.getODR_AMOUNT_EXCH_RATES(), stmt);
				setString(23, data.getTAX_APPLY_TYP(), stmt);
				setString(24, data.getTAX_CD(), stmt);
				setString(25, data.getTAX_CALC_TYP(), stmt);
				setString(26, data.getREMARKS(), stmt);
				setString(27, data.getODR_ACPT_DATE(), stmt);
				setString(28, data.getORGN_ODR_NO(), stmt);
				setString(29, data.getADD_ODR_FLG(), stmt);
				setString(30, data.getODR_CMPLT_FLG(), stmt);
				setString(31, data.getODR_CMPLT_DATE(), stmt);
				setString(32, data.getDEL_FLG(), stmt);
				setString(33, data.getCUST_CHRG_ORG_CD(), stmt);
				setString(34, data.getODR_ACPT_ORG_CD(), stmt);
		...
		public int update(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				...
				setString(6, data.getCUST_CHRG_PSN_CD(), stmt);
				setString(7, data.getDESINATED_DLV_DATE(), stmt);
				setString(8, data.getREMARKS(), stmt);
				setString(9, data.getCUST_CHRG_ORG_CD(), stmt);
				setString(10, data.getODR_NO(), stmt);
	 ...
	 * Entity定義 静的SQL
	 */
	public class T_ESTIMATE extends DataObject
	{
		protected String m_selcmd = "SELECT "
+"  T_ESTIMATE.\"ESTIMATE_NO\" AS \"ESTIMATE_NO\", "
+"  T_ESTIMATE.\"ESTIMATE_STAT\" AS \"ESTIMATE_STAT\", "
+"  T_ESTIMATE.\"MODIFY_COUNT\" AS \"MODIFY_COUNT\", "
...
+"  AND T_ESTIMATE.\"ESTIMATE_NO\" = ?";
		...
		//{{user_implement_dev:T_ESTIMATE_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:T_ESTIMATE_def
		...
		public List read(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_ESTIMATE_read
			if(m_selcmd==null) throw new FoundationException("T_ESTIMATE", "read", "クエリー未登録");
		...
		public List read(Connection conn, KM0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_ESTIMATE_read2
			if(m_selcmd==null) throw new FoundationException("T_ESTIMATE", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, KM0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_ESTIMATE_read3
			if(m_selcmd==null) throw new FoundationException("T_ESTIMATE", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public KM0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setESTIMATE_STAT( getString(2, rs) );
			data.setMODIFY_COUNT( getString(3, rs) );
			data.setES_ORG_CD( getString(4, rs) );
			data.setES_USER_CD( getString(5, rs) );
		...
		public boolean hasRecord(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("T_ESTIMATE", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_ESTIMATE_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:T_ESTIMATE_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:T_ESTIMATE_clear
		...
		/**
		 * T_ESTIMATEクラスの標準コンストラクタ
		 */
		public T_ESTIMATE()
		{
			//{{user_implement_dev:T_ESTIMATE_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:T_ESTIMATE_constractor
...
+"  AND A.\"CUST_ITEM_CD\"(+) = T_ESTIMATE_DETAL.\"CUST_ITEM_CD\" "
+"ORDER BY "
+"  T_ESTIMATE_DETAL.\"DETAL_NO\"";
		protected String m_chkcmd = null;
		protected String m_inscmd = null;
...
+"  AND T_ESTIMATE_DETAL.\"DETAL_NO\" = ?";
		...
		public KM0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setESTIMATE_QTY( getString(4, rs) );
			data.setESTIMATE_UNIT_PRICE( getString(5, rs) );
			data.setESTIMATE_AMOUNT( getString(6, rs) );
			data.setESTIMATE_TYPE( getString(7, rs) );
			data.setDESINATED_DLV_DATE( getString(8, rs) );
			data.setUNIT_CD( getString(9, rs) );
		...
		public int update(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				...
				setString(2, data.getsUser_ID(), stmt);
				setString(3, m_sUpdateProgramName, stmt);
				setString(4, data.getODR_FLG(), stmt);
				setString(5, data.getPROJECT_CD(), stmt);
				setString(6, data.getESTIMATE_NO(), stmt);
				setString(7, data.getl_DETAL_NO(), stmt);
	 ...
	 * Entity定義 静的SQL
	 */
	public class T_ESTIMATE2 extends DataObject
	{
		protected String m_selcmd = "SELECT "
+"  T_ESTIMATE.\"ESTIMATE_NO\" AS \"ESTIMATE_NO\", "
+"  T_ESTIMATE.\"ESTIMATE_STAT\" AS \"ESTIMATE_STAT\", "
...
+"  AND T_ESTIMATE.\"ESTIMATE_STAT\" = 2";
		...
		//{{user_implement_dev:T_ESTIMATE2_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:T_ESTIMATE2_def
		...
		public List read(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_ESTIMATE2_read
			if(m_selcmd==null) throw new FoundationException("T_ESTIMATE2", "read", "クエリー未登録");
		...
		public List read(Connection conn, KM0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_ESTIMATE2_read2
			if(m_selcmd==null) throw new FoundationException("T_ESTIMATE2", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, KM0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_ESTIMATE2_read3
			if(m_selcmd==null) throw new FoundationException("T_ESTIMATE2", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean hasRecord(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("T_ESTIMATE2", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_ESTIMATE2_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:T_ESTIMATE2_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:T_ESTIMATE2_clear
		...
		/**
		 * T_ESTIMATE2クラスの標準コンストラクタ
		 */
		public T_ESTIMATE2()
		{
			//{{user_implement_dev:T_ESTIMATE2_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:T_ESTIMATE2_constractor
...
+"  A.JOB_ODR_CD = ?";
	 ...
	 * Entity定義 静的SQL
	 */
	public class CHECK_M_ITEM extends DataObject
	{
		protected String m_selcmd = null;
		protected String m_chkcmd = "SELECT "
...
+"WHERE "
+"  M_ITEM.\"ITEM_CD\" = ? "
+"  AND(M_ITEM.\"MRP_ODR_TYP\" = 1 "
+"  OR  M_ITEM.\"MRP_ODR_TYP\" = 2)";
		protected String m_inscmd = null;
		protected String m_updcmd = null;
		protected String m_delcmd = null;
		protected String m_spcmd = null;
		...
		//{{user_implement_dev:CHECK_M_ITEM_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:CHECK_M_ITEM_def
		...
		public boolean check(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:CHECK_M_ITEM_check
			PreparedStatement stmt = prepare(conn, m_chkcmd, data);
		...
		public void clear()
		{
			//{{user_implement_dev:CHECK_M_ITEM_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:CHECK_M_ITEM_clear
		...
		/**
		 * CHECK_M_ITEMクラスの標準コンストラクタ
		 */
		public CHECK_M_ITEM()
		{
			//{{user_implement_dev:CHECK_M_ITEM_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:CHECK_M_ITEM_constractor
...
+"  AND M_CAL.HOLIDAY_FLG = '1'";
		...
		public PreparedStatement prepare(Connection conn, String query, KM0030010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				ary.addElement(data.getPLANT_CD());
				if(isNull(data.getPLANT_CD())) isNull = true;
				ary.addElement(data.getJOB_ODR_DLV_DATE());
				if(isNull(data.getJOB_ODR_DLV_DATE())) isNull = true;
		...
		public ResultSet executeQuery(PreparedStatement stmt, KM0030010Struct data) throws FoundationException, SQLException
		{
			...
			setString(no ++, data.getPLANT_CD(), stmt);
			// 静的SQL文の生成
			setString(no ++, data.getJOB_ODR_DLV_DATE(), stmt);
...
+"  (?, ?, ?, ?, ?, ?, 0)";
		...
		public KM0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setODR_CTL_NO( getString(1, rs) );
		...
		public int create(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				...
				setString(5, data.getsUser_ID(), stmt);
				setString(6, m_sCreateProgramName, stmt);
				setString(7, data.getODR_CTL_NO(), stmt);
				setString(8, data.getCUST_CD(), stmt);
				setString(9, data.getCUST_ITEM_CD(), stmt);
				setString(10, data.getCUST_ITEM_NAME(), stmt);
	...
	{
		protected String m_selcmd = "SELECT "
+"  'OCN' || LPAD(TO_CHAR(SEQ_ODR_CTL.NEXTVAL), 7, '0') AS \"ODR_CTL_NO\" "
+"FROM "
+"  DUAL";
		protected String m_chkcmd = null;
		protected String m_inscmd = null;
	...
	{
		protected String m_selcmd = "SELECT "
+"  'ODR' || LPAD(TO_CHAR(SEQ_ODR.NEXTVAL), 10, '0') AS \"ODR_NO\" "
+"FROM "
+"  DUAL";
		protected String m_chkcmd = null;
		protected String m_inscmd = null;
	...
	public class T_ODR_ACPT_RSLT extends DataObject
	{
		...
		protected String m_chkcmd = null;
		protected String m_inscmd = "INSERT INTO "
+"  T_ODR_ACPT_RSLT(\"RSLT_CTL_SEQ_CD\", \"ODR_CTL_NO\", \"ODR_NO\", \"CUST_ODR_NO\", \"ODR_TYP\", \"CUST_CD\", \"CUST_ITEM_CD\", \"ITEM_CD\", \"DESINATED_DLV_DATE\", \"ODR_QTY\", \"UNIT\", \"DLV_PLACE_CD\", \"UNIT_PRICE\", \"CUR_CD\", \"SPCL_PRICE_CO\", \"DEPO_TYP\", \"CUST_DLV_CD\", \"CUST_DLV_KEY_CD\", \"REMARKS\", \"CUST_CHRG_PSN_CD\", \"ODR_ACPT_PSN_CD\", \"IF_CTL_NO\", \"ODR_SEQ\", \"ODR_ACPT_DATE\", \"TAX_CD\") "
+"VALUES "
+"  (?, ?, ?, ?, ?, ?, ?, ?, TO_DATE(?, 'YYYY/MM/DD'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, TO_DATE(?, 'YYYY/MM/DD'), ?)";
		...
		public int create(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				...
				setString(9, data.getODR_NO(), stmt);
				setString(10, data.getCUST_ODR_NO(), stmt);
				setString(11, data.getODR_TYP(), stmt);
				...
				setString(17, data.getUNIT(), stmt);
				setString(18, data.getDLV_PLACE_CD(), stmt);
				setString(19, data.getUNIT_PRICE(), stmt);
				setString(20, data.getCUR_CD(), stmt);
				setString(21, data.getSPCL_PRICE_CO(), stmt);
				setString(22, data.getDEPO_TYP(), stmt);
				setString(23, data.getCUST_DLV_CD(), stmt);
				setString(24, data.getCUST_DLV_KEY_CD(), stmt);
				setString(25, data.getREMARKS(), stmt);
				setString(26, data.getCUST_CHRG_PSN_CD(), stmt);
				setString(27, data.getODR_ACPT_PSN_CD(), stmt);
				setString(28, data.getIF_CTL_NO(), stmt);
				setString(29, data.getODR_SEQ(), stmt);
				setString(30, data.getODR_ACPT_DATE(), stmt);
				setString(31, data.getTAX_CD(), stmt);
...
+"  (?, ?, TO_DATE(?, 'YYYY/MM/DD'), TO_DATE(?, 'YYYY/MM/DD'), ?, ?, ?, ?, ?)";
		...
		public int create(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				...
				setString(6, m_sCreateProgramName, stmt);
				setString(7, data.getODR_NO(), stmt);
				setString(8, data.getPART_DLV_SEQ_NO(), stmt);
				setString(9, data.getLAST_ANS_DLV_DATE_RCD(), stmt);
				setString(10, data.getDESINATED_SHIP_DATE(), stmt);
				setString(11, data.getDESINATED_SHIP_QTY(), stmt);
				setString(12, data.getREST_SHIP_ODR_QTY(), stmt);
				setString(13, data.getSHIP_ODR_CMPLT_FLG(), stmt);
				setString(14, data.getIF_CTL_NO(), stmt);
				setString(15, data.getDEL_FLG(), stmt);
	...
	public class T_JOB_ODR extends DataObject
	{
		...
		protected String m_chkcmd = null;
		protected String m_inscmd = "INSERT INTO "
+"  T_JOB_ODR(\"JOB_ODR_CD\", \"JOB_ODR_CANCEL_NO\", \"JOB_ODR_TYP\", \"ITEM_CD\", \"PLAN_TYP\", \"JOB_ODR_DLV_DATE\", \"JOB_ODR_QTY\", \"ALC_GRP_CD\", \"JOB_ODR_STS_TYP\", \"JOB_ODR_EXP_TYP\", \"JOB_ODR_DEL_FLG\", \"PLANT_CD\") "
+"VALUES "
+"  (?, ?, ?, ?, ?, TO_DATE(?,'YYYY/MM/DD'), ?, ?, ?, ?, ?, ?)";
		protected String m_updcmd = null;
		protected String m_delcmd = null;
		...
		public int create(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				...
				setString(8, data.getJOB_ODR_CANCEL_NO(), stmt);
				setString(9, data.getJOB_ODR_TYP(), stmt);
				setString(10, data.getITEM_CD(), stmt);
				setString(11, data.getPLAN_TYP(), stmt);
				setString(12, data.getJOB_ODR_DLV_DATE(), stmt);
				setString(13, data.getJOB_ODR_QTY(), stmt);
				setString(14, data.getALC_GRP_CD(), stmt);
				setString(15, data.getJOB_ODR_STS_TYP(), stmt);
				setString(16, data.getJOB_ODR_EXP_TYP(), stmt);
				setString(17, data.getJOB_ODR_DEL_FLG(), stmt);
				setString(18, data.getPLANT_CD(), stmt);
...
+"  (?, TO_NUMBER('0'), ?, ?, ?, TO_NUMBER(?))";
		...
		public int create(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				...
				setString(11, data.getALCD_QTY(), stmt);
	 ...
	 * Entity定義 静的SQL
	 */
	public class TBL_T_ESTIMATE extends DataObject
	{
		protected String m_selcmd = "SELECT "
+"  T_ESTIMATE.\"MODIFY_COUNT\" AS \"MODIFY_COUNT\" "
+"FROM "
...
+"  AND T_ESTIMATE.\"ESTIMATE_NO\" = ?";
		...
		//{{user_implement_dev:TBL_T_ESTIMATE_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:TBL_T_ESTIMATE_def
		...
		public List read(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:TBL_T_ESTIMATE_read
			if(m_selcmd==null) throw new FoundationException("TBL_T_ESTIMATE", "read", "クエリー未登録");
		...
		public List read(Connection conn, KM0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:TBL_T_ESTIMATE_read2
			if(m_selcmd==null) throw new FoundationException("TBL_T_ESTIMATE", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, KM0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:TBL_T_ESTIMATE_read3
			if(m_selcmd==null) throw new FoundationException("TBL_T_ESTIMATE", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean hasRecord(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("TBL_T_ESTIMATE", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:TBL_T_ESTIMATE_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public int update(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				...
				setString(2, data.getsUser_ID(), stmt);
				setString(3, m_sUpdateProgramName, stmt);
				setString(4, data.getESTIMATE_STAT(), stmt);
				setString(5, data.getPROJECT_CD(), stmt);
				setString(6, data.getESTIMATE_NO(), stmt);
		...
		public void clear()
		{
			//{{user_implement_dev:TBL_T_ESTIMATE_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:TBL_T_ESTIMATE_clear
		...
		/**
		 * TBL_T_ESTIMATEクラスの標準コンストラクタ
		 */
		public TBL_T_ESTIMATE()
		{
			//{{user_implement_dev:TBL_T_ESTIMATE_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:TBL_T_ESTIMATE_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class CAL_T_ESTIMATE extends DataObject
	{
		protected String m_selcmd = null;
		protected String m_chkcmd = null;
		protected String m_inscmd = null;
...
+"  AND T_ESTIMATE.\"DEL_FLG\" = 0";
		...
		//{{user_implement_dev:CAL_T_ESTIMATE_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:CAL_T_ESTIMATE_def
		...
		public void clear()
		{
			//{{user_implement_dev:CAL_T_ESTIMATE_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:CAL_T_ESTIMATE_clear
		...
		/**
		 * CAL_T_ESTIMATEクラスの標準コンストラクタ
		 */
		public CAL_T_ESTIMATE()
		{
			//{{user_implement_dev:CAL_T_ESTIMATE_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:CAL_T_ESTIMATE_constractor
...
+"  \"CUST_CHRG_ORG_CD\" = ?, "
+"  \"DESINATED_DLV_DATE\" = TO_DATE(?, 'YYYY/MM/DD'), "
+"  \"STD_DESINATED_RCV_DATE\" = TO_DATE(?, 'YYYY/MM/DD'), "
+"  \"DLV_LOC_CD\" = ?, "
+"  \"DLV_LOC_NAME_KANJI\" = ?, "
+"  \"REMARKS\" = ? "
+"WHERE "
+"  T_ODR.\"ODR_NO\" = ?";
		...
		public KM0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setMODIFY_COUNT( getString(1, rs) );
			data.setODR_CTL_NO( getString(2, rs) );
			data.setODR_UNIT_PRICE( getString(3, rs) );
			data.setCURRNCY_CD( getString(4, rs) );
			data.setSPCL_PRICE_TYP( getString(5, rs) );
			data.setDEPO_TYP( getString(6, rs) );
			data.setCUS_DLV_CD( getString(7, rs) );
			data.setCUS_DLV_KEY_CD( getString(8, rs) );
			data.setREMARKS( getString(9, rs) );
			data.setODR_ACPT_PSN_CD( getString(10, rs) );
			data.setODR_ACPT_DATE( getString(11, rs) );
			data.setTAX_CD( getString(12, rs) );
		...
		public int update(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				...
				setString(3, m_sUpdateProgramName, stmt);
				setString(4, data.getCUST_ODR_NO(), stmt);
				setString(5, data.getCUST_CHRG_PSN_CD(), stmt);
				setString(6, data.getCUST_CHRG_ORG_CD(), stmt);
				setString(7, data.getDESINATED_DLV_DATE(), stmt);
				setString(8, data.getSTD_DESINATED_RCV_DATE(), stmt);
				setString(9, data.getDLV_LOC_CD(), stmt);
				setString(10, data.getDLV_LOC_NAME(), stmt);
				setString(11, data.getREMARKS(), stmt);
				setString(12, data.getODR_NO(), stmt);
	...
	{
		protected String m_selcmd = "SELECT "
+"  SEQ_RSLT_ODR.NEXTVAL AS \"RSLT_CTL_SEQ_CD\" "
+"FROM "
+"  DUAL";
		protected String m_chkcmd = null;
		protected String m_inscmd = null;
	 ...
	 * Entity定義 静的SQL
	 */
	public class readT_ODR_CTL extends DataObject
	{
		protected String m_selcmd = "SELECT "
...
+"  T_ODR_CTL.\"ODR_CTL_NO\" = ?";
		...
		//{{user_implement_dev:readT_ODR_CTL_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:readT_ODR_CTL_def
		...
		public List read(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:readT_ODR_CTL_read
			if(m_selcmd==null) throw new FoundationException("readT_ODR_CTL", "read", "クエリー未登録");
		...
		public List read(Connection conn, KM0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:readT_ODR_CTL_read2
			if(m_selcmd==null) throw new FoundationException("readT_ODR_CTL", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, KM0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:readT_ODR_CTL_read3
			if(m_selcmd==null) throw new FoundationException("readT_ODR_CTL", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean hasRecord(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("readT_ODR_CTL", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:readT_ODR_CTL_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:readT_ODR_CTL_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:readT_ODR_CTL_clear
		...
		/**
		 * readT_ODR_CTLクラスの標準コンストラクタ
		 */
		public readT_ODR_CTL()
		{
			//{{user_implement_dev:readT_ODR_CTL_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:readT_ODR_CTL_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class TBL_T_ODR_UNSTOCK extends DataObject
	{
		protected String m_selcmd = "SELECT "
+"  T_ODR_UNSTOCK.\"MODIFY_COUNT\" AS \"MODIFY_COUNT\", "
+"  T_ODR_UNSTOCK.\"ODR_NO\" AS \"ODR_NO\", "
+"  T_ODR_UNSTOCK.\"COMPANY_CD\" AS \"COMPANY_CD\", "
+"  T_ODR_UNSTOCK.\"SLIP_CD\" AS \"SLIP_CD\", "
...
+"  T_ODR_UNSTOCK.\"ODR_ACPT_PSN_CD\" AS \"ODR_ACPT_PSN_CD\", "
+"  T_ODR_UNSTOCK.\"CURRNCY_CD\" AS \"CURRNCY_CD\", "
+"  T_ODR_UNSTOCK.\"EXCH_TYP\" AS \"EXCH_TYP\", "
+"  T_ODR_UNSTOCK.\"DESINATED_DLV_DATE\" AS \"DESINATED_DLV_DATE\", "
...
+"  T_ODR_UNSTOCK.\"TAX_APPLY_TYP\" AS \"TAX_APPLY_TYP\", "
+"  T_ODR_UNSTOCK.\"TAX_CD\" AS \"TAX_CD\", "
+"  T_ODR_UNSTOCK.\"TAX_CALC_TYP\" AS \"TAX_CALC_TYP\", "
+"  T_ODR_UNSTOCK.\"REMARKS\" AS \"REMARKS\", "
+"  T_ODR_UNSTOCK.\"ODR_ACPT_DATE\" AS \"ODR_ACPT_DATE\", "
+"  T_ODR_UNSTOCK.\"ORGN_ODR_NO\" AS \"ORGN_ODR_NO\", "
+"  T_ODR_UNSTOCK.\"ADD_ODR_FLG\" AS \"ADD_ODR_FLG\", "
+"  T_ODR_UNSTOCK.\"ODR_CMPLT_FLG\" AS \"ODR_CMPLT_FLG\", "
+"  T_ODR_UNSTOCK.\"ODR_CMPLT_DATE\" AS \"ODR_CMPLT_DATE\", "
+"  T_ODR_UNSTOCK.\"DEL_FLG\" AS \"DEL_FLG\", "
+"  T_ODR_UNSTOCK.\"CUST_CHRG_ORG_CD\" AS \"CUST_CHRG_ORG_CD\", "
+"  T_ODR_UNSTOCK.\"ODR_ACPT_ORG_CD\" AS \"ODR_ACPT_ORG_CD\" "
+"FROM "
+"  T_ODR_UNSTOCK "
+"WHERE "
+"  T_ODR_UNSTOCK.\"ODR_NO\" = ?";
...
+"  T_ODR_UNSTOCK.\"ODR_NO\" = ?";
		...
		//{{user_implement_dev:TBL_T_ODR_UNSTOCK_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:TBL_T_ODR_UNSTOCK_def
		...
		public List read(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:TBL_T_ODR_UNSTOCK_read
			if(m_selcmd==null) throw new FoundationException("TBL_T_ODR_UNSTOCK", "read", "クエリー未登録");
		...
		public List read(Connection conn, KM0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:TBL_T_ODR_UNSTOCK_read2
			if(m_selcmd==null) throw new FoundationException("TBL_T_ODR_UNSTOCK", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, KM0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:TBL_T_ODR_UNSTOCK_read3
			if(m_selcmd==null) throw new FoundationException("TBL_T_ODR_UNSTOCK", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public KM0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setSLIP_CD( getString(4, rs) );
			data.setCUST_ODR_NO( getString(5, rs) );
			data.setCUST_CD( getString(6, rs) );
			...
			data.setDESINATED_DLV_DATE( getString(13, rs) );
			data.setODR_UNIT_PRICE( getString(14, rs) );
			data.setODR_QTY( getString(15, rs) );
			data.setODR_AMOUNT( getString(16, rs) );
			data.setODR_AMOUNT_EXCH_RATES( getString(17, rs) );
			data.setTAX_APPLY_TYP( getString(18, rs) );
			data.setTAX_CD( getString(19, rs) );
			data.setTAX_CALC_TYP( getString(20, rs) );
			data.setREMARKS( getString(21, rs) );
			data.setODR_ACPT_DATE( getString(22, rs) );
			data.setORGN_ODR_NO( getString(23, rs) );
			data.setADD_ODR_FLG( getString(24, rs) );
			data.setODR_CMPLT_FLG( getString(25, rs) );
			data.setODR_CMPLT_DATE( getString(26, rs) );
			data.setDEL_FLG( getString(27, rs) );
			data.setCUST_CHRG_ORG_CD( getString(28, rs) );
			data.setODR_ACPT_ORG_CD( getString(29, rs) );
		...
		public boolean hasRecord(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("TBL_T_ODR_UNSTOCK", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:TBL_T_ODR_UNSTOCK_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:TBL_T_ODR_UNSTOCK_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:TBL_T_ODR_UNSTOCK_clear
		...
		/**
		 * TBL_T_ODR_UNSTOCKクラスの標準コンストラクタ
		 */
		public TBL_T_ODR_UNSTOCK()
		{
			//{{user_implement_dev:TBL_T_ODR_UNSTOCK_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:TBL_T_ODR_UNSTOCK_constractor
...
+"  T_ODR.\"ODR_NO\" = ?";
	 ...
	 * Entity定義 静的SQL
	 */
	public class T_SERVICE extends DataObject
	{
		protected String m_selcmd = null;
		protected String m_chkcmd = "SELECT "
+"  T_SERVICE.\"CTL_SEQ_CD\" AS \"CTL_SEQ_CD\" "
+"FROM "
+"  T_SERVICE "
+"WHERE "
+"  T_SERVICE.\"ODR_NO\" = ? "
+"  AND T_SERVICE.\"DEL_FLG\" = 0";
		...
		//{{user_implement_dev:T_SERVICE_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:T_SERVICE_def
		...
		public boolean check(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_SERVICE_check
			PreparedStatement stmt = prepare(conn, m_chkcmd, data);
		...
		public void clear()
		{
			//{{user_implement_dev:T_SERVICE_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:T_SERVICE_clear
		...
		/**
		 * T_SERVICEクラスの標準コンストラクタ
		 */
		public T_SERVICE()
		{
			//{{user_implement_dev:T_SERVICE_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:T_SERVICE_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class CHECK_STS_T_ESTIMATE_DETAL extends DataObject
	{
		protected String m_selcmd = null;
		protected String m_chkcmd = "SELECT "
+"  T_ESTIMATE_DETAL.\"DETAL_NO\" AS \"DETAL_NO\" "
...
+"  T_ESTIMATE_DETAL.\"PROJECT_CD\" = ? "
+"  AND T_ESTIMATE_DETAL.\"ESTIMATE_NO\" = ? "
+"  AND T_ESTIMATE_DETAL.\"ODR_FLG\" <> 0";
		protected String m_inscmd = null;
		protected String m_updcmd = null;
		protected String m_delcmd = null;
		protected String m_spcmd = null;
		...
		//{{user_implement_dev:CHECK_STS_T_ESTIMATE_DETAL_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:CHECK_STS_T_ESTIMATE_DETAL_def
		...
		public boolean check(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:CHECK_STS_T_ESTIMATE_DETAL_check
			PreparedStatement stmt = prepare(conn, m_chkcmd, data);
		...
		public void clear()
		{
			//{{user_implement_dev:CHECK_STS_T_ESTIMATE_DETAL_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:CHECK_STS_T_ESTIMATE_DETAL_clear
		...
		/**
		 * CHECK_STS_T_ESTIMATE_DETALクラスの標準コンストラクタ
		 */
		public CHECK_STS_T_ESTIMATE_DETAL()
		{
			//{{user_implement_dev:CHECK_STS_T_ESTIMATE_DETAL_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:CHECK_STS_T_ESTIMATE_DETAL_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class MODIFY_CNT_T_ESTIMATE extends DataObject
	{
		protected String m_selcmd = "SELECT "
+"  T_ESTIMATE.\"MODIFY_COUNT\" AS \"MODIFY_COUNT\", "
...
+"  AND T_ESTIMATE.\"ESTIMATE_NO\" = ?";
		...
		//{{user_implement_dev:MODIFY_CNT_T_ESTIMATE_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:MODIFY_CNT_T_ESTIMATE_def
		...
		public List read(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:MODIFY_CNT_T_ESTIMATE_read
			if(m_selcmd==null) throw new FoundationException("MODIFY_CNT_T_ESTIMATE", "read", "クエリー未登録");
		...
		public List read(Connection conn, KM0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:MODIFY_CNT_T_ESTIMATE_read2
			if(m_selcmd==null) throw new FoundationException("MODIFY_CNT_T_ESTIMATE", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, KM0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:MODIFY_CNT_T_ESTIMATE_read3
			if(m_selcmd==null) throw new FoundationException("MODIFY_CNT_T_ESTIMATE", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public KM0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setMODIFY_COUNT( getString(1, rs) );
			data.setUNOFFICIAL_RECEIPT_FLAG( getString(2, rs) );
		...
		public boolean hasRecord(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("MODIFY_CNT_T_ESTIMATE", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:MODIFY_CNT_T_ESTIMATE_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:MODIFY_CNT_T_ESTIMATE_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:MODIFY_CNT_T_ESTIMATE_clear
		...
		/**
		 * MODIFY_CNT_T_ESTIMATEクラスの標準コンストラクタ
		 */
		public MODIFY_CNT_T_ESTIMATE()
		{
			//{{user_implement_dev:MODIFY_CNT_T_ESTIMATE_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:MODIFY_CNT_T_ESTIMATE_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class UPD_REST_T_ESTIMATE extends DataObject
	{
		protected String m_selcmd = null;
		protected String m_chkcmd = null;
		protected String m_inscmd = null;
...
+"  AND T_ESTIMATE.\"ESTIMATE_NO\" <> ?";
		...
		//{{user_implement_dev:UPD_REST_T_ESTIMATE_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:UPD_REST_T_ESTIMATE_def
		...
		public void clear()
		{
			//{{user_implement_dev:UPD_REST_T_ESTIMATE_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:UPD_REST_T_ESTIMATE_clear
		...
		/**
		 * UPD_REST_T_ESTIMATEクラスの標準コンストラクタ
		 */
		public UPD_REST_T_ESTIMATE()
		{
			//{{user_implement_dev:UPD_REST_T_ESTIMATE_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:UPD_REST_T_ESTIMATE_constractor
	...
	{
		protected String m_selcmd = "SELECT "
+"  SYS_JOB_ODR_CD_CTRL.\"JOB_OD_CD_PREFIX\" AS \"JOB_OD_CD_PREFIX\" "
+"FROM "
+"  SYS_JOB_ODR_CD_CTRL "
+"WHERE "
+"  SYS_JOB_ODR_CD_CTRL.\"PLANT_CD\" = ?";
		...
		public KM0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setJOB_OD_CD_PREFIX( getString(1, rs) );
	 ...
	 * Entity定義 静的SQL
	 */
	public class SEQ_ODR_UNSTOCK extends DataObject
	{
		protected String m_selcmd = "SELECT "
+"  'AODR' || LPAD(TO_CHAR(SEQ_A_ODR.NEXTVAL), 10, '0') AS \"ODR_NO\" "
+"FROM "
+"  DUAL";
		protected String m_chkcmd = null;
		protected String m_inscmd = null;
		...
		//{{user_implement_dev:SEQ_ODR_UNSTOCK_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:SEQ_ODR_UNSTOCK_def
		...
		public List read(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:SEQ_ODR_UNSTOCK_read
			if(m_selcmd==null) throw new FoundationException("SEQ_ODR_UNSTOCK", "read", "クエリー未登録");
		...
		public List read(Connection conn, KM0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:SEQ_ODR_UNSTOCK_read2
			if(m_selcmd==null) throw new FoundationException("SEQ_ODR_UNSTOCK", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, KM0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:SEQ_ODR_UNSTOCK_read3
			if(m_selcmd==null) throw new FoundationException("SEQ_ODR_UNSTOCK", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean hasRecord(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("SEQ_ODR_UNSTOCK", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:SEQ_ODR_UNSTOCK_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:SEQ_ODR_UNSTOCK_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:SEQ_ODR_UNSTOCK_clear
		...
		/**
		 * SEQ_ODR_UNSTOCKクラスの標準コンストラクタ
		 */
		public SEQ_ODR_UNSTOCK()
		{
			//{{user_implement_dev:SEQ_ODR_UNSTOCK_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:SEQ_ODR_UNSTOCK_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class HS_T_ODR_UNSTOCK extends DataObject
	{
		protected String m_selcmd = null;
		protected String m_chkcmd = null;
		protected String m_inscmd = "INSERT INTO "
+"  HS_T_ODR_UNSTOCK(\"CTL_SEQ_CD\", \"ODR_NO\", \"NEW_OLD_FLG\", \"TRAN_TYPE\", \"COMPANY_CD\", \"SLIP_CD\", \"CUST_ODR_NO\", \"CUST_CD\", \"ITEM_CD\", \"ITEM_NAME\", \"CUST_CHRG_PSN_CD\", \"ODR_ACPT_PSN_CD\", \"CURRNCY_CD\", \"EXCH_TYP\", \"DESINATED_DLV_DATE\", \"ODR_UNIT_PRICE\", \"ODR_QTY\", \"ODR_AMOUNT\", \"ODR_AMOUNT_EXCH_RATES\", \"TAX_APPLY_TYP\", \"TAX_CD\", \"TAX_CALC_TYP\", \"REMARKS\", \"ODR_ACPT_DATE\", \"ORGN_ODR_NO\", \"ADD_ODR_FLG\", \"ODR_CMPLT_FLG\", \"ODR_CMPLT_DATE\", \"DEL_FLG\", \"CUST_CHRG_ORG_CD\", \"ODR_ACPT_ORG_CD\") "
+"VALUES "
+"  (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, TO_DATE(SUBSTR(?,1,10),'YYYY/MM/DD'), ?, ?, ?, ?, ?, ?, ?, ?, TO_DATE(SUBSTR(?,1,10),'YYYY/MM/DD'), ?, ?, ?, TO_DATE(SUBSTR(?,1,10),'YYYY/MM/DD'), ?, ?, ?)";
		protected String m_updcmd = null;
		protected String m_delcmd = null;
		protected String m_spcmd = null;
		...
		//{{user_implement_dev:HS_T_ODR_UNSTOCK_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:HS_T_ODR_UNSTOCK_def
		...
		public int create(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				...
				setString(19, data.getCURRNCY_CD(), stmt);
				setString(20, data.getEXCH_TYP(), stmt);
				setString(21, data.getDESINATED_DLV_DATE(), stmt);
				setString(22, data.getODR_UNIT_PRICE(), stmt);
				setString(23, data.getODR_QTY(), stmt);
				setString(24, data.getODR_AMOUNT(), stmt);
				setString(25, data.getODR_AMOUNT_EXCH_RATES(), stmt);
				setString(26, data.getTAX_APPLY_TYP(), stmt);
				setString(27, data.getTAX_CD(), stmt);
				setString(28, data.getTAX_CALC_TYP(), stmt);
				setString(29, data.getREMARKS(), stmt);
				setString(30, data.getODR_ACPT_DATE(), stmt);
				setString(31, data.getORGN_ODR_NO(), stmt);
				setString(32, data.getADD_ODR_FLG(), stmt);
				setString(33, data.getODR_CMPLT_FLG(), stmt);
				setString(34, data.getODR_CMPLT_DATE(), stmt);
				setString(35, data.getDEL_FLG(), stmt);
				setString(36, data.getCUST_CHRG_ORG_CD(), stmt);
				setString(37, data.getODR_ACPT_ORG_CD(), stmt);
		...
		public void clear()
		{
			//{{user_implement_dev:HS_T_ODR_UNSTOCK_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:HS_T_ODR_UNSTOCK_clear
		...
		/**
		 * HS_T_ODR_UNSTOCKクラスの標準コンストラクタ
		 */
		public HS_T_ODR_UNSTOCK()
		{
			//{{user_implement_dev:HS_T_ODR_UNSTOCK_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:HS_T_ODR_UNSTOCK_constractor
...
+"  AND M_EXCH_RATE.\"CUR_CD\" = ?";
		...
		public List read(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:M_EXCH_RATE_read
			if(m_selcmd==null) throw new FoundationException("M_EXCH_RATE", "read", "クエリー未登録");
		...
		public List read(Connection conn, KM0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:M_EXCH_RATE_read2
			if(m_selcmd==null) throw new FoundationException("M_EXCH_RATE", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, KM0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:M_EXCH_RATE_read3
			if(m_selcmd==null) throw new FoundationException("M_EXCH_RATE", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean hasRecord(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("M_EXCH_RATE", "hasRecord", "クエリー未登録");
...
+"  USER_MST.\"USER_CD\" = ?";
	 ...
	 * Entity定義 静的SQL
	 */
	public class CHECK_M_ITEM_SPEC extends DataObject
	{
		protected String m_selcmd = "SELECT "
+"  M_ITEM_SPEC.\"CUST_ITEM_CD\" AS \"CUST_ITEM_CD\", "
...
+"  AND M_ITEM_SPEC.\"CUST_ITEM_CD\" = ?";
		...
		//{{user_implement_dev:CHECK_M_ITEM_SPEC_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:CHECK_M_ITEM_SPEC_def
		...
		public List read(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:CHECK_M_ITEM_SPEC_read
			if(m_selcmd==null) throw new FoundationException("CHECK_M_ITEM_SPEC", "read", "クエリー未登録");
		...
		public List read(Connection conn, KM0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:CHECK_M_ITEM_SPEC_read2
			if(m_selcmd==null) throw new FoundationException("CHECK_M_ITEM_SPEC", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, KM0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:CHECK_M_ITEM_SPEC_read3
			if(m_selcmd==null) throw new FoundationException("CHECK_M_ITEM_SPEC", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean hasRecord(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("CHECK_M_ITEM_SPEC", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:CHECK_M_ITEM_SPEC_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:CHECK_M_ITEM_SPEC_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:CHECK_M_ITEM_SPEC_clear
		...
		/**
		 * CHECK_M_ITEM_SPECクラスの標準コンストラクタ
		 */
		public CHECK_M_ITEM_SPEC()
		{
			//{{user_implement_dev:CHECK_M_ITEM_SPEC_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:CHECK_M_ITEM_SPEC_constractor
...
+"  M_ITEM.\"ITEM_CD\" = ?";
	 ...
	 * Entity定義 静的SQL
	 */
	public class T_ESTIMATE_R extends DataObject
	{
		protected String m_selcmd = "SELECT "
+"  T_ESTIMATE.\"ESTIMATE_NO\" AS \"ESTIMATE_NO\", "
+"  T_ESTIMATE.\"ESTIMATE_STAT\" AS \"ESTIMATE_STAT\", "
...
+"  ( "
+"    SELECT "
+"      MAX(T_ESTIMATE.\"PROJECT_CD\") AS \"PROJECT_CD\", "
+"      MAX(T_ESTIMATE.\"ESTIMATE_NO\") AS \"ESTIMATE_NO\" "
+"    FROM "
+"      T_ESTIMATE "
+"    WHERE "
+"      T_ESTIMATE.\"PROJECT_CD\" = ? "
+"      AND T_ESTIMATE.\"ESTIMATE_STAT\" = 0 "
+"  ) MAX_T_ESTIMATE "
+"WHERE "
+"  T_ESTIMATE.\"PROJECT_CD\" = MAX_T_ESTIMATE.\"PROJECT_CD\" "
+"  AND T_ESTIMATE.\"ESTIMATE_NO\" = MAX_T_ESTIMATE.\"ESTIMATE_NO\"";
		protected String m_chkcmd = null;
		protected String m_inscmd = null;
		protected String m_updcmd = null;
		protected String m_delcmd = null;
		...
		//{{user_implement_dev:T_ESTIMATE_R_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:T_ESTIMATE_R_def
		...
		public List read(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_ESTIMATE_R_read
			if(m_selcmd==null) throw new FoundationException("T_ESTIMATE_R", "read", "クエリー未登録");
		...
		public List read(Connection conn, KM0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_ESTIMATE_R_read2
			if(m_selcmd==null) throw new FoundationException("T_ESTIMATE_R", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, KM0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_ESTIMATE_R_read3
			if(m_selcmd==null) throw new FoundationException("T_ESTIMATE_R", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean hasRecord(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("T_ESTIMATE_R", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_ESTIMATE_R_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:T_ESTIMATE_R_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:T_ESTIMATE_R_clear
		...
		/**
		 * T_ESTIMATE_Rクラスの標準コンストラクタ
		 */
		public T_ESTIMATE_R()
		{
			//{{user_implement_dev:T_ESTIMATE_R_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:T_ESTIMATE_R_constractor
...
+"  T_ANS_DLV_DATE.ODR_NO";
		...
		public KM0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setl_h_ANS_DLV_DATE_EXIST_FLG( getString(1, rs) );
	 ...
	 * Entity定義 静的SQL
	 */
	public class T_ESTIMATE2_R extends DataObject
	{
		protected String m_selcmd = "SELECT "
+"  T_ESTIMATE.\"ESTIMATE_NO\" AS \"ESTIMATE_NO\", "
+"  T_ESTIMATE.\"ESTIMATE_STAT\" AS \"ESTIMATE_STAT\", "
...
+"  AND T_ESTIMATE.\"ESTIMATE_STAT\" = 2";
		...
		//{{user_implement_dev:T_ESTIMATE2_R_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:T_ESTIMATE2_R_def
		...
		public List read(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_ESTIMATE2_R_read
			if(m_selcmd==null) throw new FoundationException("T_ESTIMATE2_R", "read", "クエリー未登録");
		...
		public List read(Connection conn, KM0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_ESTIMATE2_R_read2
			if(m_selcmd==null) throw new FoundationException("T_ESTIMATE2_R", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, KM0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_ESTIMATE2_R_read3
			if(m_selcmd==null) throw new FoundationException("T_ESTIMATE2_R", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean hasRecord(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("T_ESTIMATE2_R", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_ESTIMATE2_R_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:T_ESTIMATE2_R_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:T_ESTIMATE2_R_clear
		...
		/**
		 * T_ESTIMATE2_Rクラスの標準コンストラクタ
		 */
		public T_ESTIMATE2_R()
		{
			//{{user_implement_dev:T_ESTIMATE2_R_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:T_ESTIMATE2_R_constractor
...
+"  ITEM_CD = ?";
	 ...
	 * Entity定義 静的SQL
	 */
	public class selectT_TRAN_APR extends DataObject
	{
		protected String m_selcmd = "SELECT "
+"  SRC1.FIELD_VALUE "
+"FROM "
...
+"  T_TRAN_APR "
+"WHERE "
+"  SRC1.APPR_ID = T_TRAN_APR.APPR_ID "
+"  AND SRC1.FIELD_NAME = 'PROJECT_CD' "
+"  AND SRC1.FIELD_VALUE = ? "
+"  AND SRC2.FIELD_NAME = 'ESTIMATE_NO' "
+"  AND SRC2.FIELD_VALUE = ? "
+"  AND SRC3.FIELD_NAME = 'l_DETAL_NO' "
+"  AND SRC3.FIELD_VALUE = ? "
+"  AND T_TRAN_APR.SCREEN_URL = 'KM0030010Servlet' "
+"  AND T_TRAN_APR.STATUS = '1' "
+"  AND T_TRAN_APR.PROC_TYP = '1' "
+"  AND SRC1.APPR_ID = SRC2.APPR_ID "
+"  AND SRC1.APPR_ID = SRC3.APPR_ID";
		protected String m_chkcmd = null;
		protected String m_inscmd = null;
		protected String m_updcmd = null;
		protected String m_delcmd = null;
		...
		//{{user_implement_dev:selectT_TRAN_APR_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:selectT_TRAN_APR_def
		...
		public List read(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectT_TRAN_APR_read
			if(m_selcmd==null) throw new FoundationException("selectT_TRAN_APR", "read", "クエリー未登録");
		...
		public List read(Connection conn, KM0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectT_TRAN_APR_read2
			if(m_selcmd==null) throw new FoundationException("selectT_TRAN_APR", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, KM0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectT_TRAN_APR_read3
			if(m_selcmd==null) throw new FoundationException("selectT_TRAN_APR", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public KM0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setFIELD_VALUE( getString(1, rs) );
		...
		public boolean hasRecord(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("selectT_TRAN_APR", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectT_TRAN_APR_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:selectT_TRAN_APR_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:selectT_TRAN_APR_clear
		...
		/**
		 * selectT_TRAN_APRクラスの標準コンストラクタ
		 */
		public selectT_TRAN_APR()
		{
			//{{user_implement_dev:selectT_TRAN_APR_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:selectT_TRAN_APR_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class selectT_TRAN_APR1 extends DataObject
	{
		protected String m_selcmd = "SELECT "
+"  SRC1.FIELD_VALUE "
+"FROM "
...
+"  AND T_TRAN_APR.SCREEN_URL = 'KM0030010Servlet' "
+"  AND T_TRAN_APR.STATUS = '1' "
+"  AND T_TRAN_APR.PROC_TYP IN ('2', '3') "
+"  AND SRC1.APPR_ID = SRC2.APPR_ID "
+"  AND SRC1.APPR_ID = SRC3.APPR_ID";
		protected String m_chkcmd = null;
		protected String m_inscmd = null;
		...
		//{{user_implement_dev:selectT_TRAN_APR1_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:selectT_TRAN_APR1_def
		...
		public List read(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectT_TRAN_APR1_read
			if(m_selcmd==null) throw new FoundationException("selectT_TRAN_APR1", "read", "クエリー未登録");
		...
		public List read(Connection conn, KM0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectT_TRAN_APR1_read2
			if(m_selcmd==null) throw new FoundationException("selectT_TRAN_APR1", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, KM0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectT_TRAN_APR1_read3
			if(m_selcmd==null) throw new FoundationException("selectT_TRAN_APR1", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean hasRecord(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("selectT_TRAN_APR1", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectT_TRAN_APR1_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:selectT_TRAN_APR1_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:selectT_TRAN_APR1_clear
		...
		/**
		 * selectT_TRAN_APR1クラスの標準コンストラクタ
		 */
		public selectT_TRAN_APR1()
		{
			//{{user_implement_dev:selectT_TRAN_APR1_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:selectT_TRAN_APR1_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class T_ESTIMATE_DETAL1 extends DataObject
	{
		protected String m_selcmd = "SELECT "
+"  M_ITEM.STOCK_UNIT "
+"FROM "
...
+"  AND M_ITEM_SPEC.\"CUST_ITEM_CD\" = ?";
		...
		//{{user_implement_dev:T_ESTIMATE_DETAL1_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:T_ESTIMATE_DETAL1_def
		...
		public List read(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_ESTIMATE_DETAL1_read
			if(m_selcmd==null) throw new FoundationException("T_ESTIMATE_DETAL1", "read", "クエリー未登録");
		...
		public List read(Connection conn, KM0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_ESTIMATE_DETAL1_read2
			if(m_selcmd==null) throw new FoundationException("T_ESTIMATE_DETAL1", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, KM0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_ESTIMATE_DETAL1_read3
			if(m_selcmd==null) throw new FoundationException("T_ESTIMATE_DETAL1", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public KM0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setUNIT_CD( getString(1, rs) );
		...
		public boolean hasRecord(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("T_ESTIMATE_DETAL1", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_ESTIMATE_DETAL1_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:T_ESTIMATE_DETAL1_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:T_ESTIMATE_DETAL1_clear
		...
		/**
		 * T_ESTIMATE_DETAL1クラスの標準コンストラクタ
		 */
		public T_ESTIMATE_DETAL1()
		{
			//{{user_implement_dev:T_ESTIMATE_DETAL1_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:T_ESTIMATE_DETAL1_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class T_JOB_ODR_R extends DataObject
	{
		protected String m_selcmd = "SELECT "
+"  T_JOB_ODR.JOB_ODR_CD, "
+"  TO_CHAR(T_JOB_ODR.JOB_ODR_DLV_DATE,'YYYY/MM/DD') AS JOB_ODR_DLV_DATE, "
+"  T_JOB_ODR.JOB_ODR_QTY, "
+"  T_JOB_ODR.ALC_GRP_CD "
+"FROM "
+"  T_JOB_ODR_ODR_ALC, "
+"  T_JOB_ODR "
+"WHERE "
+"  T_JOB_ODR_ODR_ALC.ODR_NO = ? "
+"  AND T_JOB_ODR_ODR_ALC.JOB_ODR_CD = T_JOB_ODR.JOB_ODR_CD";
		protected String m_chkcmd = null;
		protected String m_inscmd = null;
		protected String m_updcmd = null;
		protected String m_delcmd = null;
		...
		//{{user_implement_dev:T_JOB_ODR_R_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:T_JOB_ODR_R_def
		...
		public List read(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_JOB_ODR_R_read
			if(m_selcmd==null) throw new FoundationException("T_JOB_ODR_R", "read", "クエリー未登録");
		...
		public List read(Connection conn, KM0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_JOB_ODR_R_read2
			if(m_selcmd==null) throw new FoundationException("T_JOB_ODR_R", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, KM0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_JOB_ODR_R_read3
			if(m_selcmd==null) throw new FoundationException("T_JOB_ODR_R", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public KM0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setALC_GRP_CD( getString(4, rs) );
		...
		public boolean hasRecord(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("T_JOB_ODR_R", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_JOB_ODR_R_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:T_JOB_ODR_R_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:T_JOB_ODR_R_clear
		...
		/**
		 * T_JOB_ODR_Rクラスの標準コンストラクタ
		 */
		public T_JOB_ODR_R()
		{
			//{{user_implement_dev:T_JOB_ODR_R_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:T_JOB_ODR_R_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class M_ITEM_SPEC2 extends DataObject
	{
		protected String m_selcmd = "SELECT "
+"  M_ITEM_SPEC.TAX_CD "
+"FROM "
...
+"  AND M_ITEM_SPEC.CUST_ITEM_CD = ?";
		...
		//{{user_implement_dev:M_ITEM_SPEC2_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:M_ITEM_SPEC2_def
		...
		public List read(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:M_ITEM_SPEC2_read
			if(m_selcmd==null) throw new FoundationException("M_ITEM_SPEC2", "read", "クエリー未登録");
		...
		public List read(Connection conn, KM0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:M_ITEM_SPEC2_read2
			if(m_selcmd==null) throw new FoundationException("M_ITEM_SPEC2", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, KM0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:M_ITEM_SPEC2_read3
			if(m_selcmd==null) throw new FoundationException("M_ITEM_SPEC2", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean hasRecord(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("M_ITEM_SPEC2", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, KM0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:M_ITEM_SPEC2_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:M_ITEM_SPEC2_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:M_ITEM_SPEC2_clear
		...
		/**
		 * M_ITEM_SPEC2クラスの標準コンストラクタ
		 */
		public M_ITEM_SPEC2()
		{
			//{{user_implement_dev:M_ITEM_SPEC2_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:M_ITEM_SPEC2_constractor
	...
	public void clear()
	{
		...
		mTBL_T_ESTIMATE.clear();
		mTBL_T_ESTIMATE = null;
		mCAL_T_ESTIMATE.clear();
		mCAL_T_ESTIMATE = null;
		mTBL_T_ODR.clear();
		mTBL_T_ODR = null;
		mSEQ_RSLT_ODR.clear();
		mSEQ_RSLT_ODR = null;
		mreadT_ODR_CTL.clear();
		mreadT_ODR_CTL = null;
		mTBL_T_ODR_UNSTOCK.clear();
		mTBL_T_ODR_UNSTOCK = null;
		mDEL_T_ODR.clear();
		mDEL_T_ODR = null;
		mT_SERVICE.clear();
		mT_SERVICE = null;
		mCHECK_STS_T_ESTIMATE_DETAL.clear();
		mCHECK_STS_T_ESTIMATE_DETAL = null;
		mMODIFY_CNT_T_ESTIMATE.clear();
		mMODIFY_CNT_T_ESTIMATE = null;
		mUPD_REST_T_ESTIMATE.clear();
		mUPD_REST_T_ESTIMATE = null;
		mSYS_JOB_ODR_CD_CTRL.clear();
		mSYS_JOB_ODR_CD_CTRL = null;
		mSEQ_ODR_UNSTOCK.clear();
		mSEQ_ODR_UNSTOCK = null;
		mHS_T_ODR_UNSTOCK.clear();
		mHS_T_ODR_UNSTOCK = null;
		mM_EXCH_RATE.clear();
		mM_EXCH_RATE = null;
		mM_ORG.clear();
		mM_ORG = null;
		mUSER_MST.clear();
		mUSER_MST = null;
		mCHECK_M_ITEM_SPEC.clear();
		mCHECK_M_ITEM_SPEC = null;
		mM_ITEM.clear();
		mM_ITEM = null;
		mT_ESTIMATE_R.clear();
		mT_ESTIMATE_R = null;
		...
		mT_ESTIMATE2_R.clear();
		mT_ESTIMATE2_R = null;
		mselectM_ITEM.clear();
		mselectM_ITEM = null;
		mselectT_TRAN_APR.clear();
		mselectT_TRAN_APR = null;
		mselectT_TRAN_APR1.clear();
		mselectT_TRAN_APR1 = null;
		mT_ESTIMATE_DETAL1.clear();
		mT_ESTIMATE_DETAL1 = null;
		mT_JOB_ODR_R.clear();
		mT_JOB_ODR_R = null;
		mM_ITEM_SPEC2.clear();
		mM_ITEM_SPEC2 = null;
	 ...
	 */
	public KM0030010Entity() throws FoundationException
	{
