/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KV0020/src/com/nec/jp/orteus/metamorBase/KV0020/KV0020B005/T_SHIP.java,v $
 *
...
public class T_SHIP extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setSHIP_SEQ_NO_C(String value) throws FoundationException { getAdapt_C().setString(7, value); }
		...
		public void setDEPO_WH_CD_C(String value) throws FoundationException { getAdapt_C().setString(18, value); }
		public void setSHIP_DATE_C(String value) throws FoundationException { getAdapt_C().setString(19, value); }
		...
		public void setSHIP_UNIT_PRICE_C(String value) throws FoundationException { getAdapt_C().setString(22, value); }
		public void setSHIP_ODR_AMOUNT_C(String value) throws FoundationException { getAdapt_C().setString(23, value); }
		public void setSHIP_ODR_AMOUNT_EXCH_RATES_C(String value) throws FoundationException { getAdapt_C().setString(24, value); }
		public void setCURRNCY_CD_C(String value) throws FoundationException { getAdapt_C().setString(25, value); }
		public void setINSPC_ACPT_INFO_IF_CTRL_NO_C(String value) throws FoundationException { getAdapt_C().setString(26, value); }
		public void setCUS_DLV_CD_C(String value) throws FoundationException { getAdapt_C().setString(27, value); }
		public void setCUS_DLV_KEY_CD_C(String value) throws FoundationException { getAdapt_C().setString(28, value); }
		...
		public int create() throws BatchAppException
		{
			try {
				...
				setSHIP_SEQ_NO_C(m_med.getCTRL_NO());
				...
				setDEPO_WH_CD_C(m_med.getDEPO_WH_CD());
				setSHIP_DATE_C(m_med.getIN_DATE());
				setSHIP_QTY_C(m_med.getIN_QTY());
				setUNIT_CD_C(m_med.getUNIT_CD());
				setSHIP_UNIT_PRICE_C(m_med.getIN_UNIT_PRICE());
				...
				setCUS_DLV_CD_C(m_med.getDLV_CD());
				setCUS_DLV_KEY_CD_C(m_med.getDLV_KEY_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("T_SHIP", "create", "レコード新規追加パラメータ設定処理失敗");
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				BatchAppException be=new BatchAppException("T_SHIP", "read", "レコード検索条件設定処理失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public String getSHIP_SEQ_NO_R() throws FoundationException { return m_doRs.getString(1); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setCTRL_NO(getSHIP_SEQ_NO_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("T_SHIP", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("T_SHIP", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	...
	void prepareAll() throws BatchAppException
	{
		...
		try {
			...
			BatchAppException be=new BatchAppException("T_SHIP", "prepareALL(FoundationException)", "SQL文のprepareで失敗しました");
			be.addMessage(e.getErrmsg());
			throw be;
		} catch(SQLException e) {
			BatchAppException be=new BatchAppException("T_SHIP", "prepareALL(SQLException)", "SQL文のprepareで失敗しました");
			throw be;
		}
	 ...
	 *
		 */
	public T_SHIP(medKV0020B005 med, BatchAppConductor cdr) throws SystemException
	{
...
+"  TO_CHAR(SEQ_SHIP_SEQ_NO.NEXTVAL) as NEXTVAL "
+"FROM "
+"  DUAL";
	protected static String m_inscmd = "insert into "
+"  T_SHIP(\"SHIP_SEQ_NO\", \"SHIP_ODR_NO\", \"SLIP_CD\", \"ITEM_CD\", \"CUST_ITEM_CD\", \"CUST_ODR_NO\", \"CUST_CD\", \"CUST_NAME\", \"CUST_CHRG_PSN_CD\", \"SHIP_ODR_ISS_PSN_CD\", \"DLV_LOC_CD\", \"DEPO_WH_CD\", \"SHIP_DATE\", \"SHIP_QTY\", \"UNIT_CD\", \"SHIP_UNIT_PRICE\", \"SHIP_ODR_AMOUNT\", \"SHIP_ODR_AMOUNT_EXCH_RATES\", \"CURRNCY_CD\", \"INSPC_ACPT_INFO_IF_CTRL_NO\", \"CUS_DLV_CD\", \"CUS_DLV_KEY_CD\", \"PART_DLV_SEQ_NO\", \"SLIP_TRN_CD\", \"DEPO_TYP\", \"DIRECT_DLV_FLG\", \"DEL_FLG\") "
+"values "
+"  (TO_NUMBER(?), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, TO_DATE(?,'YYYY/MM/DD'), ?, ?, ?, ?, ?, ?, ?, ?, ?, 1, 1, 20, 0, 0)";
