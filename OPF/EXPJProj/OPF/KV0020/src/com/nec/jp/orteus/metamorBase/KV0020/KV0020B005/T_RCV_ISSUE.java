/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KV0020/src/com/nec/jp/orteus/metamorBase/KV0020/KV0020B005/T_RCV_ISSUE.java,v $
 *
...
public class T_RCV_ISSUE extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setRCV_ISSUE_CTRL_CD_C(String value) throws FoundationException { getAdapt_C().setString(7, value); }
		public void setITEM_CD_C(String value) throws FoundationException { getAdapt_C().setString(8, value); }
		public void setPLANT_CD_C(String value) throws FoundationException { getAdapt_C().setString(9, value); }
		public void setWH_CD_C(String value) throws FoundationException { getAdapt_C().setString(10, value); }
		public void setRCV_ISSUE_QTY_C(String value) throws FoundationException { getAdapt_C().setString(11, value); }
		public void setRCV_ISSUE_DATE_C(String value) throws FoundationException { getAdapt_C().setString(12, value); }
		...
		public int create() throws BatchAppException
		{
			try {
				...
				setPLANT_CD_C(m_med.getITEM_STOK_PLANT_CD());
				setWH_CD_C(m_med.getDEPO_WH_CD());
				setRCV_ISSUE_QTY_C(m_med.getIN_QTY());
				setRCV_ISSUE_DATE_C(m_med.getIN_DATE());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("T_RCV_ISSUE", "create", "レコード新規追加パラメータ設定処理失敗");
	...
	void prepareAll() throws BatchAppException
	{
		...
		try {
			...
			BatchAppException be=new BatchAppException("T_RCV_ISSUE", "prepareALL(FoundationException)", "SQL文のprepareで失敗しました");
			be.addMessage(e.getErrmsg());
			throw be;
		} catch(SQLException e) {
			BatchAppException be=new BatchAppException("T_RCV_ISSUE", "prepareALL(SQLException)", "SQL文のprepareで失敗しました");
			throw be;
		}
	...
	/**
	 * T_RCV_ISSUEクラスの標準コンストラクタ
	 *
		 */
	public T_RCV_ISSUE(medKV0020B005 med, BatchAppConductor cdr) throws SystemException
	{
...
+"  T_RCV_ISSUE(\"RCV_ISSUE_CTRL_CD\", \"ITEM_CD\", \"PLANT_CD\", \"WH_CD\", \"RCV_ISSUE_QTY\", \"RCV_ISSUE_DATE\", \"RCV_ISSUE_TYP\", \"RCV_ISSUE_GNR_TYP\", \"STOCK_UPD_TYP\", \"RCV_ISSUE_CMPLT_FLG\") "
+"values "
+"  (?, ?, ?, ?, -1*?, TO_DATE(?, 'YYYY/MM/DD'), 2, 31, 2, 1)";
