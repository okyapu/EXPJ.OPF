/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KV0020/src/com/nec/jp/orteus/metamorBase/KV0020/KV0020B005/M_EXCH_RATE.java,v $
 *
...
public class M_EXCH_RATE extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setCUR_CD_R(String value) throws FoundationException { getAdapt_R().setString(2, value); }
		public void setEXCH_TYP_R(String value) throws FoundationException { getAdapt_R().setString(3, value); }
		public void setEXCH_START_DATE_R(String value) throws FoundationException { getAdapt_R().setString(4, value); }
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setCUR_CD_R(m_med.getCUR_CD());
				setEXCH_TYP_R(m_med.getEXCH_TYP());
				setEXCH_START_DATE_R(m_med.getIN_DATE());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("M_EXCH_RATE", "read", "レコード検索条件設定処理失敗");
		...
		public String getEXCH_RATE_R() throws FoundationException { return m_doRs.getString(1); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				BatchAppException be=new BatchAppException("M_EXCH_RATE", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("M_EXCH_RATE", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	 ...
	 *
		 */
	public M_EXCH_RATE(medKV0020B005 med, BatchAppConductor cdr) throws SystemException
	{
...
+"order by M_EXCH_RATE.\"EXCH_START_DATE\" desc";
