/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KV0020/src/com/nec/jp/orteus/metamorBase/KV0020/KV0020B002/BatchGyomuDate.java,v $
 *
...
public class BatchGyomuDate extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setPLANT_CD_R(m_med.getbtPLANT_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("BatchGyomuDate", "read", "レコード検索条件設定処理失敗");
		...
		public String getBUSINESS_OPR_DATE_R() throws FoundationException { return m_doRs.getString(1); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setbtBUSINESS_OPR_DATE(getBUSINESS_OPR_DATE_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("BatchGyomuDate", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("BatchGyomuDate", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	...
	/**
	 * BatchGyomuDateクラスの標準コンストラクタ
	 *
		 */
	public BatchGyomuDate(medKV0020B002 med, BatchAppConductor cdr) throws SystemException
	{
