/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KV0020/src/com/nec/jp/orteus/metamorBase/KV0020/KV0020B005/T_ITEM_STOCK.java,v $
 *
...
public class T_ITEM_STOCK extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setITEM_CD_R(String value) throws FoundationException { getAdapt_R().setString(1, value); }
		public void setWH_CD_R(String value) throws FoundationException { getAdapt_R().setString(2, value); }
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setITEM_CD_R(m_med.getITEM_CD());
				setWH_CD_R(m_med.getDEPO_WH_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("T_ITEM_STOCK", "read", "レコード検索条件設定処理失敗");
		...
		public void setSTOCK_ON_HAND_QTY_U(String value) throws FoundationException { getAdapt_U().setString(4, value); }
		public void setITEM_CD_U(String value) throws FoundationException { getAdapt_U().setString(5, value); }
		public void setWH_CD_U(String value) throws FoundationException { getAdapt_U().setString(6, value); }
		...
		public int update() throws BatchAppException
		{
			try {
				...
				setSTOCK_ON_HAND_QTY_U(m_med.getIN_QTY());
				setITEM_CD_U(m_med.getITEM_CD());
				setWH_CD_U(m_med.getDEPO_WH_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("T_ITEM_STOCK", "update", "レコード更新条件設定処理失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setITEM_STOK_PLANT_CD(getPLANT_CD_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("T_ITEM_STOCK", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("T_ITEM_STOCK", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	...
	void prepareAll() throws BatchAppException
	{
		...
		try {
			...
			BatchAppException be=new BatchAppException("T_ITEM_STOCK", "prepareALL(FoundationException)", "SQL文のprepareで失敗しました");
			be.addMessage(e.getErrmsg());
			throw be;
		} catch(SQLException e) {
			BatchAppException be=new BatchAppException("T_ITEM_STOCK", "prepareALL(SQLException)", "SQL文のprepareで失敗しました");
			throw be;
		}
	...
	/**
	 * T_ITEM_STOCKクラスの標準コンストラクタ
	 *
		 */
	public T_ITEM_STOCK(medKV0020B005 med, BatchAppConductor cdr) throws SystemException
	{
