/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KV0020/src/com/nec/jp/orteus/metamorBase/KV0020/KV0020B005/mainKV0020B005.java,v $
 *
...
/**
 * CLASS     : mainKV0020B005 クラス
 * ファイル・クラス説明
 * @author $Author: geng-jia $
 * @version $Revision: 1.10 $ $Date: 2015/12/03 08:56:00 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class mainKV0020B005
{
    // リターン値
	...
	public static void main(String args[])
	{
		...
		try {
			...
			if (sysLog == null) {
				...
				if(!sysLog.init("com.nec.jp.orteus.metamorBase.KV0020B005")) {
					//システムログの初期化に失敗しました
			...
			try {
				...
				// 標準出力ファイル名設定
				String logFileName = "KV0020B005.log";
				if (logFileName == null) {
				...
				// 新規作成のためバッチログファイル削除
				if (blogMode == false) {
					File logFile = new File(logOutputPath + "/KV0020B005.log");
				...
				System.setOut(new PrintStream(new FileOutputStream(logOutputPath + "/KV0020B005stdout.log", blogMode)));
				System.setErr(new PrintStream(new FileOutputStream(logOutputPath + "/KV0020B005stderr.log", blogMode)));
			...
			cdrKV0020B005 ebo = new cdrKV0020B005();
