/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KV0020/src/com/nec/jp/orteus/metamorBase/KV0020/KV0020B002/M_CUST.java,v $
 *
 ...
 * @version $Revision: 1.8 $ $Date: 2015/12/03 08:55:50 $
 */
...
public class M_CUST extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setEDI_CUST_VEND_CD_R(String value) throws FoundationException { getAdapt_R().setString(1, value); }
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setEDI_CUST_VEND_CD_R(m_med.getcustEDI_CUST_VEND_CD());
		...
		public String getCUR_CD_R() throws FoundationException { return m_doRs.getString(2); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setcustCUST_CD(getCUST_CD_R());
				m_med.setcustCUR_CD(getCUR_CD_R());
			} catch(FoundationException e) {
	 ...
	 *
		 */
	public M_CUST(medKV0020B002 med, BatchAppConductor cdr) throws SystemException
	{
	...
	// 各状態で実行するsql文の定義
	protected static String m_selcmd = "select M_CUST.\"CUST_CD\" as \"CUST_CD\", "
+"       M_CUST.\"CUR_CD\" as \"CUR_CD\" "
+"from M_CUST, "
+"     SYS_MY_COMPANY "
+"where M_CUST.\"COMPANY_CD\" = SYS_MY_COMPANY.\"COMPANY_CD\" "
