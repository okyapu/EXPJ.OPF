/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KV0020/src/com/nec/jp/orteus/metamorBase/KV0020/KV0020B005/M_CUST_BASE.java,v $
 *
...
public class M_CUST_BASE extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setDLV_LOC_CD_R(String value) throws FoundationException { getAdapt_R().setString(3, value); }
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setDLV_LOC_CD_R(m_med.getDLV_LOC_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("M_CUST_BASE", "read", "レコード検索条件設定処理失敗");
		...
		public String getDEPO_WH_CD_R() throws FoundationException { return m_doRs.getString(1); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setDEPO_WH_CD(getDEPO_WH_CD_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("M_CUST_BASE", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("M_CUST_BASE", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	 ...
	 *
		 */
	public M_CUST_BASE(medKV0020B005 med, BatchAppConductor cdr) throws SystemException
	{
