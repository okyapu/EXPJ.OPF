/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KV0020/src/com/nec/jp/orteus/metamorBase/KV0020/KV0020B001/cdrKV0020B001.java,v $
 *
...
public class cdrKV0020B001 extends Object
		implements IBatchAppCommon
{
	...
	public int getType() { return m_conductor.getType(); }
        ...
        public int beginProc() throws BatchAppException
        {
         try {
          ...
          setCommitFlag(false);
          BatchAppException be=new BatchAppException("cdrKV0020B001", "beginProc", "conductorの初期処理に失敗しました");
	...
	medKV0020B001 m_med=new medKV0020B001();

	// BatchAppConductorクラスインスタンス
	BatchAppConductor m_conductor=new BatchAppConductor("KV0020B001");
	...
	/**
	 * ctrKV0020B001クラス 標準コンストラクタ
	 *
		 */
	public cdrKV0020B001() throws BatchAppException
	{
		initialize();
