/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AC0010/src/com/nec/jp/orteus/metamorBase/AC0010/AC0010010Control.java,v $
 *
...
public class AC0010010Control
{
	...
	//{{user_implement_code_main
       ...
       //	public Object getListvalue(int x) { return this.list.get(x); }	// リストの値を返します。
        public AC0010010Struct getListvalue(int x) { return (AC0010010Struct)(this.list.get(x)); }	// リストの値を返します。
        public AC0010010Struct getStruct() { return this.struct; }	// Structを返します。
        public AC0010010Struct createStruct() { return new AC0010010Struct(); }	// 新しいStructを作って返します。
        public void setStruct(Object structname) { this.struct.setStruct((AC0010010Struct)structname); }	// Structをセットします。
        ...
        // リストの値（メディエータ）を返します。
        public AC0010010Struct getList1value(int x) { return (AC0010010Struct)(this.list1.get(x)); }
        ...
        // リストの値（メディエータ）を返します。
        public AC0010010Struct getList2value(int x) { return (AC0010010Struct)(this.list2.get(x)); }
...
//           cmd = cmd + " " + "com.nec.jp.orteus.metamorBase.AC0010.AC0010B001.mainAC0010B001"; // 呼び出し先クラス
//           cmd = cmd + " " + userID;       // ユーザID
//           cmd = cmd + " " + mrpExpMode;   // 所要量展開モード
//           cmd = cmd + " " + plantTyp;     // 処理区分(工場指定タイプ)
...
//           Process p = runtime.exec(cmd);
           ...
           buffer.add("com.nec.jp.orteus.metamorBase.AC0010.AC0010B001.mainAC0010B001"); // 呼び出し先クラス
           buffer.add(userID);             //  ユーザID
           buffer.add(mrpExpMode);         // 所要量展開モード
           buffer.add(plantTyp);           // 処理区分(工場指定タイプ)
	...
	public void controlexecute() throws BusinessProcessException, FoundationException
	{
		...
		logger.entering("AC0010010Control"+":USER="+struct.getsUser_ID(),"controlexecute");
              ...
              // insert Original Code ===================================================
                 ...
                 if (plantTyp.equals("1")) {
                  ...
                  if (this.list != null && this.list.size() > 0) {
                   // バッチ処理の実行
                   executeBatchProgram(sysUSER_CD, plantTyp, plantCd);
                  } else {
                   //sysLog.info("AC00102", sysUSER_CD); // 工場データが存在しません。
                   //AlarmMessage almMsg = new AlarmMessage("AC00102", new String[0]);
                   //msgStruct.getWarn().add(almMsg.getMessage());
                   ExpjMessage emsg = new ExpjMessage("AC00102",new String[0]);
                   msgStruct.addError( emsg );
                   return ;
                  }
                 ...
                 // 全工場の場合
                  ...
                  plantCd = "plantCd"; // ダミー文字列(この値は使われない)
                  // バッチ処理の実行
                  executeBatchProgram(sysUSER_CD, plantTyp, plantCd);
                 }
                ...
                //}}user_implement_dev:<controlexecute>
		logger.exiting("AC0010010Control"+":USER="+struct.getsUser_ID(),"controlexecute");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AC0010");
		logger.entering("AC0010010Control"+":USER="+struct.getsUser_ID(),"controlclear");
			//{{user_implement_dev:<controlclear>
                 ...
                 // 初期値をセット
                 struct.setrdoPlantTyp1("true");             // 工場指定タイプ "1"：工場指定
                 struct.settxtPlantCd(getsysPLANT_CD()); // 工場コード 自工場コード
                //}}user_implement_dev:<controlclear>
		logger.exiting("AC0010010Control"+":USER="+struct.getsUser_ID(),"controlclear");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AC0010");
		logger.entering("AC0010010Control"+":USER="+struct.getsUser_ID(),"controlclose");
			//{{user_implement_dev:<controlclose>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<controlclose>
		logger.exiting("AC0010010Control"+":USER="+struct.getsUser_ID(),"controlclose");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AC0010");
		logger.entering("AC0010010Control"+":USER="+struct.getsUser_ID(),"controlINITIAL");
		//{{user_implement_dev:<controlINITIAL>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<controlINITIAL>
		logger.exiting("AC0010010Control"+":USER="+struct.getsUser_ID(),"controlINITIAL");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AC0010");
		logger.entering("AC0010010Control"+":USER="+struct.getsUser_ID(),"controlRELOAD");
		//{{user_implement_dev:<controlRELOAD>
                 // TODO: ユーザ定義のコードを記述してください
                
                 // 画面起動時の初期値をセット
                 struct.settxtPlantCd(getsysPLANT_CD());
                 struct.setrdoPlantTyp1("true");
              
                //}}user_implement_dev:<controlRELOAD>
		logger.exiting("AC0010010Control"+":USER="+struct.getsUser_ID(),"controlRELOAD");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AC0010");
		logger.entering("AC0010010Control"+":USER="+struct.getsUser_ID(),"controlPREPARATION");
...
//		}
		...
		//{{user_implement_dev:<controlPREPARATION>
                ...
                //}}user_implement_dev:<controlPREPARATION>
		logger.exiting("AC0010010Control"+":USER="+struct.getsUser_ID(),"controlPREPARATION");
...
//			e.printStackTrace();
//			throw new FoundationException("AC0010010Control",e.getMessage(),"control_eventHandllerメソッドでエラーが発生しました。");
	...
	public void createDefaultCSV(List list, String sTitle[]) throws BusinessProcessException, FoundationException {
		...
		//{{user_implement_dev:<createDefaultCSV>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AC0010010-E999","CSVの出力処理"));
			throw new FoundationException("AC0010010Control",e.getMessage(),"createDefaultCSVメソッドでエラーが発生しました。");
		}
...
//				objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AC0010010-E999","システム日付の取得処理"));
				throw new FoundationException("AC0010010Control","beginTransaction()","システム日付取得処理でエラーが発生しました。");
			}
		...
		//{{user_implement_dev:<beginTransaction>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AC0010010-E999","コントロールのイベント処理"));
			throw new FoundationException("AC0010010Control",e.getMessage(),"beginTransactionメソッドでエラーが発生しました。");
		}
	 ...
	 * メンバ変数の定義
	 */
	protected AC0010010Entity entity;
	protected AC0010010Struct struct;
	...
	public void initialize() throws FoundationException
	{
		...
		entity = new AC0010010Entity();
		struct = new AC0010010Struct();
	...
	/**
	 * AC0010010クラスの標準コンストラクタ
	 */
	public AC0010010Control() throws BusinessProcessException, FoundationException
	{
		initialize();
	...
	public void setOrMsgKey(List keyList) throws MessageApiException {
		...
		for (int i = 0; msgKeyTypeArray != null && i < msgKeyTypeArray.size(); i++) {
			...
			for(int j = 0; j < keyList.size(); j++) {
				AC0010010Struct key = (AC0010010Struct)keyList.get(j);
				// メッセージキーを作成する
		...
		try {
			for (int i = 0; msgKeyTypeArray != null && i < msgKeyTypeArray.size(); i++) {
				...
				for (int j = 0; msgKeyArray != null && j < msgKeyArray.size(); j++) {
					...
					AC0010010Struct key = new AC0010010Struct();
