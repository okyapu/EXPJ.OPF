/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AC0010/src/com/nec/jp/orteus/metamorBase/AC0010/AC0010B001/CtrlMain.java,v $
 *
		...
		implements IBatchAppCommon
{
	 ...
	 *
		 */
	public CtrlMain(medAC0010B001 med, BatchAppConductor cdr) throws BatchAppException
	{
		// メンバ変数を初期化します
		m_conductor = cdr;
		m_med = med;
	...
	//{{user_implement_code
         ...
         *
         */
        public CtrlMain(medAC0010B001 med) throws BatchAppException
        {
         // メンバ変数を初期化します
         m_med = med;
         m_control = new interControl(med);
		...
		implements IBatchAppCommon
	{
		...
		public interControl(medAC0010B001 med) throws BatchAppException
		{
			// 各メンバ変数の初期化
			m_med = med;
