/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AC0010/src/com/nec/jp/orteus/metamorBase/AC0010/AC0010B001/medAC0010B001.java,v $
 *
...
/**
 * CLASS     : medAC0010B001 クラス
 * ファイル・クラス説明
 * @author $Author: xl-hs-zzw $
 * @version $Revision: 1.12 $ $Date: 2014/11/05 07:01:05 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class medAC0010B001 extends Object
{
	 ...
	 * プログラム名を格納します。
	 */
	protected String m_Progname="AC0010B001";
	...
	/**
	 * medAC0010B001クラスの標準コンストラクタ
	 *
		 */
	public medAC0010B001()
	{
		// mediator変数を初期化します
	...
	//////////////////////////////
       ...
       // insert Original Code ===================================================
           ...
           // 処理区分
           private int plantTyp = 0;                // 1:指定工場 2:全工場
...
//               Process p = Runtime.getRuntime().exec(cmd);
           ...
           protected void setParamArgs() throws Exception{
               ...
               if (argsLength >= 3) {
                   userId = args[0];
                   mrpExpMode = args[1];
                   if (mrpExpMode.equals("1")){
                       jobOdrCd = "";
                   }
                   try {
                       plantTyp = Integer.parseInt(args[2]);
                   } catch (NumberFormatException e) {
                       errCode = "AC00111"; // バッチ処理引数の形式が不正です
                       throw e;
                   }
                   // 処理区分（工場指定タイプ）が 1:指定工場 の場合、工場コードを取得
                   if (plantTyp == 1) {
                       if (argsLength >= 3) {
                           plantCd = args[3];
                       } else {
