/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AC0010/src/com/nec/jp/orteus/metamorBase/AC0010/AC0010020Servlet.java,v $
 *
...
public class AC0010020Servlet extends HttpServlet
{
	 ...
	 * @param control AC0010020Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AC0010020Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AC0010020Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AC0010020Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AC0010020Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AC0010020Entity entity = control.entity;
		AC0010020Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AC0010020Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
                 // TODO: ユーザ定義のコードを記述してください
              //			objMessage.m_writer.write( Level.ALL, "AC0010020"+" $Revision: 1.10 $" );
                 control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AC0010020Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AC0010020Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AC0010020Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AC0010");
		logger.entering("AC0010020Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
		...
		//{{user_implement_dev:<reloadEvent>
              ...
              //			e.printStackTrace();
              //			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AC0010020-E999","リロード処理"));
                 ExpjException ee = new ExpjException(e, "ZZ01106");
                 throw ee;
                }
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AC0010020Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickPrint(
					...
					HttpSession so,
					Hashtable params,
					AC0010020Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AC0010020Entity entity = control.entity;
		AC0010020Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AC0010");
		logger.entering("AC0010020Servlet"+":USER="+request.getRemoteUser(),"onClickPrint");
		//{{user_implement_dev:<onClickPrint>
                ...
                //}}user_implement_dev:<onClickPrint>
		logger.exiting("AC0010020Servlet"+":USER="+request.getRemoteUser(),"onClickPrint");
					...
					AC0010020Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AC0010");
		logger.entering("AC0010020Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
		//{{user_implement_dev:<onClickClear>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("AC0010020Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
					...
					AC0010020Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AC0010");
		logger.entering("AC0010020Servlet"+":USER="+request.getRemoteUser(),"onClickClose");
		//{{user_implement_dev:<onClickClose>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickClose>
		logger.exiting("AC0010020Servlet"+":USER="+request.getRemoteUser(),"onClickClose");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AC0010020Struct struct)
	{
		...
		String[] MRP_DATE = ((params.containsKey("MRP_DATE")) ? (String[])params.get("MRP_DATE") : (String[])null);
		...
		String[] PAGE_NO = ((params.containsKey("PAGE_NO")) ? (String[])params.get("PAGE_NO") : (String[])null);
		...
		String[] MRP_DATE_FROM = ((params.containsKey("MRP_DATE_FROM")) ? (String[])params.get("MRP_DATE_FROM") : (String[])null);
		String[] MRP_DATE_TO = ((params.containsKey("MRP_DATE_TO")) ? (String[])params.get("MRP_DATE_TO") : (String[])null);
		...
		String[] IN_MRP_DATE_FROM = ((params.containsKey("IN_MRP_DATE_FROM")) ? (String[])params.get("IN_MRP_DATE_FROM") : (String[])null);
		String[] IN_MRP_DATE_TO = ((params.containsKey("IN_MRP_DATE_TO")) ? (String[])params.get("IN_MRP_DATE_TO") : (String[])null);
		...
		struct.setMRP_DATE( ((MRP_DATE == null) ? (String)null : MRP_DATE[0]) );
		struct.setList_MRP_DATE(TypeConverter.convert(MRP_DATE));
		...
		struct.setJOB_ODR_DETAIL_NO( ((JOB_ODR_DETAIL_NO == null) ? (String)null : JOB_ODR_DETAIL_NO[0]) );
		...
		if( (PAGE_NO == null)||("".equals(PAGE_NO[0])) ) {
		   struct.setPAGE_NO( (Integer)null );
		} else {
		   struct.setPAGE_NO( new Integer(PAGE_NO[0]) );
		   struct.setList_PAGE_NO(TypeConverter.convert(PAGE_NO));
		}
		if( (TOTAL_PAGE == null)||("".equals(TOTAL_PAGE[0])) ) {
		   struct.setTOTAL_PAGE( (Integer)null );
		} else {
		   struct.setTOTAL_PAGE( new Integer(TOTAL_PAGE[0]) );
		...
		struct.setMRP_DATE_FROM( ((MRP_DATE_FROM == null) ? (String)null : MRP_DATE_FROM[0]) );
		struct.setList_MRP_DATE_FROM(TypeConverter.convert(MRP_DATE_FROM));
		struct.setMRP_DATE_TO( ((MRP_DATE_TO == null) ? (String)null : MRP_DATE_TO[0]) );
		struct.setList_MRP_DATE_TO(TypeConverter.convert(MRP_DATE_TO));
		...
		struct.setIN_MRP_DATE_FROM( ((IN_MRP_DATE_FROM == null) ? (String)null : IN_MRP_DATE_FROM[0]) );
		struct.setList_IN_MRP_DATE_FROM(TypeConverter.convert(IN_MRP_DATE_FROM));
		struct.setIN_MRP_DATE_TO( ((IN_MRP_DATE_TO == null) ? (String)null : IN_MRP_DATE_TO[0]) );
		struct.setList_IN_MRP_DATE_TO(TypeConverter.convert(IN_MRP_DATE_TO));
	...
	public static String DEFAULT_TARGET = "/AC0010020.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAC0010020Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAC0010020Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AC0010");
		logger.entering("AC0010020Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AC0010020Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AC0010020Control control;
		AC0010020Entity  entity = null;
		AC0010020Struct  struct = null;
		...
		try {
			...
			if( (control = (AC0010020Control)so.getAttribute("AC0010020Control_"+request.getSession(false).getId())) == null ) {
				control = new AC0010020Control();
			...
			try {
				...
				so.setAttribute("AC0010020Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.AC0010.AC0010020Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AC0010020Servlet()
	{
		//{{user_implement_dev:<AC0010020_DisConnect_FLG>
		...
		//{{user_implement_dev:<AC0010020Servlet>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<AC0010020Servlet>
	}
