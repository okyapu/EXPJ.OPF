/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AC0010/src/com/nec/jp/orteus/metamorBase/AC0010/AC0010B001/readSysOdCalcCtrl_all.java,v $
 *
...
/**
 * CLASS     : readSysOdCalcCtrl_all クラス
 * ファイル・クラス説明
 * @author $Author: xl-hs-zzw $
 * @version $Revision: 1.10 $ $Date: 2014/11/05 07:01:06 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class readSysOdCalcCtrl_all extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				BatchAppException be=new BatchAppException("readSysOdCalcCtrl_all", "read", "レコード検索条件設定処理失敗");
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				BatchAppException be=new BatchAppException("readSysOdCalcCtrl_all", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("readSysOdCalcCtrl_all", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	...
	/**
	 * readSysOdCalcCtrl_allクラスの標準コンストラクタ
	 *
		 */
	public readSysOdCalcCtrl_all(medAC0010B001 med, BatchAppConductor cdr) throws SystemException
	{
	...
	// mediatorクラス インスタンス
	public medAC0010B001 m_med=null;
...
+"  SYS_OD_CALC_CTRL "
+"where "
+"  SYS_OD_CALC_CTRL.\"OD_CALC_FLG\" = 1";
