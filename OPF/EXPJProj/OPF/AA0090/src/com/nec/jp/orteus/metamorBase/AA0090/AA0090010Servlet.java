/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AA0090/src/com/nec/jp/orteus/metamorBase/AA0090/AA0090010Servlet.java,v $
 *
...
public class AA0090010Servlet extends HttpServlet
{
	 ...
	 * @param control AA0090010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AA0090010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AA0090010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AA0090010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AA0090010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AA0090010Entity entity = control.entity;
		AA0090010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AA0090010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
			objMessage.m_writer.write( Level.ALL, "AA0090010"+" $Revision: 1.12 $" );
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AA0090010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AA0090010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AA0090010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0090");
		logger.entering("AA0090010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
		...
		try {
			...
			throw ee;
                ...
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AA0090010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickselect(
					...
					HttpSession so,
					Hashtable params,
					AA0090010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AA0090010Entity entity = control.entity;
		AA0090010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0090");
		logger.entering("AA0090010Servlet"+":USER="+request.getRemoteUser(),"onClickselect");
		...
		try {
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickselect>
		logger.exiting("AA0090010Servlet"+":USER="+request.getRemoteUser(),"onClickselect");
					...
					AA0090010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0090");
		logger.entering("AA0090010Servlet"+":USER="+request.getRemoteUser(),"onClickupdate");
		...
		try {
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickupdate>
		logger.exiting("AA0090010Servlet"+":USER="+request.getRemoteUser(),"onClickupdate");
					...
					AA0090010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0090");
		logger.entering("AA0090010Servlet"+":USER="+request.getRemoteUser(),"onClickclear");
		...
		try{
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickclear>
		logger.exiting("AA0090010Servlet"+":USER="+request.getRemoteUser(),"onClickclear");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AA0090010Struct struct)
	{
		...
		String[] PLANT_ANAME = ((params.containsKey("PLANT_ANAME")) ? (String[])params.get("PLANT_ANAME") : (String[])null);
		...
		struct.setPLANT_ANAME( ((PLANT_ANAME == null) ? (String)null : PLANT_ANAME[0]) );
		struct.setList_PLANT_ANAME(TypeConverter.convert(PLANT_ANAME));
	...
	public static String DEFAULT_TARGET = "/AA0090010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAA0090010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAA0090010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0090");
		logger.entering("AA0090010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AA0090010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AA0090010Control control;
		AA0090010Entity  entity = null;
		AA0090010Struct  struct = null;
		...
		try {
			...
			if( (control = (AA0090010Control)so.getAttribute("AA0090010Control_"+request.getSession(false).getId())) == null ) {
				control = new AA0090010Control();
			...
			try {
				...
				so.setAttribute("AA0090010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.AA0090.AA0090010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AA0090010Servlet()
	{
		//{{user_implement_dev:<AA0090010_DisConnect_FLG>
		...
		//{{user_implement_dev:<AA0090010Servlet>
                //}}user_implement_dev:<AA0090010Servlet>
	}
