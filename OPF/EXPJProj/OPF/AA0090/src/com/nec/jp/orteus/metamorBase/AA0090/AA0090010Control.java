...
public class AA0090010Control
{
	...
	public AA0090010Struct getStruct() { return this.struct; }	// Structの値（メディエータ）を返します。
	...
	public void controlselect() throws BusinessProcessException, FoundationException
	{
		...
		try {
			...
			if(temp_list.size() <= 0){
				...
				// データが存在しない場合のクリア処理
				String w_plantCd = struct.getPLANT_CD();	// キー情報の退避
				this.struct.initialize();					// 表示項目をデフォルトに戻す
				struct.setPLANT_CD(w_plantCd);				// キー情報の設定
...
//			e.printStackTrace();
//			throw new FoundationException("AA0090010Control",e.getMessage(),"control_eventHandllerメソッドでエラーが発生しました。");
	...
	public void createDefaultCSV(List list, String sTitle[]) throws BusinessProcessException, FoundationException {
		...
		//{{user_implement_dev:<createDefaultCSV>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AA0090010-E999","CSVの出力処理"));
			throw new FoundationException("AA0090010Control",e.getMessage(),"createDefaultCSVメソッドでエラーが発生しました。");
		}
...
//				objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AA0090010-E999","システム日付の取得処理"));
				throw new FoundationException("AA0090010Control","beginTransaction()","システム日付取得処理でエラーが発生しました。");
			}
		...
		//{{user_implement_dev:<beginTransaction>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AA0090010-E999","コントロールのイベント処理"));
			throw new FoundationException("AA0090010Control",e.getMessage(),"beginTransactionメソッドでエラーが発生しました。");
		}
