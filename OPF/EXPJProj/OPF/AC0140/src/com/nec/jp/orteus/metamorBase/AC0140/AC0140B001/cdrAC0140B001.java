/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AC0140/src/com/nec/jp/orteus/metamorBase/AC0140/AC0140B001/cdrAC0140B001.java,v $
 *
...
public class cdrAC0140B001 extends Object
		implements IBatchAppCommon
{
	...
	public int getType() { return m_conductor.getType(); }
        ...
        public int beginProc() throws BatchAppException
        {
         try {
          ...
          setCommitFlag(false);
          BatchAppException be=new BatchAppException("cdrAC0140B001", "beginProc", "conductorの初期処理に失敗しました");
	...
	medAC0140B001 m_med=new medAC0140B001();

	// BatchAppConductorクラスインスタンス
	BatchAppConductor m_conductor=new BatchAppConductor("AC0140B001");
	...
	/**
	 * ctrAC0140B001クラス 標準コンストラクタ
	 *
		 */
	public cdrAC0140B001() throws BatchAppException
	{
		initialize();
