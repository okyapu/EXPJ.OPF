/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AC0020/src/com/nec/jp/orteus/metamorBase/AC0020/AC0020B001/readSysDateCtrl.java,v $
 *
...
public class readSysDateCtrl extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN1_R(m_med.getplantCd());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("readSysDateCtrl", "read", "レコード検索条件設定処理失敗");
		...
		public Date getBUSINESS_OPR_DATE_R() throws FoundationException { return m_doRs.getDate(1); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setbusinessOprDate(getBUSINESS_OPR_DATE_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("readSysDateCtrl", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("readSysDateCtrl", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	 ...
	 *
		 */
	public readSysDateCtrl(medAC0020B001 med, BatchAppConductor cdr) throws SystemException
	{
