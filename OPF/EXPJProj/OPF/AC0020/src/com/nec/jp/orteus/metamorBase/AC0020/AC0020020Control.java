/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AC0020/src/com/nec/jp/orteus/metamorBase/AC0020/AC0020020Control.java,v $
 *
...
import com.nec.jp.orteus.metamorBase.AC0020.*;
...
public class AC0020020Control
{
	...
	//{{user_implement_code_main
        ...
        public AC0020020Struct getStruct() { return this.struct; }	// Structの値（メディエータ）を返します。
        ...
        // リストの値（メディエータ）を返します。
        public AC0020020Struct getList1value(int x) { return (AC0020020Struct)(this.list1.get(x)); }
        ...
        // リストの値（メディエータ）を返します。
        public AC0020020Struct getList2value(int x) { return (AC0020020Struct)(this.list2.get(x)); }
	...
	public void controlNone() throws BusinessProcessException, FoundationException
	{
		...
		logger.entering("AC0020020Control"+":USER="+struct.getsUser_ID(),"controlNone");
			//{{user_implement_dev:<controlNone>
                ...
                struct.settxtEntryTime("");
                // ===========================================================
                //}}user_implement_dev:<controlNone>
		logger.exiting("AC0020020Control"+":USER="+struct.getsUser_ID(),"controlNone");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AC0020");
		logger.entering("AC0020020Control"+":USER="+struct.getsUser_ID(),"controlExecute");
			//{{user_implement_dev:<controlExecute>
                ...
                try {
                 ...
                 String jobOdrCd = null;			  // 製番（ＭＲＰでは使用しない）
                 ...
                 jobOdrCd = "jobOdrCd";			   // 製番（ＭＲＰでは使用しない）
...
//                  Process p = runtime.exec(cmd);
              ...
              //			msgStruct.getInfo().add(emsg.getMessage());
                ...
                //}}user_implement_dev:<controlExecute>
		logger.exiting("AC0020020Control"+":USER="+struct.getsUser_ID(),"controlExecute");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AC0020");
		logger.entering("AC0020020Control"+":USER="+struct.getsUser_ID(),"controlClear");
			//{{user_implement_dev:<controlClear>
                 // TODO: ユーザ定義のコードを記述してください
                 this.msgStruct.clearAll();
                 struct.setrdoOutsideTyp1("true");
                 struct.setrdoEntry1Typ1("true");
                 struct.setTIME_CTRL(timeCtrl);
                 struct.sethdnBusinessOprDate(businessOprDate);
                //}}user_implement_dev:<controlClear>
		logger.exiting("AC0020020Control"+":USER="+struct.getsUser_ID(),"controlClear");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AC0020");
		logger.entering("AC0020020Control"+":USER="+struct.getsUser_ID(),"controlClose");
			//{{user_implement_dev:<controlClose>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<controlClose>
		logger.exiting("AC0020020Control"+":USER="+struct.getsUser_ID(),"controlClose");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AC0020");
		logger.entering("AC0020020Control"+":USER="+struct.getsUser_ID(),"controlINITIAL");
		//{{user_implement_dev:<controlINITIAL>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<controlINITIAL>
		logger.exiting("AC0020020Control"+":USER="+struct.getsUser_ID(),"controlINITIAL");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AC0020");
		logger.entering("AC0020020Control"+":USER="+struct.getsUser_ID(),"controlRELOAD");
		//{{user_implement_dev:<controlRELOAD>
              ...
              //			this.doUnBusinessLock();
                 ...
                 if(list == null || list.size() != 1){
                  ...
                  AC0020020Struct wStruct = (AC0020020Struct) list.get(0);
                  struct.sethdnBusinessOprDate( wStruct.gethdnBusinessOprDate());
                  businessOprDate =  wStruct.gethdnBusinessOprDate();
                 }
              ...
              */
                ...
                //}}user_implement_dev:<controlRELOAD>
		logger.exiting("AC0020020Control"+":USER="+struct.getsUser_ID(),"controlRELOAD");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AC0020");
		logger.entering("AC0020020Control"+":USER="+struct.getsUser_ID(),"controlPREPARATION");
...
//		}
		...
		//{{user_implement_dev:<controlPREPARATION>
                ...
                //}}user_implement_dev:<controlPREPARATION>
		logger.exiting("AC0020020Control"+":USER="+struct.getsUser_ID(),"controlPREPARATION");
...
//			e.printStackTrace();
//			throw new FoundationException("AC0020020Control",e.getMessage(),"control_eventHandllerメソッドでエラーが発生しました。");
	...
	public void createDefaultCSV(List list, String sTitle[]) throws BusinessProcessException, FoundationException {
		...
		//{{user_implement_dev:<createDefaultCSV>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AC0020020-E999","CSVの出力処理"));
			throw new FoundationException("AC0020020Control",e.getMessage(),"createDefaultCSVメソッドでエラーが発生しました。");
		}
...
//				objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AC0020020-E999","システム日付の取得処理"));
				throw new FoundationException("AC0020020Control","beginTransaction()","システム日付取得処理でエラーが発生しました。");
			}
		...
		//{{user_implement_dev:<beginTransaction>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AC0020020-E999","コントロールのイベント処理"));
			throw new FoundationException("AC0020020Control",e.getMessage(),"beginTransactionメソッドでエラーが発生しました。");
		}
	 ...
	 * メンバ変数の定義
	 */
	protected AC0020020Entity entity;
	protected AC0020020Struct struct;
	...
	public void initialize() throws FoundationException
	{
		...
		entity = new AC0020020Entity();
		struct = new AC0020020Struct();
	 ...
	 */
	public AC0020020Control() throws BusinessProcessException, FoundationException
	{
		initialize();
	...
	public void setOrMsgKey(List keyList) throws MessageApiException {
		...
		for (int i = 0; msgKeyTypeArray != null && i < msgKeyTypeArray.size(); i++) {
			...
			for(int j = 0; j < keyList.size(); j++) {
				AC0020020Struct key = (AC0020020Struct)keyList.get(j);
				// メッセージキーを作成する
		...
		try {
			for (int i = 0; msgKeyTypeArray != null && i < msgKeyTypeArray.size(); i++) {
				...
				for (int j = 0; msgKeyArray != null && j < msgKeyArray.size(); j++) {
					...
					AC0020020Struct key = new AC0020020Struct();
