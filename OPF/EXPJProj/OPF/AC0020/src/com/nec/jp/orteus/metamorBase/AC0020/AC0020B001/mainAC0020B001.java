/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AC0020/src/com/nec/jp/orteus/metamorBase/AC0020/AC0020B001/mainAC0020B001.java,v $
 *
...
/**
 * CLASS     : mainAC0020B001 クラス
 * ファイル・クラス説明
 * @author $Author: xl-hs-zzw $
 * @version $Revision: 1.6 $ $Date: 2014/11/05 07:01:34 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class mainAC0020B001
{
    // リターン値
	...
	public static void main(String args[])
	{
		...
		try {
			...
			if (sysLog == null) {
				...
				if(!sysLog.init("com.nec.jp.orteus.metamorBase.AC0020B001")) {
					//システムログの初期化に失敗しました
			...
			try {
				...
				// 標準出力ファイル名設定
				String logFileName = "AC0020B001.log";
				if (logFileName == null) {
				...
				// 新規作成のためバッチログファイル削除
				if (blogMode == false) {
					File logFile = new File(logOutputPath + "/AC0020B001.log");
				...
				System.setOut(new PrintStream(new FileOutputStream(logOutputPath + "/AC0020B001stdout.log", blogMode)));
				System.setErr(new PrintStream(new FileOutputStream(logOutputPath + "/AC0020B001stderr.log", blogMode)));
			...
			cdrAC0020B001 ebo = new cdrAC0020B001();
