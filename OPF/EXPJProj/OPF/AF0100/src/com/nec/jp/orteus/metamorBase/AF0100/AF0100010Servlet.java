/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AF0100/src/com/nec/jp/orteus/metamorBase/AF0100/AF0100010Servlet.java,v $
 *
...
public class AF0100010Servlet extends HttpServlet
{
	 ...
	 * @param control AF0100010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AF0100010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AF0100010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AF0100010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AF0100010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AF0100010Entity entity = control.entity;
		AF0100010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AF0100010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
//			objMessage.m_writer.write( Level.ALL, "AF0100010"+" $Revision: 1.12 $" );
			control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AF0100010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AF0100010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AF0100010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AF0100");
		logger.entering("AF0100010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
		...
		//---------------------------------------------------------------------
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AF0100010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickselect(
					...
					HttpSession so,
					Hashtable params,
					AF0100010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AF0100010Entity entity = control.entity;
		AF0100010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AF0100");
		logger.entering("AF0100010Servlet"+":USER="+request.getRemoteUser(),"onClickselect");
		...
		//---------------------------------------------------------------------
                //}}user_implement_dev:<onClickselect>
		logger.exiting("AF0100010Servlet"+":USER="+request.getRemoteUser(),"onClickselect");
					...
					AF0100010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AF0100");
		logger.entering("AF0100010Servlet"+":USER="+request.getRemoteUser(),"onClickinsert");
		...
		//---------------------------------------------------------------------
                //}}user_implement_dev:<onClickinsert>
		logger.exiting("AF0100010Servlet"+":USER="+request.getRemoteUser(),"onClickinsert");
					...
					AF0100010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AF0100");
		logger.entering("AF0100010Servlet"+":USER="+request.getRemoteUser(),"onClickclear");
		...
		//---------------------------------------------------------------------
                //}}user_implement_dev:<onClickclear>
		logger.exiting("AF0100010Servlet"+":USER="+request.getRemoteUser(),"onClickclear");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AF0100010Struct struct)
	{
	...
	public static String DEFAULT_TARGET = "/AF0100010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAF0100010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAF0100010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AF0100");
		logger.entering("AF0100010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AF0100010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AF0100010Control control;
		AF0100010Entity  entity = null;
		AF0100010Struct  struct = null;
		...
		try {
			...
			if( (control = (AF0100010Control)so.getAttribute("AF0100010Control_"+request.getSession(false).getId())) == null ) {
				control = new AF0100010Control();
			...
			try {
				...
				so.setAttribute("AF0100010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.AF0100.AF0100010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AF0100010Servlet()
	{
		//{{user_implement_dev:<AF0100010_DisConnect_FLG>
		...
		//{{user_implement_dev:<AF0100010Servlet>
                //}}user_implement_dev:<AF0100010Servlet>
	}
