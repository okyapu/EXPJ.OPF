...
public class AA0180030Servlet extends HttpServlet
{
	 ...
	 * @param control AA0180030Controlクラスインスタンス
	 */
...
//			e.printStackTrace();
					...
					AA0180030Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		//{{user_implement_dev:<reloadEvent>
              ...
              //			e.printStackTrace();
              //			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AA0180030-E999","リロード処理"));
                 ExpjException ee = new ExpjException(e, "ZZ01106");
	...
	public static String DEFAULT_TARGET = "/AA0180030.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAA0180030Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAA0180030Struct";   // JSP先のバインド名(Struct)の指定
