/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KU0070/src/com/nec/jp/orteus/metamorBase/KU0070/KU0070010Servlet.java,v $
 *
...
public class KU0070010Servlet extends HttpServlet
{
	 ...
	 * @param control KU0070010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, KU0070010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control KU0070010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, KU0070010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					KU0070010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		KU0070010Entity entity = control.entity;
		KU0070010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("KU0070010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
                 // TODO: ユーザ定義のコードを記述してください
              //			objMessage.m_writer.write( Level.ALL, "KU0070010"+" $Revision: 1.1 $" );
                 control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("KU0070010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					KU0070010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		KU0070010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KU0070");
		logger.entering("KU0070010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
		...
		//{{user_implement_dev:<reloadEvent>
              ...
              //			e.printStackTrace();
              //			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("KU0070010-E999","リロード処理"));
                 ExpjException ee = new ExpjException(e, "ZZ01106");
                 throw ee;
                }
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("KU0070010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickSelect(
					...
					HttpSession so,
					Hashtable params,
					KU0070010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		KU0070010Entity entity = control.entity;
		KU0070010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KU0070");
		logger.entering("KU0070010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
		//{{user_implement_dev:<onClickSelect>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickSelect>
		logger.exiting("KU0070010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
					...
					KU0070010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KU0070");
		logger.entering("KU0070010Servlet"+":USER="+request.getRemoteUser(),"onClickClose");
		//{{user_implement_dev:<onClickClose>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickClose>
		logger.exiting("KU0070010Servlet"+":USER="+request.getRemoteUser(),"onClickClose");
					...
					KU0070010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KU0070");
		logger.entering("KU0070010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
		//{{user_implement_dev:<onClickClear>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("KU0070010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
					...
					KU0070010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KU0070");
		logger.entering("KU0070010Servlet"+":USER="+request.getRemoteUser(),"onClickGoSub");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickGoSub>
		logger.exiting("KU0070010Servlet"+":USER="+request.getRemoteUser(),"onClickGoSub");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, KU0070010Struct struct)
	{
		...
		String[] IN_CHRG_PSN_CD = ((params.containsKey("IN_CHRG_PSN_CD")) ? (String[])params.get("IN_CHRG_PSN_CD") : (String[])null);
		String[] FROM_SCDL_SHIP_DATE = ((params.containsKey("FROM_SCDL_SHIP_DATE")) ? (String[])params.get("FROM_SCDL_SHIP_DATE") : (String[])null);
		String[] TO_SCDL_SHIP_DATE = ((params.containsKey("TO_SCDL_SHIP_DATE")) ? (String[])params.get("TO_SCDL_SHIP_DATE") : (String[])null);
		String[] ACTUAL_UNIT_PRICE = ((params.containsKey("ACTUAL_UNIT_PRICE")) ? (String[])params.get("ACTUAL_UNIT_PRICE") : (String[])null);
		...
		String[] SELECT_MARK = ((params.containsKey("SELECT_MARK")) ? (String[])params.get("SELECT_MARK") : (String[])null);
		...
		struct.setIN_CHRG_PSN_CD( ((IN_CHRG_PSN_CD == null) ? (String)null : IN_CHRG_PSN_CD[0]) );
		struct.setList_IN_CHRG_PSN_CD(TypeConverter.convert(IN_CHRG_PSN_CD));
		struct.setFROM_SCDL_SHIP_DATE( ((FROM_SCDL_SHIP_DATE == null) ? (String)null : FROM_SCDL_SHIP_DATE[0]) );
		struct.setList_FROM_SCDL_SHIP_DATE(TypeConverter.convert(FROM_SCDL_SHIP_DATE));
		struct.setTO_SCDL_SHIP_DATE( ((TO_SCDL_SHIP_DATE == null) ? (String)null : TO_SCDL_SHIP_DATE[0]) );
		struct.setList_TO_SCDL_SHIP_DATE(TypeConverter.convert(TO_SCDL_SHIP_DATE));
		struct.setACTUAL_UNIT_PRICE( ((ACTUAL_UNIT_PRICE == null) ? (String)null : ACTUAL_UNIT_PRICE[0]) );
		struct.setList_ACTUAL_UNIT_PRICE(TypeConverter.convert(ACTUAL_UNIT_PRICE));
		...
		struct.setSELECT_MARK( ((SELECT_MARK == null) ? (String)null : SELECT_MARK[0]) );
		struct.setList_SELECT_MARK(TypeConverter.convert(SELECT_MARK));
	...
	public static String DEFAULT_TARGET = "/KU0070010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aKU0070010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aKU0070010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KU0070");
		logger.entering("KU0070010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("KU0070010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		KU0070010Control control;
		KU0070010Entity  entity = null;
		KU0070010Struct  struct = null;
		...
		try {
			...
			if( (control = (KU0070010Control)so.getAttribute("KU0070010Control_"+request.getSession(false).getId())) == null ) {
				control = new KU0070010Control();
			...
			try {
				...
				so.setAttribute("KU0070010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.KU0070.KU0070010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public KU0070010Servlet()
	{
		//{{user_implement_dev:<KU0070010_DisConnect_FLG>
		...
		//{{user_implement_dev:<KU0070010Servlet>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<KU0070010Servlet>
	}
