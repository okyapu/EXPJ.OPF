/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DD0020/src/com/nec/jp/orteus/metamorBase/DD0020/DD0020010Struct.java,v $
 *
...
/**
 * CLASS     : DD0020010Control クラス
 * ファイル・クラス説明
 * @author $Author: xl-hs-zzw $
 * @version $Revision: 1.9 $ $Date: 2014/11/05 07:24:14 $
 *
 */
//}}user_implement_code_header

public class DD0020010Struct extends DataStruct
{
	...
	/** 第 3 List変数： l_TopItemFlg */
	public List l_TopItemFlg = null;

	/** 第 4 List変数： l_r1_OUTSIDE_TYP */
	public List l_r1_OUTSIDE_TYP = null;

	/** 第 5 List変数： l_r2_OUTSIDE_TYP */
	public List l_r2_OUTSIDE_TYP = null;

	/** 第 6 List変数： l_r3_OUTSIDE_TYP */
	public List l_r3_OUTSIDE_TYP = null;

	/** 第 7 List変数： l_DOWNLOAD_FILE */
	public List l_DOWNLOAD_FILE = null;

	/** 第 8 List変数： l_HALF_TERM_TYP_DN */
	public List l_HALF_TERM_TYP_DN = null;

	/** 第 9 List変数： l_COST_TYP_DN */
	public List l_COST_TYP_DN = null;

	/** 第 10 List変数： l_OUTSIDE_TYP_DN */
	public List l_OUTSIDE_TYP_DN = null;

	/** 第 11 List変数： l_PROC_OUTSIDE_TYP_DN */
	public List l_PROC_OUTSIDE_TYP_DN = null;

	/** 第 12 List変数： l_l_ROOT_ITEM_CD */
	...
	public String getTopItemFlg() { return m_TopItemFlg; }
	public String getr1_OUTSIDE_TYP() { return m_r1_OUTSIDE_TYP; }
	public String getr2_OUTSIDE_TYP() { return m_r2_OUTSIDE_TYP; }
	public String getr3_OUTSIDE_TYP() { return m_r3_OUTSIDE_TYP; }
	...
	public String getl_PARENT_ITEM_NAME() { return m_l_PARENT_ITEM_NAME; }
	...
	public String getPRINT_USER() { return m_PRINT_USER; }
	public String getPRINT_TIME() { return m_PRINT_TIME; }
	public String getPRINT_NUM() { return m_PRINT_NUM; }
	...
	public List getList_TopItemFlg() { return l_TopItemFlg; }
	public List getList_r1_OUTSIDE_TYP() { return l_r1_OUTSIDE_TYP; }
	public List getList_r2_OUTSIDE_TYP() { return l_r2_OUTSIDE_TYP; }
	public List getList_r3_OUTSIDE_TYP() { return l_r3_OUTSIDE_TYP; }
	...
	public List getList_l_PARENT_ITEM_NAME() { return l_l_PARENT_ITEM_NAME; }
	...
	public List getList_PRINT_USER() { return l_PRINT_USER; }
	public List getList_PRINT_TIME() { return l_PRINT_TIME; }
	public List getList_PRINT_NUM() { return l_PRINT_NUM; }
	...
	public void setTopItemFlg(String val) { m_TopItemFlg = val; }
	public void setr1_OUTSIDE_TYP(String val) { m_r1_OUTSIDE_TYP = val; }
	public void setr2_OUTSIDE_TYP(String val) { m_r2_OUTSIDE_TYP = val; }
	public void setr3_OUTSIDE_TYP(String val) { m_r3_OUTSIDE_TYP = val; }
	...
	public void setl_PARENT_ITEM_NAME(String val) { m_l_PARENT_ITEM_NAME = val; }
	...
	public void setPRINT_USER(String val) { m_PRINT_USER = val; }
	public void setPRINT_TIME(String val) { m_PRINT_TIME = val; }
	public void setPRINT_NUM(String val) { m_PRINT_NUM = val; }
	...
	public void setList_TopItemFlg(List list) { l_TopItemFlg = list; }
	public void setList_r1_OUTSIDE_TYP(List list) { l_r1_OUTSIDE_TYP = list; }
	public void setList_r2_OUTSIDE_TYP(List list) { l_r2_OUTSIDE_TYP = list; }
	public void setList_r3_OUTSIDE_TYP(List list) { l_r3_OUTSIDE_TYP = list; }
	...
	public void setList_l_PARENT_ITEM_NAME(List list) { l_l_PARENT_ITEM_NAME = list; }
	...
	public void setList_PRINT_USER(List list) { l_PRINT_USER = list; }
	public void setList_PRINT_TIME(List list) { l_PRINT_TIME = list; }
	public void setList_PRINT_NUM(List list) { l_PRINT_NUM = list; }
	...
	public int setL2L_HALF_TERM_TYP_name(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_HALF_TERM_TYP_name.add(((DD0020010Struct) list.get(i)).getHALF_TERM_TYP_name());
		}
		return size;
	}
	public int setL2L_HALF_TERM_TYP_val(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_HALF_TERM_TYP_val.add(((DD0020010Struct) list.get(i)).getHALF_TERM_TYP_val());
		}
		return size;
	}
	public int setL2L_TopItemFlg(List list) {
		int size = (list != null) ? list.size() : 0;
		if (size == 0) {
			return 0;
		}
		if (l_TopItemFlg == null) {
			l_TopItemFlg = new ArrayList();
		} else {
			l_TopItemFlg.clear();
		}
		for (int i = 0; i < size; i++) {
			l_TopItemFlg.add(((DD0020010Struct) list.get(i)).getTopItemFlg());
		}
		return size;
	}
	public int setL2L_r1_OUTSIDE_TYP(List list) {
		int size = (list != null) ? list.size() : 0;
		if (size == 0) {
			return 0;
		}
		if (l_r1_OUTSIDE_TYP == null) {
			l_r1_OUTSIDE_TYP = new ArrayList();
		} else {
			l_r1_OUTSIDE_TYP.clear();
		}
		for (int i = 0; i < size; i++) {
			l_r1_OUTSIDE_TYP.add(((DD0020010Struct) list.get(i)).getr1_OUTSIDE_TYP());
		}
		return size;
	}
	public int setL2L_r2_OUTSIDE_TYP(List list) {
		int size = (list != null) ? list.size() : 0;
		if (size == 0) {
			return 0;
		}
		if (l_r2_OUTSIDE_TYP == null) {
			l_r2_OUTSIDE_TYP = new ArrayList();
		} else {
			l_r2_OUTSIDE_TYP.clear();
		}
		for (int i = 0; i < size; i++) {
			l_r2_OUTSIDE_TYP.add(((DD0020010Struct) list.get(i)).getr2_OUTSIDE_TYP());
		}
		return size;
	}
	public int setL2L_r3_OUTSIDE_TYP(List list) {
		int size = (list != null) ? list.size() : 0;
		if (size == 0) {
			return 0;
		}
		if (l_r3_OUTSIDE_TYP == null) {
			l_r3_OUTSIDE_TYP = new ArrayList();
		} else {
			l_r3_OUTSIDE_TYP.clear();
		}
		for (int i = 0; i < size; i++) {
			l_r3_OUTSIDE_TYP.add(((DD0020010Struct) list.get(i)).getr3_OUTSIDE_TYP());
		}
		return size;
	}
	public int setL2L_DOWNLOAD_FILE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DOWNLOAD_FILE.add(((DD0020010Struct) list.get(i)).getDOWNLOAD_FILE());
		}
		return size;
	}
	public int setL2L_HALF_TERM_TYP_DN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_HALF_TERM_TYP_DN.add(((DD0020010Struct) list.get(i)).getHALF_TERM_TYP_DN());
		}
		return size;
	}
	public int setL2L_COST_TYP_DN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_COST_TYP_DN.add(((DD0020010Struct) list.get(i)).getCOST_TYP_DN());
		}
		return size;
	}
	public int setL2L_OUTSIDE_TYP_DN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OUTSIDE_TYP_DN.add(((DD0020010Struct) list.get(i)).getOUTSIDE_TYP_DN());
		}
		return size;
	}
	public int setL2L_PROC_OUTSIDE_TYP_DN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROC_OUTSIDE_TYP_DN.add(((DD0020010Struct) list.get(i)).getPROC_OUTSIDE_TYP_DN());
		}
		return size;
	}
	public int setL2L_l_ROOT_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_ROOT_ITEM_CD.add(((DD0020010Struct) list.get(i)).getl_ROOT_ITEM_CD());
		}
		return size;
	}
	public int setL2L_l_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_ITEM_CD.add(((DD0020010Struct) list.get(i)).getl_ITEM_CD());
		}
		return size;
	}
	public int setL2L_l_ITEM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_ITEM_NAME.add(((DD0020010Struct) list.get(i)).getl_ITEM_NAME());
		}
		return size;
	}
	public int setL2L_l_PARENT_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_PARENT_ITEM_CD.add(((DD0020010Struct) list.get(i)).getl_PARENT_ITEM_CD());
		}
		return size;
	}
	public int setL2L_l_PARENT_ITEM_NAME(List list) {
		int size = (list != null) ? list.size() : 0;
		if (size == 0) {
			return 0;
		}
		if (l_l_PARENT_ITEM_NAME == null) {
			l_l_PARENT_ITEM_NAME = new ArrayList();
		} else {
			l_l_PARENT_ITEM_NAME.clear();
		}
		for (int i = 0; i < size; i++) {
			l_l_PARENT_ITEM_NAME.add(((DD0020010Struct) list.get(i)).getl_PARENT_ITEM_NAME());
		}
		return size;
	}
	public int setL2L_l_OUTSIDE_TYP_DN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_OUTSIDE_TYP_DN.add(((DD0020010Struct) list.get(i)).getl_OUTSIDE_TYP_DN());
		}
		return size;
	}
	public int setL2L_l_PROC_OUTSIDE_TYP_DN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_PROC_OUTSIDE_TYP_DN.add(((DD0020010Struct) list.get(i)).getl_PROC_OUTSIDE_TYP_DN());
		}
		return size;
	}
	public int setL2L_l_CS_PROC_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_CS_PROC_CD.add(((DD0020010Struct) list.get(i)).getl_CS_PROC_CD());
		}
		return size;
	}
	public int setL2L_l_CS_PROC_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_CS_PROC_NAME.add(((DD0020010Struct) list.get(i)).getl_CS_PROC_NAME());
		}
		return size;
	}
	public int setL2L_l_NECESSARY_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_NECESSARY_QTY.add(((DD0020010Struct) list.get(i)).getl_NECESSARY_QTY());
		}
		return size;
	}
	public int setL2L_l_STOCK_UNIT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_STOCK_UNIT.add(((DD0020010Struct) list.get(i)).getl_STOCK_UNIT());
		}
		return size;
	}
	public int setL2L_l_HOME_CUR_UNIT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_HOME_CUR_UNIT.add(((DD0020010Struct) list.get(i)).getl_HOME_CUR_UNIT());
		}
		return size;
	}
	public int setL2L_l_OWN_MATR_COST(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_OWN_MATR_COST.add(((DD0020010Struct) list.get(i)).getl_OWN_MATR_COST());
		}
		return size;
	}
	public int setL2L_l_TOTAL_SBCNT_MATR_COST(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_TOTAL_SBCNT_MATR_COST.add(((DD0020010Struct) list.get(i)).getl_TOTAL_SBCNT_MATR_COST());
		}
		return size;
	}
	public int setL2L_l_OWN_SBCNT_MATR_COST(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_OWN_SBCNT_MATR_COST.add(((DD0020010Struct) list.get(i)).getl_OWN_SBCNT_MATR_COST());
		}
		return size;
	}
	public int setL2L_l_TOTAL_MATR_COST(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_TOTAL_MATR_COST.add(((DD0020010Struct) list.get(i)).getl_TOTAL_MATR_COST());
		}
		return size;
	}
	public int setL2L_l_OWN_PROC_COST_SUM_ALL(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_OWN_PROC_COST_SUM_ALL.add(((DD0020010Struct) list.get(i)).getl_OWN_PROC_COST_SUM_ALL());
		}
		return size;
	}
	public int setL2L_l_TOTAL_PROC_COST_SUM_ALL(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_TOTAL_PROC_COST_SUM_ALL.add(((DD0020010Struct) list.get(i)).getl_TOTAL_PROC_COST_SUM_ALL());
		}
		return size;
	}
	public int setL2L_PLANT_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PLANT_CD.add(((DD0020010Struct) list.get(i)).getPLANT_CD());
		}
		return size;
	}
	public int setL2L_YEAR(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_YEAR.add(((DD0020010Struct) list.get(i)).getYEAR());
		}
		return size;
	}
	public int setL2L_HALF_TERM_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_HALF_TERM_TYP.add(((DD0020010Struct) list.get(i)).getHALF_TERM_TYP());
		}
		return size;
	}
	public int setL2L_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_CD.add(((DD0020010Struct) list.get(i)).getITEM_CD());
		}
		return size;
	}
	public int setL2L_UPPER_ITEM_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_UPPER_ITEM_FLG.add(((DD0020010Struct) list.get(i)).getUPPER_ITEM_FLG());
		}
		return size;
	}
	public int setL2L_CS_PROC_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CS_PROC_CD.add(((DD0020010Struct) list.get(i)).getCS_PROC_CD());
		}
		return size;
	}
	public int setL2L_OUTSIDE_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OUTSIDE_TYP.add(((DD0020010Struct) list.get(i)).getOUTSIDE_TYP());
		}
		return size;
	}
	public int setL2L_COST_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_COST_TYP.add(((DD0020010Struct) list.get(i)).getCOST_TYP());
		}
		return size;
	}
	public int setL2L_PLANT_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PLANT_NAME.add(((DD0020010Struct) list.get(i)).getPLANT_NAME());
		}
		return size;
	}
	public int setL2L_ROOT_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ROOT_ITEM_CD.add(((DD0020010Struct) list.get(i)).getROOT_ITEM_CD());
		}
		return size;
	}
	public int setL2L_ROOT_ITEM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ROOT_ITEM_NAME.add(((DD0020010Struct) list.get(i)).getROOT_ITEM_NAME());
		}
		return size;
	}
	public int setL2L_PARENT_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PARENT_ITEM_CD.add(((DD0020010Struct) list.get(i)).getPARENT_ITEM_CD());
		}
		return size;
	}
	public int setL2L_PARENT_ITEM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PARENT_ITEM_NAME.add(((DD0020010Struct) list.get(i)).getPARENT_ITEM_NAME());
		}
		return size;
	}
	public int setL2L_ITEM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_NAME.add(((DD0020010Struct) list.get(i)).getITEM_NAME());
		}
		return size;
	}
	public int setL2L_PS_EDITION(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PS_EDITION.add(((DD0020010Struct) list.get(i)).getPS_EDITION());
		}
		return size;
	}
	public int setL2L_COST_STATEMENT_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_COST_STATEMENT_NO.add(((DD0020010Struct) list.get(i)).getCOST_STATEMENT_NO());
		}
		return size;
	}
	public int setL2L_CS_PROC_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CS_PROC_NAME.add(((DD0020010Struct) list.get(i)).getCS_PROC_NAME());
		}
		return size;
	}
	public int setL2L_WS_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_WS_CD.add(((DD0020010Struct) list.get(i)).getWS_CD());
		}
		return size;
	}
	public int setL2L_WS_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_WS_NAME.add(((DD0020010Struct) list.get(i)).getWS_NAME());
		}
		return size;
	}
	public int setL2L_ORG_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ORG_CD.add(((DD0020010Struct) list.get(i)).getORG_CD());
		}
		return size;
	}
	public int setL2L_ORG_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ORG_NAME.add(((DD0020010Struct) list.get(i)).getORG_NAME());
		}
		return size;
	}
	public int setL2L_NECESSARY_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_NECESSARY_QTY.add(((DD0020010Struct) list.get(i)).getNECESSARY_QTY());
		}
		return size;
	}
	public int setL2L_PS_INPUT_RATIO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PS_INPUT_RATIO.add(((DD0020010Struct) list.get(i)).getPS_INPUT_RATIO());
		}
		return size;
	}
	public int setL2L_ITEM_INPUT_RATIO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_INPUT_RATIO.add(((DD0020010Struct) list.get(i)).getITEM_INPUT_RATIO());
		}
		return size;
	}
	public int setL2L_TOTAL_COST(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TOTAL_COST.add(((DD0020010Struct) list.get(i)).getTOTAL_COST());
		}
		return size;
	}
	public int setL2L_OWN_MATR_COST(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OWN_MATR_COST.add(((DD0020010Struct) list.get(i)).getOWN_MATR_COST());
		}
		return size;
	}
	public int setL2L_TOTAL_MATR_COST(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TOTAL_MATR_COST.add(((DD0020010Struct) list.get(i)).getTOTAL_MATR_COST());
		}
		return size;
	}
	public int setL2L_OWN_SBCNT_MATR_COST(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OWN_SBCNT_MATR_COST.add(((DD0020010Struct) list.get(i)).getOWN_SBCNT_MATR_COST());
		}
		return size;
	}
	public int setL2L_TOTAL_SBCNT_MATR_COST(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TOTAL_SBCNT_MATR_COST.add(((DD0020010Struct) list.get(i)).getTOTAL_SBCNT_MATR_COST());
		}
		return size;
	}
	public int setL2L_OWN_PROC_COST_SUM_ALL(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OWN_PROC_COST_SUM_ALL.add(((DD0020010Struct) list.get(i)).getOWN_PROC_COST_SUM_ALL());
		}
		return size;
	}
	public int setL2L_TOTAL_PROC_COST_SUM_ALL(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TOTAL_PROC_COST_SUM_ALL.add(((DD0020010Struct) list.get(i)).getTOTAL_PROC_COST_SUM_ALL());
		}
		return size;
	}
	public int setL2L_HOME_CUR_UNIT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_HOME_CUR_UNIT.add(((DD0020010Struct) list.get(i)).getHOME_CUR_UNIT());
		}
		return size;
	}
	public int setL2L_EFF_PHASE_IN_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_EFF_PHASE_IN_DATE.add(((DD0020010Struct) list.get(i)).getEFF_PHASE_IN_DATE());
		}
		return size;
	}
	public int setL2L_EFF_PHASE_OUT_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_EFF_PHASE_OUT_DATE.add(((DD0020010Struct) list.get(i)).getEFF_PHASE_OUT_DATE());
		}
		return size;
	}
	public int setL2L_PARENT_COST_STATEMENT_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PARENT_COST_STATEMENT_NO.add(((DD0020010Struct) list.get(i)).getPARENT_COST_STATEMENT_NO());
		}
		return size;
	}
	public int setL2L_PARENT_ITEM_STOCK_UNIT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PARENT_ITEM_STOCK_UNIT.add(((DD0020010Struct) list.get(i)).getPARENT_ITEM_STOCK_UNIT());
		}
		return size;
	}
	public int setL2L_STOCK_UNIT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_STOCK_UNIT.add(((DD0020010Struct) list.get(i)).getSTOCK_UNIT());
		}
		return size;
	}
	public int setL2L_CLASIFICATION_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CLASIFICATION_CD.add(((DD0020010Struct) list.get(i)).getCLASIFICATION_CD());
		}
		return size;
	}
	public int setL2L_PROC_OUTSIDE_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROC_OUTSIDE_TYP.add(((DD0020010Struct) list.get(i)).getPROC_OUTSIDE_TYP());
		}
		return size;
	}
	public int setL2L_PROC_COST_CLS_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROC_COST_CLS_CD.add(((DD0020010Struct) list.get(i)).getPROC_COST_CLS_CD());
		}
		return size;
	}
	public int setL2L_PROC_COST_CLS_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROC_COST_CLS_NAME.add(((DD0020010Struct) list.get(i)).getPROC_COST_CLS_NAME());
		}
		return size;
	}
	public int setL2L_PROC_COST_UNIT_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROC_COST_UNIT_QTY.add(((DD0020010Struct) list.get(i)).getPROC_COST_UNIT_QTY());
		}
		return size;
	}
	public int setL2L_PROC_COST_UNIT_QTY_UNIT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROC_COST_UNIT_QTY_UNIT.add(((DD0020010Struct) list.get(i)).getPROC_COST_UNIT_QTY_UNIT());
		}
		return size;
	}
	public int setL2L_OWN_PROC_COST_01(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OWN_PROC_COST_01.add(((DD0020010Struct) list.get(i)).getOWN_PROC_COST_01());
		}
		return size;
	}
	public int setL2L_OWN_PROC_COST_02(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OWN_PROC_COST_02.add(((DD0020010Struct) list.get(i)).getOWN_PROC_COST_02());
		}
		return size;
	}
	public int setL2L_OWN_PROC_COST_03(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OWN_PROC_COST_03.add(((DD0020010Struct) list.get(i)).getOWN_PROC_COST_03());
		}
		return size;
	}
	public int setL2L_OWN_PROC_COST_04(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OWN_PROC_COST_04.add(((DD0020010Struct) list.get(i)).getOWN_PROC_COST_04());
		}
		return size;
	}
	public int setL2L_OWN_PROC_COST_05(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OWN_PROC_COST_05.add(((DD0020010Struct) list.get(i)).getOWN_PROC_COST_05());
		}
		return size;
	}
	public int setL2L_OWN_PROC_COST_06(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OWN_PROC_COST_06.add(((DD0020010Struct) list.get(i)).getOWN_PROC_COST_06());
		}
		return size;
	}
	public int setL2L_OWN_PROC_COST_07(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OWN_PROC_COST_07.add(((DD0020010Struct) list.get(i)).getOWN_PROC_COST_07());
		}
		return size;
	}
	public int setL2L_OWN_PROC_COST_08(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OWN_PROC_COST_08.add(((DD0020010Struct) list.get(i)).getOWN_PROC_COST_08());
		}
		return size;
	}
	public int setL2L_OWN_PROC_COST_09(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OWN_PROC_COST_09.add(((DD0020010Struct) list.get(i)).getOWN_PROC_COST_09());
		}
		return size;
	}
	public int setL2L_OWN_PROC_COST_10(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OWN_PROC_COST_10.add(((DD0020010Struct) list.get(i)).getOWN_PROC_COST_10());
		}
		return size;
	}
	public int setL2L_OWN_PROC_COST_11(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OWN_PROC_COST_11.add(((DD0020010Struct) list.get(i)).getOWN_PROC_COST_11());
		}
		return size;
	}
	public int setL2L_OWN_PROC_COST_12(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OWN_PROC_COST_12.add(((DD0020010Struct) list.get(i)).getOWN_PROC_COST_12());
		}
		return size;
	}
	public int setL2L_OWN_PROC_COST_SUM(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OWN_PROC_COST_SUM.add(((DD0020010Struct) list.get(i)).getOWN_PROC_COST_SUM());
		}
		return size;
	}
	public int setL2L_TOTAL_PROC_COST_01(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TOTAL_PROC_COST_01.add(((DD0020010Struct) list.get(i)).getTOTAL_PROC_COST_01());
		}
		return size;
	}
	public int setL2L_TOTAL_PROC_COST_02(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TOTAL_PROC_COST_02.add(((DD0020010Struct) list.get(i)).getTOTAL_PROC_COST_02());
		}
		return size;
	}
	public int setL2L_TOTAL_PROC_COST_03(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TOTAL_PROC_COST_03.add(((DD0020010Struct) list.get(i)).getTOTAL_PROC_COST_03());
		}
		return size;
	}
	public int setL2L_TOTAL_PROC_COST_04(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TOTAL_PROC_COST_04.add(((DD0020010Struct) list.get(i)).getTOTAL_PROC_COST_04());
		}
		return size;
	}
	public int setL2L_TOTAL_PROC_COST_05(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TOTAL_PROC_COST_05.add(((DD0020010Struct) list.get(i)).getTOTAL_PROC_COST_05());
		}
		return size;
	}
	public int setL2L_TOTAL_PROC_COST_06(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TOTAL_PROC_COST_06.add(((DD0020010Struct) list.get(i)).getTOTAL_PROC_COST_06());
		}
		return size;
	}
	public int setL2L_TOTAL_PROC_COST_07(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TOTAL_PROC_COST_07.add(((DD0020010Struct) list.get(i)).getTOTAL_PROC_COST_07());
		}
		return size;
	}
	public int setL2L_TOTAL_PROC_COST_08(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TOTAL_PROC_COST_08.add(((DD0020010Struct) list.get(i)).getTOTAL_PROC_COST_08());
		}
		return size;
	}
	public int setL2L_TOTAL_PROC_COST_09(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TOTAL_PROC_COST_09.add(((DD0020010Struct) list.get(i)).getTOTAL_PROC_COST_09());
		}
		return size;
	}
	public int setL2L_TOTAL_PROC_COST_10(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TOTAL_PROC_COST_10.add(((DD0020010Struct) list.get(i)).getTOTAL_PROC_COST_10());
		}
		return size;
	}
	public int setL2L_TOTAL_PROC_COST_11(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TOTAL_PROC_COST_11.add(((DD0020010Struct) list.get(i)).getTOTAL_PROC_COST_11());
		}
		return size;
	}
	public int setL2L_TOTAL_PROC_COST_12(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TOTAL_PROC_COST_12.add(((DD0020010Struct) list.get(i)).getTOTAL_PROC_COST_12());
		}
		return size;
	}
	public int setL2L_TOTAL_PROC_COST_SUM(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TOTAL_PROC_COST_SUM.add(((DD0020010Struct) list.get(i)).getTOTAL_PROC_COST_SUM());
		}
		return size;
	}
	public int setL2L_PROC_COST_01_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROC_COST_01_NAME.add(((DD0020010Struct) list.get(i)).getPROC_COST_01_NAME());
		}
		return size;
	}
	public int setL2L_PROC_COST_02_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROC_COST_02_NAME.add(((DD0020010Struct) list.get(i)).getPROC_COST_02_NAME());
		}
		return size;
	}
	public int setL2L_PROC_COST_03_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROC_COST_03_NAME.add(((DD0020010Struct) list.get(i)).getPROC_COST_03_NAME());
		}
		return size;
	}
	public int setL2L_PROC_COST_04_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROC_COST_04_NAME.add(((DD0020010Struct) list.get(i)).getPROC_COST_04_NAME());
		}
		return size;
	}
	public int setL2L_PROC_COST_05_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROC_COST_05_NAME.add(((DD0020010Struct) list.get(i)).getPROC_COST_05_NAME());
		}
		return size;
	}
	public int setL2L_PROC_COST_06_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROC_COST_06_NAME.add(((DD0020010Struct) list.get(i)).getPROC_COST_06_NAME());
		}
		return size;
	}
	public int setL2L_PROC_COST_07_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROC_COST_07_NAME.add(((DD0020010Struct) list.get(i)).getPROC_COST_07_NAME());
		}
		return size;
	}
	public int setL2L_PROC_COST_08_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROC_COST_08_NAME.add(((DD0020010Struct) list.get(i)).getPROC_COST_08_NAME());
		}
		return size;
	}
	public int setL2L_PROC_COST_09_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROC_COST_09_NAME.add(((DD0020010Struct) list.get(i)).getPROC_COST_09_NAME());
		}
		return size;
	}
	public int setL2L_PROC_COST_10_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROC_COST_10_NAME.add(((DD0020010Struct) list.get(i)).getPROC_COST_10_NAME());
		}
		return size;
	}
	public int setL2L_PROC_COST_11_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROC_COST_11_NAME.add(((DD0020010Struct) list.get(i)).getPROC_COST_11_NAME());
		}
		return size;
	}
	public int setL2L_PROC_COST_12_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROC_COST_12_NAME.add(((DD0020010Struct) list.get(i)).getPROC_COST_12_NAME());
		}
		return size;
	}
	public int setL2L_CURRENT_YEAR(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CURRENT_YEAR.add(((DD0020010Struct) list.get(i)).getCURRENT_YEAR());
		}
		return size;
	}
	public int setL2L_PRINT_USER(List list) {
		int size = (list != null) ? list.size() : 0;
		if (size == 0) {
			return 0;
		}
		if (l_PRINT_USER == null) {
			l_PRINT_USER = new ArrayList();
		} else {
			l_PRINT_USER.clear();
		}
		for (int i = 0; i < size; i++) {
			l_PRINT_USER.add(((DD0020010Struct) list.get(i)).getPRINT_USER());
		}
		return size;
	}
	public int setL2L_PRINT_TIME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PRINT_TIME.add(((DD0020010Struct) list.get(i)).getPRINT_TIME());
		}
		return size;
	}
	public int setL2L_PRINT_NUM(List list) {
		int size = (list != null) ? list.size() : 0;
		if (size == 0) {
			return 0;
		}
		if (l_PRINT_NUM == null) {
			l_PRINT_NUM = new ArrayList();
		} else {
			l_PRINT_NUM.clear();
		}
		for (int i = 0; i < size; i++) {
			l_PRINT_NUM.add(((DD0020010Struct) list.get(i)).getPRINT_NUM());
		}
		return size;
	}
	public int setL2L_l_COUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_COUNT.add(((DD0020010Struct) list.get(i)).getl_COUNT());
		}
		return size;
	}
	public int setL2L_ROW_COUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ROW_COUNT.add(((DD0020010Struct) list.get(i)).getROW_COUNT());
		}
		return size;
	}
	...
	public void clear()
	{
		...
		m_TopItemFlg = null;
		m_r1_OUTSIDE_TYP = null;
		m_r2_OUTSIDE_TYP = null;
		m_r3_OUTSIDE_TYP = null;
		...
		l_TopItemFlg = null;
		l_r1_OUTSIDE_TYP = null;
		l_r2_OUTSIDE_TYP = null;
		l_r3_OUTSIDE_TYP = null;
	...
	/**
	 * medDD0020010クラスの標準コンストラクタ
	 */
	public DD0020010Struct()
	{
	 ...
	 */
	public void setStruct(DD0020010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructM(DD0020010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
			...
			this.setTopItemFlg(struct.getTopItemFlg());
			this.setr1_OUTSIDE_TYP(struct.getr1_OUTSIDE_TYP());
			this.setr2_OUTSIDE_TYP(struct.getr2_OUTSIDE_TYP());
			this.setr3_OUTSIDE_TYP(struct.getr3_OUTSIDE_TYP());
			...
			this.setl_PARENT_ITEM_NAME(struct.getl_PARENT_ITEM_NAME());
			...
			this.setPRINT_USER(struct.getPRINT_USER());
			this.setPRINT_TIME(struct.getPRINT_TIME());
			this.setPRINT_NUM(struct.getPRINT_NUM());
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructL(DD0020010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
			...
			this.setList_TopItemFlg(struct.getList_TopItemFlg());
			this.setList_r1_OUTSIDE_TYP(struct.getList_r1_OUTSIDE_TYP());
			this.setList_r2_OUTSIDE_TYP(struct.getList_r2_OUTSIDE_TYP());
			this.setList_r3_OUTSIDE_TYP(struct.getList_r3_OUTSIDE_TYP());
			...
			this.setList_l_PARENT_ITEM_NAME(struct.getList_l_PARENT_ITEM_NAME());
			...
			this.setList_PRINT_USER(struct.getList_PRINT_USER());
			this.setList_PRINT_TIME(struct.getList_PRINT_TIME());
			this.setList_PRINT_NUM(struct.getList_PRINT_NUM());
...
/*
	...
	// 第 3 変数初期値： i_TopItemFlg


	final static String i_TopItemFlg = null;

	// 第 4 変数初期値： i_r1_OUTSIDE_TYP


	final static String i_r1_OUTSIDE_TYP = null;

	// 第 5 変数初期値： i_r2_OUTSIDE_TYP


	final static String i_r2_OUTSIDE_TYP = null;

	// 第 6 変数初期値： i_r3_OUTSIDE_TYP


	final static String i_r3_OUTSIDE_TYP = null;
...
*/
	...
	public void initialize()
	{
		...
		m_TopItemFlg = i_TopItemFlg;
		m_r1_OUTSIDE_TYP = i_r1_OUTSIDE_TYP;
		m_r2_OUTSIDE_TYP = i_r2_OUTSIDE_TYP;
		m_r3_OUTSIDE_TYP = i_r3_OUTSIDE_TYP;
		...
		m_l_PARENT_ITEM_NAME = i_l_PARENT_ITEM_NAME;
		...
		m_PRINT_USER = i_PRINT_USER;
		m_PRINT_TIME = i_PRINT_TIME;
		m_PRINT_NUM = i_PRINT_NUM;
	}
