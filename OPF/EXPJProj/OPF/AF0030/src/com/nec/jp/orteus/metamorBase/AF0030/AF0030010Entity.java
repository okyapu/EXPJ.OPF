/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AF0030/src/com/nec/jp/orteus/metamorBase/AF0030/AF0030010Entity.java,v $
 *
...
public class AF0030010Entity extends DataObject
{
	...
	// selectM_WH_PRIORITY_ITEMクラス インスタンス
	public selectM_WH_PRIORITY_ITEM mselectM_WH_PRIORITY_ITEM = new selectM_WH_PRIORITY_ITEM();

	// selectM_WH_PRIORITY_JOBクラス インスタンス
	public selectM_WH_PRIORITY_JOB mselectM_WH_PRIORITY_JOB = new selectM_WH_PRIORITY_JOB();

	// select_ITEM_STOCKクラス インスタンス
	public select_ITEM_STOCK mselect_ITEM_STOCK = new select_ITEM_STOCK();

	// select_JOB_ODR_STOCKクラス インスタンス
	public select_JOB_ODR_STOCK mselect_JOB_ODR_STOCK = new select_JOB_ODR_STOCK();

	// selectM_WH_vendクラス インスタンス
	public selectM_WH_vend mselectM_WH_vend = new selectM_WH_vend();

	// select_PLANT_STOCK_ITEMクラス インスタンス
	public select_PLANT_STOCK_ITEM mselect_PLANT_STOCK_ITEM = new select_PLANT_STOCK_ITEM();

	// select_PLANT_STOCK_JOBクラス インスタンス
	...
	// check_T_LOT_CTRLクラス インスタンス
	public check_T_LOT_CTRL mcheck_T_LOT_CTRL = new check_T_LOT_CTRL();

	// select_T_LOT_STOCKクラス インスタンス
	public select_T_LOT_STOCK mselect_T_LOT_STOCK = new select_T_LOT_STOCK();

	// Select_T_LOT_ISSUE_INSTクラス インスタンス
	public Select_T_LOT_ISSUE_INST mSelect_T_LOT_ISSUE_INST = new Select_T_LOT_ISSUE_INST();
	...
	// selectTOTAL_LOT_STOCKクラス インスタンス
	public selectTOTAL_LOT_STOCK mselectTOTAL_LOT_STOCK = new selectTOTAL_LOT_STOCK();

	// Select_Itemクラス インスタンス
	public Select_Item mSelect_Item = new Select_Item();

	// unAlcStockQtyクラス インスタンス
	public unAlcStockQty munAlcStockQty = new unAlcStockQty();

	// LOT_Stock_ALCD_QTYクラス インスタンス
	public LOT_Stock_ALCD_QTY mLOT_Stock_ALCD_QTY = new LOT_Stock_ALCD_QTY();

	// selectCntクラス インスタンス
	public selectCnt mselectCnt = new selectCnt();

	// select_T_LOT_STOCKCntクラス インスタンス
	public select_T_LOT_STOCKCnt mselect_T_LOT_STOCKCnt = new select_T_LOT_STOCKCnt();

	// Select_T_LOT_ISSUE_INSTCntクラス インスタンス
	public Select_T_LOT_ISSUE_INSTCnt mSelect_T_LOT_ISSUE_INSTCnt = new Select_T_LOT_ISSUE_INSTCnt();

	// selectT_WORK_IN_PROC_MINクラス インスタンス
	public selectT_WORK_IN_PROC_MIN mselectT_WORK_IN_PROC_MIN = new selectT_WORK_IN_PROC_MIN();
...
+"";		//////////////////////////////
	...
	public class ei_CSVOut extends DataObject
	{
		...
		String m_write_fname="AF0030010.csv";

		protected WriteCsv m_writer=null;		// csv書込み用

		String m_ProjName="AF0030010";
...
+"  T_OPR_INST_SLIP.\"OPR_INST_CD\" = ?";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AF0030010Struct data, String replaceStr)
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AF0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AF0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AF0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(PreparedStatement stmt, AF0030010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public PreparedStatement prepare(Connection conn, String query, AF0030010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt;
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public ResultSet executeQuery(PreparedStatement stmt, AF0030010Struct data) throws FoundationException, SQLException
		{
			int no=1;
		 ...
		 * レコードデータをStructに格納して返します
		 */
		public AF0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			if(rs.next()==false) return null;

			AF0030010Struct data = new AF0030010Struct();
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(IDbConnection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(IDbConnection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(PreparedStatement stmt, AF0030010Struct data) throws FoundationException, SQLException
		{
			ResultSet rs=executeQuery(stmt, data);
			boolean ret=true;
...
+"  T_ISSUE_INST.\"ISSUE_INST_CD\"";
		...
		public AF0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setISSUE_INST_UNIT_NUMERATOR( getString(6, rs) );
			data.setISSUE_INST_UNIT_DENOMINATOR( getString(7, rs) );
			data.setSCDL_ISSUE_DATE( getString(8, rs) );
			data.setISSUE_CMPLT_DATE( getString(9, rs) );
			data.setISSUE_CMPLT_FLG( getString(10, rs) );
			data.setWH_CD( getString(11, rs) );
			data.setWS_CD( getString(12, rs) );
			data.setWORK_ODR_CD( getString(13, rs) );
			data.setWORK_IN_PROC_CD( getString(14, rs) );
			data.setPUCH_ODR_CD( getString(15, rs) );
			data.setVEND_CD( getString(16, rs) );
			data.setCOMPANY_CD( getString(17, rs) );
			data.setCONS_TYP( getString(18, rs) );
			data.setOD_NO( getString(19, rs) );
			data.setPLANT_CD( getString(20, rs) );
			data.setMODIFY_COUNT( getString(21, rs) );
			data.setJOB_ODR_CD( getString(22, rs) );
			data.setJOB_ODR_DETAIL_NO( getInteger(23, rs) );
			data.setITEM_NAME( getString(24, rs) );
			data.setDRAW_CD( getString(25, rs) );
			data.setSPEC( getString(26, rs) );
			data.setSTOCK_UNIT( getString(27, rs) );
			data.setUNIT_QTY_TYP( getString(28, rs) );
			data.setMRP_ODR_TYP( getString(29, rs) );
			data.setWH_NAME( getString(30, rs) );
			data.setWS_NAME( getString(31, rs) );
			data.setVEND_ANAME( getString(32, rs) );
...
+"  (?, TO_NUMBER(?), ?, ?, ?, ?, ?, ?, ?, ?, TO_NUMBER(?), TO_DATE(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), ?, ?, ?, ?, TO_NUMBER(?), ?)";
		...
		protected String m_sCreateProgramName="AF0030010";
		protected String m_sUpdateProgramName="AF0030010";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int create(IDbConnection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int create(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt=null;
...
+"  M_CONS_UNIT_COST.\"EFF_PHASE_IN_DATE\" desc";
	 ...
	 * Entity定義 静的SQL
	 */
	public class selectM_WH_PRIORITY_ITEM extends DataObject
	{
		protected String m_selcmd = "select "
...
+"";
		...
		//{{user_implement_dev:selectM_WH_PRIORITY_ITEM_def
                //}}user_implement_dev:selectM_WH_PRIORITY_ITEM_def
		...
		public List read(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectM_WH_PRIORITY_ITEM_read
			if(m_selcmd==null) throw new FoundationException("selectM_WH_PRIORITY_ITEM", "read", "クエリー未登録");
		...
		public List read(Connection conn, AF0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectM_WH_PRIORITY_ITEM_read2
			if(m_selcmd==null) throw new FoundationException("selectM_WH_PRIORITY_ITEM", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AF0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectM_WH_PRIORITY_ITEM_read3
			if(m_selcmd==null) throw new FoundationException("selectM_WH_PRIORITY_ITEM", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean hasRecord(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("selectM_WH_PRIORITY_ITEM", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectM_WH_PRIORITY_ITEM_check
			PreparedStatement stmt;
			...
			if(m_chkcmd!=null) {
				...
				throw new FoundationException("selectM_WH_PRIORITY_ITEM", "check", "クエリー未登録");
			}
		...
		public void clear()
		{
			//{{user_implement_dev:selectM_WH_PRIORITY_ITEM_clear
                        //}}user_implement_dev:selectM_WH_PRIORITY_ITEM_clear
		...
		/**
		 * selectM_WH_PRIORITY_ITEMクラスの標準コンストラクタ
		 */
		public selectM_WH_PRIORITY_ITEM()
		{
			//{{user_implement_dev:selectM_WH_PRIORITY_ITEM_constractor
                        //}}user_implement_dev:selectM_WH_PRIORITY_ITEM_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class selectM_WH_PRIORITY_JOB extends DataObject
	{
		protected String m_selcmd = "select "
+"  M_WH_PRIORITY.\"WH_CD\" as \"WH_CD\", "
...
+"";
		...
		//{{user_implement_dev:selectM_WH_PRIORITY_JOB_def
                //}}user_implement_dev:selectM_WH_PRIORITY_JOB_def
		...
		public List read(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectM_WH_PRIORITY_JOB_read
			if(m_selcmd==null) throw new FoundationException("selectM_WH_PRIORITY_JOB", "read", "クエリー未登録");
		...
		public List read(Connection conn, AF0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectM_WH_PRIORITY_JOB_read2
			if(m_selcmd==null) throw new FoundationException("selectM_WH_PRIORITY_JOB", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AF0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectM_WH_PRIORITY_JOB_read3
			if(m_selcmd==null) throw new FoundationException("selectM_WH_PRIORITY_JOB", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean hasRecord(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("selectM_WH_PRIORITY_JOB", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectM_WH_PRIORITY_JOB_check
			PreparedStatement stmt;
			...
			if(m_chkcmd!=null) {
				...
				throw new FoundationException("selectM_WH_PRIORITY_JOB", "check", "クエリー未登録");
			}
		...
		public void clear()
		{
			//{{user_implement_dev:selectM_WH_PRIORITY_JOB_clear
                        //}}user_implement_dev:selectM_WH_PRIORITY_JOB_clear
		...
		/**
		 * selectM_WH_PRIORITY_JOBクラスの標準コンストラクタ
		 */
		public selectM_WH_PRIORITY_JOB()
		{
			//{{user_implement_dev:selectM_WH_PRIORITY_JOB_constractor
                        //}}user_implement_dev:selectM_WH_PRIORITY_JOB_constractor
...
+"";
		...
		public List read(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			...
			if(m_selcmd==null) throw new FoundationException("select_ITEM_STOCK", "read", "クエリー未登録");
		...
		public boolean hasRecord(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("select_ITEM_STOCK", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			...
			if(m_chkcmd!=null) {
				...
				throw new FoundationException("select_ITEM_STOCK", "check", "クエリー未登録");
			}
		...
		/**
		 * select_ITEM_STOCKクラスの標準コンストラクタ
		 */
	 ...
	 * Entity定義 静的SQL
	 */
	public class select_JOB_ODR_STOCK extends DataObject
	{
		protected String m_selcmd = "select "
...
+"";
		...
		//{{user_implement_dev:select_JOB_ODR_STOCK_def
                //}}user_implement_dev:select_JOB_ODR_STOCK_def
		...
		public List read(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_JOB_ODR_STOCK_read
			if(m_selcmd==null) throw new FoundationException("select_JOB_ODR_STOCK", "read", "クエリー未登録");
		...
		public List read(Connection conn, AF0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_JOB_ODR_STOCK_read2
			if(m_selcmd==null) throw new FoundationException("select_JOB_ODR_STOCK", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AF0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_JOB_ODR_STOCK_read3
			if(m_selcmd==null) throw new FoundationException("select_JOB_ODR_STOCK", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean hasRecord(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("select_JOB_ODR_STOCK", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_JOB_ODR_STOCK_check
			PreparedStatement stmt;
			...
			if(m_chkcmd!=null) {
				...
				throw new FoundationException("select_JOB_ODR_STOCK", "check", "クエリー未登録");
			}
		...
		public void clear()
		{
			//{{user_implement_dev:select_JOB_ODR_STOCK_clear
                        //}}user_implement_dev:select_JOB_ODR_STOCK_clear
		...
		/**
		 * select_JOB_ODR_STOCKクラスの標準コンストラクタ
		 */
		public select_JOB_ODR_STOCK()
		{
			//{{user_implement_dev:select_JOB_ODR_STOCK_constractor
                        //}}user_implement_dev:select_JOB_ODR_STOCK_constractor
...
+"  and M_WH.\"MRP_FLG\" = 1";
		...
		public List read(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			...
			if(m_selcmd==null) throw new FoundationException("select_PLANT_STOCK_ITEM", "read", "クエリー未登録");
		...
		public boolean hasRecord(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("select_PLANT_STOCK_ITEM", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			...
			if(m_chkcmd!=null) {
				...
				throw new FoundationException("select_PLANT_STOCK_ITEM", "check", "クエリー未登録");
			}
		...
		/**
		 * select_PLANT_STOCK_ITEMクラスの標準コンストラクタ
		 */
...
+"  and M_WH.\"MRP_FLG\" = 1";
		...
		public List read(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			...
			if(m_selcmd==null) throw new FoundationException("select_PLANT_STOCK_JOB", "read", "クエリー未登録");
		...
		public boolean hasRecord(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("select_PLANT_STOCK_JOB", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			...
			if(m_chkcmd!=null) {
				...
				throw new FoundationException("select_PLANT_STOCK_JOB", "check", "クエリー未登録");
			}
		...
		/**
		 * select_PLANT_STOCK_JOBクラスの標準コンストラクタ
		 */
...
+"  NAME = ?";
		...
		public PreparedStatement prepare(Connection conn, String query, AF0030010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				ary.addElement(data.getw_INPUT_PARAM());
				if(isNull(data.getw_INPUT_PARAM())) isNull = true;
		...
		public ResultSet executeQuery(PreparedStatement stmt, AF0030010Struct data) throws FoundationException, SQLException
		{
			...
			// 静的SQL文の生成
			setString(no ++, data.getw_INPUT_PARAM(), stmt);
...
+"  PLANT_CD = ?";
	 ...
	 * Entity定義 静的SQL
	 */
	public class check_T_LOT_CTRL extends DataObject
	{
		protected String m_selcmd = "select "
+"  T_LOT_CTRL.LOT_NO "
+"from "
...
+"  and T_ISSUE_INST.ITEM_CD = T_LOT_CTRL.ITEM_CD";
		...
		//{{user_implement_dev:check_T_LOT_CTRL_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:check_T_LOT_CTRL_def
		...
		public List read(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:check_T_LOT_CTRL_read
			if(m_selcmd==null) throw new FoundationException("check_T_LOT_CTRL", "read", "クエリー未登録");
		...
		public List read(Connection conn, AF0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:check_T_LOT_CTRL_read2
			if(m_selcmd==null) throw new FoundationException("check_T_LOT_CTRL", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AF0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:check_T_LOT_CTRL_read3
			if(m_selcmd==null) throw new FoundationException("check_T_LOT_CTRL", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public PreparedStatement prepare(Connection conn, String query, AF0030010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				...
				throw new FoundationException("check_T_LOT_CTRL", "prepare", "Parse失敗:"+e.toString());
			} finally {
				ary.removeAllElements();
				ary = null;
			}
		...
		public AF0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setSTOCK_LOT_CD( getString(1, rs) );
		...
		public boolean hasRecord(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("check_T_LOT_CTRL", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:check_T_LOT_CTRL_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);;
		...
		public void clear()
		{
			//{{user_implement_dev:check_T_LOT_CTRL_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:check_T_LOT_CTRL_clear
		...
		/**
		 * check_T_LOT_CTRLクラスの標準コンストラクタ
		 */
		public check_T_LOT_CTRL()
		{
			//{{user_implement_dev:check_T_LOT_CTRL_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:check_T_LOT_CTRL_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class select_T_LOT_STOCK extends DataObject
	{
		protected String m_selcmd = "select "
+"  T_LOT_STOCK.WH_CD, "
+"  T_LOT_STOCK.LOT_NO, "
...
+"  T_LOT_STOCK.LOT_NO";
		...
		//{{user_implement_dev:select_T_LOT_STOCK_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:select_T_LOT_STOCK_def
		...
		public List read(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_T_LOT_STOCK_read
			if(m_selcmd==null) throw new FoundationException("select_T_LOT_STOCK", "read", "クエリー未登録");
		...
		public List read(Connection conn, AF0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_T_LOT_STOCK_read2
			if(m_selcmd==null) throw new FoundationException("select_T_LOT_STOCK", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AF0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_T_LOT_STOCK_read3
			if(m_selcmd==null) throw new FoundationException("select_T_LOT_STOCK", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public PreparedStatement prepare(Connection conn, String query, AF0030010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				...
				throw new FoundationException("select_T_LOT_STOCK", "prepare", "Parse失敗:"+e.toString());
			} finally {
				ary.removeAllElements();
				ary = null;
			}
		...
		public AF0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setl_WH_CD_2( getString(1, rs) );
			...
			data.setWH_TYP( getString(11, rs) );
		...
		public boolean hasRecord(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("select_T_LOT_STOCK", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_T_LOT_STOCK_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);;
		...
		public void clear()
		{
			//{{user_implement_dev:select_T_LOT_STOCK_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:select_T_LOT_STOCK_clear
		...
		/**
		 * select_T_LOT_STOCKクラスの標準コンストラクタ
		 */
		public select_T_LOT_STOCK()
		{
			//{{user_implement_dev:select_T_LOT_STOCK_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:select_T_LOT_STOCK_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class Select_T_LOT_ISSUE_INST extends DataObject
	{
		protected String m_selcmd = "select "
...
+"  T_LOT_ISSUE_INST.LOT_NO";
		...
		//{{user_implement_dev:Select_T_LOT_ISSUE_INST_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:Select_T_LOT_ISSUE_INST_def
		...
		public List read(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:Select_T_LOT_ISSUE_INST_read
			if(m_selcmd==null) throw new FoundationException("Select_T_LOT_ISSUE_INST", "read", "クエリー未登録");
		...
		public List read(Connection conn, AF0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:Select_T_LOT_ISSUE_INST_read2
			if(m_selcmd==null) throw new FoundationException("Select_T_LOT_ISSUE_INST", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AF0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:Select_T_LOT_ISSUE_INST_read3
			if(m_selcmd==null) throw new FoundationException("Select_T_LOT_ISSUE_INST", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public PreparedStatement prepare(Connection conn, String query, AF0030010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				...
				throw new FoundationException("Select_T_LOT_ISSUE_INST", "prepare", "Parse失敗:"+e.toString());
			} finally {
				ary.removeAllElements();
				ary = null;
			}
		...
		public AF0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setl_SPENT_QTY( getString(3, rs) );
		...
		public boolean hasRecord(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("Select_T_LOT_ISSUE_INST", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:Select_T_LOT_ISSUE_INST_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);;
		...
		public void clear()
		{
			//{{user_implement_dev:Select_T_LOT_ISSUE_INST_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:Select_T_LOT_ISSUE_INST_clear
		...
		/**
		 * Select_T_LOT_ISSUE_INSTクラスの標準コンストラクタ
		 */
		public Select_T_LOT_ISSUE_INST()
		{
			//{{user_implement_dev:Select_T_LOT_ISSUE_INST_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:Select_T_LOT_ISSUE_INST_constractor
...
+"  and T_LOT_ISSUE_INST.LOT_NO = ?";
		...
		public int create(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				...
				setString(12, data.geth_RCV_ISSUE_QTY(), stmt);
				setString(13, data.getRCV_ISSUE_DATE(), stmt);
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int update(IDbConnection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int update(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt=null;
			int modifyCount;
	 ...
	 * Entity定義 静的SQL
	 */
	public class selectTOTAL_LOT_STOCK extends DataObject
	{
		protected String m_selcmd = "select "
+"  TO_CHAR(NVL(SUM(T_LOT_STOCK.\"STOCK_ON_HAND_QTY\"), 0), 'TM9') as \"TOTAL_STOCK_ON_HAND_QTY\" "
+"from "
+"  T_LOT_STOCK, "
+"  M_WH "
+"where "
...
+"  and M_WH.\"MRP_FLG\" = 1";
		...
		//{{user_implement_dev:selectTOTAL_LOT_STOCK_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:selectTOTAL_LOT_STOCK_def
		...
		public List read(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectTOTAL_LOT_STOCK_read
			if(m_selcmd==null) throw new FoundationException("selectTOTAL_LOT_STOCK", "read", "クエリー未登録");
		...
		public List read(Connection conn, AF0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectTOTAL_LOT_STOCK_read2
			if(m_selcmd==null) throw new FoundationException("selectTOTAL_LOT_STOCK", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AF0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectTOTAL_LOT_STOCK_read3
			if(m_selcmd==null) throw new FoundationException("selectTOTAL_LOT_STOCK", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean hasRecord(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("selectTOTAL_LOT_STOCK", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectTOTAL_LOT_STOCK_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:selectTOTAL_LOT_STOCK_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:selectTOTAL_LOT_STOCK_clear
		...
		/**
		 * selectTOTAL_LOT_STOCKクラスの標準コンストラクタ
		 */
		public selectTOTAL_LOT_STOCK()
		{
			//{{user_implement_dev:selectTOTAL_LOT_STOCK_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:selectTOTAL_LOT_STOCK_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class Select_Item extends DataObject
	{
		protected String m_selcmd = "SELECT "
+"  M_ITEM.\"DRAW_CD\" AS \"DRAW_CD\", "
+"  M_ITEM.\"SPEC\" AS \"SPEC\", "
...
+"  M_ITEM.\"ITEM_CD\" = ?";
		...
		//{{user_implement_dev:Select_Item_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:Select_Item_def
		...
		public List read(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:Select_Item_read
			if(m_selcmd==null) throw new FoundationException("Select_Item", "read", "クエリー未登録");
		...
		public List read(Connection conn, AF0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:Select_Item_read2
			if(m_selcmd==null) throw new FoundationException("Select_Item", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AF0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:Select_Item_read3
			if(m_selcmd==null) throw new FoundationException("Select_Item", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public AF0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setDRAW_CD( getString(1, rs) );
			data.setSPEC( getString(2, rs) );
			data.setSTOCK_UNIT( getString(3, rs) );
			data.setMRP_ODR_TYP( getString(4, rs) );
			data.setUNIT_QTY_TYP( getString(5, rs) );
		...
		public boolean hasRecord(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("Select_Item", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:Select_Item_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:Select_Item_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:Select_Item_clear
		...
		/**
		 * Select_Itemクラスの標準コンストラクタ
		 */
		public Select_Item()
		{
			//{{user_implement_dev:Select_Item_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:Select_Item_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class unAlcStockQty extends DataObject
	{
		protected String m_selcmd = "SELECT "
+"  DECODE(T3.LOT_CTRL_FLG, 1, NVL(T1.STOCK_ON_HAND_QTY, 0) - NVL(T2.ALCD_QTY, 0), NVL(T1.STOCK_ON_HAND_QTY, 0)) AS UN_ALC_STOCK "
+"FROM "
+"  ( "
+"    SELECT "
+"      SUM(NVL(A.STOCK_ON_HAND_QTY, 0)) AS STOCK_ON_HAND_QTY "
+"    FROM "
+"      T_ITEM_STOCK A "
+"    WHERE "
+"      A.ITEM_CD = ? "
...
+"  ( "
+"    SELECT "
+"      SUM(NVL(B.ALCD_QTY, 0)) AS ALCD_QTY "
+"    FROM "
+"      T_LOT_CTRL A, "
+"      T_LOT_STOCK B "
+"    WHERE "
...
+"  T3.ITEM_CD = ?";
		...
		//{{user_implement_dev:unAlcStockQty_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:unAlcStockQty_def
		...
		public List read(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:unAlcStockQty_read
			if(m_selcmd==null) throw new FoundationException("unAlcStockQty", "read", "クエリー未登録");
		...
		public List read(Connection conn, AF0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:unAlcStockQty_read2
			if(m_selcmd==null) throw new FoundationException("unAlcStockQty", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AF0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:unAlcStockQty_read3
			if(m_selcmd==null) throw new FoundationException("unAlcStockQty", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public AF0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setITEM_STOCK_NON_ALC_QTY( getString(1, rs) );
		...
		public boolean hasRecord(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("unAlcStockQty", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:unAlcStockQty_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:unAlcStockQty_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:unAlcStockQty_clear
		...
		/**
		 * unAlcStockQtyクラスの標準コンストラクタ
		 */
		public unAlcStockQty()
		{
			//{{user_implement_dev:unAlcStockQty_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:unAlcStockQty_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class LOT_Stock_ALCD_QTY extends DataObject
	{
		protected String m_selcmd = "select "
+"  nvl(SUM(A.ALCD_QTY), 0) AS ALCD_QTY "
+"from "
+"  T_LOT_STOCK A, "
+"  M_ITEM B, "
+"  M_WH C "
...
+"  AND A.ITEM_CD = ?";
		...
		//{{user_implement_dev:LOT_Stock_ALCD_QTY_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:LOT_Stock_ALCD_QTY_def
		...
		public List read(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:LOT_Stock_ALCD_QTY_read
			if(m_selcmd==null) throw new FoundationException("LOT_Stock_ALCD_QTY", "read", "クエリー未登録");
		...
		public List read(Connection conn, AF0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:LOT_Stock_ALCD_QTY_read2
			if(m_selcmd==null) throw new FoundationException("LOT_Stock_ALCD_QTY", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AF0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:LOT_Stock_ALCD_QTY_read3
			if(m_selcmd==null) throw new FoundationException("LOT_Stock_ALCD_QTY", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public AF0030010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setALC_NOISSUE_QTY( getString(1, rs) );
		...
		public boolean hasRecord(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("LOT_Stock_ALCD_QTY", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:LOT_Stock_ALCD_QTY_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:LOT_Stock_ALCD_QTY_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:LOT_Stock_ALCD_QTY_clear
		...
		/**
		 * LOT_Stock_ALCD_QTYクラスの標準コンストラクタ
		 */
		public LOT_Stock_ALCD_QTY()
		{
			//{{user_implement_dev:LOT_Stock_ALCD_QTY_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:LOT_Stock_ALCD_QTY_constractor
...
+"  and ROWNUM <= TO_NUMBER(?) + 1";
	 ...
	 * Entity定義 静的SQL
	 */
	public class select_T_LOT_STOCKCnt extends DataObject
	{
		protected String m_selcmd = "select "
+"  count(1) "
+"from "
...
+"  and ROWNUM <= TO_NUMBER(?) + 1";
		...
		//{{user_implement_dev:select_T_LOT_STOCKCnt_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:select_T_LOT_STOCKCnt_def
		...
		public List read(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_T_LOT_STOCKCnt_read
			if(m_selcmd==null) throw new FoundationException("select_T_LOT_STOCKCnt", "read", "クエリー未登録");
		...
		public List read(Connection conn, AF0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_T_LOT_STOCKCnt_read2
			if(m_selcmd==null) throw new FoundationException("select_T_LOT_STOCKCnt", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AF0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_T_LOT_STOCKCnt_read3
			if(m_selcmd==null) throw new FoundationException("select_T_LOT_STOCKCnt", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public PreparedStatement prepare(Connection conn, String query, AF0030010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				...
				throw new FoundationException("select_T_LOT_STOCKCnt", "prepare", "Parse失敗:"+e.toString());
			} finally {
				ary.removeAllElements();
				ary = null;
			}
		...
		public boolean hasRecord(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("select_T_LOT_STOCKCnt", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:select_T_LOT_STOCKCnt_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);;
		...
		public void clear()
		{
			//{{user_implement_dev:select_T_LOT_STOCKCnt_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:select_T_LOT_STOCKCnt_clear
		...
		/**
		 * select_T_LOT_STOCKCntクラスの標準コンストラクタ
		 */
		public select_T_LOT_STOCKCnt()
		{
			//{{user_implement_dev:select_T_LOT_STOCKCnt_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:select_T_LOT_STOCKCnt_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class Select_T_LOT_ISSUE_INSTCnt extends DataObject
	{
		protected String m_selcmd = "select "
+"  count(1) "
+"from "
...
+"  and ROWNUM <= TO_NUMBER(?) + 1";
		...
		//{{user_implement_dev:Select_T_LOT_ISSUE_INSTCnt_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:Select_T_LOT_ISSUE_INSTCnt_def
		...
		public List read(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:Select_T_LOT_ISSUE_INSTCnt_read
			if(m_selcmd==null) throw new FoundationException("Select_T_LOT_ISSUE_INSTCnt", "read", "クエリー未登録");
		...
		public List read(Connection conn, AF0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:Select_T_LOT_ISSUE_INSTCnt_read2
			if(m_selcmd==null) throw new FoundationException("Select_T_LOT_ISSUE_INSTCnt", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AF0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:Select_T_LOT_ISSUE_INSTCnt_read3
			if(m_selcmd==null) throw new FoundationException("Select_T_LOT_ISSUE_INSTCnt", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public PreparedStatement prepare(Connection conn, String query, AF0030010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				...
				throw new FoundationException("Select_T_LOT_ISSUE_INSTCnt", "prepare", "Parse失敗:"+e.toString());
			} finally {
				ary.removeAllElements();
				ary = null;
			}
		...
		public boolean hasRecord(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("Select_T_LOT_ISSUE_INSTCnt", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:Select_T_LOT_ISSUE_INSTCnt_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);;
		...
		public void clear()
		{
			//{{user_implement_dev:Select_T_LOT_ISSUE_INSTCnt_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:Select_T_LOT_ISSUE_INSTCnt_clear
		...
		/**
		 * Select_T_LOT_ISSUE_INSTCntクラスの標準コンストラクタ
		 */
		public Select_T_LOT_ISSUE_INSTCnt()
		{
			//{{user_implement_dev:Select_T_LOT_ISSUE_INSTCnt_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:Select_T_LOT_ISSUE_INSTCnt_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class selectT_WORK_IN_PROC_MIN extends DataObject
	{
		protected String m_selcmd = "select "
+"  proc.work_in_proc_cd "
+"from "
+"  t_work_in_proc_by_proc proc, "
+"  ( "
+"    select "
+"      min(t.proc_no) as proc_no_a "
+"    from "
+"      t_work_in_proc_by_proc t "
+"    where "
+"      t.work_odr_cd = ? "
+"      and t.outside_typ = 1 "
+"  ) A "
+"where "
+"  proc.work_odr_cd = ? "
+"  and proc.proc_no = A.proc_no_a "
+"  and proc.outside_typ = 1";
		protected String m_chkcmd = null;
		protected String m_inscmd = null;
		protected String m_updcmd = null;
		protected String m_delcmd = null;
		...
		//{{user_implement_dev:selectT_WORK_IN_PROC_MIN_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:selectT_WORK_IN_PROC_MIN_def
		...
		public List read(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectT_WORK_IN_PROC_MIN_read
			if(m_selcmd==null) throw new FoundationException("selectT_WORK_IN_PROC_MIN", "read", "クエリー未登録");
		...
		public List read(Connection conn, AF0030010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectT_WORK_IN_PROC_MIN_read2
			if(m_selcmd==null) throw new FoundationException("selectT_WORK_IN_PROC_MIN", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AF0030010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectT_WORK_IN_PROC_MIN_read3
			if(m_selcmd==null) throw new FoundationException("selectT_WORK_IN_PROC_MIN", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean hasRecord(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("selectT_WORK_IN_PROC_MIN", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AF0030010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectT_WORK_IN_PROC_MIN_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:selectT_WORK_IN_PROC_MIN_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:selectT_WORK_IN_PROC_MIN_clear
		...
		/**
		 * selectT_WORK_IN_PROC_MINクラスの標準コンストラクタ
		 */
		public selectT_WORK_IN_PROC_MIN()
		{
			//{{user_implement_dev:selectT_WORK_IN_PROC_MIN_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:selectT_WORK_IN_PROC_MIN_constractor
	...
	public void clear()
	{
		...
		mselectM_COST.clear();
		mselectM_COST = null;
		mselectM_WH_PRIORITY_ITEM.clear();
		mselectM_WH_PRIORITY_ITEM = null;
		mselectM_WH_PRIORITY_JOB.clear();
		mselectM_WH_PRIORITY_JOB = null;
		mselect_ITEM_STOCK.clear();
		mselect_ITEM_STOCK = null;
		mselect_JOB_ODR_STOCK.clear();
		mselect_JOB_ODR_STOCK = null;
		...
		mcheck_T_LOT_CTRL.clear();
		mcheck_T_LOT_CTRL = null;
		mselect_T_LOT_STOCK.clear();
		mselect_T_LOT_STOCK = null;
		mSelect_T_LOT_ISSUE_INST.clear();
		mSelect_T_LOT_ISSUE_INST = null;
		...
		mselectTOTAL_LOT_STOCK.clear();
		mselectTOTAL_LOT_STOCK = null;
		mSelect_Item.clear();
		mSelect_Item = null;
		munAlcStockQty.clear();
		munAlcStockQty = null;
		mLOT_Stock_ALCD_QTY.clear();
		mLOT_Stock_ALCD_QTY = null;
		mselectCnt.clear();
		mselectCnt = null;
		mselect_T_LOT_STOCKCnt.clear();
		mselect_T_LOT_STOCKCnt = null;
		mSelect_T_LOT_ISSUE_INSTCnt.clear();
		mSelect_T_LOT_ISSUE_INSTCnt = null;
		mselectT_WORK_IN_PROC_MIN.clear();
		mselectT_WORK_IN_PROC_MIN = null;
		return;
	}
	 ...
	 */
	public AF0030010Entity() throws FoundationException
	{
