/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DB0040/src/com/nec/jp/orteus/metamorBase/DB0040/DB0040010Control.java,v $
 *
...
import com.nec.jp.orteus.metamorBase.DB0040.*;
...
public class DB0040010Control
{
	...
	//{{user_implement_code_main
        ...
        public DB0040010Struct getListvalue(int x) {
         return (DB0040010Struct) (this.list.get(x));
        } // リストの値を返します。
        public DB0040010Struct getStruct() {
         return this.struct;
        } // Structを返します。
        public DB0040010Struct createStruct() {
         return new DB0040010Struct();
        } // 新しいStructを作って返します。
        public void setStruct(Object structname) {
         this.struct.setStruct((DB0040010Struct) structname);
        } // Structをセットします。
        ...
        private DB0040010Struct _mySysCostCtrl;
         ...
         * @param s 検索したデータ
         */
        private void setStruct(DB0040010Struct s) {
        }
         ...
         */
        private void executeBatchProgram(DB0040010Struct s) throws IOException {
...
//         // 呼び出し先クラス
//         buffer.append(" com.nec.jp.orteus.metamorBase.DB0040.DB0040B001.mainDB0040B001");
//         // バッチ処理区分
...
//         runtime.exec(buffer.toString());
         ...
         // 呼び出し先クラス
         buffer.add("com.nec.jp.orteus.metamorBase.DB0040.DB0040B001.mainDB0040B001");
         // バッチ処理区分
	...
	public void controlExecute() throws BusinessProcessException, FoundationException
	{
		...
		logger.entering("DB0040010Control"+":USER="+struct.getsUser_ID(),"controlExecute");
			//{{user_implement_dev:<controlExecute>
                try {
                 ...
                 if (mPlantList.isEmpty()) {
                  ...
                  DB0040010Struct plantStruct = (DB0040010Struct) mPlantList.get(0);
                ...
                //}}user_implement_dev:<controlExecute>
		logger.exiting("DB0040010Control"+":USER="+struct.getsUser_ID(),"controlExecute");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.DB0040");
		logger.entering("DB0040010Control"+":USER="+struct.getsUser_ID(),"controlClear");
			//{{user_implement_dev:<controlClear>
                initializeAll();
                //}}user_implement_dev:<controlClear>
		logger.exiting("DB0040010Control"+":USER="+struct.getsUser_ID(),"controlClear");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.DB0040");
		logger.entering("DB0040010Control"+":USER="+struct.getsUser_ID(),"controlINITIAL");
		//{{user_implement_dev:<controlINITIAL>
                //}}user_implement_dev:<controlINITIAL>
		logger.exiting("DB0040010Control"+":USER="+struct.getsUser_ID(),"controlINITIAL");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.DB0040");
		logger.entering("DB0040010Control"+":USER="+struct.getsUser_ID(),"controlRELOAD");
		//{{user_implement_dev:<controlRELOAD>
                try {
                 ...
                 if (sysCostCtrlList.isEmpty()) {
                  setErrorMessage("DB00007");
                  setErrorParameter("SYS_COST_CTRL", "PLANT_CD", struct.getPLANT_CD());
                  _mySysCostCtrl = new DB0040010Struct();
                 } else {
                  _mySysCostCtrl = (DB0040010Struct) sysCostCtrlList.get(0);
                 }
                ...
                //}}user_implement_dev:<controlRELOAD>
		logger.exiting("DB0040010Control"+":USER="+struct.getsUser_ID(),"controlRELOAD");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.DB0040");
		logger.entering("DB0040010Control"+":USER="+struct.getsUser_ID(),"controlPREPARATION");
...
//		}
		...
		//{{user_implement_dev:<controlPREPARATION>
                ...
                //}}user_implement_dev:<controlPREPARATION>
		logger.exiting("DB0040010Control"+":USER="+struct.getsUser_ID(),"controlPREPARATION");
...
//			e.printStackTrace();
//			throw new FoundationException("DB0040010Control",e.getMessage(),"control_eventHandllerメソッドでエラーが発生しました。");
	...
	public void createDefaultCSV(List list, String sTitle[]) throws BusinessProcessException, FoundationException {
		...
		//{{user_implement_dev:<createDefaultCSV>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("DB0040010-E999","CSVの出力処理"));
			throw new FoundationException("DB0040010Control",e.getMessage(),"createDefaultCSVメソッドでエラーが発生しました。");
		}
...
//				objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("DB0040010-E999","システム日付の取得処理"));
				throw new FoundationException("DB0040010Control","beginTransaction()","システム日付取得処理でエラーが発生しました。");
			}
		...
		//{{user_implement_dev:<beginTransaction>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("DB0040010-E999","コントロールのイベント処理"));
			throw new FoundationException("DB0040010Control",e.getMessage(),"beginTransactionメソッドでエラーが発生しました。");
		}
	 ...
	 * メンバ変数の定義
	 */
	protected DB0040010Entity entity;
	protected DB0040010Struct struct;
	...
	public void initialize() throws FoundationException
	{
		...
		entity = new DB0040010Entity();
		struct = new DB0040010Struct();
	 ...
	 */
	public DB0040010Control() throws BusinessProcessException, FoundationException
	{
		initialize();
	...
	public void setOrMsgKey(List keyList) throws MessageApiException {
		...
		for (int i = 0; msgKeyTypeArray != null && i < msgKeyTypeArray.size(); i++) {
			...
			for(int j = 0; j < keyList.size(); j++) {
				DB0040010Struct key = (DB0040010Struct)keyList.get(j);
				// メッセージキーを作成する
		...
		try {
			for (int i = 0; msgKeyTypeArray != null && i < msgKeyTypeArray.size(); i++) {
				...
				for (int j = 0; msgKeyArray != null && j < msgKeyArray.size(); j++) {
					...
					DB0040010Struct key = new DB0040010Struct();
