/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DB0040/src/com/nec/jp/orteus/metamorBase/DB0040/DB0040B001/cdrDB0040B001.java,v $
 *
...
public class cdrDB0040B001 extends Object
		implements IBatchAppCommon
{
	...
	public void initialize() throws BatchAppException, SystemException
	{
		try {
			...
			m_med.setSqlProcCostEntry( new SqlProcCostEntry(m_med, m_conductor) );
			...
			m_conductor.addObject( m_med.getSqlProcCostEntry() );
	...
	public int beginProc() throws BatchAppException
	{
		try {
			...
			setCommitFlag(false);
			BatchAppException be=new BatchAppException("cdrDB0040B001", "beginProc", "conductorの初期処理に失敗しました");
	...
	medDB0040B001 m_med=new medDB0040B001();

	// BatchAppConductorクラスインスタンス
	BatchAppConductor m_conductor=new BatchAppConductor("DB0040B001");
	...
	/**
	 * ctrDB0040B001クラス 標準コンストラクタ
	 *
		 */
	public cdrDB0040B001() throws BatchAppException
	{
		initialize();
