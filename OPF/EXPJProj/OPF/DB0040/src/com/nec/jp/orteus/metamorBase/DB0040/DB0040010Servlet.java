/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DB0040/src/com/nec/jp/orteus/metamorBase/DB0040/DB0040010Servlet.java,v $
 *
...
public class DB0040010Servlet extends HttpServlet
{
	 ...
	 * @param control DB0040010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, DB0040010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control DB0040010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, DB0040010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					DB0040010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		DB0040010Entity entity = control.entity;
		DB0040010Struct struct = control.struct;
		...
		try {
			...
			Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.DB0040");
			logger.entering("DB0040010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
                 // TODO: ユーザ定義のコードを記述してください
              //			objMessage.m_writer.write( Level.ALL, "DB0040010"+" $Revision: 1.5 $" );
                 control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("DB0040010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					DB0040010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		DB0040010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.DB0040");
		logger.entering("DB0040010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
		...
		//{{user_implement_dev:<reloadEvent>
              ...
              //			e.printStackTrace();
              //			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("DB0040010-E999","リロード処理"));
                 ExpjException ee = new ExpjException(e, "ZZ01106");
                 throw ee;
                }
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("DB0040010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickExecute(
					...
					HttpSession so,
					Hashtable params,
					DB0040010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		DB0040010Entity entity = control.entity;
		DB0040010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.DB0040");
		logger.entering("DB0040010Servlet"+":USER="+request.getRemoteUser(),"onClickExecute");
		//{{user_implement_dev:<onClickExecute>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickExecute>
		logger.exiting("DB0040010Servlet"+":USER="+request.getRemoteUser(),"onClickExecute");
					...
					DB0040010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.DB0040");
		logger.entering("DB0040010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
		//{{user_implement_dev:<onClickClear>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("DB0040010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, DB0040010Struct struct)
	{
	...
	public static String DEFAULT_TARGET = "/DB0040010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aDB0040010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aDB0040010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.DB0040");
		logger.entering("DB0040010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("DB0040010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		DB0040010Control control;
		DB0040010Entity  entity = null;
		DB0040010Struct  struct = null;
		...
		try {
			...
			if( (control = (DB0040010Control)so.getAttribute("DB0040010Control_"+request.getSession(false).getId())) == null ) {
				control = new DB0040010Control();
			...
			try {
				...
				so.setAttribute("DB0040010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.DB0040.DB0040010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public DB0040010Servlet()
	{
		//{{user_implement_dev:<DB0040010_DisConnect_FLG>
		...
		//{{user_implement_dev:<DB0040010Servlet>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<DB0040010Servlet>
	}
