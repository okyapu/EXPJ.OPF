/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DB0040/src/com/nec/jp/orteus/metamorBase/DB0040/DB0040B001/SYS_COST_CTRL.java,v $
 *
 ...
 * @version $Revision: 1.6 $ $Date: 2014/11/05 07:22:02 $
 */
...
public class SYS_COST_CTRL extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public String getCURRENT_YEAR_R() throws FoundationException { return m_doRs.getString(1); }
		public String getHALF_TERM_TYP_R() throws FoundationException { return m_doRs.getString(2); }
		public String getM_PROC_COST_PRIORITY_TYP_R() throws FoundationException { return m_doRs.getString(3); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setYEAR(getCURRENT_YEAR_R());
				m_med.setHALF_TERM_TYP(getHALF_TERM_TYP_R());
				m_med.setPRIORITY_TYP(getM_PROC_COST_PRIORITY_TYP_R());
			} catch(FoundationException e) {
	 ...
	 *
		 */
	public SYS_COST_CTRL(medDB0040B001 med, BatchAppConductor cdr) throws SystemException
	{
