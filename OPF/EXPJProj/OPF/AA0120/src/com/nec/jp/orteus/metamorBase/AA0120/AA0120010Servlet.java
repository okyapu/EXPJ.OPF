...
public class AA0120010Servlet extends HttpServlet
{
	 ...
	 * @param control AA0120010Controlクラスインスタンス
	 */
...
//			e.printStackTrace();
					...
					AA0120010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		//{{user_implement_dev:<reloadEvent>
              ...
              //			e.printStackTrace();
              //			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AA0120010-E999","リロード処理"));
                 ExpjException ee = new ExpjException(e, "ZZ01106");
                 throw ee;
                }
                //}}user_implement_dev:<reloadEvent>
	...
	public String onClickLineInsert(
					...
					AA0120010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = "/AA0120011.jsp";		// 移動先ＵＲＬ
		AA0120010Entity entity = control.entity;
		AA0120010Struct struct = control.struct;
		getSessionParameters(so, params, struct);
	...
	public String onClickInsert(
					...
					AA0120010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = "/AA0120010.jsp";		// 移動先ＵＲＬ
		AA0120010Entity entity = control.entity;
		AA0120010Struct struct = control.struct;
		getSessionParameters(so, params, struct);
	...
	public static String DEFAULT_TARGET = "/AA0120010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAA0120010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAA0120010Struct";   // JSP先のバインド名(Struct)の指定
