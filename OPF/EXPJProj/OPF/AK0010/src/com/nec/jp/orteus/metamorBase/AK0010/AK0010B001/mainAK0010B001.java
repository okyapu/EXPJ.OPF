/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AK0010/src/com/nec/jp/orteus/metamorBase/AK0010/AK0010B001/mainAK0010B001.java,v $
 *
...
/**
 * CLASS     : mainAK0010B001 クラス
 * ファイル・クラス説明
 * @author $Author: shan-xiuqin $
 * @version $Revision: 1.8 $ $Date: 2016/05/23 08:26:42 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class mainAK0010B001
{
    // リターン値
	...
	public static void main(String args[])
	{
		...
		try {
			...
			if (sysLog == null) {
				...
				if(!sysLog.init("com.nec.jp.orteus.metamorBase.AK0010B001")) {
					//システムログの初期化に失敗しました
			...
			try {
				...
				// 標準出力ファイル名設定
				String logFileName = "AK0010B001.log";
				if (logFileName == null) {
				...
				// 新規作成のためバッチログファイル削除
				if (blogMode == false) {
					File logFile = new File(logOutputPath + "/AK0010B001.log");
				...
				System.setOut(new PrintStream(new FileOutputStream(logOutputPath + "/AK0010B001stdout.log", blogMode)));
				System.setErr(new PrintStream(new FileOutputStream(logOutputPath + "/AK0010B001stderr.log", blogMode)));
			...
			cdrAK0010B001 ebo = new cdrAK0010B001();
