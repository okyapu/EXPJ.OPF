/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AK0010/src/com/nec/jp/orteus/metamorBase/AK0010/AK0010B001/selectPlantCd.java,v $
 *
...
public class selectPlantCd extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setallPlantCd(getPLANT_CD_R());
			} catch(FoundationException e) {
	 ...
	 *
		 */
	public selectPlantCd(medAK0010B001 med, BatchAppConductor cdr) throws SystemException
	{
