/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AK0010/src/com/nec/jp/orteus/metamorBase/AK0010/AK0010B001/cdrAK0010B001.java,v $
 *
...
public class cdrAK0010B001 extends Object
		implements IBatchAppCommon
{
	...
	public void initialize() throws BatchAppException, SystemException
	{
		try {
			...
			m_med.setcallSqlDailyProc( new callSqlDailyProc(m_med, m_conductor) );
			m_med.setreadSysBatParm( new readSysBatParm(m_med, m_conductor) );
			m_med.setselectPlantCd( new selectPlantCd(m_med, m_conductor) );
			m_med.setreadFinalDailyProcExecDate( new readFinalDailyProcExecDate(m_med, m_conductor) );
			m_med.setcheckPlantCd( new checkPlantCd(m_med, m_conductor) );
			m_med.setcheckUserCd( new checkUserCd(m_med, m_conductor) );
			m_med.setCtrlMain( new CtrlMain(m_med, m_conductor) );
			m_conductor.addObject( m_med.getcallSqlDailyProc() );
			m_conductor.addObject( m_med.getreadSysBatParm() );
			m_conductor.addObject( m_med.getselectPlantCd() );
			m_conductor.addObject( m_med.getreadFinalDailyProcExecDate() );
			m_conductor.addObject( m_med.getcheckPlantCd() );
			m_conductor.addObject( m_med.getcheckUserCd() );
	...
	public int getType() { return m_conductor.getType(); }
        ...
        public int beginProc() throws BatchAppException
        {
         try {
          ...
          setCommitFlag(false);
          BatchAppException be=new BatchAppException("cdrAK0010B001", "beginProc", "conductorの初期処理に失敗しました");
	...
	medAK0010B001 m_med=new medAK0010B001();

	// BatchAppConductorクラスインスタンス
	BatchAppConductor m_conductor=new BatchAppConductor("AK0010B001");
	...
	/**
	 * ctrAK0010B001クラス 標準コンストラクタ
	 *
		 */
	public cdrAK0010B001() throws BatchAppException
	{
		initialize();
