/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KU0010/src/com/nec/jp/orteus/metamorBase/KU0010/KU0010B001/tblT_UN_SHIP_LIST.java,v $
 *
...
public class tblT_UN_SHIP_LIST extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setCUST_CD_C(String value) throws FoundationException { getAdapt_C().setString(7, value); }
		public void setACPT_ODR_CD_C(String value) throws FoundationException { getAdapt_C().setString(8, value); }
		public void setPART_DLV_SEQ_NO_C(String value) throws FoundationException { getAdapt_C().setString(9, value); }
		public void setITEM_CD_C(String value) throws FoundationException { getAdapt_C().setString(10, value); }
		public void setUN_SHIP_QTY_C(String value) throws FoundationException { getAdapt_C().setString(11, value); }
		public void setUN_SHIP_RSN_C(String value) throws FoundationException { getAdapt_C().setString(12, value); }
		public void setWH_CD_C(String value) throws FoundationException { getAdapt_C().setString(13, value); }
		...
		public int create() throws BatchAppException
		{
			try {
				...
				setCUST_CD_C(m_med.getcreTUnShipListCUST_CD());
				setACPT_ODR_CD_C(m_med.getcreTUnShipListACPT_ODR_CD());
				setPART_DLV_SEQ_NO_C(m_med.getcreTUnShipListPART_DLV_SEQ_NO());
				setITEM_CD_C(m_med.getcreTUnShipListITEM_CD());
				setUN_SHIP_QTY_C(m_med.getcreTUnShipListUN_SHIP_QTY());
				setUN_SHIP_RSN_C(m_med.getcreTUnShipListUN_SHIP_RSN());
				setWH_CD_C(m_med.getcreTUnShipListWH_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("tblT_UN_SHIP_LIST", "create", "レコード新規追加パラメータ設定処理失敗");
		...
		public void setUN_SHIP_SEQ_NO_D(String value) throws FoundationException { getAdapt_D().setString(1, value); }

		public int delete() throws BatchAppException
		{
			try {

				setUN_SHIP_SEQ_NO_D(m_med.getUN_SHIP_SEQ_NO());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("tblT_UN_SHIP_LIST", "delete", "レコード削除条件設定処理失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
	...
	void prepareAll() throws BatchAppException
	{
		...
		try {
			...
			BatchAppException be=new BatchAppException("tblT_UN_SHIP_LIST", "prepareALL(FoundationException)", "SQL文のprepareで失敗しました");
			be.addMessage(e.getErrmsg());
			throw be;
		} catch(SQLException e) {
			BatchAppException be=new BatchAppException("tblT_UN_SHIP_LIST", "prepareALL(SQLException)", "SQL文のprepareで失敗しました");
			throw be;
		}
	...
	/**
	 * tblT_UN_SHIP_LISTクラスの標準コンストラクタ
	 *
		 */
	public tblT_UN_SHIP_LIST(medKU0010B001 med, BatchAppConductor cdr) throws SystemException
	{
...
+"values "
+"  (SEQ_UN_SHIP_SEQ_NO.NEXTVAL, ?, ?, ?, ?, ?, ?, ?, '0', '0')";
	protected static String m_updcmd = null;
	protected static String m_delcmd = "delete from T_UN_SHIP_LIST where TO_CHAR('1') = ?";
