/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KU0010/src/com/nec/jp/orteus/metamorBase/KU0010/KU0010B001/tblM_CUR.java,v $
 *
...
public class tblM_CUR extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setCUR_CD_R(String value) throws FoundationException { getAdapt_R().setString(1, value); }
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setCUR_CD_R(m_med.getstrCUR_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("tblM_CUR", "read", "レコード検索条件設定処理失敗");
		...
		public String getDECIMAL_FIG_R() throws FoundationException { return m_doRs.getString(1); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setstrDECIMAL_FIG(getDECIMAL_FIG_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("tblM_CUR", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("tblM_CUR", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	 ...
	 *
		 */
	public tblM_CUR(medKU0010B001 med, BatchAppConductor cdr) throws SystemException
	{
