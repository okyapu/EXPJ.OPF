/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KU0010/src/com/nec/jp/orteus/metamorBase/KU0010/KU0010B001/tblT_SHIP_ODR_CHK.java,v $
 *
...
public class tblT_SHIP_ODR_CHK extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setINI1_R(String value) throws FoundationException { getAdapt_R().setString(1, value); }
		public void setINI2_R(String value) throws FoundationException { getAdapt_R().setString(2, value); }
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setINI1_R(m_med.getreadTItemStockIN_ITEMCD());
				setINI2_R(m_med.getreadTItemStockIN_WHTYP());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("tblT_SHIP_ODR_CHK", "read", "レコード検索条件設定処理失敗");
		...
		public String getSHIP_QTY_R() throws FoundationException { return m_doRs.getString(1); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setstrSHIP_QTY_SUM(getSHIP_QTY_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("tblT_SHIP_ODR_CHK", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("tblT_SHIP_ODR_CHK", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	...
	/**
	 * tblT_SHIP_ODR_CHKクラスの標準コンストラクタ
	 *
		 */
	public tblT_SHIP_ODR_CHK(medKU0010B001 med, BatchAppConductor cdr) throws SystemException
	{
...
+"  NVL(SUM(T_SHIP_ODR.\"SHIP_QTY\"), 0) as \"SHIP_QTY\" "
+"from "
+"  T_SHIP_ODR "
+"where "
+"  T_SHIP_ODR.\"SHP_CMPLT_FLG\" = '0' "
+"  and T_SHIP_ODR.\"DEPO_TRANSFER_PROC_FLG\" = '0' "
+"  and T_SHIP_ODR.\"ITEM_CD\" = ? "
