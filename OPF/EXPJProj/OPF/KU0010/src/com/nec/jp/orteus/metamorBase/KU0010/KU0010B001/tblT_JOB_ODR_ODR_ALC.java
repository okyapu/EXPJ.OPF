/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KU0010/src/com/nec/jp/orteus/metamorBase/KU0010/KU0010B001/tblT_JOB_ODR_ODR_ALC.java,v $
 *
...
/**
 * CLASS     : tblT_JOB_ODR_ODR_ALC クラス
 * ファイル・クラス説明
...
public class tblT_JOB_ODR_ODR_ALC extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN1_R(m_med.getreadTAnsDlvDateODR_NO());
				setIN2_R(m_med.getstrCOMPANY_CD());
				setIN3_R(m_med.getreadTJOBODRODRALCPLANT_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("tblT_JOB_ODR_ODR_ALC", "read", "レコード検索条件設定処理失敗");
		...
		public String getJOB_ODR_CD_R() throws FoundationException { return m_doRs.getString(1); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setstrJOB_ODR_CD(getJOB_ODR_CD_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("tblT_JOB_ODR_ODR_ALC", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("tblT_JOB_ODR_ODR_ALC", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	...
	/**
	 * tblT_JOB_ODR_ODR_ALCクラスの標準コンストラクタ
	 *
		 */
	public tblT_JOB_ODR_ODR_ALC(medKU0010B001 med, BatchAppConductor cdr) throws SystemException
	{
