/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KU0010/src/com/nec/jp/orteus/metamorBase/KU0010/KU0010B001/getGyomuDate.java,v $
 *
...
public class getGyomuDate extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setstrPLANT_CD(getPLANT_CD_R());
			} catch(FoundationException e) {
	 ...
	 *
		 */
	public getGyomuDate(medKU0010B001 med, BatchAppConductor cdr) throws SystemException
	{
