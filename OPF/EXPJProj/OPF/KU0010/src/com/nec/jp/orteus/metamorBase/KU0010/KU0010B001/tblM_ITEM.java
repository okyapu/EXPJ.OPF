/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KU0010/src/com/nec/jp/orteus/metamorBase/KU0010/KU0010B001/tblM_ITEM.java,v $
 *
...
public class tblM_ITEM extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN3_R(m_med.getreadMItemIN_ITEMCD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("tblM_ITEM", "read", "レコード検索条件設定処理失敗");
		...
		public String getUNIT_WEIGHT_R() throws FoundationException { return m_doRs.getString(3); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setreadMItemITEM_CD(getITEM_CD_R());
				m_med.setreadMItemPKG_UNIT_QTY(getPKG_UNIT_QTY_R());
				m_med.setreadMItemUNIT_WEIGHT(getUNIT_WEIGHT_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("tblM_ITEM", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("tblM_ITEM", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	...
	/**
	 * tblM_ITEMクラスの標準コンストラクタ
	 *
		 */
	public tblM_ITEM(medKU0010B001 med, BatchAppConductor cdr) throws SystemException
	{
