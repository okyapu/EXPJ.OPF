/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KU0010/src/com/nec/jp/orteus/metamorBase/KU0010/KU0010B001/writeErrWngLst.java,v $
 *
...
public class writeErrWngLst extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int create() throws BatchAppException
		{
			try {
				...
				BatchAppException be=new BatchAppException("writeErrWngLst", "create", "レコード新規追加パラメータ設定処理失敗");
	...
	void prepareAll() throws BatchAppException
	{
		...
		try {
			...
			BatchAppException be=new BatchAppException("writeErrWngLst", "prepareALL(FoundationException)", "SQL文のprepareで失敗しました");
			be.addMessage(e.getErrmsg());
			throw be;
		} catch(SQLException e) {
			BatchAppException be=new BatchAppException("writeErrWngLst", "prepareALL(SQLException)", "SQL文のprepareで失敗しました");
			throw be;
		}
	...
	/**
	 * writeErrWngLstクラスの標準コンストラクタ
	 *
		 */
	public writeErrWngLst(medKU0010B001 med, BatchAppConductor cdr) throws SystemException
	{
