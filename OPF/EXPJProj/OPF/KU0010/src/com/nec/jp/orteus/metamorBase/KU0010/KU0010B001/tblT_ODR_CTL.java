/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KU0010/src/com/nec/jp/orteus/metamorBase/KU0010/KU0010B001/tblT_ODR_CTL.java,v $
 *
...
/**
 * CLASS     : tblT_ODR_CTL クラス
 * ファイル・クラス説明
 * @author $Author: geng-jia $
 * @version $Revision: 1.18 $ $Date: 2015/12/03 08:16:06 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class tblT_ODR_CTL extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN5_R(m_med.getreadTOdrCtlIN_ODRCTLNO());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("tblT_ODR_CTL", "read", "レコード検索条件設定処理失敗");
		...
		public String getCUST_ITEM_CD_R() throws FoundationException { return m_doRs.getString(3); }
		public String getCUST_CD_R() throws FoundationException { return m_doRs.getString(4); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setreadTOdrCtlODR_CTL_NO(getODR_CTL_NO_R());
				m_med.setreadTOdrCtlITEM_CD(getITEM_CD_R());
				m_med.setreadTOdrCtlCUST_ITEM_CD(getCUST_ITEM_CD_R());
				m_med.setreadTOdrCtlCUST_CD(getCUST_CD_R());
				m_med.setreadTOdrCtlDEL_FLG(getDEL_FLG_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("tblT_ODR_CTL", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("tblT_ODR_CTL", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	...
	/**
	 * tblT_ODR_CTLクラスの標準コンストラクタ
	 *
		 */
	public tblT_ODR_CTL(medKU0010B001 med, BatchAppConductor cdr) throws SystemException
	{
