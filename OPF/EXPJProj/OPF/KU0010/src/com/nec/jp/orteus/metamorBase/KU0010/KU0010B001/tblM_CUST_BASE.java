/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KU0010/src/com/nec/jp/orteus/metamorBase/KU0010/KU0010B001/tblM_CUST_BASE.java,v $
 *
...
public class tblM_CUST_BASE extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN6_R(m_med.getreadMCustBaseIN_COMPANYCD());
				setIN7_R(m_med.getreadMCustBaseIN_CUSTCD());
				setIN8_R(m_med.getreadMCustBaseIN_DLVLOCCD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("tblM_CUST_BASE", "read", "レコード検索条件設定処理失敗");
		...
		public String getCOMPANY_CD_R() throws FoundationException { return m_doRs.getString(1); }
		public String getCUST_CD_R() throws FoundationException { return m_doRs.getString(2); }
		public String getDLV_LOC_CD_R() throws FoundationException { return m_doRs.getString(3); }
		public String getTRANSPORT_LT_R() throws FoundationException { return m_doRs.getString(4); }
		public String getDEL_FLG_R() throws FoundationException { return m_doRs.getString(5); }
		public String getREMARKS_1_R() throws FoundationException { return m_doRs.getString(6); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setreadMCustBaseCOMPANY_CD(getCOMPANY_CD_R());
				m_med.setreadMCustBaseCUST_CD(getCUST_CD_R());
				m_med.setreadMCustBaseDLV_LOC_CD(getDLV_LOC_CD_R());
				m_med.setreadMCustBaseTRANSPORT_LT(getTRANSPORT_LT_R());
				m_med.setreadMCustBaseDEL_FLG(getDEL_FLG_R());
				m_med.setreadMCustBaseREMARKS_1(getREMARKS_1_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("tblM_CUST_BASE", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("tblM_CUST_BASE", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	...
	/**
	 * tblM_CUST_BASEクラスの標準コンストラクタ
	 *
		 */
	public tblM_CUST_BASE(medKU0010B001 med, BatchAppConductor cdr) throws SystemException
	{
...
+"  M_CUST_BASE.\"DEL_FLG\" as \"DEL_FLG\", "
