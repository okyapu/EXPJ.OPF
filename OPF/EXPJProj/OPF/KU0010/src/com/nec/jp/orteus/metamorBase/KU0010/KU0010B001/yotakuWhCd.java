/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KU0010/src/com/nec/jp/orteus/metamorBase/KU0010/KU0010B001/yotakuWhCd.java,v $
 *
...
/**
 * CLASS     : yotakuWhCd クラス
 * ファイル・クラス説明
 * @author $Author: geng-jia $
 * @version $Revision: 1.18 $ $Date: 2015/12/03 08:16:08 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class yotakuWhCd extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN1_R(m_med.getstrYotaku_IN_WH_TYP());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("yotakuWhCd", "read", "レコード検索条件設定処理失敗");
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setstrYotaku_WH_CD(getWH_CD_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("yotakuWhCd", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("yotakuWhCd", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	...
	/**
	 * yotakuWhCdクラスの標準コンストラクタ
	 *
		 */
	public yotakuWhCd(medKU0010B001 med, BatchAppConductor cdr) throws SystemException
	{
