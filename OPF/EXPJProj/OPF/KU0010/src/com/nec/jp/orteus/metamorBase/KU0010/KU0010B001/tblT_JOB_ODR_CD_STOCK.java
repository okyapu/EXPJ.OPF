/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KU0010/src/com/nec/jp/orteus/metamorBase/KU0010/KU0010B001/tblT_JOB_ODR_CD_STOCK.java,v $
 *
...
/**
 * CLASS     : tblT_JOB_ODR_CD_STOCK クラス
 * ファイル・クラス説明
 * @author $Author: geng-jia $
 * @version $Revision: 1.9 $ $Date: 2015/12/03 08:16:06 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class tblT_JOB_ODR_CD_STOCK extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setIN7_R(String value) throws FoundationException { getAdapt_R().setString(6, value); }
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN2_R(m_med.getreadTJOBODRCDSTOCKITEM_CD());
				setIN3_R(m_med.getstrJOB_ODR_CD());
				setIN4_R(m_med.getreadTJOBODRCDSTOCKIN_WHCD());
				setIN5_R(m_med.getreadTJOBODRCDSTOCKIN_WHCD());
				setIN6_R(m_med.getreadTJOBODRCDSTOCKITEM_CD());
				setIN7_R(m_med.getstrJOB_ODR_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("tblT_JOB_ODR_CD_STOCK", "read", "レコード検索条件設定処理失敗");
		...
		public String getPBL_SHIP_QTY_R() throws FoundationException { return m_doRs.getString(2); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setreadTJOBODRCDSTOCK_WHCD(getWH_CD_R());
				m_med.setreadTJOBODRCDSTOCK_PBL_SHIP_QTY(getPBL_SHIP_QTY_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("tblT_JOB_ODR_CD_STOCK", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("tblT_JOB_ODR_CD_STOCK", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	...
	/**
	 * tblT_JOB_ODR_CD_STOCKクラスの標準コンストラクタ
	 *
		 */
	public tblT_JOB_ODR_CD_STOCK(medKU0010B001 med, BatchAppConductor cdr) throws SystemException
	{
