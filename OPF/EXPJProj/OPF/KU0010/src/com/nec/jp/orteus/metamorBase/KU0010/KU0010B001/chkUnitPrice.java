/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KU0010/src/com/nec/jp/orteus/metamorBase/KU0010/KU0010B001/chkUnitPrice.java,v $
 *
...
public class chkUnitPrice extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setIN_EFFPHASEINDATE_R(String value) throws FoundationException { getAdapt_R().setString(4, value); }
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN2_R(m_med.getchkUnitPriceIN_COMPANYCD());
				setIN3_R(m_med.getchkUnitPriceIN_CUSTCD());
				setIN4_R(m_med.getchkUnitPriceIN_ITEMCD());
				setIN_EFFPHASEINDATE_R(m_med.getchkUnitPriceIN_EFFPHASEINDATE());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("chkUnitPrice", "read", "レコード検索条件設定処理失敗");
		...
		public String getUNIT_COST_R() throws FoundationException { return m_doRs.getString(1); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setchkUnitPriceUNIT_COST(getUNIT_COST_R());
				m_med.setchkUnitPriceEFF_PHASE_IN_DATE(getEFF_PHASE_IN_DATE_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("chkUnitPrice", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("chkUnitPrice", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	...
	/**
	 * chkUnitPriceクラスの標準コンストラクタ
	 *
		 */
	public chkUnitPrice(medKU0010B001 med, BatchAppConductor cdr) throws SystemException
	{
