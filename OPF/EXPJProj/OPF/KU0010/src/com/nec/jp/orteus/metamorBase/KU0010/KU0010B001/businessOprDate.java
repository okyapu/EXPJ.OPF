/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KU0010/src/com/nec/jp/orteus/metamorBase/KU0010/KU0010B001/businessOprDate.java,v $
 *
...
public class businessOprDate extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN3_R(m_med.getoprDateIN_PLANTCD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("businessOprDate", "read", "レコード検索条件設定処理失敗");
		...
		public String getBUSINESS_OPR_DATE_R() throws FoundationException { return m_doRs.getString(2); }
		public String getSTOCK_CRITERION_DATE_R() throws FoundationException { return m_doRs.getString(3); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setoprDatePLANT_CD(getPLANT_CD_R());
				m_med.setoprDateBUSINESS_OPR_DATE(getBUSINESS_OPR_DATE_R());
				m_med.setoprDateSTOCK_CRITERION_DATE(getSTOCK_CRITERION_DATE_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("businessOprDate", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("businessOprDate", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	...
	/**
	 * businessOprDateクラスの標準コンストラクタ
	 *
		 */
	public businessOprDate(medKU0010B001 med, BatchAppConductor cdr) throws SystemException
	{
