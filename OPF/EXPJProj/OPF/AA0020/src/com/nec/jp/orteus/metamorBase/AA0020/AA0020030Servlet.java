...
public class AA0020030Servlet extends HttpServlet
{
	 ...
	 * @param control AA0020030Controlクラスインスタンス
	 */
...
//			e.printStackTrace();
	...
	public static String DEFAULT_TARGET = "/AA0020030.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAA0020030Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAA0020030Struct";   // JSP先のバインド名(Struct)の指定
