/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AA0020/src/com/nec/jp/orteus/metamorBase/AA0020/AA0020010Entity.java,v $
 *
...
public class AA0020010Entity extends DataObject
{
	...
	// selectM_PS_set_dateクラス インスタンス
	public selectM_PS_set_date mselectM_PS_set_date = new selectM_PS_set_date();
...
+"";		//////////////////////////////
	...
	public class ei_CSVOut extends DataObject
	{
		...
		String m_write_fname="AA0020010.csv";

		protected WriteCsv m_writer=null;		// csv書込み用

		String m_ProjName="AA0020010";
...
+"  and M_PS.\"COMP_ITEM_CD\" = ?";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AA0020010Struct data) throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AA0020010Struct data, String replaceStr)
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AA0020010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AA0020010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AA0020010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AA0020010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(PreparedStatement stmt, AA0020010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public PreparedStatement prepare(Connection conn, String query, AA0020010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt;
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public ResultSet executeQuery(PreparedStatement stmt, AA0020010Struct data) throws FoundationException, SQLException
		{
			int no=1;
		 ...
		 * レコードデータをStructに格納して返します
		 */
		public AA0020010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			if(rs.next()==false) return null;

			AA0020010Struct data = new AA0020010Struct();
			...
			data.setCOMP_MANHOUR_TYP( getString(21, rs) );
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(IDbConnection conn, AA0020010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(Connection conn, AA0020010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(IDbConnection conn, AA0020010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(Connection conn, AA0020010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(PreparedStatement stmt, AA0020010Struct data) throws FoundationException, SQLException
		{
			ResultSet rs=executeQuery(stmt, data);
			boolean ret=true;
	 ...
	 * Entity定義 静的SQL
	 */
	public class selectM_PS_set_date extends DataObject
	{
		protected String m_selcmd = "select "
+"  M_PS.\"PARENT_ITEM_CD\" as \"PARENT_ITEM_CD\", "
+"  M_PS.\"COMP_ITEM_CD\" as \"COMP_ITEM_CD\", "
...
+"  and M_PS.\"EFF_PHASE_OUT_DATE\" >= TO_DATE(?)";
		...
		//{{user_implement_dev:selectM_PS_set_date_def
                //}}user_implement_dev:selectM_PS_set_date_def
		...
		public List read(Connection conn, AA0020010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectM_PS_set_date_read
                        if(m_selcmd==null) throw new FoundationException("selectM_PS_set_date", "read", "クエリー未登録");
		...
		public List read(Connection conn, AA0020010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectM_PS_set_date_read2
			if(m_selcmd==null) throw new FoundationException("selectM_PS_set_date", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AA0020010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectM_PS_set_date_read3
			if(m_selcmd==null) throw new FoundationException("selectM_PS_set_date", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public ResultSet executeQuery(PreparedStatement stmt, AA0020010Struct data) throws FoundationException, SQLException
		{
			...
			// 静的SQL文の生成
			setString(no ++, data.getEFF_PHASE_OUT_DATE(), stmt);
		...
		public boolean hasRecord(Connection conn, AA0020010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("selectM_PS_set_date", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AA0020010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:selectM_PS_set_date_check
                        PreparedStatement stmt;
                        ...
                        if(m_chkcmd!=null) {
                         ...
                         throw new FoundationException("selectM_PS_set_date", "check", "クエリー未登録");
                        }
		...
		public void clear()
		{
			//{{user_implement_dev:selectM_PS_set_date_clear
                        //}}user_implement_dev:selectM_PS_set_date_clear
		...
		/**
		 * selectM_PS_set_dateクラスの標準コンストラクタ
		 */
		public selectM_PS_set_date()
		{
			//{{user_implement_dev:selectM_PS_set_date_constractor
                        //}}user_implement_dev:selectM_PS_set_date_constractor
...
+"  (?, ?, ?, TO_NUMBER(?), TO_NUMBER(?), TO_DATE(?), TO_DATE(?), TO_NUMBER(?), ?, ?, TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), ?, ?)";
		...
		protected String m_sCreateProgramName="AA0020010";
		protected String m_sUpdateProgramName="AA0020010";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int create(IDbConnection conn, AA0020010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int create(Connection conn, AA0020010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt=null;
			...
			try {
				...
				setInteger(15, data.gets_CONS_TYP(), stmt);
				setInteger(16, data.getPS_LT_FLG(), stmt);
				...
				setInteger(21, data.gets_COST_UP_TYP(), stmt);
				setInteger(22, data.gets_MRP_EXP_TYP(), stmt);
...
+"  and M_PS.\"PS_EDITION\" = ?";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int update(IDbConnection conn, AA0020010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int update(Connection conn, AA0020010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt=null;
			int modifyCount;
			...
			try {
				...
				setString(4, data.getPS_UNIT_DENOMINATOR(), stmt);
				setString(5, data.getPS_UNIT_NUMERATOR(), stmt);
				setString(6, data.getEFF_PHASE_IN_DATE(), stmt);
				setString(7, data.getEFF_PHASE_OUT_DATE(), stmt);
				setString(8, data.getPS_SPOIL(), stmt);
				setInteger(9, data.gets_CONS_TYP(), stmt);
				setInteger(10, data.getPS_LT_FLG(), stmt);
				setString(11, data.getPS_FIXED_LT(), stmt);
				setString(12, data.getPS_PROP_LT(), stmt);
				setString(13, data.getPS_PROP_LOT_SIZE(), stmt);
				setString(14, data.getPS_REF_NO(), stmt);
				setInteger(15, data.gets_COST_UP_TYP(), stmt);
				setInteger(16, data.gets_MRP_EXP_TYP(), stmt);
				setString(17, data.getPARENT_ITEM_CD(), stmt);
				setString(18, data.getCOMP_ITEM_CD(), stmt);
				setString(19, data.getPS_EDITION(), stmt);
...
+"  and M_PS.\"PS_EDITION\" = ?";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int delete(IDbConnection conn, AA0020010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int delete(Connection conn, AA0020010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt=null;
...
+"  M_ITEM.\"ITEM_CD\" = ?";
		...
		public AA0020010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setCOMP_MANHOUR_TYP( getString(4, rs) );
...
+"  SYS_DATE_CTRL.\"PLANT_CD\" = ?";
	...
	public void clear()
	{
		mselectM_PS.clear();
		mselectM_PS = null;
		mselectM_PS_set_date.clear();
		mselectM_PS_set_date = null;
	 ...
	 */
	public AA0020010Entity() throws FoundationException
	{
