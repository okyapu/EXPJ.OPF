/**
 * CLASS     : AA0170Common クラス
 * 製品構成メンテナンスで使用する静的な初期値を定義
 * @author $Author: wang-derui $
 * @version $Revision: 1.1.1.1 $ $Date: 2008/03/26 06:51:28 $
 *
 */
...
class AA0170Common
{
	...
	/** 原価積上区分 */
	final static String _COST_UP_TYP             = new String("1");

	/** 所要量展開区分 */
	final static String _MRP_EXP_TYP             = new String("1");
