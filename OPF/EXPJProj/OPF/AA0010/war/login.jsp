...
<HEAD>
  ...
  <script type="text/javascript">
	...
	function chkBrowser() {
	  var brwInfo = com.nec.jp.orteus.utils.ClientInfo.browser;
	  if (brwInfo.isMSIE) {
	    if (brwInfo.version === 11) {
	      return;
	    }
	  } else if (brwInfo.isChrome) {
	    return;
	  } else if (brwInfo.isEdge) {
	    return;
	  }
	  alert('System Requirements: InternetExplorer11, Chrome or Edge');
	}
  </SCRIPT>
<% 
...
<BODY BGCOLOR="#FFFFFF" LEFTMARGIN=0 TOPMARGIN=0 marginheight='0' marginwidth='0' onLoad="chkBrowser();setfocus();">
  <CENTER>
...
-->
	<noscript>
	  <div style="color:#FF0000;">Error: Script is invalid.</div>
	</noscript>
