/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AF0050/src/com/nec/jp/orteus/metamorBase/AF0050/AF0050010Servlet.java,v $
 *
...
public class AF0050010Servlet extends HttpServlet
{
	 ...
	 * @param control AF0050010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AF0050010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AF0050010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AF0050010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AF0050010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AF0050010Entity entity = control.entity;
		AF0050010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AF0050010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
//			objMessage.m_writer.write( Level.ALL, "AF0050010"+" $Revision: 1.12 $" );
			control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AF0050010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AF0050010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AF0050010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AF0050");
		logger.entering("AF0050010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
		...
		//---------------------------------------------------------------------
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AF0050010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickselect(
					...
					HttpSession so,
					Hashtable params,
					AF0050010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AF0050010Entity entity = control.entity;
		AF0050010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AF0050");
		logger.entering("AF0050010Servlet"+":USER="+request.getRemoteUser(),"onClickselect");
		...
		//---------------------------------------------------------------------
                //}}user_implement_dev:<onClickselect>
		logger.exiting("AF0050010Servlet"+":USER="+request.getRemoteUser(),"onClickselect");
					...
					AF0050010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AF0050");
		logger.entering("AF0050010Servlet"+":USER="+request.getRemoteUser(),"onClickinsert");
		...
		//---------------------------------------------------------------------
                //}}user_implement_dev:<onClickinsert>
		logger.exiting("AF0050010Servlet"+":USER="+request.getRemoteUser(),"onClickinsert");
					...
					AF0050010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AF0050");
		logger.entering("AF0050010Servlet"+":USER="+request.getRemoteUser(),"onClickclear");
		...
		//---------------------------------------------------------------------
                //}}user_implement_dev:<onClickclear>
		logger.exiting("AF0050010Servlet"+":USER="+request.getRemoteUser(),"onClickclear");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AF0050010Struct struct)
	{
		...
		String[] w_IN_PLANT_CD = ((params.containsKey("w_IN_PLANT_CD")) ? (String[])params.get("w_IN_PLANT_CD") : (String[])null);
		String[] h_TRANSFER = ((params.containsKey("h_TRANSFER")) ? (String[])params.get("h_TRANSFER") : (String[])null);
		String[] w_IN_WH_CD = ((params.containsKey("w_IN_WH_CD")) ? (String[])params.get("w_IN_WH_CD") : (String[])null);
		String[] w_PLANT_NAME = ((params.containsKey("w_PLANT_NAME")) ? (String[])params.get("w_PLANT_NAME") : (String[])null);
		String[] w_IN_WH_NAME = ((params.containsKey("w_IN_WH_NAME")) ? (String[])params.get("w_IN_WH_NAME") : (String[])null);
		String[] c_JOB_ODR = ((params.containsKey("c_JOB_ODR")) ? (String[])params.get("c_JOB_ODR") : (String[])null);
		String[] c_TRANSFER = ((params.containsKey("c_TRANSFER")) ? (String[])params.get("c_TRANSFER") : (String[])null);
		String[] STOCK_UNIT = ((params.containsKey("STOCK_UNIT")) ? (String[])params.get("STOCK_UNIT") : (String[])null);
		String[] NON_ALC_QTY = ((params.containsKey("NON_ALC_QTY")) ? (String[])params.get("NON_ALC_QTY") : (String[])null);
		String[] c_i_JOB_ODR = ((params.containsKey("c_i_JOB_ODR")) ? (String[])params.get("c_i_JOB_ODR") : (String[])null);
		...
		struct.setw_IN_PLANT_CD( ((w_IN_PLANT_CD == null) ? (String)null : w_IN_PLANT_CD[0]) );
		struct.setList_w_IN_PLANT_CD(TypeConverter.convert(w_IN_PLANT_CD));
		if( (h_TRANSFER == null)||("".equals(h_TRANSFER[0])) ) {
		   struct.seth_TRANSFER( (Integer)null );
		} else {
		   struct.seth_TRANSFER( new Integer(h_TRANSFER[0]) );
		   struct.setList_h_TRANSFER(TypeConverter.convert(h_TRANSFER));
		}
		struct.setw_IN_WH_CD( ((w_IN_WH_CD == null) ? (String)null : w_IN_WH_CD[0]) );
		struct.setList_w_IN_WH_CD(TypeConverter.convert(w_IN_WH_CD));
		...
		struct.setw_IN_WH_NAME( ((w_IN_WH_NAME == null) ? (String)null : w_IN_WH_NAME[0]) );
		struct.setList_w_IN_WH_NAME(TypeConverter.convert(w_IN_WH_NAME));
		struct.setc_JOB_ODR( ((c_JOB_ODR == null) ? (String)null : c_JOB_ODR[0]) );
		struct.setList_c_JOB_ODR(TypeConverter.convert(c_JOB_ODR));
		struct.setc_TRANSFER( ((c_TRANSFER == null) ? (String)null : c_TRANSFER[0]) );
		struct.setList_c_TRANSFER(TypeConverter.convert(c_TRANSFER));
		struct.setSTOCK_UNIT( ((STOCK_UNIT == null) ? (String)null : STOCK_UNIT[0]) );
		struct.setList_STOCK_UNIT(TypeConverter.convert(STOCK_UNIT));
		struct.setNON_ALC_QTY( ((NON_ALC_QTY == null) ? (String)null : NON_ALC_QTY[0]) );
		struct.setList_NON_ALC_QTY(TypeConverter.convert(NON_ALC_QTY));
		struct.setc_i_JOB_ODR( ((c_i_JOB_ODR == null) ? (String)null : c_i_JOB_ODR[0]) );
		struct.setList_c_i_JOB_ODR(TypeConverter.convert(c_i_JOB_ODR));
	...
	public static String DEFAULT_TARGET = "/AF0050010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAF0050010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAF0050010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AF0050");
		logger.entering("AF0050010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AF0050010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AF0050010Control control;
		AF0050010Entity  entity = null;
		AF0050010Struct  struct = null;
		...
		try {
			...
			if( (control = (AF0050010Control)so.getAttribute("AF0050010Control_"+request.getSession(false).getId())) == null ) {
				control = new AF0050010Control();
			...
			try {
				...
				so.setAttribute("AF0050010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.AF0050.AF0050010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AF0050010Servlet()
	{
		//{{user_implement_dev:<AF0050010_DisConnect_FLG>
		...
		//{{user_implement_dev:<AF0050010Servlet>
                //}}user_implement_dev:<AF0050010Servlet>
	}
