/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DC0020/src/com/nec/jp/orteus/metamorBase/DC0020/DC0020B001/SYS_CS_CALC_CTRL_Stop.java,v $
 *
...
/**
 * CLASS     : SYS_CS_CALC_CTRL_Stop クラス
 * ファイル・クラス説明
...
public class SYS_CS_CALC_CTRL_Stop extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int update() throws BatchAppException
		{
			try {
				...
				setIN0_U(m_med.getPLANT_CD());
				setIN1_U(m_med.getYEAR());
				setIN2_U(m_med.getHALF_TERM_TYP());
				setIN3_U(m_med.getCOST_TYP());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("SYS_CS_CALC_CTRL_Stop", "update", "レコード更新条件設定処理失敗");
	...
	void prepareAll() throws BatchAppException
	{
		...
		try {
			...
			BatchAppException be=new BatchAppException("SYS_CS_CALC_CTRL_Stop", "prepareALL(FoundationException)", "SQL文のprepareで失敗しました");
			be.addMessage(e.getErrmsg());
			throw be;
		} catch(SQLException e) {
			BatchAppException be=new BatchAppException("SYS_CS_CALC_CTRL_Stop", "prepareALL(SQLException)", "SQL文のprepareで失敗しました");
			throw be;
		}
	...
	/**
	 * SYS_CS_CALC_CTRL_Stopクラスの標準コンストラクタ
	 *
		 */
	public SYS_CS_CALC_CTRL_Stop(medDC0020B001 med, BatchAppConductor cdr) throws SystemException
	{
