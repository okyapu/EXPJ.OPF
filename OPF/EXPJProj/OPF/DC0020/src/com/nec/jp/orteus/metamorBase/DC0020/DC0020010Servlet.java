/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DC0020/src/com/nec/jp/orteus/metamorBase/DC0020/DC0020010Servlet.java,v $
 *
...
public class DC0020010Servlet extends HttpServlet
{
	 ...
	 * @param control DC0020010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, DC0020010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control DC0020010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, DC0020010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					DC0020010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		DC0020010Entity entity = control.entity;
		DC0020010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("DC0020010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
                 // TODO: ユーザ定義のコードを記述してください
              //			objMessage.m_writer.write( Level.ALL, "DC0020010"+" $Revision: 1.5 $" );
                 control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("DC0020010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					DC0020010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		DC0020010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.DC0020");
		logger.entering("DC0020010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
		...
		//{{user_implement_dev:<reloadEvent>
              ...
              //			e.printStackTrace();
              //			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("DC0020010-E999","リロード処理"));
                 ExpjException ee = new ExpjException(e, "ZZ01106");
                 throw ee;
                }
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("DC0020010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickSelect(
					...
					HttpSession so,
					Hashtable params,
					DC0020010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		DC0020010Entity entity = control.entity;
		DC0020010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.DC0020");
		logger.entering("DC0020010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
		//{{user_implement_dev:<onClickSelect>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickSelect>
		logger.exiting("DC0020010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
					...
					DC0020010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.DC0020");
		logger.entering("DC0020010Servlet"+":USER="+request.getRemoteUser(),"onClickExecute");
		//{{user_implement_dev:<onClickExecute>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickExecute>
		logger.exiting("DC0020010Servlet"+":USER="+request.getRemoteUser(),"onClickExecute");
					...
					DC0020010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.DC0020");
		logger.entering("DC0020010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
		//{{user_implement_dev:<onClickClear>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("DC0020010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, DC0020010Struct struct)
	{
	...
	public static String DEFAULT_TARGET = "/DC0020010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aDC0020010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aDC0020010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.DC0020");
		logger.entering("DC0020010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("DC0020010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		DC0020010Control control;
		DC0020010Entity  entity = null;
		DC0020010Struct  struct = null;
		...
		try {
			...
			if( (control = (DC0020010Control)so.getAttribute("DC0020010Control_"+request.getSession(false).getId())) == null ) {
				control = new DC0020010Control();
			...
			try {
				...
				so.setAttribute("DC0020010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.DC0020.DC0020010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public DC0020010Servlet()
	{
		//{{user_implement_dev:<DC0020010_DisConnect_FLG>
		...
		//{{user_implement_dev:<DC0020010Servlet>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<DC0020010Servlet>
	}
