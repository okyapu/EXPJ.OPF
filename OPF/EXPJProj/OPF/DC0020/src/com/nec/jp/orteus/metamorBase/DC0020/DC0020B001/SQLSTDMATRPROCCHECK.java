/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DC0020/src/com/nec/jp/orteus/metamorBase/DC0020/DC0020B001/SQLSTDMATRPROCCHECK.java,v $
 *
...
public class SQLSTDMATRPROCCHECK extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public List call() throws BatchAppException
		{
			try {
				...
				e.printStackTrace();
				BatchAppException be=new BatchAppException("SQLSTDMATRPROCCHECK", "call", "Stored Procedure条件設定処理失敗");
				...
				if (cstmt != null) {
					try {
						...
						ef.printStackTrace();
						BatchAppException bef = new BatchAppException("SQLSTDMATRPROCCHECK", "call", "Stored Procedureクローズ処理失敗");
	...
	/**
	 * SQLSTDMATRPROCCHECKクラスの標準コンストラクタ
	 *
		 */
	public SQLSTDMATRPROCCHECK(medDC0020B001 med, BatchAppConductor cdr) throws SystemException
	{
	...
	protected static String m_calcmd = "{" + "call SQLSTDMATRPROCCHECK(?, ?, ?, ?, ?, ?, ?, to_number(?), to_number(?), to_number(?), to_number(?), ?)" + "}";
