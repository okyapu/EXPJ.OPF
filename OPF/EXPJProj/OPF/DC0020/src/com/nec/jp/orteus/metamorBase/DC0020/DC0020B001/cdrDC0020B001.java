/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DC0020/src/com/nec/jp/orteus/metamorBase/DC0020/DC0020B001/cdrDC0020B001.java,v $
 *
...
public class cdrDC0020B001 extends Object
		implements IBatchAppCommon
{
	...
	public void initialize() throws BatchAppException, SystemException
	{
		try {
			...
			m_med.setSQLSTDMATRPROCCHECK( new SQLSTDMATRPROCCHECK(m_med, m_conductor) );
			...
			m_conductor.addObject( m_med.getSQLSTDMATRPROCCHECK() );
	...
	public int getType() { return m_conductor.getType(); }
        ...
        public int beginProc() throws BatchAppException
        {
         try {
          ...
          setCommitFlag(false);
          BatchAppException be=new BatchAppException("cdrDC0020B001", "beginProc", "conductorの初期処理に失敗しました");
	...
	medDC0020B001 m_med=new medDC0020B001();

	// BatchAppConductorクラスインスタンス
	BatchAppConductor m_conductor=new BatchAppConductor("DC0020B001");
	...
	/**
	 * ctrDC0020B001クラス 標準コンストラクタ
	 *
		 */
	public cdrDC0020B001() throws BatchAppException
	{
		initialize();
