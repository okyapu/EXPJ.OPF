/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DC0020/src/com/nec/jp/orteus/metamorBase/DC0020/DC0020B001/T_CS_PS_T.java,v $
 *
...
public class T_CS_PS_T extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		{
			try {
				setIN0_D(m_med.getPLANT_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("T_CS_PS_T", "delete", "レコード削除条件設定処理失敗");
	...
	/**
	 * T_CS_PS_Tクラスの標準コンストラクタ
	 *
		 */
	public T_CS_PS_T(medDC0020B001 med, BatchAppConductor cdr) throws SystemException
	{
