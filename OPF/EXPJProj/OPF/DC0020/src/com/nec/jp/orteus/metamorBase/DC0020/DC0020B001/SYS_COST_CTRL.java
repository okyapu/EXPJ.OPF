/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DC0020/src/com/nec/jp/orteus/metamorBase/DC0020/DC0020B001/SYS_COST_CTRL.java,v $
 *
...
public class SYS_COST_CTRL extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setCURRENT_YEAR(getCURRENT_YEAR_R());
	 ...
	 *
		 */
	public SYS_COST_CTRL(medDC0020B001 med, BatchAppConductor cdr) throws SystemException
	{
