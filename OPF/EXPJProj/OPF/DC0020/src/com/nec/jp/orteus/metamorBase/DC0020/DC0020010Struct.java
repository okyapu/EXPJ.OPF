/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DC0020/src/com/nec/jp/orteus/metamorBase/DC0020/DC0020010Struct.java,v $
 *
...
public class DC0020010Struct extends DataStruct
{
	...
	public int setL2L_HALF_TERM_TYP_name(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_HALF_TERM_TYP_name.add(((DC0020010Struct) list.get(i)).getHALF_TERM_TYP_name());
		}
		return size;
	}
	public int setL2L_HALF_TERM_TYP_val(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_HALF_TERM_TYP_val.add(((DC0020010Struct) list.get(i)).getHALF_TERM_TYP_val());
		}
		return size;
	}
	public int setL2L_CS_CALC_PROC_NO_DN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CS_CALC_PROC_NO_DN.add(((DC0020010Struct) list.get(i)).getCS_CALC_PROC_NO_DN());
		}
		return size;
	}
	public int setL2L_r1_ExecuteType(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_r1_ExecuteType.add(((DC0020010Struct) list.get(i)).getr1_ExecuteType());
		}
		return size;
	}
	public int setL2L_r2_ExecuteType(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_r2_ExecuteType.add(((DC0020010Struct) list.get(i)).getr2_ExecuteType());
		}
		return size;
	}
	public int setL2L_EXECUTE_STATUS_TYP_DN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_EXECUTE_STATUS_TYP_DN.add(((DC0020010Struct) list.get(i)).getEXECUTE_STATUS_TYP_DN());
		}
		return size;
	}
	public int setL2L_RESULT_STATUS_TYP_DN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_RESULT_STATUS_TYP_DN.add(((DC0020010Struct) list.get(i)).getRESULT_STATUS_TYP_DN());
		}
		return size;
	}
	public int setL2L_START_TIME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_START_TIME.add(((DC0020010Struct) list.get(i)).getSTART_TIME());
		}
		return size;
	}
	public int setL2L_STOP_TIME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_STOP_TIME.add(((DC0020010Struct) list.get(i)).getSTOP_TIME());
		}
		return size;
	}
	public int setL2L_EXECUTE_STATUS_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_EXECUTE_STATUS_TYP.add(((DC0020010Struct) list.get(i)).getEXECUTE_STATUS_TYP());
		}
		return size;
	}
	public int setL2L_RESULT_STATUS_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_RESULT_STATUS_TYP.add(((DC0020010Struct) list.get(i)).getRESULT_STATUS_TYP());
		}
		return size;
	}
	public int setL2L_CS_CALC_PROC_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CS_CALC_PROC_NO.add(((DC0020010Struct) list.get(i)).getCS_CALC_PROC_NO());
		}
		return size;
	}
	public int setL2L_MODIFY_COUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_MODIFY_COUNT.add(((DC0020010Struct) list.get(i)).getMODIFY_COUNT());
		}
		return size;
	}
	public int setL2L_PLANT_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PLANT_CD.add(((DC0020010Struct) list.get(i)).getPLANT_CD());
		}
		return size;
	}
	public int setL2L_YEAR(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_YEAR.add(((DC0020010Struct) list.get(i)).getYEAR());
		}
		return size;
	}
	public int setL2L_HALF_TERM_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_HALF_TERM_TYP.add(((DC0020010Struct) list.get(i)).getHALF_TERM_TYP());
		}
		return size;
	}
	public int setL2L_CURRENT_YEAR(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CURRENT_YEAR.add(((DC0020010Struct) list.get(i)).getCURRENT_YEAR());
		}
		return size;
	}
	public int setL2L_PLANT_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PLANT_NAME.add(((DC0020010Struct) list.get(i)).getPLANT_NAME());
		}
		return size;
	}
	public int setL2L_EXECUTE_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_EXECUTE_TYP.add(((DC0020010Struct) list.get(i)).getEXECUTE_TYP());
		}
		return size;
	}
	...
	/**
	 * medDC0020010クラスの標準コンストラクタ
	 */
	public DC0020010Struct()
	{
	 ...
	 */
	public void setStruct(DC0020010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructM(DC0020010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructL(DC0020010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
