/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0040/src/com/nec/jp/orteus/metamorBase/AE0040/AE0040010Struct.java,v $
 *
...
public class AE0040010Struct extends DataStruct
{

	//////////////////////////////

	/** 第 1 変数： m_r_OUTPUT_TYPE */
	public String m_r_OUTPUT_TYPE = null;
	/** 第 2 変数： m_r2_OUTPUT_TYPE */
	public String m_r2_OUTPUT_TYPE = null;
	/** 第 3 変数： m_c_REOUTPUT */
	public String m_c_REOUTPUT = null;
	/** 第 4 変数： m_r1_FILTER1 */
	...
	/** 第 8 変数： m_INFO_TYP_CD */
	public String m_INFO_TYP_CD = null;
	/** 第 9 変数： m_COMPANY_CD */
	public String m_COMPANY_CD = null;
	/** 第 10 変数： m_PUCH_ODR_CD */
	public String m_PUCH_ODR_CD = null;
	/** 第 11 変数： m_DATA_PROC_CD */
	public String m_DATA_PROC_CD = null;
	/** 第 12 変数： m_DATA_CREATE_DATE */
	...
	public String getr_OUTPUT_TYPE() { return m_r_OUTPUT_TYPE; }
	public String getr2_OUTPUT_TYPE() { return m_r2_OUTPUT_TYPE; }
	public String getc_REOUTPUT() { return m_c_REOUTPUT; }
	...
	public String getPUCH_ODR_EDI_ISS_DATE() { return m_PUCH_ODR_EDI_ISS_DATE; }
	...
	public List getList_r_OUTPUT_TYPE() { return l_r_OUTPUT_TYPE; }
	public List getList_r2_OUTPUT_TYPE() { return l_r2_OUTPUT_TYPE; }
	public List getList_c_REOUTPUT() { return l_c_REOUTPUT; }
	...
	public List getList_PUCH_ODR_EDI_ISS_DATE() { return l_PUCH_ODR_EDI_ISS_DATE; }
	...
	public void setr_OUTPUT_TYPE(String val) { m_r_OUTPUT_TYPE = val; }
	public void setr2_OUTPUT_TYPE(String val) { m_r2_OUTPUT_TYPE = val; }
	public void setc_REOUTPUT(String val) { m_c_REOUTPUT = val; }
	...
	public void setPUCH_ODR_EDI_ISS_DATE(String val) { m_PUCH_ODR_EDI_ISS_DATE = val; }
	...
	public void setList_r_OUTPUT_TYPE(List list) { l_r_OUTPUT_TYPE = list; }
	public void setList_r2_OUTPUT_TYPE(List list) { l_r2_OUTPUT_TYPE = list; }
	public void setList_c_REOUTPUT(List list) { l_c_REOUTPUT = list; }
	...
	public void setList_PUCH_ODR_EDI_ISS_DATE(List list) { l_PUCH_ODR_EDI_ISS_DATE = list; }
	...
	public int setL2L_r_OUTPUT_TYPE(List list) {
		int size = (list != null) ? list.size() : 0;
		if (size == 0) {
			return 0;
		}
		if (l_r_OUTPUT_TYPE == null) {
			l_r_OUTPUT_TYPE = new ArrayList();
		} else {
			l_r_OUTPUT_TYPE.clear();
		}
		for (int i = 0; i < size; i++) {
			l_r_OUTPUT_TYPE.add(((AE0040010Struct) list.get(i)).getr_OUTPUT_TYPE());
		}
		return size;
	}
	public int setL2L_r2_OUTPUT_TYPE(List list) {
		int size = (list != null) ? list.size() : 0;
		if (size == 0) {
			return 0;
		}
		if (l_r2_OUTPUT_TYPE == null) {
			l_r2_OUTPUT_TYPE = new ArrayList();
		} else {
			l_r2_OUTPUT_TYPE.clear();
		}
		for (int i = 0; i < size; i++) {
			l_r2_OUTPUT_TYPE.add(((AE0040010Struct) list.get(i)).getr2_OUTPUT_TYPE());
		}
		return size;
	}
	public int setL2L_c_REOUTPUT(List list) {
		int size = (list != null) ? list.size() : 0;
		if (size == 0) {
			return 0;
		}
		if (l_c_REOUTPUT == null) {
			l_c_REOUTPUT = new ArrayList();
		} else {
			l_c_REOUTPUT.clear();
		}
		for (int i = 0; i < size; i++) {
			l_c_REOUTPUT.add(((AE0040010Struct) list.get(i)).getc_REOUTPUT());
		}
		return size;
	}
	public int setL2L_r1_FILTER1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_r1_FILTER1.add(((AE0040010Struct) list.get(i)).getr1_FILTER1());
		}
		return size;
	}
	public int setL2L_r2_FILTER1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_r2_FILTER1.add(((AE0040010Struct) list.get(i)).getr2_FILTER1());
		}
		return size;
	}
	public int setL2L_r1_FILTER2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_r1_FILTER2.add(((AE0040010Struct) list.get(i)).getr1_FILTER2());
		}
		return size;
	}
	public int setL2L_r2_FILTER2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_r2_FILTER2.add(((AE0040010Struct) list.get(i)).getr2_FILTER2());
		}
		return size;
	}
	public int setL2L_INFO_TYP_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_INFO_TYP_CD.add(((AE0040010Struct) list.get(i)).getINFO_TYP_CD());
		}
		return size;
	}
	public int setL2L_COMPANY_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_COMPANY_CD.add(((AE0040010Struct) list.get(i)).getCOMPANY_CD());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_CD.add(((AE0040010Struct) list.get(i)).getPUCH_ODR_CD());
		}
		return size;
	}
	public int setL2L_DATA_PROC_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DATA_PROC_CD.add(((AE0040010Struct) list.get(i)).getDATA_PROC_CD());
		}
		return size;
	}
	public int setL2L_DATA_CREATE_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DATA_CREATE_DATE.add(((AE0040010Struct) list.get(i)).getDATA_CREATE_DATE());
		}
		return size;
	}
	public int setL2L_VEND_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_VEND_CD.add(((AE0040010Struct) list.get(i)).getVEND_CD());
		}
		return size;
	}
	public int setL2L_PLANT_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PLANT_CD.add(((AE0040010Struct) list.get(i)).getPLANT_CD());
		}
		return size;
	}
	public int setL2L_JOB_ODR_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_JOB_ODR_CD.add(((AE0040010Struct) list.get(i)).getJOB_ODR_CD());
		}
		return size;
	}
	public int setL2L_CRCT_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CRCT_TYP.add(((AE0040010Struct) list.get(i)).getCRCT_TYP());
		}
		return size;
	}
	public int setL2L_COCK_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_COCK_TYP.add(((AE0040010Struct) list.get(i)).getCOCK_TYP());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_DATE.add(((AE0040010Struct) list.get(i)).getPUCH_ODR_DATE());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_UNIT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_UNIT.add(((AE0040010Struct) list.get(i)).getPUCH_ODR_UNIT());
		}
		return size;
	}
	public int setL2L_UNIT_COST(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_UNIT_COST.add(((AE0040010Struct) list.get(i)).getUNIT_COST());
		}
		return size;
	}
	public int setL2L_UNIT_COST_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_UNIT_COST_TYP.add(((AE0040010Struct) list.get(i)).getUNIT_COST_TYP());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_QTY.add(((AE0040010Struct) list.get(i)).getPUCH_ODR_QTY());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_AMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_AMOUNT.add(((AE0040010Struct) list.get(i)).getPUCH_ODR_AMOUNT());
		}
		return size;
	}
	public int setL2L_EDI_CONS_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_EDI_CONS_TYP.add(((AE0040010Struct) list.get(i)).getEDI_CONS_TYP());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_PERSON(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_PERSON.add(((AE0040010Struct) list.get(i)).getPUCH_ODR_PERSON());
		}
		return size;
	}
	public int setL2L_ITEM_SPEC(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_SPEC.add(((AE0040010Struct) list.get(i)).getITEM_SPEC());
		}
		return size;
	}
	public int setL2L_ITEM_DRAW_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_DRAW_TYP.add(((AE0040010Struct) list.get(i)).getITEM_DRAW_TYP());
		}
		return size;
	}
	public int setL2L_ITEM_VERSION(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_VERSION.add(((AE0040010Struct) list.get(i)).getITEM_VERSION());
		}
		return size;
	}
	public int setL2L_ITEM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_NAME.add(((AE0040010Struct) list.get(i)).getITEM_NAME());
		}
		return size;
	}
	public int setL2L_VEND_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_VEND_ITEM_CD.add(((AE0040010Struct) list.get(i)).getVEND_ITEM_CD());
		}
		return size;
	}
	public int setL2L_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_CD.add(((AE0040010Struct) list.get(i)).getITEM_CD());
		}
		return size;
	}
	public int setL2L_ITEM_DRAW_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_DRAW_QTY.add(((AE0040010Struct) list.get(i)).getITEM_DRAW_QTY());
		}
		return size;
	}
	public int setL2L_ITEM_PKG_UNIT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_PKG_UNIT.add(((AE0040010Struct) list.get(i)).getITEM_PKG_UNIT());
		}
		return size;
	}
	public int setL2L_DIRECT_DLV_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DIRECT_DLV_TYP.add(((AE0040010Struct) list.get(i)).getDIRECT_DLV_TYP());
		}
		return size;
	}
	public int setL2L_WH_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_WH_CD.add(((AE0040010Struct) list.get(i)).getWH_CD());
		}
		return size;
	}
	public int setL2L_ACPT_INSPC_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ACPT_INSPC_TYP.add(((AE0040010Struct) list.get(i)).getACPT_INSPC_TYP());
		}
		return size;
	}
	public int setL2L_DLV_INST_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_INST_TYP.add(((AE0040010Struct) list.get(i)).getDLV_INST_TYP());
		}
		return size;
	}
	public int setL2L_DLV_DATE_1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_DATE_1.add(((AE0040010Struct) list.get(i)).getDLV_DATE_1());
		}
		return size;
	}
	public int setL2L_DLV_INST_QTY_1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_INST_QTY_1.add(((AE0040010Struct) list.get(i)).getDLV_INST_QTY_1());
		}
		return size;
	}
	public int setL2L_DLV_INST_CD_1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_INST_CD_1.add(((AE0040010Struct) list.get(i)).getDLV_INST_CD_1());
		}
		return size;
	}
	public int setL2L_DLV_DATE_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_DATE_2.add(((AE0040010Struct) list.get(i)).getDLV_DATE_2());
		}
		return size;
	}
	public int setL2L_DLV_INST_QTY_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_INST_QTY_2.add(((AE0040010Struct) list.get(i)).getDLV_INST_QTY_2());
		}
		return size;
	}
	public int setL2L_DLV_INST_CD_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_INST_CD_2.add(((AE0040010Struct) list.get(i)).getDLV_INST_CD_2());
		}
		return size;
	}
	public int setL2L_DLV_DATE_3(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_DATE_3.add(((AE0040010Struct) list.get(i)).getDLV_DATE_3());
		}
		return size;
	}
	public int setL2L_DLV_INST_QTY_3(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_INST_QTY_3.add(((AE0040010Struct) list.get(i)).getDLV_INST_QTY_3());
		}
		return size;
	}
	public int setL2L_DLV_INST_CD_3(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_INST_CD_3.add(((AE0040010Struct) list.get(i)).getDLV_INST_CD_3());
		}
		return size;
	}
	public int setL2L_DLV_DATE_4(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_DATE_4.add(((AE0040010Struct) list.get(i)).getDLV_DATE_4());
		}
		return size;
	}
	public int setL2L_DLV_INST_QTY_4(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_INST_QTY_4.add(((AE0040010Struct) list.get(i)).getDLV_INST_QTY_4());
		}
		return size;
	}
	public int setL2L_DLV_INST_CD_4(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_INST_CD_4.add(((AE0040010Struct) list.get(i)).getDLV_INST_CD_4());
		}
		return size;
	}
	public int setL2L_DLV_DATE_5(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_DATE_5.add(((AE0040010Struct) list.get(i)).getDLV_DATE_5());
		}
		return size;
	}
	public int setL2L_DLV_INST_QTY_5(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_INST_QTY_5.add(((AE0040010Struct) list.get(i)).getDLV_INST_QTY_5());
		}
		return size;
	}
	public int setL2L_DLV_INST_CD_5(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_INST_CD_5.add(((AE0040010Struct) list.get(i)).getDLV_INST_CD_5());
		}
		return size;
	}
	public int setL2L_FREE_COLUMN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_FREE_COLUMN.add(((AE0040010Struct) list.get(i)).getFREE_COLUMN());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_COMMENT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_COMMENT.add(((AE0040010Struct) list.get(i)).getPUCH_ODR_COMMENT());
		}
		return size;
	}
	public int setL2L_INCLUDING_TAX_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_INCLUDING_TAX_TYP.add(((AE0040010Struct) list.get(i)).getINCLUDING_TAX_TYP());
		}
		return size;
	}
	public int setL2L_TAX_RELATION_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_RELATION_TYP.add(((AE0040010Struct) list.get(i)).getTAX_RELATION_TYP());
		}
		return size;
	}
	public int setL2L_TAX_AMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_AMOUNT.add(((AE0040010Struct) list.get(i)).getTAX_AMOUNT());
		}
		return size;
	}
	public int setL2L_NET_AMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_NET_AMOUNT.add(((AE0040010Struct) list.get(i)).getNET_AMOUNT());
		}
		return size;
	}
	public int setL2L_RESERVE_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_RESERVE_CD.add(((AE0040010Struct) list.get(i)).getRESERVE_CD());
		}
		return size;
	}
	public int setL2L_COST_PLAN_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_COST_PLAN_CD.add(((AE0040010Struct) list.get(i)).getCOST_PLAN_CD());
		}
		return size;
	}
	public int setL2L_STL_COND_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_STL_COND_TYP.add(((AE0040010Struct) list.get(i)).getSTL_COND_TYP());
		}
		return size;
	}
	public int setL2L_END_USER_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_END_USER_NAME.add(((AE0040010Struct) list.get(i)).getEND_USER_NAME());
		}
		return size;
	}
	public int setL2L_DLV_ADDRESS_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_ADDRESS_CD.add(((AE0040010Struct) list.get(i)).getDLV_ADDRESS_CD());
		}
		return size;
	}
	public int setL2L_DLV_ADDRESS(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_ADDRESS.add(((AE0040010Struct) list.get(i)).getDLV_ADDRESS());
		}
		return size;
	}
	public int setL2L_DLV_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_NAME.add(((AE0040010Struct) list.get(i)).getDLV_NAME());
		}
		return size;
	}
	public int setL2L_END_USER_ITEM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_END_USER_ITEM_NAME.add(((AE0040010Struct) list.get(i)).getEND_USER_ITEM_NAME());
		}
		return size;
	}
	public int setL2L_END_USER_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_END_USER_ITEM_CD.add(((AE0040010Struct) list.get(i)).getEND_USER_ITEM_CD());
		}
		return size;
	}
	public int setL2L_END_USER_ODR_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_END_USER_ODR_CD.add(((AE0040010Struct) list.get(i)).getEND_USER_ODR_CD());
		}
		return size;
	}
	public int setL2L_MAKER_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_MAKER_NAME.add(((AE0040010Struct) list.get(i)).getMAKER_NAME());
		}
		return size;
	}
	public int setL2L_DLV_KEY_CD_1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_KEY_CD_1.add(((AE0040010Struct) list.get(i)).getDLV_KEY_CD_1());
		}
		return size;
	}
	public int setL2L_DLV_KEY_CD_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_KEY_CD_2.add(((AE0040010Struct) list.get(i)).getDLV_KEY_CD_2());
		}
		return size;
	}
	public int setL2L_DLV_KEY_CD_3(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_KEY_CD_3.add(((AE0040010Struct) list.get(i)).getDLV_KEY_CD_3());
		}
		return size;
	}
	public int setL2L_DLV_KEY_CD_4(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_KEY_CD_4.add(((AE0040010Struct) list.get(i)).getDLV_KEY_CD_4());
		}
		return size;
	}
	public int setL2L_DLV_KEY_CD_5(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_KEY_CD_5.add(((AE0040010Struct) list.get(i)).getDLV_KEY_CD_5());
		}
		return size;
	}
	public int setL2L_WH_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_WH_NAME.add(((AE0040010Struct) list.get(i)).getWH_NAME());
		}
		return size;
	}
	public int setL2L_PUCH_BCODE_INF(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_BCODE_INF.add(((AE0040010Struct) list.get(i)).getPUCH_BCODE_INF());
		}
		return size;
	}
	public int setL2L_PUCH_COMMENT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_COMMENT.add(((AE0040010Struct) list.get(i)).getPUCH_COMMENT());
		}
		return size;
	}
	public int setL2L_CONTRACT_COND_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CONTRACT_COND_TYP.add(((AE0040010Struct) list.get(i)).getCONTRACT_COND_TYP());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_SHAP_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_SHAP_TYP.add(((AE0040010Struct) list.get(i)).getPUCH_ODR_SHAP_TYP());
		}
		return size;
	}
	public int setL2L_OWNER_ODR_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OWNER_ODR_CD.add(((AE0040010Struct) list.get(i)).getOWNER_ODR_CD());
		}
		return size;
	}
	public int setL2L_QTY_CONTRACT_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_QTY_CONTRACT_TYP.add(((AE0040010Struct) list.get(i)).getQTY_CONTRACT_TYP());
		}
		return size;
	}
	public int setL2L_ODR_MODIFY_TYP_1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ODR_MODIFY_TYP_1.add(((AE0040010Struct) list.get(i)).getODR_MODIFY_TYP_1());
		}
		return size;
	}
	public int setL2L_ODR_MODIFY_TYP_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ODR_MODIFY_TYP_2.add(((AE0040010Struct) list.get(i)).getODR_MODIFY_TYP_2());
		}
		return size;
	}
	public int setL2L_ODR_MODIFY_TYP_3(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ODR_MODIFY_TYP_3.add(((AE0040010Struct) list.get(i)).getODR_MODIFY_TYP_3());
		}
		return size;
	}
	public int setL2L_MACHINE_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_MACHINE_CD.add(((AE0040010Struct) list.get(i)).getMACHINE_CD());
		}
		return size;
	}
	public int setL2L_ENGINNERING_CHG_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ENGINNERING_CHG_CD.add(((AE0040010Struct) list.get(i)).getENGINNERING_CHG_CD());
		}
		return size;
	}
	public int setL2L_ITEM_DRAW_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_DRAW_CD.add(((AE0040010Struct) list.get(i)).getITEM_DRAW_CD());
		}
		return size;
	}
	public int setL2L_DLV_DOC_FORM_1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_DOC_FORM_1.add(((AE0040010Struct) list.get(i)).getDLV_DOC_FORM_1());
		}
		return size;
	}
	public int setL2L_DLV_DOC_COPY_NUM_1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_DOC_COPY_NUM_1.add(((AE0040010Struct) list.get(i)).getDLV_DOC_COPY_NUM_1());
		}
		return size;
	}
	public int setL2L_DLV_DOC_LANG_1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_DOC_LANG_1.add(((AE0040010Struct) list.get(i)).getDLV_DOC_LANG_1());
		}
		return size;
	}
	public int setL2L_DLV_DOC_FORM_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_DOC_FORM_2.add(((AE0040010Struct) list.get(i)).getDLV_DOC_FORM_2());
		}
		return size;
	}
	public int setL2L_DLV_DOC_COPY_NUM_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_DOC_COPY_NUM_2.add(((AE0040010Struct) list.get(i)).getDLV_DOC_COPY_NUM_2());
		}
		return size;
	}
	public int setL2L_DLV_DOC_LANG_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_DOC_LANG_2.add(((AE0040010Struct) list.get(i)).getDLV_DOC_LANG_2());
		}
		return size;
	}
	public int setL2L_DLV_DOC_FORM_3(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_DOC_FORM_3.add(((AE0040010Struct) list.get(i)).getDLV_DOC_FORM_3());
		}
		return size;
	}
	public int setL2L_DLV_DOC_COPY_NUM_3(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_DOC_COPY_NUM_3.add(((AE0040010Struct) list.get(i)).getDLV_DOC_COPY_NUM_3());
		}
		return size;
	}
	public int setL2L_DLV_DOC_LANG_3(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_DOC_LANG_3.add(((AE0040010Struct) list.get(i)).getDLV_DOC_LANG_3());
		}
		return size;
	}
	public int setL2L_DLV_DOC_FORM_4(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_DOC_FORM_4.add(((AE0040010Struct) list.get(i)).getDLV_DOC_FORM_4());
		}
		return size;
	}
	public int setL2L_DLV_DOC_COPY_NUM_4(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_DOC_COPY_NUM_4.add(((AE0040010Struct) list.get(i)).getDLV_DOC_COPY_NUM_4());
		}
		return size;
	}
	public int setL2L_DLV_DOC_LANG_4(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_DOC_LANG_4.add(((AE0040010Struct) list.get(i)).getDLV_DOC_LANG_4());
		}
		return size;
	}
	public int setL2L_STRATEGIC_GOODS_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_STRATEGIC_GOODS_TYP.add(((AE0040010Struct) list.get(i)).getSTRATEGIC_GOODS_TYP());
		}
		return size;
	}
	public int setL2L_ORGN_PLACE_CD_1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ORGN_PLACE_CD_1.add(((AE0040010Struct) list.get(i)).getORGN_PLACE_CD_1());
		}
		return size;
	}
	public int setL2L_ORGN_PLACE_CD_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ORGN_PLACE_CD_2.add(((AE0040010Struct) list.get(i)).getORGN_PLACE_CD_2());
		}
		return size;
	}
	public int setL2L_ORGN_PLACE_CD_3(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ORGN_PLACE_CD_3.add(((AE0040010Struct) list.get(i)).getORGN_PLACE_CD_3());
		}
		return size;
	}
	public int setL2L_ORGN_PLACE_CD_4(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ORGN_PLACE_CD_4.add(((AE0040010Struct) list.get(i)).getORGN_PLACE_CD_4());
		}
		return size;
	}
	public int setL2L_ORGN_PLACE_CD_5(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ORGN_PLACE_CD_5.add(((AE0040010Struct) list.get(i)).getORGN_PLACE_CD_5());
		}
		return size;
	}
	public int setL2L_DLV_TIME_1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_TIME_1.add(((AE0040010Struct) list.get(i)).getDLV_TIME_1());
		}
		return size;
	}
	public int setL2L_DLV_TIME_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_TIME_2.add(((AE0040010Struct) list.get(i)).getDLV_TIME_2());
		}
		return size;
	}
	public int setL2L_DLV_TIME_3(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_TIME_3.add(((AE0040010Struct) list.get(i)).getDLV_TIME_3());
		}
		return size;
	}
	public int setL2L_DLV_TIME_4(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_TIME_4.add(((AE0040010Struct) list.get(i)).getDLV_TIME_4());
		}
		return size;
	}
	public int setL2L_DLV_TIME_5(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_TIME_5.add(((AE0040010Struct) list.get(i)).getDLV_TIME_5());
		}
		return size;
	}
	public int setL2L_PACKAGE_DLV_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PACKAGE_DLV_CD.add(((AE0040010Struct) list.get(i)).getPACKAGE_DLV_CD());
		}
		return size;
	}
	public int setL2L_ODR_ITEM_SPEC(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ODR_ITEM_SPEC.add(((AE0040010Struct) list.get(i)).getODR_ITEM_SPEC());
		}
		return size;
	}
	public int setL2L_ODR_ORG_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ODR_ORG_NAME.add(((AE0040010Struct) list.get(i)).getODR_ORG_NAME());
		}
		return size;
	}
	public int setL2L_DLV_PART_LEN_1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_PART_LEN_1.add(((AE0040010Struct) list.get(i)).getDLV_PART_LEN_1());
		}
		return size;
	}
	public int setL2L_DLV_PART_QTY_1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_PART_QTY_1.add(((AE0040010Struct) list.get(i)).getDLV_PART_QTY_1());
		}
		return size;
	}
	public int setL2L_DLV_PART_LEN_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_PART_LEN_2.add(((AE0040010Struct) list.get(i)).getDLV_PART_LEN_2());
		}
		return size;
	}
	public int setL2L_DLV_PART_QTY_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_PART_QTY_2.add(((AE0040010Struct) list.get(i)).getDLV_PART_QTY_2());
		}
		return size;
	}
	public int setL2L_DLV_PART_LEN_3(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_PART_LEN_3.add(((AE0040010Struct) list.get(i)).getDLV_PART_LEN_3());
		}
		return size;
	}
	public int setL2L_DLV_PART_QTY_3(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_PART_QTY_3.add(((AE0040010Struct) list.get(i)).getDLV_PART_QTY_3());
		}
		return size;
	}
	public int setL2L_DLV_PART_LEN_4(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_PART_LEN_4.add(((AE0040010Struct) list.get(i)).getDLV_PART_LEN_4());
		}
		return size;
	}
	public int setL2L_DLV_PART_QTY_4(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_PART_QTY_4.add(((AE0040010Struct) list.get(i)).getDLV_PART_QTY_4());
		}
		return size;
	}
	public int setL2L_DLV_PART_LEN_5(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_PART_LEN_5.add(((AE0040010Struct) list.get(i)).getDLV_PART_LEN_5());
		}
		return size;
	}
	public int setL2L_DLV_PART_QTY_5(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_PART_QTY_5.add(((AE0040010Struct) list.get(i)).getDLV_PART_QTY_5());
		}
		return size;
	}
	public int setL2L_DLV_PART_UNIT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_PART_UNIT.add(((AE0040010Struct) list.get(i)).getDLV_PART_UNIT());
		}
		return size;
	}
	public int setL2L_CUST_CONSTRUCT_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUST_CONSTRUCT_NAME.add(((AE0040010Struct) list.get(i)).getCUST_CONSTRUCT_NAME());
		}
		return size;
	}
	public int setL2L_MATERIAL_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_MATERIAL_CD.add(((AE0040010Struct) list.get(i)).getMATERIAL_CD());
		}
		return size;
	}
	public int setL2L_MATERIAL_UNIT_PRICE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_MATERIAL_UNIT_PRICE.add(((AE0040010Struct) list.get(i)).getMATERIAL_UNIT_PRICE());
		}
		return size;
	}
	public int setL2L_MATRRIAL_UNIT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_MATRRIAL_UNIT.add(((AE0040010Struct) list.get(i)).getMATRRIAL_UNIT());
		}
		return size;
	}
	public int setL2L_TEST_REPORT_NEED_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TEST_REPORT_NEED_TYP.add(((AE0040010Struct) list.get(i)).getTEST_REPORT_NEED_TYP());
		}
		return size;
	}
	public int setL2L_TEST_REPORT_CHK_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TEST_REPORT_CHK_TYP.add(((AE0040010Struct) list.get(i)).getTEST_REPORT_CHK_TYP());
		}
		return size;
	}
	public int setL2L_TEST_REPORT_PRESENT_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TEST_REPORT_PRESENT_TYP.add(((AE0040010Struct) list.get(i)).getTEST_REPORT_PRESENT_TYP());
		}
		return size;
	}
	public int setL2L_MUNICIPAL_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_MUNICIPAL_CD.add(((AE0040010Struct) list.get(i)).getMUNICIPAL_CD());
		}
		return size;
	}
	public int setL2L_DLV_CONTACT_TEL(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_CONTACT_TEL.add(((AE0040010Struct) list.get(i)).getDLV_CONTACT_TEL());
		}
		return size;
	}
	public int setL2L_DLV_PRICE_OPEN_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_PRICE_OPEN_TYP.add(((AE0040010Struct) list.get(i)).getDLV_PRICE_OPEN_TYP());
		}
		return size;
	}
	public int setL2L_ODR_STAFF_NAME_J(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ODR_STAFF_NAME_J.add(((AE0040010Struct) list.get(i)).getODR_STAFF_NAME_J());
		}
		return size;
	}
	public int setL2L_ITEM_SPEC_NAME_J(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_SPEC_NAME_J.add(((AE0040010Struct) list.get(i)).getITEM_SPEC_NAME_J());
		}
		return size;
	}
	public int setL2L_ITEM_NAME_J(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_NAME_J.add(((AE0040010Struct) list.get(i)).getITEM_NAME_J());
		}
		return size;
	}
	public int setL2L_COMMENT_J(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_COMMENT_J.add(((AE0040010Struct) list.get(i)).getCOMMENT_J());
		}
		return size;
	}
	public int setL2L_END_USER_NAME_J(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_END_USER_NAME_J.add(((AE0040010Struct) list.get(i)).getEND_USER_NAME_J());
		}
		return size;
	}
	public int setL2L_DLV_ADDRESS_J(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_ADDRESS_J.add(((AE0040010Struct) list.get(i)).getDLV_ADDRESS_J());
		}
		return size;
	}
	public int setL2L_DLV_NAME_J(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_NAME_J.add(((AE0040010Struct) list.get(i)).getDLV_NAME_J());
		}
		return size;
	}
	public int setL2L_END_USER_ITEM_NAME_J(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_END_USER_ITEM_NAME_J.add(((AE0040010Struct) list.get(i)).getEND_USER_ITEM_NAME_J());
		}
		return size;
	}
	public int setL2L_MAKER_NAME_J(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_MAKER_NAME_J.add(((AE0040010Struct) list.get(i)).getMAKER_NAME_J());
		}
		return size;
	}
	public int setL2L_WH_NAME_J(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_WH_NAME_J.add(((AE0040010Struct) list.get(i)).getWH_NAME_J());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_COMMENT_J(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_COMMENT_J.add(((AE0040010Struct) list.get(i)).getPUCH_ODR_COMMENT_J());
		}
		return size;
	}
	public int setL2L_MACHINE_NAME_J(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_MACHINE_NAME_J.add(((AE0040010Struct) list.get(i)).getMACHINE_NAME_J());
		}
		return size;
	}
	public int setL2L_ODR_SPEC_J(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ODR_SPEC_J.add(((AE0040010Struct) list.get(i)).getODR_SPEC_J());
		}
		return size;
	}
	public int setL2L_ODR_ORG_NAME_J(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ODR_ORG_NAME_J.add(((AE0040010Struct) list.get(i)).getODR_ORG_NAME_J());
		}
		return size;
	}
	public int setL2L_CUST_CONSTRUCT_NAME_J(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUST_CONSTRUCT_NAME_J.add(((AE0040010Struct) list.get(i)).getCUST_CONSTRUCT_NAME_J());
		}
		return size;
	}
	public int setL2L_CUR_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUR_CD.add(((AE0040010Struct) list.get(i)).getCUR_CD());
		}
		return size;
	}
	public int setL2L_UNIT_COST_FOREIGN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_UNIT_COST_FOREIGN.add(((AE0040010Struct) list.get(i)).getUNIT_COST_FOREIGN());
		}
		return size;
	}
	public int setL2L_ODR_AMOUNT_FOREIGN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ODR_AMOUNT_FOREIGN.add(((AE0040010Struct) list.get(i)).getODR_AMOUNT_FOREIGN());
		}
		return size;
	}
	public int setL2L_TAX_AMOUNT_FOREIGN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_AMOUNT_FOREIGN.add(((AE0040010Struct) list.get(i)).getTAX_AMOUNT_FOREIGN());
		}
		return size;
	}
	public int setL2L_NET_AMOUNT_FOREIGN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_NET_AMOUNT_FOREIGN.add(((AE0040010Struct) list.get(i)).getNET_AMOUNT_FOREIGN());
		}
		return size;
	}
	public int setL2L_MATERIAL_UNIT_PRICE_FOREIGN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_MATERIAL_UNIT_PRICE_FOREIGN.add(((AE0040010Struct) list.get(i)).getMATERIAL_UNIT_PRICE_FOREIGN());
		}
		return size;
	}
	public int setL2L_BEFORE_ODR_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_BEFORE_ODR_QTY.add(((AE0040010Struct) list.get(i)).getBEFORE_ODR_QTY());
		}
		return size;
	}
	public int setL2L_BEFORE_UNIT_COST(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_BEFORE_UNIT_COST.add(((AE0040010Struct) list.get(i)).getBEFORE_UNIT_COST());
		}
		return size;
	}
	public int setL2L_BEFORE_UNIT_COST_FOREIGN(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_BEFORE_UNIT_COST_FOREIGN.add(((AE0040010Struct) list.get(i)).getBEFORE_UNIT_COST_FOREIGN());
		}
		return size;
	}
	public int setL2L_BEFORE_DLV_DATE_1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_BEFORE_DLV_DATE_1.add(((AE0040010Struct) list.get(i)).getBEFORE_DLV_DATE_1());
		}
		return size;
	}
	public int setL2L_BEFORE_DLV_QTY_1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_BEFORE_DLV_QTY_1.add(((AE0040010Struct) list.get(i)).getBEFORE_DLV_QTY_1());
		}
		return size;
	}
	public int setL2L_BEFORE_DLV_DATE_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_BEFORE_DLV_DATE_2.add(((AE0040010Struct) list.get(i)).getBEFORE_DLV_DATE_2());
		}
		return size;
	}
	public int setL2L_BEFORE_DLV_QTY_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_BEFORE_DLV_QTY_2.add(((AE0040010Struct) list.get(i)).getBEFORE_DLV_QTY_2());
		}
		return size;
	}
	public int setL2L_BEFORE_DLV_DATE_3(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_BEFORE_DLV_DATE_3.add(((AE0040010Struct) list.get(i)).getBEFORE_DLV_DATE_3());
		}
		return size;
	}
	public int setL2L_BEFORE_DLV_QTY_3(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_BEFORE_DLV_QTY_3.add(((AE0040010Struct) list.get(i)).getBEFORE_DLV_QTY_3());
		}
		return size;
	}
	public int setL2L_BEFORE_DLV_DATE_4(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_BEFORE_DLV_DATE_4.add(((AE0040010Struct) list.get(i)).getBEFORE_DLV_DATE_4());
		}
		return size;
	}
	public int setL2L_BEFORE_DLV_QTY_4(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_BEFORE_DLV_QTY_4.add(((AE0040010Struct) list.get(i)).getBEFORE_DLV_QTY_4());
		}
		return size;
	}
	public int setL2L_BEFORE_DLV_DATE_5(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_BEFORE_DLV_DATE_5.add(((AE0040010Struct) list.get(i)).getBEFORE_DLV_DATE_5());
		}
		return size;
	}
	public int setL2L_BEFORE_DLV_QTY_5(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_BEFORE_DLV_QTY_5.add(((AE0040010Struct) list.get(i)).getBEFORE_DLV_QTY_5());
		}
		return size;
	}
	public int setL2L_ODR_RETURN_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ODR_RETURN_DATE.add(((AE0040010Struct) list.get(i)).getODR_RETURN_DATE());
		}
		return size;
	}
	public int setL2L_REJECT_RETURN_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_REJECT_RETURN_TYP.add(((AE0040010Struct) list.get(i)).getREJECT_RETURN_TYP());
		}
		return size;
	}
	public int setL2L_EDI_ODR_ISS_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_EDI_ODR_ISS_FLG.add(((AE0040010Struct) list.get(i)).getEDI_ODR_ISS_FLG());
		}
		return size;
	}
	public int setL2L_EDI_ODR_ISS_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_EDI_ODR_ISS_DATE.add(((AE0040010Struct) list.get(i)).getEDI_ODR_ISS_DATE());
		}
		return size;
	}
	public int setL2L_l_PUCH_ODR_START_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_PUCH_ODR_START_DATE.add(((AE0040010Struct) list.get(i)).getl_PUCH_ODR_START_DATE());
		}
		return size;
	}
	public int setL2L_l_PUCH_ODR_DLV_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_PUCH_ODR_DLV_DATE.add(((AE0040010Struct) list.get(i)).getl_PUCH_ODR_DLV_DATE());
		}
		return size;
	}
	public int setL2L_l_VEND_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_VEND_CD.add(((AE0040010Struct) list.get(i)).getl_VEND_CD());
		}
		return size;
	}
	public int setL2L_l_VEND_ANAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_VEND_ANAME.add(((AE0040010Struct) list.get(i)).getl_VEND_ANAME());
		}
		return size;
	}
	public int setL2L_l_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_ITEM_CD.add(((AE0040010Struct) list.get(i)).getl_ITEM_CD());
		}
		return size;
	}
	public int setL2L_l_ITEM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_ITEM_NAME.add(((AE0040010Struct) list.get(i)).getl_ITEM_NAME());
		}
		return size;
	}
	public int setL2L_l_PUCH_ODR_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_PUCH_ODR_QTY.add(((AE0040010Struct) list.get(i)).getl_PUCH_ODR_QTY());
		}
		return size;
	}
	public int setL2L_l_STOCK_UNIT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_STOCK_UNIT.add(((AE0040010Struct) list.get(i)).getl_STOCK_UNIT());
		}
		return size;
	}
	public int setL2L_l_PUCH_ODR_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_PUCH_ODR_CD.add(((AE0040010Struct) list.get(i)).getl_PUCH_ODR_CD());
		}
		return size;
	}
	public int setL2L_l_JOB_ODR_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_JOB_ODR_CD.add(((AE0040010Struct) list.get(i)).getl_JOB_ODR_CD());
		}
		return size;
	}
	public int setL2L_l_PUCH_ODR_EDI_ISS_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_PUCH_ODR_EDI_ISS_DATE.add(((AE0040010Struct) list.get(i)).getl_PUCH_ODR_EDI_ISS_DATE());
		}
		return size;
	}
	public int setL2L_l_BUSINESS_OPR_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_BUSINESS_OPR_DATE.add(((AE0040010Struct) list.get(i)).getl_BUSINESS_OPR_DATE());
		}
		return size;
	}
	public int setL2L_l_MODIFY_COUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_MODIFY_COUNT.add(((AE0040010Struct) list.get(i)).getl_MODIFY_COUNT());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_START_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_START_DATE.add(((AE0040010Struct) list.get(i)).getPUCH_ODR_START_DATE());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_DLV_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_DLV_DATE.add(((AE0040010Struct) list.get(i)).getPUCH_ODR_DLV_DATE());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_STS_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_STS_TYP.add(((AE0040010Struct) list.get(i)).getPUCH_ODR_STS_TYP());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_EDI_ISS_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_EDI_ISS_FLG.add(((AE0040010Struct) list.get(i)).getPUCH_ODR_EDI_ISS_FLG());
		}
		return size;
	}
	public int setL2L_Not_PUCH_ODR_EDI_ISS_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_Not_PUCH_ODR_EDI_ISS_FLG.add(((AE0040010Struct) list.get(i)).getNot_PUCH_ODR_EDI_ISS_FLG());
		}
		return size;
	}
	public int setL2L_EXCH_RATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_EXCH_RATE.add(((AE0040010Struct) list.get(i)).getEXCH_RATE());
		}
		return size;
	}
	public int setL2L_PUCH_ODR_EDI_ISS_DATE(List list) {
		int size = (list != null) ? list.size() : 0;
		if (size == 0) {
			return 0;
		}
		if (l_PUCH_ODR_EDI_ISS_DATE == null) {
			l_PUCH_ODR_EDI_ISS_DATE = new ArrayList();
		} else {
			l_PUCH_ODR_EDI_ISS_DATE.clear();
		}
		for (int i = 0; i < size; i++) {
			l_PUCH_ODR_EDI_ISS_DATE.add(((AE0040010Struct) list.get(i)).getPUCH_ODR_EDI_ISS_DATE());
		}
		return size;
	}
	public int setL2L_PLANT_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PLANT_NAME.add(((AE0040010Struct) list.get(i)).getPLANT_NAME());
		}
		return size;
	}
	public int setL2L_VEND_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_VEND_NAME.add(((AE0040010Struct) list.get(i)).getVEND_NAME());
		}
		return size;
	}
	public int setL2L_USER_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_USER_NAME.add(((AE0040010Struct) list.get(i)).getUSER_NAME());
		}
		return size;
	}
	public int setL2L_MODIFY_COUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_MODIFY_COUNT.add(((AE0040010Struct) list.get(i)).getMODIFY_COUNT());
		}
		return size;
	}
	public int setL2L_l_COUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_l_COUNT.add(((AE0040010Struct) list.get(i)).getl_COUNT());
		}
		return size;
	}
	public int setL2L_ROW_COUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ROW_COUNT.add(((AE0040010Struct) list.get(i)).getROW_COUNT());
		}
		return size;
	}
	...
	public void clear()
	{
		m_r_OUTPUT_TYPE = null;
		m_r2_OUTPUT_TYPE = null;
		m_c_REOUTPUT = null;
		m_r1_FILTER1 = null;
		m_r2_FILTER1 = null;
		m_r1_FILTER2 = null;
		...
		l_r_OUTPUT_TYPE = null;
		l_r2_OUTPUT_TYPE = null;
		l_c_REOUTPUT = null;
		l_r1_FILTER1 = null;
		l_r2_FILTER1 = null;
		l_r1_FILTER2 = null;
	...
	/**
	 * medAE0040010クラスの標準コンストラクタ
	 */
	public AE0040010Struct()
	{
	 ...
	 */
	public void setStruct(AE0040010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructM(AE0040010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
			this.setr_OUTPUT_TYPE(struct.getr_OUTPUT_TYPE());
			this.setr2_OUTPUT_TYPE(struct.getr2_OUTPUT_TYPE());
			this.setc_REOUTPUT(struct.getc_REOUTPUT());
			...
			this.setPUCH_ODR_EDI_ISS_DATE(struct.getPUCH_ODR_EDI_ISS_DATE());
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructL(AE0040010Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
			this.setList_r_OUTPUT_TYPE(struct.getList_r_OUTPUT_TYPE());
			this.setList_r2_OUTPUT_TYPE(struct.getList_r2_OUTPUT_TYPE());
			this.setList_c_REOUTPUT(struct.getList_c_REOUTPUT());
			...
			this.setList_PUCH_ODR_EDI_ISS_DATE(struct.getList_PUCH_ODR_EDI_ISS_DATE());
...
/*
	// 第 1 変数初期値： i_r_OUTPUT_TYPE


	final static String i_r_OUTPUT_TYPE = null;

	// 第 2 変数初期値： i_r2_OUTPUT_TYPE


	final static String i_r2_OUTPUT_TYPE = null;

	// 第 3 変数初期値： i_c_REOUTPUT


	final static String i_c_REOUTPUT = null;

	// 第 4 変数初期値： i_r1_FILTER1


	final static String i_r1_FILTER1 = null;

	// 第 5 変数初期値： i_r2_FILTER1


	final static String i_r2_FILTER1 = null;

	// 第 6 変数初期値： i_r1_FILTER2


	final static String i_r1_FILTER2 = null;

	// 第 7 変数初期値： i_r2_FILTER2


	final static String i_r2_FILTER2 = null;

	// 第 8 変数初期値： i_INFO_TYP_CD


	final static String i_INFO_TYP_CD = null;

	// 第 9 変数初期値： i_COMPANY_CD
	...
	// 第 11 変数初期値： i_DATA_PROC_CD


	final static String i_DATA_PROC_CD = null;

	// 第 12 変数初期値： i_DATA_CREATE_DATE
	...
	// 第 23 変数初期値： i_PUCH_ODR_AMOUNT


	final static String i_PUCH_ODR_AMOUNT = null;

	// 第 24 変数初期値： i_EDI_CONS_TYP
	...
	// 第 192 変数初期値： i_PUCH_ODR_EDI_ISS_DATE


	final static String i_PUCH_ODR_EDI_ISS_DATE = null;

	// 第 193 変数初期値： i_PLANT_NAME


	final static String i_PLANT_NAME = null;

	// 第 194 変数初期値： i_VEND_NAME


	final static String i_VEND_NAME = null;

	// 第 195 変数初期値： i_USER_NAME


	final static String i_USER_NAME = null;

	// 第 196 変数初期値： i_MODIFY_COUNT


	final static String i_MODIFY_COUNT = null;

	// 第 197 変数初期値： i_l_COUNT


	final static String i_l_COUNT = null;

	// 第 198 変数初期値： i_ROW_COUNT
...
*/
	...
	// 第 1 変数初期値： i_INFO_TYP_CD
	final static String i_INFO_TYP_CD = null;
	// 第 2 変数初期値： i_COMPANY_CD
	final static String i_COMPANY_CD = null;
	// 第 3 変数初期値： i_PUCH_ODR_CD
	final static String i_PUCH_ODR_CD = null;
	// 第 4 変数初期値： i_DATA_PROC_CD
	final static String i_DATA_PROC_CD = null;
	// 第 5 変数初期値： i_DATA_CREATE_DATE
	final static String i_DATA_CREATE_DATE = null;
	// 第 6 変数初期値： i_VEND_CD
	final static String i_VEND_CD = null;
	...
	final static String i_JOB_ODR_CD = null;
	// 第 9 変数初期値： i_CRCT_TYP
	final static String i_CRCT_TYP = null;
	// 第 10 変数初期値： i_COCK_TYP
	final static String i_COCK_TYP = null;
	// 第 11 変数初期値： i_PUCH_ODR_DATE
	final static String i_PUCH_ODR_DATE = null;
	// 第 12 変数初期値： i_PUCH_ODR_UNIT
	final static String i_PUCH_ODR_UNIT = null;
	// 第 13 変数初期値： i_UNIT_COST
	final static String i_UNIT_COST = null;
	// 第 14 変数初期値： i_UNIT_COST_TYP
	final static String i_UNIT_COST_TYP = null;
	// 第 15 変数初期値： i_PUCH_ODR_QTY
	final static String i_PUCH_ODR_QTY = null;
	// 第 16 変数初期値： i_PUCH_ODR_AMOUNT
	final static String i_PUCH_ODR_AMOUNT = null;
	// 第 17 変数初期値： i_EDI_CONS_TYP
	final static String i_EDI_CONS_TYP = null;
	// 第 18 変数初期値： i_PUCH_ODR_PERSON
	final static String i_PUCH_ODR_PERSON = null;
	// 第 19 変数初期値： i_ITEM_SPEC
	final static String i_ITEM_SPEC = null;
	// 第 20 変数初期値： i_ITEM_DRAW_TYP
	final static String i_ITEM_DRAW_TYP = null;
	// 第 21 変数初期値： i_ITEM_VERSION
	final static String i_ITEM_VERSION = null;
	// 第 22 変数初期値： i_ITEM_NAME
	final static String i_ITEM_NAME = null;
	// 第 23 変数初期値： i_VEND_ITEM_CD
	final static String i_VEND_ITEM_CD = null;
	// 第 24 変数初期値： i_ITEM_CD
	final static String i_ITEM_CD = null;
	// 第 25 変数初期値： i_ITEM_DRAW_QTY
	final static String i_ITEM_DRAW_QTY = null;
	// 第 26 変数初期値： i_ITEM_PKG_UNIT
	final static String i_ITEM_PKG_UNIT = null;
	// 第 27 変数初期値： i_DIRECT_DLV_TYP
	final static String i_DIRECT_DLV_TYP = null;
	// 第 28 変数初期値： i_WH_CD
	final static String i_WH_CD = null;
	// 第 29 変数初期値： i_ACPT_INSPC_TYP
	final static String i_ACPT_INSPC_TYP = null;
	// 第 30 変数初期値： i_DLV_INST_TYP
	final static String i_DLV_INST_TYP = null;
	// 第 31 変数初期値： i_DLV_DATE_1
	final static String i_DLV_DATE_1 = null;
	// 第 32 変数初期値： i_DLV_INST_QTY_1
	final static String i_DLV_INST_QTY_1 = null;
	// 第 33 変数初期値： i_DLV_INST_CD_1
	final static String i_DLV_INST_CD_1 = null;
	// 第 34 変数初期値： i_DLV_DATE_2
	final static String i_DLV_DATE_2 = null;
	// 第 35 変数初期値： i_DLV_INST_QTY_2
	final static String i_DLV_INST_QTY_2 = null;
	// 第 36 変数初期値： i_DLV_INST_CD_2
	final static String i_DLV_INST_CD_2 = null;
	// 第 37 変数初期値： i_DLV_DATE_3
	final static String i_DLV_DATE_3 = null;
	// 第 38 変数初期値： i_DLV_INST_QTY_3
	final static String i_DLV_INST_QTY_3 = null;
	// 第 39 変数初期値： i_DLV_INST_CD_3
	final static String i_DLV_INST_CD_3 = null;
	// 第 40 変数初期値： i_DLV_DATE_4
	final static String i_DLV_DATE_4 = null;
	// 第 41 変数初期値： i_DLV_INST_QTY_4
	final static String i_DLV_INST_QTY_4 = null;
	// 第 42 変数初期値： i_DLV_INST_CD_4
	final static String i_DLV_INST_CD_4 = null;
	// 第 43 変数初期値： i_DLV_DATE_5
	final static String i_DLV_DATE_5 = null;
	// 第 44 変数初期値： i_DLV_INST_QTY_5
	final static String i_DLV_INST_QTY_5 = null;
	// 第 45 変数初期値： i_DLV_INST_CD_5
	final static String i_DLV_INST_CD_5 = null;
	// 第 46 変数初期値： i_FREE_COLUMN
	final static String i_FREE_COLUMN = null;
	// 第 47 変数初期値： i_PUCH_ODR_COMMENT
	final static String i_PUCH_ODR_COMMENT = null;
	// 第 48 変数初期値： i_INCLUDING_TAX_TYP
	final static String i_INCLUDING_TAX_TYP = null;
	// 第 49 変数初期値： i_TAX_RELATION_TYP
	final static String i_TAX_RELATION_TYP = null;
	// 第 50 変数初期値： i_TAX_AMOUNT
	final static String i_TAX_AMOUNT = null;
	// 第 51 変数初期値： i_NET_AMOUNT
	final static String i_NET_AMOUNT = null;
	// 第 52 変数初期値： i_RESERVE_CD
	final static String i_RESERVE_CD = null;
	// 第 53 変数初期値： i_COST_PLAN_CD
	final static String i_COST_PLAN_CD = null;
	// 第 54 変数初期値： i_STL_COND_TYP
	final static String i_STL_COND_TYP = null;
	// 第 55 変数初期値： i_END_USER_NAME
	final static String i_END_USER_NAME = null;
	// 第 56 変数初期値： i_DLV_ADDRESS_CD
	final static String i_DLV_ADDRESS_CD = null;
	// 第 57 変数初期値： i_DLV_ADDRESS
	final static String i_DLV_ADDRESS = null;
	// 第 58 変数初期値： i_DLV_NAME
	final static String i_DLV_NAME = null;
	// 第 59 変数初期値： i_END_USER_ITEM_NAME
	final static String i_END_USER_ITEM_NAME = null;
	// 第 60 変数初期値： i_END_USER_ITEM_CD
	final static String i_END_USER_ITEM_CD = null;
	// 第 61 変数初期値： i_END_USER_ODR_CD
	final static String i_END_USER_ODR_CD = null;
	// 第 62 変数初期値： i_MAKER_NAME
	final static String i_MAKER_NAME = null;
	// 第 63 変数初期値： i_DLV_KEY_CD_1
	final static String i_DLV_KEY_CD_1 = null;
	// 第 64 変数初期値： i_DLV_KEY_CD_2
	final static String i_DLV_KEY_CD_2 = null;
	// 第 65 変数初期値： i_DLV_KEY_CD_3
	final static String i_DLV_KEY_CD_3 = null;
	// 第 66 変数初期値： i_DLV_KEY_CD_4
	final static String i_DLV_KEY_CD_4 = null;
	// 第 67 変数初期値： i_DLV_KEY_CD_5
	final static String i_DLV_KEY_CD_5 = null;
	// 第 68 変数初期値： i_WH_NAME
	final static String i_WH_NAME = null;
	// 第 69 変数初期値： i_PUCH_BCODE_INF
	final static String i_PUCH_BCODE_INF = null;
	// 第 70 変数初期値： i_PUCH_COMMENT
	final static String i_PUCH_COMMENT = null;
	// 第 71 変数初期値： i_CONTRACT_COND_TYP
	final static String i_CONTRACT_COND_TYP = null;
	// 第 72 変数初期値： i_PUCH_ODR_SHAP_TYP
	final static String i_PUCH_ODR_SHAP_TYP = null;
	// 第 73 変数初期値： i_OWNER_ODR_CD
	final static String i_OWNER_ODR_CD = null;
	// 第 74 変数初期値： i_QTY_CONTRACT_TYP
	final static String i_QTY_CONTRACT_TYP = null;
	// 第 75 変数初期値： i_ODR_MODIFY_TYP_1
	final static String i_ODR_MODIFY_TYP_1 = null;
	// 第 76 変数初期値： i_ODR_MODIFY_TYP_2
	final static String i_ODR_MODIFY_TYP_2 = null;
	// 第 77 変数初期値： i_ODR_MODIFY_TYP_3
	final static String i_ODR_MODIFY_TYP_3 = null;
	// 第 78 変数初期値： i_MACHINE_CD
	final static String i_MACHINE_CD = null;
	// 第 79 変数初期値： i_ENGINNERING_CHG_CD
	final static String i_ENGINNERING_CHG_CD = null;
	// 第 80 変数初期値： i_ITEM_DRAW_CD
	final static String i_ITEM_DRAW_CD = null;
	// 第 81 変数初期値： i_DLV_DOC_FORM_1
	final static String i_DLV_DOC_FORM_1 = null;
	// 第 82 変数初期値： i_DLV_DOC_COPY_NUM_1
	final static String i_DLV_DOC_COPY_NUM_1 = null;
	// 第 83 変数初期値： i_DLV_DOC_LANG_1
	final static String i_DLV_DOC_LANG_1 = null;
	// 第 84 変数初期値： i_DLV_DOC_FORM_2
	final static String i_DLV_DOC_FORM_2 = null;
	// 第 85 変数初期値： i_DLV_DOC_COPY_NUM_2
	final static String i_DLV_DOC_COPY_NUM_2 = null;
	// 第 86 変数初期値： i_DLV_DOC_LANG_2
	final static String i_DLV_DOC_LANG_2 = null;
	// 第 87 変数初期値： i_DLV_DOC_FORM_3
	final static String i_DLV_DOC_FORM_3 = null;
	// 第 88 変数初期値： i_DLV_DOC_COPY_NUM_3
	final static String i_DLV_DOC_COPY_NUM_3 = null;
	// 第 89 変数初期値： i_DLV_DOC_LANG_3
	final static String i_DLV_DOC_LANG_3 = null;
	// 第 90 変数初期値： i_DLV_DOC_FORM_4
	final static String i_DLV_DOC_FORM_4 = null;
	// 第 91 変数初期値： i_DLV_DOC_COPY_NUM_4
	final static String i_DLV_DOC_COPY_NUM_4 = null;
	// 第 92 変数初期値： i_DLV_DOC_LANG_4
	final static String i_DLV_DOC_LANG_4 = null;
	// 第 93 変数初期値： i_STRATEGIC_GOODS_TYP
	final static String i_STRATEGIC_GOODS_TYP = null;
	// 第 94 変数初期値： i_ORGN_PLACE_CD_1
	final static String i_ORGN_PLACE_CD_1 = null;
	// 第 95 変数初期値： i_ORGN_PLACE_CD_2
	final static String i_ORGN_PLACE_CD_2 = null;
	// 第 96 変数初期値： i_ORGN_PLACE_CD_3
	final static String i_ORGN_PLACE_CD_3 = null;
	// 第 97 変数初期値： i_ORGN_PLACE_CD_4
	final static String i_ORGN_PLACE_CD_4 = null;
	// 第 98 変数初期値： i_ORGN_PLACE_CD_5
	final static String i_ORGN_PLACE_CD_5 = null;
	// 第 99 変数初期値： i_DLV_TIME_1
	final static String i_DLV_TIME_1 = null;
	// 第 100 変数初期値： i_DLV_TIME_2
	final static String i_DLV_TIME_2 = null;
	// 第 101 変数初期値： i_DLV_TIME_3
	final static String i_DLV_TIME_3 = null;
	// 第 102 変数初期値： i_DLV_TIME_4
	final static String i_DLV_TIME_4 = null;
	// 第 103 変数初期値： i_DLV_TIME_5
	final static String i_DLV_TIME_5 = null;
	// 第 104 変数初期値： i_PACKAGE_DLV_CD
	final static String i_PACKAGE_DLV_CD = null;
	// 第 105 変数初期値： i_ODR_ITEM_SPEC
	final static String i_ODR_ITEM_SPEC = null;
	// 第 106 変数初期値： i_ODR_ORG_NAME
	final static String i_ODR_ORG_NAME = null;
	// 第 107 変数初期値： i_DLV_PART_LEN_1
	final static String i_DLV_PART_LEN_1 = null;
	// 第 108 変数初期値： i_DLV_PART_QTY_1
	final static String i_DLV_PART_QTY_1 = null;
	// 第 109 変数初期値： i_DLV_PART_LEN_2
	final static String i_DLV_PART_LEN_2 = null;
	// 第 110 変数初期値： i_DLV_PART_QTY_2
	final static String i_DLV_PART_QTY_2 = null;
	// 第 111 変数初期値： i_DLV_PART_LEN_3
	final static String i_DLV_PART_LEN_3 = null;
	// 第 112 変数初期値： i_DLV_PART_QTY_3
	final static String i_DLV_PART_QTY_3 = null;
	// 第 113 変数初期値： i_DLV_PART_LEN_4
	final static String i_DLV_PART_LEN_4 = null;
	// 第 114 変数初期値： i_DLV_PART_QTY_4
	final static String i_DLV_PART_QTY_4 = null;
	// 第 115 変数初期値： i_DLV_PART_LEN_5
	final static String i_DLV_PART_LEN_5 = null;
	// 第 116 変数初期値： i_DLV_PART_QTY_5
	final static String i_DLV_PART_QTY_5 = null;
	// 第 117 変数初期値： i_DLV_PART_UNIT
	final static String i_DLV_PART_UNIT = null;
	// 第 118 変数初期値： i_CUST_CONSTRUCT_NAME
	final static String i_CUST_CONSTRUCT_NAME = null;
	// 第 119 変数初期値： i_MATERIAL_CD
	final static String i_MATERIAL_CD = null;
	// 第 120 変数初期値： i_MATERIAL_UNIT_PRICE
	final static String i_MATERIAL_UNIT_PRICE = null;
	// 第 121 変数初期値： i_MATRRIAL_UNIT
	final static String i_MATRRIAL_UNIT = null;
	// 第 122 変数初期値： i_TEST_REPORT_NEED_TYP
	final static String i_TEST_REPORT_NEED_TYP = null;
	// 第 123 変数初期値： i_TEST_REPORT_CHK_TYP
	final static String i_TEST_REPORT_CHK_TYP = null;
	// 第 124 変数初期値： i_TEST_REPORT_PRESENT_TYP
	final static String i_TEST_REPORT_PRESENT_TYP = null;
	// 第 125 変数初期値： i_MUNICIPAL_CD
	final static String i_MUNICIPAL_CD = null;
	// 第 126 変数初期値： i_DLV_CONTACT_TEL
	final static String i_DLV_CONTACT_TEL = null;
	// 第 127 変数初期値： i_DLV_PRICE_OPEN_TYP
	final static String i_DLV_PRICE_OPEN_TYP = null;
	// 第 128 変数初期値： i_ODR_STAFF_NAME_J
	final static String i_ODR_STAFF_NAME_J = null;
	// 第 129 変数初期値： i_ITEM_SPEC_NAME_J
	final static String i_ITEM_SPEC_NAME_J = null;
	// 第 130 変数初期値： i_ITEM_NAME_J
	final static String i_ITEM_NAME_J = null;
	// 第 131 変数初期値： i_COMMENT_J
	final static String i_COMMENT_J = null;
	// 第 132 変数初期値： i_END_USER_NAME_J
	final static String i_END_USER_NAME_J = null;
	// 第 133 変数初期値： i_DLV_ADDRESS_J
	final static String i_DLV_ADDRESS_J = null;
	// 第 134 変数初期値： i_DLV_NAME_J
	final static String i_DLV_NAME_J = null;
	// 第 135 変数初期値： i_END_USER_ITEM_NAME_J
	final static String i_END_USER_ITEM_NAME_J = null;
	// 第 136 変数初期値： i_MAKER_NAME_J
	final static String i_MAKER_NAME_J = null;
	// 第 137 変数初期値： i_WH_NAME_J
	final static String i_WH_NAME_J = null;
	// 第 138 変数初期値： i_PUCH_ODR_COMMENT_J
	final static String i_PUCH_ODR_COMMENT_J = null;
	// 第 139 変数初期値： i_MACHINE_NAME_J
	final static String i_MACHINE_NAME_J = null;
	// 第 140 変数初期値： i_ODR_SPEC_J
	final static String i_ODR_SPEC_J = null;
	// 第 141 変数初期値： i_ODR_ORG_NAME_J
	final static String i_ODR_ORG_NAME_J = null;
	// 第 142 変数初期値： i_CUST_CONSTRUCT_NAME_J
	final static String i_CUST_CONSTRUCT_NAME_J = null;
	// 第 143 変数初期値： i_CUR_CD
	final static String i_CUR_CD = null;
	// 第 144 変数初期値： i_UNIT_COST_FOREIGN
	final static String i_UNIT_COST_FOREIGN = null;
	// 第 145 変数初期値： i_ODR_AMOUNT_FOREIGN
	final static String i_ODR_AMOUNT_FOREIGN = null;
	// 第 146 変数初期値： i_TAX_AMOUNT_FOREIGN
	final static String i_TAX_AMOUNT_FOREIGN = null;
	// 第 147 変数初期値： i_NET_AMOUNT_FOREIGN
	final static String i_NET_AMOUNT_FOREIGN = null;
	// 第 148 変数初期値： i_MATERIAL_UNIT_PRICE_FOREIGN
	final static String i_MATERIAL_UNIT_PRICE_FOREIGN = null;
	// 第 149 変数初期値： i_BEFORE_ODR_QTY
	final static String i_BEFORE_ODR_QTY = null;
	// 第 150 変数初期値： i_BEFORE_UNIT_COST
	final static String i_BEFORE_UNIT_COST = null;
	// 第 151 変数初期値： i_BEFORE_UNIT_COST_FOREIGN
	final static String i_BEFORE_UNIT_COST_FOREIGN = null;
	// 第 152 変数初期値： i_BEFORE_DLV_DATE_1
	final static String i_BEFORE_DLV_DATE_1 = null;
	// 第 153 変数初期値： i_BEFORE_DLV_QTY_1
	final static String i_BEFORE_DLV_QTY_1 = null;
	// 第 154 変数初期値： i_BEFORE_DLV_DATE_2
	final static String i_BEFORE_DLV_DATE_2 = null;
	// 第 155 変数初期値： i_BEFORE_DLV_QTY_2
	final static String i_BEFORE_DLV_QTY_2 = null;
	// 第 156 変数初期値： i_BEFORE_DLV_DATE_3
	final static String i_BEFORE_DLV_DATE_3 = null;
	// 第 157 変数初期値： i_BEFORE_DLV_QTY_3
	final static String i_BEFORE_DLV_QTY_3 = null;
	// 第 158 変数初期値： i_BEFORE_DLV_DATE_4
	final static String i_BEFORE_DLV_DATE_4 = null;
	// 第 159 変数初期値： i_BEFORE_DLV_QTY_4
	final static String i_BEFORE_DLV_QTY_4 = null;
	// 第 160 変数初期値： i_BEFORE_DLV_DATE_5
	final static String i_BEFORE_DLV_DATE_5 = null;
	// 第 161 変数初期値： i_BEFORE_DLV_QTY_5
	final static String i_BEFORE_DLV_QTY_5 = null;
	// 第 162 変数初期値： i_ODR_RETURN_DATE
	final static String i_ODR_RETURN_DATE = null;
	// 第 163 変数初期値： i_REJECT_RETURN_TYP
	final static String i_REJECT_RETURN_TYP = null;
	// 第 164 変数初期値： i_EDI_ODR_ISS_FLG
	final static String i_EDI_ODR_ISS_FLG = null;
	// 第 165 変数初期値： i_EDI_ODR_ISS_DATE
	final static String i_EDI_ODR_ISS_DATE = null;
	// 第 166 変数初期値： i_l_PUCH_ODR_START_DATE
	final static String i_l_PUCH_ODR_START_DATE = null;
	// 第 167 変数初期値： i_l_PUCH_ODR_DLV_DATE
	final static String i_l_PUCH_ODR_DLV_DATE = null;
	// 第 168 変数初期値： i_l_VEND_CD
	final static String i_l_VEND_CD = null;
	// 第 169 変数初期値： i_l_VEND_ANAME
	final static String i_l_VEND_ANAME = null;
	// 第 170 変数初期値： i_l_ITEM_CD
	final static String i_l_ITEM_CD = null;
	// 第 171 変数初期値： i_l_ITEM_NAME
	final static String i_l_ITEM_NAME = null;
	// 第 172 変数初期値： i_l_PUCH_ODR_QTY
	final static String i_l_PUCH_ODR_QTY = null;
	// 第 173 変数初期値： i_l_STOCK_UNIT
	final static String i_l_STOCK_UNIT = null;
	// 第 174 変数初期値： i_l_PUCH_ODR_CD
	final static String i_l_PUCH_ODR_CD = null;
	// 第 175 変数初期値： i_l_JOB_ODR_CD
	final static String i_l_JOB_ODR_CD = null;
	// 第 176 変数初期値： i_l_PUCH_ODR_EDI_ISS_DATE
	final static String i_l_PUCH_ODR_EDI_ISS_DATE = null;
	// 第 177 変数初期値： i_l_BUSINESS_OPR_DATE
	final static String i_l_BUSINESS_OPR_DATE = null;
	// 第 178 変数初期値： i_l_MODIFY_COUNT
	final static String i_l_MODIFY_COUNT = null;
	// 第 179 変数初期値： i_PUCH_ODR_START_DATE
	final static String i_PUCH_ODR_START_DATE = null;
	// 第 180 変数初期値： i_PUCH_ODR_DLV_DATE
	final static String i_PUCH_ODR_DLV_DATE = null;
	// 第 181 変数初期値： i_PUCH_ODR_STS_TYP
	final static String i_PUCH_ODR_STS_TYP = null;
	// 第 182 変数初期値： i_PUCH_ODR_EDI_ISS_FLG
	final static String i_PUCH_ODR_EDI_ISS_FLG = null;
	// 第 183 変数初期値： i_Not_PUCH_ODR_EDI_ISS_FLG
	final static String i_Not_PUCH_ODR_EDI_ISS_FLG = null;
	// 第 184 変数初期値： i_EXCH_RATE
	final static String i_EXCH_RATE = null;
	// 第 185 変数初期値： i_PUCH_ODR_EDI_ISS_DATE
	final static String i_PUCH_ODR_EDI_ISS_DATE = null;
	// 第 186 変数初期値： i_PLANT_NAME
	final static String i_PLANT_NAME = null;
	// 第 187 変数初期値： i_VEND_NAME
	final static String i_VEND_NAME = null;
	// 第 188 変数初期値： i_USER_NAME
	final static String i_USER_NAME = null;
	// 第 189 変数初期値： i_MODIFY_COUNT
	final static String i_MODIFY_COUNT = null;
	// 第 190 変数初期値： i_r_OUTPUT_TYPE
	final static String i_r_OUTPUT_TYPE = null;
	// 第 191 変数初期値： i_r2_OUTPUT_TYPE
	final static String i_r2_OUTPUT_TYPE = null;
	// 第 192 変数初期値： i_c_REOUTPUT
	final static String i_c_REOUTPUT = null;
	// 第 193 変数初期値： i_r1_FILTER1
	final static String i_r1_FILTER1 = null;
	// 第 194 変数初期値： i_r2_FILTER1
	final static String i_r2_FILTER1 = null;
	// 第 195 変数初期値： i_r1_FILTER2
	final static String i_r1_FILTER2 = null;
	// 第 196 変数初期値： i_r2_FILTER2
	final static String i_r2_FILTER2 = null;
	...
	public void initialize()
	{
		...
		m_PUCH_ODR_EDI_ISS_DATE = i_PUCH_ODR_EDI_ISS_DATE;
		m_PLANT_NAME = i_PLANT_NAME;
		m_VEND_NAME = i_VEND_NAME;
		m_USER_NAME = i_USER_NAME;
		m_MODIFY_COUNT = i_MODIFY_COUNT;
		m_r_OUTPUT_TYPE = i_r_OUTPUT_TYPE;
		m_r2_OUTPUT_TYPE = i_r2_OUTPUT_TYPE;
		m_c_REOUTPUT = i_c_REOUTPUT;
