/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0040/src/com/nec/jp/orteus/metamorBase/AE0040/AE0040030Entity.java,v $
 *
...
public class AE0040030Entity extends DataObject
{
	...
	// T_OD_Lockクラス インスタンス
	public T_OD_Lock mT_OD_Lock = new T_OD_Lock();
...
+"";		//////////////////////////////
	...
	public class ei_CSVOut extends DataObject
	{
		...
		String m_write_fname="AE0040030.csv";

		protected WriteCsv m_writer=null;		// csv書込み用

		String m_ProjName="AE0040030";
...
+"  T_OD.\"OD_NO\" as \"OD_NO\", "
+"  T_OD.\"MODIFY_COUNT\" as \"MODIFY_COUNT\" "
+"from "
+"  T_OD, "
+"  M_ITEM, "
+"  M_VEND_CTRL, "
...
+"  and M_VEND_CTRL.VEND_CD = ITEM_VEND.VEND_CD "
...
+"  or  T_OD.OD_TYP = 2) "
+"  and T_OD.\"PLANT_CD\" = ? "
+"  and T_OD.\"ODR_START_DATE\" <= to_date(?, 'YYYY/MM/DD') "
+"  and T_OD.\"PRD_DUE_DATE\" <= to_date(?, 'YYYY/MM/DD') "
+"  and T_OD.\"JOB_ODR_CD\" like ? "
+"  and T_OD.\"ITEM_CD\" = ? "
+"  and ITEM_VEND.\"VEND_CD\" = ? "
+"order by "
+"  T_OD.\"ODR_START_DATE\", "
+"  T_OD.\"PRD_DUE_DATE\", "
+"  ITEM_VEND.\"PUCH_PRIORITY_REF_NO\", "
+"  ITEM_VEND.\"VEND_CD\", "
+"  T_OD.\"ITEM_CD\", "
+"  T_OD.\"OD_NO\"";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AE0040030Struct data) throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AE0040030Struct data, String replaceStr)
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AE0040030Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AE0040030Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AE0040030Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AE0040030Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(PreparedStatement stmt, AE0040030Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public PreparedStatement prepare(Connection conn, String query, AE0040030Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt;
			...
			try {
				...
				ary.addElement(data.getPLANT_CD());
				if(isNull(data.getPLANT_CD())) isNull = true;
				ary.addElement(data.getODR_START_DATE());
				if(isNull(data.getODR_START_DATE())) isNull = true;
				ary.addElement(data.getPRD_DUE_DATE());
				if(isNull(data.getPRD_DUE_DATE())) isNull = true;
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public ResultSet executeQuery(PreparedStatement stmt, AE0040030Struct data) throws FoundationException, SQLException
		{
			int no=1;
			...
			if(!isNull(data.getPLANT_CD())) setString(no ++, data.getPLANT_CD(), stmt);
			//動的SQL生成ロジック
			if(!isNull(data.getODR_START_DATE())) setString(no ++, data.getODR_START_DATE(), stmt);
			//動的SQL生成ロジック
			if(!isNull(data.getPRD_DUE_DATE())) setString(no ++, data.getPRD_DUE_DATE(), stmt);
			//動的SQL生成ロジック
		 ...
		 * レコードデータをStructに格納して返します
		 */
		public AE0040030Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			if(rs.next()==false) return null;

			AE0040030Struct data = new AE0040030Struct();

			data.setl_ODR_START_DATE( getString(1, rs) );
			data.setl_PRD_DUE_DATE( getString(2, rs) );
			...
			data.setl_JOB_ODR_CD( getString(9, rs) );
			data.setl_OD_NO( getString(10, rs) );
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(IDbConnection conn, AE0040030Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(Connection conn, AE0040030Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(IDbConnection conn, AE0040030Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(Connection conn, AE0040030Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(PreparedStatement stmt, AE0040030Struct data) throws FoundationException, SQLException
		{
			ResultSet rs=executeQuery(stmt, data);
			boolean ret=true;
...
+"  M_ITEM.\"ITEM_CD\" = ?";
	 ...
	 * Entity定義 静的SQL
	 */
	public class T_OD_Lock extends DataObject
	{
		protected String m_selcmd = "select "
...
+"for update nowait";
		...
		//{{user_implement_dev:T_OD_Lock_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:T_OD_Lock_def
		...
		public List read(Connection conn, AE0040030Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_OD_Lock_read
			if(m_selcmd==null) throw new FoundationException("T_OD_Lock", "read", "クエリー未登録");
		...
		public List read(Connection conn, AE0040030Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_OD_Lock_read2
			if(m_selcmd==null) throw new FoundationException("T_OD_Lock", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AE0040030Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_OD_Lock_read3
			if(m_selcmd==null) throw new FoundationException("T_OD_Lock", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public boolean hasRecord(Connection conn, AE0040030Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("T_OD_Lock", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AE0040030Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:T_OD_Lock_check
			PreparedStatement stmt;
			...
			if(m_chkcmd!=null) {
				...
				throw new FoundationException("T_OD_Lock", "check", "クエリー未登録");
			}
		...
		public void clear()
		{
			//{{user_implement_dev:T_OD_Lock_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:T_OD_Lock_clear
		...
		/**
		 * T_OD_Lockクラスの標準コンストラクタ
		 */
		public T_OD_Lock()
		{
			//{{user_implement_dev:T_OD_Lock_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:T_OD_Lock_constractor
...
+"  and ROWNUM <= TO_NUMBER(?) + 1";
	 ...
	 */
	public AE0040030Entity() throws FoundationException
	{
