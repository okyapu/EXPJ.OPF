/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0040/src/com/nec/jp/orteus/metamorBase/AE0040/AE0040030Servlet.java,v $
 *
...
public class AE0040030Servlet extends HttpServlet
{
	 ...
	 * @param control AE0040030Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AE0040030Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AE0040030Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AE0040030Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AE0040030Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AE0040030Entity entity = control.entity;
		AE0040030Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AE0040030Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
			// TODO: ユーザ定義のコードを記述してください
//			objMessage.m_writer.write( Level.ALL, "AE0040030"+" $Revision: 1.2 $" );
			control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AE0040030Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AE0040030Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AE0040030Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0040");
		logger.entering("AE0040030Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
...
//			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AE0040030-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
		}
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AE0040030Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickSelect(
					...
					HttpSession so,
					Hashtable params,
					AE0040030Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AE0040030Entity entity = control.entity;
		AE0040030Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0040");
		logger.entering("AE0040030Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickSelect>
		logger.exiting("AE0040030Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
					...
					AE0040030Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0040");
		logger.entering("AE0040030Servlet"+":USER="+request.getRemoteUser(),"onClickInsert");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickInsert>
		logger.exiting("AE0040030Servlet"+":USER="+request.getRemoteUser(),"onClickInsert");
					...
					AE0040030Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0040");
		logger.entering("AE0040030Servlet"+":USER="+request.getRemoteUser(),"onClickClose");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClose>
		logger.exiting("AE0040030Servlet"+":USER="+request.getRemoteUser(),"onClickClose");
					...
					AE0040030Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0040");
		logger.entering("AE0040030Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("AE0040030Servlet"+":USER="+request.getRemoteUser(),"onClickClear");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AE0040030Struct struct)
	{
	...
	public static String DEFAULT_TARGET = "/AE0040030.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAE0040030Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAE0040030Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0040");
		logger.entering("AE0040030Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AE0040030Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AE0040030Control control;
		AE0040030Entity  entity = null;
		AE0040030Struct  struct = null;
		...
		try {
			...
			if( (control = (AE0040030Control)so.getAttribute("AE0040030Control_"+request.getSession(false).getId())) == null ) {
				control = new AE0040030Control();
			...
			try {
				...
				so.setAttribute("AE0040030Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.AE0040.AE0040030Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AE0040030Servlet()
	{
		//{{user_implement_dev:<AE0040030_DisConnect_FLG>
		...
		//{{user_implement_dev:<AE0040030Servlet>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<AE0040030Servlet>
	}
