/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0040/src/com/nec/jp/orteus/metamorBase/AE0040/AE0040010Servlet.java,v $
 *
...
public class AE0040010Servlet extends HttpServlet
{
	 ...
	 * @param control AE0040010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AE0040010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AE0040010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AE0040010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AE0040010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AE0040010Entity entity = control.entity;
		AE0040010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AE0040010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
			// TODO: ユーザ定義のコードを記述してください
//			objMessage.m_writer.write( Level.ALL, "AE0040010"+" $Revision: 1.2 $" );
			control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AE0040010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AE0040010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AE0040010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0040");
		logger.entering("AE0040010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
...
//			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AE0040010-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
		}
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AE0040010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickSelect(
					...
					HttpSession so,
					Hashtable params,
					AE0040010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AE0040010Entity entity = control.entity;
		AE0040010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0040");
		logger.entering("AE0040010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickSelect>
		logger.exiting("AE0040010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
					...
					AE0040010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0040");
		logger.entering("AE0040010Servlet"+":USER="+request.getRemoteUser(),"onClickInsert");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickInsert>
		logger.exiting("AE0040010Servlet"+":USER="+request.getRemoteUser(),"onClickInsert");
					...
					AE0040010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0040");
		logger.entering("AE0040010Servlet"+":USER="+request.getRemoteUser(),"onClickClose");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClose>
		logger.exiting("AE0040010Servlet"+":USER="+request.getRemoteUser(),"onClickClose");
					...
					AE0040010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0040");
		logger.entering("AE0040010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("AE0040010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AE0040010Struct struct)
	{
		...
		String[] r_OUTPUT_TYPE = ((params.containsKey("r_OUTPUT_TYPE")) ? (String[])params.get("r_OUTPUT_TYPE") : (String[])null);
		String[] r2_OUTPUT_TYPE = ((params.containsKey("r2_OUTPUT_TYPE")) ? (String[])params.get("r2_OUTPUT_TYPE") : (String[])null);
		String[] c_REOUTPUT = ((params.containsKey("c_REOUTPUT")) ? (String[])params.get("c_REOUTPUT") : (String[])null);
		...
		struct.setr_OUTPUT_TYPE( ((r_OUTPUT_TYPE == null) ? (String)null : r_OUTPUT_TYPE[0]) );
		struct.setList_r_OUTPUT_TYPE(TypeConverter.convert(r_OUTPUT_TYPE));
		struct.setr2_OUTPUT_TYPE( ((r2_OUTPUT_TYPE == null) ? (String)null : r2_OUTPUT_TYPE[0]) );
		struct.setList_r2_OUTPUT_TYPE(TypeConverter.convert(r2_OUTPUT_TYPE));
		struct.setc_REOUTPUT( ((c_REOUTPUT == null) ? (String)null : c_REOUTPUT[0]) );
		struct.setList_c_REOUTPUT(TypeConverter.convert(c_REOUTPUT));
	...
	public static String DEFAULT_TARGET = "/AE0040010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAE0040010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAE0040010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0040");
		logger.entering("AE0040010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AE0040010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AE0040010Control control;
		AE0040010Entity  entity = null;
		AE0040010Struct  struct = null;
		...
		try {
			...
			if( (control = (AE0040010Control)so.getAttribute("AE0040010Control_"+request.getSession(false).getId())) == null ) {
				control = new AE0040010Control();
			...
			try {
				...
				so.setAttribute("AE0040010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.AE0040.AE0040010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AE0040010Servlet()
	{
		//{{user_implement_dev:<AE0040010_DisConnect_FLG>
		...
		//{{user_implement_dev:<AE0040010Servlet>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<AE0040010Servlet>
	}
