/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0040/src/com/nec/jp/orteus/metamorBase/AE0040/AE0040010Control.java,v $
 *
...
//	public Object getListvalue(int x) { return this.list.get(x); }	// リストの値を返します。
	public AE0040010Struct getListvalue(int x) { return (AE0040010Struct)(this.list.get(x)); }	// リストの値を返します。
	public AE0040010Struct getStruct() { return this.struct; }	// Structを返します。
	public AE0040010Struct createStruct() { return new AE0040010Struct(); }	// 新しいStructを作って返します。
	public void setStruct(Object structname) { this.struct.setStruct((AE0040010Struct)structname); }	// Structをセットします。
	...
	public void initializeAll() {
		...
		struct.setr_OUTPUT_TYPE(null);
		struct.setr2_OUTPUT_TYPE("true");
		struct.setc_REOUTPUT(null);
	...
	/**
	 * クライアントで選択されたラジオボタン、チェックボックスの値を
	 * structに設定します。
	 */	
	private void setSelectedButtonValue() {
		if ("true".equals(struct.getr_OUTPUT_TYPE())) {
			if ("true".equals(struct.getc_REOUTPUT())) {
				struct.setPUCH_ODR_STS_TYP("1");
				struct.setPUCH_ODR_EDI_ISS_FLG("1");
				struct.setNot_PUCH_ODR_EDI_ISS_FLG(null);
			} else {
				struct.setPUCH_ODR_STS_TYP("1");
				struct.setPUCH_ODR_EDI_ISS_FLG("0");
				struct.setNot_PUCH_ODR_EDI_ISS_FLG(null);
			}
		} else {
			if ("true".equals(struct.getc_REOUTPUT())) {
				struct.setPUCH_ODR_STS_TYP("2");
				struct.setPUCH_ODR_EDI_ISS_FLG("2");
				struct.setNot_PUCH_ODR_EDI_ISS_FLG(null);
			} else {
				struct.setPUCH_ODR_STS_TYP("2");
				struct.setPUCH_ODR_EDI_ISS_FLG(null);
				struct.setNot_PUCH_ODR_EDI_ISS_FLG("2");
			}
		}		
	}
	 ...
	 * @param s 参照するStruct
	 *	 */
	private AE0040010Struct createEDI_PUCH_ODRStruct(AE0040010Struct s)
		...
		AE0040010Struct newStruct = new AE0040010Struct();
	 ...
	 * @return 生成したStruct
	 */
	private AE0040010Struct createT_RLSD_PUCH_ODRStruct(AE0040010Struct s) throws SQLException, DataNotFoundException {
		...
		newStruct.setPUCH_ODR_CD(s.getPUCH_ODR_CD());
		if ("true".equals(struct.getr_OUTPUT_TYPE())) {
			newStruct.setPUCH_ODR_EDI_ISS_FLG("1");			
		} else {
			newStruct.setPUCH_ODR_EDI_ISS_FLG("2");	
		}
		newStruct.setPUCH_ODR_EDI_ISS_DATE(dcs.getBUSINESS_OPR_DATE());
		newStruct.setsOraganization_CD(struct.sOrganization_CD);
		newStruct.setsSysdate(struct.sSysdate);
		newStruct.setsUser_ID(struct.sUser_ID);
		return newStruct;
	...
	public void controlSelect() throws BusinessProcessException, FoundationException
	{
		...
		logger.entering("AE0040010Control"+":USER="+struct.getsUser_ID(),"controlSelect");
		...
		try {
			...
			if (plantList.isEmpty()) {
				...
				AE0040010Struct plantStruct = (AE0040010Struct) plantList.get(0);
			...
			if (struct.getVEND_CD() != null && !struct.getVEND_CD().equals("")) {
				...
				if (vendList.isEmpty()) {
					...
					AE0040010Struct vendStruct = (AE0040010Struct) vendList.get(0);
			...
			if (struct.getPUCH_ODR_PERSON() != null
				...
				if (userList.isEmpty()) {
					...
					AE0040010Struct userStruct = (AE0040010Struct) userList.get(0);
			...
			long rowCount = Long.parseLong(((AE0040010Struct)viewList.get(0)).getl_COUNT());  
			// 対象件数=0件の場合エラー
			if (rowCount==0) {
				...
				if (struct.getPUCH_ODR_EDI_ISS_FLG() == null) {
					setErrorParameter("T_RLSD_PUCH_ODR", "PUCH_ODR_EDI_ISS_FLG", "0 or 1");					
				} else {
					setErrorParameter("T_RLSD_PUCH_ODR", "PUCH_ODR_EDI_ISS_FLG", struct.getPUCH_ODR_EDI_ISS_FLG());										
				}
				setErrorParameter("T_RLSD_PUCH_ODR", "PUCH_ODR_STS_TYP", struct.getPUCH_ODR_STS_TYP());
			...
			throw new ExpjException(e);
                ...
                //}}user_implement_dev:<controlSelect>
		logger.exiting("AE0040010Control"+":USER="+struct.getsUser_ID(),"controlSelect");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0040");
		logger.entering("AE0040010Control"+":USER="+struct.getsUser_ID(),"controlInsert");
		...
		try {
			...
			for (int i = 0; i < selectedList.size(); i++) {
				...
				AE0040010Struct lockedStruct = (AE0040010Struct) lockedList.get(0);
				...
				AE0040010Struct puchOdrStruct = (AE0040010Struct) puchOdrList.get(0);
			...
			if (conn != null) {
                ...
                //}}user_implement_dev:<controlInsert>
		logger.exiting("AE0040010Control"+":USER="+struct.getsUser_ID(),"controlInsert");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0040");
		logger.entering("AE0040010Control"+":USER="+struct.getsUser_ID(),"controlClose");
			//{{user_implement_dev:<controlClose>

                //}}user_implement_dev:<controlClose>
		logger.exiting("AE0040010Control"+":USER="+struct.getsUser_ID(),"controlClose");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0040");
		logger.entering("AE0040010Control"+":USER="+struct.getsUser_ID(),"controlClear");
		...
		initializeAll();
                ...
                //}}user_implement_dev:<controlClear>
		logger.exiting("AE0040010Control"+":USER="+struct.getsUser_ID(),"controlClear");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0040");
		logger.entering("AE0040010Control"+":USER="+struct.getsUser_ID(),"controlCheckAll");
			//{{user_implement_dev:<controlCheckAll>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<controlCheckAll>
		logger.exiting("AE0040010Control"+":USER="+struct.getsUser_ID(),"controlCheckAll");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0040");
		logger.entering("AE0040010Control"+":USER="+struct.getsUser_ID(),"controlUncheckAll");
			//{{user_implement_dev:<controlUncheckAll>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<controlUncheckAll>
		logger.exiting("AE0040010Control"+":USER="+struct.getsUser_ID(),"controlUncheckAll");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0040");
		logger.entering("AE0040010Control"+":USER="+struct.getsUser_ID(),"controlINITIAL");
		//{{user_implement_dev:<controlINITIAL>

                //}}user_implement_dev:<controlINITIAL>
		logger.exiting("AE0040010Control"+":USER="+struct.getsUser_ID(),"controlINITIAL");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0040");
		logger.entering("AE0040010Control"+":USER="+struct.getsUser_ID(),"controlRELOAD");
		...
		try {
			...
			throw new ExpjException(e);
                ...
                //}}user_implement_dev:<controlRELOAD>
		logger.exiting("AE0040010Control"+":USER="+struct.getsUser_ID(),"controlRELOAD");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0040");
		logger.entering("AE0040010Control"+":USER="+struct.getsUser_ID(),"controlPREPARATION");
...
//		}
		...
		//{{user_implement_dev:<controlPREPARATION>
                ...
                //}}user_implement_dev:<controlPREPARATION>
		logger.exiting("AE0040010Control"+":USER="+struct.getsUser_ID(),"controlPREPARATION");
...
//			e.printStackTrace();
//			throw new FoundationException("AE0040010Control",e.getMessage(),"control_eventHandllerメソッドでエラーが発生しました。");
	...
	public void createDefaultCSV(List list, String sTitle[]) throws BusinessProcessException, FoundationException {
		...
		//{{user_implement_dev:<createDefaultCSV>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AE0040010-E999","CSVの出力処理"));
			throw new FoundationException("AE0040010Control",e.getMessage(),"createDefaultCSVメソッドでエラーが発生しました。");
		}
...
//				objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AE0040010-E999","システム日付の取得処理"));
				throw new FoundationException("AE0040010Control","beginTransaction()","システム日付取得処理でエラーが発生しました。");
			}
		...
		//{{user_implement_dev:<beginTransaction>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AE0040010-E999","コントロールのイベント処理"));
			throw new FoundationException("AE0040010Control",e.getMessage(),"beginTransactionメソッドでエラーが発生しました。");
		}
	 ...
	 * メンバ変数の定義
	 */
	protected AE0040010Entity entity;
	protected AE0040010Struct struct;
	...
	public void initialize() throws FoundationException
	{
		...
		entity = new AE0040010Entity();
		struct = new AE0040010Struct();
	...
	/**
	 * AE0040010クラスの標準コンストラクタ
	 */
	public AE0040010Control() throws BusinessProcessException, FoundationException
	{
		initialize();
	...
	public void setOrMsgKey(List keyList) throws MessageApiException {
		...
		for (int i = 0; msgKeyTypeArray != null && i < msgKeyTypeArray.size(); i++) {
			...
			for(int j = 0; j < keyList.size(); j++) {
				AE0040010Struct key = (AE0040010Struct)keyList.get(j);
				// メッセージキーを作成する
				MessageKey msgKey = new MessageKey(tableName, keyColumnName);
				if(msgKeyType.containsKeyColumn("r_OUTPUT_TYPE") && key.getr_OUTPUT_TYPE() != null) {
					msgKey.setKeyValue("r_OUTPUT_TYPE", key.getr_OUTPUT_TYPE());
				}
				if(msgKeyType.containsKeyColumn("r2_OUTPUT_TYPE") && key.getr2_OUTPUT_TYPE() != null) {
					msgKey.setKeyValue("r2_OUTPUT_TYPE", key.getr2_OUTPUT_TYPE());
				}
				if(msgKeyType.containsKeyColumn("c_REOUTPUT") && key.getc_REOUTPUT() != null) {
					msgKey.setKeyValue("c_REOUTPUT", key.getc_REOUTPUT());
				}
				...
				if(msgKeyType.containsKeyColumn("PUCH_ODR_EDI_ISS_DATE") && key.getPUCH_ODR_EDI_ISS_DATE() != null) {
					msgKey.setKeyValue("PUCH_ODR_EDI_ISS_DATE", key.getPUCH_ODR_EDI_ISS_DATE());
				}
		...
		try {
			for (int i = 0; msgKeyTypeArray != null && i < msgKeyTypeArray.size(); i++) {
				...
				for (int j = 0; msgKeyArray != null && j < msgKeyArray.size(); j++) {
					...
					AE0040010Struct key = new AE0040010Struct();
					if(msgKeyType.containsKeyColumn("r_OUTPUT_TYPE")) {
						key.setr_OUTPUT_TYPE(msgKey.getKeyValue("r_OUTPUT_TYPE"));
					}
					if(msgKeyType.containsKeyColumn("r2_OUTPUT_TYPE")) {
						key.setr2_OUTPUT_TYPE(msgKey.getKeyValue("r2_OUTPUT_TYPE"));
					}
					if(msgKeyType.containsKeyColumn("c_REOUTPUT")) {
						key.setc_REOUTPUT(msgKey.getKeyValue("c_REOUTPUT"));
					}
					...
					if(msgKeyType.containsKeyColumn("PUCH_ODR_EDI_ISS_DATE")) {
						key.setPUCH_ODR_EDI_ISS_DATE(msgKey.getKeyValue("PUCH_ODR_EDI_ISS_DATE"));
					}
