/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DE0020/src/com/nec/jp/orteus/metamorBase/DE0020/DE0020B001/SQLCSMASTDELETE.java,v $
 *
...
public class SQLCSMASTDELETE extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public List call() throws BatchAppException
		{
			try {
				...
				cstmt.setString(8, m_med.getpnumDelFlg1());
				cstmt.setString(9, m_med.getpnumDelFlg2());
				cstmt.setString(10, m_med.getpnumDelFlg3());
				...
				e.printStackTrace();
				BatchAppException be=new BatchAppException("SQLCSMASTDELETE", "call", "Stored Procedure条件設定処理失敗");
				...
				if (cstmt != null) {
					try {
						...
						ef.printStackTrace();
						BatchAppException bef = new BatchAppException("SQLCSMASTDELETE", "call", "Stored Procedureクローズ処理失敗");
		 ...
		 */
		public medDE0020B001 call(ResultSet rs) throws SQLException
		{
			if(rs == null || rs.next()==false) return null;
			medDE0020B001 data = new medDE0020B001();
			m_med.setpnumReturn(cstmt.getString(11));
			return data;
		}
	...
	/**
	 * SQLCSMASTDELETEクラスの標準コンストラクタ
	 *
		 */
	public SQLCSMASTDELETE(medDE0020B001 med, BatchAppConductor cdr) throws SystemException
	{
	...
	protected static String m_calcmd = "{" + "call SQLCSMASTDELETE(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" + "}";
