/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DE0020/src/com/nec/jp/orteus/metamorBase/DE0020/DE0020B001/cdrDE0020B001.java,v $
 *
...
public class cdrDE0020B001 extends Object
		implements IBatchAppCommon
{
	...
	public void initialize() throws BatchAppException, SystemException
	{
		try {
			...
			m_med.setSQLCSMASTDELETE( new SQLCSMASTDELETE(m_med, m_conductor) );
			...
			m_conductor.addObject( m_med.getSQLCSMASTDELETE() );
	...
	public int getType() { return m_conductor.getType(); }
        ...
        public int beginProc() throws BatchAppException
        {
         try {
          ...
          setCommitFlag(false);
          BatchAppException be=new BatchAppException("cdrDE0020B001", "beginProc", "conductorの初期処理に失敗しました");
	...
	medDE0020B001 m_med=new medDE0020B001();

	// BatchAppConductorクラスインスタンス
	BatchAppConductor m_conductor=new BatchAppConductor("DE0020B001");
	...
	/**
	 * ctrDE0020B001クラス 標準コンストラクタ
	 *
		 */
	public cdrDE0020B001() throws BatchAppException
	{
		initialize();
