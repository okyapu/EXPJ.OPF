/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DE0040/src/com/nec/jp/orteus/metamorBase/DE0040/DE0040B001/mainDE0040B001.java,v $
 *
...
/**
 * CLASS     : mainDE0040B001 クラス
 * ファイル・クラス説明
 * @author $Author: xl-hs-zzw $
 * @version $Revision: 1.6 $ $Date: 2014/11/05 07:27:40 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class mainDE0040B001
{
    // リターン値
	...
	public static void main(String args[])
	{
		...
		try {
			...
			if (sysLog == null) {
				...
				if(!sysLog.init("com.nec.jp.orteus.metamorBase.DE0040B001")) {
					//システムログの初期化に失敗しました
			...
			try {
				...
				// 標準出力ファイル名設定
				String logFileName = "DE0040B001.log";
				if (logFileName == null) {
				...
				// 新規作成のためバッチログファイル削除
				if (blogMode == false) {
					File logFile = new File(logOutputPath + "/DE0040B001.log");
				...
				System.setOut(new PrintStream(new FileOutputStream(logOutputPath + "/DE0040B001stdout.log", blogMode)));
				System.setErr(new PrintStream(new FileOutputStream(logOutputPath + "/DE0040B001stderr.log", blogMode)));
			...
			cdrDE0040B001 ebo = new cdrDE0040B001();
