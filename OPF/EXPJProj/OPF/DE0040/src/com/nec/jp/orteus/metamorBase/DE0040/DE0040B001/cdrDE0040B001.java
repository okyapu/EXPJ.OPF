/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DE0040/src/com/nec/jp/orteus/metamorBase/DE0040/DE0040B001/cdrDE0040B001.java,v $
 *
...
public class cdrDE0040B001 extends Object
		implements IBatchAppCommon
{
	...
	public void initialize() throws BatchAppException, SystemException
	{
		try {
			...
			m_med.setSQLCSCALCTRNDELETE( new SQLCSCALCTRNDELETE(m_med, m_conductor) );
			...
			m_conductor.addObject( m_med.getSQLCSCALCTRNDELETE() );
	...
	public int getType() { return m_conductor.getType(); }
        ...
        public int beginProc() throws BatchAppException
        {
         try {
          ...
          setCommitFlag(false);
          BatchAppException be=new BatchAppException("cdrDE0040B001", "beginProc", "conductorの初期処理に失敗しました");
	...
	medDE0040B001 m_med=new medDE0040B001();

	// BatchAppConductorクラスインスタンス
	BatchAppConductor m_conductor=new BatchAppConductor("DE0040B001");
	...
	/**
	 * ctrDE0040B001クラス 標準コンストラクタ
	 *
		 */
	public cdrDE0040B001() throws BatchAppException
	{
		initialize();
