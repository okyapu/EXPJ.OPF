/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DE0040/src/com/nec/jp/orteus/metamorBase/DE0040/DE0040010Control.java,v $
 *
...
import com.nec.jp.orteus.metamorBase.DE0040.*;
...
public class DE0040010Control
{
	...
	//{{user_implement_code_main
        ...
        public DE0040010Struct getListvalue(int x) {
         return (DE0040010Struct) (this.list.get(x));
        } // リストの値を返します。
        public DE0040010Struct getStruct() {
         return this.struct;
        } // Structを返します。
        public DE0040010Struct createStruct() {
         return new DE0040010Struct();
        } // 新しいStructを作って返します。
        public void setStruct(Object structname) {
         this.struct.setStruct((DE0040010Struct) structname);
        } // Structをセットします。
         ...
         * @param s 検索したデータ
         */
        private void setStruct(DE0040010Struct s) {
       
         struct.setCS_CALC_TRN_PERIOD(s.m_CS_CALC_TRN_PERIOD);
         ...
         */
        private void executeBatchProgram(DE0040010Struct s) throws IOException {
...
//         // 呼び出し先クラス
//         buffer.append(" com.nec.jp.orteus.metamorBase.DE0040.DE0040B001.mainDE0040B001");
//         // バッチ処理区分
...
//         // 原価計算トラン保持期間	
//         buffer.append(" ").append(s.getCS_CALC_TRN_PERIOD());
//         // バッチ処理実行
...
//         runtime.exec(buffer.toString());
      ...
      // 呼び出し先クラス
         buffer.add("com.nec.jp.orteus.metamorBase.DE0040.DE0040B001.mainDE0040B001");
         // バッチ処理区分
         ...
         // 原価計算トラン保持期間	
         buffer.add(s.getCS_CALC_TRN_PERIOD());
         // バッチコマンドを実行
         Runtime runtime = Runtime.getRuntime();
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.DE0040");
		logger.entering("DE0040010Control"+":USER="+struct.getsUser_ID(),"controlExecute");
			//{{user_implement_dev:<controlExecute>
                ...
                try {
                 ...
                 // データを取得
                 DE0040010Struct formStruct = (DE0040010Struct) formList.get(0);
                ...
                //}}user_implement_dev:<controlExecute>
		logger.exiting("DE0040010Control"+":USER="+struct.getsUser_ID(),"controlExecute");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.DE0040");
		logger.entering("DE0040010Control"+":USER="+struct.getsUser_ID(),"controlClear");
			//{{user_implement_dev:<controlClear>
                initializeAll();
                //}}user_implement_dev:<controlClear>
		logger.exiting("DE0040010Control"+":USER="+struct.getsUser_ID(),"controlClear");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.DE0040");
		logger.entering("DE0040010Control"+":USER="+struct.getsUser_ID(),"controlSelect");
			//{{user_implement_dev:<controlSelect>
                try {
                 ...
                 if (mPlantList.isEmpty()) {
                  ...
                  DE0040010Struct plantStruct = (DE0040010Struct) mPlantList.get(0);
                ...
                //}}user_implement_dev:<controlSelect>
		logger.exiting("DE0040010Control"+":USER="+struct.getsUser_ID(),"controlSelect");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.DE0040");
		logger.entering("DE0040010Control"+":USER="+struct.getsUser_ID(),"controlINITIAL");
		//{{user_implement_dev:<controlINITIAL>
                //}}user_implement_dev:<controlINITIAL>
		logger.exiting("DE0040010Control"+":USER="+struct.getsUser_ID(),"controlINITIAL");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.DE0040");
		logger.entering("DE0040010Control"+":USER="+struct.getsUser_ID(),"controlRELOAD");
		//{{user_implement_dev:<controlRELOAD>
                ...
                //}}user_implement_dev:<controlRELOAD>
		logger.exiting("DE0040010Control"+":USER="+struct.getsUser_ID(),"controlRELOAD");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.DE0040");
		logger.entering("DE0040010Control"+":USER="+struct.getsUser_ID(),"controlPREPARATION");
...
//		}
		...
		//{{user_implement_dev:<controlPREPARATION>
                ...
                struct.setList_COST_TYP_name(_costTypComboStruct.getExplanList());
                //}}user_implement_dev:<controlPREPARATION>
		logger.exiting("DE0040010Control"+":USER="+struct.getsUser_ID(),"controlPREPARATION");
...
//			e.printStackTrace();
//			throw new FoundationException("DE0040010Control",e.getMessage(),"control_eventHandllerメソッドでエラーが発生しました。");
	...
	public void createDefaultCSV(List list, String sTitle[]) throws BusinessProcessException, FoundationException {
		...
		//{{user_implement_dev:<createDefaultCSV>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("DE0040010-E999","CSVの出力処理"));
			throw new FoundationException("DE0040010Control",e.getMessage(),"createDefaultCSVメソッドでエラーが発生しました。");
		}
...
//				objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("DE0040010-E999","システム日付の取得処理"));
				throw new FoundationException("DE0040010Control","beginTransaction()","システム日付取得処理でエラーが発生しました。");
			}
		...
		//{{user_implement_dev:<beginTransaction>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("DE0040010-E999","コントロールのイベント処理"));
			throw new FoundationException("DE0040010Control",e.getMessage(),"beginTransactionメソッドでエラーが発生しました。");
		}
	 ...
	 * メンバ変数の定義
	 */
	protected DE0040010Entity entity;
	protected DE0040010Struct struct;
	...
	public void initialize() throws FoundationException
	{
		...
		entity = new DE0040010Entity();
		struct = new DE0040010Struct();
	...
	/**
	 * DE0040010クラスの標準コンストラクタ
	 */
	public DE0040010Control() throws BusinessProcessException, FoundationException
	{
		initialize();
	...
	public void setOrMsgKey(List keyList) throws MessageApiException {
		...
		for (int i = 0; msgKeyTypeArray != null && i < msgKeyTypeArray.size(); i++) {
			...
			for(int j = 0; j < keyList.size(); j++) {
				DE0040010Struct key = (DE0040010Struct)keyList.get(j);
				// メッセージキーを作成する
		...
		try {
			for (int i = 0; msgKeyTypeArray != null && i < msgKeyTypeArray.size(); i++) {
				...
				for (int j = 0; msgKeyArray != null && j < msgKeyArray.size(); j++) {
					...
					DE0040010Struct key = new DE0040010Struct();
