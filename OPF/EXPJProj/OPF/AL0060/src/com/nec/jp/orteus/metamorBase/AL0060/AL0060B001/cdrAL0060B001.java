/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AL0060/src/com/nec/jp/orteus/metamorBase/AL0060/AL0060B001/cdrAL0060B001.java,v $
 *
...
public class cdrAL0060B001 extends Object
		implements IBatchAppCommon
{
	...
	public void initialize() throws BatchAppException, SystemException
	{
		try {
			...
			m_med.setcallSqlLoadCalcBat( new callSqlLoadCalcBat(m_med, m_conductor) );
			m_med.setCtrlMain( new CtrlMain(m_med, m_conductor) );
			m_conductor.addObject( m_med.getreadSysBatParm() );
			m_conductor.addObject( m_med.getcallSqlLoadCalcBat() );
	...
	public int getType() { return m_conductor.getType(); }
        ...
        public int beginProc() throws BatchAppException
        {
         try {
          ...
          setCommitFlag(false);
          BatchAppException be=new BatchAppException("cdrAL0060B001", "beginProc", "conductorの初期処理に失敗しました");
	...
	medAL0060B001 m_med=new medAL0060B001();

	// BatchAppConductorクラスインスタンス
	BatchAppConductor m_conductor=new BatchAppConductor("AL0060B001");
	...
	/**
	 * ctrAL0060B001クラス 標準コンストラクタ
	 *
		 */
	public cdrAL0060B001() throws BatchAppException
	{
		initialize();
