/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AL0060/src/com/nec/jp/orteus/metamorBase/AL0060/AL0060B001/mainAL0060B001.java,v $
 *
...
/**
 * CLASS     : mainAL0060B001 クラス
 * ファイル・クラス説明
 * @author $Author: xl-hs-zzw $
 * @version $Revision: 1.5 $ $Date: 2014/11/05 07:19:55 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class mainAL0060B001
{
    // リターン値
	...
	public static void main(String args[])
	{
		...
		try {
			...
			if (sysLog == null) {
				...
				if(!sysLog.init("com.nec.jp.orteus.metamorBase.AL0060B001")) {
					//システムログの初期化に失敗しました
			...
			try {
				...
				// 標準出力ファイル名設定
				String logFileName = "AL0060B001.log";
				if (logFileName == null) {
				...
				// 新規作成のためバッチログファイル削除
				if (blogMode == false) {
					File logFile = new File(logOutputPath + "/AL0060B001.log");
				...
				System.setOut(new PrintStream(new FileOutputStream(logOutputPath + "/AL0060B001stdout.log", blogMode)));
				System.setErr(new PrintStream(new FileOutputStream(logOutputPath + "/AL0060B001stderr.log", blogMode)));
			...
			cdrAL0060B001 ebo = new cdrAL0060B001();
