/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AL0060/src/com/nec/jp/orteus/metamorBase/AL0060/AL0060B001/callSqlLoadCalcBat.java,v $
 *
...
/**
 * CLASS     : callSqlLoadCalcBat クラス
 * ファイル・クラス説明
 * @author $Author: xl-hs-zzw $
 * @version $Revision: 1.4 $ $Date: 2014/11/05 07:19:54 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class callSqlLoadCalcBat extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public List call() throws BatchAppException
		{
			try {
				...
				cstmt.setString(8, m_med.getpdtmCalcFromDate());
				cstmt.setString(9, m_med.getpdtmCalcToDate());


				cstmt.execute();

				List list = new ArrayList();
				medAL0060B001 data = null;
				...
				e.printStackTrace();
				BatchAppException be=new BatchAppException("callSqlLoadCalcBat", "call", "Stored Procedure条件設定処理失敗");
				...
				if (cstmt != null) {
					try {
						...
						ef.printStackTrace();
						BatchAppException bef = new BatchAppException("callSqlLoadCalcBat", "call", "Stored Procedureクローズ処理失敗");
		 ...
		 */
		public medAL0060B001 call(ResultSet rs) throws SQLException
		{
			if(rs == null || rs.next()==false) return null;
			medAL0060B001 data = new medAL0060B001();
			return data;
		}
	...
	/**
	 * callSqlLoadCalcBatクラスの標準コンストラクタ
	 *
		 */
	public callSqlLoadCalcBat(medAL0060B001 med, BatchAppConductor cdr) throws SystemException
	{
	...
	protected static String m_calcmd = "{" + "call SqlLoadCalcBat(?,?,?,?,?,?,?,?,?)" + "}";
