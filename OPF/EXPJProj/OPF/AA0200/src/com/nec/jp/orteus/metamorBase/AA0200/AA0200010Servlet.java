/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AA0200/src/com/nec/jp/orteus/metamorBase/AA0200/AA0200010Servlet.java,v $
 *
...
public class AA0200010Servlet extends HttpServlet
{
	 ...
	 * @param control AA0200010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AA0200010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AA0200010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AA0200010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AA0200010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AA0200010Entity entity = control.entity;
		AA0200010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AA0200010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
			// TODO: ユーザ定義のコードを記述してください
//			LogWriter.write( Level.ALL, "AA0200010"+" $Revision: 1.2 $" );
			control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AA0200010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AA0200010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AA0200010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0200");
		logger.entering("AA0200010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
...
//			e.printStackTrace();
//			LogWriter.write(Level.ALL, objMessage.getIDMsg("AA0200010-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
		}
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AA0200010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickCsvImport(
					...
					HttpSession so,
					Hashtable params,
					AA0200010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = "/AA0200011.jsp";		// 移動先ＵＲＬ
		AA0200010Entity entity = control.entity;
		AA0200010Struct struct = control.struct;
		getSessionParameters(so, params, struct);

		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0200");
		logger.entering("AA0200010Servlet"+":USER="+request.getRemoteUser(),"onClickCsvImport");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickCsvImport>
		logger.exiting("AA0200010Servlet"+":USER="+request.getRemoteUser(),"onClickCsvImport");
					...
					AA0200010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0200");
		logger.entering("AA0200010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("AA0200010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
					...
					AA0200010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0200");
		logger.entering("AA0200010Servlet"+":USER="+request.getRemoteUser(),"onClickClose");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClose>
		logger.exiting("AA0200010Servlet"+":USER="+request.getRemoteUser(),"onClickClose");
					...
					AA0200010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0200");
		logger.entering("AA0200010Servlet"+":USER="+request.getRemoteUser(),"onClickBrowse");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickBrowse>
		logger.exiting("AA0200010Servlet"+":USER="+request.getRemoteUser(),"onClickBrowse");
					...
					AA0200010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0200");
		logger.entering("AA0200010Servlet"+":USER="+request.getRemoteUser(),"onClickCsvIn");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickCsvIn>
		logger.exiting("AA0200010Servlet"+":USER="+request.getRemoteUser(),"onClickCsvIn");
					...
					AA0200010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0200");
		logger.entering("AA0200010Servlet"+":USER="+request.getRemoteUser(),"onClickCSVOut");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickCSVOut>
		logger.exiting("AA0200010Servlet"+":USER="+request.getRemoteUser(),"onClickCSVOut");
					...
					AA0200010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0200");
		logger.entering("AA0200010Servlet"+":USER="+request.getRemoteUser(),"onClickreturn_sub1");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickreturn_sub1>
		logger.exiting("AA0200010Servlet"+":USER="+request.getRemoteUser(),"onClickreturn_sub1");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AA0200010Struct struct)
	{
	...
	public static String DEFAULT_TARGET = "/AA0200010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAA0200010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAA0200010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0200");
		logger.entering("AA0200010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AA0200010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AA0200010Control control;
		AA0200010Entity  entity = null;
		AA0200010Struct  struct = null;
		...
		try {
			...
			if( (control = (AA0200010Control)so.getAttribute("AA0200010Control_"+request.getSession(false).getId())) == null ) {
				control = new AA0200010Control();
			...
			try {
				...
				so.setAttribute("AA0200010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.AA0200.AA0200010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AA0200010Servlet()
	{
		//{{user_implement_dev:<AA0200010_DisConnect_FLG>
		...
		//{{user_implement_dev:<AA0200010Servlet>
