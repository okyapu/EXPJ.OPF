/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DE0030/src/com/nec/jp/orteus/metamorBase/DE0030/DE0030B001/mainDE0030B001.java,v $
 *
...
/**
 * CLASS     : mainDE0030B001 クラス
 * ファイル・クラス説明
 * @author $Author: xl-hs-zzw $
 * @version $Revision: 1.6 $ $Date: 2014/11/05 07:27:11 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class mainDE0030B001
{
    // リターン値
	...
	public static void main(String args[])
	{
		...
		try {
			...
			if (sysLog == null) {
				...
				if(!sysLog.init("com.nec.jp.orteus.metamorBase.DE0030B001")) {
					//システムログの初期化に失敗しました
			...
			try {
				...
				// 標準出力ファイル名設定
				String logFileName = "DE0030B001.log";
				if (logFileName == null) {
				...
				// 新規作成のためバッチログファイル削除
				if (blogMode == false) {
					File logFile = new File(logOutputPath + "/DE0030B001.log");
				...
				System.setOut(new PrintStream(new FileOutputStream(logOutputPath + "/DE0030B001stdout.log", blogMode)));
				System.setErr(new PrintStream(new FileOutputStream(logOutputPath + "/DE0030B001stderr.log", blogMode)));
			...
			cdrDE0030B001 ebo = new cdrDE0030B001();
