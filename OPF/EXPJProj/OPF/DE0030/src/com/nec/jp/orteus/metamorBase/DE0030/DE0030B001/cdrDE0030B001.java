/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DE0030/src/com/nec/jp/orteus/metamorBase/DE0030/DE0030B001/cdrDE0030B001.java,v $
 *
...
public class cdrDE0030B001 extends Object
		implements IBatchAppCommon
{
	...
	public void initialize() throws BatchAppException, SystemException
	{
		try {
			...
			m_med.setSQLCSMASTIFDELETE( new SQLCSMASTIFDELETE(m_med, m_conductor) );
			...
			m_conductor.addObject( m_med.getSQLCSMASTIFDELETE() );
	...
	public int getType() { return m_conductor.getType(); }
        ...
        public int beginProc() throws BatchAppException
        {
         try {
          ...
          setCommitFlag(false);
          BatchAppException be=new BatchAppException("cdrDE0030B001", "beginProc", "conductorの初期処理に失敗しました");
	...
	medDE0030B001 m_med=new medDE0030B001();

	// BatchAppConductorクラスインスタンス
	BatchAppConductor m_conductor=new BatchAppConductor("DE0030B001");
	...
	/**
	 * ctrDE0030B001クラス 標準コンストラクタ
	 *
		 */
	public cdrDE0030B001() throws BatchAppException
	{
		initialize();
