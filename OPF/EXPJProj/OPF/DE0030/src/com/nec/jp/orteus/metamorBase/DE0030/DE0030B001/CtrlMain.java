/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DE0030/src/com/nec/jp/orteus/metamorBase/DE0030/DE0030B001/CtrlMain.java,v $
 *
 ...
 * @version $Revision: 1.7 $ $Date: 2014/11/05 07:27:10 $
 */
		...
		implements IBatchAppCommon
{
	 ...
	 *
		 */
	public CtrlMain(medDE0030B001 med, BatchAppConductor cdr) throws BatchAppException
	{
		// メンバ変数を初期化します
		m_conductor = cdr;
		m_med = med;
	...
	//{{user_implement_code
         ...
         *
         */
        public CtrlMain(medDE0030B001 med) throws BatchAppException {
         // メンバ変数を初期化します
         m_med = med;
         m_control = new interControl(med);
        ...
        private boolean checkArgs() throws BatchAppException {
         ...
         if ("0".equals(getDeleteItemCsProcIf())
          && "0".equals(getDeleteProcCostIf())
          && "0".equals(getDeleteCsPuchIf())) {
        ...
        /**
         * バッチパラメータ(7)品目別工程IF削除対象フラグを返します。<br>
         * Nullの場合(初期値:0)を返します。
         * @return 品目別工程IF削除対象フラグ 
         */
        private String getDeleteItemCsProcIf() {
         String[] args = m_med.getArgs();
         if (isNull(args[6])) {
          return "0";
         }
        ...
        /**
         * バッチパラメータ(8)加工費IF削除対象フラグを返します。<br>
         * Nullの場合(初期値:0)を返します。
         * @return 加工費IF削除対象フラグ 
         */
        private String getDeleteProcCostIf() {
         String[] args = m_med.getArgs();
         if (isNull(args[7])) {
          return "0";
         }
        ...
        /**
         * バッチパラメータ(9)購入品IF削除対象フラグを返します。<br>
         * Nullの場合(初期値:0)を返します。
         * @return 購入品IF削除対象フラグ 
         */
        private String getDeleteCsPuchIf() {
         String[] args = m_med.getArgs();
         if (isNull(args[8])) {
          return "0";
         }
        ...
        private String excuteProcedure() throws BatchAppException {
         ...
         m_med.setFUNCTION_NAME("SQLCSMASTIFDELETE");
         ...
         m_med.setpnumDelFlg1(getDeleteItemCsProcIf());
         m_med.setpnumDelFlg2(getDeleteProcCostIf());
         m_med.setpnumDelFlg3(getDeleteCsPuchIf());
         ...
         List callList = m_med.getSQLCSMASTIFDELETE().call();
       
         // PL/SQLの実行結果を取得
         medDE0030B001 resultMed = (medDE0030B001) callList.get(0);
		...
		implements IBatchAppCommon
	{
		...
		public interControl(medDE0030B001 med) throws BatchAppException
		{
			// 各メンバ変数の初期化
			m_med = med;
