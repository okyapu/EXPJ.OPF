...
public class DE0030010Struct extends DataStruct
{
	...
	/** 第 8 変数： m_c_DeleteItemCsProcIf */
	public String m_c_DeleteItemCsProcIf = null;
	/** 第 9 変数： m_c_DeleteProcCostIf */
	public String m_c_DeleteProcCostIf = null;
	/** 第 10 変数： m_c_DeleteCsPuchIf */
	...
	/** 第 3 List変数： l_CS_MAST_IF_PERIOD */
	...
	/** 第 8 List変数： l_c_DeleteItemCsProcIf */
	public List l_c_DeleteItemCsProcIf = null;

	/** 第 9 List変数： l_c_DeleteProcCostIf */
	public List l_c_DeleteProcCostIf = null;

	/** 第 10 List変数： l_c_DeleteCsPuchIf */
