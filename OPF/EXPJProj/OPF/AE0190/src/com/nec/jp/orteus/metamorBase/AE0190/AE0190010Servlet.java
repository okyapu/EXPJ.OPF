/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0190/src/com/nec/jp/orteus/metamorBase/AE0190/AE0190010Servlet.java,v $
 *
...
public class AE0190010Servlet extends HttpServlet
{
	 ...
	 * @param control AE0190010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AE0190010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AE0190010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AE0190010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AE0190010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AE0190010Entity entity = control.entity;
		AE0190010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AE0190010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
			// TODO: ユーザ定義のコードを記述してください
//			LogWriter.write( Level.ALL, "AE0190010"+" $Revision: 1.1 $" );
			control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AE0190010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AE0190010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AE0190010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0190");
		logger.entering("AE0190010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
...
//			e.printStackTrace();
//			LogWriter.write(Level.ALL, objMessage.getIDMsg("AE0190010-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
		}
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AE0190010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickSelect(
					...
					HttpSession so,
					Hashtable params,
					AE0190010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AE0190010Entity entity = control.entity;
		AE0190010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0190");
		logger.entering("AE0190010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickSelect>
		logger.exiting("AE0190010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
					...
					AE0190010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0190");
		logger.entering("AE0190010Servlet"+":USER="+request.getRemoteUser(),"onClickSelectUnitCost");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickSelectUnitCost>
		logger.exiting("AE0190010Servlet"+":USER="+request.getRemoteUser(),"onClickSelectUnitCost");
					...
					AE0190010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0190");
		logger.entering("AE0190010Servlet"+":USER="+request.getRemoteUser(),"onClickInsert");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickInsert>
		logger.exiting("AE0190010Servlet"+":USER="+request.getRemoteUser(),"onClickInsert");
					...
					AE0190010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0190");
		logger.entering("AE0190010Servlet"+":USER="+request.getRemoteUser(),"onClickUpdate");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickUpdate>
		logger.exiting("AE0190010Servlet"+":USER="+request.getRemoteUser(),"onClickUpdate");
					...
					AE0190010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0190");
		logger.entering("AE0190010Servlet"+":USER="+request.getRemoteUser(),"onClickDelete");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickDelete>
		logger.exiting("AE0190010Servlet"+":USER="+request.getRemoteUser(),"onClickDelete");
					...
					AE0190010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0190");
		logger.entering("AE0190010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("AE0190010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AE0190010Struct struct)
	{
		...
		String[] h_ALC_GRP_CD = ((params.containsKey("h_ALC_GRP_CD")) ? (String[])params.get("h_ALC_GRP_CD") : (String[])null);
		...
		struct.seth_ALC_GRP_CD( ((h_ALC_GRP_CD == null) ? (String)null : h_ALC_GRP_CD[0]) );
		struct.setList_h_ALC_GRP_CD(TypeConverter.convert(h_ALC_GRP_CD));
	...
	public static String DEFAULT_TARGET = "/AE0190010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAE0190010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAE0190010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0190");
		logger.entering("AE0190010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AE0190010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AE0190010Control control;
		AE0190010Entity  entity = null;
		AE0190010Struct  struct = null;
		...
		try {
			...
			if( (control = (AE0190010Control)so.getAttribute("AE0190010Control_"+request.getSession(false).getId())) == null ) {
				control = new AE0190010Control();
			...
			try {
				...
				so.setAttribute("AE0190010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.AE0190.AE0190010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AE0190010Servlet()
	{
		//{{user_implement_dev:<AE0190010_DisConnect_FLG>
		...
		//{{user_implement_dev:<AE0190010Servlet>
