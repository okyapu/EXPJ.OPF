/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KP0060/src/com/nec/jp/orteus/metamorBase/KP0060/KP0060B001/insertT_OD.java,v $
 *
...
public class insertT_OD extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setTOTAL_ISSUE_INST_QTY_C(String value) throws FoundationException { getAdapt_C().setString(24, value); }
		public void setTOTAL_ISSUE_QTY_C(String value) throws FoundationException { getAdapt_C().setString(25, value); }
		...
		public int create() throws BatchAppException
		{
			try {
				...
				setTOTAL_ISSUE_INST_QTY_C(m_med.getTOTAL_SHIP_QTY());
				setTOTAL_ISSUE_QTY_C(m_med.getTOTAL_SHIP_QTY());
	 ...
	 *
		 */
	public insertT_OD(medKP0060B001 med, BatchAppConductor cdr) throws SystemException
	{
...
+"  T_OD(OD_NO, PLANT_CD, ITEM_CD, DM_STS_TYP, OD_TYP, DUE_DATE, PRD_DUE_DATE, DM_QTY, MRP_ODR_TYP, OUTSIDE_TYP, ISSUE_TYP, ODR_LT, FIXED_LT, PROP_LT, SAFETY_LT, ISSUE_LT, PROP_LOT_SIZE, OD_GNR_TYP, OD_LEVEL_NO, ITEM_SPOIL, MRP_TYP, TOTAL_ISSUE_INST_QTY, TOTAL_ISSUE_QTY, ODR_STS_TYP, CONS_TYP) "
+"values "
+"  (?, ?, ?, 2, 3, to_date(?, 'YYYY/MM/DD'), to_date(?, 'YYYY/MM/DD'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 6, ?, ?, 1, ?, ?, 0, 0)";
