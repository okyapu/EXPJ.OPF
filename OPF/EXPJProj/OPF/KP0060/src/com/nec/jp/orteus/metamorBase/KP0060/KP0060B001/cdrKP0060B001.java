/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KP0060/src/com/nec/jp/orteus/metamorBase/KP0060/KP0060B001/cdrKP0060B001.java,v $
 *
...
public class cdrKP0060B001 extends Object
		implements IBatchAppCommon
{
	...
	public void initialize() throws BatchAppException, SystemException
	{
		try {
			...
			m_med.setreadT_ODR( new readT_ODR(m_med, m_conductor) );
			m_med.setreadTOTAL_SHIP_QTY( new readTOTAL_SHIP_QTY(m_med, m_conductor) );
			...
			m_conductor.addObject( m_med.getreadT_ODR() );
			m_conductor.addObject( m_med.getreadTOTAL_SHIP_QTY() );
	...
	public int beginProc() throws BatchAppException
	{
		try {
			...
			setCommitFlag(false);
			BatchAppException be=new BatchAppException("cdrKP0060B001", "beginProc", "conductorの初期処理に失敗しました");
	...
	medKP0060B001 m_med=new medKP0060B001();

	// BatchAppConductorクラスインスタンス
	BatchAppConductor m_conductor=new BatchAppConductor("KP0060B001");
	...
	/**
	 * ctrKP0060B001クラス 標準コンストラクタ
	 *
		 */
	public cdrKP0060B001() throws BatchAppException
	{
		initialize();
