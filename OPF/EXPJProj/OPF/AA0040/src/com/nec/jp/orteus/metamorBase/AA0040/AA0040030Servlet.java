/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AA0040/src/com/nec/jp/orteus/metamorBase/AA0040/AA0040030Servlet.java,v $
 *
...
public class AA0040030Servlet extends HttpServlet
{
	 ...
	 * @param control AA0040030Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AA0040030Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AA0040030Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AA0040030Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AA0040030Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AA0040030Entity entity = control.entity;
		AA0040030Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AA0040030Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
			
			objMessage.m_writer.write( Level.ALL, "AA0040030"+" $Revision: 1.13 $" );
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AA0040030Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AA0040030Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AA0040030Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0040");
		logger.entering("AA0040030Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
		...
		try {
			...
			if(control.isScreenMove() && !"AA0140030".equals(control.getScreenId())) {
				// getSessionParameters(so, params, struct);
				control.control_eventHandller("select");
				nextUrl = "/AA0040031.jsp";
			}else if(control.isScreenMove() && "AA0140030".equals(control.getScreenId())) {
				//control.control_eventHandller("select");
				nextUrl = "/AA0040030.jsp";				
			}
		} catch ( FoundationException e ) {
			ExpjException ee = new ExpjException(e, "ZZ01106");
			...
			throw ee;
                ...
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AA0040030Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickselect(
					...
					HttpSession so,
					Hashtable params,
					AA0040030Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AA0040030Entity entity = control.entity;
		AA0040030Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0040");
		logger.entering("AA0040030Servlet"+":USER="+request.getRemoteUser(),"onClickselect");
		...
		//------------------------------------------------------------------
                //}}user_implement_dev:<onClickselect>
		logger.exiting("AA0040030Servlet"+":USER="+request.getRemoteUser(),"onClickselect");
					...
					AA0040030Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0040");
		logger.entering("AA0040030Servlet"+":USER="+request.getRemoteUser(),"onClickclear");
		...
		//------------------------------------------------------------------
                //}}user_implement_dev:<onClickclear>
		logger.exiting("AA0040030Servlet"+":USER="+request.getRemoteUser(),"onClickclear");
					...
					AA0040030Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0040");
		logger.entering("AA0040030Servlet"+":USER="+request.getRemoteUser(),"onClicksub1Insert");
		...
		//------------------------------------------------------------------
                //}}user_implement_dev:<onClicksub1Insert>
		logger.exiting("AA0040030Servlet"+":USER="+request.getRemoteUser(),"onClicksub1Insert");
					...
					AA0040030Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0040");
		logger.entering("AA0040030Servlet"+":USER="+request.getRemoteUser(),"onClicksub1Update");
		...
		//------------------------------------------------------------------
                //}}user_implement_dev:<onClicksub1Update>
		logger.exiting("AA0040030Servlet"+":USER="+request.getRemoteUser(),"onClicksub1Update");
					...
					AA0040030Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0040");
		logger.entering("AA0040030Servlet"+":USER="+request.getRemoteUser(),"onClickcancelSub1");
		...
		//------------------------------------------------------------------
                //}}user_implement_dev:<onClickcancelSub1>
		logger.exiting("AA0040030Servlet"+":USER="+request.getRemoteUser(),"onClickcancelSub1");
					...
					AA0040030Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0040");
		logger.entering("AA0040030Servlet"+":USER="+request.getRemoteUser(),"onClickappend");
		...
		//------------------------------------------------------------------
                //}}user_implement_dev:<onClickappend>
		logger.exiting("AA0040030Servlet"+":USER="+request.getRemoteUser(),"onClickappend");
					...
					AA0040030Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0040");
		logger.entering("AA0040030Servlet"+":USER="+request.getRemoteUser(),"onClickmodify");
		//{{user_implement_dev:<onClickmodify>
		//------------------------------------------------------------------
		try {

			// 修正対象No取得
//		      control.setCheckNumber(new Integer(request.getParameter("rBtn")));
		...
		//------------------------------------------------------------------
                //}}user_implement_dev:<onClickmodify>
		logger.exiting("AA0040030Servlet"+":USER="+request.getRemoteUser(),"onClickmodify");
					...
					AA0040030Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0040");
		logger.entering("AA0040030Servlet"+":USER="+request.getRemoteUser(),"onClickcopy");
		...
		//------------------------------------------------------------------
                //}}user_implement_dev:<onClickcopy>
		logger.exiting("AA0040030Servlet"+":USER="+request.getRemoteUser(),"onClickcopy");
					...
					AA0040030Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0040");
		logger.entering("AA0040030Servlet"+":USER="+request.getRemoteUser(),"onClickerase");
		...
		//------------------------------------------------------------------
                //}}user_implement_dev:<onClickerase>
		logger.exiting("AA0040030Servlet"+":USER="+request.getRemoteUser(),"onClickerase");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AA0040030Struct struct)
	{
		...
		String[] p_ONEROUS_FLG = ((params.containsKey("p_ONEROUS_FLG")) ? (String[])params.get("p_ONEROUS_FLG") : (String[])null);
		String[] p_ONEROUS_FLG_name = ((params.containsKey("p_ONEROUS_FLG_name")) ? (String[])params.get("p_ONEROUS_FLG_name") : (String[])null);
		String[] p_ONEROUS_FLG_val = ((params.containsKey("p_ONEROUS_FLG_val")) ? (String[])params.get("p_ONEROUS_FLG_val") : (String[])null);
		...
		String[] p_ONEROUS_NAME = ((params.containsKey("p_ONEROUS_NAME")) ? (String[])params.get("p_ONEROUS_NAME") : (String[])null);
		...
		String[] h_APR_CONS_UNIT_COST = ((params.containsKey("h_APR_CONS_UNIT_COST")) ? (String[])params.get("h_APR_CONS_UNIT_COST") : (String[])null);
		...
		if( (p_ONEROUS_FLG == null)||("".equals(p_ONEROUS_FLG[0])) ) {
		   struct.setp_ONEROUS_FLG( (Integer)null );
		} else {
		   struct.setp_ONEROUS_FLG( new Integer(p_ONEROUS_FLG[0]) );
		   struct.setList_p_ONEROUS_FLG(TypeConverter.convert(p_ONEROUS_FLG));
		}
		struct.setp_ONEROUS_FLG_name( ((p_ONEROUS_FLG_name == null) ? (String)null : p_ONEROUS_FLG_name[0]) );
		struct.setList_p_ONEROUS_FLG_name(TypeConverter.convert(p_ONEROUS_FLG_name));
		if( (p_ONEROUS_FLG_val == null)||("".equals(p_ONEROUS_FLG_val[0])) ) {
		   struct.setp_ONEROUS_FLG_val( (Integer)null );
		} else {
		   struct.setp_ONEROUS_FLG_val( new Integer(p_ONEROUS_FLG_val[0]) );
		   struct.setList_p_ONEROUS_FLG_val(TypeConverter.convert(p_ONEROUS_FLG_val));
		}
		...
		struct.setp_ONEROUS_NAME( ((p_ONEROUS_NAME == null) ? (String)null : p_ONEROUS_NAME[0]) );
		struct.setList_p_ONEROUS_NAME(TypeConverter.convert(p_ONEROUS_NAME));
		...
		struct.seth_APR_CONS_UNIT_COST( ((h_APR_CONS_UNIT_COST == null) ? (String)null : h_APR_CONS_UNIT_COST[0]) );
		struct.setList_h_APR_CONS_UNIT_COST(TypeConverter.convert(h_APR_CONS_UNIT_COST));
	...
	public static String DEFAULT_TARGET = "/AA0040030.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAA0040030Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAA0040030Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AA0040");
		logger.entering("AA0040030Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
			
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AA0040030Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AA0040030Control control;
		AA0040030Entity  entity = null;
		AA0040030Struct  struct = null;
		...
		try {
			...
			if( (control = (AA0040030Control)so.getAttribute("AA0040030Control_"+request.getSession(false).getId())) == null ) {
				control = new AA0040030Control();
			...
			try {
				...
				so.setAttribute("AA0040030Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.AA0040.AA0040030Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AA0040030Servlet()
	{
		//{{user_implement_dev:<AA0040030_DisConnect_FLG>
		// submitボタン押下時コネクションを自動的にcloseするためのフラグ 自動切断時：true（デフォルト）
		bFLG_DISCONNECT_defaultEvent = true;
		bFLG_DISCONNECT_select = true;
		bFLG_DISCONNECT_clear = true;
		bFLG_DISCONNECT_sub1Insert = true;
		bFLG_DISCONNECT_sub1Update = true;
		...
		//{{user_implement_dev:<AA0040030Servlet>
