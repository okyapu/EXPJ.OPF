...
public class AA0040020Entity extends DataObject
{
	...
	// deleteM_SBCNT_UNIT_COST_deleteAllクラス インスタンス
	...
	// selectM_SBCNT_UNIT_COST_lockクラス インスタンス
	...
	// selectM_SBCNT_UNIT_COST_detailクラス インスタンス
...
+"  M_SBCNT_UNIT_COST.\"EFF_PHASE_IN_DATE\"";
		...
		public List read(Connection conn, AA0040020Struct data) throws FoundationException, SQLException
		{
			...
			if(m_selcmd==null) throw new FoundationException("selectM_SBCNT_UNIT_COST", "read", "クエリー未登録");
		...
		public boolean hasRecord(Connection conn, AA0040020Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("selectM_SBCNT_UNIT_COST", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AA0040020Struct data) throws FoundationException, SQLException
		{
			...
			if(m_chkcmd!=null) {
				...
				throw new FoundationException("selectM_SBCNT_UNIT_COST", "check", "クエリー未登録");
			}
		...
		/**
		 * selectM_SBCNT_UNIT_COSTクラスの標準コンストラクタ
		 */
...
+"  (?, ?, ?, ?, ?, TO_DATE(?), 0, TO_NUMBER(?), ?, TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?))";
		...
		/**
		 * insertM_SBCNT_UNIT_COSTクラスの標準コンストラクタ
		 */
...
+"for update nowait";
		...
		public boolean check(Connection conn, AA0040020Struct data) throws FoundationException, SQLException
		{
			...
			if(m_chkcmd!=null) {
				...
				throw new FoundationException("checkM_SBCNT_UNIT_COST", "check", "クエリー未登録");
			}
		...
		/**
		 * checkM_SBCNT_UNIT_COSTクラスの標準コンストラクタ
		 */
...
+"for update nowait";
		...
		public boolean check(Connection conn, AA0040020Struct data) throws FoundationException, SQLException
		{
			...
			if(m_chkcmd!=null) {
				...
				throw new FoundationException("checkM_SBCNT_UNIT_COST_H", "check", "クエリー未登録");
			}
		...
		/**
		 * checkM_SBCNT_UNIT_COST_Hクラスの標準コンストラクタ
		 */
...
+"  (?, ?, ?, ?, ?, ?)";
		...
		/**
		 * insertM_SBCNT_UNIT_COST_Hクラスの標準コンストラクタ
		 */
...
+"  and M_SBCNT_UNIT_COST.\"SBCNT_SIZE\" = 0";
		...
		/**
		 * updateM_SBCNT_UNIT_COSTクラスの標準コンストラクタ
		 */
...
+"for update nowait";
		...
		public List read(Connection conn, AA0040020Struct data) throws FoundationException, SQLException
		{
			...
			if(m_selcmd==null) throw new FoundationException("selectM_SBCNT_UNIT_COST_modify", "read", "クエリー未登録");
		...
		public boolean hasRecord(Connection conn, AA0040020Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("selectM_SBCNT_UNIT_COST_modify", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AA0040020Struct data) throws FoundationException, SQLException
		{
			...
			if(m_chkcmd!=null) {
				...
				throw new FoundationException("selectM_SBCNT_UNIT_COST_modify", "check", "クエリー未登録");
			}
		...
		/**
		 * selectM_SBCNT_UNIT_COST_modifyクラスの標準コンストラクタ
		 */
...
+"  and M_SBCNT_UNIT_COST_H.\"PROC_CD\" = ?";
		...
		/**
		 * updateM_SBCNT_UNIT_COST_Hクラスの標準コンストラクタ
		 */
...
+"for update nowait";
		...
		public List read(Connection conn, AA0040020Struct data) throws FoundationException, SQLException
		{
			...
			if(m_selcmd==null) throw new FoundationException("selectM_SBCNT_UNIT_COST_H_modify", "read", "クエリー未登録");
		...
		public boolean hasRecord(Connection conn, AA0040020Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("selectM_SBCNT_UNIT_COST_H_modify", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AA0040020Struct data) throws FoundationException, SQLException
		{
			...
			if(m_chkcmd!=null) {
				...
				throw new FoundationException("selectM_SBCNT_UNIT_COST_H_modify", "check", "クエリー未登録");
			}
		...
		/**
		 * selectM_SBCNT_UNIT_COST_H_modifyクラスの標準コンストラクタ
		 */
...
+"  and M_SBCNT_UNIT_COST.\"SBCNT_SIZE\" = 0";
		...
		public List read(Connection conn, AA0040020Struct data) throws FoundationException, SQLException
		{
			...
			if(m_selcmd==null) throw new FoundationException("selectM_SBCNT_UNIT_COST_record_count", "read", "クエリー未登録");
		...
		public boolean hasRecord(Connection conn, AA0040020Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("selectM_SBCNT_UNIT_COST_record_count", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AA0040020Struct data) throws FoundationException, SQLException
		{
			...
			if(m_chkcmd!=null) {
				...
				throw new FoundationException("selectM_SBCNT_UNIT_COST_record_count", "check", "クエリー未登録");
			}
		...
		/**
		 * selectM_SBCNT_UNIT_COST_record_countクラスの標準コンストラクタ
		 */
...
+"  and M_SBCNT_UNIT_COST.\"SBCNT_SIZE\" = 0";
		...
		/**
		 * deleteM_SBCNT_UNIT_COST_deleteAllクラスの標準コンストラクタ
		 */
...
+"for update nowait";
		...
		public List read(Connection conn, AA0040020Struct data) throws FoundationException, SQLException
		{
			...
			if(m_selcmd==null) throw new FoundationException("selectM_SBCNT_UNIT_COST_lock", "read", "クエリー未登録");
		...
		public boolean hasRecord(Connection conn, AA0040020Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("selectM_SBCNT_UNIT_COST_lock", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AA0040020Struct data) throws FoundationException, SQLException
		{
			...
			if(m_chkcmd!=null) {
				...
				throw new FoundationException("selectM_SBCNT_UNIT_COST_lock", "check", "クエリー未登録");
			}
		...
		/**
		 * selectM_SBCNT_UNIT_COST_lockクラスの標準コンストラクタ
		 */
...
+"  AND M_SBCNT_UNIT_COST.\"PLANT_CD\" = ?";
		...
		public List read(Connection conn, AA0040020Struct data) throws FoundationException, SQLException
		{
			...
			if(m_selcmd==null) throw new FoundationException("selectM_SBCNT_UNIT_COST_detail", "read", "クエリー未登録");
		...
		public PreparedStatement prepare(Connection conn, String query, AA0040020Struct data) throws FoundationException, SQLException
		{
			...
			try {
				...
				throw new FoundationException("selectM_SBCNT_UNIT_COST_detail", "prepare", "Parse失敗:"+e.toString());
			} finally {
				ary.removeAllElements();
				ary = null;
			}
		...
		public boolean hasRecord(Connection conn, AA0040020Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("selectM_SBCNT_UNIT_COST_detail", "hasRecord", "クエリー未登録");
		...
		/**
		 * selectM_SBCNT_UNIT_COST_detailクラスの標準コンストラクタ
		 */
