...
public class AA0040010Servlet extends HttpServlet
{
	 ...
	 * @param control AA0040010Controlクラスインスタンス
	 */
...
//			e.printStackTrace();
	...
	public static String DEFAULT_TARGET = "/AA0040010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAA0040010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAA0040010Struct";   // JSP先のバインド名(Struct)の指定
