...
public class AA0040020Struct extends DataStruct
{
	...
	/** 第 4 変数： m_w_MRP_ODR_NAME */
	public String m_w_MRP_ODR_NAME = null;
	/** 第 5 変数： m_w_OUTSIDE_NAME */
	...
	/** 第 4 List変数： l_w_MRP_ODR_NAME */
	public List l_w_MRP_ODR_NAME = null;

	/** 第 5 List変数： l_w_OUTSIDE_NAME */
	...
	/** 第 10 List変数： l_h_APR_SBCNT_UNIT_COST */
	public List l_h_APR_SBCNT_UNIT_COST = null;

	/** 第 11 List変数： l_h_VEND_ITEM_CD_1 */
	public List l_h_VEND_ITEM_CD_1 = null;

	/** 第 12 List変数： l_w_PLANT_CD */
	public List l_w_PLANT_CD = null;

	/** 第 13 List変数： l_w_RECORD_COUNT */
	...
	/** 第 18 List変数： l_w_MRP_ODR_TYP */
	public List l_w_MRP_ODR_TYP = null;

	/** 第 19 List変数： l_w_OUTSIDE_TYP */
	public List l_w_OUTSIDE_TYP = null;

	/** 第 20 List変数： l_COMPANY_CD */
...
/*
	...
	// 第 4 変数初期値： i_w_MRP_ODR_NAME


	final static String i_w_MRP_ODR_NAME = null;

	// 第 5 変数初期値： i_w_OUTSIDE_NAME
	...
	// 第 18 変数初期値： i_w_MRP_ODR_TYP


	final static String i_w_MRP_ODR_TYP = null;

	// 第 19 変数初期値： i_w_OUTSIDE_TYP
	...
	// 第 26 変数初期値： i_ROUND_TYP


	final static String i_ROUND_TYP = null;

	// 第 27 変数初期値： i_CUR_NAME
	...
	// 第 43 変数初期値： i_EFF_PHASE_IN_DATE
