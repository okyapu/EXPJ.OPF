/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KM0060/src/com/nec/jp/orteus/metamorBase/KM0060/KM0060B001/T_ESTIMATE_DETAL.java,v $
 *
...
public class T_ESTIMATE_DETAL extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN1_R(m_med.getPROJECT_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("T_ESTIMATE_DETAL", "read", "レコード検索条件設定処理失敗");
		...
		public String getCOUNT_R() throws FoundationException { return m_doRs.getString(1); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setOD_NO_count(getCOUNT_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("T_ESTIMATE_DETAL", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("T_ESTIMATE_DETAL", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	 ...
	 *
		 */
	public T_ESTIMATE_DETAL(medKM0060B001 med, BatchAppConductor cdr) throws SystemException
	{
