/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KM0060/src/com/nec/jp/orteus/metamorBase/KM0060/KM0060B001/cdrKM0060B001.java,v $
 *
...
public class cdrKM0060B001 extends Object
		implements IBatchAppCommon
{
	...
	public void initialize() throws BatchAppException, SystemException
	{
		try {
			...
			m_med.setSQLPjBudgetCostMake( new SQLPjBudgetCostMake(m_med, m_conductor) );
			m_med.setT_PROJECT( new T_PROJECT(m_med, m_conductor) );
			m_med.setT_PROJECT_cnt( new T_PROJECT_cnt(m_med, m_conductor) );
			m_med.setT_ESTIMATE_DETAL( new T_ESTIMATE_DETAL(m_med, m_conductor) );
			m_med.setreadODR_NO( new readODR_NO(m_med, m_conductor) );
			...
			m_conductor.addObject( m_med.getSQLPjBudgetCostMake() );
			m_conductor.addObject( m_med.getT_PROJECT() );
			m_conductor.addObject( m_med.getT_PROJECT_cnt() );
			m_conductor.addObject( m_med.getT_ESTIMATE_DETAL() );
			m_conductor.addObject( m_med.getreadODR_NO() );
	...
	public int beginProc() throws BatchAppException
	{
		try {
			...
			setCommitFlag(false);
			BatchAppException be=new BatchAppException("cdrKM0060B001", "beginProc", "conductorの初期処理に失敗しました");
	...
	medKM0060B001 m_med=new medKM0060B001();

	// BatchAppConductorクラスインスタンス
	BatchAppConductor m_conductor=new BatchAppConductor("KM0060B001");
	...
	/**
	 * ctrKM0060B001クラス 標準コンストラクタ
	 *
		 */
	public cdrKM0060B001() throws BatchAppException
	{
		initialize();
