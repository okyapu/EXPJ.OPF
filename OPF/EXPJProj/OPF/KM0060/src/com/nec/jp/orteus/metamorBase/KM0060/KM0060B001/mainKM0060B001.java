/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KM0060/src/com/nec/jp/orteus/metamorBase/KM0060/KM0060B001/mainKM0060B001.java,v $
 *
	...
	public static void main(String args[])
	{
		...
		try {
			...
			if (sysLog == null) {
				...
				if(!sysLog.init("com.nec.jp.orteus.metamorBase.KM0060B001")) {
					//システムログの初期化に失敗しました
			...
			// 標準出力ファイル名設定
			String logFileName = "KM0060B001.log";
			if(logFileName == null){
			...
			if(logOutputPath == null){
				...
				System.setOut(new PrintStream( new FileOutputStream(logOutputPath + "/KM0060B001stdout.log") ) );
				System.setErr(new PrintStream( new FileOutputStream(logOutputPath + "/KM0060B001stderr.log") ) );
			}
			...
			cdrKM0060B001 ebo = new cdrKM0060B001();
