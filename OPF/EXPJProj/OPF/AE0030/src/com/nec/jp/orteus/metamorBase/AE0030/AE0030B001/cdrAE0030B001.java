/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0030/src/com/nec/jp/orteus/metamorBase/AE0030/AE0030B001/cdrAE0030B001.java,v $
 *
...
public class cdrAE0030B001 extends Object
		implements IBatchAppCommon
{
	...
	public void initialize() throws BatchAppException, SystemException
	{
		try {
			...
			m_med.setCallSQLPUCHODRINST( new CallSQLPUCHODRINST(m_med, m_conductor) );
			m_med.setSelectSYS_BAT_PARM( new SelectSYS_BAT_PARM(m_med, m_conductor) );
			m_med.setCtrlMain( new CtrlMain(m_med, m_conductor) );
			m_conductor.addObject( m_med.getCallSQLPUCHODRINST() );
			m_conductor.addObject( m_med.getSelectSYS_BAT_PARM() );
	...
	public int getType() { return m_conductor.getType(); }
        ...
        public int beginProc() throws BatchAppException
        {
         try {
          ...
          setCommitFlag(false);
          BatchAppException be=new BatchAppException("cdrAE0030B001", "beginProc", "conductorの初期処理に失敗しました");
	...
	medAE0030B001 m_med=new medAE0030B001();

	// BatchAppConductorクラスインスタンス
	BatchAppConductor m_conductor=new BatchAppConductor("AE0030B001");
	...
	/**
	 * ctrAE0030B001クラス 標準コンストラクタ
	 *
		 */
	public cdrAE0030B001() throws BatchAppException
	{
		initialize();
