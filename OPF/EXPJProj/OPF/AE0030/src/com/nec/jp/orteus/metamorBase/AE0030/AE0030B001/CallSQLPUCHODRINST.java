/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0030/src/com/nec/jp/orteus/metamorBase/AE0030/AE0030B001/CallSQLPUCHODRINST.java,v $
 *
...
/**
 * CLASS     : CallSQLPUCHODRINST クラス
 * ファイル・クラス説明
 * @author $Author: xl-hs-zzw $
 * @version $Revision: 1.19 $ $Date: 2014/11/05 07:09:53 $
 */
...
public class CallSQLPUCHODRINST extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public List call() throws BatchAppException
		{
			try {
				...
				cstmt.setString(8, m_med.getpvc2StartDate());
				cstmt.setString(9, m_med.getpvc2DlvDate());
				cstmt.setString(10, m_med.getpvc2PuchOdrCd());
				cstmt.setString(11, m_med.getpvc2VendCd());
				cstmt.setString(12, m_med.getpvc2PuchOdrPerson());
				cstmt.setString(13, m_med.getpvc2JobOdrCd());
				cstmt.setString(14, m_med.getpvc2ApprPurInst());
				cstmt.setString(15, m_med.getpvc2ApprPowerTyp());


				cstmt.execute();

				List list = new ArrayList();
				medAE0030B001 data = null;
				...
				e.printStackTrace();
				BatchAppException be=new BatchAppException("CallSQLPUCHODRINST", "call", "Stored Procedure条件設定処理失敗");
				...
				if (cstmt != null) {
					try {
						...
						ef.printStackTrace();
						BatchAppException bef = new BatchAppException("CallSQLPUCHODRINST", "call", "Stored Procedureクローズ処理失敗");
		 ...
		 */
		public medAE0030B001 call(ResultSet rs) throws SQLException
		{
			if(rs == null || rs.next()==false) return null;
			medAE0030B001 data = new medAE0030B001();
			return data;
		}
	...
	/**
	 * CallSQLPUCHODRINSTクラスの標準コンストラクタ
	 *
		 */
	public CallSQLPUCHODRINST(medAE0030B001 med, BatchAppConductor cdr) throws SystemException
	{
	...
	protected static String m_calcmd = "{" + "call SQLPUCHODRINST(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" + "}";
