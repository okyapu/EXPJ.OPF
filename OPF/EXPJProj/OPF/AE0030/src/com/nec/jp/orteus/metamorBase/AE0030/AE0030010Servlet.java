/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0030/src/com/nec/jp/orteus/metamorBase/AE0030/AE0030010Servlet.java,v $
 *
...
public class AE0030010Servlet extends HttpServlet
{
	 ...
	 * @param control AE0030010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AE0030010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AE0030010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AE0030010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AE0030010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AE0030010Entity entity = control.entity;
		AE0030010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AE0030010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
                 // TODO: ユーザ定義のコードを記述してください
              //			objMessage.m_writer.write( Level.ALL, "AE0030010"+" $Revision: 1.19 $" );
                 control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AE0030010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AE0030010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AE0030010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0030");
		logger.entering("AE0030010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
		...
		//{{user_implement_dev:<reloadEvent>
              ...
              //			e.printStackTrace();
              //			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AE0030010-E999","リロード処理"));
                 ExpjException ee = new ExpjException(e, "ZZ01106");
                 throw ee;
                }
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AE0030010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickSelect(
					...
					HttpSession so,
					Hashtable params,
					AE0030010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AE0030010Entity entity = control.entity;
		AE0030010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0030");
		logger.entering("AE0030010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
		//{{user_implement_dev:<onClickSelect>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickSelect>
		logger.exiting("AE0030010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
					...
					AE0030010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0030");
		logger.entering("AE0030010Servlet"+":USER="+request.getRemoteUser(),"onClickExecute");
		//{{user_implement_dev:<onClickExecute>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickExecute>
		logger.exiting("AE0030010Servlet"+":USER="+request.getRemoteUser(),"onClickExecute");
					...
					AE0030010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0030");
		logger.entering("AE0030010Servlet"+":USER="+request.getRemoteUser(),"onClickUpdate");
		//{{user_implement_dev:<onClickUpdate>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickUpdate>
		logger.exiting("AE0030010Servlet"+":USER="+request.getRemoteUser(),"onClickUpdate");
					...
					AE0030010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0030");
		logger.entering("AE0030010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
		//{{user_implement_dev:<onClickClear>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("AE0030010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
					...
					AE0030010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0030");
		logger.entering("AE0030010Servlet"+":USER="+request.getRemoteUser(),"onClickCheckAll");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickCheckAll>
		logger.exiting("AE0030010Servlet"+":USER="+request.getRemoteUser(),"onClickCheckAll");
					...
					AE0030010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0030");
		logger.entering("AE0030010Servlet"+":USER="+request.getRemoteUser(),"onClickUncheckAll");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickUncheckAll>
		logger.exiting("AE0030010Servlet"+":USER="+request.getRemoteUser(),"onClickUncheckAll");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AE0030010Struct struct)
	{
		...
		String[] h_APR_PUR_INST = ((params.containsKey("h_APR_PUR_INST")) ? (String[])params.get("h_APR_PUR_INST") : (String[])null);
		...
		struct.seth_APR_PUR_INST( ((h_APR_PUR_INST == null) ? (String)null : h_APR_PUR_INST[0]) );
		struct.setList_h_APR_PUR_INST(TypeConverter.convert(h_APR_PUR_INST));
	...
	public static String DEFAULT_TARGET = "/AE0030010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAE0030010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAE0030010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0030");
		logger.entering("AE0030010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AE0030010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AE0030010Control control;
		AE0030010Entity  entity = null;
		AE0030010Struct  struct = null;
		...
		try {
			...
			if( (control = (AE0030010Control)so.getAttribute("AE0030010Control_"+request.getSession(false).getId())) == null ) {
				control = new AE0030010Control();
			...
			try {
				...
				so.setAttribute("AE0030010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.AE0030.AE0030010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AE0030010Servlet()
	{
		//{{user_implement_dev:<AE0030010_DisConnect_FLG>
		...
		//{{user_implement_dev:<AE0030010Servlet>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<AE0030010Servlet>
	}
