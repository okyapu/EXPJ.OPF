/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0030/src/com/nec/jp/orteus/metamorBase/AE0030/AE0030020Entity.java,v $
 *
...
public class AE0030020Entity extends DataObject
{
	...
	// HOME_CUR_UNITクラス インスタンス
	public HOME_CUR_UNIT mHOME_CUR_UNIT = new HOME_CUR_UNIT();
	...
	// T_RLSD_PUCH_ODR_UPDATEクラス インスタンス
	public T_RLSD_PUCH_ODR_UPDATE mT_RLSD_PUCH_ODR_UPDATE = new T_RLSD_PUCH_ODR_UPDATE();

	// View1クラス インスタンス
	public View1 mView1 = new View1();

	// ViewCnt1クラス インスタンス
	public ViewCnt1 mViewCnt1 = new ViewCnt1();
...
+"";		//////////////////////////////
	...
	public class ei_CSVOut extends DataObject
	{
		...
		String m_write_fname="AE0030020.csv";

		protected WriteCsv m_writer=null;		// csv書込み用

		String m_ProjName="AE0030020";
...
+"  and T_RLSD_PUCH_ODR.\"PUCH_ODR_INST_SLIP_ISS_FLG\" = ? "
+"  and M_VEND_CTRL.ODR_FORM_FLG = ? "
+"order by "
...
+"  T_RLSD_PUCH_ODR.\"PUCH_ODR_CD\"";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AE0030020Struct data) throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AE0030020Struct data, String replaceStr)
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AE0030020Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AE0030020Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AE0030020Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AE0030020Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(PreparedStatement stmt, AE0030020Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public PreparedStatement prepare(Connection conn, String query, AE0030020Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt;
			...
			try {
				...
				ary.addElement(data.getPUCH_ODR_INST_SLIP_ISS_FLG());
				if(isNull(data.getPUCH_ODR_INST_SLIP_ISS_FLG())) isNull = true;
				ary.addElement(data.getODR_FORM_FLG());
				if(isNull(data.getODR_FORM_FLG())) isNull = true;
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public ResultSet executeQuery(PreparedStatement stmt, AE0030020Struct data) throws FoundationException, SQLException
		{
			int no=1;
			...
			//動的SQL生成ロジック
			if(!isNull(data.getPUCH_ODR_INST_SLIP_ISS_FLG())) setString(no ++, data.getPUCH_ODR_INST_SLIP_ISS_FLG(), stmt);
			//動的SQL生成ロジック
			if(!isNull(data.getODR_FORM_FLG())) setString(no ++, data.getODR_FORM_FLG(), stmt);
		 ...
		 * レコードデータをStructに格納して返します
		 */
		public AE0030020Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			if(rs.next()==false) return null;

			AE0030020Struct data = new AE0030020Struct();
			...
			data.setl_PUCH_ODR_SLIP_ISS_DATE( getString(11, rs) );
			data.setl_MODIFY_COUNT( getString(12, rs) );
			data.setl_PUCH_ODR_INST_SLIP_ISS_FLG( getString(13, rs) );
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(IDbConnection conn, AE0030020Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(Connection conn, AE0030020Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(IDbConnection conn, AE0030020Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(Connection conn, AE0030020Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(PreparedStatement stmt, AE0030020Struct data) throws FoundationException, SQLException
		{
			ResultSet rs=executeQuery(stmt, data);
			boolean ret=true;
...
+"  decode(T_RLSD_PUCH_ODR.\"NON_NO_ITEM_FLG\", 0, M_ITEM.\"STOCK_UNIT\", T_RLSD_PUCH_ODR.\"NON_NO_ITEM_PUCH_ODR_UNIT\") as \"STOCK_UNIT\", "
+"  to_char(decode(T_RLSD_PUCH_ODR.\"NON_NO_ITEM_FLG\", 0, decode(M_ITEM.\"STOCK_UNIT_FLG\", 1, trunc(T_RLSD_PUCH_ODR.\"PUCH_ODR_QTY\" / M_ITEM.\"PKG_UNIT_QTY\"), 0), 0)) as \"PKG_QTY\", "
+"  to_char(decode(T_RLSD_PUCH_ODR.\"NON_NO_ITEM_FLG\", 0, decode(M_ITEM.\"STOCK_UNIT_FLG\", 1, mod(T_RLSD_PUCH_ODR.\"PUCH_ODR_QTY\", M_ITEM.\"PKG_UNIT_QTY\"), 0), 0)) as \"PKG_ODD_QTY\", "
+"  decode(T_RLSD_PUCH_ODR.\"NON_NO_ITEM_FLG\", 0, decode(M_ITEM.\"STOCK_UNIT_FLG\", 1, M_ITEM.\"PKG_UNIT\", NULL), NULL) as \"PKG_UNIT\", "
+"  decode(T_RLSD_PUCH_ODR.\"NON_NO_ITEM_FLG\", 0, decode(M_ITEM.\"STOCK_UNIT_FLG\", 1, M_ITEM.\"STOCK_UNIT\", NULL), NULL) as \"STOCK_UNIT2\", "
...
+"  VEND_CUR.\"CUR_UNIT\" as \"VEND_CUR_UNIT\", "
...
+"  HOME_CUR.\"CUR_UNIT\" as \"HOME_CUR_UNIT\", "
+"  VEND_CUR.\"CUR_NAME\" as \"CUR_NAME\", "
+"  M_VEND_CTRL.\"EXCH_TYP\" as \"DISPLAY_NAME\", "
+"  to_char(T_RLSD_PUCH_ODR.\"RATE_JUDGE_DATE\", 'YYYY/MM/DD HH24:MI') as \"RATE_JUDGE_DATE\", "
...
+"  M_PLANT.\"ZIP_CD\" as \"WH_ZIP_CD\", "
+"  M_PLANT.\"ADDRESS_1\" as \"WH_ADDRESS_1\", "
+"  M_PLANT.\"ADDRESS_2\" as \"WH_ADDRESS_2\", "
+"  M_PLANT.\"TEL\" as \"WH_TEL\", "
+"  decode(USER_MST.\"USER_NAME\", NULL, T_RLSD_PUCH_ODR.\"PUCH_ODR_PERSON\", USER_MST.\"USER_NAME\") as \"USER_NAME\" "
+"from "
+"  T_RLSD_PUCH_ODR, "
+"  M_VEND_CTRL, "
+"  SYS_DATE_CTRL, "
...
+"  and M_VEND_CTRL.CUR_CD = VEND_CUR.CUR_CD(+) "
+"  and T_RLSD_PUCH_ODR.\"PUCH_ODR_CD\" = ?";
		protected String m_chkcmd = null;
		protected String m_inscmd = null;
		protected String m_updcmd = null;
		...
		public AE0030020Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setPUCH_ODR_INST_SLIP_ISS_FLG( getString(1, rs) );
			data.setT_RLSD_PUCH_ODR__PUCH_ODR_CD( getString(2, rs) );
			data.setSYS_DATE_CTRL__BUSINESS_OPR_DATE( getString(3, rs) );
			data.setM_VEND_CTRL__VEND_NAME( getString(4, rs) );
			data.setM_VEND_CTRL__ZIP_CD( getString(5, rs) );
			data.setM_VEND_CTRL__ADDRESS_1( getString(6, rs) );
			data.setM_VEND_CTRL__ADDRESS_2( getString(7, rs) );
			data.setM_VEND_CTRL__VEND_ORG( getString(8, rs) );
			data.setM_VEND_CTRL__VEND_PERSON( getString(9, rs) );
			data.setM_VEND_CTRL__TEL( getString(10, rs) );
			data.setM_VEND_CTRL__FAX( getString(11, rs) );
			data.setT_RLSD_PUCH_ODR__ITEM_CD( getString(12, rs) );
			data.setM_ITEM__ITEM_NAME( getString(13, rs) );
			data.setT_OD__JOB_ODR_CD( getString(14, rs) );
			data.setT_RLSD_PUCH_ODR__PUCH_ODR_QTY( getString(15, rs) );
			data.setM_ITEM__STOCK_UNIT( getString(16, rs) );
			data.setPKG_QTY( getString(17, rs) );
			data.setPKG_ODD_QTY( getString(18, rs) );
			data.setM_ITEM__PKG_UNIT( getString(19, rs) );
			data.setM_ITEM__STOCK_UNIT2( getString(20, rs) );
			data.setl_PUCH_ODR_START_DATE( getString(21, rs) );
			data.setT_RLSD_PUCH_ODR__PUCH_ODR_DLV_DA( getString(22, rs) );
			data.setT_RLSD_PUCH_ODR__UNIT_COST( getString(23, rs) );
			data.setM_CUR__VEND_CUR_UNIT( getString(24, rs) );
			data.setT_RLSD_PUCH_ODR__PUCH_ODR_AMOUNT( getString(25, rs) );
			data.setT_RLSD_PUCH_ODR__DISC_AMOUNT( getString(26, rs) );
			data.setT_RLSD_PUCH_ODR__NET_AMOUNT( getString(27, rs) );
			data.setTAX_AMOUNT( getString(28, rs) );
			data.setT_RLSD_PUCH_ODR__AMOUNT_INCLUDE_( getString(29, rs) );
			data.setT_RLSD_PUCH_ODR__HOME_CUR_AMOUNT( getString(30, rs) );
			data.setM_CUR__HOME_CUR_UNIT( getString(31, rs) );
			data.setM_CUR__CUR_NAME( getString(32, rs) );
			data.setSYS_TYPE_VALUE__DISPLAY_NAME( getString(33, rs) );
			data.setT_RLSD_PUCH_ODR__RATE_JUDGE_DATE( getString(34, rs) );
			data.setT_RLSD_PUCH_ODR__EXCH_RATE( getString(35, rs) );
			data.setT_RLSD_PUCH_ODR__PROCESSING_COST( getString(36, rs) );
			data.setT_RLSD_PUCH_ODR__MATERIAL_COST( getString(37, rs) );
			data.setT_RLSD_PUCH_ODR__OTHER_OVERHEADS( getString(38, rs) );
			data.setT_RLSD_PUCH_ODR__PUCH_ODR_COMMEN( getString(39, rs) );
			data.setM_PLANT__PLANT_NAME( getString(40, rs) );
			data.setM_WH__WH_NAME( getString(41, rs) );
			data.setM_PLANT__ZIP_CD( getString(42, rs) );
			data.setM_PLANT__ADDRESS_1( getString(43, rs) );
			data.setM_PLANT__ADDRESS_2( getString(44, rs) );
			data.setM_PLANT__TEL( getString(45, rs) );
			data.setUSER_MST__USER_NAME( getString(46, rs) );
...
+"  T_RLSD_PUCH_ODR "
+"set "
+"  \"PUCH_ODR_INST_SLIP_ISS_FLG\" = 1, "
+"  \"PUCH_ODR_SLIP_ISS_DATE\" = to_date(?, 'YYYY/MM/DD') "
+"where "
+"  T_RLSD_PUCH_ODR.\"PUCH_ODR_CD\" = ?";
		protected String m_delcmd = null;
		protected String m_spcmd = null;

		protected String m_sCreateProgramName="AE0030020";
		protected String m_sUpdateProgramName="AE0030020";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int update(IDbConnection conn, AE0030020Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int update(Connection conn, AE0030020Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt=null;
			int modifyCount;
			...
			try {
				...
				setString(4, data.getPUCH_ODR_SLIP_ISS_DATE(), stmt);
				setString(5, data.getl_PUCH_ODR_CD(), stmt);
...
+"for update nowait";
	 ...
	 * Entity定義 静的SQL
	 */
	public class HOME_CUR_UNIT extends DataObject
	{
		protected String m_selcmd = "select "
+"  M_CUR.CUR_UNIT "
+"from "
...
+"  and SYS_HOME_CUR.CTRL_CD = 'SYSTEM'";
		...
		//{{user_implement_dev:HOME_CUR_UNIT_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:HOME_CUR_UNIT_def
		...
		public List read(Connection conn, AE0030020Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:HOME_CUR_UNIT_read
			if(m_selcmd==null) throw new FoundationException("HOME_CUR_UNIT", "read", "クエリー未登録");
		...
		public List read(Connection conn, AE0030020Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:HOME_CUR_UNIT_read2
			if(m_selcmd==null) throw new FoundationException("HOME_CUR_UNIT", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AE0030020Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:HOME_CUR_UNIT_read3
			if(m_selcmd==null) throw new FoundationException("HOME_CUR_UNIT", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public AE0030020Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setM_CUR__HOME_CUR_UNIT( getString(1, rs) );
		...
		public boolean hasRecord(Connection conn, AE0030020Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("HOME_CUR_UNIT", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AE0030020Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:HOME_CUR_UNIT_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
				return check(stmt, data);
			} finally {
		...
		public void clear()
		{
			//{{user_implement_dev:HOME_CUR_UNIT_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:HOME_CUR_UNIT_clear
		...
		/**
		 * HOME_CUR_UNITクラスの標準コンストラクタ
		 */
		public HOME_CUR_UNIT()
		{
			//{{user_implement_dev:HOME_CUR_UNIT_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:HOME_CUR_UNIT_constractor
...
+"  PLANT_CD = ?";
		...
		public AE0030020Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setwork_busDate( getString(1, rs) );
	 ...
	 * Entity定義 静的SQL
	 */
	public class T_RLSD_PUCH_ODR_UPDATE extends DataObject
	{
		protected String m_selcmd = null;
		protected String m_chkcmd = null;
		protected String m_inscmd = null;
...
+"  T_RLSD_PUCH_ODR "
+"SET "
+"  PARTIAL_DELIV_SLIP_ISS_FLG = 1, "
+"  PARTIAL_DELIV_SLIP_ISS_DATE = ? "
+"WHERE "
+"  PUCH_ODR_CD = ?";
		protected String m_delcmd = null;
		protected String m_spcmd = null;
		...
		//{{user_implement_dev:T_RLSD_PUCH_ODR_UPDATE_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:T_RLSD_PUCH_ODR_UPDATE_def
		...
		public int update(Connection conn, AE0030020Struct data) throws FoundationException, SQLException
		{
			...
			try {
				...
				setString(2, data.getsUser_ID(), stmt);
				setString(3, m_sUpdateProgramName, stmt);
				setString(4, data.getwork_ISS_DATE(), stmt);
				setString(5, data.getl_PUCH_ODR_CD(), stmt);
		...
		public void clear()
		{
			//{{user_implement_dev:T_RLSD_PUCH_ODR_UPDATE_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:T_RLSD_PUCH_ODR_UPDATE_clear
		...
		/**
		 * T_RLSD_PUCH_ODR_UPDATEクラスの標準コンストラクタ
		 */
		public T_RLSD_PUCH_ODR_UPDATE()
		{
			//{{user_implement_dev:T_RLSD_PUCH_ODR_UPDATE_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:T_RLSD_PUCH_ODR_UPDATE_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class View1 extends DataObject
	{
		protected String m_selcmd = "select "
+"  FncGetFormattedDatetime(T_RLSD_PUCH_ODR.\"PUCH_ODR_START_DATE\") as \"PUCH_ODR_START_DATE\", "
+"  FncGetFormattedDatetime(T_RLSD_PUCH_ODR.\"PUCH_ODR_DLV_DATE\") as \"PUCH_ODR_DLV_DATE\", "
...
+"  and T_RLSD_PUCH_ODR.OD_NO = T_OD.OD_NO(+) "
+"  and T_RLSD_PUCH_ODR.ITEM_CD = M_ITEM.ITEM_CD(+) "
+"  and T_RLSD_PUCH_ODR.PUCH_ODR_CD = TAR.PUCH_ODR_CD(+) "
+"  and T_RLSD_PUCH_ODR.PUCH_ODR_QTY > TAR.ACPT_QTY "
...
+"  and T_OD.\"JOB_ODR_CD\" like ? "
+"  and T_RLSD_PUCH_ODR.\"PUCH_ODR_STS_TYP\" = 2 "
+"  and T_RLSD_PUCH_ODR.\"PARTIAL_DELIV_SLIP_ISS_FLG\" = ? "
+"order by "
+"  T_RLSD_PUCH_ODR.\"PUCH_ODR_START_DATE\", "
+"  T_RLSD_PUCH_ODR.\"PUCH_ODR_DLV_DATE\", "
+"  T_RLSD_PUCH_ODR.\"PUCH_ODR_CD\"";
		...
		public List read(Connection conn, AE0030020Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:View1_read
			if(m_selcmd==null) throw new FoundationException("View1", "read", "クエリー未登録");
		...
		public List read(Connection conn, AE0030020Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:View1_read2
			if(m_selcmd==null) throw new FoundationException("View1", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AE0030020Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:View1_read3
			if(m_selcmd==null) throw new FoundationException("View1", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public PreparedStatement prepare(Connection conn, String query, AE0030020Struct data) throws FoundationException, SQLException
		{
			...
			try {
				...
				ary.addElement(data.getJOB_ODR_CD());
				if(isNull(data.getJOB_ODR_CD())) isNull = true;
				ary.addElement(data.getPARTIAL_DELIV_SLIP_ISS_FLG());
				if(isNull(data.getPARTIAL_DELIV_SLIP_ISS_FLG())) isNull = true;
				...
				throw new FoundationException("View1", "prepare", "Parse失敗:"+e.toString());
			} finally {
				ary.removeAllElements();
				ary = null;
			}
		...
		public ResultSet executeQuery(PreparedStatement stmt, AE0030020Struct data) throws FoundationException, SQLException
		{
			...
			if(!isNull(data.getJOB_ODR_CD())) setString(no ++, data.getJOB_ODR_CD(), stmt);
			//動的SQL生成ロジック
			if(!isNull(data.getPARTIAL_DELIV_SLIP_ISS_FLG())) setString(no ++, data.getPARTIAL_DELIV_SLIP_ISS_FLG(), stmt);
		...
		public boolean hasRecord(Connection conn, AE0030020Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("View1", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AE0030020Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:View1_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);;
		...
		public void clear()
		{
			//{{user_implement_dev:View1_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:View1_clear
		...
		public View1()
		{
			//{{user_implement_dev:View1_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:View1_constractor
	 ...
	 * Entity定義 静的SQL
	 */
	public class ViewCnt1 extends DataObject
	{
		protected String m_selcmd = "select "
+"  count(1) "
+"from "
...
+"  and ROWNUM <= TO_NUMBER(?) + 1";
		...
		//{{user_implement_dev:ViewCnt1_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:ViewCnt1_def
		...
		public List read(Connection conn, AE0030020Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:ViewCnt1_read
			if(m_selcmd==null) throw new FoundationException("ViewCnt1", "read", "クエリー未登録");
		...
		public List read(Connection conn, AE0030020Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:ViewCnt1_read2
			if(m_selcmd==null) throw new FoundationException("ViewCnt1", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStr);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public List read(Connection conn, AE0030020Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:ViewCnt1_read3
			if(m_selcmd==null) throw new FoundationException("ViewCnt1", "read", "クエリー未登録");
			String sql = replaceSql(m_selcmd, replaceStrs);
			PreparedStatement stmt=prepare(conn, sql, data);
		...
		public PreparedStatement prepare(Connection conn, String query, AE0030020Struct data) throws FoundationException, SQLException
		{
			...
			try {
				...
				throw new FoundationException("ViewCnt1", "prepare", "Parse失敗:"+e.toString());
			} finally {
				ary.removeAllElements();
				ary = null;
			}
		...
		public boolean hasRecord(Connection conn, AE0030020Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("ViewCnt1", "hasRecord", "クエリー未登録");
		...
		public boolean check(Connection conn, AE0030020Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:ViewCnt1_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);;
		...
		public void clear()
		{
			//{{user_implement_dev:ViewCnt1_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:ViewCnt1_clear
		...
		/**
		 * ViewCnt1クラスの標準コンストラクタ
		 */
		public ViewCnt1()
		{
			//{{user_implement_dev:ViewCnt1_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:ViewCnt1_constractor
	...
	public void clear()
	{
		...
		mSYS_DATE_CTRL = null;
		mT_RLSD_PUCH_ODR_UPDATE.clear();
		mT_RLSD_PUCH_ODR_UPDATE = null;
		mView1.clear();
		mView1 = null;
		mViewCnt1.clear();
		mViewCnt1 = null;
	 ...
	 */
	public AE0030020Entity() throws FoundationException
	{
