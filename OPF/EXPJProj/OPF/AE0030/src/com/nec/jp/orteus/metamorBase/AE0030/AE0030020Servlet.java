/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AE0030/src/com/nec/jp/orteus/metamorBase/AE0030/AE0030020Servlet.java,v $
 *
...
public class AE0030020Servlet extends HttpServlet
{
	 ...
	 * @param control AE0030020Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, AE0030020Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control AE0030020Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, AE0030020Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					AE0030020Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AE0030020Entity entity = control.entity;
		AE0030020Struct struct = control.struct;
		...
		try {
			...
			logger.entering("AE0030020Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
			// TODO: ユーザ定義のコードを記述してください
//			LogWriter.write( Level.ALL, "AE0030020"+" $Revision: 1.20 $" );
			control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("AE0030020Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					AE0030020Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		AE0030020Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0030");
		logger.entering("AE0030020Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
...
//			e.printStackTrace();
//			LogWriter.write(Level.ALL, objMessage.getIDMsg("AE0030020-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
		}
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("AE0030020Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickSelect(
					...
					HttpSession so,
					Hashtable params,
					AE0030020Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		AE0030020Entity entity = control.entity;
		AE0030020Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0030");
		logger.entering("AE0030020Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickSelect>
		logger.exiting("AE0030020Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
					...
					AE0030020Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0030");
		logger.entering("AE0030020Servlet"+":USER="+request.getRemoteUser(),"onClickPrint");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickPrint>
		logger.exiting("AE0030020Servlet"+":USER="+request.getRemoteUser(),"onClickPrint");
					...
					AE0030020Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0030");
		logger.entering("AE0030020Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("AE0030020Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
					...
					AE0030020Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0030");
		logger.entering("AE0030020Servlet"+":USER="+request.getRemoteUser(),"onClickCheckAll");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickCheckAll>
		logger.exiting("AE0030020Servlet"+":USER="+request.getRemoteUser(),"onClickCheckAll");
					...
					AE0030020Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0030");
		logger.entering("AE0030020Servlet"+":USER="+request.getRemoteUser(),"onClickUncheckAll");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickUncheckAll>
		logger.exiting("AE0030020Servlet"+":USER="+request.getRemoteUser(),"onClickUncheckAll");
	 ...
	 * @param control AE0030020Controlクラスインスタンス
	 */
	public String onClickPartialSlipOutput(
					HttpServletRequest request,
					HttpServletResponse response,
					HttpSession so,
					Hashtable params,
					AE0030020Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0030");
		logger.entering("AE0030020Servlet"+":USER="+request.getRemoteUser(),"onClickPartialSlipOutput");
		//{{user_implement_dev:<onClickPartialSlipOutput>
			// TODO: ユーザ定義のコードを記述してください
		try {
			control.control_eventHandller("PartialSlipOutput");
		} catch(FoundationException e) {
//			e.printStackTrace();
			// エラー処理を記述してください。
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
                ...
                //}}user_implement_dev:<onClickPartialSlipOutput>
		logger.exiting("AE0030020Servlet"+":USER="+request.getRemoteUser(),"onClickPartialSlipOutput");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, AE0030020Struct struct)
	{
		String locale = (String) so.getAttribute("LOCALE");
		
		String[] PLANT_NAME = ((params.containsKey("PLANT_NAME")) ? (String[])params.get("PLANT_NAME") : (String[])null);
		String[] ReOutputFlag = ((params.containsKey("ReOutputFlag")) ? (String[])params.get("ReOutputFlag") : (String[])null);
		...
		String[] r1_FILTER3 = ((params.containsKey("r1_FILTER3")) ? (String[])params.get("r1_FILTER3") : (String[])null);
		String[] r2_FILTER3 = ((params.containsKey("r2_FILTER3")) ? (String[])params.get("r2_FILTER3") : (String[])null);
		String[] l_PUCH_ODR_INST_SLIP_ISS_FLG = ((params.containsKey("l_PUCH_ODR_INST_SLIP_ISS_FLG")) ? (String[])params.get("l_PUCH_ODR_INST_SLIP_ISS_FLG") : (String[])null);

		struct.setPLANT_NAME( ((PLANT_NAME == null) ? (String)null : PLANT_NAME[0]) );
		struct.setList_PLANT_NAME(TypeConverter.convert(PLANT_NAME));
		struct.setReOutputFlag( ((ReOutputFlag == null) ? (String)null : ReOutputFlag[0]) );
		struct.setList_ReOutputFlag(TypeConverter.convert(ReOutputFlag));
		...
		struct.setr1_FILTER3( ((r1_FILTER3 == null) ? (String)null : r1_FILTER3[0]) );
		struct.setList_r1_FILTER3(TypeConverter.convert(r1_FILTER3));
		struct.setr2_FILTER3( ((r2_FILTER3 == null) ? (String)null : r2_FILTER3[0]) );
		struct.setList_r2_FILTER3(TypeConverter.convert(r2_FILTER3));
		struct.setl_PUCH_ODR_INST_SLIP_ISS_FLG( ((l_PUCH_ODR_INST_SLIP_ISS_FLG == null) ? (String)null : l_PUCH_ODR_INST_SLIP_ISS_FLG[0]) );
		struct.setList_l_PUCH_ODR_INST_SLIP_ISS_FLG(TypeConverter.convert(l_PUCH_ODR_INST_SLIP_ISS_FLG));
	...
	public static String DEFAULT_TARGET = "/AE0030020.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAE0030020Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAE0030020Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AE0030");
		logger.entering("AE0030020Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("AE0030020Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		AE0030020Control control;
		AE0030020Entity  entity = null;
		AE0030020Struct  struct = null;
		...
		try {
			...
			if( (control = (AE0030020Control)so.getAttribute("AE0030020Control_"+request.getSession(false).getId())) == null ) {
				control = new AE0030020Control();
			...
			try {
				...
				} else if( isClick(request, "PartialSlipOutput") ) {
					if ( !isCryptical(request, so, params, "PartialSlipOutput") ) return ERROR_TARGET;
					target = onClickPartialSlipOutput(request, response, so, params, control);
					control.setButton("PartialSlipOutput");
				} else {
					target = defaultEvent(request, response, so, params, control, refererURL);
				}

				so.setAttribute("AE0030020Control_"+request.getSession(false).getId(),control);
				...
				|| (isClick(request, "PartialSlipOutput") && bFLG_DISCONNECT_PartialSlipOutput)
				) {
	...
	private  static boolean bFLG_DISCONNECT_PartialSlipOutput = true;
	...
	{
		return "com.nec.jp.orteus.metamorBase.AE0030.AE0030020Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public AE0030020Servlet()
	{
		//{{user_implement_dev:<AE0030020_DisConnect_FLG>
		...
		bFLG_DISCONNECT_UncheckAll = true;
		bFLG_DISCONNECT_PartialSlipOutput = true;

                //}}user_implement_dev:<AE0030020_DisConnect_FLG>

		//{{user_implement_dev:<AE0030020Servlet>
