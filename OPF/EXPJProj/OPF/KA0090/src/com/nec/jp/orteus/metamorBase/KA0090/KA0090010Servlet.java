/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KA0090/src/com/nec/jp/orteus/metamorBase/KA0090/KA0090010Servlet.java,v $
 *
...
public class KA0090010Servlet extends HttpServlet
{
	 ...
	 * @param control KA0090010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, KA0090010Control control)
	{
		if (params == null) {
...
if(params.containsKey("ORG_CD")) {
 orgCd = (String[])params.get("ORG_CD");
}
else {
 orgCd = (String[])null;
}
if(orgCd == null) {
 control.setOrgCd((String)null);
}
else {
 control.setOrgCd(orgCd[0]);
}
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control KA0090010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, KA0090010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					KA0090010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		KA0090010Entity entity = control.entity;
		KA0090010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("KA0090010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
                 // TODO: ユーザ定義のコードを記述してください
              //			objMessage.m_writer.write( Level.ALL, "KA0090010"+" $Revision: 1.5 $" );
                 control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("KA0090010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					KA0090010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		KA0090010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KA0090");
		logger.entering("KA0090010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
		...
		//{{user_implement_dev:<reloadEvent>
              ...
              //			e.printStackTrace();
              //			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("KA0090010-E999","リロード処理"));
                 ExpjException ee = new ExpjException(e, "ZZ01106");
                 throw ee;
                }
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("KA0090010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickselect(
					...
					HttpSession so,
					Hashtable params,
					KA0090010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		KA0090010Entity entity = control.entity;
		KA0090010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KA0090");
		logger.entering("KA0090010Servlet"+":USER="+request.getRemoteUser(),"onClickselect");
		//{{user_implement_dev:<onClickselect>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickselect>
		logger.exiting("KA0090010Servlet"+":USER="+request.getRemoteUser(),"onClickselect");
					...
					KA0090010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KA0090");
		logger.entering("KA0090010Servlet"+":USER="+request.getRemoteUser(),"onClickinsert");
		//{{user_implement_dev:<onClickinsert>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickinsert>
		logger.exiting("KA0090010Servlet"+":USER="+request.getRemoteUser(),"onClickinsert");
					...
					KA0090010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KA0090");
		logger.entering("KA0090010Servlet"+":USER="+request.getRemoteUser(),"onClickupdate");
		//{{user_implement_dev:<onClickupdate>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickupdate>
		logger.exiting("KA0090010Servlet"+":USER="+request.getRemoteUser(),"onClickupdate");
					...
					KA0090010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KA0090");
		logger.entering("KA0090010Servlet"+":USER="+request.getRemoteUser(),"onClickclear");
		//{{user_implement_dev:<onClickclear>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickclear>
		logger.exiting("KA0090010Servlet"+":USER="+request.getRemoteUser(),"onClickclear");
					...
					KA0090010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KA0090");
		logger.entering("KA0090010Servlet"+":USER="+request.getRemoteUser(),"onClickdelete");
		//{{user_implement_dev:<onClickdelete>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickdelete>
		logger.exiting("KA0090010Servlet"+":USER="+request.getRemoteUser(),"onClickdelete");
					...
					KA0090010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KA0090");
		logger.entering("KA0090010Servlet"+":USER="+request.getRemoteUser(),"onClickclose");
		//{{user_implement_dev:<onClickclose>
              ...
              //			e.printStackTrace();
                ...
                //}}user_implement_dev:<onClickclose>
		logger.exiting("KA0090010Servlet"+":USER="+request.getRemoteUser(),"onClickclose");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, KA0090010Struct struct)
	{
		...
		String[] ORG_ANAME = ((params.containsKey("ORG_ANAME")) ? (String[])params.get("ORG_ANAME") : (String[])null);
		String[] ORG_KNAME = ((params.containsKey("ORG_KNAME")) ? (String[])params.get("ORG_KNAME") : (String[])null);
		String[] ORG_ENAME = ((params.containsKey("ORG_ENAME")) ? (String[])params.get("ORG_ENAME") : (String[])null);
		...
		String[] h_ORG_CD = ((params.containsKey("h_ORG_CD")) ? (String[])params.get("h_ORG_CD") : (String[])null);
		...
		struct.setORG_ANAME( ((ORG_ANAME == null) ? (String)null : ORG_ANAME[0]) );
		struct.setList_ORG_ANAME(TypeConverter.convert(ORG_ANAME));
		struct.setORG_KNAME( ((ORG_KNAME == null) ? (String)null : ORG_KNAME[0]) );
		struct.setList_ORG_KNAME(TypeConverter.convert(ORG_KNAME));
		struct.setORG_ENAME( ((ORG_ENAME == null) ? (String)null : ORG_ENAME[0]) );
		struct.setList_ORG_ENAME(TypeConverter.convert(ORG_ENAME));
		...
		struct.seth_ORG_CD( ((h_ORG_CD == null) ? (String)null : h_ORG_CD[0]) );
		struct.setList_h_ORG_CD(TypeConverter.convert(h_ORG_CD));
	...
	public static String DEFAULT_TARGET = "/KA0090010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aKA0090010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aKA0090010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KA0090");
		logger.entering("KA0090010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("KA0090010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		KA0090010Control control;
		KA0090010Entity  entity = null;
		KA0090010Struct  struct = null;
		...
		try {
			...
			if( (control = (KA0090010Control)so.getAttribute("KA0090010Control_"+request.getSession(false).getId())) == null ) {
				control = new KA0090010Control();
			...
			try {
				...
				so.setAttribute("KA0090010Control_"+request.getSession(false).getId(),control);
	...
	{
		return "com.nec.jp.orteus.metamorBase.KA0090.KA0090010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public KA0090010Servlet()
	{
		//{{user_implement_dev:<KA0090010_DisConnect_FLG>
		...
		//{{user_implement_dev:<KA0090010Servlet>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<KA0090010Servlet>
	}
