/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AD0080/src/com/nec/jp/orteus/metamorBase/AD0080/AD0080B001/SYS_TYPE_VALUE.java,v $
 *
...
public class SYS_TYPE_VALUE extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN1_R(m_med.getDEFECT_CAUSE_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("SYS_TYPE_VALUE", "read", "レコード検索条件設定処理失敗");
		...
		public String getVALUE_R() throws FoundationException { return m_doRs.getString(1); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setDEFECT_CAUSE_CD(getVALUE_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("SYS_TYPE_VALUE", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("SYS_TYPE_VALUE", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	 ...
	 *
		 */
	public SYS_TYPE_VALUE(medAD0080B001 med, BatchAppConductor cdr) throws SystemException
	{
