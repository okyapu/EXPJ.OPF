/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AD0080/src/com/nec/jp/orteus/metamorBase/AD0080/AD0080B001/SelectTworkProcByProc.java,v $
 *
...
/**
 * CLASS     : SelectTworkProcByProc クラス
 * ファイル・クラス説明
...
public class SelectTworkProcByProc extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				BatchAppException be=new BatchAppException("SelectTworkProcByProc", "read", "レコード検索条件設定処理失敗");
		...
		public String getDATA_COUNT_R() throws FoundationException { return m_doRs.getString(1); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setDATA_COUNT(getDATA_COUNT_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("SelectTworkProcByProc", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("SelectTworkProcByProc", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	 ...
	 *
		 */
	public SelectTworkProcByProc(medAD0080B001 med, BatchAppConductor cdr) throws SystemException
	{
