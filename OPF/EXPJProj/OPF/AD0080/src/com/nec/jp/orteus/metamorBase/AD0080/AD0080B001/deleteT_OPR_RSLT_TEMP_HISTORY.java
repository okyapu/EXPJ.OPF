/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AD0080/src/com/nec/jp/orteus/metamorBase/AD0080/AD0080B001/deleteT_OPR_RSLT_TEMP_HISTORY.java,v $
 *
...
/**
 * CLASS     : deleteT_OPR_RSLT_TEMP_HISTORY クラス
 * ファイル・クラス説明
...
public class deleteT_OPR_RSLT_TEMP_HISTORY extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setIN0_D(String value) throws FoundationException { getAdapt_D().setString(1, value); }
		public void setB1_D(String value) throws FoundationException { getAdapt_D().setString(2, value); }
		public void setB2_D(String value) throws FoundationException { getAdapt_D().setString(3, value); }

		public int delete() throws BatchAppException
		{
			try {

				setIN0_D(m_med.getOPR_INST_CD());
				setB1_D(m_med.getINTAKE_TERM_FROM());
				setB2_D(m_med.getINTAKE_TERM_TO());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("deleteT_OPR_RSLT_TEMP_HISTORY", "delete", "レコード削除条件設定処理失敗");
	...
	/**
	 * deleteT_OPR_RSLT_TEMP_HISTORYクラスの標準コンストラクタ
	 *
		 */
	public deleteT_OPR_RSLT_TEMP_HISTORY(medAD0080B001 med, BatchAppConductor cdr) throws SystemException
	{
