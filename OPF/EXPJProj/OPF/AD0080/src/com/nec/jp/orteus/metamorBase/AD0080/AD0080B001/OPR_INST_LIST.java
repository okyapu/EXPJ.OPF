/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AD0080/src/com/nec/jp/orteus/metamorBase/AD0080/AD0080B001/OPR_INST_LIST.java,v $
 *
...
/**
 * CLASS     : OPR_INST_LIST クラス
 * ファイル・クラス説明
 * @author $Author: geng-jia $
 * @version $Revision: 1.12 $ $Date: 2015/12/22 09:52:51 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class OPR_INST_LIST extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setTAKE_DATE_FROM_R(String value) throws FoundationException { getAdapt_R().setString(1, value); }
		public void setTAKE_DATE_TO_R(String value) throws FoundationException { getAdapt_R().setString(2, value); }
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				BatchAppException be=new BatchAppException("OPR_INST_LIST", "read", "レコード検索条件設定処理失敗");
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				BatchAppException be=new BatchAppException("OPR_INST_LIST", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("OPR_INST_LIST", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	...
	/**
	 * OPR_INST_LISTクラスの標準コンストラクタ
	 *
		 */
	public OPR_INST_LIST(medAD0080B001 med, BatchAppConductor cdr) throws SystemException
	{
