/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AD0080/src/com/nec/jp/orteus/metamorBase/AD0080/AD0080B001/SelectWhTyp.java,v $
 *
...
/**
 * CLASS     : SelectWhTyp クラス
 * ファイル・クラス説明
 * @author $Author: geng-jia $
 * @version $Revision: 1.8 $ $Date: 2015/12/22 09:52:52 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class SelectWhTyp extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN1_R(m_med.getNEXT_WH_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("SelectWhTyp", "read", "レコード検索条件設定処理失敗");
		...
		public String getWH_TYP_R() throws FoundationException { return m_doRs.getString(1); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setWH_TYP(getWH_TYP_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("SelectWhTyp", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("SelectWhTyp", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	 ...
	 *
		 */
	public SelectWhTyp(medAD0080B001 med, BatchAppConductor cdr) throws SystemException
	{
