/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AD0080/src/com/nec/jp/orteus/metamorBase/AD0080/AD0080B001/selectPRODUCT_TYP.java,v $
 *
...
/**
 * CLASS     : selectPRODUCT_TYP クラス
 * ファイル・クラス説明
 * @author $Author: geng-jia $
 * @version $Revision: 1.11 $ $Date: 2015/12/22 09:52:55 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class selectPRODUCT_TYP extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				BatchAppException be=new BatchAppException("selectPRODUCT_TYP", "read", "レコード検索条件設定処理失敗");
		...
		public String getPRODUCT_TYP_R() throws FoundationException { return m_doRs.getString(1); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setPRODUCT_TYP(getPRODUCT_TYP_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("selectPRODUCT_TYP", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("selectPRODUCT_TYP", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	 ...
	 *
		 */
	public selectPRODUCT_TYP(medAD0080B001 med, BatchAppConductor cdr) throws SystemException
	{
