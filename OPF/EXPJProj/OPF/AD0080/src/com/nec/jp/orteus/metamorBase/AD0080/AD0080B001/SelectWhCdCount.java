/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AD0080/src/com/nec/jp/orteus/metamorBase/AD0080/AD0080B001/SelectWhCdCount.java,v $
 *
...
public class SelectWhCdCount extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN1_R(m_med.getOPR_INST_CD());
				setIN2_R(m_med.getWH_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("SelectWhCdCount", "read", "レコード検索条件設定処理失敗");
		...
		public String getWH_CD_COUNT_R() throws FoundationException { return m_doRs.getString(1); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setWH_CD_COUNT(getWH_CD_COUNT_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("SelectWhCdCount", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("SelectWhCdCount", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	 ...
	 *
		 */
	public SelectWhCdCount(medAD0080B001 med, BatchAppConductor cdr) throws SystemException
	{
