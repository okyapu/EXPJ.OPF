/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AD0080/src/com/nec/jp/orteus/metamorBase/AD0080/AD0080B001/CheckFirstWork.java,v $
 *
...
/**
 * CLASS     : CheckFirstWork クラス
 * ファイル・クラス説明
 * @author $Author: geng-jia $
 * @version $Revision: 1.8 $ $Date: 2015/12/22 09:52:49 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class CheckFirstWork extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN2_R(m_med.getWORK_ODR_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("CheckFirstWork", "read", "レコード検索条件設定処理失敗");
		...
		public String getPROC_NO_R() throws FoundationException { return m_doRs.getString(2); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setFIRST_OPR_INST_CD(getOPR_INST_CD_R());
				m_med.setFIRST_PROC_NO(getPROC_NO_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("CheckFirstWork", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("CheckFirstWork", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	 ...
	 *
		 */
	public CheckFirstWork(medAD0080B001 med, BatchAppConductor cdr) throws SystemException
	{
