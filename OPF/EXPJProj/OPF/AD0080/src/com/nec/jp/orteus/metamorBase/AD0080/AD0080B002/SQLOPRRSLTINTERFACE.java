/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AD0080/src/com/nec/jp/orteus/metamorBase/AD0080/AD0080B002/SQLOPRRSLTINTERFACE.java,v $
 *
...
public class SQLOPRRSLTINTERFACE extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public List call() throws BatchAppException
		{
			try {
				...
				e.printStackTrace();
				BatchAppException be=new BatchAppException("SQLOPRRSLTINTERFACE", "call", "Stored Procedure条件設定処理失敗");
				...
				if (cstmt != null) {
					try {
						...
						ef.printStackTrace();
						BatchAppException bef = new BatchAppException("SQLOPRRSLTINTERFACE", "call", "Stored Procedureクローズ処理失敗");
		 ...
		 */
		public medAD0080B002 call(ResultSet rs) throws SQLException
		{
			if(rs == null || rs.next()==false) return null;
			medAD0080B002 data = new medAD0080B002();
			m_med.setpnumReturn(cstmt.getString(11));
			return data;
		}
	...
	/**
	 * SQLOPRRSLTINTERFACEクラスの標準コンストラクタ
	 *
		 */
	public SQLOPRRSLTINTERFACE(medAD0080B002 med, BatchAppConductor cdr) throws SystemException
	{
	...
	protected static String m_calcmd = "{" + "Call SQLOPRRSLTINTERFACE(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" + "}";
