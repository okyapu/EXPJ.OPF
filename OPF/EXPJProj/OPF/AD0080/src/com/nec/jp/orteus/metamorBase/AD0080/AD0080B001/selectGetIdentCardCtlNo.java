/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AD0080/src/com/nec/jp/orteus/metamorBase/AD0080/AD0080B001/selectGetIdentCardCtlNo.java,v $
 *
...
/**
 * CLASS     : selectGetIdentCardCtlNo クラス
 * ファイル・クラス説明
 * @author $Author: geng-jia $
 * @version $Revision: 1.12 $ $Date: 2015/12/22 09:52:54 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class selectGetIdentCardCtlNo extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN2_R(m_med.getITEM_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("selectGetIdentCardCtlNo", "read", "レコード検索条件設定処理失敗");
		...
		public String getIDENT_CARD_CTL_NO_R() throws FoundationException { return m_doRs.getString(1); }
		public String getPKG_UNIT_QTY_R() throws FoundationException { return m_doRs.getString(2); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setIDENT_CARD_CTL_NO(getIDENT_CARD_CTL_NO_R());
				m_med.setPKG_UNIT_QTY(getPKG_UNIT_QTY_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("selectGetIdentCardCtlNo", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("selectGetIdentCardCtlNo", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	 ...
	 *
		 */
	public selectGetIdentCardCtlNo(medAD0080B001 med, BatchAppConductor cdr) throws SystemException
	{
