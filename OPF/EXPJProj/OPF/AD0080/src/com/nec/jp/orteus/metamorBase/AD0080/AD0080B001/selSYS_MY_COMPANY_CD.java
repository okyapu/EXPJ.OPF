/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AD0080/src/com/nec/jp/orteus/metamorBase/AD0080/AD0080B001/selSYS_MY_COMPANY_CD.java,v $
 *
...
/**
 * CLASS     : selSYS_MY_COMPANY_CD クラス
 * ファイル・クラス説明
 * @author $Author: geng-jia $
 * @version $Revision: 1.9 $ $Date: 2015/12/22 09:52:54 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class selSYS_MY_COMPANY_CD extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				BatchAppException be=new BatchAppException("selSYS_MY_COMPANY_CD", "read", "レコード検索条件設定処理失敗");
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				BatchAppException be=new BatchAppException("selSYS_MY_COMPANY_CD", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("selSYS_MY_COMPANY_CD", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	...
	/**
	 * selSYS_MY_COMPANY_CDクラスの標準コンストラクタ
	 *
		 */
	public selSYS_MY_COMPANY_CD(medAD0080B001 med, BatchAppConductor cdr) throws SystemException
	{
