...
public class AE0130010Servlet extends HttpServlet
{
	 ...
	 * @param control AE0130010Controlクラスインスタンス
	 */
...
//			e.printStackTrace();
//			LogWriter.write(Level.ALL, objMessage.getIDMsg("AE0130010-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
		}
                //}}user_implement_dev:<reloadEvent>
...
//			e.printStackTrace();
	...
	public static String DEFAULT_TARGET = "/AE0130010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aAE0130010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aAE0130010Struct";   // JSP先のバインド名(Struct)の指定
