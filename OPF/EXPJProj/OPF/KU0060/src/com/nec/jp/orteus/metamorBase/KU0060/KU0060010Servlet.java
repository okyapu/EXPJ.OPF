/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KU0060/src/com/nec/jp/orteus/metamorBase/KU0060/KU0060010Servlet.java,v $
 *
...
public class KU0060010Servlet extends HttpServlet
{
	 ...
	 * @param control KU0060010Controlクラスインスタンス
	 */
	private void setScreenMoveParams(Hashtable params, KU0060010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenMoveParams>
	 ...
	 * @param control KU0060010Controlクラスインスタンス
	 */
	private void setScreenCommonParams(Hashtable params, KU0060010Control control)
	{
		if (params == null) {
...
//}}user_implement_dev:<setScreenCommonParams>
	...
	public String initialEvent(
					...
					HttpSession so,
					Hashtable params,
					KU0060010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		KU0060010Entity entity = control.entity;
		KU0060010Struct struct = control.struct;
		...
		try {
			...
			logger.entering("KU0060010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
		//{{user_implement_dev:<initialEvent>
			// TODO: ユーザ定義のコードを記述してください
//			LogWriter.write( Level.ALL, "KU0060010"+" $Revision: 1.13 $" );
			control.control_eventHandller("initial");
                //}}user_implement_dev:<initialEvent>
			logger.exiting("KU0060010Servlet"+":USER="+request.getRemoteUser(),"initialEvent");
...
//			e.printStackTrace();
					...
					KU0060010Control control ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		KU0060010Struct struct = control.struct;
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KU0060");
		logger.entering("KU0060010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
...
//			e.printStackTrace();
//			LogWriter.write(Level.ALL, objMessage.getIDMsg("KU0060010-E999","リロード処理"));
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
		}
                //}}user_implement_dev:<reloadEvent>
		logger.exiting("KU0060010Servlet"+":USER="+request.getRemoteUser(),"reloadEvent");
	...
	public String onClickSelect(
					...
					HttpSession so,
					Hashtable params,
					KU0060010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		String nextUrl = null;		// 移動先ＵＲＬ
		KU0060010Entity entity = control.entity;
		KU0060010Struct struct = control.struct;
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KU0060");
		logger.entering("KU0060010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickSelect>
		logger.exiting("KU0060010Servlet"+":USER="+request.getRemoteUser(),"onClickSelect");
					...
					KU0060010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KU0060");
		logger.entering("KU0060010Servlet"+":USER="+request.getRemoteUser(),"onClickInsert");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickInsert>
		logger.exiting("KU0060010Servlet"+":USER="+request.getRemoteUser(),"onClickInsert");
					...
					KU0060010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KU0060");
		logger.entering("KU0060010Servlet"+":USER="+request.getRemoteUser(),"onClickDelete");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickDelete>
		logger.exiting("KU0060010Servlet"+":USER="+request.getRemoteUser(),"onClickDelete");
					...
					KU0060010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KU0060");
		logger.entering("KU0060010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClear>
		logger.exiting("KU0060010Servlet"+":USER="+request.getRemoteUser(),"onClickClear");
					...
					KU0060010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KU0060");
		logger.entering("KU0060010Servlet"+":USER="+request.getRemoteUser(),"onClickClose");
...
//			e.printStackTrace();
			...
			throw ee;
                ...
                //}}user_implement_dev:<onClickClose>
		logger.exiting("KU0060010Servlet"+":USER="+request.getRemoteUser(),"onClickClose");
	 ...
	 * @param control KU0060010Controlクラスインスタンス
	 */
	public String onClickScrmvToShipDir(
					HttpServletRequest request,
					HttpServletResponse response,
					HttpSession so,
					Hashtable params,
					KU0060010Control control ) throws BusinessProcessException, ServletException, IOException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KU0060");
		logger.entering("KU0060010Servlet"+":USER="+request.getRemoteUser(),"onClickScrmvToShipDir");
		//{{user_implement_dev:<onClickScrmvToShipDir>
			// TODO: ユーザ定義のコードを記述してください
		try {
			control.control_eventHandller("ScrmvToShipDir");
		} catch(FoundationException e) {
//			e.printStackTrace();
			// エラー処理を記述してください。
			ExpjException ee = new ExpjException(e, "ZZ01106");
			throw ee;
                ...
                //}}user_implement_dev:<onClickScrmvToShipDir>
		logger.exiting("KU0060010Servlet"+":USER="+request.getRemoteUser(),"onClickScrmvToShipDir");

		return nextUrl;
	}


	public void getSessionParameters(HttpSession so, Hashtable params, KU0060010Struct struct)
	{
		String locale = (String) so.getAttribute("LOCALE");
		
		String[] ODR_NO = ((params.containsKey("ODR_NO")) ? (String[])params.get("ODR_NO") : (String[])null);
		String[] r1_SHIP_ODR = ((params.containsKey("r1_SHIP_ODR")) ? (String[])params.get("r1_SHIP_ODR") : (String[])null);
		String[] ITEM_CD = ((params.containsKey("ITEM_CD")) ? (String[])params.get("ITEM_CD") : (String[])null);
		String[] r2_SHIP_ODR = ((params.containsKey("r2_SHIP_ODR")) ? (String[])params.get("r2_SHIP_ODR") : (String[])null);
		String[] DESINATED_DLV_DATE = ((params.containsKey("DESINATED_DLV_DATE")) ? (String[])params.get("DESINATED_DLV_DATE") : (String[])null);
		String[] DESINATED_SHIP_DATE = ((params.containsKey("DESINATED_SHIP_DATE")) ? (String[])params.get("DESINATED_SHIP_DATE") : (String[])null);
		...
		String[] l_SHIP_QTY = ((params.containsKey("l_SHIP_QTY")) ? (String[])params.get("l_SHIP_QTY") : (String[])null);
		String[] l_REST_SHIP_QTY = ((params.containsKey("l_REST_SHIP_QTY")) ? (String[])params.get("l_REST_SHIP_QTY") : (String[])null);
		...
		String[] l_c_DIRECT_DLV_FLG = ((params.containsKey("l_c_DIRECT_DLV_FLG")) ? (String[])params.get("l_c_DIRECT_DLV_FLG") : (String[])null);
		...
		String[] l_TRANSPORT_TYP = ((params.containsKey("l_TRANSPORT_TYP")) ? (String[])params.get("l_TRANSPORT_TYP") : (String[])null);
		...
		String[] l_PARTIAL_SHIP_INST_FLG = ((params.containsKey("l_PARTIAL_SHIP_INST_FLG")) ? (String[])params.get("l_PARTIAL_SHIP_INST_FLG") : (String[])null);
		String[] l_ODR_CTL_NO = ((params.containsKey("l_ODR_CTL_NO")) ? (String[])params.get("l_ODR_CTL_NO") : (String[])null);
		String[] strBUSINESS_OPR_DATE = ((params.containsKey("strBUSINESS_OPR_DATE")) ? (String[])params.get("strBUSINESS_OPR_DATE") : (String[])null);
		String[] l_MODIFY_COUNT = ((params.containsKey("l_MODIFY_COUNT")) ? (String[])params.get("l_MODIFY_COUNT") : (String[])null);
		String[] l_DLV_MODIFY_COUNT = ((params.containsKey("l_DLV_MODIFY_COUNT")) ? (String[])params.get("l_DLV_MODIFY_COUNT") : (String[])null);

		struct.setODR_NO( ((ODR_NO == null) ? (String)null : ODR_NO[0]) );
		struct.setList_ODR_NO(TypeConverter.convert(ODR_NO));
		struct.setr1_SHIP_ODR( ((r1_SHIP_ODR == null) ? (String)null : r1_SHIP_ODR[0]) );
		struct.setList_r1_SHIP_ODR(TypeConverter.convert(r1_SHIP_ODR));
		struct.setITEM_CD( ((ITEM_CD == null) ? (String)null : ITEM_CD[0]) );
		struct.setList_ITEM_CD(TypeConverter.convert(ITEM_CD));
		struct.setr2_SHIP_ODR( ((r2_SHIP_ODR == null) ? (String)null : r2_SHIP_ODR[0]) );
		struct.setList_r2_SHIP_ODR(TypeConverter.convert(r2_SHIP_ODR));
		...
		struct.setDESINATED_SHIP_DATE( ((DESINATED_SHIP_DATE == null) ? (String)null : DESINATED_SHIP_DATE[0]) );
		struct.setList_DESINATED_SHIP_DATE(TypeConverter.convert(DESINATED_SHIP_DATE));
		...
		struct.setl_SHIP_QTY( ((l_SHIP_QTY == null) ? (String)null : l_SHIP_QTY[0]) );
		struct.setList_l_SHIP_QTY(TypeConverter.convert(l_SHIP_QTY));
		struct.setl_REST_SHIP_QTY( ((l_REST_SHIP_QTY == null) ? (String)null : l_REST_SHIP_QTY[0]) );
		struct.setList_l_REST_SHIP_QTY(TypeConverter.convert(l_REST_SHIP_QTY));
		...
		struct.setl_c_DIRECT_DLV_FLG( ((l_c_DIRECT_DLV_FLG == null) ? (String)null : l_c_DIRECT_DLV_FLG[0]) );
		struct.setList_l_c_DIRECT_DLV_FLG(TypeConverter.convert(l_c_DIRECT_DLV_FLG));
		...
		struct.setl_TRANSPORT_TYP( ((l_TRANSPORT_TYP == null) ? (String)null : l_TRANSPORT_TYP[0]) );
		struct.setList_l_TRANSPORT_TYP(TypeConverter.convert(l_TRANSPORT_TYP));
		...
		struct.setl_PARTIAL_SHIP_INST_FLG( ((l_PARTIAL_SHIP_INST_FLG == null) ? (String)null : l_PARTIAL_SHIP_INST_FLG[0]) );
		struct.setList_l_PARTIAL_SHIP_INST_FLG(TypeConverter.convert(l_PARTIAL_SHIP_INST_FLG));
		struct.setl_ODR_CTL_NO( ((l_ODR_CTL_NO == null) ? (String)null : l_ODR_CTL_NO[0]) );
		struct.setList_l_ODR_CTL_NO(TypeConverter.convert(l_ODR_CTL_NO));
		struct.setstrBUSINESS_OPR_DATE( ((strBUSINESS_OPR_DATE == null) ? (String)null : strBUSINESS_OPR_DATE[0]) );
		struct.setList_strBUSINESS_OPR_DATE(TypeConverter.convert(strBUSINESS_OPR_DATE));
		...
		struct.setl_DLV_MODIFY_COUNT( ((l_DLV_MODIFY_COUNT == null) ? (String)null : l_DLV_MODIFY_COUNT[0]) );
		struct.setList_l_DLV_MODIFY_COUNT(TypeConverter.convert(l_DLV_MODIFY_COUNT));
	...
	public static String DEFAULT_TARGET = "/KU0060010.jsp";          // 移動先URLの指定
	public static String JSP_BIND_NAME_Control = "aKU0060010Control"; // JSP先のバインド名(Control)の指定
	public static String JSP_BIND_NAME_Struct = "aKU0060010Struct";   // JSP先のバインド名(Struct)の指定
					...
					String refererURL ) throws BusinessProcessException, ServletException, IOException, MessageApiException
	{
		...
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KU0060");
		logger.entering("KU0060010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
		//{{user_implement_dev:<defaultEvent>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<defaultEvent>
		logger.exiting("KU0060010Servlet"+":USER="+request.getRemoteUser(),"defaultEvent");
					...
					HttpServletResponse response) throws ServletException, IOException
	{
		...
		KU0060010Control control;
		KU0060010Entity  entity = null;
		KU0060010Struct  struct = null;
		...
		try {
			...
			if( (control = (KU0060010Control)so.getAttribute("KU0060010Control_"+request.getSession(false).getId())) == null ) {
				control = new KU0060010Control();
			...
			try {
				...
				} else if( isClick(request, "ScrmvToShipDir") ) {
					if ( !isCryptical(request, so, params, "ScrmvToShipDir") ) return ERROR_TARGET;
					target = onClickScrmvToShipDir(request, response, so, params, control);
					control.setButton("ScrmvToShipDir");
				} else {
					target = defaultEvent(request, response, so, params, control, refererURL);
				}

				so.setAttribute("KU0060010Control_"+request.getSession(false).getId(),control);
				...
				|| (isClick(request, "ScrmvToShipDir") && bFLG_DISCONNECT_ScrmvToShipDir)
				) {
	...
	private  static boolean bFLG_DISCONNECT_ScrmvToShipDir = true;
	...
	{
		return "com.nec.jp.orteus.metamorBase.KU0060.KU0060010Servlet";
	}
	 ...
	 * 標準コンストラクタ
	 */
	public KU0060010Servlet()
	{
		//{{user_implement_dev:<KU0060010_DisConnect_FLG>
		...
		//{{user_implement_dev:<KU0060010Servlet>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<KU0060010Servlet>
	}
