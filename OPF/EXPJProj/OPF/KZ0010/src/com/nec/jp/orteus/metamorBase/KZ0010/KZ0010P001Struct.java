/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KZ0010/src/com/nec/jp/orteus/metamorBase/KZ0010/KZ0010P001Struct.java,v $
 *
...
public class KZ0010P001Struct extends DataStruct
{
	...
	public String getBRAND_CD() { return m_BRAND_CD; }
	public String getBRAND_NAME() { return m_BRAND_NAME; }
	...
	public List getList_BRAND_CD() { return l_BRAND_CD; }
	public List getList_BRAND_NAME() { return l_BRAND_NAME; }
	...
	public void setBRAND_CD(String val) { m_BRAND_CD = val; }
	public void setBRAND_NAME(String val) { m_BRAND_NAME = val; }
	...
	public void setList_BRAND_CD(List list) { l_BRAND_CD = list; }
	public void setList_BRAND_NAME(List list) { l_BRAND_NAME = list; }
	...
	public int setL2L_BRAND_CD(List list) {
		int size = (list != null) ? list.size() : 0;
		if (size == 0) {
			return 0;
		}
		if (l_BRAND_CD == null) {
			l_BRAND_CD = new ArrayList();
		} else {
			l_BRAND_CD.clear();
		}
		for (int i = 0; i < size; i++) {
			l_BRAND_CD.add(((KZ0010P001Struct) list.get(i)).getBRAND_CD());
		}
		return size;
	}
	public int setL2L_BRAND_NAME(List list) {
		int size = (list != null) ? list.size() : 0;
		if (size == 0) {
			return 0;
		}
		if (l_BRAND_NAME == null) {
			l_BRAND_NAME = new ArrayList();
		} else {
			l_BRAND_NAME.clear();
		}
		for (int i = 0; i < size; i++) {
			l_BRAND_NAME.add(((KZ0010P001Struct) list.get(i)).getBRAND_NAME());
		}
		return size;
	}
	...
	public int setL2L_CLAIM_ORG_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CLAIM_ORG_CD.add(((KZ0010P001Struct) list.get(i)).getCLAIM_ORG_CD());
		}
		return size;
	}
	public int setL2L_BILL_BALANCE_CTRL_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_BILL_BALANCE_CTRL_FLG.add(((KZ0010P001Struct) list.get(i)).getBILL_BALANCE_CTRL_FLG());
		}
		return size;
	}
	public int setL2L_AR_BALANCE_CTRL_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_AR_BALANCE_CTRL_FLG.add(((KZ0010P001Struct) list.get(i)).getAR_BALANCE_CTRL_FLG());
		}
		return size;
	}
	...
	public void setStructM(KZ0010P001Struct struct)
	{
		if (struct == null) {
			...
			this.setBRAND_CD(struct.getBRAND_CD());
			this.setBRAND_NAME(struct.getBRAND_NAME());
	...
	public void setStructL(KZ0010P001Struct struct)
	{
		if (struct == null) {
			...
			this.setList_BRAND_CD(struct.getList_BRAND_CD());
			this.setList_BRAND_NAME(struct.getList_BRAND_NAME());
...
/*
	...
	// 第 59 変数初期値： i_SHIP_SLIP_ID


	final static String i_SHIP_SLIP_ID = null;

	// 第 60 変数初期値： i_CARRIAGE_CHARGE_TYP


	final static String i_CARRIAGE_CHARGE_TYP = null;

	// 第 61 変数初期値： i_BRAND_CD


	final static String i_BRAND_CD = null;

	// 第 62 変数初期値： i_BRAND_NAME


	final static String i_BRAND_NAME = null;

	// 第 63 変数初期値： i_BILL_ADDRESSEE_CD


	final static String i_BILL_ADDRESSEE_CD = null;

	// 第 64 変数初期値： i_STL_COND_CD


	final static String i_STL_COND_CD = null;

	// 第 65 変数初期値： i_CLAIM_ORG_CD


	final static String i_CLAIM_ORG_CD = null;

	// 第 66 変数初期値： i_BILL_BALANCE_CTRL_FLG


	final static String i_BILL_BALANCE_CTRL_FLG = null;

	// 第 67 変数初期値： i_AR_BALANCE_CTRL_FLG


	final static String i_AR_BALANCE_CTRL_FLG = null;

	// 第 68 変数初期値： i_DLV_LOC_NAME
