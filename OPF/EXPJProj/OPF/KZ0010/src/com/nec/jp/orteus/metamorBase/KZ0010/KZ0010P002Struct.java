/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KZ0010/src/com/nec/jp/orteus/metamorBase/KZ0010/KZ0010P002Struct.java,v $
 *
...
public class KZ0010P002Struct extends DataStruct
{
	...
	/** 第 62 変数： m_CLAIM_ORG_CD */
	public String m_CLAIM_ORG_CD = null;
	/** 第 63 変数： m_BILL_BALANCE_CTRL_FLG */
	public String m_BILL_BALANCE_CTRL_FLG = null;
	/** 第 64 変数： m_AR_BALANCE_CTRL_FLG */
	public String m_AR_BALANCE_CTRL_FLG = null;
	/** 第 65 変数： m_DLV_LOC_NAME */
	...
	public String getCLAIM_ORG_CD() { return m_CLAIM_ORG_CD; }
	public String getBILL_BALANCE_CTRL_FLG() { return m_BILL_BALANCE_CTRL_FLG; }
	public String getAR_BALANCE_CTRL_FLG() { return m_AR_BALANCE_CTRL_FLG; }
	...
	public List getList_CLAIM_ORG_CD() { return l_CLAIM_ORG_CD; }
	public List getList_BILL_BALANCE_CTRL_FLG() { return l_BILL_BALANCE_CTRL_FLG; }
	public List getList_AR_BALANCE_CTRL_FLG() { return l_AR_BALANCE_CTRL_FLG; }
	...
	public void setCLAIM_ORG_CD(String val) { m_CLAIM_ORG_CD = val; }
	public void setBILL_BALANCE_CTRL_FLG(String val) { m_BILL_BALANCE_CTRL_FLG = val; }
	public void setAR_BALANCE_CTRL_FLG(String val) { m_AR_BALANCE_CTRL_FLG = val; }
	...
	public void setList_CLAIM_ORG_CD(List list) { l_CLAIM_ORG_CD = list; }
	public void setList_BILL_BALANCE_CTRL_FLG(List list) { l_BILL_BALANCE_CTRL_FLG = list; }
	public void setList_AR_BALANCE_CTRL_FLG(List list) { l_AR_BALANCE_CTRL_FLG = list; }
	...
	public int setL2L_COMPANY_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_COMPANY_CD.add(((KZ0010P002Struct) list.get(i)).getCOMPANY_CD());
		}
		return size;
	}
	public int setL2L_SLIP_CTRL_GRP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SLIP_CTRL_GRP.add(((KZ0010P002Struct) list.get(i)).getSLIP_CTRL_GRP());
		}
		return size;
	}
	public int setL2L_SLIP_TRN_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SLIP_TRN_CD.add(((KZ0010P002Struct) list.get(i)).getSLIP_TRN_CD());
		}
		return size;
	}
	public int setL2L_STOCK_CLASS_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_STOCK_CLASS_CD.add(((KZ0010P002Struct) list.get(i)).getSTOCK_CLASS_CD());
		}
		return size;
	}
	public int setL2L_BALANCE_CLASS_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_BALANCE_CLASS_CD.add(((KZ0010P002Struct) list.get(i)).getBALANCE_CLASS_CD());
		}
		return size;
	}
	public int setL2L_HOME_CUR_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_HOME_CUR_CD.add(((KZ0010P002Struct) list.get(i)).getHOME_CUR_CD());
		}
		return size;
	}
	public int setL2L_SALES_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SALES_DATE.add(((KZ0010P002Struct) list.get(i)).getSALES_DATE());
		}
		return size;
	}
	public int setL2L_SALES_DEPT_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SALES_DEPT_CD.add(((KZ0010P002Struct) list.get(i)).getSALES_DEPT_CD());
		}
		return size;
	}
	public int setL2L_CUST_CHRG_PSN_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUST_CHRG_PSN_CD.add(((KZ0010P002Struct) list.get(i)).getCUST_CHRG_PSN_CD());
		}
		return size;
	}
	public int setL2L_CUST_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUST_CD.add(((KZ0010P002Struct) list.get(i)).getCUST_CD());
		}
		return size;
	}
	public int setL2L_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_CD.add(((KZ0010P002Struct) list.get(i)).getITEM_CD());
		}
		return size;
	}
	public int setL2L_ITEM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ITEM_NAME.add(((KZ0010P002Struct) list.get(i)).getITEM_NAME());
		}
		return size;
	}
	public int setL2L_SALES_CUST_ODR_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SALES_CUST_ODR_NO.add(((KZ0010P002Struct) list.get(i)).getSALES_CUST_ODR_NO());
		}
		return size;
	}
	public int setL2L_SALES_AMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SALES_AMOUNT.add(((KZ0010P002Struct) list.get(i)).getSALES_AMOUNT());
		}
		return size;
	}
	public int setL2L_REMARKS(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_REMARKS.add(((KZ0010P002Struct) list.get(i)).getREMARKS());
		}
		return size;
	}
	public int setL2L_SALES_AMOUNT_EXCH_RATES(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SALES_AMOUNT_EXCH_RATES.add(((KZ0010P002Struct) list.get(i)).getSALES_AMOUNT_EXCH_RATES());
		}
		return size;
	}
	public int setL2L_OWN_CUR_TAXCREDIT_SALES_AMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OWN_CUR_TAXCREDIT_SALES_AMOUNT.add(((KZ0010P002Struct) list.get(i)).getOWN_CUR_TAXCREDIT_SALES_AMOUNT());
		}
		return size;
	}
	public int setL2L_SALES_UNIT_PRICE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SALES_UNIT_PRICE.add(((KZ0010P002Struct) list.get(i)).getSALES_UNIT_PRICE());
		}
		return size;
	}
	public int setL2L_SALES_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SALES_QTY.add(((KZ0010P002Struct) list.get(i)).getSALES_QTY());
		}
		return size;
	}
	public int setL2L_INSPC_ACPT_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_INSPC_ACPT_DATE.add(((KZ0010P002Struct) list.get(i)).getINSPC_ACPT_DATE());
		}
		return size;
	}
	public int setL2L_INSPC_ACPT_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_INSPC_ACPT_QTY.add(((KZ0010P002Struct) list.get(i)).getINSPC_ACPT_QTY());
		}
		return size;
	}
	public int setL2L_SLIP_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SLIP_CD.add(((KZ0010P002Struct) list.get(i)).getSLIP_CD());
		}
		return size;
	}
	public int setL2L_DLV_LOC_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_LOC_CD.add(((KZ0010P002Struct) list.get(i)).getDLV_LOC_CD());
		}
		return size;
	}
	public int setL2L_SHIP_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SHIP_DATE.add(((KZ0010P002Struct) list.get(i)).getSHIP_DATE());
		}
		return size;
	}
	public int setL2L_CUST_ODR_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUST_ODR_NO.add(((KZ0010P002Struct) list.get(i)).getCUST_ODR_NO());
		}
		return size;
	}
	public int setL2L_ODR_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ODR_NO.add(((KZ0010P002Struct) list.get(i)).getODR_NO());
		}
		return size;
	}
	public int setL2L_CUST_ITEM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUST_ITEM_CD.add(((KZ0010P002Struct) list.get(i)).getCUST_ITEM_CD());
		}
		return size;
	}
	public int setL2L_PART_DLV_SEQ_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PART_DLV_SEQ_NO.add(((KZ0010P002Struct) list.get(i)).getPART_DLV_SEQ_NO());
		}
		return size;
	}
	public int setL2L_SHIP_ODR_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SHIP_ODR_NO.add(((KZ0010P002Struct) list.get(i)).getSHIP_ODR_NO());
		}
		return size;
	}
	public int setL2L_INSPC_ACPT_INFO_IF_CTRL_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_INSPC_ACPT_INFO_IF_CTRL_NO.add(((KZ0010P002Struct) list.get(i)).getINSPC_ACPT_INFO_IF_CTRL_NO());
		}
		return size;
	}
	public int setL2L_DESINATED_SHIP_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DESINATED_SHIP_DATE.add(((KZ0010P002Struct) list.get(i)).getDESINATED_SHIP_DATE());
		}
		return size;
	}
	public int setL2L_SCDL_DLV_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SCDL_DLV_DATE.add(((KZ0010P002Struct) list.get(i)).getSCDL_DLV_DATE());
		}
		return size;
	}
	public int setL2L_ODR_ACPT_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ODR_ACPT_DATE.add(((KZ0010P002Struct) list.get(i)).getODR_ACPT_DATE());
		}
		return size;
	}
	public int setL2L_CUS_DLV_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUS_DLV_CD.add(((KZ0010P002Struct) list.get(i)).getCUS_DLV_CD());
		}
		return size;
	}
	public int setL2L_CUS_DLV_KEY_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUS_DLV_KEY_CD.add(((KZ0010P002Struct) list.get(i)).getCUS_DLV_KEY_CD());
		}
		return size;
	}
	public int setL2L_SPCL_PRICE_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SPCL_PRICE_TYP.add(((KZ0010P002Struct) list.get(i)).getSPCL_PRICE_TYP());
		}
		return size;
	}
	public int setL2L_ODR_CMPLT_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ODR_CMPLT_FLG.add(((KZ0010P002Struct) list.get(i)).getODR_CMPLT_FLG());
		}
		return size;
	}
	public int setL2L_SHIP_CNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SHIP_CNT.add(((KZ0010P002Struct) list.get(i)).getSHIP_CNT());
		}
		return size;
	}
	public int setL2L_T_ODR_TAX_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_T_ODR_TAX_CD.add(((KZ0010P002Struct) list.get(i)).getT_ODR_TAX_CD());
		}
		return size;
	}
	public int setL2L_UNIT_COST_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_UNIT_COST_TYP.add(((KZ0010P002Struct) list.get(i)).getUNIT_COST_TYP());
		}
		return size;
	}
	public int setL2L_CUST_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUST_NAME.add(((KZ0010P002Struct) list.get(i)).getCUST_NAME());
		}
		return size;
	}
	public int setL2L_TAX_CALC_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_CALC_TYP.add(((KZ0010P002Struct) list.get(i)).getTAX_CALC_TYP());
		}
		return size;
	}
	public int setL2L_TAX_APPLY_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_APPLY_TYP.add(((KZ0010P002Struct) list.get(i)).getTAX_APPLY_TYP());
		}
		return size;
	}
	public int setL2L_TEMP_UNIT_PRICE_SALES_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TEMP_UNIT_PRICE_SALES_FLG.add(((KZ0010P002Struct) list.get(i)).getTEMP_UNIT_PRICE_SALES_FLG());
		}
		return size;
	}
	public int setL2L_CLAIM_CYCLE_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CLAIM_CYCLE_TYP.add(((KZ0010P002Struct) list.get(i)).getCLAIM_CYCLE_TYP());
		}
		return size;
	}
	public int setL2L_RM_INP_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_RM_INP_TYP.add(((KZ0010P002Struct) list.get(i)).getRM_INP_TYP());
		}
		return size;
	}
	public int setL2L_CUR_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUR_CD.add(((KZ0010P002Struct) list.get(i)).getCUR_CD());
		}
		return size;
	}
	public int setL2L_EXCH_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_EXCH_TYP.add(((KZ0010P002Struct) list.get(i)).getEXCH_TYP());
		}
		return size;
	}
	public int setL2L_TAX_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_CD.add(((KZ0010P002Struct) list.get(i)).getTAX_CD());
		}
		return size;
	}
	public int setL2L_CUST_VARIOUS_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUST_VARIOUS_TYP.add(((KZ0010P002Struct) list.get(i)).getCUST_VARIOUS_TYP());
		}
		return size;
	}
	public int setL2L_SLIP_PRINTING_TYP_1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SLIP_PRINTING_TYP_1.add(((KZ0010P002Struct) list.get(i)).getSLIP_PRINTING_TYP_1());
		}
		return size;
	}
	public int setL2L_SLIP_PRINTING_TYP_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SLIP_PRINTING_TYP_2.add(((KZ0010P002Struct) list.get(i)).getSLIP_PRINTING_TYP_2());
		}
		return size;
	}
	public int setL2L_SLIP_PRINTING_TYP_3(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SLIP_PRINTING_TYP_3.add(((KZ0010P002Struct) list.get(i)).getSLIP_PRINTING_TYP_3());
		}
		return size;
	}
	public int setL2L_SLIP_PRINTING_TYP_4(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SLIP_PRINTING_TYP_4.add(((KZ0010P002Struct) list.get(i)).getSLIP_PRINTING_TYP_4());
		}
		return size;
	}
	public int setL2L_SLIP_PRINTING_TYP_5(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SLIP_PRINTING_TYP_5.add(((KZ0010P002Struct) list.get(i)).getSLIP_PRINTING_TYP_5());
		}
		return size;
	}
	public int setL2L_PRICE_RANK_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PRICE_RANK_CD.add(((KZ0010P002Struct) list.get(i)).getPRICE_RANK_CD());
		}
		return size;
	}
	public int setL2L_INSPC_ACPT_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_INSPC_ACPT_TYP.add(((KZ0010P002Struct) list.get(i)).getINSPC_ACPT_TYP());
		}
		return size;
	}
	public int setL2L_SHIP_SLIP_ID(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SHIP_SLIP_ID.add(((KZ0010P002Struct) list.get(i)).getSHIP_SLIP_ID());
		}
		return size;
	}
	public int setL2L_CARRIAGE_CHARGE_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CARRIAGE_CHARGE_TYP.add(((KZ0010P002Struct) list.get(i)).getCARRIAGE_CHARGE_TYP());
		}
		return size;
	}
	public int setL2L_BILL_ADDRESSEE_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_BILL_ADDRESSEE_CD.add(((KZ0010P002Struct) list.get(i)).getBILL_ADDRESSEE_CD());
		}
		return size;
	}
	public int setL2L_STL_COND_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_STL_COND_CD.add(((KZ0010P002Struct) list.get(i)).getSTL_COND_CD());
		}
		return size;
	}
	public int setL2L_CLAIM_ORG_CD(List list) {
		int size = (list != null) ? list.size() : 0;
		if (size == 0) {
			return 0;
		}
		if (l_CLAIM_ORG_CD == null) {
			l_CLAIM_ORG_CD = new ArrayList();
		} else {
			l_CLAIM_ORG_CD.clear();
		}
		for (int i = 0; i < size; i++) {
			l_CLAIM_ORG_CD.add(((KZ0010P002Struct) list.get(i)).getCLAIM_ORG_CD());
		}
		return size;
	}
	public int setL2L_BILL_BALANCE_CTRL_FLG(List list) {
		int size = (list != null) ? list.size() : 0;
		if (size == 0) {
			return 0;
		}
		if (l_BILL_BALANCE_CTRL_FLG == null) {
			l_BILL_BALANCE_CTRL_FLG = new ArrayList();
		} else {
			l_BILL_BALANCE_CTRL_FLG.clear();
		}
		for (int i = 0; i < size; i++) {
			l_BILL_BALANCE_CTRL_FLG.add(((KZ0010P002Struct) list.get(i)).getBILL_BALANCE_CTRL_FLG());
		}
		return size;
	}
	public int setL2L_AR_BALANCE_CTRL_FLG(List list) {
		int size = (list != null) ? list.size() : 0;
		if (size == 0) {
			return 0;
		}
		if (l_AR_BALANCE_CTRL_FLG == null) {
			l_AR_BALANCE_CTRL_FLG = new ArrayList();
		} else {
			l_AR_BALANCE_CTRL_FLG.clear();
		}
		for (int i = 0; i < size; i++) {
			l_AR_BALANCE_CTRL_FLG.add(((KZ0010P002Struct) list.get(i)).getAR_BALANCE_CTRL_FLG());
		}
		return size;
	}
	public int setL2L_DLV_LOC_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_LOC_NAME.add(((KZ0010P002Struct) list.get(i)).getDLV_LOC_NAME());
		}
		return size;
	}
	public int setL2L_ZIP_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ZIP_CD.add(((KZ0010P002Struct) list.get(i)).getZIP_CD());
		}
		return size;
	}
	public int setL2L_ADDRESS_1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ADDRESS_1.add(((KZ0010P002Struct) list.get(i)).getADDRESS_1());
		}
		return size;
	}
	public int setL2L_ADDRESS_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ADDRESS_2.add(((KZ0010P002Struct) list.get(i)).getADDRESS_2());
		}
		return size;
	}
	public int setL2L_CUST_ITEM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUST_ITEM_NAME.add(((KZ0010P002Struct) list.get(i)).getCUST_ITEM_NAME());
		}
		return size;
	}
	public int setL2L_EXCH_RATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_EXCH_RATE.add(((KZ0010P002Struct) list.get(i)).getEXCH_RATE());
		}
		return size;
	}
	public int setL2L_SLIP_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SLIP_DATE.add(((KZ0010P002Struct) list.get(i)).getSLIP_DATE());
		}
		return size;
	}
	public int setL2L_SHIP_SLIP_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SHIP_SLIP_CD.add(((KZ0010P002Struct) list.get(i)).getSHIP_SLIP_CD());
		}
		return size;
	}
	public int setL2L_EXTERNAL_TAX_SALES_AMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_EXTERNAL_TAX_SALES_AMOUNT.add(((KZ0010P002Struct) list.get(i)).getEXTERNAL_TAX_SALES_AMOUNT());
		}
		return size;
	}
	public int setL2L_INTERNAL_TAX_SALES_AMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_INTERNAL_TAX_SALES_AMOUNT.add(((KZ0010P002Struct) list.get(i)).getINTERNAL_TAX_SALES_AMOUNT());
		}
		return size;
	}
	public int setL2L_TAXFREE_SALES_AMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAXFREE_SALES_AMOUNT.add(((KZ0010P002Struct) list.get(i)).getTAXFREE_SALES_AMOUNT());
		}
		return size;
	}
	public int setL2L_TAX_CREDIT_SALES_AMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_CREDIT_SALES_AMOUNT.add(((KZ0010P002Struct) list.get(i)).getTAX_CREDIT_SALES_AMOUNT());
		}
		return size;
	}
	public int setL2L_EXTERNAL_TAX_AMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_EXTERNAL_TAX_AMOUNT.add(((KZ0010P002Struct) list.get(i)).getEXTERNAL_TAX_AMOUNT());
		}
		return size;
	}
	public int setL2L_INTERNAL_TAX_AMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_INTERNAL_TAX_AMOUNT.add(((KZ0010P002Struct) list.get(i)).getINTERNAL_TAX_AMOUNT());
		}
		return size;
	}
	public int setL2L_TAX_AMOUNT_1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_AMOUNT_1.add(((KZ0010P002Struct) list.get(i)).getTAX_AMOUNT_1());
		}
		return size;
	}
	public int setL2L_TAX_AMOUNT_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_AMOUNT_2.add(((KZ0010P002Struct) list.get(i)).getTAX_AMOUNT_2());
		}
		return size;
	}
	public int setL2L_TAX_AMOUNT_3(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_AMOUNT_3.add(((KZ0010P002Struct) list.get(i)).getTAX_AMOUNT_3());
		}
		return size;
	}
	public int setL2L_STATUS(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_STATUS.add(((KZ0010P002Struct) list.get(i)).getSTATUS());
		}
		return size;
	}
	public int setL2L_EDI_DATA_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_EDI_DATA_TYP.add(((KZ0010P002Struct) list.get(i)).getEDI_DATA_TYP());
		}
		return size;
	}
	public int setL2L_OLD_TAX_RATE_1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OLD_TAX_RATE_1.add(((KZ0010P002Struct) list.get(i)).getOLD_TAX_RATE_1());
		}
		return size;
	}
	public int setL2L_OLD_TAX_RATE_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OLD_TAX_RATE_2.add(((KZ0010P002Struct) list.get(i)).getOLD_TAX_RATE_2());
		}
		return size;
	}
	public int setL2L_OLD_TAX_RATE_3(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OLD_TAX_RATE_3.add(((KZ0010P002Struct) list.get(i)).getOLD_TAX_RATE_3());
		}
		return size;
	}
	public int setL2L_NEW_TAX_RATE_START_DATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_NEW_TAX_RATE_START_DATE.add(((KZ0010P002Struct) list.get(i)).getNEW_TAX_RATE_START_DATE());
		}
		return size;
	}
	public int setL2L_NEW_TAX_RATE_1(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_NEW_TAX_RATE_1.add(((KZ0010P002Struct) list.get(i)).getNEW_TAX_RATE_1());
		}
		return size;
	}
	public int setL2L_NEW_TAX_RATE_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_NEW_TAX_RATE_2.add(((KZ0010P002Struct) list.get(i)).getNEW_TAX_RATE_2());
		}
		return size;
	}
	public int setL2L_NEW_TAX_RATE_3(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_NEW_TAX_RATE_3.add(((KZ0010P002Struct) list.get(i)).getNEW_TAX_RATE_3());
		}
		return size;
	}
	public int setL2L_ROUND_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_ROUND_TYP.add(((KZ0010P002Struct) list.get(i)).getROUND_TYP());
		}
		return size;
	}
	public int setL2L_DECIMAL_FIG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DECIMAL_FIG.add(((KZ0010P002Struct) list.get(i)).getDECIMAL_FIG());
		}
		return size;
	}
	public int setL2L_SEQ_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SEQ_NO.add(((KZ0010P002Struct) list.get(i)).getSEQ_NO());
		}
		return size;
	}
	public int setL2L_LINE_NO(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_LINE_NO.add(((KZ0010P002Struct) list.get(i)).getLINE_NO());
		}
		return size;
	}
	public int setL2L_LINE_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_LINE_TYP.add(((KZ0010P002Struct) list.get(i)).getLINE_TYP());
		}
		return size;
	}
	public int setL2L_COMM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_COMM_CD.add(((KZ0010P002Struct) list.get(i)).getCOMM_CD());
		}
		return size;
	}
	public int setL2L_COMM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_COMM_NAME.add(((KZ0010P002Struct) list.get(i)).getCOMM_NAME());
		}
		return size;
	}
	public int setL2L_SPEC(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SPEC.add(((KZ0010P002Struct) list.get(i)).getSPEC());
		}
		return size;
	}
	public int setL2L_TAX_CD_2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_TAX_CD_2.add(((KZ0010P002Struct) list.get(i)).getTAX_CD_2());
		}
		return size;
	}
	public int setL2L_INP_UNIT_PRICE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_INP_UNIT_PRICE.add(((KZ0010P002Struct) list.get(i)).getINP_UNIT_PRICE());
		}
		return size;
	}
	public int setL2L_UNIT_PRICE_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_UNIT_PRICE_TYP.add(((KZ0010P002Struct) list.get(i)).getUNIT_PRICE_TYP());
		}
		return size;
	}
	public int setL2L_SLIP_QTY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SLIP_QTY.add(((KZ0010P002Struct) list.get(i)).getSLIP_QTY());
		}
		return size;
	}
	public int setL2L_PART_DLV_TIMES(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PART_DLV_TIMES.add(((KZ0010P002Struct) list.get(i)).getPART_DLV_TIMES());
		}
		return size;
	}
	public int setL2L_PART_DLV_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PART_DLV_TYP.add(((KZ0010P002Struct) list.get(i)).getPART_DLV_TYP());
		}
		return size;
	}
	public int setL2L_CUST_COMM_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUST_COMM_CD.add(((KZ0010P002Struct) list.get(i)).getCUST_COMM_CD());
		}
		return size;
	}
	public int setL2L_CUST_COMM_NAME(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUST_COMM_NAME.add(((KZ0010P002Struct) list.get(i)).getCUST_COMM_NAME());
		}
		return size;
	}
	public int setL2L_CUST_ODR_SLIP_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUST_ODR_SLIP_CD.add(((KZ0010P002Struct) list.get(i)).getCUST_ODR_SLIP_CD());
		}
		return size;
	}
	public int setL2L_CUST_UNIT_PRICE_TYP(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_CUST_UNIT_PRICE_TYP.add(((KZ0010P002Struct) list.get(i)).getCUST_UNIT_PRICE_TYP());
		}
		return size;
	}
	public int setL2L_OWN_CUR_SALES_AMOUNT(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_OWN_CUR_SALES_AMOUNT.add(((KZ0010P002Struct) list.get(i)).getOWN_CUR_SALES_AMOUNT());
		}
		return size;
	}
	public int setL2L_STOCK_CTRL_FLG(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_STOCK_CTRL_FLG.add(((KZ0010P002Struct) list.get(i)).getSTOCK_CTRL_FLG());
		}
		return size;
	}
	public int setL2L_DUMMY(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DUMMY.add(((KZ0010P002Struct) list.get(i)).getDUMMY());
		}
		return size;
	}
	public int setL2L_SLIP_CD2(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SLIP_CD2.add(((KZ0010P002Struct) list.get(i)).getSLIP_CD2());
		}
		return size;
	}
	public int setL2L_SYSTEMDATE(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SYSTEMDATE.add(((KZ0010P002Struct) list.get(i)).getSYSTEMDATE());
		}
		return size;
	}
	public int setL2L_SYSTEMUSER(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_SYSTEMUSER.add(((KZ0010P002Struct) list.get(i)).getSYSTEMUSER());
		}
		return size;
	}
	public int setL2L_PROGRAMID(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_PROGRAMID.add(((KZ0010P002Struct) list.get(i)).getPROGRAMID());
		}
		return size;
	}
	public int setL2L_DLV_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_CD.add(((KZ0010P002Struct) list.get(i)).getDLV_CD());
		}
		return size;
	}
	public int setL2L_DLV_KEY_CD(List list) {
		...
		for (int i = 0; i < size; i++) {
			l_DLV_KEY_CD.add(((KZ0010P002Struct) list.get(i)).getDLV_KEY_CD());
		}
		return size;
	}
	...
	public void clear()
	{
		...
		m_STL_COND_CD = null;
		m_CLAIM_ORG_CD = null;
		m_BILL_BALANCE_CTRL_FLG = null;
		m_AR_BALANCE_CTRL_FLG = null;
		m_DLV_LOC_NAME = null;
		m_ZIP_CD = null;
		m_ADDRESS_1 = null;
		m_ADDRESS_2 = null;
		...
		l_STL_COND_CD = null;
		l_CLAIM_ORG_CD = null;
		l_BILL_BALANCE_CTRL_FLG = null;
		l_AR_BALANCE_CTRL_FLG = null;
		l_DLV_LOC_NAME = null;
		l_ZIP_CD = null;
		l_ADDRESS_1 = null;
		l_ADDRESS_2 = null;
	...
	/**
	 * medKZ0010P002クラスの標準コンストラクタ
	 */
	public KZ0010P002Struct()
	{
	 ...
	 */
	public void setStruct(KZ0010P002Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructM(KZ0010P002Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
			...
			this.setCLAIM_ORG_CD(struct.getCLAIM_ORG_CD());
			this.setBILL_BALANCE_CTRL_FLG(struct.getBILL_BALANCE_CTRL_FLG());
			this.setAR_BALANCE_CTRL_FLG(struct.getAR_BALANCE_CTRL_FLG());
	 ...
	 * @param struct セットする元のStruct
	 */
	public void setStructL(KZ0010P002Struct struct)
	{
		if (struct == null) {
			clear();
		} else {
			...
			this.setList_CLAIM_ORG_CD(struct.getList_CLAIM_ORG_CD());
			this.setList_BILL_BALANCE_CTRL_FLG(struct.getList_BILL_BALANCE_CTRL_FLG());
			this.setList_AR_BALANCE_CTRL_FLG(struct.getList_AR_BALANCE_CTRL_FLG());
...
/*
	...
	// 第 62 変数初期値： i_CLAIM_ORG_CD


	final static String i_CLAIM_ORG_CD = null;

	// 第 63 変数初期値： i_BILL_BALANCE_CTRL_FLG


	final static String i_BILL_BALANCE_CTRL_FLG = null;

	// 第 64 変数初期値： i_AR_BALANCE_CTRL_FLG


	final static String i_AR_BALANCE_CTRL_FLG = null;

	// 第 65 変数初期値： i_DLV_LOC_NAME
