/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DE0010/src/com/nec/jp/orteus/metamorBase/DE0010/DE0010B001/cdrDE0010B001.java,v $
 *
...
public class cdrDE0010B001 extends Object
		implements IBatchAppCommon
{
	...
	public int getType() { return m_conductor.getType(); }
        ...
        public int beginProc() throws BatchAppException
        {
         try {
          ...
          setCommitFlag(false);
          BatchAppException be=new BatchAppException("cdrDE0010B001", "beginProc", "conductorの初期処理に失敗しました");
	...
	medDE0010B001 m_med=new medDE0010B001();

	// BatchAppConductorクラスインスタンス
	BatchAppConductor m_conductor=new BatchAppConductor("DE0010B001");
	...
	/**
	 * ctrDE0010B001クラス 標準コンストラクタ
	 *
		 */
	public cdrDE0010B001() throws BatchAppException
	{
		initialize();
