/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/DE0010/src/com/nec/jp/orteus/metamorBase/DE0010/DE0010B001/mainDE0010B001.java,v $
 *
...
/**
 * CLASS     : mainDE0010B001 クラス
 * ファイル・クラス説明
 * @author $Author: xl-hs-zzw $
 * @version $Revision: 1.7 $ $Date: 2014/11/05 07:25:39 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class mainDE0010B001
{
    // リターン値
	...
	public static void main(String args[])
	{
		...
		try {
			...
			if (sysLog == null) {
				...
				if(!sysLog.init("com.nec.jp.orteus.metamorBase.DE0010B001")) {
					//システムログの初期化に失敗しました
			...
			try {
				...
				// 標準出力ファイル名設定
				String logFileName = "DE0010B001.log";
				if (logFileName == null) {
				...
				// 新規作成のためバッチログファイル削除
				if (blogMode == false) {
					File logFile = new File(logOutputPath + "/DE0010B001.log");
				...
				System.setOut(new PrintStream(new FileOutputStream(logOutputPath + "/DE0010B001stdout.log", blogMode)));
				System.setErr(new PrintStream(new FileOutputStream(logOutputPath + "/DE0010B001stderr.log", blogMode)));
			...
			cdrDE0010B001 ebo = new cdrDE0010B001();
