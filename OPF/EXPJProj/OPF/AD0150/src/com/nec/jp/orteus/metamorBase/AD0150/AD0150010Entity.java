/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AD0150/src/com/nec/jp/orteus/metamorBase/AD0150/AD0150010Entity.java,v $
 *
...
public class AD0150010Entity extends DataObject
{
...
+"";		//////////////////////////////
	...
	public class ei_CSVOut extends DataObject
	{
		...
		String m_write_fname="AD0150010.csv";

		protected WriteCsv m_writer=null;		// csv書込み用

		String m_ProjName="AD0150010";
...
+"  (?, TO_NUMBER(?), TO_DATE(?), TO_NUMBER(?), ?)";
		...
		protected String m_sCreateProgramName="AD0150010";
		protected String m_sUpdateProgramName="AD0150010";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int create(IDbConnection conn, AD0150010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int create(Connection conn, AD0150010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt=null;
			...
			try {
				...
				setString(9, data.getOPR_INST_SLIP_ISS_DATE(), stmt);
				setString(10, data.getOPR_INST_SLIP_ISS_FLG(), stmt);
...
+"VALUES "
+"  (?, ?, ?, ?, ?, TO_DATE(?, 'yyyy/mm/dd hh24MI'), TO_DATE(?, 'yyyy/mm/dd hh24MI'), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_NUMBER(?), TO_DATE(?), TO_DATE(?), ?, ?)";
		protected String m_updcmd = null;
		protected String m_delcmd = null;
		protected String m_spcmd = null;
		...
		public int create(Connection conn, AD0150010Struct data) throws FoundationException, SQLException
		{
			...
			try {
				...
				setString(12, data.getOPR_INST_START_DATE(), stmt);
				setString(13, data.getWORK_ODR_DLV_DATE(), stmt);
				setString(14, data.getOPR_INST_QTY(), stmt);
				setString(15, data.getOPR_RSLT_TYP(), stmt);
				setString(16, data.getWORK_STS_TYP(), stmt);
				setString(17, data.getPROC_EXPLOSION_FLG(), stmt);
				setString(18, data.getOPR_INST_DATE(), stmt);
				setString(19, data.getWORK_CMPLT_DATE(), stmt);
...
+"  AND T_JOB_ODR.\"JOB_ODR_CD\" = ?";
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AD0150010Struct data) throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AD0150010Struct data, String replaceStr)
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AD0150010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AD0150010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AD0150010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AD0150010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(PreparedStatement stmt, AD0150010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public PreparedStatement prepare(Connection conn, String query, AD0150010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt;
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public ResultSet executeQuery(PreparedStatement stmt, AD0150010Struct data) throws FoundationException, SQLException
		{
			int no=1;
		 ...
		 * レコードデータをStructに格納して返します
		 */
		public AD0150010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			if(rs.next()==false) return null;

			AD0150010Struct data = new AD0150010Struct();

			data.setOD_NO( getString(1, rs) );
			data.setDUE_DATE( getString(2, rs) );
			data.setPARENT_OD_NO( getString(3, rs) );
			data.setODR_START_DATE( getString(4, rs) );
			data.setJOB_ODR_CD( getString(5, rs) );
			data.setJOB_ODR_STS_TYP( getString(6, rs) );
			data.setPLANT_CD( getString(7, rs) );
			data.setJOB_ODR_DLV_DATE( getString(8, rs) );
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(IDbConnection conn, AD0150010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(Connection conn, AD0150010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(IDbConnection conn, AD0150010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(Connection conn, AD0150010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(PreparedStatement stmt, AD0150010Struct data) throws FoundationException, SQLException
		{
			ResultSet rs=executeQuery(stmt, data);
			boolean ret=true;
...
+"  M_ITEM.\"ITEM_CD\" = ?";
		...
		public List read(Connection conn, AD0150010Struct data) throws FoundationException, SQLException
		{
			...
			if(m_selcmd==null) throw new FoundationException("selectItem_CD", "read", "クエリー未登録");
		...
		public boolean hasRecord(Connection conn, AD0150010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("selectItem_CD", "hasRecord", "クエリー未登録");
...
+"  T_OD.\"PARENT_OD_NO\" = ?";
	 ...
	 */
	public AD0150010Entity() throws FoundationException
	{
