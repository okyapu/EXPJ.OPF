/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AD0150/src/com/nec/jp/orteus/metamorBase/AD0150/AD0150B001/SQLWORKINPROCBYITEMINTERFACE.java,v $
 *
...
/**
 * CLASS     : SQLWORKINPROCBYITEMINTERFACE クラス
 * ファイル・クラス説明
...
public class SQLWORKINPROCBYITEMINTERFACE extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public List call() throws BatchAppException
		{
			try {
				...
				e.printStackTrace();
				BatchAppException be=new BatchAppException("SQLWORKINPROCBYITEMINTERFACE", "call", "Stored Procedure条件設定処理失敗");
				...
				if (cstmt != null) {
					try {
						...
						ef.printStackTrace();
						BatchAppException bef = new BatchAppException("SQLWORKINPROCBYITEMINTERFACE", "call", "Stored Procedureクローズ処理失敗");
		 ...
		 */
		public medAD0150B001 call(ResultSet rs) throws SQLException
		{
			if(rs == null || rs.next()==false) return null;
			medAD0150B001 data = new medAD0150B001();
			m_med.setpnumReturn(cstmt.getString(11));
			return data;
		}
	...
	/**
	 * SQLWORKINPROCBYITEMINTERFACEクラスの標準コンストラクタ
	 *
		 */
	public SQLWORKINPROCBYITEMINTERFACE(medAD0150B001 med, BatchAppConductor cdr) throws SystemException
	{
	...
	protected static String m_calcmd = "{" + "Call SQLWORKINPROCBYITEMINTERFACE(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" + "}";
