/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AD0150/src/com/nec/jp/orteus/metamorBase/AD0150/AD0150B001/selectItem_CD.java,v $
 *
...
public class selectItem_CD extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN4_R(m_med.getITEM_CD());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("selectItem_CD", "read", "レコード検索条件設定処理失敗");
		...
		public String getUNIT_QTY_TYP_R() throws FoundationException { return m_doRs.getString(2); }
		public String getMRP_ODR_TYP_R() throws FoundationException { return m_doRs.getString(3); }
		public String getOPR_RSLT_TYP_R() throws FoundationException { return m_doRs.getString(4); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setOPR_RSLT_TYP(getOPR_RSLT_TYP_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("selectItem_CD", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("selectItem_CD", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	...
	/**
	 * selectItem_CDクラスの標準コンストラクタ
	 *
		 */
	public selectItem_CD(medAD0150B001 med, BatchAppConductor cdr) throws SystemException
	{
