/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AD0150/src/com/nec/jp/orteus/metamorBase/AD0150/AD0150B001/USER_MST.java,v $
 *
...
public class USER_MST extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setPLANT_NAME(getUSER_NAME_R());
			} catch(FoundationException e) {
	 ...
	 *
		 */
	public USER_MST(medAD0150B001 med, BatchAppConductor cdr) throws SystemException
	{
