/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AD0150/src/com/nec/jp/orteus/metamorBase/AD0150/AD0150B001/cdrAD0150B001.java,v $
 *
...
public class cdrAD0150B001 extends Object
		implements IBatchAppCommon
{
	...
	public void initialize() throws BatchAppException, SystemException
	{
		try {
			...
			m_med.setSQLWORKINPROCBYITEMINTERFACE( new SQLWORKINPROCBYITEMINTERFACE(m_med, m_conductor) );
			m_med.setSYS_BAT_PARM( new SYS_BAT_PARM(m_med, m_conductor) );
			m_med.setT_WORK_ODR_TEMP( new T_WORK_ODR_TEMP(m_med, m_conductor) );
			m_med.setselectItem_CD( new selectItem_CD(m_med, m_conductor) );
			m_med.setdeleteT_WORK_ODR_TEMP( new deleteT_WORK_ODR_TEMP(m_med, m_conductor) );
			...
			m_conductor.addObject( m_med.getSQLWORKINPROCBYITEMINTERFACE() );
			m_conductor.addObject( m_med.getSYS_BAT_PARM() );
			m_conductor.addObject( m_med.getT_WORK_ODR_TEMP() );
			m_conductor.addObject( m_med.getselectItem_CD() );
			m_conductor.addObject( m_med.getdeleteT_WORK_ODR_TEMP() );
	...
	public int beginProc() throws BatchAppException
	{
		try {
			...
			setCommitFlag(false);
			BatchAppException be=new BatchAppException("cdrAD0150B001", "beginProc", "conductorの初期処理に失敗しました");
	...
	medAD0150B001 m_med=new medAD0150B001();

	// BatchAppConductorクラスインスタンス
	BatchAppConductor m_conductor=new BatchAppConductor("AD0150B001");
	...
	/**
	 * ctrAD0150B001クラス 標準コンストラクタ
	 *
		 */
	public cdrAD0150B001() throws BatchAppException
	{
		initialize();
