/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AH0070/src/com/nec/jp/orteus/metamorBase/AH0070/AH0070B001/T_INV_CTRL.java,v $
 *
...
/**
 * CLASS     : T_INV_CTRL クラス
 * ファイル・クラス説明
 * @author $Author: xl-hs-zzw $
 * @version $Revision: 1.4 $ $Date: 2014/11/05 07:13:47 $
 */

//{{user_implement_dev:header
//}}user_implement_dev:header

public class T_INV_CTRL extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public int read(boolean cache) throws BatchAppException
		{
			try {
				...
				setIN2_R(m_med.getINV_DATE());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("T_INV_CTRL", "read", "レコード検索条件設定処理失敗");
		...
		public String getAPPR_FLG_R() throws FoundationException { return m_doRs.getString(1); }
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setAPPR_FLG(getAPPR_FLG_R());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("T_INV_CTRL", "next", "レコード移動失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		...
		public boolean hasRecord(boolean moveCursor) throws BatchAppException
		{
			...
			try {
				...
				BatchAppException be=new BatchAppException("T_INV_CTRL", "hasRecord", "レコード存在チェック失敗");
				be.addMessage(e.getErrmsg());
				throw be;
			}
		}
	 ...
	 *
		 */
	public T_INV_CTRL(medAH0070B001 med, BatchAppConductor cdr) throws SystemException
	{
