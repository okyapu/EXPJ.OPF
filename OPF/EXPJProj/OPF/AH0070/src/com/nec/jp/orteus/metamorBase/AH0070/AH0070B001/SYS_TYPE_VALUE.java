/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AH0070/src/com/nec/jp/orteus/metamorBase/AH0070/AH0070B001/SYS_TYPE_VALUE.java,v $
 *
 ...
 * @version $Revision: 1.4 $ $Date: 2014/11/05 07:13:46 $
 */
...
public class SYS_TYPE_VALUE extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public boolean next() throws BatchAppException
		{
			try {
				...
				m_med.setAPR_INV_CTRL(getVALUE_R());
			} catch(FoundationException e) {
	 ...
	 *
		 */
	public SYS_TYPE_VALUE(medAH0070B001 med, BatchAppConductor cdr) throws SystemException
	{
...
+"  SYS_PARAMETER "
+"WHERE "
+"  SYS_PARAMETER.NAME = 'APR_INV_CTRL'";
