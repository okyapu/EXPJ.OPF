/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AC0150/src/com/nec/jp/orteus/metamorBase/AC0150/AC0150010Entity.java,v $
 *
...
public class AC0150010Entity extends DataObject
{
	...
	// Select_formクラス インスタンス
	public Select_form mSelect_form = new Select_form();
	...
	// T_ODRELEASE_Tクラス インスタンス
	public T_ODRELEASE_T mT_ODRELEASE_T = new T_ODRELEASE_T();
...
+"";		//////////////////////////////
	...
	public class ei_CSVOut extends DataObject
	{
		...
		String m_write_fname="AC0150010.csv";

		protected WriteCsv m_writer=null;		// csv書込み用

		String m_ProjName="AC0150010";
	 ...
	 * Entity定義 静的SQL
	 */
	public class Select_form extends DataObject
	{
...
+"  T_JOB_ODR.\"JOB_ODR_QTY\" AS \"JOB_ODR_QTY\", "
...
+"  AND T_JOB_ODR.\"JOB_ODR_CANCEL_NO\" = ?";
		...
		//{{user_implement_dev:Select_form_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:Select_form_def
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AC0150010Struct data) throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AC0150010Struct data, String replaceStr)
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(IDbConnection conn, AC0150010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AC0150010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:Select_form_read
			if(m_selcmd==null) throw new FoundationException("Select_form", "read", "クエリー未登録");
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AC0150010Struct data, String replaceStr)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:Select_form_read2
			if(m_selcmd==null) throw new FoundationException("Select_form", "read", "クエリー未登録");
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(Connection conn, AC0150010Struct data, String[] replaceStrs)
				throws FoundationException, SQLException
		{
			//{{user_implement_dev:Select_form_read3
			if(m_selcmd==null) throw new FoundationException("Select_form", "read", "クエリー未登録");
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public List read(PreparedStatement stmt, AC0150010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public PreparedStatement prepare(Connection conn, String query, AC0150010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt;
			...
			try {
				...
				throw new FoundationException("Select_form", "prepare", "Parse失敗:"+e.toString());
			} finally {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public ResultSet executeQuery(PreparedStatement stmt, AC0150010Struct data) throws FoundationException, SQLException
		{
			int no=1;
		 ...
		 * レコードデータをStructに格納して返します
		 */
		public AC0150010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			if(rs.next()==false) return null;

			AC0150010Struct data = new AC0150010Struct();

			data.setPLANT_CD( getString(1, rs) );
			data.setJOB_ODR_STS_TYP( getString(2, rs) );
			data.setJOB_ODR_TYP( getString(3, rs) );
			data.setPLAN_TYP( getString(4, rs) );
			data.setALC_GRP_CD( getString(5, rs) );
			data.setJOB_ODR_DLV_DATE( getString(6, rs) );
			data.setJOB_ODR_QTY( getString(7, rs) );
			data.setJOB_ODR_DEL_FLG( getString(8, rs) );
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(IDbConnection conn, AC0150010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean hasRecord(Connection conn, AC0150010Struct data) throws FoundationException, SQLException
		{
			if(m_selcmd==null) throw new FoundationException("Select_form", "hasRecord", "クエリー未登録");
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(IDbConnection conn, AC0150010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(Connection conn, AC0150010Struct data) throws FoundationException, SQLException
		{
			//{{user_implement_dev:Select_form_check
			PreparedStatement stmt = prepare(conn, m_selcmd, data);
			try {
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public boolean check(PreparedStatement stmt, AC0150010Struct data) throws FoundationException, SQLException
		{
			ResultSet rs=executeQuery(stmt, data);
			boolean ret=true;
		...
		public void clear()
		{
			//{{user_implement_dev:Select_form_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:Select_form_clear
		...
		/**
		 * Select_formクラスの標準コンストラクタ
		 */
		public Select_form()
		{
			//{{user_implement_dev:Select_form_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:Select_form_constractor
...
+"  V_JOB_ODR_PROG_LST.\"DM_STS_TYP\" as \"l_DM_STS_TYP\", "
...
+"  V_JOB_ODR_PROG_LST.\"ITEM_CD\"";
		...
		public AC0150010Struct next(ResultSet rs) throws FoundationException, SQLException
		{
			...
			data.setl_ODR_STS_TYP( getString(5, rs) );
			data.setl_DUE_DATE( getString(6, rs) );
			data.setl_ODR_START_DATE( getString(7, rs) );
			data.setl_PRD_DUE_DATE( getString(8, rs) );
			data.setl_PRD_START_DATE( getString(9, rs) );
			data.setl_ODR_QTY( getString(10, rs) );
			data.setl_OUTSIDE_TYP( getString(11, rs) );
			data.setl_RCV_QTY( getString(12, rs) );
			data.setl_RCV_CMPLT_DATE( getString(13, rs) );
			data.setl_OD_GNR_TYP( getString(14, rs) );
			data.setl_DM_STS_TYP( getString(15, rs) );
			data.setMRP_TYP( getString(16, rs) );
			data.setl_RLSD_PUCH_ODR_QTY( getString(17, rs) );
			data.setl_WORK_IN_PROC_QTY( getString(18, rs) );
...
+"  M_ITEM.\"ITEM_CD\" = ?";
	 ...
	 * Entity定義 静的SQL
	 */
	public class T_ODRELEASE_T extends DataObject
	{
		protected String m_selcmd = null;
		protected String m_chkcmd = null;
		protected String m_inscmd = "INSERT INTO "
+"  T_ODRELEASE_T(\"INSERT_USER\", \"INSERT_TIME\", \"PLANT_CD\", \"OD_NO\") "
+"VALUES "
+"  (?, ?, ?, ?)";
		protected String m_updcmd = null;
...
+"  AND T_ODRELEASE_T.\"INSERT_TIME\" = ?";
		...
		protected String m_sCreateProgramName="AC0150010";
		protected String m_sUpdateProgramName="AC0150010";
		protected int m_intMODIFY_COUNT=0;


		//////////////////////////////

		//{{user_implement_dev:T_ODRELEASE_T_def
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:T_ODRELEASE_T_def
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int create(IDbConnection conn, AC0150010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int create(Connection conn, AC0150010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt=null;
			...
			try {
				...
				setString(7, data.getSYS_USER(), stmt);
				setString(8, data.getSYS_TIME(), stmt);
				setString(9, data.getPLANT_CD(), stmt);
				setString(10, data.getl_OD_NO(), stmt);
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int delete(IDbConnection conn, AC0150010Struct data) throws FoundationException, SQLException
		{
		 ...
		 * @exception <<コメントを記述してください>>
		 */
		public int delete(Connection conn, AC0150010Struct data) throws FoundationException, SQLException
		{
			PreparedStatement stmt=null;
			...
			try {
				...
				setString(1, data.getSYS_USER(), stmt);
				setString(2, data.getSYS_TIME(), stmt);
		...
		public void clear()
		{
			//{{user_implement_dev:T_ODRELEASE_T_clear
				// todo: インスタンス消滅時に実行する処理を記述してください
                        //}}user_implement_dev:T_ODRELEASE_T_clear
		...
		/**
		 * T_ODRELEASE_Tクラスの標準コンストラクタ
		 */
		public T_ODRELEASE_T()
		{
			//{{user_implement_dev:T_ODRELEASE_T_constractor
				// TODO: ここに初期処理を記述してください
                        //}}user_implement_dev:T_ODRELEASE_T_constractor
	 ...
	 */
	public AC0150010Entity() throws FoundationException
	{
