/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AC0150/src/com/nec/jp/orteus/metamorBase/AC0150/AC0150B001/cdrAC0150B001.java,v $
 *
...
public class cdrAC0150B001 extends Object
		implements IBatchAppCommon
{
	...
	public void initialize() throws BatchAppException, SystemException
	{
		try {
			...
			m_med.setCallSqlOdRelease_Ind( new CallSqlOdRelease_Ind(m_med, m_conductor) );
			m_med.setreadSysBatParm( new readSysBatParm(m_med, m_conductor) );
			m_med.setDeleteT_OdReleas_T( new DeleteT_OdReleas_T(m_med, m_conductor) );
			m_med.setCtrlMain( new CtrlMain(m_med, m_conductor) );
			m_conductor.addObject( m_med.getCallSqlOdRelease_Ind() );
			m_conductor.addObject( m_med.getreadSysBatParm() );
			m_conductor.addObject( m_med.getDeleteT_OdReleas_T() );
	...
	public int beginProc() throws BatchAppException
	{
		try {
			...
			setCommitFlag(false);
			BatchAppException be=new BatchAppException("cdrAC0150B001", "beginProc", "conductorの初期処理に失敗しました");
	...
	medAC0150B001 m_med=new medAC0150B001();

	// BatchAppConductorクラスインスタンス
	BatchAppConductor m_conductor=new BatchAppConductor("AC0150B001");
	...
	/**
	 * ctrAC0150B001クラス 標準コンストラクタ
	 *
		 */
	public cdrAC0150B001() throws BatchAppException
	{
		initialize();
