/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AC0150/src/com/nec/jp/orteus/metamorBase/AC0150/AC0150B001/DeleteT_OdReleas_T.java,v $
 *
...
public class DeleteT_OdReleas_T extends AbstractBatchAppEntity
{
	...
	class interEntity
	{
		...
		public void setIN1_D(String value) throws FoundationException { getAdapt_D().setString(2, value); }

		public int delete() throws BatchAppException
		{
			try {
				setIN0_D(m_med.getpvc2UserId());
				setIN1_D(m_med.getpvc2SysTime());
			} catch(FoundationException e) {
				BatchAppException be=new BatchAppException("DeleteT_OdReleas_T", "delete", "レコード削除条件設定処理失敗");
	...
	/**
	 * DeleteT_OdReleas_Tクラスの標準コンストラクタ
	 *
		 */
	public DeleteT_OdReleas_T(medAC0150B001 med, BatchAppConductor cdr) throws SystemException
	{
...
+"  T_ODRELEASE_T "
+"WHERE "
+"  T_ODRELEASE_T.\"INSERT_USER\" = ? "
+"  AND T_ODRELEASE_T.\"INSERT_TIME\" = ?";
