/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/AN0090/src/com/nec/jp/orteus/metamorBase/AN0090/AN0090010Control.java,v $
 *
...
import com.nec.jp.orteus.metamorBase.AN0090.*;
...
public class AN0090010Control
{
	...
	//{{user_implement_code_main
       ...
       //	public Object getListvalue(int x) { return this.list.get(x); }	// リストの値を返します。
        public AN0090010Struct getListvalue(int x) { return (AN0090010Struct)(this.list.get(x)); }	// リストの値を返します。
        public AN0090010Struct getStruct() { return this.struct; }	// Structを返します。
        public AN0090010Struct createStruct() { return new AN0090010Struct(); }	// 新しいStructを作って返します。
        public void setStruct(Object structname) { this.struct.setStruct((AN0090010Struct)structname); }	// Structをセットします。
	...
	public void controlSelect() throws BusinessProcessException, FoundationException
	{
		...
		logger.entering("AN0090010Control"+":USER="+struct.getsUser_ID(),"controlSelect");
			//{{user_implement_dev:<controlSelect>
                ...
                try {
                 ...
                 // 工場名をセット
                 AN0090010Struct workStruct = (AN0090010Struct)workList.get(0);
                 struct.setPLANT_NAME(workStruct.getPLANT_NAME());
              
                 // [所要量計算制御]検索
                 bufKey = "SYS_OD_CALC_CTRL.PLANT_CD:" + struct.getPLANT_CD();
                 ...
                 // 編集領域をセット
                 AN0090010Struct structWork = (AN0090010Struct)list.get(0);
                 struct.setOD_CALC_FLG(structWork.getOD_CALC_FLG());
                 struct.setOD_MNT_FLG(structWork.getOD_MNT_FLG());
                ...
                //}}user_implement_dev:<controlSelect>
		logger.exiting("AN0090010Control"+":USER="+struct.getsUser_ID(),"controlSelect");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AN0090");
		logger.entering("AN0090010Control"+":USER="+struct.getsUser_ID(),"controlUpdate");
			//{{user_implement_dev:<controlUpdate>
                ...
                try{
                 ...
                 // [所要量計算制御]更新
                 int dummyRet = entity.mUpdateSYS_OD_CALC_CTRL.update(conn, struct);
                ...
                //}}user_implement_dev:<controlUpdate>
		logger.exiting("AN0090010Control"+":USER="+struct.getsUser_ID(),"controlUpdate");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AN0090");
		logger.entering("AN0090010Control"+":USER="+struct.getsUser_ID(),"controlClear");
			//{{user_implement_dev:<controlClear>
                ...
                //}}user_implement_dev:<controlClear>
		logger.exiting("AN0090010Control"+":USER="+struct.getsUser_ID(),"controlClear");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AN0090");
		logger.entering("AN0090010Control"+":USER="+struct.getsUser_ID(),"controlClose");
			//{{user_implement_dev:<controlClose>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<controlClose>
		logger.exiting("AN0090010Control"+":USER="+struct.getsUser_ID(),"controlClose");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AN0090");
		logger.entering("AN0090010Control"+":USER="+struct.getsUser_ID(),"controlINITIAL");
		//{{user_implement_dev:<controlINITIAL>
                 // TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<controlINITIAL>
		logger.exiting("AN0090010Control"+":USER="+struct.getsUser_ID(),"controlINITIAL");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AN0090");
		logger.entering("AN0090010Control"+":USER="+struct.getsUser_ID(),"controlRELOAD");
		//{{user_implement_dev:<controlRELOAD>
                ...
                //}}user_implement_dev:<controlRELOAD>
		logger.exiting("AN0090010Control"+":USER="+struct.getsUser_ID(),"controlRELOAD");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.AN0090");
		logger.entering("AN0090010Control"+":USER="+struct.getsUser_ID(),"controlPREPARATION");
...
//		}
		...
		//{{user_implement_dev:<controlPREPARATION>
                ...
                //}}user_implement_dev:<controlPREPARATION>
		logger.exiting("AN0090010Control"+":USER="+struct.getsUser_ID(),"controlPREPARATION");
...
//			e.printStackTrace();
//			throw new FoundationException("AN0090010Control",e.getMessage(),"control_eventHandllerメソッドでエラーが発生しました。");
	...
	public void createDefaultCSV(List list, String sTitle[]) throws BusinessProcessException, FoundationException {
		...
		//{{user_implement_dev:<createDefaultCSV>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AN0090010-E999","CSVの出力処理"));
			throw new FoundationException("AN0090010Control",e.getMessage(),"createDefaultCSVメソッドでエラーが発生しました。");
		}
...
//				objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AN0090010-E999","システム日付の取得処理"));
				throw new FoundationException("AN0090010Control","beginTransaction()","システム日付取得処理でエラーが発生しました。");
			}
		...
		//{{user_implement_dev:<beginTransaction>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("AN0090010-E999","コントロールのイベント処理"));
			throw new FoundationException("AN0090010Control",e.getMessage(),"beginTransactionメソッドでエラーが発生しました。");
		}
	 ...
	 * メンバ変数の定義
	 */
	protected AN0090010Entity entity;
	protected AN0090010Struct struct;
	...
	public void initialize() throws FoundationException
	{
		...
		entity = new AN0090010Entity();
		struct = new AN0090010Struct();
	...
	/**
	 * AN0090010クラスの標準コンストラクタ
	 */
	public AN0090010Control() throws BusinessProcessException, FoundationException
	{
		initialize();
	...
	public void setOrMsgKey(List keyList) throws MessageApiException {
		...
		for (int i = 0; msgKeyTypeArray != null && i < msgKeyTypeArray.size(); i++) {
			...
			for(int j = 0; j < keyList.size(); j++) {
				AN0090010Struct key = (AN0090010Struct)keyList.get(j);
				// メッセージキーを作成する
		...
		try {
			for (int i = 0; msgKeyTypeArray != null && i < msgKeyTypeArray.size(); i++) {
				...
				for (int j = 0; msgKeyArray != null && j < msgKeyArray.size(); j++) {
					...
					AN0090010Struct key = new AN0090010Struct();
