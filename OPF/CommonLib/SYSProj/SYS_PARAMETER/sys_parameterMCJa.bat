...
echo Data extraction(Approval parameter according to the company
...
sqlplus %TOUSER%/%TOUSERPW%@%TOUSERCONNECT% @get_onerousMCJa.sql

sqlldr %TOUSER%/%TOUSERPW%@%TOUSERCONNECT% control=sys_parameter.ctl data=sys_parameterMCJa.csv

rem Addition of Onerous
sqlldr %TOUSER%/%TOUSERPW%@%TOUSERCONNECT% control=sys_parameter_onerous.ctl data=sys_parameter_onerousMCJa.csv
