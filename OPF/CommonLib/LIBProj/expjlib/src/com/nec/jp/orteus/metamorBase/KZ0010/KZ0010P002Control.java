/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KZ0010/src/com/nec/jp/orteus/metamorBase/KZ0010/KZ0010P002Control.java,v $
 *
...
public class KZ0010P002Control
{
...
//	public Object getListvalue(int x) { return this.list.get(x); }	// リストの値を返します。
	public KZ0010P002Struct getListvalue(int x) { return (KZ0010P002Struct)(this.list.get(x)); }	// リストの値を返します。
	public KZ0010P002Struct getStruct() { return this.struct; }	// Structを返します。
	public KZ0010P002Struct createStruct() { return new KZ0010P002Struct(); }	// 新しいStructを作って返します。
	public void setStruct(Object structname) { this.struct.setStruct((KZ0010P002Struct)structname); }	// Structをセットします。
    ...
    private KZ0010P002Struct tempStruct;
//2014.08.11 add nes str
...
//2014.08.11 end
    ...
    protected String selectMyCompany() {
        try {
            ...
            //tempStruct = new KZ0010P002Struct();
            tempStruct = (KZ0010P002Struct)list.get(0);
...
//2014.08.11 mod nes end
    ...
    protected String selectClaimCustCtrl() {
        try {
            ...
            struct.setCLAIM_ORG_CD(tempStruct.getCLAIM_ORG_CD());
            String CtrlFlg = tempStruct.getBILL_BALANCE_CTRL_FLG();
            if (!"".equals(CtrlFlg) && CtrlFlg != null) {
            	struct.setBILL_BALANCE_CTRL_FLG(CtrlFlg);
            } else {
            	struct.setBILL_BALANCE_CTRL_FLG("1");
            }
            CtrlFlg = tempStruct.getAR_BALANCE_CTRL_FLG();
        	if (!"".equals(CtrlFlg) && CtrlFlg != null) {
        		struct.setAR_BALANCE_CTRL_FLG(CtrlFlg);
        	} else {
        		struct.setAR_BALANCE_CTRL_FLG("1");
        	}
    ...
    protected String insertIntoeArLedgerHTrn() {
        try {
            ...
            struct.setPROGRAMID("KZ0010P002");
    ...
    protected void calculateTax(String mode) {
        ...
        //--Add End 20131223 qian-lf
            ...
            if("2".equals(struct.getTAX_APPLY_TYP())){
            	...
            	try {
            	  list = entity.mSelectM_ITEM_SPEC.read(conn, struct);
            	  taxCd = ((KZ0010P002Struct)list.get(0)).getTAX_CD();
            	}catch (Exception e) {
                  e.printStackTrace();
                }
            }
	...
	public void controlINITIAL() throws BusinessProcessException, FoundationException
	{
		...
		logger.entering("KZ0010P002Control"+":USER="+struct.getsUser_ID(),"controlINITIAL");
		//{{user_implement_dev:<controlINITIAL>
			// TODO: ユーザ定義のコードを記述してください
                //}}user_implement_dev:<controlINITIAL>
		logger.exiting("KZ0010P002Control"+":USER="+struct.getsUser_ID(),"controlINITIAL");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KZ0010");
		logger.entering("KZ0010P002Control"+":USER="+struct.getsUser_ID(),"controlRELOAD");
...
*/
                //}}user_implement_dev:<controlRELOAD>
		logger.exiting("KZ0010P002Control"+":USER="+struct.getsUser_ID(),"controlRELOAD");
	...
	{
		Logger logger = Logger.getLogger("com.nec.jp.orteus.metamorBase.KZ0010");
		logger.entering("KZ0010P002Control"+":USER="+struct.getsUser_ID(),"controlPREPARATION");
...
//		}
		...
		//{{user_implement_dev:<controlPREPARATION>
			...
			// コンボボックス部品のデータのセットはここに記述してください。
                //}}user_implement_dev:<controlPREPARATION>
		logger.exiting("KZ0010P002Control"+":USER="+struct.getsUser_ID(),"controlPREPARATION");
...
//			e.printStackTrace();
//			throw new FoundationException("KZ0010P002Control",e.getMessage(),"control_eventHandllerメソッドでエラーが発生しました。");
	...
	public void createDefaultCSV(List list, String sTitle[]) throws BusinessProcessException, FoundationException {
		...
		//{{user_implement_dev:<createDefaultCSV>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("KZ0010P002-E999","CSVの出力処理"));
			throw new FoundationException("KZ0010P002Control",e.getMessage(),"createDefaultCSVメソッドでエラーが発生しました。");
		}
...
//				objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("KZ0010P002-E999","システム日付の取得処理"));
				throw new FoundationException("KZ0010P002Control","beginTransaction()","システム日付取得処理でエラーが発生しました。");
			}
		...
		//{{user_implement_dev:<beginTransaction>
			...
			e.printStackTrace();
//			objMessage.m_writer.write(Level.ALL, objMessage.getIDMsg("KZ0010P002-E999","コントロールのイベント処理"));
			throw new FoundationException("KZ0010P002Control",e.getMessage(),"beginTransactionメソッドでエラーが発生しました。");
		}
	 ...
	 * メンバ変数の定義
	 */
	protected KZ0010P002Entity entity;
	protected KZ0010P002Struct struct;
	...
	public void initialize() throws FoundationException
	{
		...
		entity = new KZ0010P002Entity();
		struct = new KZ0010P002Struct();
	 ...
	 */
	public KZ0010P002Control() throws BusinessProcessException, FoundationException
	{
		initialize();
	...
	public void setOrMsgKey(List keyList) throws MessageApiException {
		...
		for (int i = 0; msgKeyTypeArray != null && i < msgKeyTypeArray.size(); i++) {
			...
			for(int j = 0; j < keyList.size(); j++) {
				KZ0010P002Struct key = (KZ0010P002Struct)keyList.get(j);
				// メッセージキーを作成する
				...
				if(msgKeyType.containsKeyColumn("CLAIM_ORG_CD") && key.getCLAIM_ORG_CD() != null) {
					msgKey.setKeyValue("CLAIM_ORG_CD", key.getCLAIM_ORG_CD());
				}
				if(msgKeyType.containsKeyColumn("BILL_BALANCE_CTRL_FLG") && key.getBILL_BALANCE_CTRL_FLG() != null) {
					msgKey.setKeyValue("BILL_BALANCE_CTRL_FLG", key.getBILL_BALANCE_CTRL_FLG());
				}
				if(msgKeyType.containsKeyColumn("AR_BALANCE_CTRL_FLG") && key.getAR_BALANCE_CTRL_FLG() != null) {
					msgKey.setKeyValue("AR_BALANCE_CTRL_FLG", key.getAR_BALANCE_CTRL_FLG());
				}
		...
		try {
			for (int i = 0; msgKeyTypeArray != null && i < msgKeyTypeArray.size(); i++) {
				...
				for (int j = 0; msgKeyArray != null && j < msgKeyArray.size(); j++) {
					...
					KZ0010P002Struct key = new KZ0010P002Struct();
					...
					if(msgKeyType.containsKeyColumn("CLAIM_ORG_CD")) {
						key.setCLAIM_ORG_CD(msgKey.getKeyValue("CLAIM_ORG_CD"));
					}
					if(msgKeyType.containsKeyColumn("BILL_BALANCE_CTRL_FLG")) {
						key.setBILL_BALANCE_CTRL_FLG(msgKey.getKeyValue("BILL_BALANCE_CTRL_FLG"));
					}
					if(msgKeyType.containsKeyColumn("AR_BALANCE_CTRL_FLG")) {
						key.setAR_BALANCE_CTRL_FLG(msgKey.getKeyValue("AR_BALANCE_CTRL_FLG"));
					}
