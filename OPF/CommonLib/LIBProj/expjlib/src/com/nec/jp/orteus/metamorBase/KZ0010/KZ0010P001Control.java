/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/EXPJProj/OPF/KZ0010/src/com/nec/jp/orteus/metamorBase/KZ0010/KZ0010P001Control.java,v $
 *
...
//	public Object getListvalue(int x) { return this.list.get(x); }	// リストの値を返します。
    ...
    protected String selectCustBranch() {
        try {
            ...
            struct.setBRAND_CD(tempStruct.getBRAND_CD());
            struct.setBRAND_NAME(tempStruct.getBRAND_NAME());
	...
	public void setOrMsgKey(List keyList) throws MessageApiException {
		...
		for (int i = 0; msgKeyTypeArray != null && i < msgKeyTypeArray.size(); i++) {
			...
			for(int j = 0; j < keyList.size(); j++) {
				...
				if(msgKeyType.containsKeyColumn("BRAND_CD") && key.getBRAND_CD() != null) {
					msgKey.setKeyValue("BRAND_CD", key.getBRAND_CD());
				}
				if(msgKeyType.containsKeyColumn("BRAND_NAME") && key.getBRAND_NAME() != null) {
					msgKey.setKeyValue("BRAND_NAME", key.getBRAND_NAME());
				}
		...
		try {
			for (int i = 0; msgKeyTypeArray != null && i < msgKeyTypeArray.size(); i++) {
				...
				for (int j = 0; msgKeyArray != null && j < msgKeyArray.size(); j++) {
					...
					if(msgKeyType.containsKeyColumn("BRAND_CD")) {
						key.setBRAND_CD(msgKey.getKeyValue("BRAND_CD"));
					}
					if(msgKeyType.containsKeyColumn("BRAND_NAME")) {
						key.setBRAND_NAME(msgKey.getKeyValue("BRAND_NAME"));
					}
