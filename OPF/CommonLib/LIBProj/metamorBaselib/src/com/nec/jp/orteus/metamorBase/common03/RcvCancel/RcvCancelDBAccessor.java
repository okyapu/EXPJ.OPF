/*
 * $Source: D:/EXPJCVS/EXPJPROJ/expjprsaUV2/LIBProj/metamorBaselib/src/com/nec/jp/orteus/metamorBase/common03/RcvCancel/RcvCancelDBAccessor.java,v $
 *
...
package com.nec.jp.orteus.metamorBase.common03.RcvCancel;
 ...
 * @version $Revision: 1.5 $ $Date: 2008/03/26 07:28:30 $
 */
...
//20031013削除			selectRslt = whereStmt.executeQuery();
	 ...
	 *         SQLの発行に失敗した場合
	 */
	public int insertRcvIssue(RcvCancelStruct struct) throws SQLException
	{
		...
		try {
			...
			insertStmt.setString(18, struct.getUPDATED_BY());
			insertStmt.setString(19, struct.getUPDATED_PRG_NM());
