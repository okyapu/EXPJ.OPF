...
public class IssueStruct
{
	...
	public Integer m_ALC_STOCK_TYP = null;				// 引当在庫区分
	...
	public String  m_ALCD_QTY = null;					// 引当済数
	public String  m_ISSUEED_QTY = null;				// 出庫済数
	...
	public void copy(IssueStruct struct)
	{
		...
		if(struct.m_ALC_STOCK_TYP != null)
			 m_ALC_STOCK_TYP = new Integer(struct.getALC_STOCK_TYP().intValue());
		...
		if(struct.m_ALCD_QTY != null)
			 m_ALCD_QTY = new String(struct.getALCD_QTY());
		if(struct.m_ISSUEED_QTY != null)
			 m_ISSUEED_QTY = new String(struct.getISSUEED_QTY());
