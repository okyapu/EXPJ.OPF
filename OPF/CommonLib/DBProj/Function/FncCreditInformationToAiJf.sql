CREATE OR REPLACE FUNCTION FncCreditInformationToAiJf(
/*------------------------------------------------------------------------------
'
' FncCreditInformationToAiJf.Sql
'
' version   : 1.00.00
'
' 修正履歴
...
'
' 機能説明  : EXPLANNER/Ｊの[売上実績]から売掛情報を集約して、Aｉ向け売掛インタフェースにデータ登録する。
'
' 備考      : ダミソース
'
------------------------------------------------------------------------------*/
...
/* 定数の宣言 */
    ...
    MY_SQL_NAME                           VARCHAR2(120):= 'FNCCREDITINFORMATIONTOAIJF'; --ＰＬ／ＳＱＬ名
