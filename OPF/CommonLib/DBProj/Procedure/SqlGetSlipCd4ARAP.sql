...
------------------------------------------------------------------------------*/
   ...
   ,pvc2ActionTyp          IN      VARCHAR2    --処理種類
   ,pvc2SlipTyp            IN      VARCHAR2    --伝票種類
...
/* 定数の宣言 */
    MY_SQL_NAME            VARCHAR2(120)  := 'SqlGetSlipCd4ARAP'; --ＰＬ／ＳＱＬ名
