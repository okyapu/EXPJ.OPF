...
'             pdtmDate             - (i)対象日付
'             pnumDifference       - (i)差分
'             pnumStartForwardFlg  - (i)基準日の前倒しフラグ
...
------------------------------------------------------------------------------*/
   ...
   ,pnumStartForwardFlg    IN  NUMBER      --基準日の前倒しフラグ
...
/* 定数の宣言 */
    MY_SQL_NAME            VARCHAR2(60)  := 'SqlWorkDayCalc'; --ＰＬ／ＳＱＬ名
...
--    DBMS_OUTPUT.PUT_LINE('採番結果：' || TO_CHAR(dtmResultData,'YYYY/MM/DD') );
